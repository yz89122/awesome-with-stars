...
* [Sakura Panel ![GitHub Repo stars](https://img.shields.io/github/stars/yassinrais/sakura-panel) ![GitHub last commit](https://img.shields.io/github/last-commit/yassinrais/sakura-panel)](https://github.com/yassinrais/sakura-panel) - A Phalcon Panel created to install plugins Without Editing the Panel Source Code (Auth, ACL, Lite Bootstrap Template, And more...).
...
* [packagecloud ![GitHub Repo stars](https://img.shields.io/github/stars/phalcongelist/packagecloud) ![GitHub last commit](https://img.shields.io/github/last-commit/phalcongelist/packagecloud)](https://github.com/phalcongelist/packagecloud) - Phalcon distribution hosted on PackageCloud
