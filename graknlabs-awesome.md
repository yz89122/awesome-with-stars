...
- [`client-java` ![GitHub Repo stars](https://img.shields.io/github/stars/graknlabs/client-java) ![GitHub last commit](https://img.shields.io/github/last-commit/graknlabs/client-java)](http://github.com/graknlabs/client-java)
- [`client-nodejs` ![GitHub Repo stars](https://img.shields.io/github/stars/graknlabs/client-nodejs) ![GitHub last commit](https://img.shields.io/github/last-commit/graknlabs/client-nodejs)](http://github.com/graknlabs/client-nodejs)
- [`client-python` ![GitHub Repo stars](https://img.shields.io/github/stars/graknlabs/client-python) ![GitHub last commit](https://img.shields.io/github/last-commit/graknlabs/client-python)](http://github.com/graknlabs/client-python)


## Client Drivers (unofficial)

- [`client-elixir` ![GitHub Repo stars](https://img.shields.io/github/stars/taxfix/grakn_elixir) ![GitHub last commit](https://img.shields.io/github/last-commit/taxfix/grakn_elixir)](https://github.com/taxfix/grakn_elixir)
- [`Grakn.Net` ![GitHub Repo stars](https://img.shields.io/github/stars/WalternativE/Grakn.Net) ![GitHub last commit](https://img.shields.io/github/last-commit/WalternativE/Grakn.Net)](https://github.com/WalternativE/Grakn.Net)
- [`GraknClient.jl` ![GitHub Repo stars](https://img.shields.io/github/stars/Humans-of-Julia/GraknClient.jl) ![GitHub last commit](https://img.shields.io/github/last-commit/Humans-of-Julia/GraknClient.jl)](https://github.com/Humans-of-Julia/GraknClient.jl)


## IDE and editors support

- [`emacs-graql-mode` ![GitHub Repo stars](https://img.shields.io/github/stars/creatorrr/emacs-graql-mode) ![GitHub last commit](https://img.shields.io/github/last-commit/creatorrr/emacs-graql-mode)](https://github.com/creatorrr/emacs-graql-mode) - Major mode that provides syntax highlighting and basic completion for Graql.
- [`graql-language-vscode` ![GitHub Repo stars](https://img.shields.io/github/stars/idealley/graql-language-vscode) ![GitHub last commit](https://img.shields.io/github/last-commit/idealley/graql-language-vscode)](https://github.com/idealley/graql-language-vscode) - Graql language for Visual Studio Code.
- [`JetBrains-Graql-Plugin` ![GitHub Repo stars](https://img.shields.io/github/stars/BFergerson/JetBrains-Graql-Plugin) ![GitHub last commit](https://img.shields.io/github/last-commit/BFergerson/JetBrains-Graql-Plugin)](https://github.com/BFergerson/JetBrains-Graql-Plugin) - JetBrains support for the Graql language.
- [`language-graql` ![GitHub Repo stars](https://img.shields.io/github/stars/ShishkinDmitriy/language-graql) ![GitHub last commit](https://img.shields.io/github/last-commit/ShishkinDmitriy/language-graql)](https://github.com/ShishkinDmitriy/language-graql) - Atom's syntax highlighting for Graql.
...
- [`TypeDB Loader` ![GitHub Repo stars](https://img.shields.io/github/stars/bayer-science-for-a-better-life/grami) ![GitHub last commit](https://img.shields.io/github/last-commit/bayer-science-for-a-better-life/grami)](https://github.com/bayer-science-for-a-better-life/grami) - Formerly "GraMi", an open-source data migrator for loading data into TypeDB at scale.
...
- [`Grakn Mythos` ![GitHub Repo stars](https://img.shields.io/github/stars/BFergerson/grakn-mythos) ![GitHub last commit](https://img.shields.io/github/last-commit/BFergerson/grakn-mythos)](https://github.com/BFergerson/grakn-mythos) - Grakn-powered application for creating and sharing knowledge graphs.
...
- [`TypeDB Examples` ![GitHub Repo stars](https://img.shields.io/github/stars/vaticle/typedb-examples) ![GitHub last commit](https://img.shields.io/github/last-commit/vaticle/typedb-examples)](https://github.com/vaticle/typedb-examples)
