...
- [Dozer ![GitHub Repo stars](https://img.shields.io/github/stars/DozerMapper/dozer) ![GitHub last commit](https://img.shields.io/github/last-commit/DozerMapper/dozer)](https://github.com/DozerMapper/dozer) - Mapper that copies data from one object to another using annotations and API or XML configuration.
...
- [jbock ![GitHub Repo stars](https://img.shields.io/github/stars/h908714124/jbock) ![GitHub last commit](https://img.shields.io/github/last-commit/h908714124/jbock)](https://github.com/h908714124/jbock) - Typesafe, reflection-free, annotation based command-line parser.
...
- [AranoDB ![GitHub Repo stars](https://img.shields.io/github/stars/arangodb/arangodb-java-driver) ![GitHub last commit](https://img.shields.io/github/last-commit/arangodb/arangodb-java-driver)](https://github.com/arangodb/arangodb-java-driver) - ArangoDB Java driver.
...
- [Almanac Converter ![GitHub Repo stars](https://img.shields.io/github/stars/chrisengelsma/almanac-converter) ![GitHub last commit](https://img.shields.io/github/last-commit/chrisengelsma/almanac-converter)](https://github.com/chrisengelsma/almanac-converter) - Simple conversion between different calendar systems.
...
- [jlink.online ![GitHub Repo stars](https://img.shields.io/github/stars/cilki/jlink.online) ![GitHub last commit](https://img.shields.io/github/last-commit/cilki/jlink.online)](https://github.com/cilki/jlink.online) - Builds optimized runtimes over HTTP.
...
- [restQL-java ![GitHub Repo stars](https://img.shields.io/github/stars/b2wdigital/restQL-java) ![GitHub last commit](https://img.shields.io/github/last-commit/b2wdigital/restQL-java)](https://github.com/b2wdigital/restQL-java) - Microservice query language that fetches information from multiple services.
- [Retrofit](https://square.github.io/retrofit/) - Typesafe REST client.
- [Ribbon ![GitHub Repo stars](https://img.shields.io/github/stars/Netflix/ribbon) ![GitHub last commit](https://img.shields.io/github/last-commit/Netflix/ribbon)](https://github.com/Netflix/ribbon) - Client-side IPC library that is battle-tested in cloud.
