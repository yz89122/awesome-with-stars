...
* [Slate ![GitHub Repo stars](https://img.shields.io/github/stars/ianstormtaylor/slate) ![GitHub last commit](https://img.shields.io/github/last-commit/ianstormtaylor/slate)](https://github.com/ianstormtaylor/slate) - Rich text editor built on top of React and Immutable
* [TipTap ![GitHub Repo stars](https://img.shields.io/github/stars/scrumpy/tiptap) ![GitHub last commit](https://img.shields.io/github/last-commit/scrumpy/tiptap)](https://github.com/scrumpy/tiptap) - Rich text editor for Vue.js
* [Trix ![GitHub Repo stars](https://img.shields.io/github/stars/basecamp/trix) ![GitHub last commit](https://img.shields.io/github/last-commit/basecamp/trix)](https://github.com/basecamp/trix) - Basecamp's rich text editor
...
* [Scribe ![GitHub Repo stars](https://img.shields.io/github/stars/guardian/scribe) ![GitHub last commit](https://img.shields.io/github/last-commit/guardian/scribe)](https://github.com/guardian/scribe) - From the [Guardian](http://www.theguardian.com/) team
...
* [Ritzy ![GitHub Repo stars](https://img.shields.io/github/stars/ritzyed/ritzy) ![GitHub last commit](https://img.shields.io/github/last-commit/ritzyed/ritzy)](https://github.com/ritzyed/ritzy) - Collaborative web-based rich text editor
...
* [KindEditor ![GitHub Repo stars](https://img.shields.io/github/stars/kindsoft/kindeditor) ![GitHub last commit](https://img.shields.io/github/last-commit/kindsoft/kindeditor)](https://github.com/kindsoft/kindeditor) - Open Source HTML editor
...
* [jWYSIWYG ![GitHub Repo stars](https://img.shields.io/github/stars/jwysiwyg/jwysiwyg) ![GitHub last commit](https://img.shields.io/github/last-commit/jwysiwyg/jwysiwyg)](https://github.com/jwysiwyg/jwysiwyg) - WYSIWYG jQuery Plugin 
...
* [MediumEditor ![GitHub Repo stars](https://img.shields.io/github/stars/yabwe/medium-editor) ![GitHub last commit](https://img.shields.io/github/last-commit/yabwe/medium-editor)](https://github.com/yabwe/medium-editor) - A clone of medium.com inline editor toolbar. Uses contenteditable API to implement a rich text solution.
...
* [markdown-js ![GitHub Repo stars](https://img.shields.io/github/stars/evilstreak/markdown-js) ![GitHub last commit](https://img.shields.io/github/last-commit/evilstreak/markdown-js)](https://github.com/evilstreak/markdown-js) - A Markdown parser for javascript
