...
[<img src="https://i.imgur.com/9q98DcX.png" align="right" width="120"> ![GitHub Repo stars](https://img.shields.io/github/stars/xxczaki/awesome-calculators) ![GitHub last commit](https://img.shields.io/github/last-commit/xxczaki/awesome-calculators)](https://github.com/xxczaki/awesome-calculators)

> A curated list of resources related to calculators!

Is your project mentioned in this list? See [mentioned.md ![GitHub Repo stars](https://img.shields.io/github/stars/xxczaki/awesome-calculators) ![GitHub last commit](https://img.shields.io/github/last-commit/xxczaki/awesome-calculators)](https://github.com/xxczaki/awesome-calculators/blob/master/mentioned.md)!
...
- [Droid48 (src) ![GitHub Repo stars](https://img.shields.io/github/stars/shagr4th/droid48) ![GitHub last commit](https://img.shields.io/github/last-commit/shagr4th/droid48)](https://github.com/shagr4th/droid48/tree/master/app/src/main), [Droid48 (app)](https://play.google.com/store/apps/details?id=org.ab.x48) - Android port of x48, the awesome HP48GX/SX emulator
...
### Windows
- [Windows Calculator ![GitHub Repo stars](https://img.shields.io/github/stars/Microsoft/calculator) ![GitHub last commit](https://img.shields.io/github/last-commit/Microsoft/calculator)](https://github.com/Microsoft/calculator) - Simple yet powerful calculator that ships with Windows
...
- [in-line calculator (AutoHotkey Calculator) ![GitHub Repo stars](https://img.shields.io/github/stars/davebrny/in-line-calculator) ![GitHub last commit](https://img.shields.io/github/last-commit/davebrny/in-line-calculator)](https://github.com/davebrny/in-line-calculator) - Interface-less calculator for Windows that lets you do basic math without having to leave the line you're typing on.
...
### Linux
- [Galculator ![GitHub Repo stars](https://img.shields.io/github/stars/galculator/galculator) ![GitHub last commit](https://img.shields.io/github/last-commit/galculator/galculator)](https://github.com/galculator/galculator) - GTK 2  / GTK 3 based scientific calculator.
- [KCalc ![GitHub Repo stars](https://img.shields.io/github/stars/KDE/kcalc) ![GitHub last commit](https://img.shields.io/github/last-commit/KDE/kcalc)](https://github.com/KDE/kcalc) - Calculator which offers many more mathematical functions than meet the eye on a first glance.
- [x48 ![GitHub Repo stars](https://img.shields.io/github/stars/gwenhael-le-moine/x48) ![GitHub last commit](https://img.shields.io/github/last-commit/gwenhael-le-moine/x48)](https://github.com/gwenhael-le-moine/x48) - Emulate the HP48GX/SX, one of the best engineering calculators ever.

### Cross-Platform
- [Parsify Desktop](https://parsify.app) - Extendable calculator for the 21st Century.
- [Simple Electron Calculator ![GitHub Repo stars](https://img.shields.io/github/stars/DCKT/electron-calculator) ![GitHub last commit](https://img.shields.io/github/last-commit/DCKT/electron-calculator)](https://github.com/DCKT/electron-calculator) - Basic, cross-platform calculator made with Electron.
- [elcalc ![GitHub Repo stars](https://img.shields.io/github/stars/xxczaki/elcalc) ![GitHub last commit](https://img.shields.io/github/last-commit/xxczaki/elcalc)](https://github.com/xxczaki/elcalc) - Calculator with simple & beautiful interface.
- [Material Design Calculator ![GitHub Repo stars](https://img.shields.io/github/stars/lirios/calculator) ![GitHub last commit](https://img.shields.io/github/last-commit/lirios/calculator)](https://github.com/lirios/calculator) - Cross-platform material design calculator.
...
- [mdlt ![GitHub Repo stars](https://img.shields.io/github/stars/metadelta/mdlt) ![GitHub last commit](https://img.shields.io/github/last-commit/metadelta/mdlt)](https://github.com/metadelta/mdlt) - Command-line utility for quick math.
- [calc ![GitHub Repo stars](https://img.shields.io/github/stars/alfredxing/calc) ![GitHub last commit](https://img.shields.io/github/last-commit/alfredxing/calc)](https://github.com/alfredxing/calc) - Simple, fast and intuitive command-line calculator written in Go.
- [J# Calculator Barebones ![GitHub Repo stars](https://img.shields.io/github/stars/KrzysztofSzewczyk/JSharpCalculator) ![GitHub last commit](https://img.shields.io/github/last-commit/KrzysztofSzewczyk/JSharpCalculator)](https://github.com/KrzysztofSzewczyk/JSharpCalculator) - Very simple calculator written in J#. Made as program for J# newcomers to extend and learn from.
