...
Apps ![GitHub Repo stars](https://img.shields.io/github/stars/herrbischoff/awesome-command-line-apps) ![GitHub last commit](https://img.shields.io/github/last-commit/herrbischoff/awesome-command-line-apps)](https://github.com/herrbischoff/awesome-command-line-apps).
...
[Reposado ![GitHub Repo stars](https://img.shields.io/github/stars/wdas/reposado) ![GitHub last commit](https://img.shields.io/github/last-commit/wdas/reposado)](https://github.com/wdas/reposado) together with correct network DNS
settings to make resolution transparent.
[Margarita ![GitHub Repo stars](https://img.shields.io/github/stars/jessepeterson/margarita) ![GitHub last commit](https://img.shields.io/github/last-commit/jessepeterson/margarita)](https://github.com/jessepeterson/margarita) looks nice to have as
well.
```sh
# Use own SUS
...
([Source ![GitHub Repo stars](https://img.shields.io/github/stars/tech-otaku/macos-defaults) ![GitHub last commit](https://img.shields.io/github/last-commit/tech-otaku/macos-defaults)](https://github.com/tech-otaku/macos-defaults/blob/master/date-time.sh))
...
- [Alacritty ![GitHub Repo stars](https://img.shields.io/github/stars/jwilm/alacritty) ![GitHub last commit](https://img.shields.io/github/last-commit/jwilm/alacritty)](https://github.com/jwilm/alacritty) - Cross-platform,
...
- [Bash-it ![GitHub Repo stars](https://img.shields.io/github/stars/Bash-it/bash-it) ![GitHub last commit](https://img.shields.io/github/last-commit/Bash-it/bash-it)](https://github.com/Bash-it/bash-it) - Community Bash framework,
...
- [The Fishshell Framework ![GitHub Repo stars](https://img.shields.io/github/stars/oh-my-fish/oh-my-fish) ![GitHub last commit](https://img.shields.io/github/last-commit/oh-my-fish/oh-my-fish)](https://github.com/oh-my-fish/oh-my-fish) -
  Provides core infrastructure to allow you to install packages which extend or
  modify the look of your shell.
- [Installation & Configuration
  Tutorial ![GitHub Repo stars](https://img.shields.io/github/stars/ellerbrock/fish-shell-setup-osx) ![GitHub last commit](https://img.shields.io/github/last-commit/ellerbrock/fish-shell-setup-osx)](https://github.com/ellerbrock/fish-shell-setup-osx) - How to Setup
...
- [Prezto ![GitHub Repo stars](https://img.shields.io/github/stars/sorin-ionescu/prezto) ![GitHub last commit](https://img.shields.io/github/last-commit/sorin-ionescu/prezto)](https://github.com/sorin-ionescu/prezto) - A speedy Zsh framework.
  Enriches the command line interface environment with sane defaults, aliases,
  functions, auto completion, and prompt themes.
- [zgen ![GitHub Repo stars](https://img.shields.io/github/stars/tarjoilija/zgen) ![GitHub last commit](https://img.shields.io/github/last-commit/tarjoilija/zgen)](https://github.com/tarjoilija/zgen) - Another open source framework
...
- [Codeface ![GitHub Repo stars](https://img.shields.io/github/stars/chrissimpkins/codeface) ![GitHub last commit](https://img.shields.io/github/last-commit/chrissimpkins/codeface)](https://github.com/chrissimpkins/codeface) - A gallery and
  repository of monospaced fonts for developers.
- [DejaVu Sans Mono](https://dejavu-fonts.github.io/) - A font family based on
  the Vera Fonts.
- [Fantasque Sans Mono ![GitHub Repo stars](https://img.shields.io/github/stars/belluzj/fantasque-sans) ![GitHub last commit](https://img.shields.io/github/last-commit/belluzj/fantasque-sans)](https://github.com/belluzj/fantasque-sans) - Designed
...
- [Meslo ![GitHub Repo stars](https://img.shields.io/github/stars/andreberg/Meslo-Font) ![GitHub last commit](https://img.shields.io/github/last-commit/andreberg/Meslo-Font)](https://github.com/andreberg/Meslo-Font) - Customized version of
  Apple's Menlo font.
...
- [Powerline Fonts ![GitHub Repo stars](https://img.shields.io/github/stars/powerline/fonts) ![GitHub last commit](https://img.shields.io/github/last-commit/powerline/fonts)](https://github.com/powerline/fonts) - Repo of patched fonts
