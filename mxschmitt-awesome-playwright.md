...
- [QA Wolf ![GitHub Repo stars](https://img.shields.io/github/stars/qawolf/qawolf) ![GitHub last commit](https://img.shields.io/github/last-commit/qawolf/qawolf)](https://github.com/qawolf/qawolf) - Create browser tests 10x faster.
...
- [playwright-amazon-linux-build ![GitHub Repo stars](https://img.shields.io/github/stars/help-14/playwright-amazon-linux-build) ![GitHub last commit](https://img.shields.io/github/last-commit/help-14/playwright-amazon-linux-build)](https://github.com/help-14/playwright-amazon-linux-build) - Browser build for Playwright to run on Amazon Linux 2.
...
- [pytest-playwright ![GitHub Repo stars](https://img.shields.io/github/stars/mxschmitt/pytest-playwright) ![GitHub last commit](https://img.shields.io/github/last-commit/mxschmitt/pytest-playwright)](https://github.com/mxschmitt/pytest-playwright/) - Pytest plugin for using Playwright pages with fixtures.
...
- [playwright-test ![GitHub Repo stars](https://img.shields.io/github/stars/microsoft/playwright-test) ![GitHub last commit](https://img.shields.io/github/last-commit/microsoft/playwright-test)](https://github.com/microsoft/playwright-test) - Official build a cross-browser end-to-end test suite with Playwright.
...
- [playwright-sharp ![GitHub Repo stars](https://img.shields.io/github/stars/microsoft/playwright-sharp) ![GitHub last commit](https://img.shields.io/github/last-commit/microsoft/playwright-sharp)](https://github.com/microsoft/playwright-sharp) - Official Playwright port to .NET with C#.
...
- [playwright-go ![GitHub Repo stars](https://img.shields.io/github/stars/mxschmitt/playwright-go) ![GitHub last commit](https://img.shields.io/github/last-commit/mxschmitt/playwright-go)](https://github.com/mxschmitt/playwright-go) - Playwright port for Golang.
...
- [playwright-video ![GitHub Repo stars](https://img.shields.io/github/stars/qawolf/playwright-video) ![GitHub last commit](https://img.shields.io/github/last-commit/qawolf/playwright-video)](https://github.com/qawolf/playwright-video) - Record your Chromium browser sessions.
...
- [expect-playwright ![GitHub Repo stars](https://img.shields.io/github/stars/playwright-community/expect-playwright) ![GitHub last commit](https://img.shields.io/github/last-commit/playwright-community/expect-playwright)](https://github.com/playwright-community/expect-playwright) - Utility functions for Jest to perform expect based checks.
- [eslint-plugin-jest-playwright ![GitHub Repo stars](https://img.shields.io/github/stars/playwright-community/eslint-plugin-jest-playwright) ![GitHub last commit](https://img.shields.io/github/last-commit/playwright-community/eslint-plugin-jest-playwright)](https://github.com/playwright-community/eslint-plugin-jest-playwright) - ESLint globals for the usage with Jest Playwright.
...
- [playwright-session ![GitHub Repo stars](https://img.shields.io/github/stars/domderen/playwright-session) ![GitHub last commit](https://img.shields.io/github/last-commit/domderen/playwright-session)](https://github.com/domderen/playwright-session) - Visual Debugger for Playwright automation.
- [Playwright CLI ![GitHub Repo stars](https://img.shields.io/github/stars/microsoft/playwright-cli) ![GitHub last commit](https://img.shields.io/github/last-commit/microsoft/playwright-cli)](https://github.com/microsoft/playwright-cli) - CLI for common Playwright actions. Record and generate Playwright code, inspect selectors and take screenshots.
...
- [playwright-demos ![GitHub Repo stars](https://img.shields.io/github/stars/nmanikiran/playwright-demos) ![GitHub last commit](https://img.shields.io/github/last-commit/nmanikiran/playwright-demos)](https://github.com/nmanikiran/playwright-demos) - Playwright demos for scrapping and UI testing / automate testing workflows.
