# awesome-c [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ![GitHub Repo stars](https://img.shields.io/github/stars/sindresorhus/awesome?style=social)](https://github.com/sindresorhus/awesome)[![List Status](https://api.travis-ci.org/aleksandar-todorovic/awesome-c.svg?branch=master)](https://travis-ci.org/aleksandar-todorovic/awesome-c)
...
* [Premake ![GitHub Repo stars](https://img.shields.io/github/stars/premake/premake-core?style=social)](https://github.com/premake/premake-core) - Build script generator for toolsets like Visual Studio, Xcode, or GNU Make. [`3-clause BSD`](https://directory.fsf.org/wiki/License:BSD-3-Clause)
...
* [Ninja ![GitHub Repo stars](https://img.shields.io/github/stars/ninja-build/ninja?style=social)](https://github.com/ninja-build/ninja) - Small, simple build system with a focus on speed. [`Apache 2.0`](https://directory.fsf.org/wiki/License:Apache-2.0)
...
* [qmake](https://doc.qt.io/qt-5/qmake-manual.html) - Build system included with the Qt Framework. [`GNU GPL3 with Qt Exception` ![GitHub Repo stars](https://img.shields.io/github/stars/qt/qtbase?style=social)](https://github.com/qt/qtbase/blob/5.11/LICENSE.GPL3-EXCEPT)
* [xmake](https://xmake.io/) - Cross-platform build utility based on lua. [`Apache 2.0` ![GitHub Repo stars](https://img.shields.io/github/stars/xmake-io/xmake?style=social)](https://github.com/xmake-io/xmake/blob/master/LICENSE.md )
...
* [Intel SPMD](http://ispc.github.io/) - Compiler for a variant of the C language, for single program, multiple data programming. [`Various licenses` ![GitHub Repo stars](https://img.shields.io/github/stars/ispc/ispc?style=social)](https://github.com/ispc/ispc/blob/master/LICENSE.txt)
...
* [snappy ![GitHub Repo stars](https://img.shields.io/github/stars/google/snappy?style=social)](https://github.com/google/snappy) - Fast compression library (implementation in C++, native bindings to C).
...
* [brotli ![GitHub Repo stars](https://img.shields.io/github/stars/google/brotli?style=social)](https://github.com/google/brotli) - Generic lossless compression algorithm based on LZ77, Huffman coding and 2nd order context modelling [`MIT`](https://raw.githubusercontent.com/atom/atom/master/LICENSE.md)
...
* [pixz ![GitHub Repo stars](https://img.shields.io/github/stars/vasi/pixz?style=social)](https://github.com/vasi/pixz) - Pixz (pronounced pixie) is a parallel, indexing version of `xz`. [`2-clause BSD`](https://directory.fsf.org/wiki/License:BSD-2-Clause)
...
* [Hiredis ![GitHub Repo stars](https://img.shields.io/github/stars/redis/hiredis?style=social)](https://github.com/redis/hiredis) - Minimalistic client library for Redis. [`3-clause BSD`](https://directory.fsf.org/wiki/License:BSD-3-Clause)
* [LMDB ![GitHub Repo stars](https://img.shields.io/github/stars/LMDB/lmdb?style=social)](https://github.com/LMDB/lmdb) - Ultra-fast, ultra-compact key-value embedded data store. [`OpenLDAP License`](https://directory.fsf.org/wiki/License:OLDAP-2.7)
...
* [Amazon FreeRTOS](https://aws.amazon.com/freertos/) - RTOS for microcontrollers that makes small, low-power edge devices easy to program. [`MIT` ![GitHub Repo stars](https://img.shields.io/github/stars/aws/amazon-freertos?style=social)](https://github.com/aws/amazon-freertos/blob/master/LICENSE)
...
* [Contiki](http://www.contiki-os.org/) - Connect low-cost, low power microcontrollers to the Internet. [`3-clause BSD` ![GitHub Repo stars](https://img.shields.io/github/stars/contiki-os/contiki?style=social)](https://github.com/contiki-os/contiki/blob/master/LICENSE)
...
* [C Macro Collections ![GitHub Repo stars](https://img.shields.io/github/stars/LeoVen/C-Macro-Collections?style=social)](https://github.com/LeoVen/C-Macro-Collections) - Header only, macro generated, generic and type-safe Collections in C. [`MIT`](https://spdx.org/licenses/MIT.html)
...
* [libnih ![GitHub Repo stars](https://img.shields.io/github/stars/keybuk/libnih?style=social)](https://github.com/keybuk/libnih) - Lightweight library of C functions and structures. [`GNU GPL2.1`](http://www.gnu.org/licenses/old-licenses/gpl-2.0.html)
...
* [qlibc](http://wolkykim.github.io/qlibc/) - Simple and powerful C library, designed as a replacement for GLib while focusing on being small and light. [`qLib license` ![GitHub Repo stars](https://img.shields.io/github/stars/wolkykim/qlibc?style=social)](https://github.com/wolkykim/qlibc/blob/master/LICENSE) (similar to [`FreeBSD`](https://directory.fsf.org/wiki?title=License:FreeBSD))
* [stb ![GitHub Repo stars](https://img.shields.io/github/stars/nothings/stb?style=social)](https://github.com/nothings/stb) - Range of single-file libraries for C. [`Public Domain`](https://creativecommons.org/share-your-work/public-domain/)
...
* [Corange ![GitHub Repo stars](https://img.shields.io/github/stars/orangeduck/Corange?style=social)](https://github.com/orangeduck/Corange) - Game engine in pure C. [`FreeBSD`](https://directory.fsf.org/wiki?title=License:FreeBSD)
...
* [Quake ![GitHub Repo stars](https://img.shields.io/github/stars/id-Software/Quake?style=social)](https://github.com/id-Software/Quake) - The Quake engine. [`GNU GPL2.1`](http://www.gnu.org/licenses/old-licenses/gpl-2.0.html)
* [Quake2 ![GitHub Repo stars](https://img.shields.io/github/stars/id-Software/Quake-2?style=social)](https://github.com/id-Software/Quake-2) - The Quake2 engine. [`GNU GPL2.1`](http://www.gnu.org/licenses/old-licenses/gpl-2.0.html)
...
* [Cogl ![GitHub Repo stars](https://img.shields.io/github/stars/rib/cogl-web?style=social)](https://github.com/rib/cogl-web/wiki) - GPU graphics and utilities API. [`Expat`](https://directory.fsf.org/wiki/License:Expat)
...
* [heman ![GitHub Repo stars](https://img.shields.io/github/stars/prideout/heman?style=social)](https://github.com/prideout/heman) - Tiny library of image utilities dealing with height maps, normal maps, distance fields and the like. [`Expat`](https://directory.fsf.org/wiki/License:Expat)
* [libcaca ![GitHub Repo stars](https://img.shields.io/github/stars/cacalabs/libcaca?style=social)](https://github.com/cacalabs/libcaca) - ASCII renderer for terminal-based interfaces. [`WTFPLv2`](http://www.wtfpl.net/txt/copying/)
...
* [mozjpeg ![GitHub Repo stars](https://img.shields.io/github/stars/mozilla/mozjpeg?style=social)](https://github.com/mozilla/mozjpeg) - Improved JPEG encoder. [`3-clause BSD`](https://directory.fsf.org/wiki/License:BSD-3-Clause)

### Graphic APIs ###

* [OpenGL](https://www.opengl.org/) - Industry adopted 2D and 3D graphics API. More resources at [awesome-opengl ![GitHub Repo stars](https://img.shields.io/github/stars/eug/awesome-opengl?style=social)](https://github.com/eug/awesome-opengl).
...
* [Vulkan](https://www.khronos.org/vulkan/) - Explicit graphic and compute API for modern cross-platform development. More resources at [awesome-vulkan ![GitHub Repo stars](https://img.shields.io/github/stars/vinjn/awesome-vulkan?style=social)](https://github.com/vinjn/awesome-vulkan).
...
* [nuklear ![GitHub Repo stars](https://img.shields.io/github/stars/vurtun/nuklear?style=social)](https://github.com/vurtun/nuklear) - Single-header ANSI C gui library. [`Public Domain`](https://creativecommons.org/share-your-work/public-domain/)
* [libui ![GitHub Repo stars](https://img.shields.io/github/stars/andlabs/libui?style=social)](https://github.com/andlabs/libui) - Simple and portable (but not inflexible) GUI library. [`MIT` ![GitHub Repo stars](https://img.shields.io/github/stars/andlabs/libui?style=social)](https://github.com/andlabs/libui/blob/master/LICENSE)
* [LCUI ![GitHub Repo stars](https://img.shields.io/github/stars/lc-soft/LCUI?style=social)](https://github.com/lc-soft/LCUI/) - Small C library for building user interfaces with C, XML and CSS. [`MIT` ![GitHub Repo stars](https://img.shields.io/github/stars/lc-soft/LCUI?style=social)](https://github.com/lc-soft/LCUI/blob/develop/LICENSE.TXT)

## Hashing ##

All hashing related libraries, cryptographic or not.

* [jwHash ![GitHub Repo stars](https://img.shields.io/github/stars/watmough/jwHash?style=social)](https://github.com/watmough/jwHash) - Fast hashtable implementation. [`Apache 2.0`](https://directory.fsf.org/wiki/License:Apache-2.0)
...
* [libcrc ![GitHub Repo stars](https://img.shields.io/github/stars/PeterScott/murmur3?style=social)](https://github.com/PeterScott/murmur3) - Multi platform CRC library. [`MIT`](https://raw.githubusercontent.com/atom/atom/master/LICENSE.md)
* [murmur ![GitHub Repo stars](https://img.shields.io/github/stars/ispc/ispc?style=social)](https://github.com/ispc/ispc) - C implementation of MurMur Hashing. [`Public Domain`](https://creativecommons.org/share-your-work/public-domain/)
* [t1ha ![GitHub Repo stars](https://img.shields.io/github/stars/leo-yuriev/t1ha?style=social)](https://github.com/leo-yuriev/t1ha) - Fast Positive Hash library. [`zlib`](https://directory.fsf.org/wiki/License:Zlib)
...
* [json-c ![GitHub Repo stars](https://img.shields.io/github/stars/json-c/json-c?style=social)](https://github.com/json-c/json-c/wiki) - Library for working with JSON. [`Expat`](https://directory.fsf.org/wiki/License:Expat)
* [parson ![GitHub Repo stars](https://img.shields.io/github/stars/kgabis/parson?style=social)](https://github.com/kgabis/parson) - Lightweight JSON library written in C. [`MIT`](https://raw.githubusercontent.com/atom/atom/master/LICENSE.md)
* [WJElement ![GitHub Repo stars](https://img.shields.io/github/stars/netmail-open/wjelement?style=social)](https://github.com/netmail-open/wjelement/wiki) - Advanced JSON manipulation library, with support for JSON Schema. [`LGPL, any version` ![GitHub Repo stars](https://img.shields.io/github/stars/netmail-open/wjelement?style=social)](https://github.com/netmail-open/wjelement/)
...
* [rpmalloc ![GitHub Repo stars](https://img.shields.io/github/stars/rampantpixels/rpmalloc?style=social)](https://github.com/rampantpixels/rpmalloc) - Cross platform, lock-free memory allocator. [`Public Domain`](https://creativecommons.org/share-your-work/public-domain/)
...
* [GnuTLS](https://www.gnutls.org/) - Secure communication library, implementing SSL, TLS and DTLS. [`GNU LGPL2.1 or later`](http://www.gnu.org/licenses/old-licenses/lgpl-2.1.html)
* [gumbo-parser ![GitHub Repo stars](https://img.shields.io/github/stars/google/gumbo-parser?style=social)](https://github.com/google/gumbo-parser) - HTML5 parsing library in C99. [`Apache 2.0`](https://directory.fsf.org/wiki/License:Apache-2.0)
* [http-parser ![GitHub Repo stars](https://img.shields.io/github/stars/nodejs/http-parser?style=social)](https://github.com/nodejs/http-parser) - HTTP request/response parser. [`Expat`](https://directory.fsf.org/wiki/License:Expat)
...
* [libvldmail ![GitHub Repo stars](https://img.shields.io/github/stars/dertuxmalwieder/libvldmail?style=social)](https://github.com/dertuxmalwieder/libvldmail) - Your friendly e-mail address validation library. [`WTFPLv2`](http://www.wtfpl.net/txt/copying/)
...
* [MQTT-C ![GitHub Repo stars](https://img.shields.io/github/stars/LiamBindle/MQTT-C?style=social)](https://github.com/LiamBindle/MQTT-C) - Portable MQTT C client for embedded systems and PCs alike. [`MIT`](https://raw.githubusercontent.com/LiamBindle/MQTT-C/master/LICENSE)
* [nanomsg ![GitHub Repo stars](https://img.shields.io/github/stars/nanomsg/nanomsg?style=social)](https://github.com/nanomsg/nanomsg) - C-based implementation of ZeroMQ. [`Expat`](https://directory.fsf.org/wiki/License:Expat)
* [OpenSSL](https://www.openssl.org/) - Implementation of the SSL and TLS protocols, and also includes a cryptography library. [`Dual Licensed under the OpenSSL License and the SSLeay License`](https://www.openssl.org/source/license.html)
...
* [pig ![GitHub Repo stars](https://img.shields.io/github/stars/rafael-santiago/pig?style=social)](https://github.com/rafael-santiago/pig) - Linux packet crafting tool. [`GPL2`](http://www.gnu.org/licenses/old-licenses/gpl-2.0.html)
* [s2n ![GitHub Repo stars](https://img.shields.io/github/stars/awslabs/s2n?style=social)](https://github.com/awslabs/s2n) - C99 implementation of the TLS/SSL protocols, designed to be simple, fast and with security as a priority. [`Apache 2.0`](https://directory.fsf.org/wiki/License:Apache-2.0)
* [socket99 ![GitHub Repo stars](https://img.shields.io/github/stars/silentbicycle/socket99?style=social)](https://github.com/silentbicycle/socket99) - C99 wrapper for the BSD sockets API. [`ISC`](https://directory.fsf.org/wiki/License:ISC)
* [Tox](https://tox.chat/) - Communication platform, designed to be a Skype-killer. [`GNU GPL3`](http://www.gnu.org/licenses/gpl-3.0.html)
* [twitc ![GitHub Repo stars](https://img.shields.io/github/stars/sinemetu1/twitc?style=social)](https://github.com/sinemetu1/twitc) - Mini C library for interacting with the Twitter OAuth API. [`Expat`](https://directory.fsf.org/wiki/License:Expat)
* [librg ![GitHub Repo stars](https://img.shields.io/github/stars/librg/librg?style=social)](https://github.com/librg/librg) - Library for building simple and elegant cross-platform mmo client-server solutions. [`Apache 2.0`](https://directory.fsf.org/wiki/License:Apache-2.0)
* [dyad ![GitHub Repo stars](https://img.shields.io/github/stars/rxi/dyad?style=social)](https://github.com/rxi/dyad) - Asynchronous networking library. [`MIT`](https://raw.githubusercontent.com/atom/atom/master/LICENSE.md)
* [h2o ![GitHub Repo stars](https://img.shields.io/github/stars/h2o/h2o?style=social)](https://github.com/h2o/h2o/) - Optimized HTTP/1, HTTP/2 high performance server/library. [`MIT`](https://raw.githubusercontent.com/atom/atom/master/LICENSE.md)
...
* [OpenMPI ![GitHub Repo stars](https://img.shields.io/github/stars/open-mpi/ompi?style=social)](https://github.com/open-mpi/ompi) - Message passing interface implementation. [`3-clause BSD`](https://directory.fsf.org/wiki/License:BSD-3-Clause)
...
* [hammer ![GitHub Repo stars](https://img.shields.io/github/stars/abiggerhammer/hammer?style=social)](https://github.com/abiggerhammer/hammer) - Parser combinators for binary formats. [`GNU GPL2.1`](http://www.gnu.org/licenses/old-licenses/gpl-2.0.html)
* [iniparser ![GitHub Repo stars](https://img.shields.io/github/stars/ndevilla/iniparser?style=social)](https://github.com/ndevilla/iniparser) - Parser for `.ini` files. [`Expat`](https://directory.fsf.org/wiki/License:Expat)
* [libconfini ![GitHub Repo stars](https://img.shields.io/github/stars/madmurphy/libconfini?style=social)](https://github.com/madmurphy/libconfini) - Yet another INI parser. [`GNU GPL3 or later`](http://www.gnu.org/licenses/gpl-3.0.html)
* [libYAML](https://pyyaml.org/wiki/LibYAML) - YAML 1.1 parser and emitter. [`Expat`](https://directory.fsf.org/wiki/License:Expat)
* [mpc ![GitHub Repo stars](https://img.shields.io/github/stars/orangeduck/mpc?style=social)](https://github.com/orangeduck/mpc) - Parser combinator library. [`FreeBSD`](https://directory.fsf.org/wiki?title=License:FreeBSD)
* [libucl ![GitHub Repo stars](https://img.shields.io/github/stars/vstakhov/libucl?style=social)](https://github.com/vstakhov/libucl) - Universal configuration library parser. [`FreeBSD`](https://directory.fsf.org/wiki?title=License:FreeBSD)
...
* [regexp4 ![GitHub Repo stars](https://img.shields.io/github/stars/nasciiboy/recursiveregexpraptor-4?style=social)](https://github.com/nasciiboy/recursiveregexpraptor-4) - Simple and complete implementation of regular expressions with its own sintax. [`GNU GPL3 or later`](http://www.gnu.org/licenses/gpl-3.0.html)
* [SLRE ![GitHub Repo stars](https://img.shields.io/github/stars/cesanta/slre?style=social)](https://github.com/cesanta/slre) - Super Light Regular Expression library; a very small implementation of a subset of Perl regex syntax. [`GNU GPL2.1`](http://www.gnu.org/licenses/old-licenses/gpl-2.0.html)
* [sregex ![GitHub Repo stars](https://img.shields.io/github/stars/openresty/sregex?style=social)](https://github.com/openresty/sregex) - Non-backtracking NFA/DFA-based Perl-compatible regex engine library. [`3-clause BSD`](https://opensource.org/licenses/BSD-3-Clause)
* [TRE ![GitHub Repo stars](https://img.shields.io/github/stars/laurikari/tre?style=social)](https://github.com/laurikari/tre/) - POSIX-compliant, feature-full regex library. [`FreeBSD`](https://directory.fsf.org/wiki?title=License:FreeBSD)

## Serialization ##

* [binn ![GitHub Repo stars](https://img.shields.io/github/stars/liteserver/binn?style=social)](https://github.com/liteserver/binn) - Binary serialization format meant to be compact, fast and easy-to-use. [`Apache 2.0`](https://directory.fsf.org/wiki/License:Apache-2.0)
* [c-capnproto ![GitHub Repo stars](https://img.shields.io/github/stars/jmckaskill/c-capnproto?style=social)](https://github.com/jmckaskill/c-capnproto) - Implementation of the Cap'n Proto serialization protocol. [`Expat`](https://directory.fsf.org/wiki/License:Expat)
* [cmp ![GitHub Repo stars](https://img.shields.io/github/stars/camgunz/cmp?style=social)](https://github.com/camgunz/cmp) - Implementation of the [MessagePack](https://msgpack.org/) serialization protocol. [`Expat`](https://directory.fsf.org/wiki/License:Expat)
...
* [mpack ![GitHub Repo stars](https://img.shields.io/github/stars/ludocode/mpack?style=social)](https://github.com/ludocode/mpack) - Another implementation of the [MessagePack](https://msgpack.org/) serialization protocol. [`Expat`](https://directory.fsf.org/wiki/License:Expat)
* [netstring-c ![GitHub Repo stars](https://img.shields.io/github/stars/liteserver/netstring-c?style=social)](https://github.com/liteserver/netstring-c) - Netstring encoder and decoder. [`Public Domain`](https://creativecommons.org/share-your-work/public-domain/)
* [protobuf-c ![GitHub Repo stars](https://img.shields.io/github/stars/protobuf-c/protobuf-c?style=social)](https://github.com/protobuf-c/protobuf-c) - Implementation of Google Protocol Buffer in C. [`FreeBSD`](https://directory.fsf.org/wiki?title=License:FreeBSD)
...
* [Bionic ![GitHub Repo stars](https://img.shields.io/github/stars/aosp-mirror/platform_bionic?style=social)](https://github.com/aosp-mirror/platform_bionic) - Google's C standard library, developed for Android. [`3-clause BSD`](https://directory.fsf.org/wiki/License:BSD-3-Clause)
...
* [SDS ![GitHub Repo stars](https://img.shields.io/github/stars/antirez/sds?style=social)](https://github.com/antirez/sds) - Simple Dynamic Strings; a library for handling C strings in a simpler way, but one that is compatible with normal C string functions. Available via [clib ![GitHub Repo stars](https://img.shields.io/github/stars/clibs/clib?style=social)](https://github.com/clibs/clib). [`FreeBSD`](https://directory.fsf.org/wiki?title=License:FreeBSD)
...
* [smaz ![GitHub Repo stars](https://img.shields.io/github/stars/antirez/smaz?style=social)](https://github.com/antirez/smaz) - Efficient string compression library. [`3-clause BSD`](https://directory.fsf.org/wiki/License:BSD-3-Clause)
* [utf8.h ![GitHub Repo stars](https://img.shields.io/github/stars/sheredom/utf8.h?style=social)](https://github.com/sheredom/utf8.h) - Single header utf8 string functions. [`Unlicense`](https://unlicense.org/)
* [utf8proc ![GitHub Repo stars](https://img.shields.io/github/stars/JuliaStrings/utf8proc?style=social)](https://github.com/JuliaStrings/utf8proc) - Small, clean library for processing UTF-8 Unicode data. [`License` ![GitHub Repo stars](https://img.shields.io/github/stars/JuliaStrings/utf8proc?style=social)](https://github.com/JuliaStrings/utf8proc/blob/master/LICENSE.md)
...
* [Cutest ![GitHub Repo stars](https://img.shields.io/github/stars/rafael-santiago/cutest?style=social)](https://github.com/rafael-santiago/cutest) - Library for unit testing with memory leak detection (Linux, freeBSD and Windows). [`GPL2`](http://www.gnu.org/licenses/old-licenses/gpl-2.0.html)
* [minunit ![GitHub Repo stars](https://img.shields.io/github/stars/siu/minunit?style=social)](https://github.com/siu/minunit) - Minimal unit testing framework for C. [`Expat`](https://directory.fsf.org/wiki/License:Expat)
...
### Atom ###
* [linter-clang ![GitHub Repo stars](https://img.shields.io/github/stars/AtomLinter/linter-clang?style=social)](https://github.com/AtomLinter/linter-clang) - Lint C code in Atom, using Clang. [`MIT`](https://raw.githubusercontent.com/atom/atom/master/LICENSE.md)
* [linter-gcc ![GitHub Repo stars](https://img.shields.io/github/stars/hebaishi/linter-gcc?style=social)](https://github.com/hebaishi/linter-gcc) - Lint C code in Atom, using GCC. [`MIT`](https://raw.githubusercontent.com/atom/atom/master/LICENSE.md)
...
* [Flycheck ![GitHub Repo stars](https://img.shields.io/github/stars/flycheck/flycheck?style=social)](https://github.com/flycheck/flycheck) - Modern syntax checking. For C, it can use either GCC or Clang as a back-end. [`GNU GPL3 or later`](http://www.gnu.org/licenses/gpl-3.0.html)
* [Yasnippet ![GitHub Repo stars](https://img.shields.io/github/stars/joaotavora/yasnippet?style=social)](https://github.com/joaotavora/yasnippet) - Template system, with C templates for common code snippets. [`GNU GPL3 or later`](http://www.gnu.org/licenses/gpl-3.0.html)

### Vim ###

* [Syntastic ![GitHub Repo stars](https://img.shields.io/github/stars/vim-syntastic/syntastic?style=social)](https://github.com/vim-syntastic/syntastic) - Syntax checking and linting. [`Do What The Fuck You Want To license` ![GitHub Repo stars](https://img.shields.io/github/stars/vim-syntastic/syntastic?style=social)](https://github.com/vim-syntastic/syntastic/blob/master/LICENCE)
...
* [address-sanitizer ![GitHub Repo stars](https://img.shields.io/github/stars/google/sanitizers?style=social)](https://github.com/google/sanitizers) - Fast memory error detector. [`Apache 2.0`](https://directory.fsf.org/wiki/License:Apache-2.0)
* [biicode](https://biicode.github.io/biicode/) - Modern dependency manager for C. [`Expat`](https://directory.fsf.org/wiki/License:Expat)
* [c ![GitHub Repo stars](https://img.shields.io/github/stars/ryanmjacobs/c?style=social)](https://github.com/ryanmjacobs/c) - Compile and execute C "scripts" in one go on the command line. Also has shebang support. [`Expat`](https://directory.fsf.org/wiki/License:Expat)
* [c99sh ![GitHub Repo stars](https://img.shields.io/github/stars/RhysU/c99sh?style=social)](https://github.com/RhysU/c99sh) - Run C files using hash-bang. [`FreeBSD`](https://directory.fsf.org/wiki?title=License:FreeBSD)
...
* [ApeTagLibs ![GitHub Repo stars](https://img.shields.io/github/stars/jeremyevans/ape_tag_libs?style=social)](https://github.com/jeremyevans/ape_tag_libs/tree/master/c) - C library for working with APEv2 tags. [`Expat`](https://directory.fsf.org/wiki/License:Expat)
...
* [CommonMark ![GitHub Repo stars](https://img.shields.io/github/stars/commonmark/commonmark-spec?style=social)](https://github.com/commonmark/commonmark-spec) - C implementation of the CommonMark spec. [`Various Licenses` ![GitHub Repo stars](https://img.shields.io/github/stars/commonmark/commonmark-spec?style=social)](https://github.com/commonmark/commonmark-spec/blob/master/LICENSE)
* [CException ![GitHub Repo stars](https://img.shields.io/github/stars/ThrowTheSwitch/CException?style=social)](https://github.com/ThrowTheSwitch/CException) - C implementation of exceptions. [`Expat`](https://directory.fsf.org/wiki/License:Expat)
* [docopt.c ![GitHub Repo stars](https://img.shields.io/github/stars/docopt/docopt.c?style=social)](https://github.com/docopt/docopt.c) - C implementation of a command-line option parser. [`Expat`](https://directory.fsf.org/wiki/License:Expat)
...
* [Genann ![GitHub Repo stars](https://img.shields.io/github/stars/codeplea/genann?style=social)](https://github.com/codeplea/genann) - Simple neural network library in C. [`Zlib`](https://directory.fsf.org/wiki/License:Zlib)
...
* [gperftools ![GitHub Repo stars](https://img.shields.io/github/stars/gperftools/gperftools?style=social)](https://github.com/gperftools/gperftools) - Collection of utilities for measuring and improving performance. [`3-clause BSD`](https://directory.fsf.org/wiki/License:BSD-3-Clause)
* [huffandpuff ![GitHub Repo stars](https://img.shields.io/github/stars/adamierymenko/huffandpuff?style=social)](https://github.com/adamierymenko/huffandpuff) - Minimal Huffman encoder and decoder. [`Public Domain`](https://creativecommons.org/share-your-work/public-domain/)
* [kdtree ![GitHub Repo stars](https://img.shields.io/github/stars/jtsiomb/kdtree?style=social)](https://github.com/jtsiomb/kdtree) - Simple library for working with KD-trees. [`3-clause BSD`](https://directory.fsf.org/wiki/License:BSD-3-Clause)
...
* [libbson ![GitHub Repo stars](https://img.shields.io/github/stars/mongodb/libbson?style=social)](https://github.com/mongodb/libbson) - BSON utility library. [`Apache 2.0`](https://directory.fsf.org/wiki/License:Apache-2.0)
...
* [libffi ![GitHub Repo stars](https://img.shields.io/github/stars/libffi/libffi?style=social)](https://github.com/libffi/libffi) - Portable foreign-function interface library. [`Expat`](https://directory.fsf.org/wiki/License:Expat)
* [libgit2](https://libgit2.org/) - Pure C implementation of Git. [`GNU GPL2 only, with a linking exception` ![GitHub Repo stars](https://img.shields.io/github/stars/libgit2/libgit2?style=social)](https://github.com/libgit2/libgit2/blob/master/COPYING)
* [libimobiledevice ![GitHub Repo stars](https://img.shields.io/github/stars/libimobiledevice/libimobiledevice?style=social)](https://github.com/libimobiledevice/libimobiledevice) - Cross-platform protocol library to communicate with iThings. [`GNU LGPLv2.1 or later (library)`](http://www.gnu.org/licenses/old-licenses/lgpl-2.1.html) or [`GNU GPL2.1 or later (tools)`](http://www.gnu.org/licenses/old-licenses/gpl-2.0.html)
* [libnfc ![GitHub Repo stars](https://img.shields.io/github/stars/nfc-tools/libnfc?style=social)](https://github.com/nfc-tools/libnfc) - Platform-independent Near-Field Communication library. [`GNU LGPL3`](http://www.gnu.org/licenses/lgpl-3.0.html)
* [libPhenom ![GitHub Repo stars](https://img.shields.io/github/stars/facebookarchive/libphenom?style=social)](https://github.com/facebookarchive/libphenom) - Deprecated, here for archival purposes. Eventing framework for building high-scalability and high-performance systems. [`Apache 2.0`](https://directory.fsf.org/wiki/License:Apache-2.0)
...
* [nope.c ![GitHub Repo stars](https://img.shields.io/github/stars/riolet/WAFer?style=social)](https://github.com/riolet/WAFer) - C-language-based, ultra-light software platform for scalable server-side and networking applications (think node.js for C programmers). [`GNU GPL2.1`](http://www.gnu.org/licenses/old-licenses/gpl-2.0.html)
* [pbc ![GitHub Repo stars](https://img.shields.io/github/stars/cloudwu/pbc?style=social)](https://github.com/cloudwu/pbc) - Protocol buffers library. [`Expat`](https://directory.fsf.org/wiki/License:Expat)
* [rabbitmq-c ![GitHub Repo stars](https://img.shields.io/github/stars/alanxz/rabbitmq-c?style=social)](https://github.com/alanxz/rabbitmq-c) - Client library for [RabbitMQ](https://www.rabbitmq.com/). [`Expat`](https://directory.fsf.org/wiki/License:Expat)
...
* [Tinyexpr ![GitHub Repo stars](https://img.shields.io/github/stars/codeplea/tinyexpr?style=social)](https://github.com/codeplea/tinyexpr) - Tiny recursive-descent parser, compiler and evaluation engine for simple mathematical expressions. [`zlib`](https://directory.fsf.org/wiki/License:Zlib)
...
* [cpu_features ![GitHub Repo stars](https://img.shields.io/github/stars/google/cpu_features?style=social)](https://github.com/google/cpu_features) - A cross platform C99 library to get cpu features at runtime. [`Apache 2.0`](https://directory.fsf.org/wiki/License:Apache-2.0)
* [pblog ![GitHub Repo stars](https://img.shields.io/github/stars/google/pblog?style=social)](https://github.com/google/pblog) - Small, low overhead, structured logging library intended for logging formware events.[`Apache 2.0`](https://directory.fsf.org/wiki/License:Apache-2.0)
* [libelf ![GitHub Repo stars](https://img.shields.io/github/stars/WolfgangSt/libelf?style=social)](https://github.com/WolfgangSt/libelf) - ELF object file access library in C. [`GNU GPL2.1`](http://www.gnu.org/licenses/old-licenses/gpl-2.0.html)
* [mcpp](http://mcpp.sourceforge.net/) - Portable C preprocessor. [`2-clause BSD`](https://opensource.org/licenses/BSD-2-Clause)
* [libusb](https://libusb.info/) - Generic access to USB devices. [`LGPL2.1` ![GitHub Repo stars](https://img.shields.io/github/stars/libusb/libusb?style=social)](https://github.com/libusb/libusb/blob/master/COPYING)
...
* [Capstone ![GitHub Repo stars](https://img.shields.io/github/stars/aquynh/capstone?style=social)](https://github.com/aquynh/capstone) - Dissasembly/disassembler framework. [`BSD 3-clause` ![GitHub Repo stars](https://img.shields.io/github/stars/aquynh/capstone?style=social)](https://github.com/aquynh/capstone/blob/master/LICENSE.TXT)
...
* [mini-xml ![GitHub Repo stars](https://img.shields.io/github/stars/michaelrsweet/mxml?style=social)](https://github.com/michaelrsweet/mxml) - Small XML reading and writing library. No dependencies aside from C standard library. [`Apache 2.0 with exceptions` ![GitHub Repo stars](https://img.shields.io/github/stars/michaelrsweet/mxml?style=social)](https://github.com/michaelrsweet/mxml/blob/master/LICENSE)
