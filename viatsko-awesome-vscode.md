...
> Have a look at the [README.md ![GitHub Repo stars](https://img.shields.io/github/stars/KnisterPeter/vscode-github) ![GitHub last commit](https://img.shields.io/github/last-commit/KnisterPeter/vscode-github)](https://github.com/KnisterPeter/vscode-github/blob/master/README.md) on how to get started with the setup for this extension.
...
- [vscode-extension-vscode ![GitHub Repo stars](https://img.shields.io/github/stars/Microsoft/vscode-extension-vscode) ![GitHub last commit](https://img.shields.io/github/last-commit/Microsoft/vscode-extension-vscode)](https://github.com/Microsoft/vscode-extension-vscode) - The vscode.d.ts node module
- [vscode-set-text ![GitHub Repo stars](https://img.shields.io/github/stars/samverschueren/vscode-set-text) ![GitHub last commit](https://img.shields.io/github/last-commit/samverschueren/vscode-set-text)](https://github.com/samverschueren/vscode-set-text) - An easy-to-use VS Code `#setText()` method.
