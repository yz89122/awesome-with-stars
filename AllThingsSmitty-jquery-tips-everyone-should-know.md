...
**Note:** Watch for some [buggy behavior ![GitHub Repo stars](https://img.shields.io/github/stars/jquery/api.jquery.com) ![GitHub last commit](https://img.shields.io/github/last-commit/jquery/api.jquery.com)](https://github.com/jquery/api.jquery.com/issues/417) with `scrollTop`.
