...
* [devops_roadmap ![GitHub Repo stars](https://img.shields.io/github/stars/kamranahmedse/developer-roadmap) ![GitHub last commit](https://img.shields.io/github/last-commit/kamranahmedse/developer-roadmap)](https://github.com/kamranahmedse/developer-roadmap)  
...
* [SimpleCI ![GitHub Repo stars](https://img.shields.io/github/stars/simpleci/simpleci) ![GitHub last commit](https://img.shields.io/github/last-commit/simpleci/simpleci)](https://github.com/simpleci/simpleci) Docker-based self-hosted ci system. Supports distributed build cache, external providers (GCE), real-time build log, etc.  
* [pulse](http://zutubi.com) no free version.  
* [PHP Censor ![GitHub Repo stars](https://img.shields.io/github/stars/php-censor/php-censor) ![GitHub last commit](https://img.shields.io/github/last-commit/php-censor/php-censor)](https://github.com/php-censor/php-censor) Open source self-hosted continuous integration server for PHP projects.  
...
* [T.A.D.S. boilerplate ![GitHub Repo stars](https://img.shields.io/github/stars/Thomvaill/tads-boilerplate) ![GitHub last commit](https://img.shields.io/github/last-commit/Thomvaill/tads-boilerplate)](https://github.com/Thomvaill/tads-boilerplate) A boilerplate to setup a Docker Swarm environment with Ansible
* [vagrantup](https://www.vagrantup.com/)  Create and configure lightweight, reproducible, and portable development environments.  
* [veewee ![GitHub Repo stars](https://img.shields.io/github/stars/jedi4ever/veewee) ![GitHub last commit](https://img.shields.io/github/last-commit/jedi4ever/veewee)](https://github.com/jedi4ever/veewee) Easing the building of vagrant boxes  
...
* [do ![GitHub Repo stars](https://img.shields.io/github/stars/8gears/do) ![GitHub last commit](https://img.shields.io/github/last-commit/8gears/do)](https://github.com/8gears/do)  The simplest build tool on earth. Agnostic and multipurpose build tool and a build file. Tries to be better than the usual shell hell.
...
* [Macaca ![GitHub Repo stars](https://img.shields.io/github/stars/alibaba/macaca) ![GitHub last commit](https://img.shields.io/github/last-commit/alibaba/macaca)](https://github.com/alibaba/macaca) Automation test solution for native, hybrid, mobile web and web application on mobile and desktop platforms
...
* [fpm ![GitHub Repo stars](https://img.shields.io/github/stars/jordansissel/fpm) ![GitHub last commit](https://img.shields.io/github/last-commit/jordansissel/fpm)](https://github.com/jordansissel/fpm) Effing package management! Build packages for multiple platforms (deb, rpm, etc) with great ease and sanity.  
...
* [herd ![GitHub Repo stars](https://img.shields.io/github/stars/russss/Herd) ![GitHub last commit](https://img.shields.io/github/last-commit/russss/Herd)](https://github.com/russss/Herd) A single-command bittorrent distribution system, based on Twitter's Murder     
* [murder ![GitHub Repo stars](https://img.shields.io/github/stars/lg/murder) ![GitHub last commit](https://img.shields.io/github/last-commit/lg/murder)](https://github.com/lg/murder)  Large scale server deploys using BitTorrent and the BitTornado library from twitter.com  
...
* [awesome-shell ![GitHub Repo stars](https://img.shields.io/github/stars/itech001/awesome-shell) ![GitHub last commit](https://img.shields.io/github/last-commit/itech001/awesome-shell)](https://github.com/itech001/awesome-shell/blob/master/README.md)  
* [awesome-python ![GitHub Repo stars](https://img.shields.io/github/stars/vinta/awesome-python) ![GitHub last commit](https://img.shields.io/github/last-commit/vinta/awesome-python)](https://github.com/vinta/awesome-python)  
* [awesome-perl ![GitHub Repo stars](https://img.shields.io/github/stars/hachiojipm/awesome-perl) ![GitHub last commit](https://img.shields.io/github/last-commit/hachiojipm/awesome-perl)](https://github.com/hachiojipm/awesome-perl)  
...
* [awesome-awesome ![GitHub Repo stars](https://img.shields.io/github/stars/emijrp/awesome-awesome) ![GitHub last commit](https://img.shields.io/github/last-commit/emijrp/awesome-awesome)](https://github.com/emijrp/awesome-awesome)  
...
* [sysadmin ![GitHub Repo stars](https://img.shields.io/github/stars/itech001/awesome-sysadmin) ![GitHub last commit](https://img.shields.io/github/last-commit/itech001/awesome-sysadmin)](https://github.com/itech001/awesome-sysadmin)  
* [ci tools compare](https://en.wikipedia.org/wiki/Comparison_of_continuous_integration_software)  
* [ci tools compare2 ![GitHub Repo stars](https://img.shields.io/github/stars/ciandcd/Continuous-Integration-services) ![GitHub last commit](https://img.shields.io/github/last-commit/ciandcd/Continuous-Integration-services)](https://github.com/ciandcd/Continuous-Integration-services/blob/master/continuous-integration-services-list.md)
* [ci tools compare 3 ![GitHub Repo stars](https://img.shields.io/github/stars/ligurio/Continuous-Integration-services) ![GitHub last commit](https://img.shields.io/github/last-commit/ligurio/Continuous-Integration-services)](https://github.com/ligurio/Continuous-Integration-services)
* [awesome-docker ![GitHub Repo stars](https://img.shields.io/github/stars/veggiemonk/awesome-docker) ![GitHub last commit](https://img.shields.io/github/last-commit/veggiemonk/awesome-docker)](https://github.com/veggiemonk/awesome-docker)  
