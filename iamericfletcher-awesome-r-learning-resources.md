...
- [Awesome R Shiny ![GitHub Repo stars](https://img.shields.io/github/stars/grabear/awesome-rshiny) ![GitHub last commit](https://img.shields.io/github/last-commit/grabear/awesome-rshiny)](https://github.com/grabear/awesome-rshiny) - A curated list of resources for R Shiny. Author: Rob Gilmore.
...
- [Awesome ggplot2 ![GitHub Repo stars](https://img.shields.io/github/stars/erikgahner/awesome-ggplot2) ![GitHub last commit](https://img.shields.io/github/last-commit/erikgahner/awesome-ggplot2)](https://github.com/erikgahner/awesome-ggplot2) - A curated list of awesome ggplot2 tutorials, packages etc. Author: Erik Gahner Larsen.
...
- [r-color-palettes ![GitHub Repo stars](https://img.shields.io/github/stars/EmilHvitfeldt/r-color-palettes) ![GitHub last commit](https://img.shields.io/github/last-commit/EmilHvitfeldt/r-color-palettes)](https://github.com/EmilHvitfeldt/r-color-palettes) - Comprehensive list of color palettes available in r. Author: Emil Hvitfeldt.
...
- [Web Scraping Reference: Cheat Sheet for Web Scraping using R ![GitHub Repo stars](https://img.shields.io/github/stars/yusuzech/r-web-scraping-cheat-sheet) ![GitHub last commit](https://img.shields.io/github/last-commit/yusuzech/r-web-scraping-cheat-sheet)](https://github.com/yusuzech/r-web-scraping-cheat-sheet) - Guide, reference and cheatsheet on web scraping using rvest, httr and Rselenium. Author: [yifyan et al.](https://github.com/yusuzech)
...
- [TidyTuesday ![GitHub Repo stars](https://img.shields.io/github/stars/rfordatascience/tidytuesday) ![GitHub last commit](https://img.shields.io/github/last-commit/rfordatascience/tidytuesday)](https://github.com/rfordatascience/tidytuesday) - TidyTuesday is a weekly data project aimed at the R ecosystem with an emphasis placed on understanding how to summarize and arrange data to make meaningful charts.
...
## Contributing
- Your contributions are always welcome! Please visit our [contributing.md ![GitHub Repo stars](https://img.shields.io/github/stars/iamericfletcher/r-learning-resources) ![GitHub last commit](https://img.shields.io/github/last-commit/iamericfletcher/r-learning-resources)](https://github.com/iamericfletcher/r-learning-resources/blob/main/contributing.md) to learn how to contribute to this list.
