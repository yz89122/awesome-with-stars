...
- [hac ![GitHub Repo stars](https://img.shields.io/github/stars/zertovitch/hac) ![GitHub last commit](https://img.shields.io/github/last-commit/zertovitch/hac)](https://github.com/zertovitch/hac) - Experimental Ada compiler fully in Ada.
...
<img width="120px" hspace="10px" src="http://docs.adacore.com/live/wave/gps/html/gps_ug/_images/gps-main-window.png"> [The GNAT Programming Studio ![GitHub Repo stars](https://img.shields.io/github/stars/AdaCore/gps) ![GitHub last commit](https://img.shields.io/github/last-commit/AdaCore/gps)](https://github.com/AdaCore/gps)
...
#### Editors
- [lea ![GitHub Repo stars](https://img.shields.io/github/stars/zertovitch/lea) ![GitHub last commit](https://img.shields.io/github/last-commit/zertovitch/lea)](https://github.com/zertovitch/lea) - LEA, a Lightweight Editor for Ada, aims to provide an easy, script-world-like, "look & feel" for developing Ada projects of any size and level, while enabling access to full-scale development tools like GNAT.
...
- [terminal-apps ![GitHub Repo stars](https://img.shields.io/github/stars/fastrgv/TerminalApps) ![GitHub last commit](https://img.shields.io/github/last-commit/fastrgv/TerminalApps)](https://github.com/fastrgv/TerminalApps) - Fun puzzle games that run on any terminal on any OS.
...
- [mini-pacman ![GitHub Repo stars](https://img.shields.io/github/stars/fastrgv/MiniPacman) ![GitHub last commit](https://img.shields.io/github/last-commit/fastrgv/MiniPacman)](https://github.com/fastrgv/MiniPacman) - MiniPac is a kid friendly ascii character version of Pacman that plays in a commandline terminal.
...
- [protobuf-ada ![GitHub Repo stars](https://img.shields.io/github/stars/persan/protobuf-ada) ![GitHub last commit](https://img.shields.io/github/last-commit/persan/protobuf-ada)](https://github.com/persan/protobuf-ada) - Experimantal Ada code generation support for Google Protocol Buffers.
...
- [ada-synth-lib ![GitHub Repo stars](https://img.shields.io/github/stars/raph-amiard/ada-synth-lib) ![GitHub last commit](https://img.shields.io/github/last-commit/raph-amiard/ada-synth-lib)](https://github.com/raph-amiard/ada-synth-lib) - Simple audio synthesis library.
...
- [ada-portable-sound ![GitHub Repo stars](https://img.shields.io/github/stars/fastrgv/portable-linux-sound) ![GitHub last commit](https://img.shields.io/github/last-commit/fastrgv/portable-linux-sound)](https://github.com/fastrgv/portable-linux-sound) - a linux-sound-playing package for Ada apps that can asynchronously start and stop music loops, as well as initiate transient sounds.  Suitable for games.
...
- [ssprep ![GitHub Repo stars](https://img.shields.io/github/stars/persan/ssprep.git) ![GitHub last commit](https://img.shields.io/github/last-commit/persan/ssprep.git)](https://github.com/persan/ssprep.git) - An extensible template engine akin to jinja but using [template-parser ![GitHub Repo stars](https://img.shields.io/github/stars/AdaCore/templates-parser) ![GitHub last commit](https://img.shields.io/github/last-commit/AdaCore/templates-parser)](https://github.com/AdaCore/templates-parser) and intended for command line usage.
...
- [simple-logging ![GitHub Repo stars](https://img.shields.io/github/stars/mosteo/simple_logging) ![GitHub last commit](https://img.shields.io/github/last-commit/mosteo/simple_logging)](https://github.com/mosteo/simple_logging) - Easy to use logging facilities for output to console in Ada programs.
...
- [ada-net-framework-core ![GitHub Repo stars](https://img.shields.io/github/stars/Alex-Gamper/Ada-NetFrameworkCore) ![GitHub last commit](https://img.shields.io/github/last-commit/Alex-Gamper/Ada-NetFrameworkCore)](https://github.com/Alex-Gamper/Ada-NetFrameworkCore) - Ada bindings for the Microsft NetFramework Api.
...
#### Multimedia
- [eagle-lander ![GitHub Repo stars](https://img.shields.io/github/stars/Fabien-Chouteau/eagle-lander) ![GitHub last commit](https://img.shields.io/github/last-commit/Fabien-Chouteau/eagle-lander)](https://github.com/Fabien-Chouteau/eagle-lander) - Apollo 11 lunar lander simulator (Ada/Gtk/Cairo).
...
- [cvsweb2git ![GitHub Repo stars](https://img.shields.io/github/stars/reznikmm/cvsweb2git) ![GitHub last commit](https://img.shields.io/github/last-commit/reznikmm/cvsweb2git)](https://github.com/reznikmm/cvsweb2git) - This tool imports CVS repository shared on Ada Conformity Assessment Authority into the Git repository.
