...
* [Consfigurator ![GitHub Repo stars](https://img.shields.io/github/stars/spwhitton/consfigurator) ![GitHub last commit](https://img.shields.io/github/last-commit/spwhitton/consfigurator)](https://github.com/spwhitton/consfigurator) - Lisp declarative configuration management system.  You can use it to configure hosts as root, deploy services as unprivileged users, build and deploy containers, and produce disc images. [GPL3][2].
