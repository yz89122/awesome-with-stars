...
Want to add something? Just make a pull request, but be sure to follow the [contributing guidelines](./contributing.md)! Question? Ask it in the [General Discussion issue ![GitHub Repo Stars](https://img.shields.io/github/stars/stingalleman/awesome-audiovisual) ![GitHub last commit](https://img.shields.io/github/last-commit/stingalleman/awesome-audiovisual)](https://github.com/stingalleman/awesome-audiovisual/issues/2).
...
- [QLC+](https://www.qlcplus.org/) - QLC+ is a free and cross-platform software to control DMX or analog lighting systems like moving heads, dimmers, scanners etc. [Source Code ![GitHub Repo Stars](https://img.shields.io/github/stars/mcallegari/qlcplus) ![GitHub last commit](https://img.shields.io/github/last-commit/mcallegari/qlcplus)](https://github.com/mcallegari/qlcplus) `✓ open-source`.
- [xLights](https://xlights.org/) - Meant for home Christmas light shows but is a great way to sync lights to music on a budget. [Source Code ![GitHub Repo Stars](https://img.shields.io/github/stars/smeighan/xLights) ![GitHub last commit](https://img.shields.io/github/last-commit/smeighan/xLights)](https://github.com/smeighan/xLights) `✓ open-source`.
...
- [Ardour](https://ardour.org/) - A full realtime audio recording and editing suite. [Source Code ![GitHub Repo Stars](https://img.shields.io/github/stars/Ardour/ardour) ![GitHub last commit](https://img.shields.io/github/last-commit/Ardour/ardour)](https://github.com/Ardour/ardour) `✓ open-source`.
...
- [Linux Show Player](https://www.linux-show-player.org/) - Free cue player designed for stage productions. [Source Code ![GitHub Repo Stars](https://img.shields.io/github/stars/FrancescoCeruti/linux-show-player) ![GitHub last commit](https://img.shields.io/github/last-commit/FrancescoCeruti/linux-show-player)](https://github.com/FrancescoCeruti/linux-show-player) `✓ open-source`.
...
See [ebu/awesome-broadcasting ![GitHub Repo Stars](https://img.shields.io/github/stars/ebu/awesome-broadcasting) ![GitHub last commit](https://img.shields.io/github/last-commit/ebu/awesome-broadcasting)](https://github.com/ebu/awesome-broadcasting#readme).
...
- [TCgenerator ![GitHub Repo Stars](https://img.shields.io/github/stars/dimitriCGNL/TCGenerator) ![GitHub last commit](https://img.shields.io/github/last-commit/dimitriCGNL/TCGenerator)](https://github.com/dimitriCGNL/TCGenerator) - Reaper time marker to GrandMA2 TC Generator. `✓ open-source`.
- [Timecode ![GitHub Repo Stars](https://img.shields.io/github/stars/MrExplode/Timecode) ![GitHub last commit](https://img.shields.io/github/last-commit/MrExplode/Timecode)](https://github.com/MrExplode/Timecode) - ArtNet and LTC timecode generator, made with Java. `✓ open-source`.
- [Time MIDI sender ![GitHub Repo Stars](https://img.shields.io/github/stars/TheGreyDiamond/Time-MIDI-sender) ![GitHub last commit](https://img.shields.io/github/last-commit/TheGreyDiamond/Time-MIDI-sender)](https://github.com/TheGreyDiamond/Time-MIDI-sender) - A free tool for sending time data to DasLight (via MIDI). `✓ open-source`.
- [TimelordMTC](https://timelord-mtc.com/) - Advanced timecode management tool. `⚠ not free`.
- [M2Q ![GitHub Repo Stars](https://img.shields.io/github/stars/lorenzofattori/M2Q) ![GitHub last commit](https://img.shields.io/github/last-commit/lorenzofattori/M2Q)](https://github.com/lorenzofattori/M2Q) - Python application capable to trigger Chamsys Consoles/Software via MIDI for advanced synchronized shows. `✓ open-source`.

### Monitoring

- [AES67 WebMeter ![GitHub Repo Stars](https://img.shields.io/github/stars/zjstraus/AES67-WebMeter) ![GitHub last commit](https://img.shields.io/github/last-commit/zjstraus/AES67-WebMeter)](https://github.com/zjstraus/AES67-WebMeter) - Server that receives an AES67 audio stream and presents a webpage with meters. `✓ open-source`.
- [meters.lv2 ![GitHub Repo Stars](https://img.shields.io/github/stars/x42/meters.lv2) ![GitHub last commit](https://img.shields.io/github/last-commit/x42/meters.lv2)](https://github.com/x42/meters.lv2) - meters.lv2 is a collection of audio-level meters with GUI in LV2 plugin format. `✓ open-source`.
...
- [Open Lighting Architecture](https://www.openlighting.org/ola/) - A framework for lighting control information. Supports a range of protocols and over a dozen of USB devices. [Source Code ![GitHub Repo Stars](https://img.shields.io/github/stars/OpenLightingProject/ola) ![GitHub last commit](https://img.shields.io/github/last-commit/OpenLightingProject/ola)](https://github.com/OpenLightingProject/ola)
- [node-dmx ![GitHub Repo Stars](https://img.shields.io/github/stars/node-dmx/dmx) ![GitHub last commit](https://img.shields.io/github/last-commit/node-dmx/dmx)](https://github.com/node-dmx/dmx) - DMX controller library for Node.js. `nodejs` `✓ open-source`.

### ArtNet Libraries

- [artnet ![GitHub Repo Stars](https://img.shields.io/github/stars/hobbyquaker/artnet) ![GitHub last commit](https://img.shields.io/github/last-commit/hobbyquaker/artnet)](https://github.com/hobbyquaker/artnet) - Node.js module that can be used to send ArtDMX packages to an Art-Net node. `nodejs`.
- [artnet4j ![GitHub Repo Stars](https://img.shields.io/github/stars/cansik/artnet4j) ![GitHub last commit](https://img.shields.io/github/last-commit/cansik/artnet4j)](https://github.com/cansik/artnet4j) - Art-Net library for Java and Processing. `java`.
...
- [awesome-linuxaudio ![GitHub Repo Stars](https://img.shields.io/github/stars/nodiscc/awesome-linuxaudio) ![GitHub last commit](https://img.shields.io/github/last-commit/nodiscc/awesome-linuxaudio)](https://github.com/nodiscc/awesome-linuxaudio) - A Awesome list with all things Linux audio.
...
- [Blender ArtNet ![GitHub Repo Stars](https://img.shields.io/github/stars/BryanCrotaz/blender-artnet) ![GitHub last commit](https://img.shields.io/github/last-commit/BryanCrotaz/blender-artnet)](https://github.com/BryanCrotaz/blender-artnet) - Blender script to push ArtNet data to Evee lights. Runs at 30fps with Evee rendering in the viewport. `✓ open-source`.
...
- [MIDI Monster ![GitHub Repo Stars](https://img.shields.io/github/stars/cbdevnet/midimonster) ![GitHub last commit](https://img.shields.io/github/last-commit/cbdevnet/midimonster)](https://github.com/cbdevnet/midimonster/) - MIDIMonster is a universal control and translation tool. It can translate between many different protocols such as MIDI, Artnet, sACN and OSC. `✓ open-source`.
