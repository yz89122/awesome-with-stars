...
- [gRPC ![GitHub Repo Stars](https://img.shields.io/github/stars/grpc/grpc) ![GitHub last commit](https://img.shields.io/github/last-commit/grpc/grpc)](https://github.com/grpc/grpc/blob/master/doc/PROTOCOL-HTTP2.md) - This document serves as a detailed description for an implementation of gRPC carried over HTTP2 framing.
...
- [Apache Thrift ![GitHub Repo Stars](https://img.shields.io/github/stars/apache/thrift) ![GitHub last commit](https://img.shields.io/github/last-commit/apache/thrift)](https://github.com/apache/thrift/tree/master/doc/specs) - Interface Definition Language and binary communication protocol used for defining and creating services for programming languages.
...
- [RAML Spec ![GitHub Repo Stars](https://img.shields.io/github/stars/raml-org/raml-spec) ![GitHub last commit](https://img.shields.io/github/last-commit/raml-org/raml-spec)](https://github.com/raml-org/raml-spec) - RESTful API Modeling Language is a YAML based language for describing static APIs (but not REST APIs).
...
- [OpenMessaging Spec ![GitHub Repo Stars](https://img.shields.io/github/stars/openmessaging/specification) ![GitHub last commit](https://img.shields.io/github/last-commit/openmessaging/specification)](https://github.com/openmessaging/specification) - Vendor-neutral and language-independent, aimed to develop messaging and streaming applications across heterogeneous systems.
- [CloudEvents Spec ![GitHub Repo Stars](https://img.shields.io/github/stars/cloudevents/spec) ![GitHub last commit](https://img.shields.io/github/last-commit/cloudevents/spec)](https://github.com/cloudevents/spec) - A specification for describing event data in a common way.
...
- [Siren ![GitHub Repo Stars](https://img.shields.io/github/stars/kevinswiber/siren) ![GitHub last commit](https://img.shields.io/github/last-commit/kevinswiber/siren)](https://github.com/kevinswiber/siren) - Structured Interface for Representing Entities, super-rad hypermedia, defines links and actions.
- [Collection+JSON ![GitHub Repo Stars](https://img.shields.io/github/stars/collection-json/spec) ![GitHub last commit](https://img.shields.io/github/last-commit/collection-json/spec)](https://github.com/collection-json/spec) - JSON-based read/write hypermedia-type designed, defines links and actions.
...
- [JSEND ![GitHub Repo Stars](https://img.shields.io/github/stars/omniti-labs/jsend) ![GitHub last commit](https://img.shields.io/github/last-commit/omniti-labs/jsend)](https://github.com/omniti-labs/jsend) - Specification for a simple, no-frills, JSON based format for application-level communication.
- [Google API Design Guide](https://cloud.google.com/apis/design) - A general design guide for networked APIs provided by Google.
- [Microsoft REST API Guidelines ![GitHub Repo Stars](https://img.shields.io/github/stars/Microsoft/api-guidelines) ![GitHub last commit](https://img.shields.io/github/last-commit/Microsoft/api-guidelines)](https://github.com/Microsoft/api-guidelines) - Repository contains a collection of documents and related materials.
...
- [ECMAScript Proposals ![GitHub Repo Stars](https://img.shields.io/github/stars/tc39/proposals) ![GitHub last commit](https://img.shields.io/github/last-commit/tc39/proposals)](https://github.com/tc39/proposals) - Ecma TC39 (Technical Committee 39) is responsible for evolving the ECMAScript programming language and authoring the specification.
...
- [KEEP ![GitHub Repo Stars](https://img.shields.io/github/stars/Kotlin/KEEP) ![GitHub last commit](https://img.shields.io/github/last-commit/Kotlin/KEEP)](https://github.com/Kotlin/KEEP) - Kotlin Evolution and Enhancement Process.
- [SIPs](https://docs.scala-lang.org/sips/) - Scala Improvement Proposals.
- [GHC Proposals ![GitHub Repo Stars](https://img.shields.io/github/stars/ghc-proposals/ghc-proposals) ![GitHub last commit](https://img.shields.io/github/last-commit/ghc-proposals/ghc-proposals)](https://github.com/ghc-proposals/ghc-proposals) - Compiler and language changes for Haskell/GHC.
...
- [Go Proposals ![GitHub Repo Stars](https://img.shields.io/github/stars/golang/proposal) ![GitHub last commit](https://img.shields.io/github/last-commit/golang/proposal)](https://github.com/golang/proposal) - Design discussions for Go language evolution.
- [GoLang Spec](https://go.dev/ref/spec) - The Go Programming Language Specification.
- [Dart Design ![GitHub Repo Stars](https://img.shields.io/github/stars/dart-lang/language) ![GitHub last commit](https://img.shields.io/github/last-commit/dart-lang/language)](https://github.com/dart-lang/language) - Design of the Dart language.
- [C# Design ![GitHub Repo Stars](https://img.shields.io/github/stars/dotnet/csharplang) ![GitHub last commit](https://img.shields.io/github/last-commit/dotnet/csharplang)](https://github.com/dotnet/csharplang) - C# Language Design Proposals.
- [F# Design ![GitHub Repo Stars](https://img.shields.io/github/stars/fsharp/fslang-design) ![GitHub last commit](https://img.shields.io/github/last-commit/fsharp/fslang-design)](https://github.com/fsharp/fslang-design) - F# Language Design RFCs.
- [Zig Proposals ![GitHub Repo Stars](https://img.shields.io/github/stars/ziglang/zig) ![GitHub last commit](https://img.shields.io/github/last-commit/ziglang/zig)](https://github.com/ziglang/zig/issues?q=is:issue+is:open+label:proposal) - Issues with Proposal label in Zig repository.
...
- [CEPs ![GitHub Repo Stars](https://img.shields.io/github/stars/coq/ceps) ![GitHub last commit](https://img.shields.io/github/last-commit/coq/ceps)](https://github.com/coq/ceps) - Coq Enhancement Proposals.
- [OCaml RFCs ![GitHub Repo Stars](https://img.shields.io/github/stars/ocaml/RFCs) ![GitHub last commit](https://img.shields.io/github/last-commit/ocaml/RFCs)](https://github.com/ocaml/RFCs) - Design discussions about the OCaml language.
...
- [npm RFCs ![GitHub Repo Stars](https://img.shields.io/github/stars/npm/rfcs) ![GitHub last commit](https://img.shields.io/github/last-commit/npm/rfcs)](https://github.com/npm/rfcs) - Change proposals for npm.
- [Yarn RFCs ![GitHub Repo Stars](https://img.shields.io/github/stars/yarnpkg/rfcs) ![GitHub last commit](https://img.shields.io/github/last-commit/yarnpkg/rfcs)](https://github.com/yarnpkg/rfcs) - Proposals for improvements in Yarn package manager.
- [React RFCs ![GitHub Repo Stars](https://img.shields.io/github/stars/reactjs/rfcs) ![GitHub last commit](https://img.shields.io/github/last-commit/reactjs/rfcs)](https://github.com/reactjs/rfcs) - Change requests for React.
- [Vue RFCs ![GitHub Repo Stars](https://img.shields.io/github/stars/vuejs/rfcs) ![GitHub last commit](https://img.shields.io/github/last-commit/vuejs/rfcs)](https://github.com/vuejs/rfcs) - Suggestions for major changes to Vue.js.
- [Svelte RFCs ![GitHub Repo Stars](https://img.shields.io/github/stars/sveltejs/rfcs) ![GitHub last commit](https://img.shields.io/github/last-commit/sveltejs/rfcs)](https://github.com/sveltejs/rfcs) - Svelte framework enhancement discussions.
- [Ember RFCs](https://rfcs.emberjs.com/) - Standards for Ember.js framework evolution.
- [ESLint RFCs ![GitHub Repo Stars](https://img.shields.io/github/stars/eslint/rfcs) ![GitHub last commit](https://img.shields.io/github/last-commit/eslint/rfcs)](https://github.com/eslint/rfcs) - Change requests for ESLint.
- [React Native RFCs ![GitHub Repo Stars](https://img.shields.io/github/stars/react-native-community/discussions-and-proposals) ![GitHub last commit](https://img.shields.io/github/last-commit/react-native-community/discussions-and-proposals)](https://github.com/react-native-community/discussions-and-proposals) - React Native enhancement discussions.
...
- [HeadVer Spec ![GitHub Repo Stars](https://img.shields.io/github/stars/line/headver) ![GitHub last commit](https://img.shields.io/github/last-commit/line/headver)](https://github.com/line/headver) - SemVer compatible version specification that has {head}.{yearweek}.{build} system.
...
- [OpenAutoComplete Spec ![GitHub Repo Stars](https://img.shields.io/github/stars/openautocomplete/openautocomplete) ![GitHub last commit](https://img.shields.io/github/last-commit/openautocomplete/openautocomplete)](https://github.com/openautocomplete/openautocomplete) - CLI autocomplete specification.

## Decentralized Systems

- [BIPs ![GitHub Repo Stars](https://img.shields.io/github/stars/bitcoin/bips) ![GitHub last commit](https://img.shields.io/github/last-commit/bitcoin/bips)](https://github.com/bitcoin/bips) - Bitcoin Improvement Proposals.
- [EIPs](https://eips.ethereum.org/) - Ethereum Improvement Proposals.
- [ZIPs](https://zips.z.cash/) - Zcash Improvement Proposals.
- [NEPs ![GitHub Repo Stars](https://img.shields.io/github/stars/near/NEPs) ![GitHub last commit](https://img.shields.io/github/last-commit/near/NEPs)](https://github.com/near/NEPs) - NEAR Protocol Specifications and Standards.
- [BOLTs ![GitHub Repo Stars](https://img.shields.io/github/stars/lightning/bolts) ![GitHub last commit](https://img.shields.io/github/last-commit/lightning/bolts)](https://github.com/lightning/bolts) - Basis of Lightning Technology (Lightning Network Specifications).
- [BEPs ![GitHub Repo Stars](https://img.shields.io/github/stars/bittorrent/bittorrent.org) ![GitHub last commit](https://img.shields.io/github/last-commit/bittorrent/bittorrent.org)](https://github.com/bittorrent/bittorrent.org) - BitTorrent Enhancement Proposals.
- [BTIPs ![GitHub Repo Stars](https://img.shields.io/github/stars/bittorrent/BTIPs) ![GitHub last commit](https://img.shields.io/github/last-commit/bittorrent/BTIPs)](https://github.com/bittorrent/BTIPs) - BitTorrent File System Improvement Proposals.
- [SLIPs ![GitHub Repo Stars](https://img.shields.io/github/stars/satoshilabs/slips) ![GitHub last commit](https://img.shields.io/github/last-commit/satoshilabs/slips)](https://github.com/satoshilabs/slips) - SatoshiLabs Improvement Proposals.
- [YIPs](https://yips.yearn.fi/) - Yearn Finance Improvement Proposals.
- [AIPs ![GitHub Repo Stars](https://img.shields.io/github/stars/aave/aip) ![GitHub last commit](https://img.shields.io/github/last-commit/aave/aip)](https://github.com/aave/aip) - Aave Improvement Proposals.
- [Optimism Specs](https://specs.optimism.io/) - Optimism Stack Specifications.
- [PIPs ![GitHub Repo Stars](https://img.shields.io/github/stars/maticnetwork/Polygon-Improvement-Proposals) ![GitHub last commit](https://img.shields.io/github/last-commit/maticnetwork/Polygon-Improvement-Proposals)](https://github.com/maticnetwork/Polygon-Improvement-Proposals) - Polygon Improvement Proposals.
...
- [LibP2P Specs ![GitHub Repo Stars](https://img.shields.io/github/stars/libp2p/specs) ![GitHub last commit](https://img.shields.io/github/last-commit/libp2p/specs)](https://github.com/libp2p/specs) - Technical specifications for the libp2p networking stack.
...
- [OWASP MASVS ![GitHub Repo Stars](https://img.shields.io/github/stars/OWASP/owasp-masvs) ![GitHub last commit](https://img.shields.io/github/last-commit/OWASP/owasp-masvs)](https://github.com/OWASP/owasp-masvs) - Mobile Application Security Verification Standard is the industry standard for mobile app security.
...
- [Awesome Guidelines ![GitHub Repo Stars](https://img.shields.io/github/stars/Kristories/awesome-guidelines) ![GitHub last commit](https://img.shields.io/github/last-commit/Kristories/awesome-guidelines)](https://github.com/Kristories/awesome-guidelines) - Coding style conventions and standards.
- [Awesome API Devtools ![GitHub Repo Stars](https://img.shields.io/github/stars/yosriady/awesome-api-devtools) ![GitHub last commit](https://img.shields.io/github/last-commit/yosriady/awesome-api-devtools)](https://github.com/yosriady/awesome-api-devtools) - A collection of useful resources for building RESTful HTTP+JSON APIs.
- [Awesome Corporate Standards ![GitHub Repo Stars](https://img.shields.io/github/stars/openapi/awesome-corporate-standards) ![GitHub last commit](https://img.shields.io/github/last-commit/openapi/awesome-corporate-standards)](https://github.com/openapi/awesome-corporate-standards) - International standards, frameworks, and certification bodies for organizations and businesses (quality, security, privacy, ESG, finance, and sector-specific compliance).
