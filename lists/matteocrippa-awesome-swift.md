...
* [FluidAudio ![GitHub Repo Stars](https://img.shields.io/github/stars/FluidInference/FluidAudio) ![GitHub last commit](https://img.shields.io/github/last-commit/FluidInference/FluidAudio)](https://github.com/FluidInference/FluidAudio) - SDK for real-time on-device audio intelligence on iOS/macOS (diarization, identification, VAD, separation, embeddings, ASR), with CoreML models converted directly from PyTorch to leverage Apple Neural Engine performance.
...
* [ReerCodable ![GitHub Repo Stars](https://img.shields.io/github/stars/reers/ReerCodable) ![GitHub last commit](https://img.shields.io/github/last-commit/reers/ReerCodable)](https://github.com/reers/ReerCodable) - Codable extensions using Swift macro.
...
* [solid-like-a-rock ![GitHub Repo Stars](https://img.shields.io/github/stars/nenadvulic/solid-like-a-rock) ![GitHub last commit](https://img.shields.io/github/last-commit/nenadvulic/solid-like-a-rock)](https://github.com/nenadvulic/solid-like-a-rock) :penguin: - Architecture linter that enforces Clean Architecture and TCA import rules using SwiftSyntax.
...
* [TouchBridge ![GitHub Repo Stars](https://img.shields.io/github/stars/HMAKT99/UnTouchID) ![GitHub last commit](https://img.shields.io/github/last-commit/HMAKT99/UnTouchID)](https://github.com/HMAKT99/UnTouchID) - Use your phone's fingerprint to authenticate on any Mac.
...
* [ReerKit ![GitHub Repo Stars](https://img.shields.io/github/stars/reers/ReerKit) ![GitHub last commit](https://img.shields.io/github/last-commit/reers/ReerKit)](https://github.com/reers/ReerKit) - Powerful Swift foundation library of extensions and providing utility functions to supercharge your iOS/macOS/Linux development workflow.
...
* [swift-build ![GitHub Repo Stars](https://img.shields.io/github/stars/brightdigit/swift-build) ![GitHub last commit](https://img.shields.io/github/last-commit/brightdigit/swift-build)](https://github.com/brightdigit/swift-build) - GitHub Action for building and testing Swift packages across all platforms.
...
* [SyntaxKit ![GitHub Repo Stars](https://img.shields.io/github/stars/brightdigit/SyntaxKit) ![GitHub last commit](https://img.shields.io/github/last-commit/brightdigit/SyntaxKit)](https://github.com/brightdigit/SyntaxKit) - Generate Swift code programmatically with a declarative syntax.
