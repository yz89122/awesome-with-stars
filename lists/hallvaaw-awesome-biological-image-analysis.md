...
- [Ilastik ![GitHub Repo Stars](https://img.shields.io/github/stars/ilastik/ilastik) ![GitHub last commit](https://img.shields.io/github/last-commit/ilastik/ilastik)](https://github.com/ilastik/ilastik) - Simple, user-friendly tool for interactive image classification, segmentation and analysis.
...
- [CellVit++ ![GitHub Repo Stars](https://img.shields.io/github/stars/TIO-IKIM/CellViT) ![GitHub last commit](https://img.shields.io/github/last-commit/TIO-IKIM/CellViT)](https://github.com/TIO-IKIM/CellViT) - A framework for lightweight cell segmentation model training and inference.
- [Classpose ![GitHub Repo Stars](https://img.shields.io/github/stars/sohmandal/classpose) ![GitHub last commit](https://img.shields.io/github/last-commit/sohmandal/classpose)](https://github.com/sohmandal/classpose) - A foundation model-driven whole slide image-scale cell phenotyping method with QuPath integration.
...
- [FlashDeconv ![GitHub Repo Stars](https://img.shields.io/github/stars/cafferychen777/flashdeconv) ![GitHub last commit](https://img.shields.io/github/last-commit/cafferychen777/flashdeconv)](https://github.com/cafferychen777/flashdeconv) - High-performance spatial transcriptomics deconvolution for cell type mapping using structure-preserving randomized sketching.
...
- [HoVer-Net ![GitHub Repo Stars](https://img.shields.io/github/stars/vqdang/hover_net) ![GitHub last commit](https://img.shields.io/github/last-commit/vqdang/hover_net)](https://github.com/vqdang/hover_net) - A multi-branch network for nuclear instance segmentation and classification with pre-trained weights.
...
- [Nellie ![GitHub Repo Stars](https://img.shields.io/github/stars/aelefebv/nellie) ![GitHub last commit](https://img.shields.io/github/last-commit/aelefebv/nellie)](https://github.com/aelefebv/nellie) - Automated organelle segmentation, tracking, and hierarchical feature extraction in 2D/3D live-cell microscopy.
...
- [Proseg ![GitHub Repo Stars](https://img.shields.io/github/stars/dcjones/proseg) ![GitHub last commit](https://img.shields.io/github/last-commit/dcjones/proseg)](https://github.com/dcjones/proseg) : A cell segmentation method for in situ spatial transcriptomics.
...
- [SplineDist ![GitHub Repo Stars](https://img.shields.io/github/stars/uhlmanngroup/splinedist) ![GitHub last commit](https://img.shields.io/github/last-commit/uhlmanngroup/splinedist)](https://github.com/uhlmanngroup/splinedist) - Object detection with spline curves.
...
- [Brainrender ![GitHub Repo Stars](https://img.shields.io/github/stars/brainglobe/brainrender) ![GitHub last commit](https://img.shields.io/github/last-commit/brainglobe/brainrender)](https://github.com/brainglobe/brainrender) - Python package for the visualization of three dimensional neuro-anatomical data.
...
- [VisionSetil](https://visionsetil.com) - Multi-view image classification of Iberian mushrooms for education (open encyclopedia of 523 taxa, deadly lookalikes). Orientation only — never consumption permission.
...
- [SimpleITK ![GitHub Repo Stars](https://img.shields.io/github/stars/SimpleITK/SimpleITK) ![GitHub last commit](https://img.shields.io/github/last-commit/SimpleITK/SimpleITK)](https://github.com/SimpleITK/SimpleITK) - Open-source multi-dimensional image analysis in Python, R, Java, C#, Lua, Ruby, TCL and C++.
