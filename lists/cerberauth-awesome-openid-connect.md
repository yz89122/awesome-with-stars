...
- [Authentik ![GitHub Repo Stars](https://img.shields.io/github/stars/goauthentik/authentik) ![GitHub last commit](https://img.shields.io/github/last-commit/goauthentik/authentik)](https://github.com/goauthentik/authentik) - Open Source Identity Provider focused on flexibility and versatility.
...
- [Dex ![GitHub Repo Stars](https://img.shields.io/github/stars/dexidp/dex) ![GitHub last commit](https://img.shields.io/github/last-commit/dexidp/dex)](https://github.com/dexidp/dex) - Provider that acts as a portal to other identity providers through "connectors." like LDAP, SAML, OIDC or established identity providers like GitHub, Google, and Active Directory.
...
- [Logto ![GitHub Repo Stars](https://img.shields.io/github/stars/logto-io/logto) ![GitHub last commit](https://img.shields.io/github/last-commit/logto-io/logto)](https://github.com/logto-io/logto) - An Open-source solution designed for Customer Identity and Access Management (CIAM) and Workforce Identity Management with OpenID Connect based authentication.
...
- [MITREid Connect ![GitHub Repo Stars](https://img.shields.io/github/stars/mitreid-connect/OpenID-Connect-Java-Spring-Server) ![GitHub last commit](https://img.shields.io/github/last-commit/mitreid-connect/OpenID-Connect-Java-Spring-Server)](https://github.com/mitreid-connect/OpenID-Connect-Java-Spring-Server) - Open Source OpenID Connect reference implementation in Java.
- [OpenIddict ![GitHub Repo Stars](https://img.shields.io/github/stars/openiddict/openiddict-core) ![GitHub last commit](https://img.shields.io/github/last-commit/openiddict/openiddict-core)](https://github.com/openiddict/openiddict-core) - .NET Open Source OpenID Connect Provider implementation with ASP.NET Core 2.1 (and higher) applications support.
- [OneLogin](https://www.onelogin.com/) - SaaS Employee and Customer IAM solution with OpenID Connect Provider capabilities.
- [Ory Hydra ![GitHub Repo Stars](https://img.shields.io/github/stars/ory/hydra) ![GitHub last commit](https://img.shields.io/github/last-commit/ory/hydra)](https://github.com/ory/hydra) - Open Source OpenID Certified™ OpenID Connect and OAuth Provider.
- [Ory Polis (formerly BoxyHQ Jackson) ![GitHub Repo Stars](https://img.shields.io/github/stars/ory/polis) ![GitHub last commit](https://img.shields.io/github/last-commit/ory/polis)](https://github.com/ory/polis) - Open Source Enterprise SSO bridges or proxies a SAML login flow to OpenID Connect with also user directory sync capabilities.
- [panva/node-oidc-provider ![GitHub Repo Stars](https://img.shields.io/github/stars/panva/node-oidc-provider) ![GitHub last commit](https://img.shields.io/github/last-commit/panva/node-oidc-provider)](https://github.com/panva/node-oidc-provider) - Open Source and certified OpenID Connect provider implementation in Node.js with FAPI 1.0 and FAPI 2.0 support.
...
- [Pocket ID ![GitHub Repo Stars](https://img.shields.io/github/stars/pocket-id/pocket-id) ![GitHub last commit](https://img.shields.io/github/last-commit/pocket-id/pocket-id)](https://github.com/pocket-id/pocket-id) - A simple OpenID Connect Provider that allows users to authenticate with their passkeys.
...
- [Zitadel ![GitHub Repo Stars](https://img.shields.io/github/stars/zitadel/zitadel) ![GitHub last commit](https://img.shields.io/github/last-commit/zitadel/zitadel)](https://github.com/zitadel/zitadel) - Open Source Identity solution with OpenID Connect provider (OP) and SAMLv2 ready to use.
...
- [liboauth2 ![GitHub Repo Stars](https://img.shields.io/github/stars/OpenIDC/liboauth2) ![GitHub last commit](https://img.shields.io/github/last-commit/OpenIDC/liboauth2)](https://github.com/OpenIDC/liboauth2) - Generic library to build C-based OpenID Connect Provider and Relying Party.
- [mod_auth_openidc ![GitHub Repo Stars](https://img.shields.io/github/stars/OpenIDC/mod_auth_openidc) ![GitHub last commit](https://img.shields.io/github/last-commit/OpenIDC/mod_auth_openidc)](https://github.com/OpenIDC/mod_auth_openidc) - OpenID Connect Relying Party certified implementation for Apache Server 2.x.
- [ngx_oauth2_module ![GitHub Repo Stars](https://img.shields.io/github/stars/OpenIDC/ngx_oauth2_module) ![GitHub last commit](https://img.shields.io/github/last-commit/OpenIDC/ngx_oauth2_module)](https://github.com/OpenIDC/ngx_oauth2_module) - OpenID Connect Relying Party certified implementation for Nginx.

### C#

- [IdentityModel.OidcClient ![GitHub Repo Stars](https://img.shields.io/github/stars/IdentityModel/IdentityModel.OidcClient) ![GitHub last commit](https://img.shields.io/github/last-commit/IdentityModel/IdentityModel.OidcClient)](https://github.com/IdentityModel/IdentityModel.OidcClient) - C# / .NET OpenID Connect relying party client certified library for native mobile/desktop applications.

### Dart

- [openid_client ![GitHub Repo Stars](https://img.shields.io/github/stars/appsup-dart/openid_client) ![GitHub last commit](https://img.shields.io/github/last-commit/appsup-dart/openid_client)](https://github.com/appsup-dart/openid_client) - OpenID Connect Relying Party client library for Dart in Flutter, Web and Command Line.

### Erlang

- [oidcc ![GitHub Repo Stars](https://img.shields.io/github/stars/erlef/oidcc) ![GitHub last commit](https://img.shields.io/github/last-commit/erlef/oidcc)](https://github.com/erlef/oidcc) - Certified OpenID Connect Relying Party client library for Erlang and Elixir with FAPI support.
...
- [com.google.oauth-client/google-oauth-client ![GitHub Repo Stars](https://img.shields.io/github/stars/googleapis/google-oauth-java-client) ![GitHub last commit](https://img.shields.io/github/last-commit/googleapis/google-oauth-java-client)](https://github.com/googleapis/google-oauth-java-client) - OAuth Relying Party Java library written by Google for OAuth 2.0 with Android support.
...
- [openid-client ![GitHub Repo Stars](https://img.shields.io/github/stars/panva/node-openid-client) ![GitHub last commit](https://img.shields.io/github/last-commit/panva/node-openid-client)](https://github.com/panva/node-openid-client) - OpenID Certified™ Relying Party (OpenID Connect/OAuth 2.0 Client) implementation for Node.js.
- [oauth4webapi ![GitHub Repo Stars](https://img.shields.io/github/stars/panva/oauth4webapi) ![GitHub last commit](https://img.shields.io/github/last-commit/panva/oauth4webapi)](https://github.com/panva/oauth4webapi) - OAuth 2/OpenID Connect library for JavaScript Runtimes.
- [oidc-client-ts ![GitHub Repo Stars](https://img.shields.io/github/stars/authts/oidc-client-ts) ![GitHub last commit](https://img.shields.io/github/last-commit/authts/oidc-client-ts)](https://github.com/authts/oidc-client-ts) - TypeScript OpenID Client and OAuth 2.0 client for browser-based applications.

*Libraries layer focused on specific framework integration*

- [Better Auth ![GitHub Repo Stars](https://img.shields.io/github/stars/better-auth/better-auth) ![GitHub last commit](https://img.shields.io/github/last-commit/better-auth/better-auth)](https://github.com/better-auth/better-auth) - TypeScript Framework agnostic authentication library for SPAs and server-side applications.
- [nuxt-auth for Nuxt 2 ![GitHub Repo Stars](https://img.shields.io/github/stars/nuxt-community/auth-module) ![GitHub last commit](https://img.shields.io/github/last-commit/nuxt-community/auth-module)](https://github.com/nuxt-community/auth-module) - Zero-boilerplate authentication support for Nuxt.js 2.
- [nuxt-auth for Nuxt3 ![GitHub Repo Stars](https://img.shields.io/github/stars/sidebase/nuxt-auth) ![GitHub last commit](https://img.shields.io/github/last-commit/sidebase/nuxt-auth)](https://github.com/sidebase/nuxt-auth) - Nuxt 3 user authentication and sessions library. nuxt-auth wraps NextAuth.js.
- [angular-auth-oidc-client ![GitHub Repo Stars](https://img.shields.io/github/stars/damienbod/angular-auth-oidc-client) ![GitHub last commit](https://img.shields.io/github/last-commit/damienbod/angular-auth-oidc-client)](https://github.com/damienbod/angular-auth-oidc-client) - Angular certified library with OAuth 2.0 and OpenID Connect flows, and Angular schematics.
- [angular-oauth2-oidc ![GitHub Repo Stars](https://img.shields.io/github/stars/manfredsteyer/angular-oauth2-oidc) ![GitHub last commit](https://img.shields.io/github/last-commit/manfredsteyer/angular-oauth2-oidc)](https://github.com/manfredsteyer/angular-oauth2-oidc) - Library which bring support for OAuth 2.0 and OpenID Connect (OIDC) in Angular.

### OCaml

- [ocaml-oidc ![GitHub Repo Stars](https://img.shields.io/github/stars/ulrikstrid/ocaml-oidc) ![GitHub last commit](https://img.shields.io/github/last-commit/ulrikstrid/ocaml-oidc)](https://github.com/ulrikstrid/ocaml-oidc) - Certified OpenID Connect Relying Party implementation in OCaml.
...
- [Authlib ![GitHub Repo Stars](https://img.shields.io/github/stars/authlib/authlib) ![GitHub last commit](https://img.shields.io/github/last-commit/authlib/authlib)](https://github.com/authlib/authlib) - Python library in building OAuth and OpenID Connect servers and clients.
- [mozilla-django-oidc ![GitHub Repo Stars](https://img.shields.io/github/stars/mozilla/mozilla-django-oidc) ![GitHub last commit](https://img.shields.io/github/last-commit/mozilla/mozilla-django-oidc)](https://github.com/mozilla/mozilla-django-oidc/) - A Django OpenID Connect relying party library maintained by Mozilla.

### Ruby

- [openid_connect ![GitHub Repo Stars](https://img.shields.io/github/stars/nov/openid_connect) ![GitHub last commit](https://img.shields.io/github/last-commit/nov/openid_connect)](https://github.com/nov/openid_connect) - Ruby OpenID Connect Relying party (RP) and Provider (OP) library.
- [omniauth_openid_connect ![GitHub Repo Stars](https://img.shields.io/github/stars/omniauth/omniauth_openid_connect) ![GitHub last commit](https://img.shields.io/github/last-commit/omniauth/omniauth_openid_connect)](https://github.com/omniauth/omniauth_openid_connect) - OpenID Connect Strategy for Ruby OmniAuth library.

### Rust

- [openidconnect ![GitHub Repo Stars](https://img.shields.io/github/stars/ramosbugs/openidconnect-rs) ![GitHub last commit](https://img.shields.io/github/last-commit/ramosbugs/openidconnect-rs)](https://github.com/ramosbugs/openidconnect-rs) - OpenID Connect Relying party (RP) library for Rust.
...
- [OAuth 2.0 App2App Browserless Flow ![GitHub Repo Stars](https://img.shields.io/github/stars/yaron-zehavi/oauth-app2app-browserless) ![GitHub last commit](https://img.shields.io/github/last-commit/yaron-zehavi/oauth-app2app-browserless)](https://github.com/yaron-zehavi/oauth-app2app-browserless) - Describing a protocol enabling native navigation across apps performing authentication using the App2App pattern, without requiring a web browser.
...
- [SecureAuthCorp/oauth2c ![GitHub Repo Stars](https://img.shields.io/github/stars/SecureAuthCorp/oauth2c) ![GitHub last commit](https://img.shields.io/github/last-commit/SecureAuthCorp/oauth2c)](https://github.com/SecureAuthCorp/oauth2c) - OAuth 2.0 and OpenID Connect command line client for testing and exploring different flows.
