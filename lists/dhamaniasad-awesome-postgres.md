...
* [pgbackweb ![GitHub Repo Stars](https://img.shields.io/github/stars/eduardolat/pgbackweb) ![GitHub last commit](https://img.shields.io/github/last-commit/eduardolat/pgbackweb)](https://github.com/eduardolat/pgbackweb) - A Complete Docker-based Postgres backup and maintenance tool with Web UI. 
...
* [postgres-backup-oss ![GitHub Repo Stars](https://img.shields.io/github/stars/isaced/postgres-backup-oss) ![GitHub last commit](https://img.shields.io/github/last-commit/isaced/postgres-backup-oss)](https://github.com/isaced/postgres-backup-oss) - A handy Docker container to periodically backup PostgreSQL to Alibaba Cloud Object Storage Service (OSS)
...
* [pgwd ![GitHub Repo Stars](https://img.shields.io/github/stars/hrodrig/pgwd) ![GitHub last commit](https://img.shields.io/github/last-commit/hrodrig/pgwd)](https://github.com/hrodrig/pgwd) - monitors PostgreSQL connection usage and stale sessions, with threshold alerts, Prometheus metrics, and multiple notification backends.
...
* [HypoPG ![GitHub Repo Stars](https://img.shields.io/github/stars/HypoPG/hypopg) ![GitHub last commit](https://img.shields.io/github/last-commit/HypoPG/hypopg)](https://github.com/HypoPG/hypopg) - HypoPG provides hypothetical/virtual indexes feature.
...
* [NServiceBus.Transport.PostgreSql ![GitHub Repo Stars](https://img.shields.io/github/stars/Particular/NServiceBus.SqlServer) ![GitHub last commit](https://img.shields.io/github/last-commit/Particular/NServiceBus.SqlServer)](https://github.com/Particular/NServiceBus.SqlServer) - The NServiceBus.Transport.PostgreSql library allows .NET developers to [use a PostgreSQL database as a message broker](https://docs.particular.net/transports/postgresql). (Commerical Software)
...
* [pgFirstAid ![GitHub Repo Stars](https://img.shields.io/github/stars/randoneering/pgFirstAid) ![GitHub last commit](https://img.shields.io/github/last-commit/randoneering/pgFirstAid)](https://github.com/randoneering/pgFirstAid) - Easy-to-deploy, open source PostgreSQL function that provides a prioritized list of actions to improve database stability and performance. Directly inspired by Brent Ozar's FirstResponderKit for SQL Server.
...
* [PostGraphile ![GitHub Repo Stars](https://img.shields.io/github/stars/graphile/postgraphile) ![GitHub last commit](https://img.shields.io/github/last-commit/graphile/postgraphile)](https://github.com/graphile/postgraphile) - Instant GraphQL API or GraphQL schema for your PostgreSQL database
