...
[![LaTeX Logo ![GitHub Repo Stars](https://img.shields.io/github/stars/egeerardyn/awesome-LaTeX) ![GitHub last commit](https://img.shields.io/github/last-commit/egeerardyn/awesome-LaTeX)](https://github.com/egeerardyn/awesome-LaTeX/raw/master/fig/latex-logo.svg)](https://www.latex-project.org/)
...
- [Oleafly ![GitHub Repo Stars](https://img.shields.io/github/stars/Oleafly/Oleafly) ![GitHub last commit](https://img.shields.io/github/last-commit/Oleafly/Oleafly)](https://github.com/Oleafly/Oleafly) - Free, open-source desktop editor for LaTeX, Typst, and Markdown with live PDF preview, SyncTeX, bundled engines, and Git-native projects. ![foss]
...
- [Modern LaTeX Editor ![GitHub Repo Stars](https://img.shields.io/github/stars/InMDev/Modern-LaTeX-Editor) ![GitHub last commit](https://img.shields.io/github/last-commit/InMDev/Modern-LaTeX-Editor)](https://github.com/InMDev/Modern-LaTeX-Editor) - Online editor, no-signup hybrid code editor + visual editor that mixes Notion/Google docs/Microsoft Word-like editing with raw LaTeX code blocks.
...
- [Overleaf](https://www.overleaf.com) - Online editor, also with a WYSIWYM editor and git support. Also available as [Overleaf Community Edition ![GitHub Repo Stars](https://img.shields.io/github/stars/overleaf/overleaf) ![GitHub last commit](https://img.shields.io/github/last-commit/overleaf/overleaf)](https://github.com/overleaf/overleaf) (self-hosted, AGPL licensed). ![foss]
  - [olcli ![GitHub Repo Stars](https://img.shields.io/github/stars/aloth/olcli) ![GitHub last commit](https://img.shields.io/github/last-commit/aloth/olcli)](https://github.com/aloth/olcli) - Command-line interface for Overleaf to sync, manage, and compile projects from the terminal. ![foss]
- [SciTeX Cloud ![GitHub Repo Stars](https://img.shields.io/github/stars/ywatanabe1989/scitex-cloud) ![GitHub last commit](https://img.shields.io/github/last-commit/ywatanabe1989/scitex-cloud)](https://github.com/ywatanabe1989/scitex-cloud) - Self-hostable online editor with AI assistant integration, figure/table/citation management, real-time collaboration, and an MCP server (29 tools). ![foss]
...
- [TexLab ![GitHub Repo Stars](https://img.shields.io/github/stars/latex-lsp/texlab) ![GitHub last commit](https://img.shields.io/github/last-commit/latex-lsp/texlab)](https://github.com/latex-lsp/texlab) - Language server for LaTeX and BibTeX with completion, definitions, references, rename, formatting, and forward search. ![foss]
- [Badness ![GitHub Repo Stars](https://img.shields.io/github/stars/jolars/badness) ![GitHub last commit](https://img.shields.io/github/last-commit/jolars/badness)](https://github.com/jolars/badness) - Language server, formatter, and linter for LaTeX built on a lossless, error-tolerant syntax tree in the style of rust-analyzer. ![foss]
...
- [betterbib ![GitHub Repo Stars](https://img.shields.io/github/stars/nschloe/betterbib) ![GitHub last commit](https://img.shields.io/github/last-commit/nschloe/betterbib)](https://github.com/nschloe/betterbib) - Command-line utility for improving your BibTeX files. Fetches information from online sources. ![mac] ![windows] ![linux] ![foss]
- [OneCite ![GitHub Repo Stars](https://img.shields.io/github/stars/HzaCode/OneCite) ![GitHub last commit](https://img.shields.io/github/last-commit/HzaCode/OneCite)](https://github.com/HzaCode/OneCite) - Universal citation management and academic reference toolkit that converts messy references into perfectly formatted citations. Supports DOI, arXiv ID, titles, and more, with output in BibTeX, APA, and MLA formats. ![mac] ![windows] ![linux] ![foss]
- [CrossRef Local ![GitHub Repo Stars](https://img.shields.io/github/stars/ywatanabe1989/crossref-local) ![GitHub last commit](https://img.shields.io/github/last-commit/ywatanabe1989/crossref-local)](https://github.com/ywatanabe1989/crossref-local) - Local CrossRef database (167M papers) with full-text search, impact factor data, Python API for bibliography enrichment, and an MCP server (15 tools). ![foss]
- [OpenAlex Local ![GitHub Repo Stars](https://img.shields.io/github/stars/ywatanabe1989/openalex-local) ![GitHub last commit](https://img.shields.io/github/last-commit/ywatanabe1989/openalex-local)](https://github.com/ywatanabe1989/openalex-local) - Local OpenAlex database (284M scholarly works) with abstracts and semantic search for literature discovery, and an MCP server. ![foss]
...
- [SciTeX Writer ![GitHub Repo Stars](https://img.shields.io/github/stars/ywatanabe1989/scitex-writer) ![GitHub last commit](https://img.shields.io/github/last-commit/ywatanabe1989/scitex-writer)](https://github.com/ywatanabe1989/scitex-writer) - Manuscript compilation system with templates for manuscripts, revisions, and supplementary materials, plus figure, table, and citation handling, and an MCP server (38 tools). ![foss]
...
- [tex-fmt ![GitHub Repo Stars](https://img.shields.io/github/stars/WGUNDERWOOD/tex-fmt) ![GitHub last commit](https://img.shields.io/github/last-commit/WGUNDERWOOD/tex-fmt)](https://github.com/WGUNDERWOOD/tex-fmt) - Extremely fast LaTeX formatter written in Rust, with sensible defaults and minimal configuration. ![foss]
- [Badness ![GitHub Repo Stars](https://img.shields.io/github/stars/jolars/badness) ![GitHub last commit](https://img.shields.io/github/last-commit/jolars/badness)](https://github.com/jolars/badness) - Deterministic, rule-based, and idempotent LaTeX formatter written in Rust (also a linter and language server). ![foss]
...
- [Badness ![GitHub Repo Stars](https://img.shields.io/github/stars/jolars/badness) ![GitHub last commit](https://img.shields.io/github/last-commit/jolars/badness)](https://github.com/jolars/badness) - Error-tolerant LaTeX linter with rich diagnostics and source snippets (also a formatter and language server). ![foss]
- [latex2arxiv ![GitHub Repo Stars](https://img.shields.io/github/stars/YuZh98/latex2arxiv) ![GitHub last commit](https://img.shields.io/github/last-commit/YuZh98/latex2arxiv)](https://github.com/YuZh98/latex2arxiv) - CLI tool that prepares a LaTeX project for arXiv submission: prunes unreachable files, strips draft markup, validates the bibliography, and catches desk-rejection errors before upload. Also available as a GitHub Action and MCP server for AI agents. ![windows] ![linux] ![mac] ![foss]
...
- [OpenTikZ ![GitHub Repo Stars](https://img.shields.io/github/stars/opentikz/opentikz) ![GitHub last commit](https://img.shields.io/github/last-commit/opentikz/opentikz)](https://github.com/opentikz/opentikz) - Community library of copyable TikZ icons and editable, parametric templates for academic conceptual diagrams (system/architecture, pipelines, flowcharts); CC0 content, with a Claude Code skill to edit figures on request. ![foss]
