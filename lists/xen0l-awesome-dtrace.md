...
- [Using DTrace stories ![GitHub Repo Stars](https://img.shields.io/github/stars/NanXiao/using-dtrace-stories) ![GitHub last commit](https://img.shields.io/github/last-commit/NanXiao/using-dtrace-stories)](https://github.com/NanXiao/using-dtrace-stories) - A collection of using DTrace to debug system stories.
...
- [lua-usdt ![GitHub Repo Stars](https://img.shields.io/github/stars/chrisa/lua-usdt) ![GitHub last commit](https://img.shields.io/github/last-commit/chrisa/lua-usdt)](https://github.com/chrisa/lua-usdt) - Libusdt bindings for Lua.

#### Node.js

- [node-dtrace-provider ![GitHub Repo Stars](https://img.shields.io/github/stars/chrisa/node-dtrace-provider) ![GitHub last commit](https://img.shields.io/github/last-commit/chrisa/node-dtrace-provider)](https://github.com/chrisa/node-dtrace-provider) - Native DTrace probes for Node.js apps.

#### Perl

- [perl-Devel-DTrace-Provider ![GitHub Repo Stars](https://img.shields.io/github/stars/chrisa/perl-Devel-DTrace-Provider) ![GitHub last commit](https://img.shields.io/github/last-commit/chrisa/perl-Devel-DTrace-Provider)](https://github.com/chrisa/perl-Devel-DTrace-Provider) - Perl wrapper for libusdt.
...
- [python-usdt ![GitHub Repo Stars](https://img.shields.io/github/stars/nshalman/python-usdt) ![GitHub last commit](https://img.shields.io/github/last-commit/nshalman/python-usdt)](https://github.com/nshalman/python-usdt) - Libusdt bindings for Python.

#### Ruby

- [Ruby](http://ruby-doc.org/core-2.3.1/doc/dtrace_probes_rdoc.html) - Ruby DTrace probes.
- [ruby-usdt ![GitHub Repo Stars](https://img.shields.io/github/stars/kevinykchan/ruby-usdt) ![GitHub last commit](https://img.shields.io/github/last-commit/kevinykchan/ruby-usdt)](https://github.com/kevinykchan/ruby-usdt) - Native DTrace probes for ruby apps.
...
- [mod_usdt ![GitHub Repo Stars](https://img.shields.io/github/stars/davepacheco/mod_usdt) ![GitHub last commit](https://img.shields.io/github/last-commit/davepacheco/mod_usdt)](https://github.com/davepacheco/mod_usdt) - "httpd" DTrace provider.

### Visualization

- [FlameGraph ![GitHub Repo Stars](https://img.shields.io/github/stars/brendangregg/FlameGraph) ![GitHub last commit](https://img.shields.io/github/last-commit/brendangregg/FlameGraph)](https://github.com/brendangregg/FlameGraph) - Stack trace visualizer.
- [node-stackvis ![GitHub Repo Stars](https://img.shields.io/github/stars/joyent/node-stackvis) ![GitHub last commit](https://img.shields.io/github/last-commit/joyent/node-stackvis)](https://github.com/joyent/node-stackvis) - Stack trace visualizer.

## Tools

- [DTraceToolkit](http://www.brendangregg.com/dtracetoolkit.html) - A collection of useful documented DTrace scripts.
- [dtrace-cloud-tools ![GitHub Repo Stars](https://img.shields.io/github/stars/brendangregg/dtrace-cloud-tools) ![GitHub last commit](https://img.shields.io/github/last-commit/brendangregg/dtrace-cloud-tools)](https://github.com/brendangregg/dtrace-cloud-tools) - DTrace tools written for the SmartOS/SmartDataCenter cloud (illumos-based).
- [pgsql tools ![GitHub Repo Stars](https://img.shields.io/github/stars/joyent/pgsqlstat) ![GitHub last commit](https://img.shields.io/github/last-commit/joyent/pgsqlstat)](https://github.com/joyent/pgsqlstat) - Report top-level PostgreSQL stats.
- [portsnoop ![GitHub Repo Stars](https://img.shields.io/github/stars/davepacheco/portsnoop) ![GitHub last commit](https://img.shields.io/github/last-commit/davepacheco/portsnoop)](https://github.com/davepacheco/portsnoop) - Trace event port activity.
- [storage tools ![GitHub Repo Stars](https://img.shields.io/github/stars/richardelling/tools) ![GitHub last commit](https://img.shields.io/github/last-commit/richardelling/tools)](https://github.com/richardelling/tools) - Report NFS, CIFS and iSCSI stats.
...
Contributions are more than welcome! Please see [contribution guidelines ![GitHub Repo Stars](https://img.shields.io/github/stars/xen0l/awesome-dtrace) ![GitHub last commit](https://img.shields.io/github/last-commit/xen0l/awesome-dtrace)](https://github.com/xen0l/awesome-dtrace/blob/master/CONTRIBUTING.md) first.
