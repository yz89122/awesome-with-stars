...
- [Google Books ![GitHub Repo Stars](https://img.shields.io/github/stars/aharris88/google-bookshelves-widget) ![GitHub last commit](https://img.shields.io/github/last-commit/aharris88/google-bookshelves-widget)](https://github.com/aharris88/google-bookshelves-widget) - Allows you to display the books in your Google Books Library.
...
- [1Backend ![GitHub Repo Stars](https://img.shields.io/github/stars/1backend/1backend) ![GitHub last commit](https://img.shields.io/github/last-commit/1backend/1backend)](https://github.com/1backend/1backend) - Deploy your backend in seconds. Free tier included. Open source.
...
- [Gitment ![GitHub Repo Stars](https://img.shields.io/github/stars/imsun/gitment) ![GitHub last commit](https://img.shields.io/github/last-commit/imsun/gitment)](https://github.com/imsun/gitment) - Comment system based on GitHub Issues, which can be used in the frontend without any server-side implementation.
- [giscus ![GitHub Repo Stars](https://img.shields.io/github/stars/laymonage/giscus) ![GitHub last commit](https://img.shields.io/github/last-commit/laymonage/giscus)](https://github.com/laymonage/giscus) - A comments widget built on GitHub Discussions.
...
- [Brisk Forms ![GitHub Repo Stars](https://img.shields.io/github/stars/stevensona/briskforms) ![GitHub last commit](https://img.shields.io/github/last-commit/stevensona/briskforms)](https://github.com/stevensona/briskforms) - Free form submission service emails you responses while keeping your email address private and is open source.
...
- [GitHub Issues](https://help.github.com/articles/about-issues/) - This is an interesting way for developers to get comments/questions. See [github.com/sindresorhus/ama ![GitHub Repo Stars](https://img.shields.io/github/stars/sindresorhus/ama) ![GitHub last commit](https://img.shields.io/github/last-commit/sindresorhus/ama)](https://github.com/sindresorhus/ama) for an example.
- [Utterences ![GitHub Repo Stars](https://img.shields.io/github/stars/utterance/utterances) ![GitHub last commit](https://img.shields.io/github/last-commit/utterance/utterances)](https://github.com/utterance/utterances) - A lightweight comments widget built on GitHub issues.
...
- [itemsjs ![GitHub Repo Stars](https://img.shields.io/github/stars/itemsapi/itemsjs) ![GitHub last commit](https://img.shields.io/github/last-commit/itemsapi/itemsjs)](https://github.com/itemsapi/itemsjs) - Full text, faceted, almost dependency free search engine in javascript
- [minisearch ![GitHub Repo Stars](https://img.shields.io/github/stars/lucaong/minisearch) ![GitHub last commit](https://img.shields.io/github/last-commit/lucaong/minisearch)](https://github.com/lucaong/minisearch) - Tiny and powerful JavaScript full-text search engine for browser and Node
- [flexsearch ![GitHub Repo Stars](https://img.shields.io/github/stars/nextapps-de/flexsearch) ![GitHub last commit](https://img.shields.io/github/last-commit/nextapps-de/flexsearch)](https://github.com/nextapps-de/flexsearch) - Next-Generation full text search library for Browser and Node.js
- [fuse.js](https://fusejs.io/) - Powerful, lightweight fuzzy-search library, with zero dependencies
- [static-search ![GitHub Repo Stars](https://img.shields.io/github/stars/dchest/static-search) ![GitHub last commit](https://img.shields.io/github/last-commit/dchest/static-search)](https://github.com/dchest/static-search) - A Go program to generate JSON index of HTML files, and a JavaScript component with optional UI to search this index
...
- [tinysearch ![GitHub Repo Stars](https://img.shields.io/github/stars/tinysearch/tinysearch) ![GitHub last commit](https://img.shields.io/github/last-commit/tinysearch/tinysearch)](https://github.com/tinysearch/tinysearch) - Tiny, full-text search engine for static websites built with Rust and Wasm
...
- [search-index ![GitHub Repo Stars](https://img.shields.io/github/stars/fergiemcdowall/search-index) ![GitHub last commit](https://img.shields.io/github/last-commit/fergiemcdowall/search-index)](https://github.com/fergiemcdowall/search-index) - A persistent, network resilient, full text search library for the browser and Node.js
- [fuzzysearch ![GitHub Repo Stars](https://img.shields.io/github/stars/bevacqua/fuzzysearch) ![GitHub last commit](https://img.shields.io/github/last-commit/bevacqua/fuzzysearch)](https://github.com/bevacqua/fuzzysearch) - Tiny and blazing-fast fuzzy search in JavaScript
- [fuzzy ![GitHub Repo Stars](https://img.shields.io/github/stars/mattyork/fuzzy) ![GitHub last commit](https://img.shields.io/github/last-commit/mattyork/fuzzy)](https://github.com/mattyork/fuzzy) - Fuzzy search / filter for browser and node
...
- [Hulipaa ![GitHub Repo Stars](https://img.shields.io/github/stars/sambuccid/hulipaa) ![GitHub last commit](https://img.shields.io/github/last-commit/sambuccid/hulipaa)](https://github.com/sambuccid/hulipaa) - Static full-text search engine capable of handling thousands of pages with a minimalist searchbar UI to add to your static website.
...
- [Awesome Static Hosting ![GitHub Repo Stars](https://img.shields.io/github/stars/b-long/awesome-static-hosting) ![GitHub last commit](https://img.shields.io/github/last-commit/b-long/awesome-static-hosting)](https://github.com/b-long/awesome-static-hosting)
- [Awesome Azure Static Web Apps ![GitHub Repo Stars](https://img.shields.io/github/stars/staticwebdev/awesome-azure-static-web-apps) ![GitHub last commit](https://img.shields.io/github/last-commit/staticwebdev/awesome-azure-static-web-apps)](https://github.com/staticwebdev/awesome-azure-static-web-apps)
