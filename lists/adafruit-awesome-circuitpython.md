...
- [Awesome List for the RP2040 Macropad ![GitHub Repo Stars](https://img.shields.io/github/stars/prcutler/awesome-macropad) ![GitHub last commit](https://img.shields.io/github/last-commit/prcutler/awesome-macropad)](https://github.com/prcutler/awesome-macropad) - A list of awesome Macropad applications, macros, 3D printed plans, and more.
- [Tod Kurt's CircuitPython Tips and Tricks ![GitHub Repo Stars](https://img.shields.io/github/stars/todbot/circuitpython-tricks) ![GitHub last commit](https://img.shields.io/github/last-commit/todbot/circuitpython-tricks)](https://github.com/todbot/circuitpython-tricks) - A collection of tips and tricks for CircuitPython. Also available as an Adafruit [Learn Guide](https://learn.adafruit.com/todbot-circuitpython-tricks?view=all).
- [Tod Kurt's CircuitPython `synthio` Tips and Tricks ![GitHub Repo Stars](https://img.shields.io/github/stars/todbot/circuitpython-synthio-tricks) ![GitHub last commit](https://img.shields.io/github/last-commit/todbot/circuitpython-synthio-tricks)](https://github.com/todbot/circuitpython-synthio-tricks) - More tips and tricks from Tod Kurt about CircuitPython's `synthio` library.
...
- [Microsoft Device Simulator Express ![GitHub Repo Stars](https://img.shields.io/github/stars/microsoft/vscode-python-devicesimulator) ![GitHub last commit](https://img.shields.io/github/last-commit/microsoft/vscode-python-devicesimulator)](https://github.com/microsoft/vscode-python-devicesimulator) - Virtual Circuit Playground Express and CircuitPython programming in Visual Studio Code (no longer maintained).
...
1. Fork [this repository ![GitHub Repo Stars](https://img.shields.io/github/stars/adafruit/awesome-circuitpython) ![GitHub last commit](https://img.shields.io/github/last-commit/adafruit/awesome-circuitpython)](https://github.com/adafruit/awesome-circuitpython) on GitHub.
