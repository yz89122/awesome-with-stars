...
- [PiCCANTE ![GitHub Repo Stars](https://img.shields.io/github/stars/Alia5/PiCCANTE) ![GitHub last commit](https://img.shields.io/github/last-commit/Alia5/PiCCANTE)](https://github.com/Alia5/PiCCANTE) - Open-source CAN hacking tool based on Raspberry Pi Pico [2] (W) - Up to 3x CAN interfaces, includes ELM327 emulator. 
- [AutoPi ![GitHub Repo Stars](https://img.shields.io/github/stars/autopi-io/autopi-core) ![GitHub last commit](https://img.shields.io/github/last-commit/autopi-io/autopi-core)](https://github.com/autopi-io/autopi-core) - Open-source core software for the AutoPi dongle, a Raspberry Pi-based OBD-II device for vehicle telematics, CAN bus data collection, and automotive IoT applications.
...
- [BlackFlag ECU ![GitHub Repo Stars](https://img.shields.io/github/stars/bad-antics/blackflag-ecu) ![GitHub last commit](https://img.shields.io/github/last-commit/bad-antics/blackflag-ecu)](https://github.com/bad-antics/blackflag-ecu) - Professional ECU diagnostics and tuning suite with OBD-II scanning, DTC reading, live sensor monitoring, and reflash capabilities.
...
- [CANalyzat0r ![GitHub Repo Stars](https://img.shields.io/github/stars/schutzwerk/CANalyzat0r) ![GitHub last commit](https://img.shields.io/github/last-commit/schutzwerk/CANalyzat0r)](https://github.com/schutzwerk/CANalyzat0r) - A security analysis toolkit for proprietary car protocols.
- [Tesla Mod ![GitHub Repo Stars](https://img.shields.io/github/stars/hypery11/flipper-tesla-fsd) ![GitHub last commit](https://img.shields.io/github/last-commit/hypery11/flipper-tesla-fsd)](https://github.com/hypery11/flipper-tesla-fsd) - Tesla CAN bus toolkit for Flipper Zero and ESP32. Nag killer, FSD region unlock, track mode, BMS dashboard, blind spot alert, high beam strobe, and 30+ more CAN handlers. Open source (GPL-3.0).
...
- [canarchy ![GitHub Repo Stars](https://img.shields.io/github/stars/hexsecs/canarchy) ![GitHub last commit](https://img.shields.io/github/last-commit/hexsecs/canarchy)](https://github.com/hexsecs/canarchy) - CANarchy is a stream-first CAN analysis and manipulation runtime designed for automation, security research, and agent-driven workflows.
