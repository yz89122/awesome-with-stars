...
- [Tiniest vWeb Server ![GitHub Repo Stars](https://img.shields.io/github/stars/davlgd/tws) ![GitHub last commit](https://img.shields.io/github/last-commit/davlgd/tws)](https://github.com/davlgd/tws) - A < 1MB static hosting web server written in V, based on x.vweb. 🍃
