...
- [fastgit ![GitHub Repo Stars](https://img.shields.io/github/stars/tailsmails/fastgit) ![GitHub last commit](https://img.shields.io/github/last-commit/tailsmails/fastgit)](https://github.com/tailsmails/fastgit) - A command-line tool written in V, designed to automate and simplify uploading, syncing, and modifying GitHub repositories.
...
- [gatevay ![GitHub Repo Stars](https://img.shields.io/github/stars/tailsmails/gatevay) ![GitHub last commit](https://img.shields.io/github/last-commit/tailsmails/gatevay)](https://github.com/tailsmails/gatevay) - A lightweight, multi-gateway SOCKS5 proxy tool.
...
- [httest ![GitHub Repo Stars](https://img.shields.io/github/stars/gechandesu/httest) ![GitHub last commit](https://img.shields.io/github/last-commit/gechandesu/httest)](https://github.com/gechandesu/httest) - A CGI-enabled HTTP test server for mocking backends, inspecting requests and simulating latency and failures.
...
- [lagger ![GitHub Repo Stars](https://img.shields.io/github/stars/tailsmails/lagger) ![GitHub last commit](https://img.shields.io/github/last-commit/tailsmails/lagger)](https://github.com/tailsmails/lagger) - A dynamic network latency and packet loss simulation proxy designed to emulate real-world network degradation at the application layer.
...
- [minimax-v ![GitHub Repo Stars](https://img.shields.io/github/stars/whiter001/minimax-v) ![GitHub last commit](https://img.shields.io/github/last-commit/whiter001/minimax-v)](https://github.com/whiter001/minimax-v) - Local AI Agent runtime implemented in the V language.
- [mushroomtek ![GitHub Repo Stars](https://img.shields.io/github/stars/tailsmails/mushroomtek) ![GitHub last commit](https://img.shields.io/github/last-commit/tailsmails/mushroomtek)](https://github.com/tailsmails/mushroomtek) - Don't worry about the grid, you are just a radius (Anti-IMSI catcher/Anti-Triangulation...).
- [musicc ![GitHub Repo Stars](https://img.shields.io/github/stars/tailsmails/musicc) ![GitHub last commit](https://img.shields.io/github/last-commit/tailsmails/musicc)](https://github.com/tailsmails/musicc) - A lightweight, high-performance command-line music compiler.
- [netprint ![GitHub Repo Stars](https://img.shields.io/github/stars/tailsmails/netprint) ![GitHub last commit](https://img.shields.io/github/last-commit/tailsmails/netprint)](https://github.com/tailsmails/netprint) - A low-level network telemetry and anomaly detection tool designed to identify environmental changes and traffic interception.
- [newfolder ![GitHub Repo Stars](https://img.shields.io/github/stars/tailsmails/newfolder) ![GitHub last commit](https://img.shields.io/github/last-commit/tailsmails/newfolder)](https://github.com/tailsmails/newfolder) - A lightweight, high-performance command-line steganography, file obfuscation, and secure metadata-destruction workstation written in V.
- [oscall ![GitHub Repo Stars](https://img.shields.io/github/stars/tailsmails/oscall) ![GitHub last commit](https://img.shields.io/github/last-commit/tailsmails/oscall)](https://github.com/tailsmails/oscall) - A native, low-level CLI utility written in V for inspecting, loading, and dynamically executing arbitrary C/C++ functions.
- [pfjson ![GitHub Repo Stars](https://img.shields.io/github/stars/fleximus/pfjson) ![GitHub last commit](https://img.shields.io/github/last-commit/fleximus/pfjson)](https://github.com/fleximus/pfjson) - A CLI tool to convert OpenBSD Packet Filter configuration files (`pf.conf`) to JSON and vice versa.
- [PhoneSnatchProof ![GitHub Repo Stars](https://img.shields.io/github/stars/tailsmails/PhoneSnatchProof) ![GitHub last commit](https://img.shields.io/github/last-commit/tailsmails/PhoneSnatchProof)](https://github.com/tailsmails/PhoneSnatchProof) - An FS that encrypts your app data and keeps them on RAM (with a backup).
- [pixviper ![GitHub Repo Stars](https://img.shields.io/github/stars/tailsmails/pixviper) ![GitHub last commit](https://img.shields.io/github/last-commit/tailsmails/pixviper)](https://github.com/tailsmails/pixviper) - A parallel template matching and de-redaction investigation tool written in V.
...
- [salty ![GitHub Repo Stars](https://img.shields.io/github/stars/tailsmails/salty) ![GitHub last commit](https://img.shields.io/github/last-commit/tailsmails/salty)](https://github.com/tailsmails/salty) - A lightweight command-line utility written in V for secure data encryption, deep compression, and steganographic-like format obfuscation.
- [sockslender ![GitHub Repo Stars](https://img.shields.io/github/stars/tailsmails/sockslender) ![GitHub last commit](https://img.shields.io/github/last-commit/tailsmails/sockslender)](https://github.com/tailsmails/sockslender) - A lightweight, blazing-fast SOCKS5 proxy failover tool written in V.
- [stripshot ![GitHub Repo Stars](https://img.shields.io/github/stars/tailsmails/stripshot) ![GitHub last commit](https://img.shields.io/github/last-commit/tailsmails/stripshot)](https://github.com/tailsmails/stripshot) - Strips device/OS fingerprints from screenshots.
...
- [timingless ![GitHub Repo Stars](https://img.shields.io/github/stars/tailsmails/timingless) ![GitHub last commit](https://img.shields.io/github/last-commit/tailsmails/timingless)](https://github.com/tailsmails/timingless) - A SOCKS5 proxy that sits between your applications and Tor, enforcing constant bandwidth to defeat traffic timing analysis.
...
- [v_llama_cpp ![GitHub Repo Stars](https://img.shields.io/github/stars/sakana-ctf/v_llama_cpp) ![GitHub last commit](https://img.shields.io/github/last-commit/sakana-ctf/v_llama_cpp)](https://github.com/sakana-ctf/v_llama_cpp) - Lightweight V wrapper for Llama.cpp, enabling efficient LLM execution.
...
- [vfc ![GitHub Repo Stars](https://img.shields.io/github/stars/Ict00/vfc) ![GitHub last commit](https://img.shields.io/github/last-commit/Ict00/vfc)](https://github.com/Ict00/vfc) - A simple TUI file manager, made with V.
...
- [vsnap ![GitHub Repo Stars](https://img.shields.io/github/stars/skandhas/vsnap) ![GitHub last commit](https://img.shields.io/github/last-commit/skandhas/vsnap)](https://github.com/skandhas/vsnap) - A tiny local snapshot tool for saving and restoring files before risky edits, lighter than Git and built around explicit paths.
...
- [lilly ![GitHub Repo Stars](https://img.shields.io/github/stars/tauraamui/lilly) ![GitHub last commit](https://img.shields.io/github/last-commit/tauraamui/lilly)](https://github.com/tauraamui/lilly) - TUI editor and VIM/Neovim alternative.
...
- [Dino ![GitHub Repo Stars](https://img.shields.io/github/stars/egevtech/dino) ![GitHub last commit](https://img.shields.io/github/last-commit/egevtech/dino)](https://github.com/egevtech/dino) - A simple console arcade game written in V where you control a dino and avoid cactuses and birds.
...
- [vchess ![GitHub Repo Stars](https://img.shields.io/github/stars/hedgeg0d/vchess) ![GitHub last commit](https://img.shields.io/github/last-commit/hedgeg0d/vchess)](https://github.com/hedgeg0d/vchess) - Chess game written in V programming language.
...
- [vpaint ![GitHub Repo Stars](https://img.shields.io/github/stars/pisaiah/vpaint) ![GitHub last commit](https://img.shields.io/github/last-commit/pisaiah/vpaint)](https://github.com/pisaiah/vpaint) - MS-Paint alternative written in V.
...
- [papyrus-compiler ![GitHub Repo Stars](https://img.shields.io/github/stars/russo-2025/papyrus-compiler) ![GitHub last commit](https://img.shields.io/github/last-commit/russo-2025/papyrus-compiler)](https://github.com/russo-2025/papyrus-compiler) - Open-source compiler for Bethesda's Papyrus scripting language (Skyrim SE/AE).
...
- [boj-server ![GitHub Repo Stars](https://img.shields.io/github/stars/hyperpolymath/boj-server) ![GitHub last commit](https://img.shields.io/github/last-commit/hyperpolymath/boj-server)](https://github.com/hyperpolymath/boj-server) - Unified developer tool server using V for the network adapter layer. Exposes REST (port 7700), gRPC (7701), and GraphQL (7702) from a single V codebase. 18 capability cartridges loaded via Zig FFI with Idris2-verified interfaces.
...
- [qptorrent ![GitHub Repo Stars](https://img.shields.io/github/stars/qptorrent/qptorrent) ![GitHub last commit](https://img.shields.io/github/last-commit/qptorrent/qptorrent)](https://github.com/qptorrent/qptorrent) - A minimal GUI/CLI BitTorrent client written in V + vlang/gui.
- [raur ![GitHub Repo Stars](https://img.shields.io/github/stars/Matejsdevelopment/raur) ![GitHub last commit](https://img.shields.io/github/last-commit/Matejsdevelopment/raur)](https://github.com/Matejsdevelopment/raur) - Simple Arch User Repository (AUR) helper coded in Vlang.
- [unix-emulators-win ![GitHub Repo Stars](https://img.shields.io/github/stars/Ddiidev/unix-emulators-win) ![GitHub last commit](https://img.shields.io/github/last-commit/Ddiidev/unix-emulators-win)](https://github.com/Ddiidev/unix-emulators-win) - Collection of 16 UNIX utilities rewritten in V for Windows.
...
- [gitval ![GitHub Repo Stars](https://img.shields.io/github/stars/davlgd/gitval) ![GitHub last commit](https://img.shields.io/github/last-commit/davlgd/gitval)](https://github.com/davlgd/gitval) - A static site generator for Git repositories, written in V.
...
- [Mustela ![GitHub Repo Stars](https://img.shields.io/github/stars/filipos800/mustela) ![GitHub last commit](https://img.shields.io/github/last-commit/filipos800/mustela)](https://github.com/filipos800/mustela) - Ultra-high-performance static site generator (SSG) engineered for speed (>9,000 pages/sec) and total data sovereignty.
...
- [Verne ![GitHub Repo Stars](https://img.shields.io/github/stars/davlgd/Verne) ![GitHub last commit](https://img.shields.io/github/last-commit/davlgd/Verne)](https://github.com/davlgd/Verne) - The other static site generator named after a famous French author.
- [vico_bot ![GitHub Repo Stars](https://img.shields.io/github/stars/KArjmand/vico_bot) ![GitHub last commit](https://img.shields.io/github/last-commit/KArjmand/vico_bot)](https://github.com/KArjmand/vico_bot) - Lightweight self-hosted AI chatbot with persistent memory and tool calling.
...
- [v-webdriver ![GitHub Repo Stars](https://img.shields.io/github/stars/quaesitor-scientiam/v-webdriver) ![GitHub last commit](https://img.shields.io/github/last-commit/quaesitor-scientiam/v-webdriver)](https://github.com/quaesitor-scientiam/v-webdriver) - A V language implementation of the W3C WebDriver protocol for browser automation.
...
- [rxv ![GitHub Repo Stars](https://img.shields.io/github/stars/ulises-jeremias/rxv) ![GitHub last commit](https://img.shields.io/github/last-commit/ulises-jeremias/rxv)](https://github.com/ulises-jeremias/rxv) - Reactive Extensions for the V language. Compose async event streams with creation, filtering, transformation, aggregation, timing, and combination operators.
...
- [sdl2test ![GitHub Repo Stars](https://img.shields.io/github/stars/nsauzede/sdl2test) ![GitHub last commit](https://img.shields.io/github/last-commit/nsauzede/sdl2test)](https://github.com/nsauzede/sdl2test) - Exhaustive suite of tests and examples for SDL2 with V.
...
- [svgg ![GitHub Repo Stars](https://img.shields.io/github/stars/Avocadocs/svgg) ![GitHub last commit](https://img.shields.io/github/last-commit/Avocadocs/svgg)](https://github.com/Avocadocs/svgg) - V module to load and resterize svg file into `gg.Image` object.
...
- [vglyph ![GitHub Repo Stars](https://img.shields.io/github/stars/vlang/vglyph) ![GitHub last commit](https://img.shields.io/github/last-commit/vlang/vglyph)](https://github.com/vlang/vglyph) - High-performance text rendering engine for the V programming language, built on Pango, FreeType, and Sokol.
...
- [vsl.vcl ![GitHub Repo Stars](https://img.shields.io/github/stars/vlang/vsl) ![GitHub last commit](https://img.shields.io/github/last-commit/vlang/vsl)](https://github.com/vlang/vsl/tree/main/vcl#readme) - VCL is a high level way of writing programs with OpenCL using V. These are highly opinionated OpenCL bindings for V. It tries to make GPU computing easy, with some sugar abstraction, V's concurrency and channels.
- [vsl.plot ![GitHub Repo Stars](https://img.shields.io/github/stars/vlang/vsl) ![GitHub last commit](https://img.shields.io/github/last-commit/vlang/vsl)](https://github.com/vlang/vsl/tree/main/plot#readme) - Plotting module for VSL with 85+ examples. Create line charts, scatter plots, 3D surfaces, bar charts, box plots, histograms, heatmaps, and more.
...
- [vjsx ![GitHub Repo Stars](https://img.shields.io/github/stars/guweigang/vjsx) ![GitHub last commit](https://img.shields.io/github/last-commit/guweigang/vjsx)](https://github.com/guweigang/vjsx) - V bindings to quickjs javascript engine. Run JS in V.
- [vphp ![GitHub Repo Stars](https://img.shields.io/github/stars/guweigang/vphp) ![GitHub last commit](https://img.shields.io/github/last-commit/guweigang/vphp)](https://github.com/guweigang/vphp) - Vlang library for building PHP extensions natively in Vlang.
...
- [rgc ![GitHub Repo Stars](https://img.shields.io/github/stars/tailsmails/rgc) ![GitHub last commit](https://img.shields.io/github/last-commit/tailsmails/rgc)](https://github.com/tailsmails/rgc) - A lightweight, concurrent resource garbage collector for V.
- [vcomp ![GitHub Repo Stars](https://img.shields.io/github/stars/tailsmails/vcomp) ![GitHub last commit](https://img.shields.io/github/last-commit/tailsmails/vcomp)](https://github.com/tailsmails/vcomp) - A lightweight Linux Seccomp (Secure Computing Mode) BPF filter wrapper for vlang.
...
- [vsl.fft ![GitHub Repo Stars](https://img.shields.io/github/stars/vlang/vsl) ![GitHub last commit](https://img.shields.io/github/last-commit/vlang/vsl)](https://github.com/vlang/vsl/tree/main/fft#readme) - Fast Fourier Transform module for VSL. Includes real and complex FFT with multiple backend options.
- [vsl.ml ![GitHub Repo Stars](https://img.shields.io/github/stars/vlang/vsl) ![GitHub last commit](https://img.shields.io/github/last-commit/vlang/vsl)](https://github.com/vlang/vsl/tree/main/ml#readme) - Machine Learning module for VSL with K-means, KNN, linear/logistic regression, SVM, decision trees, random forest, and more.
- [vsl.quaternion ![GitHub Repo Stars](https://img.shields.io/github/stars/vlang/vsl) ![GitHub last commit](https://img.shields.io/github/last-commit/vlang/vsl)](https://github.com/vlang/vsl/tree/main/quaternion#readme) - Quaternion math module for VSL. Supports 3D rotations, spherical linear interpolation (slerp), and Julia fractal generation.
...
- [vtl.autograd ![GitHub Repo Stars](https://img.shields.io/github/stars/vlang/vtl) ![GitHub last commit](https://img.shields.io/github/last-commit/vlang/vtl)](https://github.com/vlang/vtl/tree/main/autograd#readme) - Automatic differentiation module for VTL. Enables gradient computation for machine learning and optimization.
- [vtl.datasets ![GitHub Repo Stars](https://img.shields.io/github/stars/vlang/vtl) ![GitHub last commit](https://img.shields.io/github/last-commit/vlang/vtl)](https://github.com/vlang/vtl/tree/main/datasets#readme) - Datasets module for VTL providing built-in datasets for ML benchmarking and tutorials.
- [vtl.nn ![GitHub Repo Stars](https://img.shields.io/github/stars/vlang/vtl) ![GitHub last commit](https://img.shields.io/github/last-commit/vlang/vtl)](https://github.com/vlang/vtl/tree/main/nn#readme) - Neural Networks module for VTL. Build and train deep learning models with layers, activations, and optimizers.
...
- [velegram ![GitHub Repo Stars](https://img.shields.io/github/stars/tailsmails/velegram) ![GitHub last commit](https://img.shields.io/github/last-commit/tailsmails/velegram)](https://github.com/tailsmails/velegram) - A V language wrapper for TDLib (Telegram Database Library).
...
- [vsoup ![GitHub Repo Stars](https://img.shields.io/github/stars/marcalc/vsoup) ![GitHub last commit](https://img.shields.io/github/last-commit/marcalc/vsoup)](https://github.com/marcalc/vsoup) - A fast, JSoup-inspired HTML5 parser and DOM manipulation library for V, powered by Lexbor.
...
- [xlsx ![GitHub Repo Stars](https://img.shields.io/github/stars/hungrybluedev/xlsx) ![GitHub last commit](https://img.shields.io/github/last-commit/hungrybluedev/xlsx)](https://github.com/hungrybluedev/xlsx) - V library for reading and writing Microsoft Excel files.
...
- [bobatea ![GitHub Repo Stars](https://img.shields.io/github/stars/tauraamui/bobatea) ![GitHub last commit](https://img.shields.io/github/last-commit/tauraamui/bobatea)](https://github.com/tauraamui/bobatea) - TUI framework inspired by Bubble Tea.
...
- [v-hash ![GitHub Repo Stars](https://img.shields.io/github/stars/deatil/v-hash) ![GitHub last commit](https://img.shields.io/github/last-commit/deatil/v-hash)](https://github.com/deatil/v-hash) - A hash library for vlang.
- [v-rsa ![GitHub Repo Stars](https://img.shields.io/github/stars/deatil/v-rsa) ![GitHub last commit](https://img.shields.io/github/last-commit/deatil/v-rsa)](https://github.com/deatil/v-rsa) - A RSA library for vlang.
...
- [vanadium ![GitHub Repo Stars](https://img.shields.io/github/stars/tailsmails/vanadium) ![GitHub last commit](https://img.shields.io/github/last-commit/tailsmails/vanadium)](https://github.com/tailsmails/vanadium) - Ada-level runtime safety for the V programming language.
...
- [vop ![GitHub Repo Stars](https://img.shields.io/github/stars/tailsmails/vop) ![GitHub last commit](https://img.shields.io/github/last-commit/tailsmails/vop)](https://github.com/tailsmails/vop) - A message-passing object protocol providing dynamic property management and closure-based state encapsulation.
...
- [v-jwt ![GitHub Repo Stars](https://img.shields.io/github/stars/deatil/v-jwt) ![GitHub last commit](https://img.shields.io/github/last-commit/deatil/v-jwt)](https://github.com/deatil/v-jwt) - A JWT (JSON Web Token) library for vlang.
- [v-sm3 ![GitHub Repo Stars](https://img.shields.io/github/stars/deatil/v-sm3) ![GitHub last commit](https://img.shields.io/github/last-commit/deatil/v-sm3)](https://github.com/deatil/v-sm3) - A SM3 hash function for vlang.
...
- [veb ![GitHub Repo Stars](https://img.shields.io/github/stars/vlang/v) ![GitHub last commit](https://img.shields.io/github/last-commit/vlang/v)](https://github.com/vlang/v/tree/master/vlib/veb) - V's built-in web framework.
...
#### Zed
- [zed-v ![GitHub Repo Stars](https://img.shields.io/github/stars/lv37/zed-v) ![GitHub last commit](https://img.shields.io/github/last-commit/lv37/zed-v)](https://github.com/lv37/zed-v) - Support for V syntax highlighting in Zed.
...
- [setup-v ![GitHub Repo Stars](https://img.shields.io/github/stars/vlang/setup-v) ![GitHub last commit](https://img.shields.io/github/last-commit/vlang/setup-v)](https://github.com/vlang/setup-v) - GitHub Action to install and use V in your workflow. Available on the [marketplace ![GitHub Repo Stars](https://img.shields.io/github/stars/marketplace/actions) ![GitHub last commit](https://img.shields.io/github/last-commit/marketplace/actions)](https://github.com/marketplace/actions/setup-vlang).
