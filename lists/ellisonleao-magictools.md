...
- :free: [WorldLoop ![GitHub Repo Stars](https://img.shields.io/github/stars/Daniele-Cangi/worldloop-technical-showcase) ![GitHub last commit](https://img.shields.io/github/last-commit/Daniele-Cangi/worldloop-technical-showcase)](https://github.com/Daniele-Cangi/worldloop-technical-showcase) - Procedural architecture and world generation combining semantic CAD, playable structures, voxel terrain, caves and water, with direct export to Roblox Studio
...
- :tada: [Carimbo ![GitHub Repo Stars](https://img.shields.io/github/stars/willtobyte/carimbo) ![GitHub last commit](https://img.shields.io/github/last-commit/willtobyte/carimbo)](https://github.com/willtobyte/carimbo) - A 2D game engine developed in modern C++ using SDL, an Entity-Component-System (ECS) architecture, and Box2D. It features Lua scripting and is designed for web portability via WebAssembly.
...
- :tada: [Codename One ![GitHub Repo Stars](https://img.shields.io/github/stars/codenameone/CodenameOne) ![GitHub last commit](https://img.shields.io/github/last-commit/codenameone/CodenameOne)](https://github.com/codenameone/CodenameOne) - Cross-platform Java framework with beta game APIs and a visual Game Builder for 2D and 3D games.
...
- :free: :tada: [Folded Paper Engine ![GitHub Repo Stars](https://img.shields.io/github/stars/papercraftgames/folded-paper-engine) ![GitHub last commit](https://img.shields.io/github/last-commit/papercraftgames/folded-paper-engine)](https://github.com/papercraftgames/folded-paper-engine) – Blender to Godot game mechanics engine/plug-ins. Just a few clicks. Super easy. Featuring: 2.5D/first-person/third-person controls, trigger commands/events, inventory, holdable items and all kinds of stuff.
...
- :tada: [GameFrameX ![GitHub Repo Stars](https://img.shields.io/github/stars/GameFrameX/GameFrameX) ![GitHub last commit](https://img.shields.io/github/last-commit/GameFrameX/GameFrameX)](https://github.com/GameFrameX/GameFrameX) - A cross-engine game framework: Unity and Godot clients on a single actor-model .NET server, sharing one Protobuf contract and LuBan config pipeline. AI-agent friendly: instruction docs in-repo, codegen'd protocol/config layers.
...
- :tada: [is::Engine ![GitHub Repo Stars](https://img.shields.io/github/stars/Is-Daouda/is-Engine) ![GitHub last commit](https://img.shields.io/github/last-commit/Is-Daouda/is-Engine)](https://github.com/Is-Daouda/is-Engine) - C++, SDL 2 and SFML game engine that allows to create games on Nintendo Switch, Web (HTML 5), Mobile and PC.
...
- :tada: [Parlour ![GitHub Repo Stars](https://img.shields.io/github/stars/braedonsaunders/parlour) ![GitHub last commit](https://img.shields.io/github/last-commit/braedonsaunders/parlour)](https://github.com/braedonsaunders/parlour) - Deterministic TypeScript card-game engine with a cozy playable browser table (Blitz, Wild, P2P rooms, no backend).
...
- :tada: [steamworks-ffi-node ![GitHub Repo Stars](https://img.shields.io/github/stars/ArtyProf/steamworks-ffi-node) ![GitHub last commit](https://img.shields.io/github/last-commit/ArtyProf/steamworks-ffi-node)](https://github.com/ArtyProf/steamworks-ffi-node) - a Node.js wrapper for Steamworks SDK.
...
- :tada: [vectarine ![GitHub Repo Stars](https://img.shields.io/github/stars/vanyle/vectarine) ![GitHub last commit](https://img.shields.io/github/last-commit/vanyle/vectarine)](https://github.com/vanyle/vectarine/) - Vectarine is a cross-platform game engine focusing on fast prototyping and having fun. Write games using Luau and extend the engine with Rust modules.
...
### AI
- :tada: [AI Game Developer ![GitHub Repo Stars](https://img.shields.io/github/stars/IvanMurzak/Unity-MCP) ![GitHub last commit](https://img.shields.io/github/last-commit/IvanMurzak/Unity-MCP)](https://github.com/IvanMurzak/Unity-MCP) - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
