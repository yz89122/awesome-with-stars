...
[<img src="https://github.com/shano/awesome-backstage/raw/main/backstage-logo.svg" align="right" width="100">](https://backstage.io)
...
- [GitHub Repository ![GitHub Repo Stars](https://img.shields.io/github/stars/backstage/backstage) ![GitHub last commit](https://img.shields.io/github/last-commit/backstage/backstage)](https://github.com/backstage/backstage)
...
- [Catalog ![GitHub Repo Stars](https://img.shields.io/github/stars/backstage/backstage) ![GitHub last commit](https://img.shields.io/github/last-commit/backstage/backstage)](https://github.com/backstage/backstage/tree/master/plugins/catalog) - Provides an inventory of all components in your ecosystem.
- [TechDocs ![GitHub Repo Stars](https://img.shields.io/github/stars/backstage/backstage) ![GitHub last commit](https://img.shields.io/github/last-commit/backstage/backstage)](https://github.com/backstage/backstage/tree/master/plugins/techdocs) - Manage and display technical documentation for your components.
- [Scaffolder ![GitHub Repo Stars](https://img.shields.io/github/stars/backstage/backstage) ![GitHub last commit](https://img.shields.io/github/last-commit/backstage/backstage)](https://github.com/backstage/backstage/tree/master/plugins/scaffolder) - Create new components using templates.
- [Cost Insights ![GitHub Repo Stars](https://img.shields.io/github/stars/backstage/community-plugins) ![GitHub last commit](https://img.shields.io/github/last-commit/backstage/community-plugins)](https://github.com/backstage/community-plugins/tree/main/workspaces/cost-insights/plugins/cost-insights) - Gain insights into your cloud costs.

### Community Plugins

- [Community Plugins ![GitHub Repo Stars](https://img.shields.io/github/stars/backstage/community-plugins) ![GitHub last commit](https://img.shields.io/github/last-commit/backstage/community-plugins)](https://github.com/backstage/community-plugins) - Where Backstage maintains the list of community plugins available.
...
- [Qeta ![GitHub Repo Stars](https://img.shields.io/github/stars/drodil/backstage-plugin-qeta) ![GitHub last commit](https://img.shields.io/github/last-commit/drodil/backstage-plugin-qeta)](https://github.com/drodil/backstage-plugin-qeta) - Stack Overflow-inspired Q&A and knowledge sharing plugin for questions, answers, articles, collections, and AI-assisted collaboration.
- [Bazaar ![GitHub Repo Stars](https://img.shields.io/github/stars/backstage/community-plugins) ![GitHub last commit](https://img.shields.io/github/last-commit/backstage/community-plugins)](https://github.com/backstage/community-plugins/tree/main/workspaces/bazaar/plugins/bazaar) - Discover and collaborate on internal projects within your organization.
- [backstage-aws-cloudformation-plugin ![GitHub Repo Stars](https://img.shields.io/github/stars/purple-technology/backstage-aws-cloudformation-plugin) ![GitHub last commit](https://img.shields.io/github/last-commit/purple-technology/backstage-aws-cloudformation-plugin)](https://github.com/purple-technology/backstage-aws-cloudformation-plugin) - Manage AWS CloudFormation stacks.
...
- [Toolbox ![GitHub Repo Stars](https://img.shields.io/github/stars/drodil/backstage-plugin-toolbox) ![GitHub last commit](https://img.shields.io/github/last-commit/drodil/backstage-plugin-toolbox)](https://github.com/drodil/backstage-plugin-toolbox) - Add a toolbox page with built-in and custom developer utilities directly inside Backstage.
...
- [Backstage Community ![GitHub Repo Stars](https://img.shields.io/github/stars/backstage/community) ![GitHub last commit](https://img.shields.io/github/last-commit/backstage/community)](https://github.com/backstage/community) - Join the Backstage community to ask questions and share your knowledge.
- [Good First Issues ![GitHub Repo Stars](https://img.shields.io/github/stars/backstage/backstage) ![GitHub last commit](https://img.shields.io/github/last-commit/backstage/backstage)](https://github.com/backstage/backstage/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) - Contribute to the project by tackling "Good First Issues" on GitHub.
...
- [RFCs on GitHub ![GitHub Repo Stars](https://img.shields.io/github/stars/backstage/backstage) ![GitHub last commit](https://img.shields.io/github/last-commit/backstage/backstage)](https://github.com/backstage/backstage/labels/RFC) - Track active proposals and community feedback.

## Related Projects

- [Lighthouse ![GitHub Repo Stars](https://img.shields.io/github/stars/GoogleChrome/lighthouse-ci) ![GitHub last commit](https://img.shields.io/github/last-commit/GoogleChrome/lighthouse-ci)](https://github.com/GoogleChrome/lighthouse-ci) - Automate running Lighthouse for every commit and viewing the changes over time.
- [Roadie](https://roadie.io/) - Managed Backstage service for enterprises.
- [KubeStellar Console ![GitHub Repo Stars](https://img.shields.io/github/stars/kubestellar/console) ![GitHub last commit](https://img.shields.io/github/last-commit/kubestellar/console)](https://github.com/kubestellar/console) - Multi-cluster Kubernetes management portal complementary to Backstage; provides cluster health, GitOps, RBAC management and AI-assisted operations for platform engineering teams.
