...
Please give it a star(⭐) to support the development. Read about history of Awesome J2ME and reverse engineering projects in <a href="https://hstsethi.vercel.app/posts/programming/awesome-j2me">this blog post</a>. Also check out [Awesome Symbian ![GitHub Repo Stars](https://img.shields.io/github/stars/hstsethi/awesome-symbian) ![GitHub last commit](https://img.shields.io/github/last-commit/hstsethi/awesome-symbian)](https://github.com/hstsethi/awesome-symbian).
