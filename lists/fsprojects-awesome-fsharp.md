...
- [Chia ![GitHub Repo Stars](https://img.shields.io/github/stars/DanpowerGruppe/Chia) ![GitHub last commit](https://img.shields.io/github/last-commit/DanpowerGruppe/Chia)](https://github.com/DanpowerGruppe/Chia) - Chia is a F# library which contains HelperFunctions for reporting, logging and Azure cloud operations.
...
- [Myriad ![GitHub Repo Stars](https://img.shields.io/github/stars/MoiraeSoftware/myriad) ![GitHub last commit](https://img.shields.io/github/last-commit/MoiraeSoftware/myriad)](https://github.com/MoiraeSoftware/myriad) - Myriad is a pre-compilation code generator.
...
- [VimSpeak ![GitHub Repo Stars](https://img.shields.io/github/stars/AshleyF/VimSpeak) ![GitHub last commit](https://img.shields.io/github/last-commit/AshleyF/VimSpeak)](https://github.com/AshleyF/VimSpeak) - VimSpeak lets you control Vim with your voice using speech recognition.
...
- [FSharpx.Extras ![GitHub Repo Stars](https://img.shields.io/github/stars/fsprojects/FSharpx.Extras) ![GitHub last commit](https://img.shields.io/github/last-commit/fsprojects/FSharpx.Extras)](https://github.com/fsprojects/FSharpx.Extras) - FSharpx.Extras is a collection of libraries and tools for use with F#.
...
- [Fling ![GitHub Repo Stars](https://img.shields.io/github/stars/cmeeren/Fling) ![GitHub last commit](https://img.shields.io/github/last-commit/cmeeren/Fling)](https://github.com/cmeeren/Fling) - Fling significantly reduces boilerplate needed to efficiently save/load complex domain entities to/from multiple tables.
...
- [FsUnit ![GitHub Repo Stars](https://img.shields.io/github/stars/fsprojects/FsUnit) ![GitHub last commit](https://img.shields.io/github/last-commit/fsprojects/FsUnit)](https://github.com/fsprojects/FsUnit) - FsUnit makes unit-testing with F# more enjoyable. It adds a special syntax to your favorite .NET testing framework.
...
- [Facil ![GitHub Repo Stars](https://img.shields.io/github/stars/cmeeren/Facil) ![GitHub last commit](https://img.shields.io/github/last-commit/cmeeren/Facil)](https://github.com/cmeeren/Facil) - Facil generates F# data access source code from SQL queries and stored procedures.
...
- [Suave ![GitHub Repo Stars](https://img.shields.io/github/stars/SuaveIO/suave) ![GitHub last commit](https://img.shields.io/github/last-commit/SuaveIO/suave)](https://github.com/SuaveIO/suave) - Suave is a simple web development F# library providing a lightweight web server and a set of combinators to manipulate route flow and task composition.
