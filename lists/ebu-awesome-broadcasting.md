...
* [caspar-obs-client ![GitHub Repo Stars](https://img.shields.io/github/stars/michalramus/caspar-obs-client) ![GitHub last commit](https://img.shields.io/github/last-commit/michalramus/caspar-obs-client)](https://github.com/michalramus/caspar-obs-client) - Python GUI application for seamless integration between CasparCG media servers and OBS Studio.
...
* [Podlove Publisher ![GitHub Repo Stars](https://img.shields.io/github/stars/podlove/podlove-publisher) ![GitHub last commit](https://img.shields.io/github/last-commit/podlove/podlove-publisher)](https://github.com/podlove/podlove-publisher) - Podcast Publisher for WordPress.
* [Podlove Web Player ![GitHub Repo Stars](https://img.shields.io/github/stars/podlove/podlove-ui) ![GitHub last commit](https://img.shields.io/github/last-commit/podlove/podlove-ui)](https://github.com/podlove/podlove-ui) - Podcast-optimized, HTML5-based video and audio player.
...
* [ATEM Tally Light with ESP8266 ![GitHub Repo Stars](https://img.shields.io/github/stars/AronHetLam/ATEM_tally_light_with_ESP8266) ![GitHub last commit](https://img.shields.io/github/last-commit/AronHetLam/ATEM_tally_light_with_ESP8266)](https://github.com/AronHetLam/ATEM_tally_light_with_ESP8266) - Wireless tally light for ATEM switchers using an ESP8266 WiFi module, supporting unlimited tally units.
...
* [MOS-connection ![GitHub Repo Stars](https://img.shields.io/github/stars/Sofie-Automation/sofie-mos-connection) ![GitHub last commit](https://img.shields.io/github/last-commit/Sofie-Automation/sofie-mos-connection)](https://github.com/Sofie-Automation/sofie-mos-connection) - A JavaScript library for connection and MOS messaging either as MOS device or NRCS.
* [obs-shotlister ![GitHub Repo Stars](https://img.shields.io/github/stars/michalramus/obs-shotlister) ![GitHub last commit](https://img.shields.io/github/last-commit/michalramus/obs-shotlister)](https://github.com/michalramus/obs-shotlister) - Camera shot queue manager for live productions with OBS Studio integration, LAN web monitoring, and OSC support.
...
* [TallyLights ![GitHub Repo Stars](https://img.shields.io/github/stars/michalramus/TallyLights) ![GitHub last commit](https://img.shields.io/github/last-commit/michalramus/TallyLights)](https://github.com/michalramus/TallyLights) - DIY tally lights supporting TSL 3.1 and 5.0 protocols, built around the WeMos D1 Mini microcontroller.
...
* [wifi-tally ![GitHub Repo Stars](https://img.shields.io/github/stars/wifi-tally/wifi-tally) ![GitHub last commit](https://img.shields.io/github/last-commit/wifi-tally/wifi-tally)](https://github.com/wifi-tally/wifi-tally) - Affordable WiFi-enabled tally light system based on NodeMCU/ESP8266, supporting multiple video mixers.
