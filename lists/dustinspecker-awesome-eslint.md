...
- [SonarJS ![GitHub Repo Stars](https://img.shields.io/github/stars/SonarSource/SonarJS) ![GitHub last commit](https://img.shields.io/github/last-commit/SonarSource/SonarJS)](https://github.com/SonarSource/SonarJS/blob/master/packages/jsts/src/rules/README.md) - Rules detecting bugs and suspicious patterns.
...
- [eslint-plugin-code-complete ![GitHub Repo Stars](https://img.shields.io/github/stars/aryelu/eslint-plugin-code-complete) ![GitHub last commit](https://img.shields.io/github/last-commit/aryelu/eslint-plugin-code-complete)](https://github.com/aryelu/eslint-plugin-code-complete) - A custom ESLint plugin that enforces principles of clean, maintainable software design — inspired by Code Complete.
...
- React
  - [JSX a11y ![GitHub Repo Stars](https://img.shields.io/github/stars/jsx-eslint/eslint-plugin-jsx-a11y) ![GitHub last commit](https://img.shields.io/github/last-commit/jsx-eslint/eslint-plugin-jsx-a11y)](https://github.com/jsx-eslint/eslint-plugin-jsx-a11y) - Accessibility rules on JSX elements.
  ...
  - [React Refresh ![GitHub Repo Stars](https://img.shields.io/github/stars/ArnaudBarre/eslint-plugin-react-refresh) ![GitHub last commit](https://img.shields.io/github/last-commit/ArnaudBarre/eslint-plugin-react-refresh)](https://github.com/ArnaudBarre/eslint-plugin-react-refresh) - Improve HMR experience when using Vite.
...
- [eslint-plugin-error-cause ![GitHub Repo Stars](https://img.shields.io/github/stars/Amnish04/eslint-plugin-error-cause) ![GitHub last commit](https://img.shields.io/github/last-commit/Amnish04/eslint-plugin-error-cause)](https://github.com/Amnish04/eslint-plugin-error-cause) - A plugin to preserve original error context when re-throwing exceptions.
...
- [Math ![GitHub Repo Stars](https://img.shields.io/github/stars/ota-meshi/eslint-plugin-math) ![GitHub last commit](https://img.shields.io/github/last-commit/ota-meshi/eslint-plugin-math)](https://github.com/ota-meshi/eslint-plugin-math) - ESLint plugin related to Math object and Number.
