...
- [p8dl - Carts Downloader - Python ![GitHub Repo Stars](https://img.shields.io/github/stars/franciscod/p8dl) ![GitHub last commit](https://img.shields.io/github/last-commit/franciscod/p8dl)](https://github.com/franciscod/p8dl) - Downloads cartridges into the correct folder (looks at your config.txt).
...
- [jspicl ![GitHub Repo Stars](https://img.shields.io/github/stars/jspicl/jspicl) ![GitHub last commit](https://img.shields.io/github/last-commit/jspicl/jspicl)](https://github.com/jspicl/jspicl) - Write PICO-8 games in JavaScript or TypeScript, with live reloading so you can see your changes instantly!
...
- [pico8-physics ![GitHub Repo Stars](https://img.shields.io/github/stars/jamesedge/pico8-physics) ![GitHub last commit](https://img.shields.io/github/last-commit/jamesedge/pico8-physics)](https://github.com/jamesedge/pico8-physics) - Pico8 implementation of Box2d with 8 demos.
- [SCUMM-8 ![GitHub Repo Stars](https://img.shields.io/github/stars/Liquidream/scumm-8) ![GitHub last commit](https://img.shields.io/github/last-commit/Liquidream/scumm-8)](https://github.com/Liquidream/scumm-8) - De-make of the SCUMM engine for making point-and-click classic adventures.
...
- Visual Studio Code / NeoVim / JetBrains / Others： [pico8-definitions ![GitHub Repo Stars](https://img.shields.io/github/stars/ahai64/pico8-definitions) ![GitHub last commit](https://img.shields.io/github/last-commit/ahai64/pico8-definitions)](https://github.com/ahai64/pico8-definitions) - An add-on for sumneko/lua to provide PICO-8 language support.
...
- [Pikuseru ![GitHub Repo Stars](https://img.shields.io/github/stars/PikuseruConsole/pikuseru) ![GitHub last commit](https://img.shields.io/github/last-commit/PikuseruConsole/pikuseru)](https://github.com/PikuseruConsole/pikuseru) - Open Source Fantasy Console in pure Rust [Core].
