...
- [gnat-ce (discontinued) ![GitHub Repo Stars](https://img.shields.io/github/stars/AdaCore/gnat-community-archives) ![GitHub last commit](https://img.shields.io/github/last-commit/AdaCore/gnat-community-archives)](https://github.com/AdaCore/gnat-community-archives) - GNAT Community edition. A release of AdaCore GNAT for free software developers, hobbyists, and students. The run-time libraries provided with GNAT Community are licensed under GPLv3 without linking exception. It supports Ada 2012 only.
...
- [ravenadm ![GitHub Repo Stars](https://img.shields.io/github/stars/jrmarino/ravenadm) ![GitHub last commit](https://img.shields.io/github/last-commit/jrmarino/ravenadm)](https://github.com/jrmarino/ravenadm) - Administration tool for Ravenports http://www.ravenports.com.
...
- [Straylight ![GitHub Repo Stars](https://img.shields.io/github/stars/ajxs/straylight) ![GitHub last commit](https://img.shields.io/github/last-commit/ajxs/straylight)](https://github.com/ajxs/straylight) - A simple monolithic RISC-V operating system developed in Ada.
...
- [xxhash-ada ![GitHub Repo Stars](https://img.shields.io/github/stars/lyarbean/xxhash-ada) ![GitHub last commit](https://img.shields.io/github/last-commit/lyarbean/xxhash-ada)](https://github.com/lyarbean/xxhash-ada) - Extremely fast non-cryptographic Hash algorithm, xxhash is working at speeds close to RAM limits.
...
- [AdaTracker ![GitHub Repo Stars](https://img.shields.io/github/stars/UlrikHjort/Ada-Tracker) ![GitHub last commit](https://img.shields.io/github/last-commit/UlrikHjort/Ada-Tracker)](https://github.com/UlrikHjort/Ada-Tracker) - A MOD, XM, S3M, and IT music tracker player written in Ada, using SDL2 for audio output and UI rendering.
...
### Linux and POSIX
- [florist ![GitHub Repo Stars](https://img.shields.io/github/stars/AdaCore/florist) ![GitHub last commit](https://img.shields.io/github/last-commit/AdaCore/florist)](https://github.com/AdaCore/florist/) - POSIX Ada binding, IEEE Standards 1003.5(b,c).
- [florist-blady ![GitHub Repo Stars](https://img.shields.io/github/stars/Blady-Com/florist) ![GitHub last commit](https://img.shields.io/github/last-commit/Blady-Com/florist)](https://github.com/Blady-Com/florist) - A fork of Florist which is available as an Alire crate.
...
- [libgfxinit ![GitHub Repo Stars](https://img.shields.io/github/stars/coreboot/libgfxinit) ![GitHub last commit](https://img.shields.io/github/last-commit/coreboot/libgfxinit)](https://github.com/coreboot/libgfxinit) - A graphics initialization (aka modesetting) library for embedded environments, implemented in SPARK.
...
- [spark-railway-demo ![GitHub Repo Stars](https://img.shields.io/github/stars/Fabien-Chouteau/spark-railway-demo) ![GitHub last commit](https://img.shields.io/github/last-commit/Fabien-Chouteau/spark-railway-demo)](https://github.com/Fabien-Chouteau/spark-railway-demo) - Simulated railway network in SPARK/Ada.
- [micro-tem-pi ![GitHub Repo Stars](https://img.shields.io/github/stars/jklmnn/MicroTemPi) ![GitHub last commit](https://img.shields.io/github/last-commit/jklmnn/MicroTemPi)](https://github.com/jklmnn/MicroTemPi) - Raspberry Pi using a BBC Micro:Bit as temperature sensor.
- [wee-noise-maker ![GitHub Repo Stars](https://img.shields.io/github/stars/Fabien-Chouteau/Wee-Noise-Maker) ![GitHub last commit](https://img.shields.io/github/last-commit/Fabien-Chouteau/Wee-Noise-Maker)](https://github.com/Fabien-Chouteau/Wee-Noise-Maker) - Wee Noise Maker is an open source pocket synthesizer.
- [lunar-lander-rotation ![GitHub Repo Stars](https://img.shields.io/github/stars/AdaCore/Lunar_Lander_Rotation_Demo) ![GitHub last commit](https://img.shields.io/github/last-commit/AdaCore/Lunar_Lander_Rotation_Demo)](https://github.com/AdaCore/Lunar_Lander_Rotation_Demo) - Program that interacts with the AdaFruit BNO055 breakout board in order to send orientation data to a host computer.
...
- [wasabee ![GitHub Repo Stars](https://img.shields.io/github/stars/zertovitch/wasabee) ![GitHub last commit](https://img.shields.io/github/last-commit/zertovitch/wasabee)](https://github.com/zertovitch/wasabee) - A Web browser with safety focus.
- [yass ![GitHub Repo Stars](https://img.shields.io/github/stars/yet-another-static-site-generator/yass) ![GitHub last commit](https://img.shields.io/github/last-commit/yet-another-static-site-generator/yass)](https://github.com/yet-another-static-site-generator/yass) - Yet Another Static Site Generator (like Jekyll or Hugo).
...
### Simulation
- [eagle-lander ![GitHub Repo Stars](https://img.shields.io/github/stars/Fabien-Chouteau/eagle-lander) ![GitHub last commit](https://img.shields.io/github/last-commit/Fabien-Chouteau/eagle-lander)](https://github.com/Fabien-Chouteau/eagle-lander) - Apollo 11 lunar lander simulator ([gtkada]/Cairo).
- [ghdl ![GitHub Repo Stars](https://img.shields.io/github/stars/ghdl/ghdl) ![GitHub last commit](https://img.shields.io/github/last-commit/ghdl/ghdl)](https://github.com/ghdl/ghdl) - VHDL 2008/93/87 simulator.
- [parallel-sim ![GitHub Repo Stars](https://img.shields.io/github/stars/JulianSchutsch/ParallelSim) ![GitHub last commit](https://img.shields.io/github/last-commit/JulianSchutsch/ParallelSim)](https://github.com/JulianSchutsch/ParallelSim) - Distributed Simulation of Transport Networks.
- [covid-19-simulator ![GitHub Repo Stars](https://img.shields.io/github/stars/ohenley/COVID-19_Simulator) ![GitHub last commit](https://img.shields.io/github/last-commit/ohenley/COVID-19_Simulator)](https://github.com/ohenley/COVID-19_Simulator) - Multi engine/algorithms COVID-19 simulator. Ada, Qt code under the hood.
- [mars-mpl ![GitHub Repo Stars](https://img.shields.io/github/stars/Jellix/mars_mpl) ![GitHub last commit](https://img.shields.io/github/last-commit/Jellix/mars_mpl)](https://github.com/Jellix/mars_mpl) - Mars Polar Lander (Crash) Simulator ([gtkada], [aicwl]).
- [doppler-effect-sample2 ![GitHub Repo Stars](https://img.shields.io/github/stars/moriyasum/GtkAda_OpenAL_Doppler_Effect_Sample2) ![GitHub last commit](https://img.shields.io/github/last-commit/moriyasum/GtkAda_OpenAL_Doppler_Effect_Sample2)](https://github.com/moriyasum/GtkAda_OpenAL_Doppler_Effect_Sample2) - Moving airplane causes Stereo Sound Doppler effect ([gtkada]).
...
- [cappulada ![GitHub Repo Stars](https://img.shields.io/github/stars/Componolit/Cappulada) ![GitHub last commit](https://img.shields.io/github/last-commit/Componolit/Cappulada)](https://github.com/Componolit/Cappulada) - Ada binding generator for C++.
- [asis2xml ![GitHub Repo Stars](https://img.shields.io/github/stars/simonjwright/asis2xml) ![GitHub last commit](https://img.shields.io/github/last-commit/simonjwright/asis2xml)](https://github.com/simonjwright/asis2xml) - Converts Ada sources' ASIS representation to XML, so as to make it easier to develop reporting and transformational tools using (for example) XSLT.
...
- [yotroc ![GitHub Repo Stars](https://img.shields.io/github/stars/docandrew/YOTROC) ![GitHub last commit](https://img.shields.io/github/last-commit/docandrew/YOTROC)](https://github.com/docandrew/YOTROC) - Assembler/Emulator for a fictional CPU architecture. IDE implemented in [gtkada].
