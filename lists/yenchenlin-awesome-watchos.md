...
### Connectivity
 * [MMWormhole ![GitHub Repo Stars](https://img.shields.io/github/stars/mutualmobile/MMWormhole) ![GitHub last commit](https://img.shields.io/github/last-commit/mutualmobile/MMWormhole)](https://github.com/mutualmobile/MMWormhole) - A powerful toolkit for synthesizing, processing, and analyzing sounds.

  <space><space><img src="https://github.com/mutualmobile/MMWormhole/blob/master/MMWormhole.gif" width="500") alt="Example App"/>

### UI
 * [IGInterfaceDataTable ![GitHub Repo Stars](https://img.shields.io/github/stars/Instagram/IGInterfaceDataTable) ![GitHub last commit](https://img.shields.io/github/last-commit/Instagram/IGInterfaceDataTable)](https://github.com/Instagram/IGInterfaceDataTable) - A category on WKInterfaceTable that makes configuring tables with multi-dimensional data easier.
 ...
 * [JBWatchActivityIndicator ![GitHub Repo Stars](https://img.shields.io/github/stars/mikeswanson/JBWatchActivityIndicator) ![GitHub last commit](https://img.shields.io/github/last-commit/mikeswanson/JBWatchActivityIndicator)](https://github.com/mikeswanson/JBWatchActivityIndicator) - An easy way to generate activity indicator images for Apple Watch.
...
### Charts
 * [YOChartImageKit ![GitHub Repo Stars](https://img.shields.io/github/stars/yasuoza/YOChartImageKit) ![GitHub last commit](https://img.shields.io/github/last-commit/yasuoza/YOChartImageKit)](https://github.com/yasuoza/YOChartImageKit) - A chart image framework for watchOS.
 ...
 * [NKWatchChart ![GitHub Repo Stars](https://img.shields.io/github/stars/NilStack/NKWatchChart) ![GitHub last commit](https://img.shields.io/github/last-commit/NilStack/NKWatchChart)](https://github.com/NilStack/NKWatchChart) - A chart library for Apple Watch based on PNChart and ios-charts.
...
### Images Generator
 * [RadialChartImageGenerator ![GitHub Repo Stars](https://img.shields.io/github/stars/hmaidasani/RadialChartImageGenerator) ![GitHub last commit](https://img.shields.io/github/last-commit/hmaidasani/RadialChartImageGenerator)](https://github.com/hmaidasani/RadialChartImageGenerator) - A radial bar chart generator for apple watch.
 * [KFWatchKitAnimations ![GitHub Repo Stars](https://img.shields.io/github/stars/kiavashfaisali/KFWatchKitAnimations) ![GitHub last commit](https://img.shields.io/github/last-commit/kiavashfaisali/KFWatchKitAnimations)](https://github.com/kiavashfaisali/KFWatchKitAnimations) - An image generator that creates beautiful 60 FPS animations for  Watch by recording animations from the iOS Simulator.
 ...
 * [Cherry ![GitHub Repo Stars](https://img.shields.io/github/stars/kenshin03/Cherry) ![GitHub last commit](https://img.shields.io/github/last-commit/kenshin03/Cherry)](https://github.com/kenshin03/Cherry) - A mini pomodoro timer app designed for the  Watch.
 ...
 * [WWDC ![GitHub Repo Stars](https://img.shields.io/github/stars/sugarso/WWDC) ![GitHub last commit](https://img.shields.io/github/last-commit/sugarso/WWDC)](https://github.com/sugarso/WWDC) - An open sourcing WWDC hit parties app.

   <space><space><img src="https://raw.githubusercontent.com/sugarso/WWDC/master/Assets/watch1.png") alt="Example App" width="230"/>

 * [SwiftHN ![GitHub Repo Stars](https://img.shields.io/github/stars/Dimillian/SwiftHN) ![GitHub last commit](https://img.shields.io/github/last-commit/Dimillian/SwiftHN)](https://github.com/Dimillian/SwiftHN) - A Hacker News reader written in Swift.
 * [BaiduFM-Swift ![GitHub Repo Stars](https://img.shields.io/github/stars/belm/BaiduFM-Swift) ![GitHub last commit](https://img.shields.io/github/last-commit/belm/BaiduFM-Swift)](https://github.com/belm/BaiduFM-Swift) - A apple watch app for BaiduFM.
 ...
 * [done-swift ![GitHub Repo Stars](https://img.shields.io/github/stars/FancyPixel/done-swift) ![GitHub last commit](https://img.shields.io/github/last-commit/FancyPixel/done-swift)](https://github.com/FancyPixel/done-swift) - A sample app to demonstrate data sharing between a WatchKit app and its main app using Realm.
 ...
 * [HighstreetWatchApp ![GitHub Repo Stars](https://img.shields.io/github/stars/GetHighstreet/HighstreetWatchApp) ![GitHub last commit](https://img.shields.io/github/last-commit/GetHighstreet/HighstreetWatchApp)](https://github.com/GetHighstreet/HighstreetWatchApp) - The watchKit app built on the <http://highstreetapp.com> platform.
 ...
 * [OnTime ![GitHub Repo Stars](https://img.shields.io/github/stars/D-32/OnTime) ![GitHub last commit](https://img.shields.io/github/last-commit/D-32/OnTime)](https://github.com/D-32/OnTime) - An apple watch app to access the SBB timetable.
 ...
 * [WatchNotes ![GitHub Repo Stars](https://img.shields.io/github/stars/azamsharp/WatchNotes) ![GitHub last commit](https://img.shields.io/github/last-commit/azamsharp/WatchNotes)](https://github.com/azamsharp/WatchNotes) - An apple watch app to display notes on your wrist.
 ...
 * [WatchPics ![GitHub Repo Stars](https://img.shields.io/github/stars/D-32/WatchPics) ![GitHub last commit](https://img.shields.io/github/last-commit/D-32/WatchPics)](https://github.com/D-32/WatchPics) - Instagram for the Apple Watch.
 ...
 * [WatchKit-Apps ![GitHub Repo Stars](https://img.shields.io/github/stars/kostiakoval/WatchKit-Apps) ![GitHub last commit](https://img.shields.io/github/last-commit/kostiakoval/WatchKit-Apps)](https://github.com/kostiakoval/WatchKit-Apps) - Tutorials app for WatchKit.
 * [watchOS-2-Sampler ![GitHub Repo Stars](https://img.shields.io/github/stars/shu223/watchOS-2-Sampler) ![GitHub last commit](https://img.shields.io/github/last-commit/shu223/watchOS-2-Sampler)](https://github.com/shu223/watchOS-2-Sampler) - Code examples for new features of watchOS 2.

 * [soon ![GitHub Repo Stars](https://img.shields.io/github/stars/sandofsky/soon) ![GitHub last commit](https://img.shields.io/github/last-commit/sandofsky/soon)](https://github.com/sandofsky/soon) - A countdown app.
 ...
 * Awesome-swift
   * [@matteocrippa ![GitHub Repo Stars](https://img.shields.io/github/stars/matteocrippa/awesome-swift) ![GitHub last commit](https://img.shields.io/github/last-commit/matteocrippa/awesome-swift)](https://github.com/matteocrippa/awesome-swift) - A collaborative list of awesome swift resources.
   * [@Wolg ![GitHub Repo Stars](https://img.shields.io/github/stars/Wolg/awesome-swift) ![GitHub last commit](https://img.shields.io/github/last-commit/Wolg/awesome-swift)](https://github.com/Wolg/awesome-swift) - A curated list of awesome Swift frameworks, libraries and software.
 * [awesome watchkit apps ![GitHub Repo Stars](https://img.shields.io/github/stars/sanketfirodiya/sample-watchkit-apps) ![GitHub last commit](https://img.shields.io/github/last-commit/sanketfirodiya/sample-watchkit-apps)](https://github.com/sanketfirodiya/sample-watchkit-apps) curated list of sample watchkit apps and tutorials.
 * [iOS Learning Resources ![GitHub Repo Stars](https://img.shields.io/github/stars/sanketfirodiya/iOS-learning-resources) ![GitHub last commit](https://img.shields.io/github/last-commit/sanketfirodiya/iOS-learning-resources)](https://github.com/sanketfirodiya/iOS-learning-resources) Comprenehensive collection of high quality, frequently updated and well maintained iOS tutorial sites.
 * [awesome-ios-animation ![GitHub Repo Stars](https://img.shields.io/github/stars/sxyx2008/awesome-ios-animation) ![GitHub last commit](https://img.shields.io/github/last-commit/sxyx2008/awesome-ios-animation)](https://github.com/sxyx2008/awesome-ios-animation) - A curated list of awesome iOS animation, including Objective-C and Swift libraries.
 * [awesome-ios-chart ![GitHub Repo Stars](https://img.shields.io/github/stars/sxyx2008/awesome-ios-chart) ![GitHub last commit](https://img.shields.io/github/last-commit/sxyx2008/awesome-ios-chart)](https://github.com/sxyx2008/awesome-ios-chart) - A curated list of awesome iOS chart libraries, including Objective-C and Swift.
 ...
 * [awesome-ios-ui ![GitHub Repo Stars](https://img.shields.io/github/stars/cjwirth/awesome-ios-ui) ![GitHub last commit](https://img.shields.io/github/last-commit/cjwirth/awesome-ios-ui)](https://github.com/cjwirth/awesome-ios-ui) - A curated list of awesome iOS UI/UX libraries.
