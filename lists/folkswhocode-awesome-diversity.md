...
- [1 Million Women To Tech ![GitHub Repo Stars](https://img.shields.io/github/stars/1millionwomentotech/toolkitten) ![GitHub last commit](https://img.shields.io/github/last-commit/1millionwomentotech/toolkitten)](https://github.com/1millionwomentotech/toolkitten) - Organization whose mission is to offer free coding education to 1 million women by 2020. Has free (DIY) and paid (certification) courses.
...
- [GoodForPoc ![GitHub Repo Stars](https://img.shields.io/github/stars/GoodForPoC/GoodForPoC) ![GitHub last commit](https://img.shields.io/github/last-commit/GoodForPoC/GoodForPoC)](https://github.com/GoodForPoC/GoodForPoC) - List of inclusive companies for people of color in tech.
...
- [Resources For Allies ![GitHub Repo Stars](https://img.shields.io/github/stars/larahogan/ally-resources) ![GitHub last commit](https://img.shields.io/github/last-commit/larahogan/ally-resources)](https://github.com/larahogan/ally-resources) - By Lara Hogan.
...
- [Increase Diversity In Our Speaker Line Up ![GitHub Repo Stars](https://img.shields.io/github/stars/lnug/feedback) ![GitHub last commit](https://img.shields.io/github/last-commit/lnug/feedback)](https://github.com/lnug/feedback/issues/107#issuecomment-296282498) - By Soledad Penadés.
- [On Improving Diversity In Hiring](https://cate.blog/2017/09/28/on-improving-diversity-in-hiring/) - By Cate Huston.
- [So, You Just Learned There Are Issues With The Tech Industry. Now What? ![GitHub Repo Stars](https://img.shields.io/github/stars/stephmarx/so-you-just-learned) ![GitHub last commit](https://img.shields.io/github/last-commit/stephmarx/so-you-just-learned)](https://github.com/stephmarx/so-you-just-learned) - By Stephanie Slattery.
...
- [You Can’t Just Hit The Diversity Button](https://medium.com/projectinclude/you-cant-just-hit-the-diversity-button-94b7043372a9) - By Project Include's Laura I. G��mez.
...
This means that it adheres to its [core values ![GitHub Repo Stars](https://img.shields.io/github/stars/folkswhocode/base) ![GitHub last commit](https://img.shields.io/github/last-commit/folkswhocode/base)](https://github.com/folkswhocode/base/blob/master/en/VALUES.md), [code of conduct ![GitHub Repo Stars](https://img.shields.io/github/stars/folkswhocode/base) ![GitHub last commit](https://img.shields.io/github/last-commit/folkswhocode/base)](https://github.com/folkswhocode/base/blob/master/en/CODE_OF_CONDUCT.md) and
