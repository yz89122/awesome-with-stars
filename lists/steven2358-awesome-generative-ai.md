...
- [Kimi K2 ![GitHub Repo Stars](https://img.shields.io/github/stars/moonshotai/Kimi-K2) ![GitHub last commit](https://img.shields.io/github/last-commit/moonshotai/Kimi-K2)](https://github.com/moonshotai/Kimi-K2) - A series of open-source MoE language models by Moonshot AI for agentic tasks. #opensource
- [GLM ![GitHub Repo Stars](https://img.shields.io/github/stars/zai-org/GLM-5) ![GitHub last commit](https://img.shields.io/github/last-commit/zai-org/GLM-5)](https://github.com/zai-org/GLM-5) - A series of open-source MoE language models by Z.ai for agentic tasks. #opensource
...
- [LibreChat](https://librechat.ai/) - LibreChat is a free and open-source chat interface for assistant AIs. [#opensource ![GitHub Repo Stars](https://img.shields.io/github/stars/danny-avila/LibreChat) ![GitHub last commit](https://img.shields.io/github/last-commit/danny-avila/LibreChat)](https://github.com/danny-avila/LibreChat).
- [Chatbot UI](https://www.chatbotui.com/) - An open source ChatGPT UI. [#opensource ![GitHub Repo Stars](https://img.shields.io/github/stars/mckaywrigley/chatbot-ui) ![GitHub last commit](https://img.shields.io/github/last-commit/mckaywrigley/chatbot-ui)](https://github.com/mckaywrigley/chatbot-ui).
...
- [privateGPT ![GitHub Repo Stars](https://img.shields.io/github/stars/zylon-ai/private-gpt) ![GitHub last commit](https://img.shields.io/github/last-commit/zylon-ai/private-gpt)](https://github.com/zylon-ai/private-gpt) - Ask questions to your documents without an internet connection, using the power of LLMs.
- [quivr ![GitHub Repo Stars](https://img.shields.io/github/stars/QuivrHQ/quivr) ![GitHub last commit](https://img.shields.io/github/last-commit/QuivrHQ/quivr)](https://github.com/QuivrHQ/quivr) - Dump all your files and chat with it using your generative AI second brain using LLMs & embeddings.
...
- [Plandex ![GitHub Repo Stars](https://img.shields.io/github/stars/plandex-ai/plandex) ![GitHub last commit](https://img.shields.io/github/last-commit/plandex-ai/plandex)](https://github.com/plandex-ai/plandex) - Open source, terminal-based AI programming engine for complex tasks. [#opensource ![GitHub Repo Stars](https://img.shields.io/github/stars/plandex-ai/plandex) ![GitHub last commit](https://img.shields.io/github/last-commit/plandex-ai/plandex)](https://github.com/plandex-ai/plandex)
- [Jupyter AI ![GitHub Repo Stars](https://img.shields.io/github/stars/jupyterlab/jupyter-ai) ![GitHub last commit](https://img.shields.io/github/last-commit/jupyterlab/jupyter-ai)](https://github.com/jupyterlab/jupyter-ai) - An open-source, configurable AI assistant in Jupyter Notebook and JupyterLab that supports 100+ LLMs, including locally-hosted models from Ollama and GPT4All. #opensource
...
- [Ludwig ![GitHub Repo Stars](https://img.shields.io/github/stars/ludwig-ai/ludwig) ![GitHub last commit](https://img.shields.io/github/last-commit/ludwig-ai/ludwig)](https://github.com/ludwig-ai/ludwig) - A low-code framework for building custom AI models like LLMs and other deep neural networks. [#opensource ![GitHub Repo Stars](https://img.shields.io/github/stars/ludwig-ai/ludwig) ![GitHub last commit](https://img.shields.io/github/last-commit/ludwig-ai/ludwig)](https://github.com/ludwig-ai/ludwig)
- [Unsloth](https://unsloth.ai) - A Python library for fine-tuning LLMs [#opensource ![GitHub Repo Stars](https://img.shields.io/github/stars/unslothai/unsloth) ![GitHub last commit](https://img.shields.io/github/last-commit/unslothai/unsloth)](https://github.com/unslothai/unsloth).
...
- [Manifest](https://manifest.build) - An open-source LLM router that routes agent requests to the most cost-effective model, with usage limits and model benchmarking. [#opensource ![GitHub Repo Stars](https://img.shields.io/github/stars/mnfst/manifest) ![GitHub last commit](https://img.shields.io/github/last-commit/mnfst/manifest)](https://github.com/mnfst/manifest)
...
- [Rapid-MLX ![GitHub Repo Stars](https://img.shields.io/github/stars/raullenchai/Rapid-MLX) ![GitHub last commit](https://img.shields.io/github/last-commit/raullenchai/Rapid-MLX)](https://github.com/raullenchai/Rapid-MLX) - OpenAI-compatible local LLM inference server optimized for Apple Silicon, with tool calling, reasoning, vision, and structured output support. #opensource
...
- [Mastra](https://mastra.ai) - A TypeScript framework for building AI agents, workflows, and applications. [#opensource ![GitHub Repo Stars](https://img.shields.io/github/stars/mastra-ai/mastra) ![GitHub last commit](https://img.shields.io/github/last-commit/mastra-ai/mastra)](https://github.com/mastra-ai/mastra)
- [OpenClaw](https://openclaw.ai) - A personal AI assistant you run on your own devices. [#opensource ![GitHub Repo Stars](https://img.shields.io/github/stars/openclaw/openclaw) ![GitHub last commit](https://img.shields.io/github/last-commit/openclaw/openclaw)](https://github.com/openclaw/openclaw)
...
- [Hive ![GitHub Repo Stars](https://img.shields.io/github/stars/aden-hive/hive) ![GitHub last commit](https://img.shields.io/github/last-commit/aden-hive/hive)](https://github.com/aden-hive/hive) - An open-source multi-agent framework with auto-generated graphs, evolution loops, and MCP integration. #opensource
...
- [whisper.cpp ![GitHub Repo Stars](https://img.shields.io/github/stars/ggml-org/whisper.cpp) ![GitHub last commit](https://img.shields.io/github/last-commit/ggml-org/whisper.cpp)](https://github.com/ggml-org/whisper.cpp) - Port of OpenAI's Whisper model in C/C++. #opensource
...
- [NeMo ![GitHub Repo Stars](https://img.shields.io/github/stars/NVIDIA-NeMo/Speech) ![GitHub last commit](https://img.shields.io/github/last-commit/NVIDIA-NeMo/Speech)](https://github.com/NVIDIA-NeMo/Speech) - An open-source framework by NVIDIA for building speech AI systems, including automatic speech recognition and text-to-speech. #opensource
...
- [Generative Deep Art ![GitHub Repo Stars](https://img.shields.io/github/stars/filipecalegario/awesome-generative-ai) ![GitHub last commit](https://img.shields.io/github/last-commit/filipecalegario/awesome-generative-ai)](https://github.com/filipecalegario/awesome-generative-ai) - A curated list of generative deep learning tools, works, models, etc. for artistic uses, by [@filipecalegario](https://github.com/filipecalegario/).
...
- [Awesome ChatGPT Prompts ![GitHub Repo Stars](https://img.shields.io/github/stars/f/prompts.chat) ![GitHub last commit](https://img.shields.io/github/last-commit/f/prompts.chat)](https://github.com/f/prompts.chat) - A collection of prompt examples to be used with the ChatGPT model.
