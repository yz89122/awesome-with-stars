...
* [Getting Started with Site Reliability Engineering ![GitHub Repo Stars](https://img.shields.io/github/stars/devopsenterprise/2018-London) ![GitHub last commit](https://img.shields.io/github/last-commit/devopsenterprise/2018-London)](https://github.com/devopsenterprise/2018-London/blob/master/Tuesday/Breakout%20Sessions/Throne%2C%20Stephen%2C%20Getting%20Started%20with%20Site%20Reliability%20Engineering.pdf)
...
* [Making operational work more visible ![GitHub Repo Stars](https://img.shields.io/github/stars/readme/guides) ![GitHub last commit](https://img.shields.io/github/last-commit/readme/guides)](https://github.com/readme/guides/ops-work-visible)
...
* [Chaos Engineering resources ![GitHub Repo Stars](https://img.shields.io/github/stars/dastergon/awesome-chaos-engineering) ![GitHub last commit](https://img.shields.io/github/last-commit/dastergon/awesome-chaos-engineering)](https://github.com/dastergon/awesome-chaos-engineering)
...
* [The On-Call Handbook ![GitHub Repo Stars](https://img.shields.io/github/stars/alicegoldfuss/oncall-handbook) ![GitHub last commit](https://img.shields.io/github/last-commit/alicegoldfuss/oncall-handbook)](https://github.com/alicegoldfuss/oncall-handbook)
...
* [Run Book / Operations Manual template ![GitHub Repo Stars](https://img.shields.io/github/stars/SkeltonThatcher/run-book-template) ![GitHub last commit](https://img.shields.io/github/last-commit/SkeltonThatcher/run-book-template)](https://github.com/SkeltonThatcher/run-book-template)
...
* [Extended Dreyfus Model for Incident Lifecycles ![GitHub Repo Stars](https://img.shields.io/github/stars/preed/incident-lifecycle-model) ![GitHub last commit](https://img.shields.io/github/last-commit/preed/incident-lifecycle-model)](https://github.com/preed/incident-lifecycle-model)
...
* [A collection of postmortem templates ![GitHub Repo Stars](https://img.shields.io/github/stars/dastergon/postmortem-templates) ![GitHub last commit](https://img.shields.io/github/last-commit/dastergon/postmortem-templates)](https://github.com/dastergon/postmortem-templates)
...
## SRE Tools
* [Awesome SRE Tools ![GitHub Repo Stars](https://img.shields.io/github/stars/SquadcastHub/awesome-sre-tools) ![GitHub last commit](https://img.shields.io/github/last-commit/SquadcastHub/awesome-sre-tools)](https://github.com/SquadcastHub/awesome-sre-tools) - A curated list of Site Reliability and Production Engineering tools
* [List of Continuous Integration services ![GitHub Repo Stars](https://img.shields.io/github/stars/ligurio/awesome-ci) ![GitHub last commit](https://img.shields.io/github/last-commit/ligurio/awesome-ci)](https://github.com/ligurio/awesome-ci)
* [SRE cheat sheet ![GitHub Repo Stars](https://img.shields.io/github/stars/shibumi/SRE-cheat-sheet) ![GitHub last commit](https://img.shields.io/github/last-commit/shibumi/SRE-cheat-sheet)](https://github.com/shibumi/SRE-cheat-sheet) - A cheat sheet for Site Reliability Engineering principles and numbers
