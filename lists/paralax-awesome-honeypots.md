...
- Web honeypots
  ...
  - [Lophiid ![GitHub Repo Stars](https://img.shields.io/github/stars/mrheinen/lophiid) ![GitHub last commit](https://img.shields.io/github/last-commit/mrheinen/lophiid)](https://github.com/mrheinen/lophiid/) - Distributed web application honeypot to interact with large scale exploitation attempts.
  ...
  - [nginx-honeypot ![GitHub Repo Stars](https://img.shields.io/github/stars/GetPageSpeed/nginx-honeypot) ![GitHub last commit](https://img.shields.io/github/last-commit/GetPageSpeed/nginx-honeypot)](https://github.com/GetPageSpeed/nginx-honeypot) - A simple honeypot based on NGINX configuration that logs and blocks bots scanning for vulnerabilities.
...
- Service Honeypots
  ...
  - [Trapster Commmunity ![GitHub Repo Stars](https://img.shields.io/github/stars/0xBallpoint/trapster-community) ![GitHub last commit](https://img.shields.io/github/last-commit/0xBallpoint/trapster-community)](https://github.com/0xBallpoint/trapster-community) - Modural and easy to install Python Honeypot, with comprehensive alerting
