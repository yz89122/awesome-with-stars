...
- [GitHub repo ![GitHub Repo Stars](https://img.shields.io/github/stars/saltstack/salt) ![GitHub last commit](https://img.shields.io/github/last-commit/saltstack/salt)](https://github.com/saltstack/salt) - Salt's source code, issues discussion and collaboration.
...
- [Introduction to SaltStack ![GitHub Repo Stars](https://img.shields.io/github/stars/redmage123/Introduction-to-Saltstack) ![GitHub last commit](https://img.shields.io/github/last-commit/redmage123/Introduction-to-Saltstack)](https://github.com/redmage123/Introduction-to-Saltstack) - A two day course designed to quickly introduce System Administrators and Application Developers on how to start using Saltstack.
...
- [zulily/alkali ![GitHub Repo Stars](https://img.shields.io/github/stars/zulily/alkali) ![GitHub last commit](https://img.shields.io/github/last-commit/zulily/alkali)](https://github.com/zulily/alkali) - A collections of SaltStack states and pillar data that provide just the basics for provisioning Linux instances that may be built upon.
- [zulily/buoyant ![GitHub Repo Stars](https://img.shields.io/github/stars/zulily/buoyant) ![GitHub last commit](https://img.shields.io/github/last-commit/zulily/buoyant)](https://github.com/zulily/buoyant) - Leverages docker to provide an alternative to VM-centric SaltStack development environments.
...
- [madflojo/masterless-salt-base ![GitHub Repo Stars](https://img.shields.io/github/stars/madflojo/masterless-salt-base) ![GitHub last commit](https://img.shields.io/github/last-commit/madflojo/masterless-salt-base)](https://github.com/madflojo/masterless-salt-base) - Quickly bootstrap a generic(ish) Ubuntu server. One that is ready to host Docker containers.
...
- [SaltGUI ![GitHub Repo Stars](https://img.shields.io/github/stars/erwindon/SaltGUI) ![GitHub last commit](https://img.shields.io/github/last-commit/erwindon/SaltGUI)](https://github.com/erwindon/SaltGUI) - A web interface for managing SaltStack based infrastructure.
- [Pepperboard ![GitHub Repo Stars](https://img.shields.io/github/stars/webedia-dev/pepperboard) ![GitHub last commit](https://img.shields.io/github/last-commit/webedia-dev/pepperboard)](https://github.com/webedia-dev/pepperboard) - A simple and modular dashboard toolkit for SaltStack.
- [Molten ![GitHub Repo Stars](https://img.shields.io/github/stars/martinhoefling/molten) ![GitHub last commit](https://img.shields.io/github/last-commit/martinhoefling/molten)](https://github.com/martinhoefling/molten) - Molten is a WebUI for the REST API exposed by Saltstack.
...
- [SaltStack Cheat Sheet Plus ![GitHub Repo Stars](https://img.shields.io/github/stars/fmdlc/saltstack-cheatsheet) ![GitHub last commit](https://img.shields.io/github/last-commit/fmdlc/saltstack-cheatsheet)](https://github.com/fmdlc/saltstack-cheatsheet) - by Facu de la Cruz.
...
- [SaltStack Wiki ![GitHub Repo Stars](https://img.shields.io/github/stars/saltstack/salt) ![GitHub last commit](https://img.shields.io/github/last-commit/saltstack/salt)](https://github.com/saltstack/salt/wiki/Cheat-Sheet) - Cheat sheet in the SaltStack GitHub Wiki.
