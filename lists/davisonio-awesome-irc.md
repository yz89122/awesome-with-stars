...
- [ObsidianIRC](https://hello.obby.world/) - Modern WebSocket IRC client with Discord-like UI. ([source ![GitHub Repo Stars](https://img.shields.io/github/stars/obbyworld/obby) ![GitHub last commit](https://img.shields.io/github/last-commit/obbyworld/obby)](https://github.com/obbyworld/obby)) `Linux` `Windows` `macOS` `Android` `iOS` `Web`
