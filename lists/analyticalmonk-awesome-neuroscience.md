<!-- ![Awesome Neuroscience](https://github.com/analyticalmonk/awesome-neuroscience/raw/main/AWESOME2.png) -->
<img src="https://github.com/analyticalmonk/awesome-neuroscience/raw/main/AWESOME2.png" width="50%">
...
- [Brian2 ![GitHub Repo Stars](https://img.shields.io/github/stars/brian-team/brian2) ![GitHub last commit](https://img.shields.io/github/last-commit/brian-team/brian2)](https://github.com/brian-team/brian2) - Free, open source simulator for spiking neural networks.
...
- [DeepLabCut ![GitHub Repo Stars](https://img.shields.io/github/stars/DeepLabCut/DeepLabCut) ![GitHub last commit](https://img.shields.io/github/last-commit/DeepLabCut/DeepLabCut)](https://github.com/DeepLabCut/DeepLabCut) - Markerless pose estimation toolkit for animal behavior analysis using transfer learning with deep neural networks.
- [CaImAn ![GitHub Repo Stars](https://img.shields.io/github/stars/flatironinstitute/CaImAn) ![GitHub last commit](https://img.shields.io/github/last-commit/flatironinstitute/CaImAn)](https://github.com/flatironinstitute/CaImAn) - Computational toolbox for large-scale calcium imaging data analysis, including motion correction, source extraction, and deconvolution.
- [Elephant ![GitHub Repo Stars](https://img.shields.io/github/stars/NeuralEnsemble/elephant) ![GitHub last commit](https://img.shields.io/github/last-commit/NeuralEnsemble/elephant)](https://github.com/NeuralEnsemble/elephant) - Library for the analysis of electrophysiology data, providing tools for spike train statistics, signal processing, and connectivity analysis.
- [NEURON ![GitHub Repo Stars](https://img.shields.io/github/stars/neuronsimulator/nrn) ![GitHub last commit](https://img.shields.io/github/last-commit/neuronsimulator/nrn)](https://github.com/neuronsimulator/nrn) - Simulation environment for modeling individual neurons and networks of neurons, widely used in computational and systems neuroscience.
- [Nipype ![GitHub Repo Stars](https://img.shields.io/github/stars/nipy/nipype) ![GitHub last commit](https://img.shields.io/github/last-commit/nipy/nipype)](https://github.com/nipy/nipype) - Workflow engine providing a uniform Python interface to existing neuroimaging packages (FSL, FreeSurfer, AFNI, SPM, ANTs) and flexible pipeline composition.
- [PyNWB ![GitHub Repo Stars](https://img.shields.io/github/stars/NeurodataWithoutBorders/pynwb) ![GitHub last commit](https://img.shields.io/github/last-commit/NeurodataWithoutBorders/pynwb)](https://github.com/NeurodataWithoutBorders/pynwb) - Python API for reading and writing Neurodata Without Borders (NWB) files, the community standard data format for cellular-based neurophysiology data.
- [fMRIPrep ![GitHub Repo Stars](https://img.shields.io/github/stars/nipreps/fmriprep) ![GitHub last commit](https://img.shields.io/github/last-commit/nipreps/fmriprep)](https://github.com/nipreps/fmriprep) - Robust preprocessing pipeline for fMRI data that adapts to nearly any dataset and produces analysis-ready outputs with minimal manual intervention.
- [AllenSDK ![GitHub Repo Stars](https://img.shields.io/github/stars/AllenInstitute/AllenSDK) ![GitHub last commit](https://img.shields.io/github/last-commit/AllenInstitute/AllenSDK)](https://github.com/AllenInstitute/AllenSDK) - Toolkit for accessing and processing data from the Allen Institute for Brain Science, including the Allen Brain Atlas and Allen Brain Observatory.
- [Suite2p ![GitHub Repo Stars](https://img.shields.io/github/stars/MouseLand/suite2p) ![GitHub last commit](https://img.shields.io/github/last-commit/MouseLand/suite2p)](https://github.com/MouseLand/suite2p) - Pipeline for cell detection and signal extraction from large-scale two-photon calcium imaging recordings.
- [Neo ![GitHub Repo Stars](https://img.shields.io/github/stars/NeuralEnsemble/python-neo) ![GitHub last commit](https://img.shields.io/github/last-commit/NeuralEnsemble/python-neo)](https://github.com/NeuralEnsemble/python-neo) - Package for representing electrophysiology data in Python, with readers for a wide range of neurophysiology file formats.
- [Monty ![GitHub Repo Stars](https://img.shields.io/github/stars/thousandbrainsproject/tbp.monty) ![GitHub last commit](https://img.shields.io/github/last-commit/thousandbrainsproject/tbp.monty)](https://github.com/thousandbrainsproject/tbp.monty) - Sensorimotor learning framework based on the thousand brains theory of the neocortex.
- [PyNoetic ![GitHub Repo Stars](https://img.shields.io/github/stars/NeuroDiag/PyNoetic-official) ![GitHub last commit](https://img.shields.io/github/last-commit/NeuroDiag/PyNoetic-official)](https://github.com/NeuroDiag/PyNoetic-official) - A Modular Python Framework for No-Code Development of EEG Brain-Computer Interfaces supporting end-to-end BCI design. 
...
- [SORTED ![GitHub Repo Stars](https://img.shields.io/github/stars/PTDZ/SORTED) ![GitHub last commit](https://img.shields.io/github/last-commit/PTDZ/SORTED)](https://github.com/PTDZ/SORTED) - SORTED: a list of interesting science ideas and links (cognitive/neuro & data science)
