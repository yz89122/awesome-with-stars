...
* [Wissance.WebApiTookit ![GitHub Repo Stars](https://img.shields.io/github/stars/Wissance/WebApiToolkit) ![GitHub last commit](https://img.shields.io/github/last-commit/Wissance/WebApiToolkit)](https://github.com/Wissance/WebApiToolkit) - A set of libraries and classes that simplify building REST APIs and gRPC services, reducing the amount of code to be written with even one line of code for a fully functional REST controller.
...
* [Runtime ![GitHub Repo Stars](https://img.shields.io/github/stars/dotnet/runtime) ![GitHub last commit](https://img.shields.io/github/last-commit/dotnet/runtime)](https://github.com/dotnet/runtime) -  The runtime repo contains the library implementation (formerly called "CoreFX") for .NET (5+). It includes System.Collections, System.IO, System.Xml and many other components.
...
* [ActualLab.Fusion ![GitHub Repo Stars](https://img.shields.io/github/stars/ActualLab/Fusion) ![GitHub last commit](https://img.shields.io/github/last-commit/ActualLab/Fusion)](https://github.com/ActualLab/Fusion) - Skip SignalR and gRPC. Build real-time Blazor and MAUI apps while writing just 0.1% of the usual real-time update code. Handle 10× more API requests with the ActualLab.Rpc protocol—or 1000× more with Fusion’s transparent and perfectly coherent caching. [Samples ![GitHub Repo Stars](https://img.shields.io/github/stars/ActualLab/Fusion.Samples) ![GitHub last commit](https://img.shields.io/github/last-commit/ActualLab/Fusion.Samples)](https://github.com/ActualLab/Fusion.Samples). [Documentation](https://fusion.actuallab.net/).
...
* [Positron-JS ![GitHub Repo Stars](https://img.shields.io/github/stars/Positron-JS/positron-web-view) ![GitHub last commit](https://img.shields.io/github/last-commit/Positron-JS/positron-web-view)](https://github.com/Positron-JS/positron-web-view) - An advanced Web View (PositronWebView) with native JavaScript Context to access .NET APIs from hybrid applications inspired from capacitor/cordova.
...
* [ASP.NET Core Identity ![GitHub Repo Stars](https://img.shields.io/github/stars/dotnet/aspnetcore) ![GitHub last commit](https://img.shields.io/github/last-commit/dotnet/aspnetcore)](https://github.com/dotnet/aspnetcore/) - New membership system for ASP.NET applications
...
* [Logto ![GitHub Repo Stars](https://img.shields.io/github/stars/logto-io/csharp) ![GitHub last commit](https://img.shields.io/github/last-commit/logto-io/csharp)](https://github.com/logto-io/csharp) - An IAM infrastructure for modern apps and SaaS products, supporting OIDC, OAuth 2.0 and SAML for authentication and authorization **[$][Free for OSS]**
...
* [FastLZMA2NET ![GitHub Repo Stars](https://img.shields.io/github/stars/kingsznhone/FastLZMA2Net) ![GitHub last commit](https://img.shields.io/github/last-commit/kingsznhone/FastLZMA2Net)](https://github.com/kingsznhone/FastLZMA2Net) - A .NET Wrapper of [Fast LZMA2 Algorithm ![GitHub Repo Stars](https://img.shields.io/github/stars/conor42/fast-lzma2) ![GitHub last commit](https://img.shields.io/github/last-commit/conor42/fast-lzma2)](https://github.com/conor42/fast-lzma2).
...
* [ServiceStack Redis ![GitHub Repo Stars](https://img.shields.io/github/stars/ServiceStack/ServiceStack) ![GitHub last commit](https://img.shields.io/github/last-commit/ServiceStack/ServiceStack)](https://github.com/ServiceStack/ServiceStack) - .NET's leading C# Redis client
* [StackExchange Redis ![GitHub Repo Stars](https://img.shields.io/github/stars/ServiceStack/ServiceStack) ![GitHub last commit](https://img.shields.io/github/last-commit/ServiceStack/ServiceStack)](https://github.com/ServiceStack/ServiceStack) - General purpose Redis client from StackExchange
...
* [ServiceStack.Stripe ![GitHub Repo Stars](https://img.shields.io/github/stars/ServiceStack/ServiceStack) ![GitHub last commit](https://img.shields.io/github/last-commit/ServiceStack/ServiceStack)](https://github.com/ServiceStack/ServiceStack) - Typed .NET clients for stripe.com REST APIs
...
* [Dotnet CLI ![GitHub Repo Stars](https://img.shields.io/github/stars/dotnet/sdk) ![GitHub last commit](https://img.shields.io/github/last-commit/dotnet/sdk)](https://github.com/dotnet/sdk) - The cross-platform .NET Core command-line toolchain utility.
...
## Feature management
* [Microsoft.FeatureManagement ![GitHub Repo Stars](https://img.shields.io/github/stars/microsoft/FeatureManagement-Dotnet) ![GitHub last commit](https://img.shields.io/github/last-commit/microsoft/FeatureManagement-Dotnet)](https://github.com/microsoft/FeatureManagement-Dotnet) - This library provides a way to develop and expose application functionality based on feature flags. It enables scenarios like new feature rollouts and A/B testing for experimentation purposes. It also provides integration with common .NET coding patterns and ASP.NET Core.
...
* [Git Credential Manager ![GitHub Repo Stars](https://img.shields.io/github/stars/git-ecosystem/git-credential-manager) ![GitHub last commit](https://img.shields.io/github/last-commit/git-ecosystem/git-credential-manager)](https://github.com/git-ecosystem/git-credential-manager) - Helps solving issues of credentials
...
* [LiveCharts2 ![GitHub Repo Stars](https://img.shields.io/github/stars/beto-rodriguez/LiveCharts2) ![GitHub last commit](https://img.shields.io/github/last-commit/beto-rodriguez/LiveCharts2)](https://github.com/beto-rodriguez/LiveCharts2) - Simple, flexible, interactive & powerful charts, maps, and gauges for .Net. LiveCharts2 supports WPF, WinForms, Xamarin, Avalonia, WinUI, UWP.
* [Helix Toolkit ![GitHub Repo Stars](https://img.shields.io/github/stars/helix-toolkit/helix-toolkit) ![GitHub last commit](https://img.shields.io/github/last-commit/helix-toolkit/helix-toolkit)](https://github.com/helix-toolkit/helix-toolkit) - Helix Toolkit is a collection of 3D components for .NET
...
* [VectSharp ![GitHub Repo Stars](https://img.shields.io/github/stars/arklumpus/VectSharp) ![GitHub last commit](https://img.shields.io/github/last-commit/arklumpus/VectSharp)](https://github.com/arklumpus/VectSharp) - .NET library to create vector graphics and text, and then export it to PDF, SVG and raster image formats.

## GraphQL
* [GraphQL.NET ![GitHub Repo Stars](https://img.shields.io/github/stars/graphql-dotnet/graphql-dotnet) ![GitHub last commit](https://img.shields.io/github/last-commit/graphql-dotnet/graphql-dotnet)](https://github.com/graphql-dotnet/graphql-dotnet) - Implementation of [Facebook's GraphQL ![GitHub Repo Stars](https://img.shields.io/github/stars/graphql/graphql-spec) ![GitHub last commit](https://img.shields.io/github/last-commit/graphql/graphql-spec)](https://github.com/graphql/graphql-spec) in .Net
* [HotChocolate ![GitHub Repo Stars](https://img.shields.io/github/stars/ChilliCream/hotchocolate) ![GitHub last commit](https://img.shields.io/github/last-commit/ChilliCream/hotchocolate)](https://github.com/ChilliCream/hotchocolate) - GraphQL server compatible to all GraphQL compliant clients like Strawberry Shake, Relay, Apollo Client, and various other clients and tools.
...
* [ZeroQL ![GitHub Repo Stars](https://img.shields.io/github/stars/byme8/ZeroQL) ![GitHub last commit](https://img.shields.io/github/last-commit/byme8/ZeroQL)](https://github.com/byme8/ZeroQL) - high-performance C#-friendly GraphQL client. It supports Linq-like syntax. It doesn't require Reflection.Emit or expressions. As a result, the runtime provides performance very close to a raw HTTP call.
...
* [ImageWizard ![GitHub Repo Stars](https://img.shields.io/github/stars/usercode/ImageWizard) ![GitHub last commit](https://img.shields.io/github/last-commit/usercode/ImageWizard)](https://github.com/usercode/ImageWizard) - Image processing webservice based on ASP.NET Core and ImageSharp / SkiaSharp / SvgNet / DocNET
...
* [MagicScaler ![GitHub Repo Stars](https://img.shields.io/github/stars/saucecontrol/PhotoSauce) ![GitHub last commit](https://img.shields.io/github/last-commit/saucecontrol/PhotoSauce)](https://github.com/saucecontrol/PhotoSauce) - High-performance image processing pipeline for .NET, focused on making complex imaging tasks simple.
...
* [PixelViewer ![GitHub Repo Stars](https://img.shields.io/github/stars/carina-studio/PixelViewer) ![GitHub last commit](https://img.shields.io/github/last-commit/carina-studio/PixelViewer)](https://github.com/carina-studio/PixelViewer) - Cross-platform (Windows/macOS/Linux) image viewer which supports reading raw Luminance/YUV/RGB/ARGB/Bayer pixels data from file and rendering it. 10/16-bit YUV and viewing image frame sequence are also supported (v1.99+).
...
* [Wix Toolset ![GitHub Repo Stars](https://img.shields.io/github/stars/wixtoolset/wix) ![GitHub last commit](https://img.shields.io/github/last-commit/wixtoolset/wix)](https://github.com/wixtoolset/wix) - The most powerful set of tools available to create your Windows installation experience
...
* [YantraJS ![GitHub Repo Stars](https://img.shields.io/github/stars/yantrajs/yantra) ![GitHub last commit](https://img.shields.io/github/last-commit/yantrajs/yantra)](https://github.com/yantrajs/yantra) - JavaScript Runtime (Similar to NodeJS) for .NET Standard, compiles JavaScript to IL, support for many ES6 features, generators, CommonJS modules, CSX modules and expression compiler.
...
* [F# Data ![GitHub Repo Stars](https://img.shields.io/github/stars/fsprojects/FSharp.Data) ![GitHub last commit](https://img.shields.io/github/last-commit/fsprojects/FSharp.Data)](https://github.com/fsprojects/FSharp.Data) - F# type providers for accessing XML, JSON, CSV and HTML files (based on sample documents) and for accessing WorldBank data
...
* [OpenGA.Net ![GitHub Repo Stars](https://img.shields.io/github/stars/asarnaout/OpenGeneticAlgorithm.NET) ![GitHub last commit](https://img.shields.io/github/last-commit/asarnaout/OpenGeneticAlgorithm.NET)](https://github.com/asarnaout/OpenGeneticAlgorithm.NET) - Genetic algorithm .NET library for solving optimization problems, featuring extensible operators and adaptive strategy selection.
...
* [MailKitSimplified ![GitHub Repo Stars](https://img.shields.io/github/stars/danzuep/MailKitSimplified) ![GitHub last commit](https://img.shields.io/github/last-commit/danzuep/MailKitSimplified)](https://github.com/danzuep/MailKitSimplified) - A fully-featured fluent wrapper for MailKit that makes sending _and receiving_ emails as simple as possible.
...
* [WPF-Math ![GitHub Repo Stars](https://img.shields.io/github/stars/ForNeVeR/wpf-math) ![GitHub last commit](https://img.shields.io/github/last-commit/ForNeVeR/wpf-math)](https://github.com/ForNeVeR/wpf-math) - a .NET library for rendering mathematical formulae using the LaTeX typesetting style, for the WPF framework
* [Jodo.Numerics ![GitHub Repo Stars](https://img.shields.io/github/stars/JosephJShort/Jodo) ![GitHub last commit](https://img.shields.io/github/last-commit/JosephJShort/Jodo)](https://github.com/JosephJShort/Jodo/#numerics) - Provides extra number types (such as fixed-point and non-overflowing numbers) with full support for operators, math, string-parsing etc. Extensively tested, and cross-platform compatible.
...
* [Community Toolkit](https://github.com/CommunityToolkit) - Collection of control & helper libraries and samples for various .NET technologies. Contains modern MVVM library, supported by Microsoft. Includes [Windows Community Toolkit ![GitHub Repo Stars](https://img.shields.io/github/stars/CommunityToolkit/WindowsCommunityToolkit) ![GitHub last commit](https://img.shields.io/github/last-commit/CommunityToolkit/WindowsCommunityToolkit)](https://github.com/CommunityToolkit/WindowsCommunityToolkit), [MAUI Community Toolkit ![GitHub Repo Stars](https://img.shields.io/github/stars/CommunityToolkit/Maui) ![GitHub last commit](https://img.shields.io/github/last-commit/CommunityToolkit/Maui)](https://github.com/CommunityToolkit/Maui), and [Dotnet Community Toolkit ![GitHub Repo Stars](https://img.shields.io/github/stars/CommunityToolkit/dotnet) ![GitHub last commit](https://img.shields.io/github/last-commit/CommunityToolkit/dotnet)](https://github.com/CommunityToolkit/dotnet).
...
* [Catel ![GitHub Repo Stars](https://img.shields.io/github/stars/Catel/Catel) ![GitHub last commit](https://img.shields.io/github/last-commit/Catel/Catel)](https://github.com/Catel/Catel) - Catel is an application development platform with the focus on MVVM (WPF, Silverlight, Windows Phone and WinRT) and MVC (ASP.NET MVC). The core of Catel contains an IoC container, models, validation, memento, message mediator, argument checking, etc.
...
* [Mapperly ![GitHub Repo Stars](https://img.shields.io/github/stars/riok/mapperly) ![GitHub last commit](https://img.shields.io/github/last-commit/riok/mapperly)](https://github.com/riok/mapperly) - A .NET source generator for generating object mappings. No runtime reflection.
...
* [OfficeIMO ![GitHub Repo Stars](https://img.shields.io/github/stars/EvotecIt/OfficeIMO) ![GitHub last commit](https://img.shields.io/github/last-commit/EvotecIt/OfficeIMO)](https://github.com/EvotecIt/OfficeIMO) - OfficeIMO makes it easier for developers to create/modify Word (docx) files without having Microsoft Word or Office installed
...
* [EPPlus ![GitHub Repo Stars](https://img.shields.io/github/stars/EPPlusSoftware/EPPlus) ![GitHub last commit](https://img.shields.io/github/last-commit/EPPlusSoftware/EPPlus)](https://github.com/EPPlusSoftware/EPPlus) - EPPlus is a .NET library that reads and writes Excel 2007/2010 files using the Open Office XML format (xlsx).
...
* [EFCore.BulkExtensions ![GitHub Repo Stars](https://img.shields.io/github/stars/borisdj/EFCore.BulkExtensions) ![GitHub last commit](https://img.shields.io/github/last-commit/borisdj/EFCore.BulkExtensions)](https://github.com/borisdj/EFCore.BulkExtensions) - Entity Framework Core Bulk Extensions for super fast (BulkCopy) CRUD ops + SaveChanges on multiple DBs: SQL, PG, My, Lite.
...
* [ServiceStack.OrmLite ![GitHub Repo Stars](https://img.shields.io/github/stars/ServiceStack/ServiceStack) ![GitHub last commit](https://img.shields.io/github/last-commit/ServiceStack/ServiceStack)](https://github.com/ServiceStack/ServiceStack/tree/main/ServiceStack.OrmLite) - Light, simple and fast convention-based POCO ORM **[[Free for OSS ![GitHub Repo Stars](https://img.shields.io/github/stars/ServiceStack/ServiceStack) ![GitHub last commit](https://img.shields.io/github/last-commit/ServiceStack/ServiceStack)](https://github.com/ServiceStack/ServiceStack/blob/master/license.txt)]** **[$]**
...
* [QPdfSharp ![GitHub Repo Stars](https://img.shields.io/github/stars/svengeance/QPdfSharp) ![GitHub last commit](https://img.shields.io/github/last-commit/svengeance/QPdfSharp)](https://github.com/svengeance/QPdfSharp) - A C# wrapper written around QPdf to allow for easy PDF manipulation that is tested for both linux and windows. QPdf is one of the only libraries capable of PDF linearization, and this wrapper ensures you keep up to date with the underlying improvements.
...
* [IText ![GitHub Repo Stars](https://img.shields.io/github/stars/itext/itext-dotnet) ![GitHub last commit](https://img.shields.io/github/last-commit/itext/itext-dotnet)](https://github.com/itext/itext-dotnet) - iText is a PDF library that allows you to CREATE, ADAPT, INSPECT and MAINTAIN documents in the Portable Document Format (PDF)**[$]** **[Free for OSS]**
...
* [Kevsoft.PDFtk ![GitHub Repo Stars](https://img.shields.io/github/stars/kevbite/Kevsoft.PDFtk) ![GitHub last commit](https://img.shields.io/github/last-commit/kevbite/Kevsoft.PDFtk)](https://github.com/kevbite/Kevsoft.PDFtk) - A wrapper to drive the awesome pdftk binary, which can fill PDF forms, get field information, concatenate multiple documents or pages, split documents, add or replace stamps, and can attach files to or download files from pages.
...
* [gRPCurl ![GitHub Repo Stars](https://img.shields.io/github/stars/fullstorydev/grpcurl) ![GitHub last commit](https://img.shields.io/github/last-commit/fullstorydev/grpcurl)](https://github.com/fullstorydev/grpcurl) - gRPCurl is a command-line tool that lets you interact with gRPC servers. It's basically curl for gRPC servers.
* [gRPC UI ![GitHub Repo Stars](https://img.shields.io/github/stars/fullstorydev/grpcui) ![GitHub last commit](https://img.shields.io/github/last-commit/fullstorydev/grpcui)](https://github.com/fullstorydev/grpcui) - gRPC UI is a command-line tool that lets you interact with gRPC servers via a browser. It's sort of like Postman, but for gRPC APIs instead of REST.
...
* [NCrontab.Scheduler ![GitHub Repo Stars](https://img.shields.io/github/stars/thomasgalliker/NCrontab.Scheduler) ![GitHub last commit](https://img.shields.io/github/last-commit/thomasgalliker/NCrontab.Scheduler)](https://github.com/thomasgalliker/NCrontab.Scheduler) - Simple task scheduler library for scheduling NCrontab-based tasks
...
**Embedded Search Libraries** - like lucene, but easier to use.  
  * [Lunr-Core ![GitHub Repo Stars](https://img.shields.io/github/stars/bleroy/lunr-core) ![GitHub last commit](https://img.shields.io/github/last-commit/bleroy/lunr-core)](https://github.com/bleroy/lunr-core) - Lunr-core is a small, full text search library for use in small applications. It's a .NET port of LUNR.js. 
  * [hOOt ![GitHub Repo Stars](https://img.shields.io/github/stars/mgholam/hOOt) ![GitHub last commit](https://img.shields.io/github/last-commit/mgholam/hOOt)](https://github.com/mgholam/hOOt) - Smallest full text search engine (lucene replacement). built from scratch using inverted Roaring bitmap index, highly compact storage, operating in database and document modes 
  * [ZoneTree.FullTextSearch ![GitHub Repo Stars](https://img.shields.io/github/stars/koculu/ZoneTree.FullTextSearch) ![GitHub last commit](https://img.shields.io/github/last-commit/koculu/ZoneTree.FullTextSearch)](https://github.com/koculu/ZoneTree.FullTextSearch) - efficient full-text search library. extends ZoneTree. It is fast, embedded search engine suitable for applications that require high performance and do not rely on external databases. 
...
* [FlatSharp ![GitHub Repo Stars](https://img.shields.io/github/stars/jamescourtney/FlatSharp) ![GitHub last commit](https://img.shields.io/github/last-commit/jamescourtney/FlatSharp)](https://github.com/jamescourtney/FlatSharp) - Fast, idiomatic FlatBuffers implementation. Use .fbs files or attributes.
...
* [ObjectDumper.NET ![GitHub Repo Stars](https://img.shields.io/github/stars/thomasgalliker/ObjectDumper) ![GitHub last commit](https://img.shields.io/github/last-commit/thomasgalliker/ObjectDumper)](https://github.com/thomasgalliker/ObjectDumper) - Serializes in-memory object to C# code.
* [FluentSerializer ![GitHub Repo Stars](https://img.shields.io/github/stars/Marvin-Brouwer/FluentSerializer) ![GitHub last commit](https://img.shields.io/github/last-commit/Marvin-Brouwer/FluentSerializer)](https://github.com/Marvin-Brouwer/FluentSerializer#readme) - A profile-based Serializer for multiple data-formats.
...
* [Morestachio ![GitHub Repo Stars](https://img.shields.io/github/stars/JPVenson/morestachio) ![GitHub last commit](https://img.shields.io/github/last-commit/JPVenson/morestachio)](https://github.com/JPVenson/morestachio) - A full sized {{mustache}} like template engine with focus on extendibility.
* [Fluid ![GitHub Repo Stars](https://img.shields.io/github/stars/sebastienros/fluid) ![GitHub last commit](https://img.shields.io/github/last-commit/sebastienros/fluid)](https://github.com/sebastienros/fluid) - Fluid is an open-source .NET template engine based on the Liquid template language.
* [SmartFormat ![GitHub Repo Stars](https://img.shields.io/github/stars/axuno/SmartFormat) ![GitHub last commit](https://img.shields.io/github/last-commit/axuno/SmartFormat)](https://github.com/axuno/SmartFormat) - A lightweight text templating library written in C# which can be a drop-in replacement for string.Format
* [Handlebars.Net ![GitHub Repo Stars](https://img.shields.io/github/stars/Handlebars-Net/Handlebars.Net) ![GitHub last commit](https://img.shields.io/github/last-commit/Handlebars-Net/Handlebars.Net)](https://github.com/Handlebars-Net/Handlebars.Net) - A real .NET Handlebars engine
...
* [Moq ![GitHub Repo Stars](https://img.shields.io/github/stars/devlooped/moq) ![GitHub last commit](https://img.shields.io/github/last-commit/devlooped/moq)](https://github.com/devlooped/moq) - The most popular and friendly mocking framework for .NET
* [NBomber ![GitHub Repo Stars](https://img.shields.io/github/stars/PragmaticFlow/NBomber) ![GitHub last commit](https://img.shields.io/github/last-commit/PragmaticFlow/NBomber)](https://github.com/PragmaticFlow/NBomber) - Very simple load testing framework for Pull and Push scenarios. It's 100% written in F# and targeting .NET Core and full .NET Framework.
...
* [Testcontainers ![GitHub Repo Stars](https://img.shields.io/github/stars/testcontainers/testcontainers-dotnet) ![GitHub last commit](https://img.shields.io/github/last-commit/testcontainers/testcontainers-dotnet)](https://github.com/testcontainers/testcontainers-dotnet) - A library to support tests with throwaway instances of Docker containers for all compatible .NET Standard versions.
* [SecTester ![GitHub Repo Stars](https://img.shields.io/github/stars/NeuraLegion/sectester-net) ![GitHub last commit](https://img.shields.io/github/last-commit/NeuraLegion/sectester-net)](https://github.com/NeuraLegion/sectester-net) - SecTester is a new tool that integrates [Bright](https://brightsec.com/) enterprise-grade scan engine directly into your integration or e2e tests. **[Proprietary]** **[Free]**
...
* [DeftSharp.Windows.Input ![GitHub Repo Stars](https://img.shields.io/github/stars/Empiree/DeftSharp.Windows.Input) ![GitHub last commit](https://img.shields.io/github/last-commit/Empiree/DeftSharp.Windows.Input)](https://github.com/Empiree/DeftSharp.Windows.Input) - Listen Global keyboard / mouse events. simple to use. for Windows UI applications (WPF, MAUI, Avalonia) 
