...
- [renoir ![GitHub Repo Stars](https://img.shields.io/github/stars/MichailSemoglou/renoir) ![GitHub last commit](https://img.shields.io/github/last-commit/MichailSemoglou/renoir)](https://github.com/MichailSemoglou/renoir) - Python package for teaching computational color theory through art history. Extracts and analyzes artist-specific works from WikiArt with color palette extraction, harmony detection, and 17 progressive Jupyter notebooks for digital humanities education.
- [Stylo ![GitHub Repo Stars](https://img.shields.io/github/stars/computationalstylistics/stylo) ![GitHub last commit](https://img.shields.io/github/last-commit/computationalstylistics/stylo)](https://github.com/computationalstylistics/stylo) - R package for stylometric analyses.
...
- [OCRmyPDF ![GitHub Repo Stars](https://img.shields.io/github/stars/jbarlow83/OCRmyPDF) ![GitHub last commit](https://img.shields.io/github/last-commit/jbarlow83/OCRmyPDF)](https://github.com/jbarlow83/OCRmyPDF) - OCR toolkit.
...
- [Awesome Digital History ![GitHub Repo Stars](https://img.shields.io/github/stars/maehr/awesome-digital-history) ![GitHub last commit](https://img.shields.io/github/last-commit/maehr/awesome-digital-history)](https://github.com/maehr/awesome-digital-history) - A curated list of awesome things related to digital history.
- [Awesome IIIF ![GitHub Repo Stars](https://img.shields.io/github/stars/IIIF/awesome-iiif) ![GitHub last commit](https://img.shields.io/github/last-commit/IIIF/awesome-iiif)](https://github.com/IIIF/awesome-iiif) - A curated list of awesome resources related to the International Image Interoperability Framework (IIIF).
- [Awesome OCR ![GitHub Repo Stars](https://img.shields.io/github/stars/kba/awesome-ocr) ![GitHub last commit](https://img.shields.io/github/last-commit/kba/awesome-ocr)](https://github.com/kba/awesome-ocr) - This list contains links to great software tools and libraries and literature related to Optical Character Recognition (OCR).
- [Awesome Scientific Writing ![GitHub Repo Stars](https://img.shields.io/github/stars/writing-resources/awesome-scientific-writing) ![GitHub last commit](https://img.shields.io/github/last-commit/writing-resources/awesome-scientific-writing)](https://github.com/writing-resources/awesome-scientific-writing) - A curated list of awesome tools, demos and resources to go beyond LaTeX.
- [Awesome Web Archiving ![GitHub Repo Stars](https://img.shields.io/github/stars/iipc/awesome-web-archiving) ![GitHub last commit](https://img.shields.io/github/last-commit/iipc/awesome-web-archiving)](https://github.com/iipc/awesome-web-archiving) - Resources to archive the web.
...
- [DHSlack ![GitHub Repo Stars](https://img.shields.io/github/stars/amandavisconti/DHslack) ![GitHub last commit](https://img.shields.io/github/last-commit/amandavisconti/DHslack)](https://github.com/amandavisconti/DHslack/blob/master/CodeOfConduct.md) - Slack channels for digital humanities scholars.
...
- [Jupyter Notebooks for Digital Humanities ![GitHub Repo Stars](https://img.shields.io/github/stars/quinnanya/dh-jupyter) ![GitHub last commit](https://img.shields.io/github/last-commit/quinnanya/dh-jupyter)](https://github.com/quinnanya/dh-jupyter/blob/master/README.md) - A diverse range of Jupyter notebooks, comprising research materials, course content, Python tutorials, and specific analysis tools.
...
- [Bertin.js ![GitHub Repo Stars](https://img.shields.io/github/stars/neocarto/bertin) ![GitHub last commit](https://img.shields.io/github/last-commit/neocarto/bertin)](https://github.com/neocarto/bertin) - JavaScript library for visualizing geospatial data and make thematic maps for the web.
