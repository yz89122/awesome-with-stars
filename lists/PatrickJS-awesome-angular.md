...
* [playwright-ct-angular ![GitHub Repo Stars](https://img.shields.io/github/stars/sand4rt/playwright-ct-angular) ![GitHub last commit](https://img.shields.io/github/last-commit/sand4rt/playwright-ct-angular)](https://github.com/sand4rt/playwright-ct-angular) - Playwright Angular component testing.
...
* [ng-chartist ![GitHub Repo Stars](https://img.shields.io/github/stars/willsoto/ng-chartist) ![GitHub last commit](https://img.shields.io/github/last-commit/willsoto/ng-chartist)](https://github.com/willsoto/ng-chartist) - Angular component for Chartist.js.
...
* [luxon-angular ![GitHub Repo Stars](https://img.shields.io/github/stars/dstelljes/luxon-angular) ![GitHub last commit](https://img.shields.io/github/last-commit/dstelljes/luxon-angular)](https://github.com/dstelljes/luxon-angular) - date pipes for Angular.
* [angular-globalize ![GitHub Repo Stars](https://img.shields.io/github/stars/code-art-eg/angular-globalize) ![GitHub last commit](https://img.shields.io/github/last-commit/code-art-eg/angular-globalize)](https://github.com/code-art-eg/angular-globalize) - Angular pipes for localizing numbers and dates using Globalize.
...
* [angular-bootstrap-datetimepicker ![GitHub Repo Stars](https://img.shields.io/github/stars/dalelotts/angular-bootstrap-datetimepicker) ![GitHub last commit](https://img.shields.io/github/last-commit/dalelotts/angular-bootstrap-datetimepicker)](https://github.com/dalelotts/angular-bootstrap-datetimepicker) - Native Angular date/time picker component styled by Bootstrap.
...
* [ng-resize-observer ![GitHub Repo Stars](https://img.shields.io/github/stars/ChristianKohler/ng-resize-observer) ![GitHub last commit](https://img.shields.io/github/last-commit/ChristianKohler/ng-resize-observer)](https://github.com/ChristianKohler/ng-resize-observer)
...
* [ngx-validator ![GitHub Repo Stars](https://img.shields.io/github/stars/why520crazy/ngx-validator) ![GitHub last commit](https://img.shields.io/github/last-commit/why520crazy/ngx-validator)](https://github.com/why520crazy/ngx-validator) - Angular 7+ Validator. Handle validation messages easily and automatically.
...
* [ng-svg-icon-sprite ![GitHub Repo Stars](https://img.shields.io/github/stars/jannicz/ng-svg-icon-sprite) ![GitHub last commit](https://img.shields.io/github/last-commit/jannicz/ng-svg-icon-sprite)](https://github.com/jannicz/ng-svg-icon-sprite) - Angular 16+ package for generating and using inline SVG icons in your project.
...
* [ionic-angular-collect-icons ![GitHub Repo Stars](https://img.shields.io/github/stars/rdlabo-team/ionic-angular-collect-icons) ![GitHub last commit](https://img.shields.io/github/last-commit/rdlabo-team/ionic-angular-collect-icons)](https://github.com/rdlabo-team/ionic-angular-collect-icons) - This library is used to uniquely group the ionIcons in a project, and generate for export ionIcons file.
...
* [ngx-bootstrap-icons ![GitHub Repo Stars](https://img.shields.io/github/stars/avmaisak/ngx-bootstrap-icons) ![GitHub last commit](https://img.shields.io/github/last-commit/avmaisak/ngx-bootstrap-icons)](https://github.com/avmaisak/ngx-bootstrap-icons) - This Angular module allows you to use the Bootstrap Icons in your Angular application without additional dependencies.
* [ngx-icon ![GitHub Repo Stars](https://img.shields.io/github/stars/anedomansky/ngx-icon) ![GitHub last commit](https://img.shields.io/github/last-commit/anedomansky/ngx-icon)](https://github.com/anedomansky/ngx-icon) - An Angular component for displaying SVG icons.
* [angular-feather ![GitHub Repo Stars](https://img.shields.io/github/stars/michaelbazos/angular-feather) ![GitHub last commit](https://img.shields.io/github/last-commit/michaelbazos/angular-feather)](https://github.com/michaelbazos/angular-feather) - This package allows you to use [Feather Icons ![GitHub Repo Stars](https://img.shields.io/github/stars/feathericons/feather) ![GitHub last commit](https://img.shields.io/github/last-commit/feathericons/feather)](https://github.com/feathericons/feather) in your Angular applications.
...
* [ngx-unsplash ![GitHub Repo Stars](https://img.shields.io/github/stars/BerryCloud/ngx-unsplash) ![GitHub last commit](https://img.shields.io/github/last-commit/BerryCloud/ngx-unsplash)](https://github.com/BerryCloud/ngx-unsplash) - Angular service for proxied [Unsplash API](https://unsplash.com/developers).
...
* [ngx-logger ![GitHub Repo Stars](https://img.shields.io/github/stars/dbfannin/ngx-logger) ![GitHub last commit](https://img.shields.io/github/last-commit/dbfannin/ngx-logger)](https://github.com/dbfannin/ngx-logger) - NGX Logger is a simple logging module for Angular (6+). It allows "pretty print" to the console, as well as allowing log messages to be POSTed to a URL for server-side logging.
...
* [ngx-action-logger ![GitHub Repo Stars](https://img.shields.io/github/stars/TALRACE/ngx-action-logger) ![GitHub last commit](https://img.shields.io/github/last-commit/TALRACE/ngx-action-logger)](https://github.com/TALRACE/ngx-action-logger) - Logger for Angular applications, capable of both outputting data to the console or sending data to elastic.
...
* [ngx-youtube-player ![GitHub Repo Stars](https://img.shields.io/github/stars/orizens/ngx-youtube-player) ![GitHub last commit](https://img.shields.io/github/last-commit/orizens/ngx-youtube-player)](https://github.com/orizens/ngx-youtube-player) - Angular component based on [YouTube player iframe API](https://developers.google.com/youtube/iframe_api_reference).
...
* [ngx-scrolltop ![GitHub Repo Stars](https://img.shields.io/github/stars/bartholomej/ngx-scrolltop) ![GitHub last commit](https://img.shields.io/github/last-commit/bartholomej/ngx-scrolltop)](https://github.com/bartholomej/ngx-scrolltop) - Lightweight, Material Design inspired **button for scroll-to-top** of the page. 🔼 **No dependencies. Pure Angular!** (Compatibility: Angular 9, Ivy, Universal, `ng add`).
...
* [angular-confirmation-popover ![GitHub Repo Stars](https://img.shields.io/github/stars/mattlewis92/angular-confirmation-popover) ![GitHub last commit](https://img.shields.io/github/last-commit/mattlewis92/angular-confirmation-popover)](https://github.com/mattlewis92/angular-confirmation-popover) - An angular 15.0+ bootstrap confirmation popover.
...
* [ng2-tooltip-directive ![GitHub Repo Stars](https://img.shields.io/github/stars/cloudfactorydk/ng2-tooltip-directive) ![GitHub last commit](https://img.shields.io/github/last-commit/cloudfactorydk/ng2-tooltip-directive)](https://github.com/cloudfactorydk/ng2-tooltip-directive) - Forked from [ng2-tooltip-directive ![GitHub Repo Stars](https://img.shields.io/github/stars/drozhzhin-n-e/ng2-tooltip-directive) ![GitHub last commit](https://img.shields.io/github/last-commit/drozhzhin-n-e/ng2-tooltip-directive)](https://github.com/drozhzhin-n-e/ng2-tooltip-directive).
...
* [ngrx-store-formsync ![GitHub Repo Stars](https://img.shields.io/github/stars/larscom/ngrx-store-formsync) ![GitHub last commit](https://img.shields.io/github/last-commit/larscom/ngrx-store-formsync)](https://github.com/larscom/ngrx-store-formsync) - Synchronize any reactive form to `@ngrx/store`.
...
* [observer-spy ![GitHub Repo Stars](https://img.shields.io/github/stars/hirezio/observer-spy) ![GitHub last commit](https://img.shields.io/github/last-commit/hirezio/observer-spy)](https://github.com/hirezio/observer-spy) - This library makes RxJS Observables testing easy!
...
* [rxjs-toolbox ![GitHub Repo Stars](https://img.shields.io/github/stars/kievsash/rxjs-toolbox) ![GitHub last commit](https://img.shields.io/github/last-commit/kievsash/rxjs-toolbox)](https://github.com/kievsash/rxjs-toolbox) - Set of custom operators and handy factory functions for RxJS.
