...
If you want to [contribute ![GitHub Repo Stars](https://img.shields.io/github/stars/sublimino/awesome-funny-markov) ![GitHub last commit](https://img.shields.io/github/last-commit/sublimino/awesome-funny-markov)](https://github.com/sublimino/awesome-funny-markov/blob/master/contributing.md) to this list (please do), send a pull request or contact me [@sublimino](https://twitter.com/sublimino).

Looking for more information on Markov Chains? Try [Awesome Machine Learning ![GitHub Repo Stars](https://img.shields.io/github/stars/josephmisiti/awesome-machine-learning) ![GitHub last commit](https://img.shields.io/github/last-commit/josephmisiti/awesome-machine-learning)](https://github.com/josephmisiti/awesome-machine-learning).
...
- [4chan Text Generator ![GitHub Repo Stars](https://img.shields.io/github/stars/02sh/4chanMarkovText) ![GitHub last commit](https://img.shields.io/github/last-commit/02sh/4chanMarkovText)](https://github.com/02sh/4chanMarkovText) - With sample inputs for /biz/ /pol/ /b/ /fit/ (NSFW).
...
- [Reimagined Yo Mama ![GitHub Repo Stars](https://img.shields.io/github/stars/Trshant/reimagined-yomama) ![GitHub last commit](https://img.shields.io/github/last-commit/Trshant/reimagined-yomama)](https://github.com/Trshant/reimagined-yomama) - yo mama jokes using markov chains (code only).
