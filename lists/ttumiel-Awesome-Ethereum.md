...
- [GitHub Wiki ![GitHub Repo Stars](https://img.shields.io/github/stars/ethereum/wiki) ![GitHub last commit](https://img.shields.io/github/last-commit/ethereum/wiki)](https://github.com/ethereum/wiki/wiki) - Ethereum wiki covering all things related to Ethereum. The go-to place for all things.
- [Whitepaper ![GitHub Repo Stars](https://img.shields.io/github/stars/ethereum/wiki) ![GitHub last commit](https://img.shields.io/github/last-commit/ethereum/wiki)](https://github.com/ethereum/wiki/wiki/White-Paper) - Non-technical introductory description of Ethereum.
...
- [Embark Framework ![GitHub Repo Stars](https://img.shields.io/github/stars/embark-framework/embark) ![GitHub last commit](https://img.shields.io/github/last-commit/embark-framework/embark)](https://github.com/embark-framework/embark) - Framework for serverless Decentralized Applications using Ethereum, IPFS and other platforms.
...
- [Smart contract safety ![GitHub Repo Stars](https://img.shields.io/github/stars/ethereum/wiki) ![GitHub last commit](https://img.shields.io/github/last-commit/ethereum/wiki)](https://github.com/ethereum/wiki/wiki/Safety) - Ethereum wiki on best practices for safety in smart contracts.
...
- [Ethereum Wiki Philosophy ![GitHub Repo Stars](https://img.shields.io/github/stars/ethereum/ethereum.org) ![GitHub last commit](https://img.shields.io/github/last-commit/ethereum/ethereum.org)](https://github.com/ethereum/ethereum.org/wiki/Philosophy) - Some of the core philosophies of Ethereum.
...
- [Mist ![GitHub Repo Stars](https://img.shields.io/github/stars/ethereum/mist) ![GitHub last commit](https://img.shields.io/github/last-commit/ethereum/mist)](https://github.com/ethereum/mist) - Official Ethereum wallet - Browse and use Ðapps on the Ethereum network.
...
- [Whisper ![GitHub Repo Stars](https://img.shields.io/github/stars/ethereum/wiki) ![GitHub last commit](https://img.shields.io/github/last-commit/ethereum/wiki)](https://github.com/ethereum/wiki/wiki/Whisper-pages) - A communication protocol for DApps to communicate with each other.
- [Casper ![GitHub Repo Stars](https://img.shields.io/github/stars/ethereum/wiki) ![GitHub last commit](https://img.shields.io/github/last-commit/ethereum/wiki)](https://github.com/ethereum/wiki/wiki/Casper-Proof-of-Stake-compendium) - Proof of Stake Implementation.
  - Casper CBC - Correct by Construction for full Proof-of-Stake.
    - [Code Repository ![GitHub Repo Stars](https://img.shields.io/github/stars/ethereum/cbc-casper) ![GitHub last commit](https://img.shields.io/github/last-commit/ethereum/cbc-casper)](https://github.com/ethereum/cbc-casper) - A python implementation of a class of correct-by-construction consensus protocols.
    - [CBC Wiki ![GitHub Repo Stars](https://img.shields.io/github/stars/ethereum/cbc-casper) ![GitHub last commit](https://img.shields.io/github/last-commit/ethereum/cbc-casper)](https://github.com/ethereum/cbc-casper/wiki)
    - [CBC Research Paper ![GitHub Repo Stars](https://img.shields.io/github/stars/ethereum/research) ![GitHub last commit](https://img.shields.io/github/last-commit/ethereum/research)](https://github.com/ethereum/research/blob/master/papers/cbc-consensus/AbstractCBC.pdf)
  - Casper FFG - Friendly Finality Gadget for PoS validation with Proof-of-Work.
    - [Code Repository ![GitHub Repo Stars](https://img.shields.io/github/stars/ethereum/casper) ![GitHub last commit](https://img.shields.io/github/last-commit/ethereum/casper)](https://github.com/ethereum/casper) - The FFG contract, related software and tests.
    - [Casper the Friendly Finality Gadget Paper](https://arxiv.org/abs/1710.09437) - Research paper detailing FFG.
  - [PoS FAQs ![GitHub Repo Stars](https://img.shields.io/github/stars/ethereum/wiki) ![GitHub last commit](https://img.shields.io/github/last-commit/ethereum/wiki)](https://github.com/ethereum/wiki/wiki/Proof-of-Stake-FAQs)
...
- [Sharding ![GitHub Repo Stars](https://img.shields.io/github/stars/ethereum/wiki) ![GitHub last commit](https://img.shields.io/github/last-commit/ethereum/wiki)](https://github.com/ethereum/wiki/wiki/Sharding-introduction-R&D-compendium) - Partitioning computational resources so that nodes do not have to process the entire blockchain.
- [Web3.js ![GitHub Repo Stars](https://img.shields.io/github/stars/ethereum/web3.js) ![GitHub last commit](https://img.shields.io/github/last-commit/ethereum/web3.js)](https://github.com/ethereum/web3.js) - Ethereum's JavaScript API.
- [Ethash Proof of Work ![GitHub Repo Stars](https://img.shields.io/github/stars/ethereum/wiki) ![GitHub last commit](https://img.shields.io/github/last-commit/ethereum/wiki)](https://github.com/ethereum/wiki/wiki/Ethash) - Ethereum's Proof of Work Algorithm.
- zk-SNARKS - Verify knowledge of a secret without revealing it.
  ...
  - [A practical beginner's guide to creating, proving, and verifying zkSNARKs ![GitHub Repo Stars](https://img.shields.io/github/stars/jstoxrocky/zksnarks_example) ![GitHub last commit](https://img.shields.io/github/last-commit/jstoxrocky/zksnarks_example)](https://github.com/jstoxrocky/zksnarks_example) - Introduction to zk-SNARKS and implementation as a smart contract.
...
- [Mastering Ethereum ![GitHub Repo Stars](https://img.shields.io/github/stars/ethereumbook/ethereumbook) ![GitHub last commit](https://img.shields.io/github/last-commit/ethereumbook/ethereumbook)](https://github.com/ethereumbook/ethereumbook) - A developers guide to the operation and use of Ethereum.
