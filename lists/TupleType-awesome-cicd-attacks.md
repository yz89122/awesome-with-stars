...
- [GitLab Secrets ![GitHub Repo Stars](https://img.shields.io/github/stars/RichardoC/gitlab-secrets) ![GitHub last commit](https://img.shields.io/github/last-commit/RichardoC/gitlab-secrets)](https://github.com/RichardoC/gitlab-secrets) - A tool that can reveal deleted GitLab commits that potentially contain sensitive information and are not accessible via the public Git history.
...
- [ActionsTOCTOU (Time Of Check to Time Of Use) ![GitHub Repo Stars](https://img.shields.io/github/stars/AdnaneKhan/ActionsTOCTOU) ![GitHub last commit](https://img.shields.io/github/last-commit/AdnaneKhan/ActionsTOCTOU)](https://github.com/AdnaneKhan/ActionsTOCTOU/) - A tool to monitor for an approval event and then quickly replace a file in the PR head with a local file specified as a parameter.
...
- [Living off the pipeline ![GitHub Repo Stars](https://img.shields.io/github/stars/boostsecurityio/lotp) ![GitHub last commit](https://img.shields.io/github/last-commit/boostsecurityio/lotp)](https://github.com/boostsecurityio/lotp) - Inventory how development tools (typically CLIs), have lesser-known RCE-By-Design features.
...
- [PR sneaking ![GitHub Repo Stars](https://img.shields.io/github/stars/mortenson/pr-sneaking) ![GitHub last commit](https://img.shields.io/github/last-commit/mortenson/pr-sneaking)](https://github.com/mortenson/pr-sneaking) - Methods of sneaking malicious code into GitHub pull requests.
...
## Tools
- [ADOKit ![GitHub Repo Stars](https://img.shields.io/github/stars/xforcered/ADOKit) ![GitHub last commit](https://img.shields.io/github/last-commit/xforcered/ADOKit)](https://github.com/xforcered/ADOKit) - Azure DevOps Services Attack Toolkit.
- [Gato ![GitHub Repo Stars](https://img.shields.io/github/stars/praetorian-inc/gato) ![GitHub last commit](https://img.shields.io/github/last-commit/praetorian-inc/gato)](https://github.com/praetorian-inc/gato) - GitHub Attack Toolkit.
- [Gato-X ![GitHub Repo Stars](https://img.shields.io/github/stars/AdnaneKhan/Gato-X) ![GitHub last commit](https://img.shields.io/github/last-commit/AdnaneKhan/Gato-X)](https://github.com/AdnaneKhan/Gato-X) - GitHub Attack Toolkit - Extreme Edition.
...
- [git-dumper ![GitHub Repo Stars](https://img.shields.io/github/stars/arthaud/git-dumper) ![GitHub last commit](https://img.shields.io/github/last-commit/arthaud/git-dumper)](https://github.com/arthaud/git-dumper) - Dump Git repository from a website.
- [GitFive ![GitHub Repo Stars](https://img.shields.io/github/stars/mxrch/gitfive) ![GitHub last commit](https://img.shields.io/github/last-commit/mxrch/gitfive)](https://github.com/mxrch/gitfive) - OSINT tool to investigate GitHub profiles.
- [Grep.app](https://grep.app/) - Search GitHub using regex.
- [Jenkins Attack Framework ![GitHub Repo Stars](https://img.shields.io/github/stars/Accenture/jenkins-attack-framework) ![GitHub last commit](https://img.shields.io/github/last-commit/Accenture/jenkins-attack-framework)](https://github.com/Accenture/jenkins-attack-framework) - This tool can manage Jenkins tasks, like listing jobs, dumping credentials, running commands/scripts, and managing API tokens.
...
- [zizmor ![GitHub Repo Stars](https://img.shields.io/github/stars/zizmorcore/zizmor) ![GitHub last commit](https://img.shields.io/github/last-commit/zizmorcore/zizmor)](https://github.com/zizmorcore/zizmor) - Static analysis for GitHub Actions.
...
- [GitHub Actions Attack Diagram ![GitHub Repo Stars](https://img.shields.io/github/stars/jstawinski/GitHub-Actions-Attack-Diagram) ![GitHub last commit](https://img.shields.io/github/last-commit/jstawinski/GitHub-Actions-Attack-Diagram)](https://github.com/jstawinski/GitHub-Actions-Attack-Diagram) - Includes public vulnerability research presented at Black Hat USA 2024 and DEF CON 32.
