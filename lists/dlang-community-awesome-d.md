...
* [OpenGL tutorials ![GitHub Repo Stars](https://img.shields.io/github/stars/drewet/opengl-tutorials) ![GitHub last commit](https://img.shields.io/github/last-commit/drewet/opengl-tutorials)](https://github.com/drewet/opengl-tutorials) - OpenGL tutorials in D.
...
* [Pegged ![GitHub Repo Stars](https://img.shields.io/github/stars/dlang-community/Pegged) ![GitHub last commit](https://img.shields.io/github/last-commit/dlang-community/Pegged)](https://github.com/dlang-community/Pegged) - A Parsing Expression Grammar (PEG) module written in D.
...
* [NuMem ![GitHub Repo Stars](https://img.shields.io/github/stars/Inochi2D/numem) ![GitHub last commit](https://img.shields.io/github/last-commit/Inochi2D/numem)](https://github.com/Inochi2D/numem) - No-GC memory management utilities for DLang.
...
* [commandr ![GitHub Repo Stars](https://img.shields.io/github/stars/robik/commandr) ![GitHub last commit](https://img.shields.io/github/last-commit/robik/commandr)](https://github.com/robik/commandr) - A modern, powerful command line argument parser.
...
* [sokol-d ![GitHub Repo Stars](https://img.shields.io/github/stars/floooh/sokol-d) ![GitHub last commit](https://img.shields.io/github/last-commit/floooh/sokol-d)](https://github.com/floooh/sokol-d) - D bindings for the sokol headers.
...
* [DSFML ![GitHub Repo Stars](https://img.shields.io/github/stars/Jebbs/DSFML) ![GitHub last commit](https://img.shields.io/github/last-commit/Jebbs/DSFML)](https://github.com/Jebbs/DSFML) - A static binding of SFML in a way that makes sense for D.
...
* [BindBC](https://github.com/BindBC) - Bindings compatible with `-betterC` and `@nogc`, using [bindbc-loader ![GitHub Repo Stars](https://img.shields.io/github/stars/BindBC/bindbc-loader) ![GitHub last commit](https://img.shields.io/github/last-commit/BindBC/bindbc-loader)](https://github.com/BindBC/bindbc-loader).
	...
	* [Imgui ![GitHub Repo Stars](https://img.shields.io/github/stars/Inochi2D/i2d-imgui) ![GitHub last commit](https://img.shields.io/github/last-commit/Inochi2D/i2d-imgui)](https://github.com/Inochi2D/i2d-imgui) - Immediate mode GUI
	...
	* [WebGPU ![GitHub Repo Stars](https://img.shields.io/github/stars/DLangGamedev/bindbc-wgpu) ![GitHub last commit](https://img.shields.io/github/last-commit/DLangGamedev/bindbc-wgpu)](https://github.com/DLangGamedev/bindbc-wgpu) - Modern GPU API
	...
	* [SoLoud ![GitHub Repo Stars](https://img.shields.io/github/stars/DLangGamedev/bindbc-soloud) ![GitHub last commit](https://img.shields.io/github/last-commit/DLangGamedev/bindbc-soloud)](https://github.com/DLangGamedev/bindbc-soloud) - Audio library
	...
	* [Newton Dynamics ![GitHub Repo Stars](https://img.shields.io/github/stars/DLangGamedev/bindbc-newton) ![GitHub last commit](https://img.shields.io/github/last-commit/DLangGamedev/bindbc-newton)](https://github.com/DLangGamedev/bindbc-newton) - Physics library
...
* [dlogg ![GitHub Repo Stars](https://img.shields.io/github/stars/NCrashed/dlogg) ![GitHub last commit](https://img.shields.io/github/last-commit/NCrashed/dlogg)](https://github.com/NCrashed/dlogg) - Logging for concurrent applications and daemons with lazy and delayed logging, logrotate support.
