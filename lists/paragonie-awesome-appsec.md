...
### [Hack Night ![GitHub Repo Stars](https://img.shields.io/github/stars/isislab/Hack-Night) ![GitHub last commit](https://img.shields.io/github/last-commit/isislab/Hack-Night)](https://github.com/isislab/Hack-Night)
...
### [OWASP NodeGoat ![GitHub Repo Stars](https://img.shields.io/github/stars/owasp/nodegoat) ![GitHub last commit](https://img.shields.io/github/last-commit/owasp/nodegoat)](https://github.com/owasp/nodegoat)

Purposly vulnerable to the OWASP Top 10 Node.JS web application, with [tutorials](https://nodegoat.herokuapp.com/tutorial), [security regression testing with the OWASP Zap API ![GitHub Repo Stars](https://img.shields.io/github/stars/OWASP/NodeGoat) ![GitHub last commit](https://img.shields.io/github/last-commit/OWASP/NodeGoat)](https://github.com/OWASP/NodeGoat/wiki/NodeGoat-Security-Regression-tests-with-ZAP-API), [docker image ![GitHub Repo Stars](https://img.shields.io/github/stars/owasp/nodegoat) ![GitHub last commit](https://img.shields.io/github/last-commit/owasp/nodegoat)](https://github.com/owasp/nodegoat#option-3---run-nodegoat-on-docker). With several options to get up and running fast.
...
### [Clojure OWASP ![GitHub Repo Stars](https://img.shields.io/github/stars/nubank/clj-owasp) ![GitHub last commit](https://img.shields.io/github/last-commit/nubank/clj-owasp)](https://github.com/nubank/clj-owasp) (2020)
...
### [Awesome Electron.js hacking & pentesting resources ![GitHub Repo Stars](https://img.shields.io/github/stars/doyensec/awesome-electronjs-hacking) ![GitHub last commit](https://img.shields.io/github/last-commit/doyensec/awesome-electronjs-hacking)](https://github.com/doyensec/awesome-electronjs-hacking) (2020)
...
Discusses the importance of end-to-end network-layer encryption (HTTPS) as well as secure encryption for data at rest, then introduces the specific cryptography tools that developers should use for specific use cases, whether they use [libsodium](https://pecl.php.net/package/libsodium), [Defuse Security's secure PHP encryption library ![GitHub Repo Stars](https://img.shields.io/github/stars/defuse/php-encryption) ![GitHub last commit](https://img.shields.io/github/last-commit/defuse/php-encryption)](https://github.com/defuse/php-encryption), or OpenSSL.
...
### [defuse/php-encryption ![GitHub Repo Stars](https://img.shields.io/github/stars/defuse/php-encryption) ![GitHub last commit](https://img.shields.io/github/last-commit/defuse/php-encryption)](https://github.com/defuse/php-encryption)

Symmetric-key encryption library for PHP applications. (**Recommended** over rolling your own!)

### [ircmaxell/password_compat ![GitHub Repo Stars](https://img.shields.io/github/stars/ircmaxell/password_compat) ![GitHub last commit](https://img.shields.io/github/last-commit/ircmaxell/password_compat)](https://github.com/ircmaxell/password_compat)

If you're using PHP 5.3.7+ or 5.4, use this to hash passwords

### [ircmaxell/RandomLib ![GitHub Repo Stars](https://img.shields.io/github/stars/ircmaxell/RandomLib) ![GitHub last commit](https://img.shields.io/github/last-commit/ircmaxell/RandomLib)](https://github.com/ircmaxell/RandomLib)

Useful for generating random strings or numbers

### [thephpleague/oauth2-server ![GitHub Repo Stars](https://img.shields.io/github/stars/thephpleague/oauth2-server) ![GitHub last commit](https://img.shields.io/github/last-commit/thephpleague/oauth2-server)](https://github.com/thephpleague/oauth2-server)

A secure OAuth2 server implementation

### [paragonie/random_compat ![GitHub Repo Stars](https://img.shields.io/github/stars/paragonie/random_compat) ![GitHub last commit](https://img.shields.io/github/last-commit/paragonie/random_compat)](https://github.com/paragonie/random_compat)
...
### [psecio/gatekeeper ![GitHub Repo Stars](https://img.shields.io/github/stars/psecio/gatekeeper) ![GitHub last commit](https://img.shields.io/github/last-commit/psecio/gatekeeper)](https://github.com/psecio/gatekeeper)
...
### [OWASP Python Security Wiki ![GitHub Repo Stars](https://img.shields.io/github/stars/ebranca/owasp-pysec) ![GitHub last commit](https://img.shields.io/github/last-commit/ebranca/owasp-pysec)](https://github.com/ebranca/owasp-pysec/wiki) (2014)
...
A guide to secure Ruby development by the Fedora Security Team. Also available on [Github ![GitHub Repo Stars](https://img.shields.io/github/stars/jrusnack/secure-ruby-development-guide) ![GitHub last commit](https://img.shields.io/github/last-commit/jrusnack/secure-ruby-development-guide)](https://github.com/jrusnack/secure-ruby-development-guide).
