...
# [<img src="https://cdn.rawgit.com/willempienaar/awesome-quantified-self/master/awesome-quantified-self.png"> ![GitHub Repo Stars](https://img.shields.io/github/stars/willempienaar/awesome-quantified-self) ![GitHub last commit](https://img.shields.io/github/last-commit/willempienaar/awesome-quantified-self)](https://github.com/willempienaar/awesome-quantified-self)
...
- [BiomarkerDash ![GitHub Repo Stars](https://img.shields.io/github/stars/NoTranslationLayer/biomarkerdash) ![GitHub last commit](https://img.shields.io/github/last-commit/NoTranslationLayer/biomarkerdash)](https://github.com/NoTranslationLayer/biomarkerdash) - Simple dashboard to visualize trends in bloodwork biomarkers.
...
- [Bloodboy ![GitHub Repo Stars](https://img.shields.io/github/stars/ashugaev/bloodboy-biomarkers-tracker) ![GitHub last commit](https://img.shields.io/github/last-commit/ashugaev/bloodboy-biomarkers-tracker)](https://github.com/ashugaev/bloodboy-biomarkers-tracker) - Biomarker analyzer that extracts lab results from PDFs, converts units, and visualizes trends.
...
- [Garmin AI Notifier ![GitHub Repo Stars](https://img.shields.io/github/stars/deep0410/garmin-ai-notifier) ![GitHub last commit](https://img.shields.io/github/last-commit/deep0410/garmin-ai-notifier)](https://github.com/deep0410/garmin-ai-notifier) - Free daily pipeline that pulls Garmin Connect into SQLite, computes full-history wellness stats, generates a Gemini-written brief, and pushes it to your phone via ntfy, Telegram, or email. Runs on GitHub Actions.
...
- [AirwayLab ![GitHub Repo Stars](https://img.shields.io/github/stars/airwaylab-app/airwaylab) ![GitHub last commit](https://img.shields.io/github/last-commit/airwaylab-app/airwaylab)](https://github.com/airwaylab-app/airwaylab) - Browser-based PAP therapy analysis with flow limitation scoring and an oximetry pipeline. All processing runs locally (Web).
...
- [Ledger ![GitHub Repo Stars](https://img.shields.io/github/stars/ledger/ledger) ![GitHub last commit](https://img.shields.io/github/last-commit/ledger/ledger)](https://github.com/ledger/ledger) - Simple but powerful command line accounting.
...
- [ezBookkeeping ![GitHub Repo Stars](https://img.shields.io/github/stars/mayswind/ezbookkeeping) ![GitHub last commit](https://img.shields.io/github/last-commit/mayswind/ezbookkeeping)](https://github.com/mayswind/ezbookkeeping) - A lightweight, self-hosted personal finance and bookkeeping app.
...
- [DNA Claude Analysis ![GitHub Repo Stars](https://img.shields.io/github/stars/shmlkv/dna-claude-analysis) ![GitHub last commit](https://img.shields.io/github/last-commit/shmlkv/dna-claude-analysis)](https://github.com/shmlkv/dna-claude-analysis) - Interactive personal genome analysis toolkit using Claude Code. Analyzes raw DNA data from 23andMe, AncestryDNA, and others across 17 categories including health risks, pharmacogenomics, nutrition, and longevity.

## Open Source Projects

- [Open mHealth](http://www.openmhealth.org/) - Open source health data integration tools.
- [Timelinize ![GitHub Repo Stars](https://img.shields.io/github/stars/timelinize/timelinize) ![GitHub last commit](https://img.shields.io/github/last-commit/timelinize/timelinize)](https://github.com/timelinize/timelinize) - A data aggregation and and timeline visualization tool.
- [TimelineBuilder ![GitHub Repo Stars](https://img.shields.io/github/stars/facebookresearch/personal-timeline) ![GitHub last commit](https://img.shields.io/github/last-commit/facebookresearch/personal-timeline)](https://github.com/facebookresearch/personal-timeline) - A data aggregation and and timeline visualization tool by Facebook.
- [Me API ![GitHub Repo Stars](https://img.shields.io/github/stars/danfang/me-api) ![GitHub last commit](https://img.shields.io/github/last-commit/danfang/me-api)](https://github.com/danfang/me-api) - An extensible, personal API with custom integrations.
- [Memacs ![GitHub Repo Stars](https://img.shields.io/github/stars/novoid/Memacs) ![GitHub last commit](https://img.shields.io/github/last-commit/novoid/Memacs)](https://github.com/novoid/Memacs) - Visualize your life in Orgmode.
- [HumanProgrammingInterface ![GitHub Repo Stars](https://img.shields.io/github/stars/karlicoss/HPI) ![GitHub last commit](https://img.shields.io/github/last-commit/karlicoss/HPI)](https://github.com/karlicoss/HPI) - Unify, acces and interact with all of your personal data.
...
- [ble-scale-sync ![GitHub Repo Stars](https://img.shields.io/github/stars/KristianP26/ble-scale-sync) ![GitHub last commit](https://img.shields.io/github/last-commit/KristianP26/ble-scale-sync)](https://github.com/KristianP26/ble-scale-sync) - Self-hosted CLI that reads BLE smart scales (23 brands), calculates body composition (fat %, muscle, BMR, etc.), and exports to Garmin Connect, MQTT, InfluxDB, Webhook, and Ntfy. [Website](https://blescalesync.dev).
- [Chronicle ![GitHub Repo Stars](https://img.shields.io/github/stars/chronicle-app/chronicle-etl) ![GitHub last commit](https://img.shields.io/github/last-commit/chronicle-app/chronicle-etl)](https://github.com/chronicle-app/chronicle-etl) - A CLI toolkit for extracting and working with your digital history.
- [QS-Schema ![GitHub Repo Stars](https://img.shields.io/github/stars/QS-Schema/qs-schema) ![GitHub last commit](https://img.shields.io/github/last-commit/QS-Schema/qs-schema)](https://github.com/QS-Schema/qs-schema) - Open schemes for QS applications.
- [Screenpipe ![GitHub Repo Stars](https://img.shields.io/github/stars/screenpipe/screenpipe) ![GitHub last commit](https://img.shields.io/github/last-commit/screenpipe/screenpipe)](https://github.com/screenpipe/screenpipe) - 24/7 local screen and audio recording with AI-powered search. Captures everything you see, say, and hear for personal analytics and lifelogging.
...
- [Longevity World Cup ![GitHub Repo Stars](https://img.shields.io/github/stars/nopara73/LongevityWorldCup) ![GitHub last commit](https://img.shields.io/github/last-commit/nopara73/LongevityWorldCup)](https://github.com/nopara73/LongevityWorldCup) - Open source healthspan competition platform with biological age calculators, athlete profiles, and public leaderboards.
- [shenas ![GitHub Repo Stars](https://img.shields.io/github/stars/shenas-org/shenas) ![GitHub last commit](https://img.shields.io/github/last-commit/shenas-org/shenas)](https://github.com/shenas-org/shenas) - Local-first personal analytics platform that ingests health, finance, and activity data into a per-user DuckDB; raw data stays on your device and models train via federated learning.
- [lifeos-cli ![GitHub Repo Stars](https://img.shields.io/github/stars/liujuanjuan1984/lifeos-cli) ![GitHub last commit](https://img.shields.io/github/last-commit/liujuanjuan1984/lifeos-cli)](https://github.com/liujuanjuan1984/lifeos-cli) - Terminal-native LifeOS for personal workflows, habits, and timelogs.
- [GitStory ![GitHub Repo Stars](https://img.shields.io/github/stars/pankajkumardev/gitstory-2025) ![GitHub last commit](https://img.shields.io/github/last-commit/pankajkumardev/gitstory-2025)](https://github.com/pankajkumardev/gitstory-2025) - Generates a "Spotify Wrapped" style visual summary of your yearly GitHub contribution activity.
- [PGIS ![GitHub Repo Stars](https://img.shields.io/github/stars/chukwumaonyeije/pgis-manus-skill) ![GitHub last commit](https://img.shields.io/github/last-commit/chukwumaonyeije/pgis-manus-skill)](https://github.com/chukwumaonyeije/pgis-manus-skill#readme) - Open-source decision-support framework for optimizing endurance training while managing Type 2 diabetes, integrating CGM, HRV, sleep, and training load data.
