...
- [Heedy ![GitHub Repo Stars](https://img.shields.io/github/stars/heedy/heedy) ![GitHub last commit](https://img.shields.io/github/last-commit/heedy/heedy)](https://github.com/heedy/heedy) - A repository for all of your quantified-self data.
- [Quantifier ![GitHub Repo Stars](https://img.shields.io/github/stars/tsubery/quantifier) ![GitHub last commit](https://img.shields.io/github/last-commit/tsubery/quantifier)](https://github.com/tsubery/quantifier) - A Quantified Self app that tracks various fitness and productivity metrics.
- [Fluxtream ![GitHub Repo Stars](https://img.shields.io/github/stars/fluxtream/fluxtream-app) ![GitHub last commit](https://img.shields.io/github/last-commit/fluxtream/fluxtream-app)](https://github.com/fluxtream/fluxtream-app) - An open-source non-profit personal data visualization framework.
- [Flow Dashboard ![GitHub Repo Stars](https://img.shields.io/github/stars/onejgordon/flow-dashboard) ![GitHub last commit](https://img.shields.io/github/last-commit/onejgordon/flow-dashboard)](https://github.com/onejgordon/flow-dashboard) - Habit tracker and personal data analytics app.
...
- [Timeliner ![GitHub Repo Stars](https://img.shields.io/github/stars/mholt/timeliner) ![GitHub last commit](https://img.shields.io/github/last-commit/mholt/timeliner)](https://github.com/mholt/timeliner) - A data aggregation and and timeline visualization tool.
...
- [Bolero ![GitHub Repo Stars](https://img.shields.io/github/stars/bcongdon/bolero) ![GitHub last commit](https://img.shields.io/github/last-commit/bcongdon/bolero)](https://github.com/bcongdon/bolero) - An extensible, personal API with custom integrations.
...
- [Syte3 ![GitHub Repo Stars](https://img.shields.io/github/stars/rigoneri/Syte3) ![GitHub last commit](https://img.shields.io/github/last-commit/rigoneri/Syte3)](https://github.com/rigoneri/Syte3) - A personal website that shows your activity on social networks and more.
