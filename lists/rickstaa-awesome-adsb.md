...
- [amnesica/BelugaProject ![GitHub Repo Stars](https://img.shields.io/github/stars/amnesica/BelugaProject) ![GitHub last commit](https://img.shields.io/github/last-commit/amnesica/BelugaProject)](https://github.com/amnesica/BelugaProject) - A web application that displays data of one or multiple, local ADS-B feeders and AIS-data along with additional information on a map interface in the browser.
...
## ADS-B Derived Data
- [aircraft-flight-schedules ![GitHub Repo Stars](https://img.shields.io/github/stars/MrAirspace/aircraft-flight-schedules) ![GitHub last commit](https://img.shields.io/github/last-commit/MrAirspace/aircraft-flight-schedules)](https://github.com/MrAirspace/aircraft-flight-schedules) - Open-source datasets featuring global, high-level flight schedules extracted from worldwide aircraft ADS-B position transmissions (2024+ onwards). Covers all flights globally as long as within coverage of the [ADSBlol](https://adsb.lol/) initiative.
