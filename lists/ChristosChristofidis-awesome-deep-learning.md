...
141. [LLVIP ![GitHub Repo Stars](https://img.shields.io/github/stars/bupt-ai-cz/LLVIP) ![GitHub last commit](https://img.shields.io/github/last-commit/bupt-ai-cz/LLVIP)](https://github.com/bupt-ai-cz/LLVIP) - 15488 visible-infrared paired images (30976 images) for low-light vision research, [Project_Page](https://bupt-ai-cz.github.io/LLVIP/)
142. [MSDA ![GitHub Repo Stars](https://img.shields.io/github/stars/bupt-ai-cz/Meta-SelfLearning) ![GitHub last commit](https://img.shields.io/github/last-commit/bupt-ai-cz/Meta-SelfLearning)](https://github.com/bupt-ai-cz/Meta-SelfLearning) - Over over 5 million images from 5 different domains for multi-source ocr/text recognition DA research, [Project_Page](https://bupt-ai-cz.github.io/Meta-SelfLearning/)
...
148. [SberQuAD ![GitHub Repo Stars](https://img.shields.io/github/stars/annnyway/QA-for-Russian) ![GitHub last commit](https://img.shields.io/github/last-commit/annnyway/QA-for-Russian)](https://github.com/annnyway/QA-for-Russian) - Sberbank released ~90,000 Russian QA pairs
...
67.  [Colossal-AI - An Integrated Large-scale Model Training System with Efficient Parallelization Techniques ![GitHub Repo Stars](https://img.shields.io/github/stars/hpcaitech/ColossalAI) ![GitHub last commit](https://img.shields.io/github/last-commit/hpcaitech/ColossalAI)](https://github.com/hpcaitech/ColossalAI)
68.  [haystack: an open-source neural search framework](https://haystack.deepset.ai/docs/intromd)
69.  [Maze ![GitHub Repo Stars](https://img.shields.io/github/stars/enlite-ai/maze) ![GitHub last commit](https://img.shields.io/github/last-commit/enlite-ai/maze)](https://github.com/enlite-ai/maze) - Application-oriented deep reinforcement learning framework addressing real-world decision problems.
70.  [InsNet - A neural network library for building instance-dependent NLP models with padding-free dynamic batching ![GitHub Repo Stars](https://img.shields.io/github/stars/chncwang/InsNet) ![GitHub last commit](https://img.shields.io/github/last-commit/chncwang/InsNet)](https://github.com/chncwang/InsNet)

### Tools

1.  [Nebullvm ![GitHub Repo Stars](https://img.shields.io/github/stars/nebuly-ai/nebullvm) ![GitHub last commit](https://img.shields.io/github/last-commit/nebuly-ai/nebullvm)](https://github.com/nebuly-ai/nebullvm) - Easy-to-use library to boost deep learning inference leveraging multiple deep learning compilers.
2.  [Netron ![GitHub Repo Stars](https://img.shields.io/github/stars/lutzroeder/netron) ![GitHub last commit](https://img.shields.io/github/last-commit/lutzroeder/netron)](https://github.com/lutzroeder/netron) - Visualizer for deep learning and machine learning models
...
12. [hub ![GitHub Repo Stars](https://img.shields.io/github/stars/activeloopai/Hub) ![GitHub last commit](https://img.shields.io/github/last-commit/activeloopai/Hub)](https://github.com/activeloopai/Hub) - Fastest unstructured dataset management for TensorFlow/PyTorch by activeloop.ai. Stream & version-control data. Converts large data into single     numpy-like array on the cloud, accessible on any machine.
...
4.  [Caffe DockerFile ![GitHub Repo Stars](https://img.shields.io/github/stars/tleyden/docker) ![GitHub last commit](https://img.shields.io/github/last-commit/tleyden/docker)](https://github.com/tleyden/docker/tree/master/caffe)
5.  [TorontoDeepLEarning convnet ![GitHub Repo Stars](https://img.shields.io/github/stars/TorontoDeepLearning/convnet) ![GitHub last commit](https://img.shields.io/github/last-commit/TorontoDeepLearning/convnet)](https://github.com/TorontoDeepLearning/convnet)
6.  [gfx.js ![GitHub Repo Stars](https://img.shields.io/github/stars/clementfarabet/gfx.js) ![GitHub last commit](https://img.shields.io/github/last-commit/clementfarabet/gfx.js)](https://github.com/clementfarabet/gfx.js)
7.  [Torch7 Cheat sheet ![GitHub Repo Stars](https://img.shields.io/github/stars/torch/torch7) ![GitHub last commit](https://img.shields.io/github/last-commit/torch/torch7)](https://github.com/torch/torch7/wiki/Cheatsheet)
...
13. [A chess AI that learns to play chess using deep learning. ![GitHub Repo Stars](https://img.shields.io/github/stars/erikbern/deep-pink) ![GitHub last commit](https://img.shields.io/github/last-commit/erikbern/deep-pink)](https://github.com/erikbern/deep-pink)
14. [Reproducing the results of "Playing Atari with Deep Reinforcement Learning" by DeepMind ![GitHub Repo Stars](https://img.shields.io/github/stars/kristjankorjus/Replicating-DeepMind) ![GitHub last commit](https://img.shields.io/github/last-commit/kristjankorjus/Replicating-DeepMind)](https://github.com/kristjankorjus/Replicating-DeepMind)
15. [Wiki2Vec. Getting Word2vec vectors for entities and word from Wikipedia Dumps ![GitHub Repo Stars](https://img.shields.io/github/stars/idio/wiki2vec) ![GitHub last commit](https://img.shields.io/github/last-commit/idio/wiki2vec)](https://github.com/idio/wiki2vec)
16. [The original code from the DeepMind article + tweaks ![GitHub Repo Stars](https://img.shields.io/github/stars/kuz/DeepMind-Atari-Deep-Q-Learner) ![GitHub last commit](https://img.shields.io/github/last-commit/kuz/DeepMind-Atari-Deep-Q-Learner)](https://github.com/kuz/DeepMind-Atari-Deep-Q-Learner)
17. [Google deepdream - Neural Network art ![GitHub Repo Stars](https://img.shields.io/github/stars/google/deepdream) ![GitHub last commit](https://img.shields.io/github/last-commit/google/deepdream)](https://github.com/google/deepdream)
18. [An efficient, batched LSTM.](https://gist.github.com/karpathy/587454dc0146a6ae21fc)
19. [A recurrent neural network designed to generate classical music. ![GitHub Repo Stars](https://img.shields.io/github/stars/hexahedria/biaxial-rnn-music-composition) ![GitHub last commit](https://img.shields.io/github/last-commit/hexahedria/biaxial-rnn-music-composition)](https://github.com/hexahedria/biaxial-rnn-music-composition)
20. [Memory Networks Implementations - Facebook ![GitHub Repo Stars](https://img.shields.io/github/stars/facebook/MemNN) ![GitHub last commit](https://img.shields.io/github/last-commit/facebook/MemNN)](https://github.com/facebook/MemNN)
21. [Face recognition with Google's FaceNet deep neural network. ![GitHub Repo Stars](https://img.shields.io/github/stars/cmusatyalab/openface) ![GitHub last commit](https://img.shields.io/github/last-commit/cmusatyalab/openface)](https://github.com/cmusatyalab/openface)
22. [Basic digit recognition neural network ![GitHub Repo Stars](https://img.shields.io/github/stars/joeledenberg/DigitRecognition) ![GitHub last commit](https://img.shields.io/github/last-commit/joeledenberg/DigitRecognition)](https://github.com/joeledenberg/DigitRecognition)
23. [Emotion Recognition API Demo - Microsoft](https://www.projectoxford.ai/demo/emotion#detection)
24. [Proof of concept for loading Caffe models in TensorFlow ![GitHub Repo Stars](https://img.shields.io/github/stars/ethereon/caffe-tensorflow) ![GitHub last commit](https://img.shields.io/github/last-commit/ethereon/caffe-tensorflow)](https://github.com/ethereon/caffe-tensorflow)
...
37. [Ladder Network ![GitHub Repo Stars](https://img.shields.io/github/stars/divamgupta/ladder_network_keras) ![GitHub last commit](https://img.shields.io/github/last-commit/divamgupta/ladder_network_keras)](https://github.com/divamgupta/ladder_network_keras) - Keras Implementation of Ladder Network for Semi-Supervised Learning 
38. [toolbox: Curated list of ML libraries ![GitHub Repo Stars](https://img.shields.io/github/stars/amitness/toolbox) ![GitHub last commit](https://img.shields.io/github/last-commit/amitness/toolbox)](https://github.com/amitness/toolbox)
39. [CNN Explainer](https://poloclub.github.io/cnn-explainer/)
40. [AI Expert Roadmap ![GitHub Repo Stars](https://img.shields.io/github/stars/AMAI-GmbH/AI-Expert-Roadmap) ![GitHub last commit](https://img.shields.io/github/last-commit/AMAI-GmbH/AI-Expert-Roadmap)](https://github.com/AMAI-GmbH/AI-Expert-Roadmap) - Roadmap to becoming an Artificial Intelligence Expert
41. [Awesome Drug Interactions, Synergy, and Polypharmacy Prediction ![GitHub Repo Stars](https://img.shields.io/github/stars/AstraZeneca/awesome-polipharmacy-side-effect-prediction) ![GitHub last commit](https://img.shields.io/github/last-commit/AstraZeneca/awesome-polipharmacy-side-effect-prediction)](https://github.com/AstraZeneca/awesome-polipharmacy-side-effect-prediction/)
