...
- [Foundation for Emails ![GitHub Repo Stars](https://img.shields.io/github/stars/zurb/foundation-emails) ![GitHub last commit](https://img.shields.io/github/last-commit/zurb/foundation-emails)](https://github.com/zurb/foundation-emails) - Quickly create responsive HTML emails that work on any device & client. Even Outlook.
...
- [Campaign ![GitHub Repo Stars](https://img.shields.io/github/stars/bevacqua/campaign) ![GitHub last commit](https://img.shields.io/github/last-commit/bevacqua/campaign)](https://github.com/bevacqua/campaign) - Compose responsive email templates easily, fill them with models, and send them out.
- [Sendwithus](https://www.sendwithus.com/resources/templates) - Open source email templates.
- [Mailchimp Email Blueprints ![GitHub Repo Stars](https://img.shields.io/github/stars/mailchimp/Email-Blueprints) ![GitHub last commit](https://img.shields.io/github/last-commit/mailchimp/Email-Blueprints)](https://github.com/mailchimp/Email-Blueprints) - Email Blueprints is a collection of HTML email templates that can serve as a solid foundation and starting point for the design of emails.
...
- [Responsive Transactional HTML Email Templates ![GitHub Repo Stars](https://img.shields.io/github/stars/mailgun/transactional-email-templates) ![GitHub last commit](https://img.shields.io/github/last-commit/mailgun/transactional-email-templates)](https://github.com/mailgun/transactional-email-templates) - Each template is responsive and each has been tested in all the popular email clients.
- [Cerberus ![GitHub Repo Stars](https://img.shields.io/github/stars/TedGoas/Cerberus) ![GitHub last commit](https://img.shields.io/github/last-commit/TedGoas/Cerberus)](https://github.com/TedGoas/Cerberus) - Few responsive email patterns.
- [Antwort ![GitHub Repo Stars](https://img.shields.io/github/stars/internations/antwort) ![GitHub last commit](https://img.shields.io/github/last-commit/internations/antwort)](https://github.com/internations/antwort) - Antwort offers responsive layouts for Email that both fits and adapts to client widths.
- [Responsive HTML Template ![GitHub Repo Stars](https://img.shields.io/github/stars/charlesmudy/responsive-html-email-template) ![GitHub last commit](https://img.shields.io/github/last-commit/charlesmudy/responsive-html-email-template)](https://github.com/charlesmudy/responsive-html-email-template) - This template is designed to work on all major email platforms and it is built with media query, making it responsive for smartphones that supports media query.
...
- [Grunt Email Boilerplate ![GitHub Repo Stars](https://img.shields.io/github/stars/dwightjack/grunt-email-boilerplate) ![GitHub last commit](https://img.shields.io/github/last-commit/dwightjack/grunt-email-boilerplate)](https://github.com/dwightjack/grunt-email-boilerplate) - A Grunt template to create emails.
- [Responsive Email Patterns](http://responsiveemailpatterns.com/) - A collection of patterns & modules for responsive emails.
- [Email boilerplate ![GitHub Repo Stars](https://img.shields.io/github/stars/seanpowell/Email-Boilerplate) ![GitHub last commit](https://img.shields.io/github/last-commit/seanpowell/Email-Boilerplate)](https://github.com/seanpowell/Email-Boilerplate) - The email boilerplate for sending out nicely formatted messages.
- [htmlemail](https://htmlemail.io/) - Responsive HTML email templates for startups & developers.
- [Postmark Transactional Email Templates ![GitHub Repo Stars](https://img.shields.io/github/stars/wildbit/postmark-templates) ![GitHub last commit](https://img.shields.io/github/last-commit/wildbit/postmark-templates)](https://github.com/wildbit/postmark-templates) - Rock-solid email templates for applications.
...
- [Lee Munroe's Grunt Email Design ![GitHub Repo Stars](https://img.shields.io/github/stars/leemunroe/grunt-email-workflow) ![GitHub last commit](https://img.shields.io/github/last-commit/leemunroe/grunt-email-workflow)](https://github.com/leemunroe/grunt-email-workflow) - A Grunt workflow for designing and testing responsive HTML email templates with SCSS.
...
- [email-verifier ![GitHub Repo Stars](https://img.shields.io/github/stars/AfterShip/email-verifier) ![GitHub last commit](https://img.shields.io/github/last-commit/AfterShip/email-verifier)](https://github.com/AfterShip/email-verifier) - A tool for email verification without sending any emails.
...
- [Postal ![GitHub Repo Stars](https://img.shields.io/github/stars/atech/postal) ![GitHub last commit](https://img.shields.io/github/last-commit/atech/postal)](https://github.com/atech/postal) - A fully featured open source mail delivery platform for incoming & outgoing e-mail.
...
- [SimpleLogin ![GitHub Repo Stars](https://img.shields.io/github/stars/simple-login/app) ![GitHub last commit](https://img.shields.io/github/last-commit/simple-login/app)](https://github.com/simple-login/app) - Self-hosted email alias solution.
...
- [Darylldoyle Gulp workflow ![GitHub Repo Stars](https://img.shields.io/github/stars/darylldoyle/Gulp-Email-Creator) ![GitHub last commit](https://img.shields.io/github/last-commit/darylldoyle/Gulp-Email-Creator)](https://github.com/darylldoyle/Gulp-Email-Creator) - Gulp Email Creator is a gulp workflow inspired by Lee Munroe's grunt-email-design workflow.
...
- [Email marketing regulations ![GitHub Repo Stars](https://img.shields.io/github/stars/threeheartsdigital/email-marketing-regulations) ![GitHub last commit](https://img.shields.io/github/last-commit/threeheartsdigital/email-marketing-regulations)](https://github.com/threeheartsdigital/email-marketing-regulations) - A guide to email marketing regulations around the world.
...
- [MailHog ![GitHub Repo Stars](https://img.shields.io/github/stars/mailhog/MailHog) ![GitHub last commit](https://img.shields.io/github/last-commit/mailhog/MailHog)](https://github.com/mailhog/MailHog) A local fake SMTP server (based on Go).
...
If you want to contribute, please read the [contribution guidelines ![GitHub Repo Stars](https://img.shields.io/github/stars/jonathandion/awesome-emails) ![GitHub last commit](https://img.shields.io/github/last-commit/jonathandion/awesome-emails)](https://github.com/jonathandion/awesome-emails/blob/master/contributing.md).

### Check Also

- [Awesome JS Books ![GitHub Repo Stars](https://img.shields.io/github/stars/jonathandion/awesome-js-books) ![GitHub last commit](https://img.shields.io/github/last-commit/jonathandion/awesome-js-books)](https://github.com/jonathandion/awesome-js-books) - This is a curated list of all the best JavaScript books.
- [Web Configs ![GitHub Repo Stars](https://img.shields.io/github/stars/jonathandion/web-configs) ![GitHub last commit](https://img.shields.io/github/last-commit/jonathandion/web-configs)](https://github.com/jonathandion/web-configs) - Monorepo for all common configurations for building web apps.
- [My Neovim Config ![GitHub Repo Stars](https://img.shields.io/github/stars/jonathandion/web-dev.nvim) ![GitHub last commit](https://img.shields.io/github/last-commit/jonathandion/web-dev.nvim)](https://github.com/jonathandion/web-dev.nvim) - Small Neovim configuration written in Lua that is specifically designed for web development.
