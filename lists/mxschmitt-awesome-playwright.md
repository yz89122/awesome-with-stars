...
- [playwright-php ![GitHub Repo Stars](https://img.shields.io/github/stars/playwright-php/playwright) ![GitHub last commit](https://img.shields.io/github/last-commit/playwright-php/playwright)](https://github.com/playwright-php/playwright) - Playwright port for PHP.
...
- [nextcov ![GitHub Repo Stars](https://img.shields.io/github/stars/stevez/nextcov) ![GitHub last commit](https://img.shields.io/github/last-commit/stevez/nextcov)](https://github.com/stevez/nextcov) - V8 code coverage collection and merging for Next.js apps tested with Playwright, unifying unit, component, and integration coverage into a single report.
...
- [Figranium ![GitHub Repo Stars](https://img.shields.io/github/stars/figranium/figranium) ![GitHub last commit](https://img.shields.io/github/last-commit/figranium/figranium)](https://github.com/figranium/figranium) - Build complex browser workflows visually and execute them via API. Dockerized and Playwright-based.
...
- [playwright-captcha ![GitHub Repo Stars](https://img.shields.io/github/stars/techinz/playwright-captcha) ![GitHub last commit](https://img.shields.io/github/last-commit/techinz/playwright-captcha)](https://github.com/techinz/playwright-captcha) - Automated captcha solving for Playwright, Patchright and Camoufox. Supports Cloudflare Turnstile, reCAPTCHA V2 & V3.
...
- [kinora ![GitHub Repo Stars](https://img.shields.io/github/stars/Kinora-dev/kinora) ![GitHub last commit](https://img.shields.io/github/last-commit/Kinora-dev/kinora)](https://github.com/Kinora-dev/kinora) - Self-hostable dashboard for Playwright reports across projects and over time: pass rate, trends, per-test flaky/fail rate, and an embedded trace viewer that opens failures inline.
...
- [Piwi ![GitHub Repo Stars](https://img.shields.io/github/stars/PiwiTests/platform) ![GitHub last commit](https://img.shields.io/github/last-commit/PiwiTests/platform)](https://github.com/PiwiTests/platform) - Self-hosted Playwright dashboard with live run streaming, cross-project analytics, locator healing, flaky tracking, MCP server, and optional AI-assisted diagnosis.
