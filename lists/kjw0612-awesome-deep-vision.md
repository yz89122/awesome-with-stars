...
A curated list of deep learning resources for computer vision, inspired by [awesome-php ![GitHub Repo Stars](https://img.shields.io/github/stars/ziadoz/awesome-php) ![GitHub last commit](https://img.shields.io/github/last-commit/ziadoz/awesome-php)](https://github.com/ziadoz/awesome-php) and [awesome-computer-vision ![GitHub Repo Stars](https://img.shields.io/github/stars/jbhuang0604/awesome-computer-vision) ![GitHub last commit](https://img.shields.io/github/last-commit/jbhuang0604/awesome-computer-vision)](https://github.com/jbhuang0604/awesome-computer-vision).
...
## Contributing
Please feel free to [pull requests ![GitHub Repo Stars](https://img.shields.io/github/stars/kjw0612/awesome-deep-vision) ![GitHub last commit](https://img.shields.io/github/last-commit/kjw0612/awesome-deep-vision)](https://github.com/kjw0612/awesome-deep-vision/pulls) to add papers.
...
* Chao Ma, Jia-Bin Huang, Xiaokang Yang and Ming-Hsuan Yang, Hierarchical Convolutional Features for Visual Tracking, ICCV 2015 [[Paper](http://www.cv-foundation.org/openaccess/content_iccv_2015/papers/Ma_Hierarchical_Convolutional_Features_ICCV_2015_paper.pdf)] [[Code ![GitHub Repo Stars](https://img.shields.io/github/stars/jbhuang0604/CF2) ![GitHub last commit](https://img.shields.io/github/last-commit/jbhuang0604/CF2)](https://github.com/jbhuang0604/CF2)]
* Lijun Wang, Wanli Ouyang, Xiaogang Wang, and Huchuan Lu, Visual Tracking with fully Convolutional Networks, ICCV 2015  [[Paper](http://202.118.75.4/lu/Paper/ICCV2015/iccv15_lijun.pdf)] [[Code ![GitHub Repo Stars](https://img.shields.io/github/stars/scott89/FCNT) ![GitHub last commit](https://img.shields.io/github/last-commit/scott89/FCNT)](https://github.com/scott89/FCNT)]
* Hyeonseob Namand Bohyung Han, Learning Multi-Domain Convolutional Neural Networks for Visual Tracking, [[Paper](http://arxiv.org/pdf/1510.07945.pdf)] [[Code ![GitHub Repo Stars](https://img.shields.io/github/stars/HyeonseobNam/MDNet) ![GitHub last commit](https://img.shields.io/github/last-commit/HyeonseobNam/MDNet)](https://github.com/HyeonseobNam/MDNet)] [[Project Page](http://cvlab.postech.ac.kr/research/mdnet/)]
...
* Adversarial Networks
  ...
  * Jun-Yan Zhu, Philipp Krahenbuhl, Eli Shechtman, and Alexei A. Efros, "Generative Visual Manipulation on the Natural Image Manifold", ECCV 2016. [[Paper](https://arxiv.org/pdf/1609.03552v2.pdf)] [[Code ![GitHub Repo Stars](https://img.shields.io/github/stars/junyanz/iGAN) ![GitHub last commit](https://img.shields.io/github/last-commit/junyanz/iGAN)](https://github.com/junyanz/iGAN)] [[Video](https://youtu.be/9c4z6YsBGQ0)]
...
* Torch7: Deep learning library in Lua, used by Facebook and Google Deepmind [[Web](http://torch.ch/)]
  * Torch-based deep learning libraries: [[torchnet ![GitHub Repo Stars](https://img.shields.io/github/stars/torchnet/torchnet) ![GitHub last commit](https://img.shields.io/github/last-commit/torchnet/torchnet)](https://github.com/torchnet/torchnet)],
...
* Theano: Mathematical library in Python, maintained by LISA lab [[Web](http://deeplearning.net/software/theano/)]
  * Theano-based deep learning libraries: [[Pylearn2](http://deeplearning.net/software/pylearn2/)], [[Blocks ![GitHub Repo Stars](https://img.shields.io/github/stars/mila-udem/blocks) ![GitHub last commit](https://img.shields.io/github/last-commit/mila-udem/blocks)](https://github.com/mila-udem/blocks)], [[Keras](http://keras.io/)], [[Lasagne ![GitHub Repo Stars](https://img.shields.io/github/stars/Lasagne/Lasagne) ![GitHub last commit](https://img.shields.io/github/last-commit/Lasagne/Lasagne)](https://github.com/Lasagne/Lasagne)]
...
* Deepgaze: A computer vision library for human-computer interaction based on CNNs [[Web ![GitHub Repo Stars](https://img.shields.io/github/stars/mpatacchiola/deepgaze) ![GitHub last commit](https://img.shields.io/github/last-commit/mpatacchiola/deepgaze)](https://github.com/mpatacchiola/deepgaze)]
...
* [CVPR 2015] [Applied Deep Learning for Computer Vision with Torch ![GitHub Repo Stars](https://img.shields.io/github/stars/soumith/cvpr2015) ![GitHub last commit](https://img.shields.io/github/last-commit/soumith/cvpr2015)](https://github.com/soumith/cvpr2015)
