...
* [Premake ![GitHub Repo Stars](https://img.shields.io/github/stars/premake/premake-core) ![GitHub last commit](https://img.shields.io/github/last-commit/premake/premake-core)](https://github.com/premake/premake-core) - Build script generator for toolsets like Visual Studio, Xcode, or GNU Make. [`3-clause BSD`](https://directory.fsf.org/wiki/License:BSD-3-Clause)
...
* [Ninja ![GitHub Repo Stars](https://img.shields.io/github/stars/ninja-build/ninja) ![GitHub last commit](https://img.shields.io/github/last-commit/ninja-build/ninja)](https://github.com/ninja-build/ninja) - Small, simple build system with a focus on speed. [`Apache 2.0`](https://directory.fsf.org/wiki/License:Apache-2.0)
...
* [qmake](https://doc.qt.io/qt-5/qmake-manual.html) - Build system included with the Qt Framework. [`GNU GPL3 with Qt Exception` ![GitHub Repo Stars](https://img.shields.io/github/stars/qt/qtbase) ![GitHub last commit](https://img.shields.io/github/last-commit/qt/qtbase)](https://github.com/qt/qtbase/blob/5.11/LICENSE.GPL3-EXCEPT)
* [xmake](https://xmake.io/) - Cross-platform build utility based on lua. [`Apache 2.0` ![GitHub Repo Stars](https://img.shields.io/github/stars/xmake-io/xmake) ![GitHub last commit](https://img.shields.io/github/last-commit/xmake-io/xmake)](https://github.com/xmake-io/xmake/blob/master/LICENSE.md )
...
* [Intel SPMD](http://ispc.github.io/) - Compiler for a variant of the C language, for single program, multiple data programming. [`Various licenses` ![GitHub Repo Stars](https://img.shields.io/github/stars/ispc/ispc) ![GitHub last commit](https://img.shields.io/github/last-commit/ispc/ispc)](https://github.com/ispc/ispc/blob/master/LICENSE.txt)
...
* [snappy ![GitHub Repo Stars](https://img.shields.io/github/stars/google/snappy) ![GitHub last commit](https://img.shields.io/github/last-commit/google/snappy)](https://github.com/google/snappy) - Fast compression library (implementation in C++, native bindings to C).
...
* [brotli ![GitHub Repo Stars](https://img.shields.io/github/stars/google/brotli) ![GitHub last commit](https://img.shields.io/github/last-commit/google/brotli)](https://github.com/google/brotli) - Generic lossless compression algorithm based on LZ77, Huffman coding and 2nd order context modelling [`MIT`](https://raw.githubusercontent.com/atom/atom/master/LICENSE.md)
...
* [pixz ![GitHub Repo Stars](https://img.shields.io/github/stars/vasi/pixz) ![GitHub last commit](https://img.shields.io/github/last-commit/vasi/pixz)](https://github.com/vasi/pixz) - Pixz (pronounced pixie) is a parallel, indexing version of `xz`. [`2-clause BSD`](https://directory.fsf.org/wiki/License:BSD-2-Clause)
...
* [Hiredis ![GitHub Repo Stars](https://img.shields.io/github/stars/redis/hiredis) ![GitHub last commit](https://img.shields.io/github/last-commit/redis/hiredis)](https://github.com/redis/hiredis) - Minimalistic client library for Redis. [`3-clause BSD`](https://directory.fsf.org/wiki/License:BSD-3-Clause)
* [LMDB ![GitHub Repo Stars](https://img.shields.io/github/stars/LMDB/lmdb) ![GitHub last commit](https://img.shields.io/github/last-commit/LMDB/lmdb)](https://github.com/LMDB/lmdb) - Ultra-fast, ultra-compact key-value embedded data store. [`OpenLDAP License`](https://directory.fsf.org/wiki/License:OLDAP-2.7)
...
* [Qt Creator](https://www.qt.io/qt-features-libraries-apis-tools-and-ide/#ide) - Cross-platform IDE written with C++ and Qt, part of the Qt SDK. Supports Clang Code Model. [`GNU GPL3 with Qt exception` ![GitHub Repo Stars](https://img.shields.io/github/stars/qt-creator/qt-creator) ![GitHub last commit](https://img.shields.io/github/last-commit/qt-creator/qt-creator)](https://github.com/qt-creator/qt-creator/blob/master/LICENSE.GPL3-EXCEPT)
...
* [Amazon FreeRTOS](https://aws.amazon.com/freertos/) - RTOS for microcontrollers that makes small, low-power edge devices easy to program. [`MIT` ![GitHub Repo Stars](https://img.shields.io/github/stars/aws/amazon-freertos) ![GitHub last commit](https://img.shields.io/github/last-commit/aws/amazon-freertos)](https://github.com/aws/amazon-freertos/blob/master/LICENSE)
...
* [Contiki](http://www.contiki-os.org/) - Connect low-cost, low power microcontrollers to the Internet. [`3-clause BSD` ![GitHub Repo Stars](https://img.shields.io/github/stars/contiki-os/contiki) ![GitHub last commit](https://img.shields.io/github/last-commit/contiki-os/contiki)](https://github.com/contiki-os/contiki/blob/master/LICENSE)
...
* [C Macro Collections ![GitHub Repo Stars](https://img.shields.io/github/stars/LeoVen/C-Macro-Collections) ![GitHub last commit](https://img.shields.io/github/last-commit/LeoVen/C-Macro-Collections)](https://github.com/LeoVen/C-Macro-Collections) - Header only, macro generated, generic and type-safe Collections in C. [`MIT`](https://spdx.org/licenses/MIT.html)
...
* [libnih ![GitHub Repo Stars](https://img.shields.io/github/stars/keybuk/libnih) ![GitHub last commit](https://img.shields.io/github/last-commit/keybuk/libnih)](https://github.com/keybuk/libnih) - Lightweight library of C functions and structures. [`GNU GPL2.1`](http://www.gnu.org/licenses/old-licenses/gpl-2.0.html)
...
* [qlibc](http://wolkykim.github.io/qlibc/) - Simple and powerful C library, designed as a replacement for GLib while focusing on being small and light. [`qLib license` ![GitHub Repo Stars](https://img.shields.io/github/stars/wolkykim/qlibc) ![GitHub last commit](https://img.shields.io/github/last-commit/wolkykim/qlibc)](https://github.com/wolkykim/qlibc/blob/master/LICENSE) (similar to [`FreeBSD`](https://directory.fsf.org/wiki?title=License:FreeBSD))
* [stb ![GitHub Repo Stars](https://img.shields.io/github/stars/nothings/stb) ![GitHub last commit](https://img.shields.io/github/last-commit/nothings/stb)](https://github.com/nothings/stb) - Range of single-file libraries for C. [`Public Domain`](https://creativecommons.org/share-your-work/public-domain/)
...
* [Corange ![GitHub Repo Stars](https://img.shields.io/github/stars/orangeduck/Corange) ![GitHub last commit](https://img.shields.io/github/last-commit/orangeduck/Corange)](https://github.com/orangeduck/Corange) - Game engine in pure C. [`FreeBSD`](https://directory.fsf.org/wiki?title=License:FreeBSD)
...
* [Quake ![GitHub Repo Stars](https://img.shields.io/github/stars/id-Software/Quake) ![GitHub last commit](https://img.shields.io/github/last-commit/id-Software/Quake)](https://github.com/id-Software/Quake) - The Quake engine. [`GNU GPL2.1`](http://www.gnu.org/licenses/old-licenses/gpl-2.0.html)
* [Quake2 ![GitHub Repo Stars](https://img.shields.io/github/stars/id-Software/Quake-2) ![GitHub last commit](https://img.shields.io/github/last-commit/id-Software/Quake-2)](https://github.com/id-Software/Quake-2) - The Quake2 engine. [`GNU GPL2.1`](http://www.gnu.org/licenses/old-licenses/gpl-2.0.html)
...
* [Cogl ![GitHub Repo Stars](https://img.shields.io/github/stars/rib/cogl-web) ![GitHub last commit](https://img.shields.io/github/last-commit/rib/cogl-web)](https://github.com/rib/cogl-web/wiki) - GPU graphics and utilities API. [`Expat`](https://directory.fsf.org/wiki/License:Expat)
...
* [heman ![GitHub Repo Stars](https://img.shields.io/github/stars/prideout/heman) ![GitHub last commit](https://img.shields.io/github/last-commit/prideout/heman)](https://github.com/prideout/heman) - Tiny library of image utilities dealing with height maps, normal maps, distance fields and the like. [`Expat`](https://directory.fsf.org/wiki/License:Expat)
* [libcaca ![GitHub Repo Stars](https://img.shields.io/github/stars/cacalabs/libcaca) ![GitHub last commit](https://img.shields.io/github/last-commit/cacalabs/libcaca)](https://github.com/cacalabs/libcaca) - ASCII renderer for terminal-based interfaces. [`WTFPLv2`](http://www.wtfpl.net/txt/copying/)
...
* [mozjpeg ![GitHub Repo Stars](https://img.shields.io/github/stars/mozilla/mozjpeg) ![GitHub last commit](https://img.shields.io/github/last-commit/mozilla/mozjpeg)](https://github.com/mozilla/mozjpeg) - Improved JPEG encoder. [`3-clause BSD`](https://directory.fsf.org/wiki/License:BSD-3-Clause)

### Graphic APIs ###

* [OpenGL](https://www.opengl.org/) - Industry adopted 2D and 3D graphics API. More resources at [awesome-opengl ![GitHub Repo Stars](https://img.shields.io/github/stars/eug/awesome-opengl) ![GitHub last commit](https://img.shields.io/github/last-commit/eug/awesome-opengl)](https://github.com/eug/awesome-opengl).
...
* [Vulkan](https://www.khronos.org/vulkan/) - Explicit graphic and compute API for modern cross-platform development. More resources at [awesome-vulkan ![GitHub Repo Stars](https://img.shields.io/github/stars/vinjn/awesome-vulkan) ![GitHub last commit](https://img.shields.io/github/last-commit/vinjn/awesome-vulkan)](https://github.com/vinjn/awesome-vulkan).
...
* [nuklear ![GitHub Repo Stars](https://img.shields.io/github/stars/vurtun/nuklear) ![GitHub last commit](https://img.shields.io/github/last-commit/vurtun/nuklear)](https://github.com/vurtun/nuklear) - Single-header ANSI C gui library. [`Public Domain`](https://creativecommons.org/share-your-work/public-domain/)
* [libui ![GitHub Repo Stars](https://img.shields.io/github/stars/andlabs/libui) ![GitHub last commit](https://img.shields.io/github/last-commit/andlabs/libui)](https://github.com/andlabs/libui) - Simple and portable (but not inflexible) GUI library. [`MIT` ![GitHub Repo Stars](https://img.shields.io/github/stars/andlabs/libui) ![GitHub last commit](https://img.shields.io/github/last-commit/andlabs/libui)](https://github.com/andlabs/libui/blob/master/LICENSE)
* [LCUI ![GitHub Repo Stars](https://img.shields.io/github/stars/lc-soft/LCUI) ![GitHub last commit](https://img.shields.io/github/last-commit/lc-soft/LCUI)](https://github.com/lc-soft/LCUI/) - Small C library for building user interfaces with C, XML and CSS. [`MIT` ![GitHub Repo Stars](https://img.shields.io/github/stars/lc-soft/LCUI) ![GitHub last commit](https://img.shields.io/github/last-commit/lc-soft/LCUI)](https://github.com/lc-soft/LCUI/blob/develop/LICENSE.TXT)

## Hashing ##

All hashing related libraries, cryptographic or not.

* [jwHash ![GitHub Repo Stars](https://img.shields.io/github/stars/watmough/jwHash) ![GitHub last commit](https://img.shields.io/github/last-commit/watmough/jwHash)](https://github.com/watmough/jwHash) - Fast hashtable implementation. [`Apache 2.0`](https://directory.fsf.org/wiki/License:Apache-2.0)
...
* [libcrc ![GitHub Repo Stars](https://img.shields.io/github/stars/PeterScott/murmur3) ![GitHub last commit](https://img.shields.io/github/last-commit/PeterScott/murmur3)](https://github.com/PeterScott/murmur3) - Multi platform CRC library. [`MIT`](https://raw.githubusercontent.com/atom/atom/master/LICENSE.md)
* [murmur ![GitHub Repo Stars](https://img.shields.io/github/stars/ispc/ispc) ![GitHub last commit](https://img.shields.io/github/last-commit/ispc/ispc)](https://github.com/ispc/ispc) - C implementation of MurMur Hashing. [`Public Domain`](https://creativecommons.org/share-your-work/public-domain/)
* [t1ha ![GitHub Repo Stars](https://img.shields.io/github/stars/leo-yuriev/t1ha) ![GitHub last commit](https://img.shields.io/github/last-commit/leo-yuriev/t1ha)](https://github.com/leo-yuriev/t1ha) - Fast Positive Hash library. [`zlib`](https://directory.fsf.org/wiki/License:Zlib)
...
* [json-c ![GitHub Repo Stars](https://img.shields.io/github/stars/json-c/json-c) ![GitHub last commit](https://img.shields.io/github/last-commit/json-c/json-c)](https://github.com/json-c/json-c/wiki) - Library for working with JSON. [`Expat`](https://directory.fsf.org/wiki/License:Expat)
* [parson ![GitHub Repo Stars](https://img.shields.io/github/stars/kgabis/parson) ![GitHub last commit](https://img.shields.io/github/last-commit/kgabis/parson)](https://github.com/kgabis/parson) - Lightweight JSON library written in C. [`MIT`](https://raw.githubusercontent.com/atom/atom/master/LICENSE.md)
* [WJElement ![GitHub Repo Stars](https://img.shields.io/github/stars/netmail-open/wjelement) ![GitHub last commit](https://img.shields.io/github/last-commit/netmail-open/wjelement)](https://github.com/netmail-open/wjelement/wiki) - Advanced JSON manipulation library, with support for JSON Schema. [`LGPL, any version` ![GitHub Repo Stars](https://img.shields.io/github/stars/netmail-open/wjelement) ![GitHub last commit](https://img.shields.io/github/last-commit/netmail-open/wjelement)](https://github.com/netmail-open/wjelement/)
...
* [rpmalloc ![GitHub Repo Stars](https://img.shields.io/github/stars/rampantpixels/rpmalloc) ![GitHub last commit](https://img.shields.io/github/last-commit/rampantpixels/rpmalloc)](https://github.com/rampantpixels/rpmalloc) - Cross platform, lock-free memory allocator. [`Public Domain`](https://creativecommons.org/share-your-work/public-domain/)
...
* [GnuTLS](https://www.gnutls.org/) - Secure communication library, implementing SSL, TLS and DTLS. [`GNU LGPL2.1 or later`](http://www.gnu.org/licenses/old-licenses/lgpl-2.1.html)
* [gumbo-parser ![GitHub Repo Stars](https://img.shields.io/github/stars/google/gumbo-parser) ![GitHub last commit](https://img.shields.io/github/last-commit/google/gumbo-parser)](https://github.com/google/gumbo-parser) - HTML5 parsing library in C99. [`Apache 2.0`](https://directory.fsf.org/wiki/License:Apache-2.0)
* [http-parser ![GitHub Repo Stars](https://img.shields.io/github/stars/nodejs/http-parser) ![GitHub last commit](https://img.shields.io/github/last-commit/nodejs/http-parser)](https://github.com/nodejs/http-parser) - HTTP request/response parser. [`Expat`](https://directory.fsf.org/wiki/License:Expat)
...
* [libvldmail ![GitHub Repo Stars](https://img.shields.io/github/stars/dertuxmalwieder/libvldmail) ![GitHub last commit](https://img.shields.io/github/last-commit/dertuxmalwieder/libvldmail)](https://github.com/dertuxmalwieder/libvldmail) - Your friendly e-mail address validation library. [`WTFPLv2`](http://www.wtfpl.net/txt/copying/)
...
* [MQTT-C ![GitHub Repo Stars](https://img.shields.io/github/stars/LiamBindle/MQTT-C) ![GitHub last commit](https://img.shields.io/github/last-commit/LiamBindle/MQTT-C)](https://github.com/LiamBindle/MQTT-C) - Portable MQTT C client for embedded systems and PCs alike. [`MIT`](https://raw.githubusercontent.com/LiamBindle/MQTT-C/master/LICENSE)
* [nanomsg ![GitHub Repo Stars](https://img.shields.io/github/stars/nanomsg/nanomsg) ![GitHub last commit](https://img.shields.io/github/last-commit/nanomsg/nanomsg)](https://github.com/nanomsg/nanomsg) - C-based implementation of ZeroMQ. [`Expat`](https://directory.fsf.org/wiki/License:Expat)
* [OpenSSL](https://www.openssl.org/) - Implementation of the SSL and TLS protocols, and also includes a cryptography library. [`Dual Licensed under the OpenSSL License and the SSLeay License`](https://www.openssl.org/source/license.html)
...
* [pig ![GitHub Repo Stars](https://img.shields.io/github/stars/rafael-santiago/pig) ![GitHub last commit](https://img.shields.io/github/last-commit/rafael-santiago/pig)](https://github.com/rafael-santiago/pig) - Linux packet crafting tool. [`GPL2`](http://www.gnu.org/licenses/old-licenses/gpl-2.0.html)
* [s2n ![GitHub Repo Stars](https://img.shields.io/github/stars/awslabs/s2n) ![GitHub last commit](https://img.shields.io/github/last-commit/awslabs/s2n)](https://github.com/awslabs/s2n) - C99 implementation of the TLS/SSL protocols, designed to be simple, fast and with security as a priority. [`Apache 2.0`](https://directory.fsf.org/wiki/License:Apache-2.0)
* [socket99 ![GitHub Repo Stars](https://img.shields.io/github/stars/silentbicycle/socket99) ![GitHub last commit](https://img.shields.io/github/last-commit/silentbicycle/socket99)](https://github.com/silentbicycle/socket99) - C99 wrapper for the BSD sockets API. [`ISC`](https://directory.fsf.org/wiki/License:ISC)
* [Tox](https://tox.chat/) - Communication platform, designed to be a Skype-killer. [`GNU GPL3`](http://www.gnu.org/licenses/gpl-3.0.html)
* [twitc ![GitHub Repo Stars](https://img.shields.io/github/stars/sinemetu1/twitc) ![GitHub last commit](https://img.shields.io/github/last-commit/sinemetu1/twitc)](https://github.com/sinemetu1/twitc) - Mini C library for interacting with the Twitter OAuth API. [`Expat`](https://directory.fsf.org/wiki/License:Expat)
* [librg ![GitHub Repo Stars](https://img.shields.io/github/stars/librg/librg) ![GitHub last commit](https://img.shields.io/github/last-commit/librg/librg)](https://github.com/librg/librg) - Library for building simple and elegant cross-platform mmo client-server solutions. [`Apache 2.0`](https://directory.fsf.org/wiki/License:Apache-2.0)
* [dyad ![GitHub Repo Stars](https://img.shields.io/github/stars/rxi/dyad) ![GitHub last commit](https://img.shields.io/github/last-commit/rxi/dyad)](https://github.com/rxi/dyad) - Asynchronous networking library. [`MIT`](https://raw.githubusercontent.com/atom/atom/master/LICENSE.md)
* [h2o ![GitHub Repo Stars](https://img.shields.io/github/stars/h2o/h2o) ![GitHub last commit](https://img.shields.io/github/last-commit/h2o/h2o)](https://github.com/h2o/h2o/) - Optimized HTTP/1, HTTP/2 high performance server/library. [`MIT`](https://raw.githubusercontent.com/atom/atom/master/LICENSE.md)
...
* [cmathl](https://scientificc.github.io/cmathl/) - Pure-C Math library with a great variety of mathematical functions and CMake build support. Seeks to be close to C89/C90 compliant for portability. [`MIT` ![GitHub Repo Stars](https://img.shields.io/github/stars/ScientificC/cmathl) ![GitHub last commit](https://img.shields.io/github/last-commit/ScientificC/cmathl)](https://github.com/ScientificC/cmathl/blob/master/LICENSE)
...
* [OpenMPI ![GitHub Repo Stars](https://img.shields.io/github/stars/open-mpi/ompi) ![GitHub last commit](https://img.shields.io/github/last-commit/open-mpi/ompi)](https://github.com/open-mpi/ompi) - Message passing interface implementation. [`3-clause BSD`](https://directory.fsf.org/wiki/License:BSD-3-Clause)
...
* [hammer ![GitHub Repo Stars](https://img.shields.io/github/stars/abiggerhammer/hammer) ![GitHub last commit](https://img.shields.io/github/last-commit/abiggerhammer/hammer)](https://github.com/abiggerhammer/hammer) - Parser combinators for binary formats. [`GNU GPL2.1`](http://www.gnu.org/licenses/old-licenses/gpl-2.0.html)
* [iniparser ![GitHub Repo Stars](https://img.shields.io/github/stars/ndevilla/iniparser) ![GitHub last commit](https://img.shields.io/github/last-commit/ndevilla/iniparser)](https://github.com/ndevilla/iniparser) - Parser for `.ini` files. [`Expat`](https://directory.fsf.org/wiki/License:Expat)
* [libconfini ![GitHub Repo Stars](https://img.shields.io/github/stars/madmurphy/libconfini) ![GitHub last commit](https://img.shields.io/github/last-commit/madmurphy/libconfini)](https://github.com/madmurphy/libconfini) - Yet another INI parser. [`GNU GPL3 or later`](http://www.gnu.org/licenses/gpl-3.0.html)
* [libYAML](https://pyyaml.org/wiki/LibYAML) - YAML 1.1 parser and emitter. [`Expat`](https://directory.fsf.org/wiki/License:Expat)
* [mpc ![GitHub Repo Stars](https://img.shields.io/github/stars/orangeduck/mpc) ![GitHub last commit](https://img.shields.io/github/last-commit/orangeduck/mpc)](https://github.com/orangeduck/mpc) - Parser combinator library. [`FreeBSD`](https://directory.fsf.org/wiki?title=License:FreeBSD)
* [libucl ![GitHub Repo Stars](https://img.shields.io/github/stars/vstakhov/libucl) ![GitHub last commit](https://img.shields.io/github/last-commit/vstakhov/libucl)](https://github.com/vstakhov/libucl) - Universal configuration library parser. [`FreeBSD`](https://directory.fsf.org/wiki?title=License:FreeBSD)
...
* [regexp4 ![GitHub Repo Stars](https://img.shields.io/github/stars/nasciiboy/recursiveregexpraptor-4) ![GitHub last commit](https://img.shields.io/github/last-commit/nasciiboy/recursiveregexpraptor-4)](https://github.com/nasciiboy/recursiveregexpraptor-4) - Simple and complete implementation of regular expressions with its own sintax. [`GNU GPL3 or later`](http://www.gnu.org/licenses/gpl-3.0.html)
* [SLRE ![GitHub Repo Stars](https://img.shields.io/github/stars/cesanta/slre) ![GitHub last commit](https://img.shields.io/github/last-commit/cesanta/slre)](https://github.com/cesanta/slre) - Super Light Regular Expression library; a very small implementation of a subset of Perl regex syntax. [`GNU GPL2.1`](http://www.gnu.org/licenses/old-licenses/gpl-2.0.html)
* [sregex ![GitHub Repo Stars](https://img.shields.io/github/stars/openresty/sregex) ![GitHub last commit](https://img.shields.io/github/last-commit/openresty/sregex)](https://github.com/openresty/sregex) - Non-backtracking NFA/DFA-based Perl-compatible regex engine library. [`3-clause BSD`](https://opensource.org/licenses/BSD-3-Clause)
* [TRE ![GitHub Repo Stars](https://img.shields.io/github/stars/laurikari/tre) ![GitHub last commit](https://img.shields.io/github/last-commit/laurikari/tre)](https://github.com/laurikari/tre/) - POSIX-compliant, feature-full regex library. [`FreeBSD`](https://directory.fsf.org/wiki?title=License:FreeBSD)

## Serialization ##

* [binn ![GitHub Repo Stars](https://img.shields.io/github/stars/liteserver/binn) ![GitHub last commit](https://img.shields.io/github/last-commit/liteserver/binn)](https://github.com/liteserver/binn) - Binary serialization format meant to be compact, fast and easy-to-use. [`Apache 2.0`](https://directory.fsf.org/wiki/License:Apache-2.0)
* [c-capnproto ![GitHub Repo Stars](https://img.shields.io/github/stars/jmckaskill/c-capnproto) ![GitHub last commit](https://img.shields.io/github/last-commit/jmckaskill/c-capnproto)](https://github.com/jmckaskill/c-capnproto) - Implementation of the Cap'n Proto serialization protocol. [`Expat`](https://directory.fsf.org/wiki/License:Expat)
* [cmp ![GitHub Repo Stars](https://img.shields.io/github/stars/camgunz/cmp) ![GitHub last commit](https://img.shields.io/github/last-commit/camgunz/cmp)](https://github.com/camgunz/cmp) - Implementation of the [MessagePack](https://msgpack.org/) serialization protocol. [`Expat`](https://directory.fsf.org/wiki/License:Expat)
...
* [mpack ![GitHub Repo Stars](https://img.shields.io/github/stars/ludocode/mpack) ![GitHub last commit](https://img.shields.io/github/last-commit/ludocode/mpack)](https://github.com/ludocode/mpack) - Another implementation of the [MessagePack](https://msgpack.org/) serialization protocol. [`Expat`](https://directory.fsf.org/wiki/License:Expat)
* [netstring-c ![GitHub Repo Stars](https://img.shields.io/github/stars/liteserver/netstring-c) ![GitHub last commit](https://img.shields.io/github/last-commit/liteserver/netstring-c)](https://github.com/liteserver/netstring-c) - Netstring encoder and decoder. [`Public Domain`](https://creativecommons.org/share-your-work/public-domain/)
* [protobuf-c ![GitHub Repo Stars](https://img.shields.io/github/stars/protobuf-c/protobuf-c) ![GitHub last commit](https://img.shields.io/github/last-commit/protobuf-c/protobuf-c)](https://github.com/protobuf-c/protobuf-c) - Implementation of Google Protocol Buffer in C. [`FreeBSD`](https://directory.fsf.org/wiki?title=License:FreeBSD)
...
* [clib ![GitHub Repo Stars](https://img.shields.io/github/stars/clibs/clib) ![GitHub last commit](https://img.shields.io/github/last-commit/clibs/clib)](https://github.com/clibs/clib) - Something of a package manager for C. Comes with a [bunch of libraries of its own ![GitHub Repo Stars](https://img.shields.io/github/stars/clibs/clib) ![GitHub last commit](https://img.shields.io/github/last-commit/clibs/clib)](https://github.com/clibs/clib/wiki/Packages). [`Expat`](https://directory.fsf.org/wiki/License:Expat)
...
* [Bionic ![GitHub Repo Stars](https://img.shields.io/github/stars/aosp-mirror/platform_bionic) ![GitHub last commit](https://img.shields.io/github/last-commit/aosp-mirror/platform_bionic)](https://github.com/aosp-mirror/platform_bionic) - Google's C standard library, developed for Android. [`3-clause BSD`](https://directory.fsf.org/wiki/License:BSD-3-Clause)
...
* [SDS ![GitHub Repo Stars](https://img.shields.io/github/stars/antirez/sds) ![GitHub last commit](https://img.shields.io/github/last-commit/antirez/sds)](https://github.com/antirez/sds) - Simple Dynamic Strings; a library for handling C strings in a simpler way, but one that is compatible with normal C string functions. Available via [clib ![GitHub Repo Stars](https://img.shields.io/github/stars/clibs/clib) ![GitHub last commit](https://img.shields.io/github/last-commit/clibs/clib)](https://github.com/clibs/clib). [`FreeBSD`](https://directory.fsf.org/wiki?title=License:FreeBSD)
...
* [smaz ![GitHub Repo Stars](https://img.shields.io/github/stars/antirez/smaz) ![GitHub last commit](https://img.shields.io/github/last-commit/antirez/smaz)](https://github.com/antirez/smaz) - Efficient string compression library. [`3-clause BSD`](https://directory.fsf.org/wiki/License:BSD-3-Clause)
* [utf8.h ![GitHub Repo Stars](https://img.shields.io/github/stars/sheredom/utf8.h) ![GitHub last commit](https://img.shields.io/github/last-commit/sheredom/utf8.h)](https://github.com/sheredom/utf8.h) - Single header utf8 string functions. [`Unlicense`](https://unlicense.org/)
* [utf8proc ![GitHub Repo Stars](https://img.shields.io/github/stars/JuliaStrings/utf8proc) ![GitHub last commit](https://img.shields.io/github/last-commit/JuliaStrings/utf8proc)](https://github.com/JuliaStrings/utf8proc) - Small, clean library for processing UTF-8 Unicode data. [`License` ![GitHub Repo Stars](https://img.shields.io/github/stars/JuliaStrings/utf8proc) ![GitHub last commit](https://img.shields.io/github/last-commit/JuliaStrings/utf8proc)](https://github.com/JuliaStrings/utf8proc/blob/master/LICENSE.md)
...
* [Cutest ![GitHub Repo Stars](https://img.shields.io/github/stars/rafael-santiago/cutest) ![GitHub last commit](https://img.shields.io/github/last-commit/rafael-santiago/cutest)](https://github.com/rafael-santiago/cutest) - Library for unit testing with memory leak detection (Linux, freeBSD and Windows). [`GPL2`](http://www.gnu.org/licenses/old-licenses/gpl-2.0.html)
* [minunit ![GitHub Repo Stars](https://img.shields.io/github/stars/siu/minunit) ![GitHub last commit](https://img.shields.io/github/last-commit/siu/minunit)](https://github.com/siu/minunit) - Minimal unit testing framework for C. [`Expat`](https://directory.fsf.org/wiki/License:Expat)
...
### Atom ###
* [linter-clang ![GitHub Repo Stars](https://img.shields.io/github/stars/AtomLinter/linter-clang) ![GitHub last commit](https://img.shields.io/github/last-commit/AtomLinter/linter-clang)](https://github.com/AtomLinter/linter-clang) - Lint C code in Atom, using Clang. [`MIT`](https://raw.githubusercontent.com/atom/atom/master/LICENSE.md)
* [linter-gcc ![GitHub Repo Stars](https://img.shields.io/github/stars/hebaishi/linter-gcc) ![GitHub last commit](https://img.shields.io/github/last-commit/hebaishi/linter-gcc)](https://github.com/hebaishi/linter-gcc) - Lint C code in Atom, using GCC. [`MIT`](https://raw.githubusercontent.com/atom/atom/master/LICENSE.md)
...
* [Flycheck ![GitHub Repo Stars](https://img.shields.io/github/stars/flycheck/flycheck) ![GitHub last commit](https://img.shields.io/github/last-commit/flycheck/flycheck)](https://github.com/flycheck/flycheck) - Modern syntax checking. For C, it can use either GCC or Clang as a back-end. [`GNU GPL3 or later`](http://www.gnu.org/licenses/gpl-3.0.html)
* [Yasnippet ![GitHub Repo Stars](https://img.shields.io/github/stars/joaotavora/yasnippet) ![GitHub last commit](https://img.shields.io/github/last-commit/joaotavora/yasnippet)](https://github.com/joaotavora/yasnippet) - Template system, with C templates for common code snippets. [`GNU GPL3 or later`](http://www.gnu.org/licenses/gpl-3.0.html)

### Vim ###

* [Syntastic ![GitHub Repo Stars](https://img.shields.io/github/stars/vim-syntastic/syntastic) ![GitHub last commit](https://img.shields.io/github/last-commit/vim-syntastic/syntastic)](https://github.com/vim-syntastic/syntastic) - Syntax checking and linting. [`Do What The Fuck You Want To license` ![GitHub Repo Stars](https://img.shields.io/github/stars/vim-syntastic/syntastic) ![GitHub last commit](https://img.shields.io/github/last-commit/vim-syntastic/syntastic)](https://github.com/vim-syntastic/syntastic/blob/master/LICENCE)
...
* [address-sanitizer ![GitHub Repo Stars](https://img.shields.io/github/stars/google/sanitizers) ![GitHub last commit](https://img.shields.io/github/last-commit/google/sanitizers)](https://github.com/google/sanitizers) - Fast memory error detector. [`Apache 2.0`](https://directory.fsf.org/wiki/License:Apache-2.0)
* [biicode](https://biicode.github.io/biicode/) - Modern dependency manager for C. [`Expat`](https://directory.fsf.org/wiki/License:Expat)
* [c ![GitHub Repo Stars](https://img.shields.io/github/stars/ryanmjacobs/c) ![GitHub last commit](https://img.shields.io/github/last-commit/ryanmjacobs/c)](https://github.com/ryanmjacobs/c) - Compile and execute C "scripts" in one go on the command line. Also has shebang support. [`Expat`](https://directory.fsf.org/wiki/License:Expat)
* [c99sh ![GitHub Repo Stars](https://img.shields.io/github/stars/RhysU/c99sh) ![GitHub last commit](https://img.shields.io/github/last-commit/RhysU/c99sh)](https://github.com/RhysU/c99sh) - Run C files using hash-bang. [`FreeBSD`](https://directory.fsf.org/wiki?title=License:FreeBSD)
...
* [include-what-you-use ![GitHub Repo Stars](https://img.shields.io/github/stars/include-what-you-use/include-what-you-use) ![GitHub last commit](https://img.shields.io/github/last-commit/include-what-you-use/include-what-you-use)](https://github.com/include-what-you-use/include-what-you-use) - Helps find unecessary inclusions and make suggestions for fixing them. Based on LLVM/Clang (and only works with it). [`NCSA`](https://directory.fsf.org/wiki/License:NCSA)
...
* [ApeTagLibs ![GitHub Repo Stars](https://img.shields.io/github/stars/jeremyevans/ape_tag_libs) ![GitHub last commit](https://img.shields.io/github/last-commit/jeremyevans/ape_tag_libs)](https://github.com/jeremyevans/ape_tag_libs/tree/master/c) - C library for working with APEv2 tags. [`Expat`](https://directory.fsf.org/wiki/License:Expat)
...
* [CommonMark ![GitHub Repo Stars](https://img.shields.io/github/stars/commonmark/commonmark-spec) ![GitHub last commit](https://img.shields.io/github/last-commit/commonmark/commonmark-spec)](https://github.com/commonmark/commonmark-spec) - C implementation of the CommonMark spec. [`Various Licenses` ![GitHub Repo Stars](https://img.shields.io/github/stars/commonmark/commonmark-spec) ![GitHub last commit](https://img.shields.io/github/last-commit/commonmark/commonmark-spec)](https://github.com/commonmark/commonmark-spec/blob/master/LICENSE)
* [CException ![GitHub Repo Stars](https://img.shields.io/github/stars/ThrowTheSwitch/CException) ![GitHub last commit](https://img.shields.io/github/last-commit/ThrowTheSwitch/CException)](https://github.com/ThrowTheSwitch/CException) - C implementation of exceptions. [`Expat`](https://directory.fsf.org/wiki/License:Expat)
* [docopt.c ![GitHub Repo Stars](https://img.shields.io/github/stars/docopt/docopt.c) ![GitHub last commit](https://img.shields.io/github/last-commit/docopt/docopt.c)](https://github.com/docopt/docopt.c) - C implementation of a command-line option parser. [`Expat`](https://directory.fsf.org/wiki/License:Expat)
...
* [Genann ![GitHub Repo Stars](https://img.shields.io/github/stars/codeplea/genann) ![GitHub last commit](https://img.shields.io/github/last-commit/codeplea/genann)](https://github.com/codeplea/genann) - Simple neural network library in C. [`Zlib`](https://directory.fsf.org/wiki/License:Zlib)
...
* [gperftools ![GitHub Repo Stars](https://img.shields.io/github/stars/gperftools/gperftools) ![GitHub last commit](https://img.shields.io/github/last-commit/gperftools/gperftools)](https://github.com/gperftools/gperftools) - Collection of utilities for measuring and improving performance. [`3-clause BSD`](https://directory.fsf.org/wiki/License:BSD-3-Clause)
* [huffandpuff ![GitHub Repo Stars](https://img.shields.io/github/stars/adamierymenko/huffandpuff) ![GitHub last commit](https://img.shields.io/github/last-commit/adamierymenko/huffandpuff)](https://github.com/adamierymenko/huffandpuff) - Minimal Huffman encoder and decoder. [`Public Domain`](https://creativecommons.org/share-your-work/public-domain/)
* [kdtree ![GitHub Repo Stars](https://img.shields.io/github/stars/jtsiomb/kdtree) ![GitHub last commit](https://img.shields.io/github/last-commit/jtsiomb/kdtree)](https://github.com/jtsiomb/kdtree) - Simple library for working with KD-trees. [`3-clause BSD`](https://directory.fsf.org/wiki/License:BSD-3-Clause)
...
* [libbson ![GitHub Repo Stars](https://img.shields.io/github/stars/mongodb/libbson) ![GitHub last commit](https://img.shields.io/github/last-commit/mongodb/libbson)](https://github.com/mongodb/libbson) - BSON utility library. [`Apache 2.0`](https://directory.fsf.org/wiki/License:Apache-2.0)
...
* [libffi ![GitHub Repo Stars](https://img.shields.io/github/stars/libffi/libffi) ![GitHub last commit](https://img.shields.io/github/last-commit/libffi/libffi)](https://github.com/libffi/libffi) - Portable foreign-function interface library. [`Expat`](https://directory.fsf.org/wiki/License:Expat)
* [libgit2](https://libgit2.org/) - Pure C implementation of Git. [`GNU GPL2 only, with a linking exception` ![GitHub Repo Stars](https://img.shields.io/github/stars/libgit2/libgit2) ![GitHub last commit](https://img.shields.io/github/last-commit/libgit2/libgit2)](https://github.com/libgit2/libgit2/blob/master/COPYING)
* [libimobiledevice ![GitHub Repo Stars](https://img.shields.io/github/stars/libimobiledevice/libimobiledevice) ![GitHub last commit](https://img.shields.io/github/last-commit/libimobiledevice/libimobiledevice)](https://github.com/libimobiledevice/libimobiledevice) - Cross-platform protocol library to communicate with iThings. [`GNU LGPLv2.1 or later (library)`](http://www.gnu.org/licenses/old-licenses/lgpl-2.1.html) or [`GNU GPL2.1 or later (tools)`](http://www.gnu.org/licenses/old-licenses/gpl-2.0.html)
* [libnfc ![GitHub Repo Stars](https://img.shields.io/github/stars/nfc-tools/libnfc) ![GitHub last commit](https://img.shields.io/github/last-commit/nfc-tools/libnfc)](https://github.com/nfc-tools/libnfc) - Platform-independent Near-Field Communication library. [`GNU LGPL3`](http://www.gnu.org/licenses/lgpl-3.0.html)
* [libPhenom ![GitHub Repo Stars](https://img.shields.io/github/stars/facebookarchive/libphenom) ![GitHub last commit](https://img.shields.io/github/last-commit/facebookarchive/libphenom)](https://github.com/facebookarchive/libphenom) - Deprecated, here for archival purposes. Eventing framework for building high-scalability and high-performance systems. [`Apache 2.0`](https://directory.fsf.org/wiki/License:Apache-2.0)
...
* [nope.c ![GitHub Repo Stars](https://img.shields.io/github/stars/riolet/WAFer) ![GitHub last commit](https://img.shields.io/github/last-commit/riolet/WAFer)](https://github.com/riolet/WAFer) - C-language-based, ultra-light software platform for scalable server-side and networking applications (think node.js for C programmers). [`GNU GPL2.1`](http://www.gnu.org/licenses/old-licenses/gpl-2.0.html)
* [pbc ![GitHub Repo Stars](https://img.shields.io/github/stars/cloudwu/pbc) ![GitHub last commit](https://img.shields.io/github/last-commit/cloudwu/pbc)](https://github.com/cloudwu/pbc) - Protocol buffers library. [`Expat`](https://directory.fsf.org/wiki/License:Expat)
* [rabbitmq-c ![GitHub Repo Stars](https://img.shields.io/github/stars/alanxz/rabbitmq-c) ![GitHub last commit](https://img.shields.io/github/last-commit/alanxz/rabbitmq-c)](https://github.com/alanxz/rabbitmq-c) - Client library for [RabbitMQ](https://www.rabbitmq.com/). [`Expat`](https://directory.fsf.org/wiki/License:Expat)
...
* [Tinyexpr ![GitHub Repo Stars](https://img.shields.io/github/stars/codeplea/tinyexpr) ![GitHub last commit](https://img.shields.io/github/last-commit/codeplea/tinyexpr)](https://github.com/codeplea/tinyexpr) - Tiny recursive-descent parser, compiler and evaluation engine for simple mathematical expressions. [`zlib`](https://directory.fsf.org/wiki/License:Zlib)
...
* [cpu_features ![GitHub Repo Stars](https://img.shields.io/github/stars/google/cpu_features) ![GitHub last commit](https://img.shields.io/github/last-commit/google/cpu_features)](https://github.com/google/cpu_features) - A cross platform C99 library to get cpu features at runtime. [`Apache 2.0`](https://directory.fsf.org/wiki/License:Apache-2.0)
* [pblog ![GitHub Repo Stars](https://img.shields.io/github/stars/google/pblog) ![GitHub last commit](https://img.shields.io/github/last-commit/google/pblog)](https://github.com/google/pblog) - Small, low overhead, structured logging library intended for logging formware events.[`Apache 2.0`](https://directory.fsf.org/wiki/License:Apache-2.0)
* [libelf ![GitHub Repo Stars](https://img.shields.io/github/stars/WolfgangSt/libelf) ![GitHub last commit](https://img.shields.io/github/last-commit/WolfgangSt/libelf)](https://github.com/WolfgangSt/libelf) - ELF object file access library in C. [`GNU GPL2.1`](http://www.gnu.org/licenses/old-licenses/gpl-2.0.html)
* [mcpp](http://mcpp.sourceforge.net/) - Portable C preprocessor. [`2-clause BSD`](https://opensource.org/licenses/BSD-2-Clause)
* [libusb](https://libusb.info/) - Generic access to USB devices. [`LGPL2.1` ![GitHub Repo Stars](https://img.shields.io/github/stars/libusb/libusb) ![GitHub last commit](https://img.shields.io/github/last-commit/libusb/libusb)](https://github.com/libusb/libusb/blob/master/COPYING)
...
* [Capstone ![GitHub Repo Stars](https://img.shields.io/github/stars/aquynh/capstone) ![GitHub last commit](https://img.shields.io/github/last-commit/aquynh/capstone)](https://github.com/aquynh/capstone) - Dissasembly/disassembler framework. [`BSD 3-clause` ![GitHub Repo Stars](https://img.shields.io/github/stars/aquynh/capstone) ![GitHub last commit](https://img.shields.io/github/last-commit/aquynh/capstone)](https://github.com/aquynh/capstone/blob/master/LICENSE.TXT)
...
* [mini-xml ![GitHub Repo Stars](https://img.shields.io/github/stars/michaelrsweet/mxml) ![GitHub last commit](https://img.shields.io/github/last-commit/michaelrsweet/mxml)](https://github.com/michaelrsweet/mxml) - Small XML reading and writing library. No dependencies aside from C standard library. [`Apache 2.0 with exceptions` ![GitHub Repo Stars](https://img.shields.io/github/stars/michaelrsweet/mxml) ![GitHub last commit](https://img.shields.io/github/last-commit/michaelrsweet/mxml)](https://github.com/michaelrsweet/mxml/blob/master/LICENSE)
