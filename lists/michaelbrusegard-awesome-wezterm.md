...
- [MLFlexer/modal.wezterm ![GitHub Repo Stars](https://img.shields.io/github/stars/MLFlexer/modal.wezterm) ![GitHub last commit](https://img.shields.io/github/last-commit/MLFlexer/modal.wezterm)](https://github.com/MLFlexer/modal.wezterm) - Predefined Vim-like modal keybindings with a good looking UI.
- [sravioli/chord.wz ![GitHub Repo Stars](https://img.shields.io/github/stars/sravioli/chord.wz) ![GitHub last commit](https://img.shields.io/github/last-commit/sravioli/chord.wz)](https://github.com/sravioli/chord.wz) - Vim-style key notation, modal key tables, and hint bars.
- [sei40kr/wez-pain-control ![GitHub Repo Stars](https://img.shields.io/github/stars/sei40kr/wez-pain-control) ![GitHub last commit](https://img.shields.io/github/last-commit/sei40kr/wez-pain-control)](https://github.com/sei40kr/wez-pain-control?tab=readme-ov-file) - Pane control keybindings like tmux-pain-control.
...
- [KawaiiSelbst/nu_utf8_hack.wez ![GitHub Repo Stars](https://img.shields.io/github/stars/KawaiiSelbst/nu_utf8_hack.wez) ![GitHub last commit](https://img.shields.io/github/last-commit/KawaiiSelbst/nu_utf8_hack.wez)](https://github.com/KawaiiSelbst/nu_utf8_hack.wez) - Rough hack for correct handling utf8 symbols with `SHIFT` key with `kitty-keyboard-protocol` for users of nushell.
- [KawaiiSelbst/keys_bypass.wez ![GitHub Repo Stars](https://img.shields.io/github/stars/KawaiiSelbst/keys_bypass.wez) ![GitHub last commit](https://img.shields.io/github/last-commit/KawaiiSelbst/keys_bypass.wez)](https://github.com/KawaiiSelbst/keys_bypass.wez) - Bypasses WezTerm shortcuts to send keys to the foreground process (e.g., Zellij or tmux). 

## Media

- [xarvex/presentation.wez ![GitHub Repo Stars](https://img.shields.io/github/stars/xarvex/presentation.wez) ![GitHub last commit](https://img.shields.io/github/last-commit/xarvex/presentation.wez)](https://github.com/xarvex/presentation.wez) - Rather simple presentation mode toggle.

## Neovim

- [mrjones2014/smart-splits.nvim ![GitHub Repo Stars](https://img.shields.io/github/stars/mrjones2014/smart-splits.nvim) ![GitHub last commit](https://img.shields.io/github/last-commit/mrjones2014/smart-splits.nvim)](https://github.com/mrjones2014/smart-splits.nvim) - Provides an addon for seamless pane navigation between Neovim and the WezTerm MUX.
- [winter-again/wezterm-config.nvim ![GitHub Repo Stars](https://img.shields.io/github/stars/winter-again/wezterm-config.nvim) ![GitHub last commit](https://img.shields.io/github/last-commit/winter-again/wezterm-config.nvim)](https://github.com/winter-again/wezterm-config.nvim) - Interact with the WezTerm configuration directly from Neovim.

## Panes

- [ChrisGVE/pivot_panes.wezterm ![GitHub Repo Stars](https://img.shields.io/github/stars/ChrisGVE/pivot_panes.wezterm) ![GitHub last commit](https://img.shields.io/github/last-commit/ChrisGVE/pivot_panes.wezterm)](https://github.com/ChrisGVE/pivot_panes.wezterm) - Toggle pane orientation between horizontal and vertical splits.
- [bad-noodles/stack.wez ![GitHub Repo Stars](https://img.shields.io/github/stars/bad-noodles/stack.wez) ![GitHub last commit](https://img.shields.io/github/last-commit/bad-noodles/stack.wez)](https://github.com/bad-noodles/stack.wez) - Stacked pane mode, work with multiple panes but see only one at a time.
...
- [StephenGemin/resurrect.wezterm ![GitHub Repo Stars](https://img.shields.io/github/stars/StephenGemin/resurrect.wezterm) ![GitHub last commit](https://img.shields.io/github/last-commit/StephenGemin/resurrect.wezterm)](https://github.com/StephenGemin/resurrect.wezterm) - Save and restore the state of workspaces, windows, tabs and panes.
...
- [adriankarlen/bar.wezterm ![GitHub Repo Stars](https://img.shields.io/github/stars/adriankarlen/bar.wezterm) ![GitHub last commit](https://img.shields.io/github/last-commit/adriankarlen/bar.wezterm)](https://github.com/adriankarlen/bar.wezterm) - A configurable tab bar with batteries included.
- [michaelbrusegard/tabline.wez ![GitHub Repo Stars](https://img.shields.io/github/stars/michaelbrusegard/tabline.wez) ![GitHub last commit](https://img.shields.io/github/last-commit/michaelbrusegard/tabline.wez)](https://github.com/michaelbrusegard/tabline.wez) - A versatile and easy to use retro tab bar with the `lualine.nvim` configuration format.
...
- [Tomauskasz/electric-control-room.wez ![GitHub Repo Stars](https://img.shields.io/github/stars/Tomauskasz/electric-control-room.wez) ![GitHub last commit](https://img.shields.io/github/last-commit/Tomauskasz/electric-control-room.wez)](https://github.com/Tomauskasz/electric-control-room.wez) - Animated electric control-room theme with layered APNG background effects.
- [william-ricchiuti/Wezterm-Window-Tint ![GitHub Repo Stars](https://img.shields.io/github/stars/william-ricchiuti/Wezterm-Window-Tint) ![GitHub last commit](https://img.shields.io/github/last-commit/william-ricchiuti/Wezterm-Window-Tint)](https://github.com/william-ricchiuti/Wezterm-Window-Tint) - Color the window frame, tab bar, and status badge by the active pane's Git root.

## Utility

- [aureolebigben/wezterm-cmd-sender ![GitHub Repo Stars](https://img.shields.io/github/stars/aureolebigben/wezterm-cmd-sender) ![GitHub last commit](https://img.shields.io/github/last-commit/aureolebigben/wezterm-cmd-sender)](https://github.com/aureolebigben/wezterm-cmd-sender) - Send commands to multiple panes.
- [ChrisGVE/dev.wezterm ![GitHub Repo Stars](https://img.shields.io/github/stars/ChrisGVE/dev.wezterm) ![GitHub last commit](https://img.shields.io/github/last-commit/ChrisGVE/dev.wezterm)](https://github.com/ChrisGVE/dev.wezterm) - Location resolver for development and deployment of a plugin.
- [ChrisGVE/lib.wezterm ![GitHub Repo Stars](https://img.shields.io/github/stars/ChrisGVE/lib.wezterm) ![GitHub last commit](https://img.shields.io/github/last-commit/ChrisGVE/lib.wezterm)](https://github.com/ChrisGVE/lib.wezterm) - A library of common utility functions for plugin developers.
- [ChrisGVE/listeners.wezterm ![GitHub Repo Stars](https://img.shields.io/github/stars/ChrisGVE/listeners.wezterm) ![GitHub last commit](https://img.shields.io/github/last-commit/ChrisGVE/listeners.wezterm)](https://github.com/ChrisGVE/listeners.wezterm) - Enables enhanced event listener capabilities with persistent state management.
- [dfsramos/wezterm-sync ![GitHub Repo Stars](https://img.shields.io/github/stars/dfsramos/wezterm-sync) ![GitHub last commit](https://img.shields.io/github/last-commit/dfsramos/wezterm-sync)](https://github.com/dfsramos/wezterm-sync) - Sync your config across machines via a private GitHub Gist, with zero external dependencies.
...
- [sravioli/lantern.wz ![GitHub Repo Stars](https://img.shields.io/github/stars/sravioli/lantern.wz) ![GitHub last commit](https://img.shields.io/github/last-commit/sravioli/lantern.wz)](https://github.com/sravioli/lantern.wz) - Selector framework for colorschemes, fonts, GPU adapters, window appearance, and custom config presets.
- [sravioli/log.wz ![GitHub Repo Stars](https://img.shields.io/github/stars/sravioli/log.wz) ![GitHub last commit](https://img.shields.io/github/last-commit/sravioli/log.wz)](https://github.com/sravioli/log.wz) - Tagged logging library with pluggable sinks and severity thresholds.
...
- [sravioli/ribbon.wz ![GitHub Repo Stars](https://img.shields.io/github/stars/sravioli/ribbon.wz) ![GitHub last commit](https://img.shields.io/github/last-commit/sravioli/ribbon.wz)](https://github.com/sravioli/ribbon.wz) - Builds styled text segments for status bars, tab titles, and selector previews.
- [sravioli/sigil.wz ![GitHub Repo Stars](https://img.shields.io/github/stars/sravioli/sigil.wz) ![GitHub last commit](https://img.shields.io/github/last-commit/sravioli/sigil.wz)](https://github.com/sravioli/sigil.wz) - Icon and identity-color registry for processes, tools, and UI labels.
- [sravioli/warp.wz ![GitHub Repo Stars](https://img.shields.io/github/stars/sravioli/warp.wz) ![GitHub last commit](https://img.shields.io/github/last-commit/sravioli/warp.wz)](https://github.com/sravioli/warp.wz) - General-purpose utility library with string, table, list, path, and filesystem helpers.
...
- [usrivastava92/widgets.wez ![GitHub Repo Stars](https://img.shields.io/github/stars/usrivastava92/widgets.wez) ![GitHub last commit](https://img.shields.io/github/last-commit/usrivastava92/widgets.wez)](https://github.com/usrivastava92/widgets.wez) - Cross-platform status bar widgets for CPU, RAM, battery, network, and disk on macOS, Linux, and Windows.
