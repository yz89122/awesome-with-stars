...
- [Context mapping ![GitHub Repo Stars](https://img.shields.io/github/stars/ddd-crew/context-mapping) ![GitHub last commit](https://img.shields.io/github/last-commit/ddd-crew/context-mapping)](https://github.com/ddd-crew/context-mapping) - Visualize the contract between bounded contexts and teams with a collection of patterns.
- [Core domain charts ![GitHub Repo Stars](https://img.shields.io/github/stars/ddd-crew/core-domain-charts) ![GitHub last commit](https://img.shields.io/github/last-commit/ddd-crew/core-domain-charts)](https://github.com/ddd-crew/core-domain-charts) - Help you to visualise the strategic importance of each (sub)domain or business capability in your architecture allowing you to make business model-aligned architectural decisions.
