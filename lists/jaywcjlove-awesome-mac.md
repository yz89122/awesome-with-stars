...
* [xxh ![GitHub Repo Stars](https://img.shields.io/github/stars/xxh/xxh) ![GitHub last commit](https://img.shields.io/github/last-commit/xxh/xxh)](https://github.com/xxh/xxh) - Bring your favorite shell wherever you go through the SSH. [![Open-Source Software][OSS Icon]](https://sourceforge.net/projects/zsh/) ![Freeware][Freeware Icon]
* [x-cmd ![GitHub Repo Stars](https://img.shields.io/github/stars/x-cmd/x-cmd) ![GitHub last commit](https://img.shields.io/github/last-commit/x-cmd/x-cmd)](https://github.com/x-cmd/x-cmd) - x-cmd is a vast and interesting collection of tools guided by the Unix philosophy.[![Open-Source Software][OSS Icon]](https://sourceforge.net/projects/zsh/) ![Freeware][Freeware Icon]
