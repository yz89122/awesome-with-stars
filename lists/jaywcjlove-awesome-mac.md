...
* [Harbor ![GitHub Repo Stars](https://img.shields.io/github/stars/tahseen-kakar/harbor) ![GitHub last commit](https://img.shields.io/github/last-commit/tahseen-kakar/harbor)](https://github.com/tahseen-kakar/harbor) - Open-source download manager for HTTP(S), magnet links, and `.torrent` files. [![Open-Source Software][OSS Icon]](https://github.com/tahseen-kakar/harbor) ![Freeware][Freeware Icon]
