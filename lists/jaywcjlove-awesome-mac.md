...
**Awesome Mac App for macOS**. Installers for the latest stable build for Mac can be [downloaded here ![GitHub Repo Stars](https://img.shields.io/github/stars/jaywcjlove/amac) ![GitHub last commit](https://img.shields.io/github/last-commit/jaywcjlove/amac)](https://github.com/jaywcjlove/amac/releases).
