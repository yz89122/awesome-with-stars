...
- [regex-to-mermaid ![GitHub Repo Stars](https://img.shields.io/github/stars/tayles/regex-to-mermaid) ![GitHub last commit](https://img.shields.io/github/last-commit/tayles/regex-to-mermaid)](https://github.com/tayles/regex-to-mermaid) - Generate Mermaid diagrams to visualize regexes within Markdown docs, etc.
