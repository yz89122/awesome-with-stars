...
- [Vite Lit + Intlayer ![GitHub Repo Stars](https://img.shields.io/github/stars/aymericzip/intlayer-vite-lit-template) ![GitHub last commit](https://img.shields.io/github/last-commit/aymericzip/intlayer-vite-lit-template)](https://github.com/aymericzip/intlayer-vite-lit-template) - Per-component i18n solution for app and design-systems.
...
- [Burnish Components ![GitHub Repo Stars](https://img.shields.io/github/stars/danfking/burnish) ![GitHub last commit](https://img.shields.io/github/last-commit/danfking/burnish)](https://github.com/danfking/burnish/tree/main/packages/components) - Web components for rendering MCP tool-call output as UI.
...
- [M3E ![GitHub Repo Stars](https://img.shields.io/github/stars/matraic/m3e) ![GitHub last commit](https://img.shields.io/github/last-commit/matraic/m3e)](https://github.com/matraic/m3e) - Web Components implementing Material 3 Expressive.
...
- [PatternFly Elements ![GitHub Repo Stars](https://img.shields.io/github/stars/patternfly/patternfly-elements) ![GitHub last commit](https://img.shields.io/github/last-commit/patternfly/patternfly-elements)](https://github.com/patternfly/patternfly-elements) - Lightweight web components based on the PatternFly design system.
...
- [TrendChart Elements ![GitHub Repo Stars](https://img.shields.io/github/stars/WebLogin/trendchart-elements) ![GitHub last commit](https://img.shields.io/github/last-commit/WebLogin/trendchart-elements)](https://github.com/WebLogin/trendchart-elements) - Components to generate simple charts representing trends.
...
- [`<editor-container>` ![GitHub Repo Stars](https://img.shields.io/github/stars/toeverything/blocksuite) ![GitHub last commit](https://img.shields.io/github/last-commit/toeverything/blocksuite)](https://github.com/toeverything/blocksuite) - Block based editor, designed for general-purpose collaborative applications.
...
- [`<lit-image-cropper>` ![GitHub Repo Stars](https://img.shields.io/github/stars/andy-austin/lit-image-cropper) ![GitHub last commit](https://img.shields.io/github/last-commit/andy-austin/lit-image-cropper)](https://github.com/andy-austin/lit-image-cropper) - Fast and lightweight image cropper component.
...
- [`<responsive-image>` ![GitHub Repo Stars](https://img.shields.io/github/stars/simonihmig/responsive-image) ![GitHub last commit](https://img.shields.io/github/last-commit/simonihmig/responsive-image)](https://github.com/simonihmig/responsive-image) - Web component for rendering responsive images.
...
- [Mappa ![GitHub Repo Stars](https://img.shields.io/github/stars/bennypowers/mappa) ![GitHub last commit](https://img.shields.io/github/last-commit/bennypowers/mappa)](https://github.com/bennypowers/mappa) - Fast import map generator for ES modules, resolving bare specifiers from package.json dependencies.
...
- [Asimonim ![GitHub Repo Stars](https://img.shields.io/github/stars/bennypowers/asimonim) ![GitHub last commit](https://img.shields.io/github/last-commit/bennypowers/asimonim)](https://github.com/bennypowers/asimonim) - Design tokens parser, validator, and language server for the W3C DTCG specification.
- [cem ![GitHub Repo Stars](https://img.shields.io/github/stars/bennypowers/cem) ![GitHub last commit](https://img.shields.io/github/last-commit/bennypowers/cem)](https://github.com/bennypowers/cem) - CLI multitool for generating, validating, and querying Custom Elements Manifests, with built-in LSP and MCP servers.
