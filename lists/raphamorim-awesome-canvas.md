...
A curated list of awesome Canvas examples, related articles and posts. Inspired by [awesome-python ![GitHub Repo Stars](https://img.shields.io/github/stars/vinta/awesome-python) ![GitHub last commit](https://img.shields.io/github/last-commit/vinta/awesome-python)](https://github.com/vinta/awesome-python).

## Contributing

Please take a quick gander at the [contribution guidelines ![GitHub Repo Stars](https://img.shields.io/github/stars/raphamorim/awesome-canvas) ![GitHub last commit](https://img.shields.io/github/last-commit/raphamorim/awesome-canvas)](https://github.com/raphamorim/awesome-canvas/blob/master/CONTRIBUTING.md) first.
...
* [Cloth Effect](http://raphamorim.io/canvas-experiments/cloth) [[show me the code ![GitHub Repo Stars](https://img.shields.io/github/stars/raphamorim/canvas-experiments) ![GitHub last commit](https://img.shields.io/github/last-commit/raphamorim/canvas-experiments)](https://github.com/raphamorim/canvas-experiments)] • A cloth 3D effect fork.
* [Colorful Particles](http://raphamorim.io/canvas-experiments/particles) [[show me the code ![GitHub Repo Stars](https://img.shields.io/github/stars/raphamorim/canvas-experiments) ![GitHub last commit](https://img.shields.io/github/last-commit/raphamorim/canvas-experiments)](https://github.com/raphamorim/canvas-experiments)] • Experiment show how to generates random particles. Very simple code for assimilate.
* [Distance Field Waves](http://www.kevs3d.co.uk/dev/shaders/distancefield3.html) [[show me the code ![GitHub Repo Stars](https://img.shields.io/github/stars/kevinroast/webglshaders) ![GitHub last commit](https://img.shields.io/github/last-commit/kevinroast/webglshaders)](https://github.com/kevinroast/webglshaders/blob/master/distancefield3.html)] • A example about GPU rendering shader experiments with procedural 3D scene generation using ray marching and distance field (also known as 'sphere tracing') rendering techniques.
...
* [Just Canvas](http://raphamorim.io/just-canvas/) [[show me the code ![GitHub Repo Stars](https://img.shields.io/github/stars/raphamorim/just-canvas) ![GitHub last commit](https://img.shields.io/github/last-commit/raphamorim/just-canvas)](https://github.com/raphamorim/just-canvas)]• This is a JavaScript experiment to capture movements. Just Dance Idea + HTML5 Canvas Implementation.
...
* [Matrix Animation](https://matrix.dotglitch.dev/) [[show me the code ![GitHub Repo Stars](https://img.shields.io/github/stars/knackstedt/matrix-animation) ![GitHub last commit](https://img.shields.io/github/last-commit/knackstedt/matrix-animation)](https://github.com/knackstedt/matrix-animation)] • A Matrix Rain animation using canvas.
...
* [PixelCraft ![GitHub Repo Stars](https://img.shields.io/github/stars/rgab1508/PixelCraft) ![GitHub last commit](https://img.shields.io/github/last-commit/rgab1508/PixelCraft)](https://github.com/rgab1508/PixelCraft) • A pixel-art editor made using canvas
* [Raining Day](http://raphamorim.io/raining-day/) [[show me the code ![GitHub Repo Stars](https://img.shields.io/github/stars/raphamorim/canvas-experiments) ![GitHub last commit](https://img.shields.io/github/last-commit/raphamorim/canvas-experiments)](https://github.com/raphamorim/canvas-experiments)] • Raindrops using canvas. It's Neatnait Canvas Rain fork.
* [Space Noodles](http://www.spielzeugz.de/html5/space-noodles/) • Amazing example about line movement and animation.
* [Star Time Lapse Effect](https://fralonra.github.io/star-time-lapse/demo/) [[show me the code ![GitHub Repo Stars](https://img.shields.io/github/stars/fralonra/star-time-lapse) ![GitHub last commit](https://img.shields.io/github/last-commit/fralonra/star-time-lapse)](https://github.com/fralonra/star-time-lapse)] • An example about creating a star time-lapse sky using canvas.
...
* [Trigonoparty!](https://ramesaliyev.com/trigonoparty) [[show me the code ![GitHub Repo Stars](https://img.shields.io/github/stars/ramesaliyev/trigonoparty) ![GitHub last commit](https://img.shields.io/github/last-commit/ramesaliyev/trigonoparty)](https://github.com/ramesaliyev/trigonoparty)] • Simple trigonometry visualisation.
* [tsParticles examples](https://codepen.io/tv/DPOage) Collection of [tsParticles ![GitHub Repo Stars](https://img.shields.io/github/stars/matteobruni/tsparticles) ![GitHub last commit](https://img.shields.io/github/last-commit/matteobruni/tsparticles)](https://github.com/matteobruni/tsparticles) particles animations samples
...
- [iio.js ![GitHub Repo Stars](https://img.shields.io/github/stars/iioinc/iio.js) ![GitHub last commit](https://img.shields.io/github/last-commit/iioinc/iio.js)](https://github.com/iioinc/iio.js) - A javascript library that speeds the creation and deployment of HTML5 Canvas applications
- [isomerjs](http://jdan.github.io/isomer/) - An isometric graphics library for HTML5 canvas
- [Javascript-Voronoi ![GitHub Repo Stars](https://img.shields.io/github/stars/gorhill/Javascript-Voronoi) ![GitHub last commit](https://img.shields.io/github/last-commit/gorhill/Javascript-Voronoi)](https://github.com/gorhill/Javascript-Voronoi) - A Javascript implementation of Fortune's algorithm to compute Voronoi cells 
...
- [Origami.js ![GitHub Repo Stars](https://img.shields.io/github/stars/raphamorim/origami.js) ![GitHub last commit](https://img.shields.io/github/last-commit/raphamorim/origami.js)](https://github.com/raphamorim/origami.js) - JS Lib to redesign canvas API interface
- [p5.js](https://p5js.org) - p5.js is a JS client-side library for creating graphic and interactive experiences
- [Paper.js ![GitHub Repo Stars](https://img.shields.io/github/stars/paperjs/paper.js) ![GitHub last commit](https://img.shields.io/github/last-commit/paperjs/paper.js)](https://github.com/paperjs/paper.js) - Scriptographer ported to JavaScript and the browser, using HTML5 Canvas.
...
- [Proton ![GitHub Repo Stars](https://img.shields.io/github/stars/a-jie/Proton) ![GitHub last commit](https://img.shields.io/github/last-commit/a-jie/Proton)](https://github.com/a-jie/Proton) is a lightweight and powerful javascript particle engine. With it you can easily create countless cool effects 
...
- [Sketch ![GitHub Repo Stars](https://img.shields.io/github/stars/soulwire/sketch.js) ![GitHub last commit](https://img.shields.io/github/last-commit/soulwire/sketch.js)](https://github.com/soulwire/sketch.js) - Cross-Platform JavaScript Creative Coding Framework
...
* [@jeresig](https://twitter.com/jeresig) - Creator of [Processing.js ![GitHub Repo Stars](https://img.shields.io/github/stars/jeresig/processing-js) ![GitHub last commit](https://img.shields.io/github/last-commit/jeresig/processing-js)](https://github.com/jeresig/processing-js)
* [@mrdoob](https://twitter.com/mrdoob) - Creator of [three.js ![GitHub Repo Stars](https://img.shields.io/github/stars/mrdoob/three.js) ![GitHub last commit](https://img.shields.io/github/last-commit/mrdoob/three.js)](https://github.com/mrdoob/three.js)
* [@soulwire](https://twitter.com/soulwire) - Creator of [sketch.js ![GitHub Repo Stars](https://img.shields.io/github/stars/soulwire/sketch.js) ![GitHub last commit](https://img.shields.io/github/last-commit/soulwire/sketch.js)](https://github.com/soulwire/sketch.js) and actively creating and sharing canvas/WebGL experiments
