...
Development happens on [GitHub ![GitHub Repo Stars](https://img.shields.io/github/stars/vim/vim) ![GitHub last commit](https://img.shields.io/github/last-commit/vim/vim)](https://github.com/vim/vim), discussions on the
...
[my vimrc ![GitHub Repo Stars](https://img.shields.io/github/stars/mhinz/dotfiles) ![GitHub last commit](https://img.shields.io/github/last-commit/mhinz/dotfiles)](https://github.com/mhinz/dotfiles/blob/master/.vim/vimrc).
...
Or quickly open a cheatsheet from within Vim: [vim-cheat40 ![GitHub Repo Stars](https://img.shields.io/github/stars/lifepillar/vim-cheat40) ![GitHub last commit](https://img.shields.io/github/last-commit/lifepillar/vim-cheat40)](https://github.com/lifepillar/vim-cheat40).
...
[undotree ![GitHub Repo Stars](https://img.shields.io/github/stars/mbbill/undotree) ![GitHub last commit](https://img.shields.io/github/last-commit/mbbill/undotree)](https://github.com/mbbill/undotree) does a great job at visualizing
it.
...
[FastFold ![GitHub Repo Stars](https://img.shields.io/github/stars/Konfekt/FastFold) ![GitHub last commit](https://img.shields.io/github/last-commit/Konfekt/FastFold)](https://github.com/Konfekt/FastFold), which prevents Vim from
...
[Pathogen ![GitHub Repo Stars](https://img.shields.io/github/stars/tpope/vim-pathogen) ![GitHub last commit](https://img.shields.io/github/last-commit/tpope/vim-pathogen)](https://github.com/tpope/vim-pathogen) was the first popular tool for
...
[multiple-cursors ![GitHub Repo Stars](https://img.shields.io/github/stars/terryma/vim-multiple-cursors) ![GitHub last commit](https://img.shields.io/github/last-commit/terryma/vim-multiple-cursors)](https://github.com/terryma/vim-multiple-cursors).
...
[tmux ![GitHub Repo Stars](https://img.shields.io/github/stars/tmux/tmux) ![GitHub last commit](https://img.shields.io/github/last-commit/tmux/tmux)](https://github.com/tmux/tmux/wiki) which basically sits in between the
...
- [janus ![GitHub Repo Stars](https://img.shields.io/github/stars/carlhuda/janus.git) ![GitHub last commit](https://img.shields.io/github/last-commit/carlhuda/janus.git)](https://github.com/carlhuda/janus.git)
- [spacevim ![GitHub Repo Stars](https://img.shields.io/github/stars/SpaceVim/SpaceVim) ![GitHub last commit](https://img.shields.io/github/last-commit/SpaceVim/SpaceVim)](https://github.com/SpaceVim/SpaceVim)
- [spf13 ![GitHub Repo Stars](https://img.shields.io/github/stars/spf13/spf13-vim) ![GitHub last commit](https://img.shields.io/github/last-commit/spf13/spf13-vim)](https://github.com/spf13/spf13-vim)
...
An alternative would be using [caps2esc ![GitHub Repo Stars](https://img.shields.io/github/stars/oblitum/caps2esc) ![GitHub last commit](https://img.shields.io/github/last-commit/oblitum/caps2esc)](https://github.com/oblitum/caps2esc) or
[xcape ![GitHub Repo Stars](https://img.shields.io/github/stars/alols/xcape) ![GitHub last commit](https://img.shields.io/github/last-commit/alols/xcape)](https://github.com/alols/xcape).
...
| `:set foldmethod=syntax` | If the syntax file is slow already, this makes it even worse. | `:set foldmethod=manual`, `:set foldmethod=marker` or [FastFold ![GitHub Repo Stars](https://img.shields.io/github/stars/Konfekt/FastFold) ![GitHub last commit](https://img.shields.io/github/last-commit/Konfekt/FastFold)](https://github.com/Konfekt/FastFold) |
...
[bracketed-paste ![GitHub Repo Stars](https://img.shields.io/github/stars/ConradIrwin/vim-bracketed-paste) ![GitHub last commit](https://img.shields.io/github/last-commit/ConradIrwin/vim-bracketed-paste)](https://github.com/ConradIrwin/vim-bracketed-paste).
...
[8.0.360 ![GitHub Repo Stars](https://img.shields.io/github/stars/vim/vim) ![GitHub last commit](https://img.shields.io/github/last-commit/vim/vim)](https://github.com/vim/vim/commit/b544f3c81f1e6a50322855681ac266ffaa8e313c)
