...
- [Cartography ![GitHub Repo Stars](https://img.shields.io/github/stars/lyft/cartography) ![GitHub last commit](https://img.shields.io/github/last-commit/lyft/cartography)](https://github.com/lyft/cartography) - A Neo4J-based tool to map out dependencies and relationships between services and resources. Supports AWS, GCP, GSuite, Okta and GitHub.

- [Open guide to AWS Security and IAM ![GitHub Repo Stars](https://img.shields.io/github/stars/open-guides/og-aws) ![GitHub last commit](https://img.shields.io/github/last-commit/open-guides/og-aws)](https://github.com/open-guides/og-aws#security-and-iam)
...
- [SuperTokens ![GitHub Repo Stars](https://img.shields.io/github/stars/supertokens/supertokens-core) ![GitHub last commit](https://img.shields.io/github/last-commit/supertokens/supertokens-core)](https://github.com/supertokens/supertokens-core) - Open-source project for login and session management which supports passwordless, social login, email and phone logins.

- [UserFrosting ![GitHub Repo Stars](https://img.shields.io/github/stars/userfrosting/UserFrosting) ![GitHub last commit](https://img.shields.io/github/last-commit/userfrosting/UserFrosting)](https://github.com/userfrosting/UserFrosting) - Modern PHP user login and management framework.
...
- [Papers we love: Cryptography ![GitHub Repo Stars](https://img.shields.io/github/stars/papers-we-love/papers-we-love) ![GitHub last commit](https://img.shields.io/github/last-commit/papers-we-love/papers-we-love)](https://github.com/papers-we-love/papers-we-love/blob/master/cryptography/README.md) - Foundational papers of cryptography.
...
- [Awesome GUID ![GitHub Repo Stars](https://img.shields.io/github/stars/secretGeek/AwesomeGUID) ![GitHub last commit](https://img.shields.io/github/last-commit/secretGeek/AwesomeGUID)](https://github.com/secretGeek/AwesomeGUID) - Funny take on the global aspect of unique identifiers.
...
- [oathkeeper ![GitHub Repo Stars](https://img.shields.io/github/stars/ory/oathkeeper) ![GitHub last commit](https://img.shields.io/github/last-commit/ory/oathkeeper)](https://github.com/ory/oathkeeper) - Identity & Access Proxy and Access Control Decision API that authenticates, authorizes, and mutates incoming HTTP requests. Inspired by the BeyondCorp / Zero Trust white paper.

- [transcend ![GitHub Repo Stars](https://img.shields.io/github/stars/cogolabs/transcend) ![GitHub last commit](https://img.shields.io/github/last-commit/cogolabs/transcend)](https://github.com/cogolabs/transcend) - BeyondCorp-inspired Access Proxy server.

- [Pomerium ![GitHub Repo Stars](https://img.shields.io/github/stars/pomerium/pomerium) ![GitHub last commit](https://img.shields.io/github/last-commit/pomerium/pomerium)](https://github.com/pomerium/pomerium) - An identity-aware proxy that enables secure access to internal applications.
...
- [Dumb Password Rules ![GitHub Repo Stars](https://img.shields.io/github/stars/dumb-password-rules/dumb-password-rules) ![GitHub last commit](https://img.shields.io/github/last-commit/dumb-password-rules/dumb-password-rules)](https://github.com/dumb-password-rules/dumb-password-rules) - Shaming sites with dumb password rules.
...
- [A Well-Known URL for Changing Passwords ![GitHub Repo Stars](https://img.shields.io/github/stars/WICG/change-password-url) ![GitHub last commit](https://img.shields.io/github/last-commit/WICG/change-password-url)](https://github.com/WICG/change-password-url) - Specification defining site resource for password updates.
...
- [Solo ![GitHub Repo Stars](https://img.shields.io/github/stars/solokeys/solo) ![GitHub last commit](https://img.shields.io/github/last-commit/solokeys/solo)](https://github.com/solokeys/solo) - Open security key supporting FIDO2 & U2F over USB + NFC.

- [OpenSK ![GitHub Repo Stars](https://img.shields.io/github/stars/google/OpenSK) ![GitHub last commit](https://img.shields.io/github/last-commit/google/OpenSK)](https://github.com/google/OpenSK) - Open-source implementation for security keys written in Rust that supports both FIDO U2F and FIDO2 standards.

- [YubiKey Guide ![GitHub Repo Stars](https://img.shields.io/github/stars/drduh/YubiKey-Guide) ![GitHub last commit](https://img.shields.io/github/last-commit/drduh/YubiKey-Guide)](https://github.com/drduh/YubiKey-Guide) - Guide to using YubiKey as a SmartCard for storing GPG encryption, signing and authentication keys, which can also be used for SSH. Many of the principles in this document are applicable to other smart card devices.

- [YubiKey at Datadog ![GitHub Repo Stars](https://img.shields.io/github/stars/DataDog/yubikey) ![GitHub last commit](https://img.shields.io/github/last-commit/DataDog/yubikey)](https://github.com/DataDog/yubikey) - Guide to setup Yubikey, U2F, GPG, git, SSH, Keybase, VMware Fusion and Docker Content Trust.
...
- [`lemur` ![GitHub Repo Stars](https://img.shields.io/github/stars/Netflix/lemur) ![GitHub last commit](https://img.shields.io/github/last-commit/Netflix/lemur)](https://github.com/Netflix/lemur) - Acts as a broker between CAs and environments, providing a central portal for developers to issue TLS certificates with 'sane' defaults.

- [CFSSL ![GitHub Repo Stars](https://img.shields.io/github/stars/cloudflare/cfssl) ![GitHub last commit](https://img.shields.io/github/last-commit/cloudflare/cfssl)](https://github.com/cloudflare/cfssl) - A swiss army knife for PKI/TLS by CloudFlare. Command line tool and an HTTP API server for signing, verifying, and bundling TLS certificates.

- [JA3 ![GitHub Repo Stars](https://img.shields.io/github/stars/salesforce/ja3) ![GitHub last commit](https://img.shields.io/github/last-commit/salesforce/ja3)](https://github.com/salesforce/ja3) - Method for creating SSL/TLS client fingerprints that should be easy to produce on any platform and can be easily shared for threat intelligence.
...
- [Learn how to use JWT for Authentication ![GitHub Repo Stars](https://img.shields.io/github/stars/dwyl/learn-json-web-tokens) ![GitHub last commit](https://img.shields.io/github/last-commit/dwyl/learn-json-web-tokens)](https://github.com/dwyl/learn-json-web-tokens) - Learn how to use JWT to secure your web app.
...
- [`loginsrv` ![GitHub Repo Stars](https://img.shields.io/github/stars/tarent/loginsrv) ![GitHub last commit](https://img.shields.io/github/last-commit/tarent/loginsrv)](https://github.com/tarent/loginsrv) - Standalone minimalistic login server providing a JWT login for multiple login backends (htpasswd, OSIAM, user/password, HTTP basic authentication, OAuth2: GitHub, Google, Bitbucket, Facebook, GitLab).

- [jwtXploiter ![GitHub Repo Stars](https://img.shields.io/github/stars/DontPanicO/jwtXploiter) ![GitHub last commit](https://img.shields.io/github/last-commit/DontPanicO/jwtXploiter)](https://github.com/DontPanicO/jwtXploiter) - A tool to test security of json web token.
...
- [PolicyUniverse ![GitHub Repo Stars](https://img.shields.io/github/stars/Netflix-Skunkworks/policyuniverse) ![GitHub last commit](https://img.shields.io/github/last-commit/Netflix-Skunkworks/policyuniverse)](https://github.com/Netflix-Skunkworks/policyuniverse) - Parse and process AWS policies, statements, ARNs, and wildcards.
...
- [Awesome OpenID Connect ![GitHub Repo Stars](https://img.shields.io/github/stars/cerberauth/awesome-openid-connect) ![GitHub last commit](https://img.shields.io/github/last-commit/cerberauth/awesome-openid-connect)](https://github.com/cerberauth/awesome-openid-connect) - A curated list of providers, services, libraries, and resources for OpenID Connect.

- [The problem with OAuth for Authentication](http://www.thread-safe.com/2012/01/problem-with-oauth-for-authentication.html) - “The problem is that OAuth 2.0 is a Delegated Authorization protocol, and not a Authentication protocol.” 10 years after, this article is still the best explanation on [why use OpenID Connect instead of plain OAuth2](https://web.archive.org/web/20250519085713/https://security.stackexchange.com/questions/37818/why-use-openid-connect-instead-of-plain-oauth2/260519#260519)?
...
- [Casdoor ![GitHub Repo Stars](https://img.shields.io/github/stars/casbin/casdoor) ![GitHub last commit](https://img.shields.io/github/last-commit/casbin/casdoor)](https://github.com/casbin/casdoor) - A UI-first centralized authentication / Single-Sign-On (SSO) platform based. Supports OIDC and OAuth 2, social logins, user management, 2FA based on Email and SMS.
...
- [Logto ![GitHub Repo Stars](https://img.shields.io/github/stars/logto-io/logto) ![GitHub last commit](https://img.shields.io/github/last-commit/logto-io/logto)](https://github.com/logto-io/logto) - An IAM infrastructure for modern apps and SaaS products, supporting OIDC, OAuth 2.0 and SAML for authentication and authorization.
...
- [`truffleHog` ![GitHub Repo Stars](https://img.shields.io/github/stars/dxa4481/truffleHog) ![GitHub last commit](https://img.shields.io/github/last-commit/dxa4481/truffleHog)](https://github.com/dxa4481/truffleHog) - Searches through git repositories for high entropy strings and secrets, digging deep into commit history.
...
- [`roca` ![GitHub Repo Stars](https://img.shields.io/github/stars/crocs-muni/roca) ![GitHub last commit](https://img.shields.io/github/last-commit/crocs-muni/roca)](https://github.com/crocs-muni/roca) - Python module to check for weak RSA moduli in various key formats.
...
- [Project Oak ![GitHub Repo Stars](https://img.shields.io/github/stars/project-oak/oak) ![GitHub last commit](https://img.shields.io/github/last-commit/project-oak/oak)](https://github.com/project-oak/oak) - A specification and a reference implementation for the secure transfer, storage and processing of data.
...
- [Awesome List of Billing and Payments: Fraud links ![GitHub Repo Stars](https://img.shields.io/github/stars/kdeldycke/awesome-billing) ![GitHub last commit](https://img.shields.io/github/last-commit/kdeldycke/awesome-billing)](https://github.com/kdeldycke/awesome-billing#fraud) - Section dedicated to fraud management for billing and payment, from our sister repository.
...
- [Statistically Likely Usernames ![GitHub Repo Stars](https://img.shields.io/github/stars/insidetrust/statistically-likely-usernames) ![GitHub last commit](https://img.shields.io/github/last-commit/insidetrust/statistically-likely-usernames)](https://github.com/insidetrust/statistically-likely-usernames) - Wordlists for creating statistically likely usernames for use in username-enumeration, simulated password-attacks and other security testing tasks.
...
- [Ballerine ![GitHub Repo Stars](https://img.shields.io/github/stars/ballerine-io/ballerine) ![GitHub last commit](https://img.shields.io/github/last-commit/ballerine-io/ballerine)](https://github.com/ballerine-io/ballerine) - An open-source infrastructure for user identity and risk management.
...
- [The challenges of file formats](https://speakerdeck.com/ange/the-challenges-of-file-formats) - At one point you will let users upload files in your system. Here is a [corpus of suspicious media files ![GitHub Repo Stars](https://img.shields.io/github/stars/corkami/pocs) ![GitHub last commit](https://img.shields.io/github/last-commit/corkami/pocs)](https://github.com/corkami/pocs) that can be leveraged by scammers =to bypass security or fool users.

- [SecLists ![GitHub Repo Stars](https://img.shields.io/github/stars/danielmiessler/SecLists) ![GitHub last commit](https://img.shields.io/github/last-commit/danielmiessler/SecLists)](https://github.com/danielmiessler/SecLists) - Collection of multiple types of lists used during security assessments, collected in one place. List types include usernames, passwords, URLs, sensitive data patterns, fuzzing payloads, web shells, and many more.

- [PhishingKitTracker ![GitHub Repo Stars](https://img.shields.io/github/stars/neonprimetime/PhishingKitTracker) ![GitHub last commit](https://img.shields.io/github/last-commit/neonprimetime/PhishingKitTracker)](https://github.com/neonprimetime/PhishingKitTracker) - CSV database of email addresses used by threat actor in phishing kits.

- [PhoneInfoga ![GitHub Repo Stars](https://img.shields.io/github/stars/sundowndev/PhoneInfoga) ![GitHub last commit](https://img.shields.io/github/last-commit/sundowndev/PhoneInfoga)](https://github.com/sundowndev/PhoneInfoga) - Tools to scan phone numbers using only free resources. The goal is to first gather standard information such as country, area, carrier and line type on any international phone numbers with a very good accuracy. Then search for footprints on search engines to try to find the VoIP provider or identify the owner.

- [Confusable Homoglyphs ![GitHub Repo Stars](https://img.shields.io/github/stars/vhf/confusable_homoglyphs) ![GitHub last commit](https://img.shields.io/github/last-commit/vhf/confusable_homoglyphs)](https://github.com/vhf/confusable_homoglyphs) - Homoglyphs is a common phishing trick.

### Captcha

Another line of defense against spammers.

- [Awesome Captcha ![GitHub Repo Stars](https://img.shields.io/github/stars/ZYSzys/awesome-captcha) ![GitHub last commit](https://img.shields.io/github/last-commit/ZYSzys/awesome-captcha)](https://github.com/ZYSzys/awesome-captcha) - Reference all open-source captcha libraries, integration, alternatives and cracking tools.
...
- [Country IP Blocks ![GitHub Repo Stars](https://img.shields.io/github/stars/herrbischoff/country-ip-blocks) ![GitHub last commit](https://img.shields.io/github/last-commit/herrbischoff/country-ip-blocks)](https://github.com/herrbischoff/country-ip-blocks) - CIDR country-level IP data, straight from the Regional Internet Registries, updated hourly.

- [Certificate Transparency Subdomains ![GitHub Repo Stars](https://img.shields.io/github/stars/internetwache/CT_subdomains) ![GitHub last commit](https://img.shields.io/github/last-commit/internetwache/CT_subdomains)](https://github.com/internetwache/CT_subdomains) - An hourly updated list of subdomains gathered from certificate transparency logs.

- Subdomain denylists: [#1](https://gist.github.com/artgon/5366868), [#2 ![GitHub Repo Stars](https://img.shields.io/github/stars/sandeepshetty/subdomain-blacklist) ![GitHub last commit](https://img.shields.io/github/last-commit/sandeepshetty/subdomain-blacklist)](https://github.com/sandeepshetty/subdomain-blacklist/blob/master/subdomain-blacklist.txt), [#3 ![GitHub Repo Stars](https://img.shields.io/github/stars/nccgroup/typofinder) ![GitHub last commit](https://img.shields.io/github/last-commit/nccgroup/typofinder)](https://github.com/nccgroup/typofinder/blob/master/TypoMagic/datasources/subdomains.txt), [#4](https://www.quora.com/How-do-sites-prevent-vanity-URLs-from-colliding-with-future-features).
...
- [`hosts-blocklists` ![GitHub Repo Stars](https://img.shields.io/github/stars/notracking/hosts-blocklists) ![GitHub last commit](https://img.shields.io/github/last-commit/notracking/hosts-blocklists)](https://github.com/notracking/hosts-blocklists) - No more ads, tracking and other virtual garbage.
...
- [`pyisp` ![GitHub Repo Stars](https://img.shields.io/github/stars/ActivisionGameScience/pyisp) ![GitHub last commit](https://img.shields.io/github/last-commit/ActivisionGameScience/pyisp)](https://github.com/ActivisionGameScience/pyisp) - IP to ISP lookup library (includes ASN).
...
- [`gman` ![GitHub Repo Stars](https://img.shields.io/github/stars/benbalter/gman) ![GitHub last commit](https://img.shields.io/github/last-commit/benbalter/gman)](https://github.com/benbalter/gman) - “A ruby gem to check if the owner of a given email address or website is working for THE MAN (a.k.a verifies government domains).” Good resource to hunt for potential government customers in your user base.

- [`Swot` ![GitHub Repo Stars](https://img.shields.io/github/stars/leereilly/swot) ![GitHub last commit](https://img.shields.io/github/last-commit/leereilly/swot)](https://github.com/leereilly/swot) - In the same spirit as above, but this time to flag academic users.
...
- [List of Dirty, Naughty, Obscene, and Otherwise Bad Words ![GitHub Repo Stars](https://img.shields.io/github/stars/LDNOOBW/List-of-Dirty-Naughty-Obscene-and-Otherwise-Bad-Words) ![GitHub last commit](https://img.shields.io/github/last-commit/LDNOOBW/List-of-Dirty-Naughty-Obscene-and-Otherwise-Bad-Words)](https://github.com/LDNOOBW/List-of-Dirty-Naughty-Obscene-and-Otherwise-Bad-Words) - Profanity blocklist from Shutterstock.

- [`profanity-check` ![GitHub Repo Stars](https://img.shields.io/github/stars/vzhou842/profanity-check) ![GitHub last commit](https://img.shields.io/github/last-commit/vzhou842/profanity-check)](https://github.com/vzhou842/profanity-check) - Uses a linear SVM model trained on 200k human-labeled samples of clean and profane text strings.
...
- [Paper we love: Privacy ![GitHub Repo Stars](https://img.shields.io/github/stars/papers-we-love/papers-we-love) ![GitHub last commit](https://img.shields.io/github/last-commit/papers-we-love/papers-we-love)](https://github.com/papers-we-love/papers-we-love/tree/master/privacy) - A collection of scientific studies of schemes providing privacy by design.
...
- [Email marketing regulations around the world ![GitHub Repo Stars](https://img.shields.io/github/stars/threeheartsdigital/email-marketing-regulations) ![GitHub last commit](https://img.shields.io/github/last-commit/threeheartsdigital/email-marketing-regulations)](https://github.com/threeheartsdigital/email-marketing-regulations) - As the world becomes increasingly connected, the email marketing regulation landscape becomes more and more complex.
...
- [Presidio ![GitHub Repo Stars](https://img.shields.io/github/stars/microsoft/presidio) ![GitHub last commit](https://img.shields.io/github/last-commit/microsoft/presidio)](https://github.com/microsoft/presidio) - Context aware, pluggable and customizable data protection and PII data anonymization service for text and images.
...
- [GDPR Developer Guide ![GitHub Repo Stars](https://img.shields.io/github/stars/LINCnil/GDPR-Developer-Guide) ![GitHub last commit](https://img.shields.io/github/last-commit/LINCnil/GDPR-Developer-Guide)](https://github.com/LINCnil/GDPR-Developer-Guide) - Best practices for developers.
...
- [GDPR documents ![GitHub Repo Stars](https://img.shields.io/github/stars/good-lly/gdpr-documents) ![GitHub last commit](https://img.shields.io/github/last-commit/good-lly/gdpr-documents)](https://github.com/good-lly/gdpr-documents) - Templates for personal use to have companies comply with "Data Access" requests.
...
- [Best-of Digital Identity ![GitHub Repo Stars](https://img.shields.io/github/stars/jruizaranguren/best-of-digital-identity) ![GitHub last commit](https://img.shields.io/github/last-commit/jruizaranguren/best-of-digital-identity)](https://github.com/jruizaranguren/best-of-digital-identity) - Ranking, popularity and activity status of open-source digital identity projects.
...
- [Google Cloud Developer's Cheat Sheet ![GitHub Repo Stars](https://img.shields.io/github/stars/gregsramblings/google-cloud-4-words) ![GitHub last commit](https://img.shields.io/github/last-commit/gregsramblings/google-cloud-4-words)](https://github.com/gregsramblings/google-cloud-4-words#the-google-cloud-developers-cheat-sheet) - Describe all GCP products in 4 words or less.
