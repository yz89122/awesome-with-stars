...
* [`npc` ![GitHub Repo Stars](https://img.shields.io/github/stars/samestep/npc) ![GitHub last commit](https://img.shields.io/github/last-commit/samestep/npc)](https://github.com/samestep/npc) - CLI to view and bisect Nixpkgs channel history.
...
* [Colmena ![GitHub Repo Stars](https://img.shields.io/github/stars/nix-community/colmena) ![GitHub last commit](https://img.shields.io/github/last-commit/nix-community/colmena)](https://github.com/nix-community/colmena) - A simple, stateless NixOS deployment tool modeled after NixOps and morph.
...
* [terraform-nixos ![GitHub Repo Stars](https://img.shields.io/github/stars/nix-community/terraform-nixos) ![GitHub last commit](https://img.shields.io/github/last-commit/nix-community/terraform-nixos)](https://github.com/nix-community/terraform-nixos) - A set of Terraform modules designed to deploy NixOS.
* [terranix](https://terranix.org) - Use Nix and the NixOS module system to write your Terraform code.

## Virtualisation

* [agent-sandbox.nix ![GitHub Repo Stars](https://img.shields.io/github/stars/archie-judd/agent-sandbox.nix) ![GitHub last commit](https://img.shields.io/github/last-commit/archie-judd/agent-sandbox.nix)](https://github.com/archie-judd/agent-sandbox.nix) - Declarative sandboxing for any package (e.g. AI coding agents) using bubblewrap on Linux and sandbox-exec on macOS.
...
* [angrr ![GitHub Repo Stars](https://img.shields.io/github/stars/linyinfeng/angrr) ![GitHub last commit](https://img.shields.io/github/last-commit/linyinfeng/angrr)](https://github.com/linyinfeng/angrr) - Auto Nix GC Roots Retention. This tool simply deletes auto GC roots based on the modified time of their symbolic link target.
...
* [dix ![GitHub Repo Stars](https://img.shields.io/github/stars/manic-systems/dix) ![GitHub last commit](https://img.shields.io/github/last-commit/manic-systems/dix)](https://github.com/manic-systems/dix) - Diff Nix; a super-fast tool to diff Nix related things.
...
* [nix-index ![GitHub Repo Stars](https://img.shields.io/github/stars/nix-community/nix-index) ![GitHub last commit](https://img.shields.io/github/last-commit/nix-community/nix-index)](https://github.com/nix-community/nix-index) - Quickly locate Nix packages with specific files.
...
* [nixos-cli ![GitHub Repo Stars](https://img.shields.io/github/stars/nix-community/nixos-cli) ![GitHub last commit](https://img.shields.io/github/last-commit/nix-community/nixos-cli)](https://github.com/nix-community/nixos-cli) - Configurable all-in-one CLI for common NixOS tools with an emphasis on improved user experience.
...
* [flake-edit ![GitHub Repo Stars](https://img.shields.io/github/stars/a-kenji/flake-edit) ![GitHub last commit](https://img.shields.io/github/last-commit/a-kenji/flake-edit)](https://github.com/a-kenji/flake-edit) - Edit your flake inputs with auto-follows and update functionality directly from the CLI.
...
* [make-shell ![GitHub Repo Stars](https://img.shields.io/github/stars/nicknovitski/make-shell) ![GitHub last commit](https://img.shields.io/github/last-commit/nicknovitski/make-shell)](https://github.com/nicknovitski/make-shell) - `mkShell` meets modules, a modular almost-drop-in replacement for `pkgs.mkShell` function.
* [MCP-NixOS ![GitHub Repo Stars](https://img.shields.io/github/stars/utensils/mcp-nixos) ![GitHub last commit](https://img.shields.io/github/last-commit/utensils/mcp-nixos)](https://github.com/utensils/mcp-nixos) - An MCP server that provides AI assistants with accurate information about NixOS packages, options, Home Manager, and nix-darwin configurations.
...
* [nix2container ![GitHub Repo Stars](https://img.shields.io/github/stars/nlewo/nix2container) ![GitHub last commit](https://img.shields.io/github/last-commit/nlewo/nix2container)](https://github.com/nlewo/nix2container) - An efficient container building workflow with Nix.
...
* [nix-oci ![GitHub Repo Stars](https://img.shields.io/github/stars/Dauliac/nix-oci) ![GitHub last commit](https://img.shields.io/github/last-commit/Dauliac/nix-oci)](https://github.com/Dauliac/nix-oci) - A flake-parts module for building minimal, reproducible OCI containers using nix2container.
...
* [treefmt-nix ![GitHub Repo Stars](https://img.shields.io/github/stars/numtide/treefmt-nix) ![GitHub last commit](https://img.shields.io/github/last-commit/numtide/treefmt-nix)](https://github.com/numtide/treefmt-nix) - A formatter that allows formatting all your project files with a single command, all via a single `.nix` file.
...
* [ruby-nix ![GitHub Repo Stars](https://img.shields.io/github/stars/inscapist/ruby-nix) ![GitHub last commit](https://img.shields.io/github/last-commit/inscapist/ruby-nix)](https://github.com/inscapist/ruby-nix) - Generates reproducible ruby/bundler app environment with Nix.
...
* [naersk ![GitHub Repo Stars](https://img.shields.io/github/stars/nix-community/naersk) ![GitHub last commit](https://img.shields.io/github/last-commit/nix-community/naersk)](https://github.com/nix-community/naersk) - Build Rust packages directly from `Cargo.lock`. No conversion step needed.
* [nix-cargo-integration ![GitHub Repo Stars](https://img.shields.io/github/stars/90-008/nix-cargo-integration) ![GitHub last commit](https://img.shields.io/github/last-commit/90-008/nix-cargo-integration)](https://github.com/90-008/nix-cargo-integration) - A library that allows easy and effortless integration for Cargo projects.
* [rust-nix-templater ![GitHub Repo Stars](https://img.shields.io/github/stars/90-008/rust-nix-templater) ![GitHub last commit](https://img.shields.io/github/last-commit/90-008/rust-nix-templater)](https://github.com/90-008/rust-nix-templater) - Generates Nix build and development files for Rust projects.
...
* [Nixvim ![GitHub Repo Stars](https://img.shields.io/github/stars/nix-community/nixvim) ![GitHub last commit](https://img.shields.io/github/last-commit/nix-community/nixvim)](https://github.com/nix-community/nixvim) - A pre-packaged Neovim distribution built with Nix modules and Nixpkgs.
...
* [neovim-nightly-overlay ![GitHub Repo Stars](https://img.shields.io/github/stars/nix-community/neovim-nightly-overlay) ![GitHub last commit](https://img.shields.io/github/last-commit/nix-community/neovim-nightly-overlay)](https://github.com/nix-community/neovim-nightly-overlay) - Daily bumped Neovim nightly package.
