...
- [GlowBarn OS ![GitHub Repo Stars](https://img.shields.io/github/stars/bad-antics/glowbarn-os) ![GitHub last commit](https://img.shields.io/github/last-commit/bad-antics/glowbarn-os)](https://github.com/bad-antics/glowbarn-os) - Buildroot-based Linux distribution for paranormal research with EMF sensors, environmental monitoring, web dashboard and automated data logging. ![Supports Raspberry Pi 4+](https://github.com/thibmaek/awesome-raspberry-pi/raw/main/media/badges/rpi-4.png)
...
- [n01d-forge ![GitHub Repo Stars](https://img.shields.io/github/stars/bad-antics/n01d-forge) ![GitHub last commit](https://img.shields.io/github/last-commit/bad-antics/n01d-forge)](https://github.com/bad-antics/n01d-forge) - Native Rust image burner with LUKS/VeraCrypt encryption support, perfect for creating secure bootable SD cards for Raspberry Pi.
...
- [PiPulse ![GitHub Repo Stars](https://img.shields.io/github/stars/techtiki21/PiPulse) ![GitHub last commit](https://img.shields.io/github/last-commit/techtiki21/PiPulse)](https://github.com/techtiki21/PiPulse) - Monitor Raspberry Pi at all times without SSH.
...
- [ble-scale-sync ![GitHub Repo Stars](https://img.shields.io/github/stars/KristianP26/ble-scale-sync) ![GitHub last commit](https://img.shields.io/github/last-commit/KristianP26/ble-scale-sync)](https://github.com/KristianP26/ble-scale-sync) - Reads BLE smart scales (23 brands) via built-in Bluetooth, calculates body composition, and exports to Garmin Connect, MQTT/Home Assistant, InfluxDB, and more. [Website](https://blescalesync.dev).
- [BotWave ![GitHub Repo Stars](https://img.shields.io/github/stars/dpipstudio/botwave) ![GitHub last commit](https://img.shields.io/github/last-commit/dpipstudio/botwave)](https://github.com/dpipstudio/botwave/) - FM broadcasting system with server-client architecture for managing multiple Raspberry Pi transmitters remotely. ![Supports Raspberry Pi Zero](https://github.com/thibmaek/awesome-raspberry-pi/raw/main/media/badges/rpi-0.png) ![Supports Raspberry Pi 2](https://github.com/thibmaek/awesome-raspberry-pi/raw/main/media/badges/rpi-2.png) ![Supports Raspberry Pi 3](https://github.com/thibmaek/awesome-raspberry-pi/raw/main/media/badges/rpi-3.png)
...
- [Cama-Camel Pack ![GitHub Repo Stars](https://img.shields.io/github/stars/Barqawiz/iot_watering_system) ![GitHub last commit](https://img.shields.io/github/last-commit/Barqawiz/iot_watering_system)](https://github.com/Barqawiz/iot_watering_system) - A home-based irrigation system for efficient plant care using IoT.
...
- [CookCLI ![GitHub Repo Stars](https://img.shields.io/github/stars/cooklang/CookCLI) ![GitHub last commit](https://img.shields.io/github/last-commit/cooklang/CookCLI)](https://github.com/cooklang/CookCLI) - Turn your Raspberry Pi into a self-hosted recipe server. Manage recipes in plain-text Cooklang format with web UI, shopping lists, and meal planning.
...
- [CocktailTDI ![GitHub Repo Stars](https://img.shields.io/github/stars/SimonWaldherr/CocktailTDI) ![GitHub last commit](https://img.shields.io/github/last-commit/SimonWaldherr/CocktailTDI)](https://github.com/SimonWaldherr/CocktailTDI) - Another cocktail machine (powered by Raspberry Pi 4, Golang, a pneumatic pump and valves).
...
- [DCS-BIOS ![GitHub Repo Stars](https://img.shields.io/github/stars/DCS-Skunkworks/dcs-bios) ![GitHub last commit](https://img.shields.io/github/last-commit/DCS-Skunkworks/dcs-bios)](https://github.com/DCS-Skunkworks/dcs-bios) - Exports DCS World cockpit data (switches, lights, displays) over serial/UDP to Arduino, ESP32, or Raspberry Pi for physical panel builds.
...
- [DIY Arcade Machine ![GitHub Repo Stars](https://img.shields.io/github/stars/SimonWaldherr/DIY-Arcade-Machine) ![GitHub last commit](https://img.shields.io/github/last-commit/SimonWaldherr/DIY-Arcade-Machine)](https://github.com/SimonWaldherr/DIY-Arcade-Machine) - A retro style arcade machine, based on a Raspberry Pi Pico, a Hub75 LED matrix and some other stuff (Wii Nunchucks, 3D printed parts, ...) 
...
- [Haven ![GitHub Repo Stars](https://img.shields.io/github/stars/havenweb/haven) ![GitHub last commit](https://img.shields.io/github/last-commit/havenweb/haven)](https://github.com/havenweb/haven) - Host a private blog on your Rasperry Pi instead of using Facebook.
- [HookProbe ![GitHub Repo Stars](https://img.shields.io/github/stars/hookprobe/hookprobe) ![GitHub last commit](https://img.shields.io/github/last-commit/hookprobe/hookprobe)](https://github.com/hookprobe/hookprobe) - AI-native intrusion detection system with eBPF/XDP packet filtering and ML threat classification. Processes 8.8M+ security events on a Pi 5.
...
- [idle-less ![GitHub Repo Stars](https://img.shields.io/github/stars/tvup/idle-less) ![GitHub last commit](https://img.shields.io/github/last-commit/tvup/idle-less)](https://github.com/tvup/idle-less) - Docker-based nginx reverse proxy that wakes sleeping servers via Wake-on-LAN, ideal for energy-saving Raspberry Pi homelabs.
...
- [NanoBot AI Chat Robot ![GitHub Repo Stars](https://img.shields.io/github/stars/samartzidis/NanoBot) ![GitHub last commit](https://img.shields.io/github/last-commit/samartzidis/NanoBot)](https://github.com/samartzidis/NanoBot) - Raspberry Pi powered AI chat robot, ideal for education and teaching assistance.
...
- [PiSpot-Show ![GitHub Repo Stars](https://img.shields.io/github/stars/GeiserX/PiSpot-Show) ![GitHub last commit](https://img.shields.io/github/last-commit/GeiserX/PiSpot-Show)](https://github.com/GeiserX/PiSpot-Show) - WiFi voucher display system with weather integration and PiJuice battery management. ![Supports Raspberry Pi 3](https://github.com/thibmaek/awesome-raspberry-pi/raw/main/media/badges/rpi-3.png)
- [PiSpot Watch ![GitHub Repo Stars](https://img.shields.io/github/stars/GeiserX/PiSpot-Watch) ![GitHub last commit](https://img.shields.io/github/last-commit/GeiserX/PiSpot-Watch)](https://github.com/GeiserX/PiSpot-Watch) - Wrist-wearable Pi Zero smartwatch with e-ink display that generates Wi-Fi voucher codes on demand via button press. ![Supports Raspberry Pi Zero](https://github.com/thibmaek/awesome-raspberry-pi/raw/main/media/badges/rpi-0.png)
...
- [RustChain ![GitHub Repo Stars](https://img.shields.io/github/stars/Scottcjn/Rustchain) ![GitHub last commit](https://img.shields.io/github/last-commit/Scottcjn/Rustchain)](https://github.com/Scottcjn/Rustchain) - Proof-of-Antiquity blockchain that rewards vintage and edge hardware including Raspberry Pi for mining. DePIN infrastructure for IoT devices.
- [Raspberry Pi Telegram Bot ![GitHub Repo Stars](https://img.shields.io/github/stars/GraveEaterMadison/Raspberry_pi_telegram_bot) ![GitHub last commit](https://img.shields.io/github/last-commit/GraveEaterMadison/Raspberry_pi_telegram_bot)](https://github.com/GraveEaterMadison/Raspberry_pi_telegram_bot) - Remotely control your Raspberry Pi using Telegram, with support for GPIO, system commands, custom modules, and real-time interaction.
...
- [Secluso ![GitHub Repo Stars](https://img.shields.io/github/stars/secluso/core) ![GitHub last commit](https://img.shields.io/github/last-commit/secluso/core)](https://github.com/secluso/core) - A private-by-default Raspberry Pi home security camera that uses end-to-end encryption. Supports Raspberry Pi Zero 2 W. ![Supports Raspberry Pi 2+](https://github.com/thibmaek/awesome-raspberry-pi/raw/main/media/badges/rpi-2+.png)
...
- [Sonus ![GitHub Repo Stars](https://img.shields.io/github/stars/evancohen/sonus) ![GitHub last commit](https://img.shields.io/github/last-commit/evancohen/sonus)](https://github.com/evancohen/sonus) - Node.js voice control for your Pi (and everything else) with customizable offline hotword detection.
...
- [Ultimate DNS Shield ![GitHub Repo Stars](https://img.shields.io/github/stars/cherifon/Ultimate-DNS-Shield) ![GitHub last commit](https://img.shields.io/github/last-commit/cherifon/Ultimate-DNS-Shield)](https://github.com/cherifon/Ultimate-DNS-Shield) - Self-hosted recursive DNS server using Pi-hole, Unbound and Docker on Raspberry Pi 4.
...
- [RasRobot 4WD TB6612FNG checklist ![GitHub Repo Stars](https://img.shields.io/github/stars/willoc2023/rasrobot-tb6612fng-4wd) ![GitHub last commit](https://img.shields.io/github/last-commit/willoc2023/rasrobot-tb6612fng-4wd)](https://github.com/willoc2023/rasrobot-tb6612fng-4wd) - Practical Raspberry Pi motor-driver checklist for debugging a 4WD robot with TB6612FNG drivers, common ground, standby pin and step-by-step motor tests.
