...
* [onnx-c ![GitHub Repo Stars](https://img.shields.io/github/stars/onnx/onnx-c) ![GitHub last commit](https://img.shields.io/github/last-commit/onnx/onnx-c)](https://github.com/onnx/onnx-c) - A lightweight C library for ONNX model inference, optimized for performance and portability across platforms.
...
* [YOLOv8 ![GitHub Repo Stars](https://img.shields.io/github/stars/ultralytics/ultralytics) ![GitHub last commit](https://img.shields.io/github/last-commit/ultralytics/ultralytics)](https://github.com/ultralytics/ultralytics) - Ultralytics' YOLOv8 implementation with C++ support for real-time object detection and tracking, optimized for edge devices.
...
* [FlexML ![GitHub Repo Stars](https://img.shields.io/github/stars/ozguraslank/flexml) ![GitHub last commit](https://img.shields.io/github/last-commit/ozguraslank/flexml)](https://github.com/ozguraslank/flexml) - Easy-to-use and flexible AutoML library for Python.
...
* [MCGrad ![GitHub Repo Stars](https://img.shields.io/github/stars/facebookincubator/MCGrad) ![GitHub last commit](https://img.shields.io/github/last-commit/facebookincubator/MCGrad)](https://github.com/facebookincubator/MCGrad/) - A production-ready library for multicalibration, fairness, and bias correction in machine learning models.
...
* [SentencePiece ![GitHub Repo Stars](https://img.shields.io/github/stars/google/sentencepiece) ![GitHub last commit](https://img.shields.io/github/last-commit/google/sentencepiece)](https://github.com/google/sentencepiece) - A C++ library for unsupervised text tokenization and detokenization, widely used in modern NLP models.
...
* [Vosk ![GitHub Repo Stars](https://img.shields.io/github/stars/alphacep/vosk-api) ![GitHub last commit](https://img.shields.io/github/last-commit/alphacep/vosk-api)](https://github.com/alphacep/vosk-api) - An offline speech recognition toolkit with C++ support, designed for low-resource devices and multiple languages.
...
* [Kandle ![GitHub Repo Stars](https://img.shields.io/github/stars/final-kk/kandle) ![GitHub last commit](https://img.shields.io/github/last-commit/final-kk/kandle)](https://github.com/final-kk/kandle) - A JavaScript Native PyTorch-aligned Machine Learning Framework, built from scratch on WebGPU.
...
* [LightlyTrain ![GitHub Repo Stars](https://img.shields.io/github/stars/lightly-ai/lightly-train) ![GitHub last commit](https://img.shields.io/github/last-commit/lightly-ai/lightly-train)](https://github.com/lightly-ai/lightly-train) - Pretrain computer vision models on unlabeled data for industrial applications
...
* [MCP Memory Service ![GitHub Repo Stars](https://img.shields.io/github/stars/doobidoo/mcp-memory-service) ![GitHub last commit](https://img.shields.io/github/last-commit/doobidoo/mcp-memory-service)](https://github.com/doobidoo/mcp-memory-service) - Universal memory service with semantic search, autonomous consolidation, and multi-client support for AI applications.
...
* [Gower Express ![GitHub Repo Stars](https://img.shields.io/github/stars/momonga-ml/gower-express.git) ![GitHub last commit](https://img.shields.io/github/last-commit/momonga-ml/gower-express.git)](https://github.com/momonga-ml/gower-express.git) - The Fastest Gower Distance Implementation for Python. GPU-accelerated similarity matching for mixed data types, 15-25% faster than alternatives with production-ready reliability.
...
* [skrub ![GitHub Repo Stars](https://img.shields.io/github/stars/skrub-data/skrub) ![GitHub last commit](https://img.shields.io/github/last-commit/skrub-data/skrub)](https://github.com/skrub-data/skrub) - Skrub is a Python library that eases preprocessing and feature engineering for machine learning on dataframes.
...
* [ClearML ![GitHub Repo Stars](https://img.shields.io/github/stars/clearml/clearml) ![GitHub last commit](https://img.shields.io/github/last-commit/clearml/clearml)](https://github.com/clearml/clearml) -  Auto-Magical CI/CD to streamline your AI workload. Experiment Management, Data Management, Pipeline, Orchestration, Scheduling & Serving in one MLOps/LLMOps solution. 
...
* [minidiff ![GitHub Repo Stars](https://img.shields.io/github/stars/ahoynodnarb/minidiff) ![GitHub last commit](https://img.shields.io/github/last-commit/ahoynodnarb/minidiff)](https://github.com/ahoynodnarb/minidiff) - A slightly larger, somewhat feature-complete, PyTorch-inspired, NumPy implementation of a tensor reverse-mode automatic differentiation engine.
...
* [Gym4ReaL ![GitHub Repo Stars](https://img.shields.io/github/stars/Daveonwave/gym4ReaL) ![GitHub last commit](https://img.shields.io/github/last-commit/Daveonwave/gym4ReaL)](https://github.com/Daveonwave/gym4ReaL) - Gym4ReaL is a comprehensive suite of realistic environments designed to support the development and evaluation of RL algorithms that can operate in real-world scenarios. The suite includes a diverse set of tasks exposing RL algorithms to a variety of practical challenges.
...
* [Localforge](https://localforge.dev/) – Is an [open source ![GitHub Repo Stars](https://img.shields.io/github/stars/rockbite/localforge) ![GitHub last commit](https://img.shields.io/github/last-commit/rockbite/localforge)](https://github.com/rockbite/localforge) on-prem AI coding autonomous assistant that lives inside your repo, edits and tests files at SSD speed. Think Claude Code but with UI. plug in any LLM (OpenAI, Gemini, Ollama, etc.) and let it work for you.
...
* [ClawMoat ![GitHub Repo Stars](https://img.shields.io/github/stars/darfaz/clawmoat) ![GitHub last commit](https://img.shields.io/github/last-commit/darfaz/clawmoat)](https://github.com/darfaz/clawmoat) - Open-source runtime security scanner for AI agents. Detects prompt injection, jailbreak, PII leakage, memory poisoning, and tool misuse. Zero deps, MIT licensed.
...
* [RunAnywhere ![GitHub Repo Stars](https://img.shields.io/github/stars/RunanywhereAI/runanywhere-sdks) ![GitHub last commit](https://img.shields.io/github/last-commit/RunanywhereAI/runanywhere-sdks)](https://github.com/RunanywhereAI/runanywhere-sdks) - Open-source SDK for running LLMs and multimodal models on-device across iOS, Android, and cross-platform apps.
