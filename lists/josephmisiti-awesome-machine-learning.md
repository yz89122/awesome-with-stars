...
* [notorch ![GitHub Repo Stars](https://img.shields.io/github/stars/ariannamethod/notorch) ![GitHub last commit](https://img.shields.io/github/last-commit/ariannamethod/notorch)](https://github.com/ariannamethod/notorch) - Neural networks framework in pure C: training and inference, no dependencies.
...
* [qwen3.8-27b-in-c ![GitHub Repo Stars](https://img.shields.io/github/stars/shyringo/qwen3.8-27b-in-c) ![GitHub last commit](https://img.shields.io/github/last-commit/shyringo/qwen3.8-27b-in-c)](https://github.com/shyringo/qwen3.8-27b-in-c) - A native C inference engine for running Qwen3.8-27B locally on a single laptop CPU, with direct GGUF loading and a tested 8 GB memory path.
* [deepseek-v4-flash-0731-in-c ![GitHub Repo Stars](https://img.shields.io/github/stars/shyringo/deepseek-v4-flash-0731-in-c) ![GitHub last commit](https://img.shields.io/github/last-commit/shyringo/deepseek-v4-flash-0731-in-c)](https://github.com/shyringo/deepseek-v4-flash-0731-in-c) - A native C CPU inference engine for running the 284B-A13B DeepSeek-V4-Flash-0731 on one laptop, reaching up to 1.12 token/s on tested hardware while streaming the 167 GB checkpoint from disk with a tested 8 GB memory path and no GPU or Python.
...
#### Speech Recognition
* [VoxRT ![GitHub Repo Stars](https://img.shields.io/github/stars/VoxRT/voxrt-asr-linux) ![GitHub last commit](https://img.shields.io/github/last-commit/VoxRT/voxrt-asr-linux)](https://github.com/VoxRT/voxrt-asr-linux) - On-device streaming speech recognition runtime with C API for Linux (aarch64/x86_64). Based on NVIDIA NeMo FastConformer (80 ms cache-aware lookahead). Companion Silero VAD, wake-word, and 14-command KWS via same runtime.
...
* [CosmoEdge ![GitHub Repo Stars](https://img.shields.io/github/stars/cosmo-wander-ai/cosmo-edge) ![GitHub last commit](https://img.shields.io/github/last-commit/cosmo-wander-ai/cosmo-edge)](https://github.com/cosmo-wander-ai/cosmo-edge) - A C++ edge video AI engine for RTSP ingestion, CV/VLM inference, visual pipeline orchestration, alarms, and event delivery on Sophon and Rockchip NPUs.
...
* [MiaIA ![GitHub Repo Stars](https://img.shields.io/github/stars/Agosillo/MiaIA) ![GitHub last commit](https://img.shields.io/github/last-commit/Agosillo/MiaIA)](https://github.com/Agosillo/MiaIA) - An open-source C++20 neural-network engine and Unreal Engine 5 Studio for building, training, visualizing, inspecting, and debugging observable feed-forward networks.
...
* [Ombre ![GitHub Repo Stars](https://img.shields.io/github/stars/pypl0/Ombre) ![GitHub last commit](https://img.shields.io/github/last-commit/pypl0/Ombre)](https://github.com/pypl0/Ombre) - Open source AI infrastructure layer. Eight agents run automatically: security, caching, memory, hallucination detection, and tamper-proof audit trail. Runs locally.
...
* [VoxRT ![GitHub Repo Stars](https://img.shields.io/github/stars/VoxRT/voxrt-asr-linux) ![GitHub last commit](https://img.shields.io/github/last-commit/VoxRT/voxrt-asr-linux)](https://github.com/VoxRT/voxrt-asr-linux) - On-device streaming speech recognition runtime with C/C++ headers for Linux (aarch64/x86_64). Based on NVIDIA NeMo FastConformer (80 ms cache-aware lookahead). Companion Silero VAD, wake-word, and 14-command KWS via same runtime.
...
* [anneal ![GitHub Repo Stars](https://img.shields.io/github/stars/georgebuilds/anneal) ![GitHub last commit](https://img.shields.io/github/last-commit/georgebuilds/anneal)](https://github.com/georgebuilds/anneal) - From-scratch Go port of tinygrad: a graph-rewrite ML compiler with reverse-mode autodiff and a WebGPU backend.
...
#### Speech Recognition
* [VoxRT ![GitHub Repo Stars](https://img.shields.io/github/stars/VoxRT/voxrt-asr-linux) ![GitHub last commit](https://img.shields.io/github/last-commit/VoxRT/voxrt-asr-linux)](https://github.com/VoxRT/voxrt-asr-linux) - On-device streaming speech recognition runtime with Go bindings. Based on NVIDIA NeMo FastConformer (80 ms cache-aware lookahead). Ships alongside C/C++, PyPI, and npm packages for Linux (aarch64/x86_64).
...
* [AI on Browser ![GitHub Repo Stars](https://img.shields.io/github/stars/ai-on-browser/ai-on-browser.github.io) ![GitHub last commit](https://img.shields.io/github/last-commit/ai-on-browser/ai-on-browser.github.io)](https://github.com/ai-on-browser/ai-on-browser.github.io) - An educational, pure JavaScript library designed to help developers and students understand the inner workings of ML algorithms without the magic of external libraries.

<a name="javascript-speech-recognition"></a>
#### Speech Recognition
* [VoxRT ![GitHub Repo Stars](https://img.shields.io/github/stars/VoxRT/voxrt-asr-linux) ![GitHub last commit](https://img.shields.io/github/last-commit/VoxRT/voxrt-asr-linux)](https://github.com/VoxRT/voxrt-asr-linux) - On-device streaming speech recognition runtime with npm bindings. Based on NVIDIA NeMo FastConformer (80 ms cache-aware lookahead). Ships alongside C/C++, Python (PyPI), and Go packages for Linux (aarch64/x86_64).
...
#### Speech Recognition
* [VoxRT ![GitHub Repo Stars](https://img.shields.io/github/stars/VoxRT/voxrt-asr-android) ![GitHub last commit](https://img.shields.io/github/last-commit/VoxRT/voxrt-asr-android)](https://github.com/VoxRT/voxrt-asr-android) - On-device streaming speech recognition SDK for Android with Kotlin bindings (JitPack). Based on NVIDIA NeMo FastConformer (80 ms cache-aware lookahead). Companion Silero VAD, wake-word, and 14-command KWS via same runtime.
...
* [pyinterpret ![GitHub Repo Stars](https://img.shields.io/github/stars/mowne67/pyinterpret) ![GitHub last commit](https://img.shields.io/github/last-commit/mowne67/pyinterpret)](https://github.com/mowne67/pyinterpret) - Unified API for SHAP, LIME, permutation importance, and partial dependence explanations.
...
* [Leanpass ![GitHub Repo Stars](https://img.shields.io/github/stars/Terminay/LeanPass) ![GitHub last commit](https://img.shields.io/github/last-commit/Terminay/LeanPass)](https://github.com/Terminay/LeanPass) - A lightweight, NumPy-only autodiff library for small ML projects and learning how backpropagation works. It is 700x times lighter than Pytorch and 900x times lighter than TensorFlow.
...
* [Adaptive Reliability Layer ![GitHub Repo Stars](https://img.shields.io/github/stars/pberlizov/adaptive-reliability-layer) ![GitHub last commit](https://img.shields.io/github/last-commit/pberlizov/adaptive-reliability-layer)](https://github.com/pberlizov/adaptive-reliability-layer): A bounded controller for production ML under distribution shift — detects drift, learns from delayed labels, and takes the smallest safe steering step to defer unnecessary retrains.
...
* [HypercubeESN ![GitHub Repo Stars](https://img.shields.io/github/stars/dliptak001/HypercubeESN) ![GitHub last commit](https://img.shields.io/github/last-commit/dliptak001/HypercubeESN)](https://github.com/dliptak001/HypercubeESN) - Echo State Network on a Boolean hypercube reservoir: XOR Hamming-1 connectivity, no stored adjacency, C++23 + Python (`pip install hypercube-esn`).
* [HypercubeWTF ![GitHub Repo Stars](https://img.shields.io/github/stars/dliptak001/HypercubeWTF) ![GitHub last commit](https://img.shields.io/github/last-commit/dliptak001/HypercubeWTF)](https://github.com/dliptak001/HypercubeWTF) - Frozen hypercube reservoir for static fields (synthetic-time orbit + thin CNN readout). Sibling of HypercubeESN.
* [HypercubeCascade ![GitHub Repo Stars](https://img.shields.io/github/stars/dliptak001/HypercubeCascade) ![GitHub last commit](https://img.shields.io/github/last-commit/dliptak001/HypercubeCascade)](https://github.com/dliptak001/HypercubeCascade) - Etalon transit then WTF orbit on one cube, then a thin HypercubeCNN readout.
* [HypercubeHopfield ![GitHub Repo Stars](https://img.shields.io/github/stars/dliptak001/HypercubeHopfield) ![GitHub last commit](https://img.shields.io/github/last-commit/dliptak001/HypercubeHopfield)](https://github.com/dliptak001/HypercubeHopfield) - Modern Hopfield associative memory on a hypercube graph with sparse local-attention retrieval (C++23 + Python).
...
#### Speech Recognition
* [VoxRT ![GitHub Repo Stars](https://img.shields.io/github/stars/VoxRT/voxrt-asr-ios) ![GitHub last commit](https://img.shields.io/github/last-commit/VoxRT/voxrt-asr-ios)](https://github.com/VoxRT/voxrt-asr-ios) - On-device streaming speech recognition SDK for iOS with Swift bindings (SPM). Based on NVIDIA NeMo FastConformer (80 ms cache-aware lookahead). Companion Silero VAD, wake-word, and 14-command KWS via same runtime.
