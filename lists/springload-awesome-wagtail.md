...
- [wagtailnews ![GitHub Repo Stars](https://img.shields.io/github/stars/neon-jungle/wagtailnews) ![GitHub last commit](https://img.shields.io/github/last-commit/neon-jungle/wagtailnews)](https://github.com/neon-jungle/wagtailnews) - A plugin for Wagtail that provides news / blogging functionality.
...
- [wagtail-readability ![GitHub Repo Stars](https://img.shields.io/github/stars/neon-jungle/wagtail-readability) ![GitHub last commit](https://img.shields.io/github/last-commit/neon-jungle/wagtail-readability)](https://github.com/neon-jungle/wagtail-readability) - Test how readable the content you enter into Wagtail is.
...
- [Wagtail HTML Editor ![GitHub Repo Stars](https://img.shields.io/github/stars/kkm-horikawa/wagtail-html-editor) ![GitHub last commit](https://img.shields.io/github/last-commit/kkm-horikawa/wagtail-html-editor)](https://github.com/kkm-horikawa/wagtail-html-editor) - A CodeMirror 6-powered HTML editor for Wagtail with syntax highlighting, Emmet support, and dark mode.

### StreamField

- [Wagtail FontAwesome](https://gitlab.com/alexgleason/wagtailfontawesome) - Add FontAwesome icons to StreamField.
- [Wagtail Commonblocks ![GitHub Repo Stars](https://img.shields.io/github/stars/springload/wagtailcommonblocks) ![GitHub last commit](https://img.shields.io/github/last-commit/springload/wagtailcommonblocks)](https://github.com/springload/wagtailcommonblocks) - Common StreamField blocks for Wagtail.
...
- [Wagtail ClearStream ![GitHub Repo Stars](https://img.shields.io/github/stars/hminnovation/wagtailclearstream) ![GitHub last commit](https://img.shields.io/github/last-commit/hminnovation/wagtailclearstream)](https://github.com/hminnovation/wagtailclearstream) - An app to make Wagtail's StreamField more modular.
...
- [Wagtail Code Block ![GitHub Repo Stars](https://img.shields.io/github/stars/wagtail-nest/wagtailcodeblock) ![GitHub last commit](https://img.shields.io/github/last-commit/wagtail-nest/wagtailcodeblock)](https://github.com/wagtail-nest/wagtailcodeblock) - StreamField code blocks for the Wagtail CMS with real-time PrismJS Syntax Highlighting.
...
- [Wagtail-bakery ![GitHub Repo Stars](https://img.shields.io/github/stars/wagtail-nest/wagtail-bakery) ![GitHub last commit](https://img.shields.io/github/last-commit/wagtail-nest/wagtail-bakery)](https://github.com/wagtail-nest/wagtail-bakery) - A set of helpers for baking your Django Wagtail site out as flat files.
...
- [wagtailinvoices ![GitHub Repo Stars](https://img.shields.io/github/stars/LiamBrenner/wagtailinvoices) ![GitHub last commit](https://img.shields.io/github/last-commit/LiamBrenner/wagtailinvoices)](https://github.com/LiamBrenner/wagtailinvoices) - A Wagtail module for creating invoices.
- [longclaw ![GitHub Repo Stars](https://img.shields.io/github/stars/longclawshop/longclaw) ![GitHub last commit](https://img.shields.io/github/last-commit/longclawshop/longclaw)](https://github.com/longclawshop/longclaw) - A shop template for Wagtail CMS.
...
- [wagtail-metadata ![GitHub Repo Stars](https://img.shields.io/github/stars/neon-jungle/wagtail-metadata) ![GitHub last commit](https://img.shields.io/github/last-commit/neon-jungle/wagtail-metadata)](https://github.com/neon-jungle/wagtail-metadata) - A tool to assist with metadata for social media and search engines.
...
- [wagtail-schema.org ![GitHub Repo Stars](https://img.shields.io/github/stars/neon-jungle/wagtail-schema.org) ![GitHub last commit](https://img.shields.io/github/last-commit/neon-jungle/wagtail-schema.org)](https://github.com/neon-jungle/wagtail-schema.org) - Schema.org JSON-LD tags for Wagtail sites.
...
- [Wagtail Image Import ![GitHub Repo Stars](https://img.shields.io/github/stars/emilytoppm/wagtail-image-import) ![GitHub last commit](https://img.shields.io/github/last-commit/emilytoppm/wagtail-image-import)](https://github.com/emilytoppm/wagtail-image-import) - A plugin for importing images from Google Drive.
...
- [Wagtail Makeup ![GitHub Repo Stars](https://img.shields.io/github/stars/torchbox/wagtail-makeup) ![GitHub last commit](https://img.shields.io/github/last-commit/torchbox/wagtail-makeup)](https://github.com/torchbox/wagtail-makeup) - A plugin that replaces all your images with Unsplash images.
...
- [Wagtail Transcription ![GitHub Repo Stars](https://img.shields.io/github/stars/j-bodek/wagtail-transcription) ![GitHub last commit](https://img.shields.io/github/last-commit/j-bodek/wagtail-transcription)](https://github.com/j-bodek/wagtail-transcription) - Provides a field to automatically creates transcriptions from YouTube videos.
...
- [wagtailtrans ![GitHub Repo Stars](https://img.shields.io/github/stars/wagtail/wagtailtrans) ![GitHub last commit](https://img.shields.io/github/last-commit/wagtail/wagtailtrans)](https://github.com/wagtail/wagtailtrans) - A Wagtail add-on for supporting multilingual sites.
...
- [Wagtail ReCaptcha ![GitHub Repo Stars](https://img.shields.io/github/stars/wagtail-nest/wagtail-django-recaptcha) ![GitHub last commit](https://img.shields.io/github/last-commit/wagtail-nest/wagtail-django-recaptcha)](https://github.com/wagtail-nest/wagtail-django-recaptcha) - wagtail-django-captcha provides an easy way to integrate the [django-recaptcha ![GitHub Repo Stars](https://img.shields.io/github/stars/django-recaptcha/django-recaptcha) ![GitHub last commit](https://img.shields.io/github/last-commit/django-recaptcha/django-recaptcha)](https://github.com/django-recaptcha/django-recaptcha) field when using the Wagtail formbuilder.
...
- [Wagtail JotForm ![GitHub Repo Stars](https://img.shields.io/github/stars/torchbox/wagtail-jotform) ![GitHub last commit](https://img.shields.io/github/last-commit/torchbox/wagtail-jotform)](https://github.com/torchbox/wagtail-jotform) - Embeddable Jotform forms for Wagtail pages.
...
- [wagtail-linkchecker ![GitHub Repo Stars](https://img.shields.io/github/stars/neon-jungle/wagtail-linkchecker) ![GitHub last commit](https://img.shields.io/github/last-commit/neon-jungle/wagtail-linkchecker)](https://github.com/neon-jungle/wagtail-linkchecker) - A tool to assist with finding broken links on your Wagtail site.
- [Wagtail Accessibility ![GitHub Repo Stars](https://img.shields.io/github/stars/wagtail-nest/wagtail-accessibility) ![GitHub last commit](https://img.shields.io/github/last-commit/wagtail-nest/wagtail-accessibility)](https://github.com/wagtail-nest/wagtail-accessibility) – A plugin to assist with accessibility when developing in Wagtail.
- [Wagtail Factories ![GitHub Repo Stars](https://img.shields.io/github/stars/wagtail/wagtail-factories) ![GitHub last commit](https://img.shields.io/github/last-commit/wagtail/wagtail-factories)](https://github.com/wagtail/wagtail-factories) - Factory boy classes for Wagtail.
...
- [wagtailmenus ![GitHub Repo Stars](https://img.shields.io/github/stars/jazzband/wagtailmenus) ![GitHub last commit](https://img.shields.io/github/last-commit/jazzband/wagtailmenus)](https://github.com/jazzband/wagtailmenus) - An app to help you manage and render menus in your Wagtail projects more effectively.
...
- [Beginner Wagtail Cookiecutter ![GitHub Repo Stars](https://img.shields.io/github/stars/hminnovation/beginner-wagtail) ![GitHub last commit](https://img.shields.io/github/last-commit/hminnovation/beginner-wagtail)](https://github.com/hminnovation/beginner-wagtail) – A super simple implementation of Wagtail CMS.
- [Wagtail Pipit ![GitHub Repo Stars](https://img.shields.io/github/stars/Frojd/Wagtail-Pipit) ![GitHub last commit](https://img.shields.io/github/last-commit/Frojd/Wagtail-Pipit)](https://github.com/Frojd/Wagtail-Pipit) – Pipit is a Wagtail boilerplate which aims to provide an easy and modern developer workflow with a React-rendered frontend.
...
- [Wordpress to Wagtail migration kit ![GitHub Repo Stars](https://img.shields.io/github/stars/wagtail/wagtail-wordpress-import) ![GitHub last commit](https://img.shields.io/github/last-commit/wagtail/wagtail-wordpress-import)](https://github.com/wagtail/wagtail-wordpress-import) - Import WordPress blog content from an XML file into Wagtail.
...
- [State Design System (DSFR) starter ![GitHub Repo Stars](https://img.shields.io/github/stars/numerique-gouv/sites-conformes) ![GitHub last commit](https://img.shields.io/github/last-commit/numerique-gouv/sites-conformes)](https://github.com/numerique-gouv/sites-conformes) - Wagtail template and starter kit from the French government.
...
- [Wagtail news template ![GitHub Repo Stars](https://img.shields.io/github/stars/wagtail/news-template) ![GitHub last commit](https://img.shields.io/github/last-commit/wagtail/news-template)](https://github.com/wagtail/news-template)
...
- [wagtail-textract – Wagtail Space 2019](https://www.youtube.com/watch?t=3313&v=CSwpj-jyjP4) by Kees Hink. [Code ![GitHub Repo Stars](https://img.shields.io/github/stars/fourdigits/wagtail_textract) ![GitHub last commit](https://img.shields.io/github/last-commit/fourdigits/wagtail_textract)](https://github.com/fourdigits/wagtail_textract).
...
- [torchbox.com ![GitHub Repo Stars](https://img.shields.io/github/stars/torchbox/torchbox.com) ![GitHub last commit](https://img.shields.io/github/last-commit/torchbox/torchbox.com)](https://github.com/torchbox/torchbox.com) – Wagtail build of Torchbox.com.
...
- [OpenCanada.org ![GitHub Repo Stars](https://img.shields.io/github/stars/CIGIHub/opencanada) ![GitHub last commit](https://img.shields.io/github/last-commit/CIGIHub/opencanada)](https://github.com/CIGIHub/opencanada) – The opencanada.org website source.
...
- [NHS.UK Content Store ![GitHub Repo Stars](https://img.shields.io/github/stars/nhsuk-archive/nhsuk-content-store) ![GitHub last commit](https://img.shields.io/github/last-commit/nhsuk-archive/nhsuk-content-store)](https://github.com/nhsuk-archive/nhsuk-content-store) – NHS.UK content store and editing app.
...
- [WesternFriend ![GitHub Repo Stars](https://img.shields.io/github/stars/WesternFriend/westernfriend.org) ![GitHub last commit](https://img.shields.io/github/last-commit/WesternFriend/westernfriend.org)](https://github.com/WesternFriend/westernfriend.org) - community website with directory, ecommerce, and online subscription
...
- [Wagtail user guide ![GitHub Repo Stars](https://img.shields.io/github/stars/wagtail/guide) ![GitHub last commit](https://img.shields.io/github/last-commit/wagtail/guide)](https://github.com/wagtail/guide) - A website to teach Wagtail to content editors, moderators and administrators.
