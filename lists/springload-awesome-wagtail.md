...
- [Wagtail Makeup ![GitHub Repo Stars](https://img.shields.io/github/stars/torchbox/wagtail-makeup) ![GitHub last commit](https://img.shields.io/github/last-commit/torchbox/wagtail-makeup)](https://github.com/torchbox/wagtail-makeup) - A plugin that replaces all your images with [Unsplash](https://unsplash.com/) images.
...
- [wagtailmenus ![GitHub Repo Stars](https://img.shields.io/github/stars/jazzband/wagtailmenus) ![GitHub last commit](https://img.shields.io/github/last-commit/jazzband/wagtailmenus)](https://github.com/jazzband/wagtailmenus) - An extension for Torchbox's Wagtail CMS to help you manage and render multi-level navigation and simple flat menus in a consistent, flexible way.
...
- [State Design System (DSFR) starter ![GitHub Repo Stars](https://img.shields.io/github/stars/numerique-gouv/sites-faciles) ![GitHub last commit](https://img.shields.io/github/last-commit/numerique-gouv/sites-faciles)](https://github.com/numerique-gouv/sites-faciles) - Wagtail template and starter kit from the French government.
...
- [Wagtail — еще ��дна CMS на Django](https://www.youtube.com/watch?v=yRmZ6WUfoOc) by Mikalai Radchuk - This talk is an introduction to Wagtail in Russian.
...
- [Wagtail: когда хочется че��о-то приятнее, чем просто Django – Moscow Python Conf++ 2018](https://www.youtube.com/watch?v=xPPfTvLS7oQ) by Игорь Мосягин
