...
- [Web Vitals ![GitHub Repo Stars](https://img.shields.io/github/stars/GoogleChrome/web-vitals) ![GitHub last commit](https://img.shields.io/github/last-commit/GoogleChrome/web-vitals)](https://github.com/GoogleChrome/web-vitals) - Open Source Library to collect Field Data.
...
- Is it happening? - Did the navigation start successfully? Has the server responded? (e.g [FCP ![GitHub Repo Stars](https://img.shields.io/github/stars/csabapalfi/awesome-web-performance-metrics) ![GitHub last commit](https://img.shields.io/github/last-commit/csabapalfi/awesome-web-performance-metrics)](https://github.com/csabapalfi/awesome-web-performance-metrics/#first-contentful-paint-fcp))
- Is it useful/meaningful? - Has enough content rendered that users can engage with it? (e.g. [LCP ![GitHub Repo Stars](https://img.shields.io/github/stars/csabapalfi/awesome-web-performance-metrics) ![GitHub last commit](https://img.shields.io/github/last-commit/csabapalfi/awesome-web-performance-metrics)](https://github.com/csabapalfi/awesome-web-performance-metrics/#largest-contentful-paint-lcp))
- Is it usable - Can users interact with the page, or is it still busy loading? (e.g [TBT ![GitHub Repo Stars](https://img.shields.io/github/stars/csabapalfi/awesome-web-performance-metrics) ![GitHub last commit](https://img.shields.io/github/last-commit/csabapalfi/awesome-web-performance-metrics)](https://github.com/csabapalfi/awesome-web-performance-metrics/#total-blocking-time-tbt))
...
- [Spec - LCP - W3C ![GitHub Repo Stars](https://img.shields.io/github/stars/WICG/largest-contentful-paint) ![GitHub last commit](https://img.shields.io/github/last-commit/WICG/largest-contentful-paint)](https://github.com/WICG/largest-contentful-paint#readme)
...
- [Spec - Layout Instability API - W3C ![GitHub Repo Stars](https://img.shields.io/github/stars/WICG/layout-instability) ![GitHub last commit](https://img.shields.io/github/last-commit/WICG/layout-instability)](https://github.com/WICG/layout-instability)
...
- Lab: WPT
- Field: Chrome 77+
- [Docs - Last Painted Hero - WPT ![GitHub Repo Stars](https://img.shields.io/github/stars/WPO-Foundation/webpagetest) ![GitHub last commit](https://img.shields.io/github/last-commit/WPO-Foundation/webpagetest)](https://github.com/WPO-Foundation/webpagetest/blob/master/docs/Metrics/HeroElements.md)
...
- [Polyfill - FID ![GitHub Repo Stars](https://img.shields.io/github/stars/GoogleChromeLabs/first-input-delay) ![GitHub last commit](https://img.shields.io/github/last-commit/GoogleChromeLabs/first-input-delay)](https://github.com/GoogleChromeLabs/first-input-delay)
...
- [Which third party scripts are most excessive ![GitHub Repo Stars](https://img.shields.io/github/stars/patrickhulce/third-party-web) ![GitHub last commit](https://img.shields.io/github/last-commit/patrickhulce/third-party-web)](https://github.com/patrickhulce/third-party-web)
