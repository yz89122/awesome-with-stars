...
- [Dependabot ![GitHub Repo Stars](https://img.shields.io/github/stars/security/advanced-security) ![GitHub last commit](https://img.shields.io/github/last-commit/security/advanced-security)](https://github.com/security/advanced-security) - Dependabot is a dependency update service. It monitors and updates your dependencies by sending a pull-request. The service is free for public repos and personal account repos.
