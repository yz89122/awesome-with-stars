...
- [Square Shooter ![GitHub Repo Stars](https://img.shields.io/github/stars/namzug16/squareshooter_flame) ![GitHub last commit](https://img.shields.io/github/last-commit/namzug16/squareshooter_flame)](https://github.com/namzug16/squareshooter_flame) - A simple 2D top-down shooter for the web. Play solo vs AI or sit back and let the AI battle its own. By [Namzug](https://namzug.dev/).

#### Education

- [Visual Graphs](https://mglsj.eu.org/visual_graphs/) - A graph (data structure) algoithims visualizer built with Flutter & Flame. By [mglsj ![GitHub Repo Stars](https://img.shields.io/github/stars/mglsj/visual_graphs) ![GitHub last commit](https://img.shields.io/github/last-commit/mglsj/visual_graphs)](https://github.com/mglsj/visual_graphs)
...
- [Mandarin Chinese (中��) ![GitHub Repo Stars](https://img.shields.io/github/stars/flame-engine/awesome-flame) ![GitHub last commit](https://img.shields.io/github/last-commit/flame-engine/awesome-flame)](https://github.com/flame-engine/awesome-flame/blob/main/CONTENT_ZH.md)
...
[4]: https://github.com/flame-engine/awesome-flame/raw/main/%3Chttps://www.coconutisland.app%3E 'Coconut Island Apps'
