...
- [AWX ![GitHub Repo Stars](https://img.shields.io/github/stars/ansible/awx) ![GitHub last commit](https://img.shields.io/github/last-commit/ansible/awx)](https://github.com/ansible/awx) - Web-based user interface, REST API, and task engine built on top of Ansible. It is the upstream project for Automation Controller.
...
- [ansible-static-lint ![GitHub Repo Stars](https://img.shields.io/github/stars/arhuman/ansible-static-lint) ![GitHub last commit](https://img.shields.io/github/last-commit/arhuman/ansible-static-lint)](https://github.com/arhuman/ansible-static-lint) - Fast, offline static linter for playbooks written in Go, implementing a subset of ansible-lint rules without requiring Python or an Ansible runtime.
...
- [Ansible DocSmith ![GitHub Repo Stars](https://img.shields.io/github/stars/foundata/ansible-docsmith) ![GitHub last commit](https://img.shields.io/github/last-commit/foundata/ansible-docsmith)](https://github.com/foundata/ansible-docsmith) - Generates Ansible role documentation from argument_specs.yml for READMEs and default variable files.
...
- [ARA ![GitHub Repo Stars](https://img.shields.io/github/stars/ansible-community/ara) ![GitHub last commit](https://img.shields.io/github/last-commit/ansible-community/ara)](https://github.com/ansible-community/ara) - Records Ansible playbooks and makes them easier to understand and troubleshoot with a reporting API, UI and CLI.
...
- [ansible-security-scanner ![GitHub Repo Stars](https://img.shields.io/github/stars/cpeoples/ansible-security-scanner) ![GitHub last commit](https://img.shields.io/github/last-commit/cpeoples/ansible-security-scanner)](https://github.com/cpeoples/ansible-security-scanner) - Static analyzer for playbooks, roles and collections covering hardcoded credentials, RCE, and supply-chain risks. Outputs SARIF, CycloneDX SBOM and GitLab SAST.
...
- [Ansible Semaphore ![GitHub Repo Stars](https://img.shields.io/github/stars/ansible-semaphore/semaphore) ![GitHub last commit](https://img.shields.io/github/last-commit/ansible-semaphore/semaphore)](https://github.com/ansible-semaphore/semaphore) - Modern UI for managing and running Ansible playbooks.
...
- [Linuxfabrik LFOps ![GitHub Repo Stars](https://img.shields.io/github/stars/Linuxfabrik/lfops) ![GitHub last commit](https://img.shields.io/github/last-commit/Linuxfabrik/lfops)](https://github.com/Linuxfabrik/lfops) - An Ansible Collection with 145+ playbooks and 160+ roles to bootstrap and manage Linux infrastructure (RHEL 8/9/10, Debian, Ubuntu). Covers OS hardening, MariaDB, Icinga2, Nextcloud, FreeIPA, KVM and Bitwarden integration.
