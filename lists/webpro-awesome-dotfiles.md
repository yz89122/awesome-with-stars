...
| Title                                                         | Description                                                              | Focus                                                                                                                                            |
| :------------------------------------------------------------ | :----------------------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------- |
| [Nick Khan's dotfiles ![GitHub Repo Stars](https://img.shields.io/github/stars/nicksp/dotfiles) ![GitHub last commit](https://img.shields.io/github/last-commit/nicksp/dotfiles)](https://github.com/nicksp/dotfiles/)                         | Personal dotfiles for configuring macOS environment with Zsh and Homebrew. No fluff, only the stuff I actually use.                     | Zsh, Git (w/ aliases), Visual Studio Code, Ghostty, shell aliases, sensible macOS defaults, custom CLI script, etc. |
...
- [rotz ![GitHub Repo Stars](https://img.shields.io/github/stars/volllly/rotz) ![GitHub last commit](https://img.shields.io/github/last-commit/volllly/rotz)](https://github.com/volllly/rotz) - Fully cross-platform dotfile manager and dev environment bootstrapper
  written in Rust.
