...
- [TODOvue Blog ![GitHub Repo Stars](https://img.shields.io/github/stars/TODOvue/todo-vue) ![GitHub last commit](https://img.shields.io/github/last-commit/TODOvue/todo-vue)](https://github.com/TODOvue/todo-vue) - Guides and tutorials on creating modern components with Vue.js. [Website](https://todovue.blog/)
...
- [Maxim Web Chat ![GitHub Repo Stars](https://img.shields.io/github/stars/maxim-top/maxim-web) ![GitHub last commit](https://img.shields.io/github/last-commit/maxim-top/maxim-web)](https://github.com/maxim-top/maxim-web) - A chat demo using [MaximTop](https://www.maximtop.com)'s IM SDK (floo), 使用美信拓扑 IM SDK 实现的聊天 App ���例.
...
- [Reka UI ![GitHub Repo Stars](https://img.shields.io/github/stars/unovue/reka-ui) ![GitHub last commit](https://img.shields.io/github/last-commit/unovue/reka-ui)](https://github.com/unovue/reka-ui) - An open-source library of unstyled, accessible UI primitives for building high-quality design systems and web apps in Vue 3 (formerly Radix Vue).
- [shadcn-vue ![GitHub Repo Stars](https://img.shields.io/github/stars/unovue/shadcn-vue) ![GitHub last commit](https://img.shields.io/github/last-commit/unovue/shadcn-vue)](https://github.com/unovue/shadcn-vue) - An unofficial, community-led Vue port of [shadcn/ui ![GitHub Repo Stars](https://img.shields.io/github/stars/shadcn-ui/ui) ![GitHub last commit](https://img.shields.io/github/last-commit/shadcn-ui/ui)](https://github.com/shadcn-ui/ui) (re-usable components built with Reka UI and Tailwind CSS).
...
- [@oneflowui/ui ![GitHub Repo Stars](https://img.shields.io/github/stars/qixi54/oneui) ![GitHub last commit](https://img.shields.io/github/last-commit/qixi54/oneui)](https://github.com/qixi54/oneui) - Vue 3 + TypeScript component library for task management views, featuring Table, Kanban, Gantt timeline, Gallery, AI Chat, Dashboard charts, Rich Text Editor, MermaidChart and more. 75+ components out of the box.
- [Nuxt UI ![GitHub Repo Stars](https://img.shields.io/github/stars/nuxt/ui) ![GitHub last commit](https://img.shields.io/github/last-commit/nuxt/ui)](https://github.com/nuxt/ui) - 125+ accessible and customizable components for Vue and Nuxt, built with Tailwind CSS and Reka UI.
...
- [virtual-scroll ![GitHub Repo Stars](https://img.shields.io/github/stars/pdanpdan/virtual-scroll) ![GitHub last commit](https://img.shields.io/github/last-commit/pdanpdan/virtual-scroll)](https://github.com/pdanpdan/virtual-scroll) - High-performance Vue 3 virtual scroll library designed to handle massive lists with ease. Supports vertical, horizontal, and bidirectional (grid) scrolling, dynamic item sizes using ResizeObserver, full support for Right-to-Left (RTL) layouts, build in a11y.
...
- [@ioi-dev/vue-table ![GitHub Repo Stars](https://img.shields.io/github/stars/Rawand-Hawez/ioi-vue-table) ![GitHub last commit](https://img.shields.io/github/last-commit/Rawand-Hawez/ioi-vue-table)](https://github.com/Rawand-Hawez/ioi-vue-table) - Performance-first Vue 3 datatable with virtualization, selection, editing, and CSV export.
...
- [markdown-design ![GitHub Repo Stars](https://img.shields.io/github/stars/ZeroOneJs/markdown-design) ![GitHub last commit](https://img.shields.io/github/last-commit/ZeroOneJs/markdown-design)](https://github.com/ZeroOneJs/markdown-design) - An out-of-the-box Vue 3 Markdown component with real-time rendering, featuring TOC generation, full-text search, and more.
...
- [vue-smooth-picker ![GitHub Repo Stars](https://img.shields.io/github/stars/hiyali/vue-smooth-picker) ![GitHub last commit](https://img.shields.io/github/last-commit/hiyali/vue-smooth-picker)](https://github.com/hiyali/vue-smooth-picker) - A SmoothPicker for Vue 3 (like native datetime picker of iOS)
...
- [hevue-img-preview ![GitHub Repo Stars](https://img.shields.io/github/stars/heyongsheng/hevue-img-preview) ![GitHub last commit](https://img.shields.io/github/last-commit/heyongsheng/hevue-img-preview)](https://github.com/heyongsheng/hevue-img-preview) - Image preview for Vue 2 & 3, supports mobile and desktop. [(demo)](https://heyongsheng.github.io/en/guide/profile.html)
...
- [vue3-websocket ![GitHub Repo Stars](https://img.shields.io/github/stars/muzychenka/vue3-websocket) ![GitHub last commit](https://img.shields.io/github/last-commit/muzychenka/vue3-websocket)](https://github.com/muzychenka/vue3-websocket) - Validate incoming WebSocket data with Zod.
...
- [@erlihs/pinia-plugin-storage ![GitHub Repo Stars](https://img.shields.io/github/stars/erlihs/pinia-plugin-storage) ![GitHub last commit](https://img.shields.io/github/last-commit/erlihs/pinia-plugin-storage)](https://github.com/erlihs/pinia-plugin-storage) - A comprehensive state persistence and synchronization, yet as simple as it can be.
...
- [vuefire ![GitHub Repo Stars](https://img.shields.io/github/stars/vuejs/vuefire) ![GitHub last commit](https://img.shields.io/github/last-commit/vuejs/vuefire)](https://github.com/vuejs/vuefire) - Official Firebase bindings for Vue.js
...
- [Roundtable ![GitHub Repo Stars](https://img.shields.io/github/stars/askbudi/roundtable) ![GitHub last commit](https://img.shields.io/github/last-commit/askbudi/roundtable)](https://github.com/askbudi/roundtable) - Zero-configuration MCP server that unifies multiple AI assistants (Claude Code, Cursor, GPT-4, etc.) into a single development workflow for Vue.js projects.
...
- [vue-enterprise-boilerplate ![GitHub Repo Stars](https://img.shields.io/github/stars/bencodezen/vue-enterprise-boilerplate) ![GitHub last commit](https://img.shields.io/github/last-commit/bencodezen/vue-enterprise-boilerplate)](https://github.com/bencodezen/vue-enterprise-boilerplate) - An ever-evolving, very opinionated architecture and dev environment for new Vue SPA projects using Vue CLI 3.
