...
- [Maxim Web Chat ![GitHub Repo Stars](https://img.shields.io/github/stars/maxim-top/maxim-web) ![GitHub last commit](https://img.shields.io/github/last-commit/maxim-top/maxim-web)](https://github.com/maxim-top/maxim-web) - A chat demo using [MaximTop](https://www.maximtop.com)'s IM SDK (floo), 使用美信拓扑 IM SDK ��现的聊天 App 示例.
