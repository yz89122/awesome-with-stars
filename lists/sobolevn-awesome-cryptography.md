...
- [micro-rsa-dsa-dh ![GitHub Repo Stars](https://img.shields.io/github/stars/paulmillr/micro-rsa-dsa-dh) ![GitHub last commit](https://img.shields.io/github/last-commit/paulmillr/micro-rsa-dsa-dh)](https://github.com/paulmillr/micro-rsa-dsa-dh) - Minimal implementation of older cryptography algorithms: RSA, DSA, DH, ElGamal.
...
- noble - high-security, easily auditable set of contained cryptographic libraries and tools. Zero dependencies each.
  ...
  - [noble-hashes ![GitHub Repo Stars](https://img.shields.io/github/stars/paulmillr/noble-hashes) ![GitHub last commit](https://img.shields.io/github/last-commit/paulmillr/noble-hashes)](https://github.com/paulmillr/noble-hashes) — SHA2, SHA3, RIPEMD, BLAKE2/3, HMAC, HKDF, PBKDF2, Scrypt & Argon2id
  - [noble-post-quantum ![GitHub Repo Stars](https://img.shields.io/github/stars/paulmillr/noble-post-quantum) ![GitHub last commit](https://img.shields.io/github/last-commit/paulmillr/noble-post-quantum)](https://github.com/paulmillr/noble-post-quantum) — ML-KEM, ML-DSA, SLH-DSA (CRYSTALS-Kyber, CRYSTALS-Dilithium, Sphincs+) and hybrids
