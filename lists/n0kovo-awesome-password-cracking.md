...
- [SePass: Semantic Password Guessing using k-nn Similarity Search in Word Embeddings ![GitHub Repo Stars](https://img.shields.io/github/stars/Knuust/SePass) ![GitHub last commit](https://img.shields.io/github/last-commit/Knuust/SePass)](https://github.com/Knuust/SePass) - A password guessing method that utilizes word embeddings to discover and exploit semantic correlations in password lists.
