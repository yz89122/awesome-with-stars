...
- [gatling-kafka-extension ![GitHub Repo Stars](https://img.shields.io/github/stars/kbdering/GatlingMessaging) ![GitHub last commit](https://img.shields.io/github/last-commit/kbdering/GatlingMessaging)](https://github.com/kbdering/GatlingMessaging) - A Gatling extension for load testing Kafka applications, with a focus on Request-Reply (RPC) patterns, Quality of Service (QoS) measurement, and resilience testing.
