...
See also [awesome-nlp ![GitHub Repo Stars](https://img.shields.io/github/stars/keon/awesome-nlp) ![GitHub last commit](https://img.shields.io/github/last-commit/keon/awesome-nlp)](https://github.com/keon/awesome-nlp), [awesome-biology ![GitHub Repo Stars](https://img.shields.io/github/stars/raivivek/awesome-biology) ![GitHub last commit](https://img.shields.io/github/last-commit/raivivek/awesome-biology)](https://github.com/raivivek/awesome-biology) and [Awesome-Bioinformatics ![GitHub Repo Stars](https://img.shields.io/github/stars/danielecook/Awesome-Bioinformatics) ![GitHub last commit](https://img.shields.io/github/last-commit/danielecook/Awesome-Bioinformatics)](https://github.com/danielecook/Awesome-Bioinformatics).

_Please read the [contribution guidelines](contributing.md) before contributing. Please add your favourite resource by raising a [pull request ![GitHub Repo Stars](https://img.shields.io/github/stars/caufieldjh/awesome-bioie) ![GitHub last commit](https://img.shields.io/github/last-commit/caufieldjh/awesome-bioie)](https://github.com/caufieldjh/awesome-bioie/pulls)._
...
* [Biopython](https://biopython.org/) - [paper](http://dx.doi.org/10.1093/bioinformatics/btp163) - [code ![GitHub Repo Stars](https://img.shields.io/github/stars/biopython/biopython) ![GitHub last commit](https://img.shields.io/github/last-commit/biopython/biopython)](https://github.com/biopython/biopython) - Python tools primarily intended for bioinformatics and computational molecular biology purposes, but also a convenient way to obtain data, including documents/abstracts from PubMed (see Chapter 9 of the documentation).
* [Bio-SCoRes ![GitHub Repo Stars](https://img.shields.io/github/stars/kilicogluh/Bio-SCoRes) ![GitHub last commit](https://img.shields.io/github/last-commit/kilicogluh/Bio-SCoRes)](https://github.com/kilicogluh/Bio-SCoRes) - [paper](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0148538) - A framework for biomedical coreference resolution.
* [medaCy ![GitHub Repo Stars](https://img.shields.io/github/stars/NLPatVCU/medaCy) ![GitHub last commit](https://img.shields.io/github/last-commit/NLPatVCU/medaCy)](https://github.com/NLPatVCU/medaCy) - A system for building predictive medical natural language processing models. Built on the [spaCy](https://spacy.io/) framework. 
* [ScispaCy ![GitHub Repo Stars](https://img.shields.io/github/stars/allenai/SciSpaCy) ![GitHub last commit](https://img.shields.io/github/last-commit/allenai/SciSpaCy)](https://github.com/allenai/SciSpaCy) - [paper](https://arxiv.org/abs/1902.07669) - A version of the [spaCy](https://spacy.io/) framework for scientific and biomedical documents.
* [rentrez ![GitHub Repo Stars](https://img.shields.io/github/stars/ropensci/rentrez) ![GitHub last commit](https://img.shields.io/github/last-commit/ropensci/rentrez)](https://github.com/ropensci/rentrez) - R utilities for accessing NCBI resources, including PubMed.
* [Med7](https://medium.com/@kormilitzin/med7-clinical-information-extraction-system-in-python-and-spacy-5e6f68ab1c68) - [paper](https://arxiv.org/abs/2003.01271) - [code ![GitHub Repo Stars](https://img.shields.io/github/stars/kormilitzin/med7) ![GitHub last commit](https://img.shields.io/github/last-commit/kormilitzin/med7)](https://github.com/kormilitzin/med7) - a Python package and model (for use with spaCy) for doing NER with medication-related concepts.

### Repos for Specific Datasets

* [mimic-code ![GitHub Repo Stars](https://img.shields.io/github/stars/MIT-LCP/mimic-code) ![GitHub last commit](https://img.shields.io/github/last-commit/MIT-LCP/mimic-code)](https://github.com/MIT-LCP/mimic-code) - Code associated with the MIMIC-III dataset (see below). Includes some helpful [tutorials ![GitHub Repo Stars](https://img.shields.io/github/stars/MIT-LCP/mimic-code) ![GitHub last commit](https://img.shields.io/github/last-commit/MIT-LCP/mimic-code)](https://github.com/MIT-LCP/mimic-code/tree/master/tutorials).

[Back to Top](#contents)

## Tools, Platforms, and Services

* [cTAKES](https://ctakes.apache.org/) - [paper](https://academic.oup.com/jamia/article/17/5/507/830823) - [code ![GitHub Repo Stars](https://img.shields.io/github/stars/apache/ctakes) ![GitHub last commit](https://img.shields.io/github/last-commit/apache/ctakes)](https://github.com/apache/ctakes) - A system for processing the text in electronic medical records. Widely used and open source. 
...
* [DeepPhe ![GitHub Repo Stars](https://img.shields.io/github/stars/DeepPhe/DeepPhe-Release) ![GitHub last commit](https://img.shields.io/github/last-commit/DeepPhe/DeepPhe-Release)](https://github.com/DeepPhe/DeepPhe-Release) - A system for processing documents describing cancer presentations. Based on cTAKES (see above).
...
* [II-Commons ![GitHub Repo Stars](https://img.shields.io/github/stars/Intelligent-Internet/II-Commons-Skills) ![GitHub last commit](https://img.shields.io/github/last-commit/Intelligent-Internet/II-Commons-Skills)](https://github.com/Intelligent-Internet/II-Commons-Skills) - A Node.js CLI and agent skill for deterministic, daily-updated retrieval across PubMed/PMC, arXiv, and supported US policy corpora, with metadata lookup and full-document Markdown retrieval.
...
* [Pubrunner ![GitHub Repo Stars](https://img.shields.io/github/stars/jakelever/pubrunner) ![GitHub last commit](https://img.shields.io/github/last-commit/jakelever/pubrunner)](https://github.com/jakelever/pubrunner) - A framework for running text mining tools on the newest set(s) of documents from PubMed.
* [SemEHR ![GitHub Repo Stars](https://img.shields.io/github/stars/CogStack/CogStack-SemEHR) ![GitHub last commit](https://img.shields.io/github/last-commit/CogStack/CogStack-SemEHR)](https://github.com/CogStack/CogStack-SemEHR) - [paper](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6019046/) - an IE infrastructure for electronic health records (EHR). Built on the [CogStack project](https://github.com/CogStack).
...
* [TabInOut ![GitHub Repo Stars](https://img.shields.io/github/stars/nikolamilosevic86/TabInOut) ![GitHub last commit](https://img.shields.io/github/last-commit/nikolamilosevic86/TabInOut)](https://github.com/nikolamilosevic86/TabInOut) - [paper](https://link.springer.com/article/10.1007/s10032-019-00317-0) - a framework for IE from tables in the literature.

### Annotation Tools

* [Anafora ![GitHub Repo Stars](https://img.shields.io/github/stars/weitechen/anafora) ![GitHub last commit](https://img.shields.io/github/last-commit/weitechen/anafora)](https://github.com/weitechen/anafora) - [paper](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5657237/) - An annotation tool with adjudication and progress tracking features.
* [brat](https://brat.nlplab.org/) - [paper](https://www.aclweb.org/anthology/E12-2021/) - [code ![GitHub Repo Stars](https://img.shields.io/github/stars/nlplab/brat) ![GitHub last commit](https://img.shields.io/github/last-commit/nlplab/brat)](https://github.com/nlplab/brat) - The brat rapid annotation tool. Supports producing text annotations visually, through the browser. Not subject specific; appropriate for many annotation projects. Visualization is based on that of the [_stav_ tool ![GitHub Repo Stars](https://img.shields.io/github/stars/nlplab/stav) ![GitHub last commit](https://img.shields.io/github/last-commit/nlplab/stav)](https://github.com/nlplab/stav/).
* [MedTator](https://ohnlp.github.io/MedTator/) - [paper](https://academic.oup.com/bioinformatics/article-abstract/38/6/1776/6496915) - [code ![GitHub Repo Stars](https://img.shields.io/github/stars/OHNLP/MedTator) ![GitHub last commit](https://img.shields.io/github/last-commit/OHNLP/MedTator)](https://github.com/OHNLP/MedTator) - An annotation tool designed to have minimal dependencies.
...
### BERT models
* [BioBERT ![GitHub Repo Stars](https://img.shields.io/github/stars/naver/biobert-pretrained) ![GitHub last commit](https://img.shields.io/github/last-commit/naver/biobert-pretrained)](https://github.com/naver/biobert-pretrained) - [paper](https://arxiv.org/abs/1901.08746) - [code ![GitHub Repo Stars](https://img.shields.io/github/stars/dmis-lab/biobert) ![GitHub last commit](https://img.shields.io/github/last-commit/dmis-lab/biobert)](https://github.com/dmis-lab/biobert) - A PubMed and PubMed Central-trained version of the [BERT language model](https://arxiv.org/abs/1810.04805).
* ClinicalBERT - Two language models trained on clinical text have similar names. Both are BERT models trained on the text of clinical notes from the MIMIC-III dataset.
  * [Alsentzer et al Clinical BERT ![GitHub Repo Stars](https://img.shields.io/github/stars/EmilyAlsentzer/clinicalBERT) ![GitHub last commit](https://img.shields.io/github/last-commit/EmilyAlsentzer/clinicalBERT)](https://github.com/EmilyAlsentzer/clinicalBERT) - [paper](https://www.aclweb.org/anthology/W19-1909/)
  * [Huang et al ClinicalBERT ![GitHub Repo Stars](https://img.shields.io/github/stars/kexinhuang12345/clinicalBERT) ![GitHub last commit](https://img.shields.io/github/last-commit/kexinhuang12345/clinicalBERT)](https://github.com/kexinhuang12345/clinicalBERT) - [paper](https://arxiv.org/abs/1904.05342)
* [SciBERT ![GitHub Repo Stars](https://img.shields.io/github/stars/allenai/scibert) ![GitHub last commit](https://img.shields.io/github/last-commit/allenai/scibert)](https://github.com/allenai/scibert) - [paper](https://arxiv.org/abs/1903.10676) - A BERT model trained on >1M papers from the Semantic Scholar database.
* [BlueBERT ![GitHub Repo Stars](https://img.shields.io/github/stars/ncbi-nlp/bluebert) ![GitHub last commit](https://img.shields.io/github/last-commit/ncbi-nlp/bluebert)](https://github.com/ncbi-nlp/bluebert) - [paper](https://arxiv.org/abs/1906.05474) - A BERT model pre-trained on PubMed text and MIMIC-III notes.
...
### GPT-2 models
* [BioGPT ![GitHub Repo Stars](https://img.shields.io/github/stars/microsoft/BioGPT) ![GitHub last commit](https://img.shields.io/github/last-commit/microsoft/BioGPT)](https://github.com/microsoft/BioGPT) - [paper](https://doi.org/10.1093/bib/bbac409) - A GPT-2 model pre-trained on 15 million PubMed abstracts, along with fine-tuned versions for several biomedical tasks.

### Other models
* [Flair embeddings from PubMed ![GitHub Repo Stars](https://img.shields.io/github/stars/zalandoresearch/flair) ![GitHub last commit](https://img.shields.io/github/last-commit/zalandoresearch/flair)](https://github.com/zalandoresearch/flair/pull/519) - A language model available through the Flair framework and embedding method. Trained over a 5% sample of PubMed abstracts until 2015, or > 1.2 million abstracts in total.
...
* [BioWordVec](https://figshare.com/articles/Improving_Biomedical_Word_Embeddings_with_Subword_Information_and_MeSH_Ontology/6882647) - [paper](https://www.nature.com/articles/s41597-019-0055-0) - [code ![GitHub Repo Stars](https://img.shields.io/github/stars/ncbi-nlp/BioWordVec) ![GitHub last commit](https://img.shields.io/github/last-commit/ncbi-nlp/BioWordVec)](https://github.com/ncbi-nlp/BioWordVec) - Word embeddings derived from biomedical text (>27 million PubMed titles and abstracts), including subword embedding model based on MeSH.
...
* [CORD-19 ![GitHub Repo Stars](https://img.shields.io/github/stars/allenai/cord19) ![GitHub last commit](https://img.shields.io/github/last-commit/allenai/cord19)](https://github.com/allenai/cord19) - A corpus of scholarly manuscripts concerning COVID-19. Articles are primarily from PubMed Central and preprint servers, though the set also includes metadata on papers without full-text availability.
...
* [CRAFT ![GitHub Repo Stars](https://img.shields.io/github/stars/UCDenver-ccp/CRAFT) ![GitHub last commit](https://img.shields.io/github/last-commit/UCDenver-ccp/CRAFT)](https://github.com/UCDenver-ccp/CRAFT) - [paper](https://link.springer.com/chapter/10.1007/978-94-024-0881-2_53) - 67 full-text biomedical articles annotated in a variety of ways, including for concepts and coreferences. Now on version 5, including annotations linking concepts to the MONDO disease ontology.
...
* [Disease Ontology](http://www.disease-ontology.org/) - [paper](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4383880/) - An ontology of human diseases. Has cross-links to MeSH, ICD, NCI Thesaurus, SNOMED, and OMIM. Public domain. Available on [GitHub ![GitHub Repo Stars](https://img.shields.io/github/stars/DiseaseOntology/HumanDiseaseOntology) ![GitHub last commit](https://img.shields.io/github/last-commit/DiseaseOntology/HumanDiseaseOntology)](https://github.com/DiseaseOntology/HumanDiseaseOntology) and on the [OBO Foundry](http://www.obofoundry.org/ontology/doid.html).
...
* [Biolink](https://biolink.github.io/biolink-model/) - [code ![GitHub Repo Stars](https://img.shields.io/github/stars/biolink/biolink-model) ![GitHub last commit](https://img.shields.io/github/last-commit/biolink/biolink-model)](https://github.com/biolink/biolink-model) - A data model of biological entities. Provided as a [YAML](https://yaml.org/) file.
...
* [OMOP Common Data Model ![GitHub Repo Stars](https://img.shields.io/github/stars/OHDSI/CommonDataModel) ![GitHub last commit](https://img.shields.io/github/last-commit/OHDSI/CommonDataModel)](https://github.com/OHDSI/CommonDataModel) - a standard for observational healthcare data.
* [unmiri-ngs-fhir-schema ![GitHub Repo Stars](https://img.shields.io/github/stars/unmirihealth/unmiri-ngs-fhir-schema) ![GitHub last commit](https://img.shields.io/github/last-commit/unmirihealth/unmiri-ngs-fhir-schema)](https://github.com/unmirihealth/unmiri-ngs-fhir-schema) - Apache-2.0 JSON Schema (Draft 2020-12) API contract for cross-vendor somatic NGS interpretation output (Foundation Medicine, Tempus, Caris, Guardant), aligned with the HL7 FHIR Genomics IG. A standards-aligned target representation for biomedical information-extraction pipelines that parse oncology lab reports.
