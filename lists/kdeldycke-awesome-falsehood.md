...
- [Awesome Unicode ![GitHub Repo Stars](https://img.shields.io/github/stars/jagracey/Awesome-Unicode) ![GitHub last commit](https://img.shields.io/github/last-commit/jagracey/Awesome-Unicode)](https://github.com/jagracey/Awesome-Unicode) - A curated list of delightful Unicode tidbits, packages and resources.
...
- [`libaddressinput` ![GitHub Repo Stars](https://img.shields.io/github/stars/google/libaddressinput) ![GitHub last commit](https://img.shields.io/github/last-commit/google/libaddressinput)](https://github.com/google/libaddressinput) - 🆓 Google's common C++ and Java library for parsing, formatting, and validating international postal addresses.
