...
- [Vibe-Trading ![GitHub Repo Stars](https://img.shields.io/github/stars/HKUDS/Vibe-Trading) ![GitHub last commit](https://img.shields.io/github/last-commit/HKUDS/Vibe-Trading)](https://github.com/HKUDS/Vibe-Trading) - Multi-agent finance research workspace for strategy generation, backtests, portfolio analysis, and research insights.
- [TraceArena ![GitHub Repo Stars](https://img.shields.io/github/stars/tonyhyworld/TraceArena) ![GitHub last commit](https://img.shields.io/github/last-commit/tonyhyworld/TraceArena)](https://github.com/tonyhyworld/TraceArena) - Open-source runtime for auditable multi-agent investment evaluation with evidence-linked actions, deterministic simulated settlement, and reproducible replay; no brokerage connection.
...
- [oracle3 ![GitHub Repo Stars](https://img.shields.io/github/stars/YichengYang-Ethan/oracle3) ![GitHub last commit](https://img.shields.io/github/last-commit/YichengYang-Ethan/oracle3)](https://github.com/YichengYang-Ethan/oracle3) - Prediction-market trading agent for Kalshi, Polymarket, and Solana DFlow, with Wang Transform pricing and arbitrage strategies.
- [stock-analysis ![GitHub Repo Stars](https://img.shields.io/github/stars/AdvancingTitans/stock-analysis) ![GitHub last commit](https://img.shields.io/github/last-commit/AdvancingTitans/stock-analysis)](https://github.com/AdvancingTitans/stock-analysis) - Evidence-driven market recap CLI for AI agents, producing Markdown reports and JSON Evidence Packs for A/HK/US stocks, funds, and portfolios.
...
- [atilaahmettaner/tradingview-mcp ![GitHub Repo Stars](https://img.shields.io/github/stars/atilaahmettaner/tradingview-mcp) ![GitHub last commit](https://img.shields.io/github/last-commit/atilaahmettaner/tradingview-mcp)](https://github.com/atilaahmettaner/tradingview-mcp) - 30+ tools for real-time TradingView market data, technical analysis, screeners, and backtesting across stocks, crypto, forex, and futures.
- [dgunning/edgartools ![GitHub Repo Stars](https://img.shields.io/github/stars/dgunning/edgartools) ![GitHub last commit](https://img.shields.io/github/last-commit/dgunning/edgartools)](https://github.com/dgunning/edgartools) - 11 MCP tools for SEC EDGAR — every filing type (10-K, 10-Q, 8-K, S-1), no API key required; 1,800+ Smithery installs.
- [financial-datasets/mcp-server ![GitHub Repo Stars](https://img.shields.io/github/stars/financial-datasets/mcp-server) ![GitHub last commit](https://img.shields.io/github/last-commit/financial-datasets/mcp-server)](https://github.com/financial-datasets/mcp-server) - Structured access to income statements, balance sheets, cash flows, stock prices, and market news via the Financial Datasets API.
- [guangxiangdebizi/FinanceMCP ![GitHub Repo Stars](https://img.shields.io/github/stars/guangxiangdebizi/FinanceMCP) ![GitHub last commit](https://img.shields.io/github/last-commit/guangxiangdebizi/FinanceMCP)](https://github.com/guangxiangdebizi/FinanceMCP) - Integrates Tushare (Chinese A-shares, funds, bonds, macro) and Binance (crypto) for LLM financial data access.
- [TickDB/tickdb-unified-realtime-marketdata-api ![GitHub Repo Stars](https://img.shields.io/github/stars/TickDB/tickdb-unified-realtime-marketdata-api) ![GitHub last commit](https://img.shields.io/github/last-commit/TickDB/tickdb-unified-realtime-marketdata-api)](https://github.com/TickDB/tickdb-unified-realtime-marketdata-api) - 13-tool unified real-time and historical market data across Forex, US/HK/CN stocks, and crypto.
- [massive-com/mcp_massive ![GitHub Repo Stars](https://img.shields.io/github/stars/massive-com/mcp_massive) ![GitHub last commit](https://img.shields.io/github/last-commit/massive-com/mcp_massive)](https://github.com/massive-com/mcp_massive) - Polygon.io professional-grade real-time and historical data for stocks, forex, crypto, and options.
- [Alex2Yang97/yahoo-finance-mcp ![GitHub Repo Stars](https://img.shields.io/github/stars/Alex2Yang97/yahoo-finance-mcp) ![GitHub last commit](https://img.shields.io/github/last-commit/Alex2Yang97/yahoo-finance-mcp)](https://github.com/Alex2Yang97/yahoo-finance-mcp) - Yahoo Finance MCP: stock quotes, financials, options chains, and market news.
- [zwldarren/akshare-one-mcp ![GitHub Repo Stars](https://img.shields.io/github/stars/zwldarren/akshare-one-mcp) ![GitHub last commit](https://img.shields.io/github/last-commit/zwldarren/akshare-one-mcp)](https://github.com/zwldarren/akshare-one-mcp) - AKShare API for Chinese stock market: historical prices, real-time quotes, financial reports, and news.
- [alphavantage/alpha_vantage_mcp ![GitHub Repo Stars](https://img.shields.io/github/stars/alphavantage/alpha_vantage_mcp) ![GitHub last commit](https://img.shields.io/github/last-commit/alphavantage/alpha_vantage_mcp)](https://github.com/alphavantage/alpha_vantage_mcp) - **Official** Alpha Vantage MCP server: real-time and historical data for stocks, forex, crypto, options, and ETFs.
...
- [alpacahq/alpaca-mcp-server ![GitHub Repo Stars](https://img.shields.io/github/stars/alpacahq/alpaca-mcp-server) ![GitHub last commit](https://img.shields.io/github/last-commit/alpacahq/alpaca-mcp-server)](https://github.com/alpacahq/alpaca-mcp-server) - **Official** Alpaca MCP server: natural-language trading of US stocks, ETFs, options, and crypto.
- [krakenfx/kraken-cli ![GitHub Repo Stars](https://img.shields.io/github/stars/krakenfx/kraken-cli) ![GitHub last commit](https://img.shields.io/github/last-commit/krakenfx/kraken-cli)](https://github.com/krakenfx/kraken-cli) - **Official** Kraken AI-native CLI with built-in MCP support for spot trading, portfolio management, and market data.
- [ariadng/metatrader-mcp-server ![GitHub Repo Stars](https://img.shields.io/github/stars/ariadng/metatrader-mcp-server) ![GitHub last commit](https://img.shields.io/github/last-commit/ariadng/metatrader-mcp-server)](https://github.com/ariadng/metatrader-mcp-server) - MCP bridge to MetaTrader 5 for natural-language trade execution and live position tracking across forex and futures.
- [mcpdotdirect/evm-mcp-server ![GitHub Repo Stars](https://img.shields.io/github/stars/mcpdotdirect/evm-mcp-server) ![GitHub last commit](https://img.shields.io/github/last-commit/mcpdotdirect/evm-mcp-server)](https://github.com/mcpdotdirect/evm-mcp-server) - 22-tool MCP server for 60+ EVM-compatible networks: token balances, smart contracts, and DeFi operations.
- [okx/agent-trade-kit ![GitHub Repo Stars](https://img.shields.io/github/stars/okx/agent-trade-kit) ![GitHub last commit](https://img.shields.io/github/last-commit/okx/agent-trade-kit)](https://github.com/okx/agent-trade-kit) - **Official** OKX MCP server: AI agent trading of spot, perpetuals, and futures with full order management.
- [rcontesti/IB_MCP ![GitHub Repo Stars](https://img.shields.io/github/stars/rcontesti/IB_MCP) ![GitHub last commit](https://img.shields.io/github/last-commit/rcontesti/IB_MCP)](https://github.com/rcontesti/IB_MCP) - Interactive Brokers TWS/Gateway MCP server for live trading and market access across 150 markets.
- [QuantConnect/mcp-server ![GitHub Repo Stars](https://img.shields.io/github/stars/QuantConnect/mcp-server) ![GitHub last commit](https://img.shields.io/github/last-commit/QuantConnect/mcp-server)](https://github.com/QuantConnect/mcp-server) - **Official** QuantConnect MCP server: write Python trading strategies, run cloud backtests, and deploy live algorithms.
- [koreainvestment/open-trading-api ![GitHub Repo Stars](https://img.shields.io/github/stars/koreainvestment/open-trading-api) ![GitHub last commit](https://img.shields.io/github/last-commit/koreainvestment/open-trading-api)](https://github.com/koreainvestment/open-trading-api) - **Official** Korea Investment & Securities Open API with MCP and LLM integration for Korean equity market trading.
...
- [The Automation Ahead ![GitHub Repo Stars](https://img.shields.io/github/stars/CFA-Institute-RPC/The-Automation-Ahead) ![GitHub last commit](https://img.shields.io/github/last-commit/CFA-Institute-RPC/The-Automation-Ahead)](https://github.com/CFA-Institute-RPC/The-Automation-Ahead) - CFA Institute examples for GenAI-driven investment workflows.
...
- [ml-quant-trading ![GitHub Repo Stars](https://img.shields.io/github/stars/initial-d/ml-quant-trading) ![GitHub last commit](https://img.shields.io/github/last-commit/initial-d/ml-quant-trading)](https://github.com/initial-d/ml-quant-trading) - PyTorch research stack for mask-aware multi-factor modeling, ML baselines, portfolio optimization, and vectorized backtesting.
...
- [FinanceKit MCP ![GitHub Repo Stars](https://img.shields.io/github/stars/vdalhambra/financekit-mcp) ![GitHub last commit](https://img.shields.io/github/last-commit/vdalhambra/financekit-mcp)](https://github.com/vdalhambra/financekit-mcp) - MCP server for stock quotes, technical analysis, crypto data, risk metrics, and portfolio analysis. No API keys for core data.
