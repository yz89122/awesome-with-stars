...
- [Danku ![GitHub Repo Stars](https://img.shields.io/github/stars/algorithmiaio/danku) ![GitHub last commit](https://img.shields.io/github/last-commit/algorithmiaio/danku)](https://github.com/algorithmiaio/danku) - A blockchain-based protocol for evaluating and purchasing ML models on a public blockchain such as Ethereum. [Blog post.](https://algorithmia.com/research/ml-models-on-blockchain)
- [Decentralized & Collaborative AI on Blockchain ![GitHub Repo Stars](https://img.shields.io/github/stars/microsoft/0xDeCA10B) ![GitHub last commit](https://img.shields.io/github/last-commit/microsoft/0xDeCA10B)](https://github.com/microsoft/0xDeCA10B) - 0xDeCA10B is a framework to host and train publicly available machine learning models in smart contracts with incentive mechanisms to encourage good quality training data while keeping the models free to use for prediction. [Blog post.](https://www.microsoft.com/en-us/research/blog/leveraging-blockchain-to-make-machine-learning-models-more-accessible/)
