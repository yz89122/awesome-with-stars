...
- [Plethora](https://plethora.madefor.cc) -  A mod which adds peripherals and allows many blocks to be accessed as such. In addition, it also allows for manipulation of the player as a peripheral.
    - [Plethora Fabric ![GitHub Repo Stars](https://img.shields.io/github/stars/SwitchCraftCC/Plethora-Fabric) ![GitHub last commit](https://img.shields.io/github/last-commit/SwitchCraftCC/Plethora-Fabric)](https://github.com/SwitchCraftCC/Plethora-Fabric) - A 1.19+ port of Plethora to Fabric.
...
- [sc-peripherals ![GitHub Repo Stars](https://img.shields.io/github/stars/SwitchCraftCC/sc-peripherals) ![GitHub last commit](https://img.shields.io/github/last-commit/SwitchCraftCC/sc-peripherals)](https://github.com/SwitchCraftCC/sc-peripherals) - A mod that adds 3D printers which allow creating custom blocks and posters.
...
- [PngLua ![GitHub Repo Stars](https://img.shields.io/github/stars/9551-Dev/pngLua) ![GitHub last commit](https://img.shields.io/github/last-commit/9551-Dev/pngLua)](https://github.com/9551-Dev/pngLua) - PNG parsing library designed for ComputerCraft.
...
- [CCDoom ![GitHub Repo Stars](https://img.shields.io/github/stars/Xella37/CCDoom) ![GitHub last commit](https://img.shields.io/github/last-commit/Xella37/CCDoom)](https://github.com/Xella37/CCDoom) - The [_Doom_ shooter](<https://en.wikipedia.org/wiki/Doom_(1993_video_game)>) ported to ComputerCraft using Pine3D.
- [CC-Minecraft ![GitHub Repo Stars](https://img.shields.io/github/stars/Xella37/CC-Minecraft) ![GitHub last commit](https://img.shields.io/github/last-commit/Xella37/CC-Minecraft)](https://github.com/Xella37/CC-Minecraft) - _Minecraft_ ported to ComputerCraft using Pine3D.
...
- [Artist ![GitHub Repo Stars](https://img.shields.io/github/stars/SquidDev-CC/artist) ![GitHub last commit](https://img.shields.io/github/last-commit/SquidDev-CC/artist)](https://github.com/SquidDev-CC/artist) - A Rather Tremendous Item SysTem
- [hopper.lua ![GitHub Repo Stars](https://img.shields.io/github/stars/umnikos/hopper.lua) ![GitHub last commit](https://img.shields.io/github/last-commit/umnikos/hopper.lua)](https://github.com/umnikos/hopper.lua) - Command line interface to move items between containers.
- [MISC ![GitHub Repo Stars](https://img.shields.io/github/stars/MasonGulu/CC-MISC) ![GitHub last commit](https://img.shields.io/github/last-commit/MasonGulu/CC-MISC)](https://github.com/MasonGulu/CC-MISC) - Modular Inventory Storage and Crafting
- [Milo ![GitHub Repo Stars](https://img.shields.io/github/stars/kepler155c/opus-apps) ![GitHub last commit](https://img.shields.io/github/last-commit/kepler155c/opus-apps)](https://github.com/kepler155c/opus-apps/tree/develop-1.8/milo) - A general-purpose AE2-style storage system, for use within Opus OS.
...
- [Radon ![GitHub Repo Stars](https://img.shields.io/github/stars/Allymonies/Radon) ![GitHub last commit](https://img.shields.io/github/last-commit/Allymonies/Radon)](https://github.com/Allymonies/Radon) - Highly-configurable Krist shop, complete with layouts, hooks, and more.
...
- [printshop ![GitHub Repo Stars](https://img.shields.io/github/stars/znepb/printshop) ![GitHub last commit](https://img.shields.io/github/last-commit/znepb/printshop)](https://github.com/znepb/printshop) - A Krist shop which sells 3D prints and posters, also allowing players to print their own designs.
...
- [`cc-mek-scada` ![GitHub Repo Stars](https://img.shields.io/github/stars/MikaylaFischler/cc-mek-scada) ![GitHub last commit](https://img.shields.io/github/last-commit/MikaylaFischler/cc-mek-scada)](https://github.com/MikaylaFischler/cc-mek-scada) - Integral management of a Mekanism factory.
...
- [Plethora Meters ![GitHub Repo Stars](https://img.shields.io/github/stars/Snowcone-Archive/plethora-meters) ![GitHub last commit](https://img.shields.io/github/last-commit/Snowcone-Archive/plethora-meters)](https://github.com/Snowcone-Archive/plethora-meters) - Provides Rainmeter-esque heads-up-display information.
...
- [img2poster ![GitHub Repo Stars](https://img.shields.io/github/stars/PatriikPlays/img2poster) ![GitHub last commit](https://img.shields.io/github/last-commit/PatriikPlays/img2poster)](https://github.com/PatriikPlays/img2poster) - Allows converting from popular image formats to 2dj poster format.
