...
- [PCUI ![GitHub Repo Stars](https://img.shields.io/github/stars/playcanvas/pcui) ![GitHub last commit](https://img.shields.io/github/last-commit/playcanvas/pcui)](https://github.com/playcanvas/pcui) - Open source front-end framework used by the PlayCanvas toolset.
...
- [playcanvas-ar ![GitHub Repo Stars](https://img.shields.io/github/stars/playcanvas/playcanvas-ar) ![GitHub last commit](https://img.shields.io/github/last-commit/playcanvas/playcanvas-ar)](https://github.com/playcanvas/playcanvas-ar) - Marker-based AR solution built on ARToolkit.
...
- [playcanvas-opti-pixel ![GitHub Repo Stars](https://img.shields.io/github/stars/AlexAPPi/playcanvas-opti-pixel) ![GitHub last commit](https://img.shields.io/github/last-commit/AlexAPPi/playcanvas-opti-pixel)](https://github.com/AlexAPPi/playcanvas-opti-pixel) - GPU instancing, LOD, BVH frustum culling, and occlusion culling.
...
- [playcanvas-react-colyseus ![GitHub Repo Stars](https://img.shields.io/github/stars/JonasPfi/PlayCanvasReactColyseus) ![GitHub last commit](https://img.shields.io/github/last-commit/JonasPfi/PlayCanvasReactColyseus)](https://github.com/JonasPfi/PlayCanvasReactColyseus) - Starter template for multiplayer games with React and Colyseus.
...
- [Quake ![GitHub Repo Stars](https://img.shields.io/github/stars/willeastcott/playcanvas-quake) ![GitHub last commit](https://img.shields.io/github/last-commit/willeastcott/playcanvas-quake)](https://github.com/willeastcott/playcanvas-quake) - A port of id Software's Quake to PlayCanvas.
