...
* [WebGL Month ![GitHub Repo Stars](https://img.shields.io/github/stars/lesnitsky/webgl-month) ![GitHub last commit](https://img.shields.io/github/last-commit/lesnitsky/webgl-month)](https://github.com/lesnitsky/webgl-month) – Daily WebGL tutorial for a month.
...
* [WebGL Insights ![GitHub Repo Stars](https://img.shields.io/github/stars/WebGLInsights/WebGLInsights.github.io) ![GitHub last commit](https://img.shields.io/github/last-commit/WebGLInsights/WebGLInsights.github.io)](https://github.com/WebGLInsights/WebGLInsights.github.io/releases/download/v1.0/WebGL.Insights.-.Patrick.Cozzi.pdf) by **Patrick Cozzi** - Presents real-world techniques for intermediate and advanced WebGL developers by assembling contributions from experienced WebGL engine and application developers, GPU vendors, browser developers, researchers, and educators.
...
* [Khronos Github Issue Page ![GitHub Repo Stars](https://img.shields.io/github/stars/KhronosGroup/WebGL) ![GitHub last commit](https://img.shields.io/github/last-commit/KhronosGroup/WebGL)](https://github.com/KhronosGroup/WebGL/issues) - Spec or Conformance related bugs
...
* [GLSLbin](http://glslb.in) - Fragment shader sandbox supporting [glslify ![GitHub Repo Stars](https://img.shields.io/github/stars/glslify/glslify) ![GitHub last commit](https://img.shields.io/github/last-commit/glslify/glslify)](https://github.com/glslify/glslify).
...
* [Google Project ANGLE ![GitHub Repo Stars](https://img.shields.io/github/stars/google/angle) ![GitHub last commit](https://img.shields.io/github/last-commit/google/angle)](https://github.com/google/angle) - Default WebGL backend for both Google Chrome and Mozilla Firefox on Windows platforms.
...
* [WebGL Source Code ![GitHub Repo Stars](https://img.shields.io/github/stars/KhronosGroup/WebGL) ![GitHub last commit](https://img.shields.io/github/last-commit/KhronosGroup/WebGL)](https://github.com/KhronosGroup/WebGL) - Source code to both view and contribute.
...
* [Khronos Dev Tools ![GitHub Repo Stars](https://img.shields.io/github/stars/KhronosGroup/WebGLDeveloperTools) ![GitHub last commit](https://img.shields.io/github/last-commit/KhronosGroup/WebGLDeveloperTools)](https://github.com/KhronosGroup/WebGLDeveloperTools) - Useful WebGL developer tools, intended to be used as an ES6 module.
...
* [GLSL Shader Editor Extension ![GitHub Repo Stars](https://img.shields.io/github/stars/spite/ShaderEditorExtension) ![GitHub last commit](https://img.shields.io/github/last-commit/spite/ShaderEditorExtension)](https://github.com/spite/ShaderEditorExtension) - Chrome DevTools extension to help you edit shaders live in the browser.
...
* [Webgl Insight ![GitHub Repo Stars](https://img.shields.io/github/stars/3Dparallax/insight) ![GitHub last commit](https://img.shields.io/github/last-commit/3Dparallax/insight)](https://github.com/3Dparallax/insight) - Chrome extension WebGL debugging toolkit providing a variety of capabilities.
...
> [More detailed information about the different libraries can be found in the Libraries directory. ![GitHub Repo Stars](https://img.shields.io/github/stars/sjfricke/awesome-webgl) ![GitHub last commit](https://img.shields.io/github/last-commit/sjfricke/awesome-webgl)](https://github.com/sjfricke/awesome-webgl/tree/master/Libraries)

### 2D
* [p2.js ![GitHub Repo Stars](https://img.shields.io/github/stars/schteppe/p2.js) ![GitHub last commit](https://img.shields.io/github/last-commit/schteppe/p2.js)](https://github.com/schteppe/p2.js) - 2D rigid body physics engine written in JavaScript.
...
* [Planck.js ![GitHub Repo Stars](https://img.shields.io/github/stars/shakiba/planck.js) ![GitHub last commit](https://img.shields.io/github/last-commit/shakiba/planck.js)](https://github.com/shakiba/planck.js) - 2D physics engine for cross-platform HTML5 game development.
* [Stage.js ![GitHub Repo Stars](https://img.shields.io/github/stars/shakiba/stage.js) ![GitHub last commit](https://img.shields.io/github/last-commit/shakiba/stage.js)](https://github.com/shakiba/stage.js) - 2D Library for cross-platform HTML5 game development.
...
#### Particles
* [Phenomenon ![GitHub Repo Stars](https://img.shields.io/github/stars/vaneenige/phenomenon) ![GitHub last commit](https://img.shields.io/github/last-commit/vaneenige/phenomenon)](https://github.com/vaneenige/phenomenon) - Very small, low-level WebGL library that provides the essentials to deliver a high performance experience.
...
* [MapMetrics GL ![GitHub Repo Stars](https://img.shields.io/github/stars/MapMetrics/mapmetrics-gl) ![GitHub last commit](https://img.shields.io/github/last-commit/MapMetrics/mapmetrics-gl)](https://github.com/MapMetrics/mapmetrics-gl) - Mapbox GL JS-compatible mapping library with built-in vector tiles, geocoding, routing, and search.
...
### Rendering
* [GLBoost ![GitHub Repo Stars](https://img.shields.io/github/stars/emadurandal/GLBoost) ![GitHub last commit](https://img.shields.io/github/last-commit/emadurandal/GLBoost)](https://github.com/emadurandal/GLBoost) - Rendering library for 3D graphic geeks.
* [GrimoireGL](https://grimoire.gl/) - Bridge between Web engineers and CG engineers.
* [Hilo3d ![GitHub Repo Stars](https://img.shields.io/github/stars/hiloteam/Hilo3d) ![GitHub last commit](https://img.shields.io/github/last-commit/hiloteam/Hilo3d)](https://github.com/hiloteam/Hilo3d) - WebGL rendering engine for 3D games.
...
* [Lightgl.js ![GitHub Repo Stars](https://img.shields.io/github/stars/evanw/lightgl.js) ![GitHub last commit](https://img.shields.io/github/last-commit/evanw/lightgl.js)](https://github.com/evanw/lightgl.js) - Lightweight and explict library to help prototype.
...
* [Pocket.gl ![GitHub Repo Stars](https://img.shields.io/github/stars/gportelli/pocket.gl) ![GitHub last commit](https://img.shields.io/github/last-commit/gportelli/pocket.gl)](https://github.com/gportelli/pocket.gl) - Fully customizable webgl shader sandbox to embed in your pages.
...
* [Turbulenz ![GitHub Repo Stars](https://img.shields.io/github/stars/turbulenz/turbulenz_engine) ![GitHub last commit](https://img.shields.io/github/last-commit/turbulenz/turbulenz_engine)](https://github.com/turbulenz/turbulenz_engine) - Modular 3D and 2D game framework for making HTML5 powered games for browsers, desktops and mobile devices.
...
* [awesome-opengl ![GitHub Repo Stars](https://img.shields.io/github/stars/eug/awesome-opengl) ![GitHub last commit](https://img.shields.io/github/last-commit/eug/awesome-opengl)](https://github.com/eug/awesome-opengl) - Curated list of awesome OpenGL libraries, debuggers and resources. Inspired by awesome-... stuff.
* [awesome-vulkan ![GitHub Repo Stars](https://img.shields.io/github/stars/vinjn/awesome-vulkan) ![GitHub last commit](https://img.shields.io/github/last-commit/vinjn/awesome-vulkan)](https://github.com/vinjn/awesome-vulkan) - Curated list of awesome Vulkan projects and ecosystem.
...
* [glTF ![GitHub Repo Stars](https://img.shields.io/github/stars/KhronosGroup/glTF) ![GitHub last commit](https://img.shields.io/github/last-commit/KhronosGroup/glTF)](https://github.com/KhronosGroup/glTF) - Runtime 3D Asset Delivery designed for the web.
...
## Contributing
Please see [CONTRIBUTING ![GitHub Repo Stars](https://img.shields.io/github/stars/sjfricke/awesome-webgl) ![GitHub last commit](https://img.shields.io/github/last-commit/sjfricke/awesome-webgl)](https://github.com/sjfricke/awesome-webgl/blob/master/CONTRIBUTING.md) for details.

## Testing
Travis CI testing automation thanks to [awesome_bot ![GitHub Repo Stars](https://img.shields.io/github/stars/dkhamsing/awesome_bot) ![GitHub last commit](https://img.shields.io/github/last-commit/dkhamsing/awesome_bot)](https://github.com/dkhamsing/awesome_bot)!
