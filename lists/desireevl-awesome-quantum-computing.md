...
For further resources related to Open Source Quantum Software Projects, please check out qosf's [repo ![GitHub Repo Stars](https://img.shields.io/github/stars/qosf/os_quantum_software) ![GitHub last commit](https://img.shields.io/github/last-commit/qosf/os_quantum_software)](https://github.com/qosf/os_quantum_software).
...
- [Qiskit Tutorials ![GitHub Repo Stars](https://img.shields.io/github/stars/Qiskit/qiskit-tutorial) ![GitHub last commit](https://img.shields.io/github/last-commit/Qiskit/qiskit-tutorial)](https://github.com/Qiskit/qiskit-tutorial) - Jupyter notebooks simply demonstrating how to use Qiskit.
...
- [Quantum Katas ![GitHub Repo Stars](https://img.shields.io/github/stars/Microsoft/QuantumKatas) ![GitHub last commit](https://img.shields.io/github/last-commit/Microsoft/QuantumKatas)](https://github.com/Microsoft/QuantumKatas/) - Programming exercises for learning quantum computing and Q#.
...
- [Blueqat ![GitHub Repo Stars](https://img.shields.io/github/stars/Blueqat/Blueqat) ![GitHub last commit](https://img.shields.io/github/last-commit/Blueqat/Blueqat)](https://github.com/Blueqat/Blueqat) - Software development kit in Python for quantum gate computing.
- [Boulder Opal](https://q-ctrl.com/boulder-opal) - Python toolset for automating and optimizing quantum hardware performance.
- [Cirq ![GitHub Repo Stars](https://img.shields.io/github/stars/quantumlib/Cirq) ![GitHub last commit](https://img.shields.io/github/last-commit/quantumlib/Cirq)](https://github.com/quantumlib/Cirq) - Python library for writing, manipulating, and optimizing NISQ circuits to run on quantum computers.
- [Covalent ![GitHub Repo Stars](https://img.shields.io/github/stars/AgnostiqHQ/covalent) ![GitHub last commit](https://img.shields.io/github/last-commit/AgnostiqHQ/covalent)](https://github.com/AgnostiqHQ/covalent) - Framework for distributed computing on heterogeneous infrastructure from CPUs to GPUs to quantum computers.
...
- [NISQAI ![GitHub Repo Stars](https://img.shields.io/github/stars/quantumai-lib/nisqai) ![GitHub last commit](https://img.shields.io/github/last-commit/quantumai-lib/nisqai)](https://github.com/quantumai-lib/nisqai) - Library for performing quantum artificial intelligence on near-term quantum computers.
...
- [Paddle Quantum ![GitHub Repo Stars](https://img.shields.io/github/stars/PaddlePaddle/Quantum) ![GitHub last commit](https://img.shields.io/github/last-commit/PaddlePaddle/Quantum)](https://github.com/PaddlePaddle/Quantum) - Baidu's python toolkit for quantum machine learning.
- [PennyLane ![GitHub Repo Stars](https://img.shields.io/github/stars/XanaduAI/pennylane) ![GitHub last commit](https://img.shields.io/github/last-commit/XanaduAI/pennylane)](http://github.com/XanaduAI/pennylane) - Open source framework for quantum computing and quantum machine learning that integrates various other platforms.
- [Project Q](http://projectq.ch/) - Framework for implementing quantum computing in Python.
- [pyQuil ![GitHub Repo Stars](https://img.shields.io/github/stars/rigetticomputing/pyquil) ![GitHub last commit](https://img.shields.io/github/last-commit/rigetticomputing/pyquil)](https://github.com/rigetticomputing/pyquil) - Python library for quantum programming using Quil by Rigetti.
...
- [Qiskit.js ![GitHub Repo Stars](https://img.shields.io/github/stars/QISKit/qiskit-js) ![GitHub last commit](https://img.shields.io/github/last-commit/QISKit/qiskit-js)](https://github.com/QISKit/qiskit-js) - Qiskit for JavaScript made by IBM.
...
- [Quantum++ ![GitHub Repo Stars](https://img.shields.io/github/stars/vsoftco/qpp) ![GitHub last commit](https://img.shields.io/github/last-commit/vsoftco/qpp)](https://github.com/vsoftco/qpp) - High performance modern C++11 quantum computing library.
...
- [Qurry ![GitHub Repo Stars](https://img.shields.io/github/stars/LSaldyt/Qurry) ![GitHub last commit](https://img.shields.io/github/last-commit/LSaldyt/Qurry)](https://github.com/LSaldyt/Qurry) - Quantum probabilistic programming language based on functional and probabilistic paradigms.
...
- [Tequila ![GitHub Repo Stars](https://img.shields.io/github/stars/aspuru-guzik-group/tequila) ![GitHub last commit](https://img.shields.io/github/last-commit/aspuru-guzik-group/tequila)](https://github.com/aspuru-guzik-group/tequila) - An Extensible Quantum Information and Learning Architecture developed by Alan Aspuru-Guzik group (University of Toronto).
...
- [Quantum Computing in Portuguese ![GitHub Repo Stars](https://img.shields.io/github/stars/smendoncabruna/ComputacaoQuantica) ![GitHub last commit](https://img.shields.io/github/last-commit/smendoncabruna/ComputacaoQuantica)](https://github.com/smendoncabruna/ComputacaoQuantica) - A repository with curated content on Quantum Computing in Portuguese.
