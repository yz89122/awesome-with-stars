...
- [Preserver ![GitHub Repo Stars](https://img.shields.io/github/stars/hsbalar/preserver) ![GitHub last commit](https://img.shields.io/github/last-commit/hsbalar/preserver)](https://github.com/hsbalar/preserver) - Notes organizer desktop application based on Electron.
...
- [GitHub Projects ![GitHub Repo Stars](https://img.shields.io/github/stars/features/project-management) ![GitHub last commit](https://img.shields.io/github/last-commit/features/project-management)](https://github.com/features/project-management/) - A lesser known feature of GitHub, makes it easy to tie your project management process to your code.
...
- [Pomolectron ![GitHub Repo Stars](https://img.shields.io/github/stars/amitmerchant1990/pomolectron) ![GitHub last commit](https://img.shields.io/github/last-commit/amitmerchant1990/pomolectron)](https://github.com/amitmerchant1990/pomolectron) - A pomodoro app for your menubar/tray.
...
- [Topydo ![GitHub Repo Stars](https://img.shields.io/github/stars/topydo/topydo) ![GitHub last commit](https://img.shields.io/github/last-commit/topydo/topydo)](https://github.com/topydo/topydo) - A powerful todo list application using the todo.txt format, positioned between todo.txt CLI and Taskwarrior.
...
- [Awesome AutoHotKey ![GitHub Repo Stars](https://img.shields.io/github/stars/ahkscript/awesome-AutoHotkey) ![GitHub last commit](https://img.shields.io/github/last-commit/ahkscript/awesome-AutoHotkey)](https://github.com/ahkscript/awesome-AutoHotkey) - AutoHotKey is a free, open-source macro-creation and automation software for Windows that allows users to automate repetitive tasks.
