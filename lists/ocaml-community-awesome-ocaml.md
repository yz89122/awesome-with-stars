...
- **Libraries**:
  - [Eio ![GitHub Repo Stars](https://img.shields.io/github/stars/ocaml-multicore/eio) ![GitHub last commit](https://img.shields.io/github/last-commit/ocaml-multicore/eio)](https://github.com/ocaml-multicore/eio) — effects-based direct-style IO for multicore OCaml.
  - [Miou ![GitHub Repo Stars](https://img.shields.io/github/stars/robur-coop/miou) ![GitHub last commit](https://img.shields.io/github/last-commit/robur-coop/miou)](https://github.com/robur-coop/miou) — a simple scheduler for OCaml 5.
...
- [puml2xml ![GitHub Repo Stars](https://img.shields.io/github/stars/khalidbelk/puml2xml) ![GitHub last commit](https://img.shields.io/github/last-commit/khalidbelk/puml2xml)](https://github.com/khalidbelk/puml2xml) – A PlantUML (**.puml**) to XML (**.xmi**) converter.
...
- [Notty ![GitHub Repo Stars](https://img.shields.io/github/stars/ocaml-community/notty-community) ![GitHub last commit](https://img.shields.io/github/last-commit/ocaml-community/notty-community)](https://github.com/ocaml-community/notty-community) - Notty is a declarative terminal library for OCaml, structured around the notion of composable images.
