...
- Integrations & Plugins (third-party libraries):
	...
	- [Esri-gl ![GitHub Repo Stars](https://img.shields.io/github/stars/muimsd/esri-gl) ![GitHub last commit](https://img.shields.io/github/last-commit/muimsd/esri-gl)](https://github.com/muimsd/esri-gl) - A community-maintained plugin that enables the use of ArcGIS services in Mapbox GL JS and MapLibre GL JS applications.
...
- [EsriJapan/arcgis-dev-resources ![GitHub Repo Stars](https://img.shields.io/github/stars/EsriJapan/arcgis-dev-resources) ![GitHub last commit](https://img.shields.io/github/last-commit/EsriJapan/arcgis-dev-resources)](https://github.com/EsriJapan/arcgis-dev-resources) - ArcGIS Developers 開発リソース集 (by Esri Japan).
- .NET:
...
- Format conversion:
  ...
  - [geojson2svg ![GitHub Repo Stars](https://img.shields.io/github/stars/w8r/geojson2svg) ![GitHub last commit](https://img.shields.io/github/last-commit/w8r/geojson2svg)](https://github.com/w8r/geojson2svg) - Render GeoJSON into SVG using an inline or external stylesheet.
...
- [arcgis-js-api-camera-helper ![GitHub Repo Stars](https://img.shields.io/github/stars/pjmclaughlin1979/arcgis-js-api-camera-helper) ![GitHub last commit](https://img.shields.io/github/last-commit/pjmclaughlin1979/arcgis-js-api-camera-helper)](https://github.com/pjmclaughlin1979/arcgis-js-api-camera-helper) - Web application to get the camera position JSON object for 3D web apps in the ArcGIS API for JavaScript 4.x.
...
For more information, please see Esri's [guidelines for contributing ![GitHub Repo Stars](https://img.shields.io/github/stars/esri/contributing) ![GitHub last commit](https://img.shields.io/github/last-commit/esri/contributing)](https://github.com/esri/contributing).
