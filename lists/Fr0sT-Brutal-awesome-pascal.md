...
* [FMXAudio ![GitHub Repo Stars](https://img.shields.io/github/stars/HemulGM/FMXAudio) ![GitHub last commit](https://img.shields.io/github/last-commit/HemulGM/FMXAudio)](https://github.com/HemulGM/FMXAudio). `[Delphi]` Audio player component based [BASS](https://www.un4seen.com) for FMX (Windows, Android)
...
* [KIcon ![GitHub Repo Stars](https://img.shields.io/github/stars/kryslt/KControls) ![GitHub last commit](https://img.shields.io/github/last-commit/kryslt/KControls)](https://github.com/kryslt/KControls). `[Delphi]` `[FPC]` This component makes sense if a more complex manipulation with icons (or better icon files *.ico) than just viewing is needed. Full PNG icon image support, correct rendering, icons with alpha channel.
...
* [OpenGL Pascal Toolkit ![GitHub Repo Stars](https://img.shields.io/github/stars/daar/GLPT) ![GitHub last commit](https://img.shields.io/github/last-commit/daar/GLPT)](https://github.com/daar/GLPT). `[FPC]` Easy to use native pascal toolkit that allows to create and manage OpenGL contexts in a platform independent way.
...
* [Ray4Laz ![GitHub Repo Stars](https://img.shields.io/github/stars/GuvaCode/Ray4Laz) ![GitHub last commit](https://img.shields.io/github/last-commit/GuvaCode/Ray4Laz)](https://github.com/GuvaCode/Ray4Laz). `[FPC]` A complete header translation (binding) of [raylib](https://www.raylib.com/) to Pascal.
...
* [KafkaGate ![GitHub Repo Stars](https://img.shields.io/github/stars/dinmil/KafkaGate) ![GitHub last commit](https://img.shields.io/github/last-commit/dinmil/KafkaGate)](https://github.com/dinmil/KafkaGate). `[FPC]` Apache Kafka Free Pascal bindings using librdkafka and ZeroMQ.
...
* [Dext Framework ![GitHub Repo Stars](https://img.shields.io/github/stars/cesarliws/dext) ![GitHub last commit](https://img.shields.io/github/last-commit/cesarliws/dext)](https://github.com/cesarliws/dext). `[Delphi]` Modern Full-Stack ecosystem for modern Delphi development. It brings the productivity and architectural patterns of frameworks like ASP.NET Core and Spring Boot to the native performance of Object Pascal.
...
* [Usb serial controller for Android ![GitHub Repo Stars](https://img.shields.io/github/stars/felHR85/UsbSerial) ![GitHub last commit](https://img.shields.io/github/last-commit/felHR85/UsbSerial)](https://github.com/felHR85/UsbSerial). `[Delphi]` Usb serial controller for Android
...
* [liblcl ![GitHub Repo Stars](https://img.shields.io/github/stars/ying32/liblcl) ![GitHub last commit](https://img.shields.io/github/last-commit/ying32/liblcl)](https://github.com/ying32/liblcl). `[FPC]` A common cross-platform GUI library, the core uses Lazarus LCL.
...
* [DelphiCassandra ![GitHub Repo Stars](https://img.shields.io/github/stars/grijjy/DelphiCassandra) ![GitHub last commit](https://img.shields.io/github/last-commit/grijjy/DelphiCassandra)](https://github.com/grijjy/DelphiCassandra). `[Delphi]` Delphi driver classes to communicate with Cassandra database.

* [DelphiCouchbase ![GitHub Repo Stars](https://img.shields.io/github/stars/grijjy/DelphiCouchbase) ![GitHub last commit](https://img.shields.io/github/last-commit/grijjy/DelphiCouchbase)](https://github.com/grijjy/DelphiCouchbase). `[Delphi]` Delphi driver classes to communicate with Couchbase database.

* [DelphiMongoDB ![GitHub Repo Stars](https://img.shields.io/github/stars/grijjy/DelphiMongoDB) ![GitHub last commit](https://img.shields.io/github/last-commit/grijjy/DelphiMongoDB)](https://github.com/grijjy/DelphiMongoDB). `[Delphi]` Delphi driver classes to communicate with MongoDB database.

* [QuickORM ![GitHub Repo Stars](https://img.shields.io/github/stars/exilon/QuickORM) ![GitHub last commit](https://img.shields.io/github/last-commit/exilon/QuickORM)](https://github.com/exilon/QuickORM). `[Delphi]` `[FPC]` QuickORM is a simple RestServer and Restclient based on mORMot framework. Provides a fast implementation of client-server applications in few minutes.

* [iORM ![GitHub Repo Stars](https://img.shields.io/github/stars/mauriziodm/iORM) ![GitHub last commit](https://img.shields.io/github/last-commit/mauriziodm/iORM)](https://github.com/mauriziodm/iORM). `[Delphi]`  Delphi ORM interface based useful to develop desktop and mobile application.
...
* [Pascal Script ![GitHub Repo Stars](https://img.shields.io/github/stars/remobjects/pascalscript) ![GitHub last commit](https://img.shields.io/github/last-commit/remobjects/pascalscript)](https://github.com/remobjects/pascalscript). `[Delphi]` `[FPC]` Free scripting engine that allows you to use most of the Object Pascal language within your Delphi or Free Pascal projects at runtime. Written completely in Delphi, it is composed of a set of units that can be compiled into your executable, eliminating the need to distribute any external files. Pascal Script started out as a need for a good working script, when there were none available at the time.
...
* [SpiderMonkey ![GitHub Repo Stars](https://img.shields.io/github/stars/synopse/mORMot) ![GitHub last commit](https://img.shields.io/github/last-commit/synopse/mORMot)](https://github.com/synopse/mORMot/blob/master/SynSM.pas). `[Delphi]` `[FPC]` Binding for Mozilla JavaScript engine, including JIT and multi-threading, with easy objects access via Delphi variants.
// *Spidermonkey DLL required*

* [BESEN ![GitHub Repo Stars](https://img.shields.io/github/stars/BeRo1985/besen) ![GitHub last commit](https://img.shields.io/github/last-commit/BeRo1985/besen)](https://github.com/BeRo1985/besen). `[Delphi]` `[FPC]` Complete ECMAScript Fifth Edition Implementation in Object Pascal, which is compilable with Delphi >=7 and Free Pascal >= 2.5.1 (maybe also 2.4.1).

* [Python for Delphi (P4D) ![GitHub Repo Stars](https://img.shields.io/github/stars/pyscripter/python4delphi) ![GitHub last commit](https://img.shields.io/github/last-commit/pyscripter/python4delphi)](https://github.com/pyscripter/python4delphi). `[Delphi]` `[FPC]` Set of free components that wrap up the Python dll into Delphi and Lazarus (FPC). They let you easily execute Python scripts, create new Python modules and new Python types. You can create Python extensions as dlls and much more

* [CrystalLUA ![GitHub Repo Stars](https://img.shields.io/github/stars/d-mozulyov/CrystalLUA) ![GitHub last commit](https://img.shields.io/github/last-commit/d-mozulyov/CrystalLUA)](https://github.com/d-mozulyov/CrystalLUA). `[Delphi]` Lua binding (Delphi6-2007).
// *LUA DLL required*

* [lua4delphi ![GitHub Repo Stars](https://img.shields.io/github/stars/danieleteti/lua4delphi) ![GitHub last commit](https://img.shields.io/github/last-commit/danieleteti/lua4delphi)](https://github.com/danieleteti/lua4delphi). `[Delphi]` Delphi binding for Lua 5.1 language.
// *LUA DLL required*

* [chakracore-delphi ![GitHub Repo Stars](https://img.shields.io/github/stars/tondrej/chakracore-delphi) ![GitHub last commit](https://img.shields.io/github/last-commit/tondrej/chakracore-delphi)](https://github.com/tondrej/chakracore-delphi). `[Delphi]` `[FPC]` Delphi and Free Pascal bindings and classes for Microsoft's ChakraCore JavaScript engine library.

* [VerySimple.Lua ![GitHub Repo Stars](https://img.shields.io/github/stars/Dennis1000/verysimplelua) ![GitHub last commit](https://img.shields.io/github/last-commit/Dennis1000/verysimplelua)](https://github.com/Dennis1000/verysimplelua). `[Delphi]` Lua Wrapper for Delphi XE5-D10.1 which automatically creates OOP callback functions for Delphi <-> Lua.
// *LUA DLL required*
...
* [noe ![GitHub Repo Stars](https://img.shields.io/github/stars/ariaghora/noe) ![GitHub last commit](https://img.shields.io/github/last-commit/ariaghora/noe)](https://github.com/ariaghora/noe). `[FPC]` Framework to build neural networks in pure object pascal.

* [Keras4Delphi ![GitHub Repo Stars](https://img.shields.io/github/stars/Pigrecos/Keras4Delphi) ![GitHub last commit](https://img.shields.io/github/last-commit/Pigrecos/Keras4Delphi)](https://github.com/Pigrecos/Keras4Delphi). `[Delphi]` High-level neural networks API, written in Pascal with Python Binding

* [Marvin.IA ![GitHub Repo Stars](https://img.shields.io/github/stars/marvinbraga/Marvin.IA) ![GitHub last commit](https://img.shields.io/github/last-commit/marvinbraga/Marvin.IA)](https://github.com/marvinbraga/Marvin.IA). `[Delphi]` Machine learning collection of object-oriented Pascal primitives (only interfaces and classes).

* [CAI Neural API ![GitHub Repo Stars](https://img.shields.io/github/stars/joaopauloschuler/neural-api) ![GitHub last commit](https://img.shields.io/github/last-commit/joaopauloschuler/neural-api)](https://github.com/joaopauloschuler/neural-api). `[FPC]` Pascal-based deep learning neural network API optimized for AVX, AVX2 and AVX512 instruction sets plus OpenCL capable devices including AMD, Intel and NVIDIA. This API has been tested under Windows and Linux.
...
* [SynCrypto ![GitHub Repo Stars](https://img.shields.io/github/stars/synopse/mORMot) ![GitHub last commit](https://img.shields.io/github/last-commit/synopse/mORMot)](https://github.com/synopse/mORMot/blob/master/SynCrypto.pas). `[Delphi]` `[FPC]` Fast cryptographic routines (hashing and cypher), implementing AES, XOR, RC4, ADLER32, MD5, SHA1, SHA256 algorithms, optimized for speed (tuned assembler and VIA PADLOCK optional support).

* [TForge ![GitHub Repo Stars](https://img.shields.io/github/stars/sergworks/tforge) ![GitHub last commit](https://img.shields.io/github/last-commit/sergworks/tforge)](https://github.com/sergworks/tforge) (Seems abandoned, [Newer fork ![GitHub Repo Stars](https://img.shields.io/github/stars/ElminsterAU/tforge) ![GitHub last commit](https://img.shields.io/github/last-commit/ElminsterAU/tforge)](https://github.com/ElminsterAU/tforge)). `[Delphi]` `[FPC]` Open-source crypto library written in Delphi, compatible with Free Pascal Compiler. MD5, SHA1, SHA256, CRC32, Jenkins-One-At-Time, HMAC, PBKDF1, PBKDF2, AES, DES, RC4, RC5, Salsa20.
...
* [SuperObject ![GitHub Repo Stars](https://img.shields.io/github/stars/hgourvest/superobject) ![GitHub last commit](https://img.shields.io/github/last-commit/hgourvest/superobject)](https://github.com/hgourvest/superobject). `[Delphi]` `[FPC]` Parser/writer for JSON data format. This toolkit is designed to work with Delphi and FreePascal (win32, win64, linux32, linux64, macOS Intel). Supports reading/writing XML as well.
...
* [SynCommons ![GitHub Repo Stars](https://img.shields.io/github/stars/synopse/mORMot) ![GitHub last commit](https://img.shields.io/github/last-commit/synopse/mORMot)](https://github.com/synopse/mORMot/blob/master/SynCommons.pas). `[Delphi]` `[FPC]` High speed JSON library, using `TDocVariant` custom variant type for storage and access.

* [SynCrossPlatformJSON ![GitHub Repo Stars](https://img.shields.io/github/stars/synopse/mORMot) ![GitHub last commit](https://img.shields.io/github/last-commit/synopse/mORMot)](https://github.com/synopse/mORMot/blob/master/CrossPlatform/SynCrossPlatformJSON.pas). `[Delphi]` `[FPC]` High speed cross-platform JSON library, using `TJSONVariant` custom variant type for storage and access.

* [Json Data Objects ![GitHub Repo Stars](https://img.shields.io/github/stars/ahausladen/JsonDataObjects) ![GitHub last commit](https://img.shields.io/github/last-commit/ahausladen/JsonDataObjects)](https://github.com/ahausladen/JsonDataObjects). `[Delphi]` This Delphi unit contains a JSON parser that supports Delphi 2009-10Seattle and the platforms Win32, Win64 and ARM Android (MacOS and iOS may work).

* [TinyJSON](http://sourceforge.net/projects/tiny-json) ([mirror at GH ![GitHub Repo Stars](https://img.shields.io/github/stars/tmcdos/tiny-json) ![GitHub last commit](https://img.shields.io/github/last-commit/tmcdos/tiny-json)](https://github.com/tmcdos/tiny-json)). `[Delphi]` This is a small and clean library for associative arrays with Boolean / Integer / Float / WideString values. Allows import (export) from (to) JSON text. Extensive error-checking. Uses FunHash (by Sokolov Yura), HatTrie (by Daniel C. Jones), FastInt64 and FastMove (by FastCode project).
...
* [delphi-yaml ![GitHub Repo Stars](https://img.shields.io/github/stars/ashumkin/delphi-yaml) ![GitHub last commit](https://img.shields.io/github/last-commit/ashumkin/delphi-yaml)](https://github.com/ashumkin/delphi-yaml). `[Delphi]` Delphi 7 compatible bindings for libyaml, YAML parser and emitter library implemented in C. Four layers of bindings are proposed.

* [GrijjyFoundation](#general-libraries). JSON/BSON.

* [VerySimpleXML ![GitHub Repo Stars](https://img.shields.io/github/stars/Dennis1000/verysimplexml) ![GitHub last commit](https://img.shields.io/github/last-commit/Dennis1000/verysimplexml)](https://github.com/Dennis1000/verysimplexml). `[Delphi]` Lightweight, one-unit, cross-platform XML reader/writer for Delphi 2010 - 10.2.2 Tokyo

* [XSuperObject ![GitHub Repo Stars](https://img.shields.io/github/stars/onryldz/x-superobject) ![GitHub last commit](https://img.shields.io/github/last-commit/onryldz/x-superobject)](https://github.com/onryldz/x-superobject). `[Delphi]` Delphi Cross Platform Rapid JSON

* [Internet Tools ![GitHub Repo Stars](https://img.shields.io/github/stars/benibela/internettools) ![GitHub last commit](https://img.shields.io/github/last-commit/benibela/internettools)](https://github.com/benibela/internettools). `[Delphi]` `[FPC]` Package provides standard conformant XPath 2.0, XQuery 1.0 and XPath/XQuery 3.0 interpreters with extensions for - among others - JSONiq, pattern matching, CSS and HTML; as well as functions to perform HTTP/S requests on Windows/Linux/macOS/Android, an XSLT-inspired webscraping language, and an auto update class.

* [Delphi-JsonToDelphiClass ![GitHub Repo Stars](https://img.shields.io/github/stars/PKGeorgiev/Delphi-JsonToDelphiClass) ![GitHub last commit](https://img.shields.io/github/last-commit/PKGeorgiev/Delphi-JsonToDelphiClass)](https://github.com/PKGeorgiev/Delphi-JsonToDelphiClass) ([Newer fork ![GitHub Repo Stars](https://img.shields.io/github/stars/JensBorrisholt/Delphi-JsonToDelphiClass) ![GitHub last commit](https://img.shields.io/github/last-commit/JensBorrisholt/Delphi-JsonToDelphiClass)](https://github.com/JensBorrisholt/Delphi-JsonToDelphiClass). `[Delphi]` Generates Delphi Classes based on JSON string (Json To Delphi Class Generator / JSON Data Binding Tool). Also includes unit for interaction with GitHub.
...
* [HTML parser ![GitHub Repo Stars](https://img.shields.io/github/stars/ying32/htmlparser) ![GitHub last commit](https://img.shields.io/github/last-commit/ying32/htmlparser)](https://github.com/ying32/htmlparser). `[Delphi]` HTML parser. Supports Windows, macOS, iOS, Android platform. Comments in Chinese

* [Neslib ![GitHub Repo Stars](https://img.shields.io/github/stars/neslib/Neslib.Xml) ![GitHub last commit](https://img.shields.io/github/last-commit/neslib/Neslib.Xml)](https://github.com/neslib/Neslib.Xml). `[Delphi]` Ultra light-weight and cross-platform XML library for Delphi.

* [DJSON ![GitHub Repo Stars](https://img.shields.io/github/stars/mauriziodm/DJSON) ![GitHub last commit](https://img.shields.io/github/last-commit/mauriziodm/DJSON)](https://github.com/mauriziodm/DJSON). `[Delphi]` Delphi JSON object mapper

* [fast-html-parser ![GitHub Repo Stars](https://img.shields.io/github/stars/z505/fast-html-parser) ![GitHub last commit](https://img.shields.io/github/last-commit/z505/fast-html-parser)](https://github.com/z505/fast-html-parser). `[Delphi]` `[FPC]` Fast HTML Parser

* [THTMLWriter ![GitHub Repo Stars](https://img.shields.io/github/stars/NickHodges/delphihtmlwriter) ![GitHub last commit](https://img.shields.io/github/last-commit/NickHodges/delphihtmlwriter)](https://github.com/NickHodges/delphihtmlwriter). `[Delphi]` Class library that enables the developer to create HTML and HTML documents. It uses the fluent interface to make creating HTML text easy and natural.
...
* [Next Delphi Yacc & Lex ![GitHub Repo Stars](https://img.shields.io/github/stars/RomanYankovsky/ndyacclex) ![GitHub last commit](https://img.shields.io/github/last-commit/RomanYankovsky/ndyacclex)](https://github.com/RomanYankovsky/ndyacclex). `[Delphi]` Parser generator toolset for Delphi.

* [Abstract Syntax Tree Builder ![GitHub Repo Stars](https://img.shields.io/github/stars/RomanYankovsky/DelphiAST) ![GitHub last commit](https://img.shields.io/github/last-commit/RomanYankovsky/DelphiAST)](https://github.com/RomanYankovsky/DelphiAST). `[Delphi]` With DelphiAST you can take real Delphi code and get an abstract syntax tree. One unit at time and without a symbol table though.

* [Castalia-Delphi-Parser ![GitHub Repo Stars](https://img.shields.io/github/stars/jacobthurman/Castalia-Delphi-Parser) ![GitHub last commit](https://img.shields.io/github/last-commit/jacobthurman/Castalia-Delphi-Parser)](https://github.com/jacobthurman/Castalia-Delphi-Parser). `[Delphi]` These files make up a hand-written high speed parser for the Object Pascal dialect known as "Delphi". The original work was done by Martin Waldenburg in the late 1990s, and the project was abandoned sometime before 2003, when I found the code and began working on it.  I have kept it updated as necessary to work with my project, called "Castalia".

* [CrossPascal ![GitHub Repo Stars](https://img.shields.io/github/stars/BeRo1985/crosspascal) ![GitHub last commit](https://img.shields.io/github/last-commit/BeRo1985/crosspascal)](https://github.com/BeRo1985/crosspascal). `[Delphi]` Aims to be a Delphi 7 compatible cross-platform source-to-source compiler (together with the new unicode string types from XE3 but where ansistring is still the default string type for to be still Delphi 7 compatible) which generates intermediate C code.
...
* [FastMM ![GitHub Repo Stars](https://img.shields.io/github/stars/pleriche/FastMM4) ![GitHub last commit](https://img.shields.io/github/last-commit/pleriche/FastMM4)](https://github.com/pleriche/FastMM4). `[Delphi]` Lightning fast replacement memory manager for Embarcadero Delphi Win32 and Win64 applications that is not prone to memory fragmentation, and supports shared memory without the use of external .DLL files.
...
* [ScaleMM ![GitHub Repo Stars](https://img.shields.io/github/stars/andremussche/scalemm) ![GitHub last commit](https://img.shields.io/github/last-commit/andremussche/scalemm)](https://github.com/andremussche/scalemm). `[Delphi]` Fast scaling memory manager for Delphi

* [BrainMM ![GitHub Repo Stars](https://img.shields.io/github/stars/d-mozulyov/BrainMM) ![GitHub last commit](https://img.shields.io/github/last-commit/d-mozulyov/BrainMM)](https://github.com/d-mozulyov/BrainMM). `[Delphi]` Extremely fast memory manager for Delphi.
// *Advanced memory allocation functions for faster aligned operations.*

* [FastMM4-AVX ![GitHub Repo Stars](https://img.shields.io/github/stars/maximmasiutin/FastMM4-AVX) ![GitHub last commit](https://img.shields.io/github/last-commit/maximmasiutin/FastMM4-AVX)](https://github.com/maximmasiutin/FastMM4-AVX). `[Delphi]` `[FPC]` FastMM4 fork with AVX support and multi-threaded enhancements (faster locking)

* [FastMM5 ![GitHub Repo Stars](https://img.shields.io/github/stars/pleriche/FastMM5) ![GitHub last commit](https://img.shields.io/github/last-commit/pleriche/FastMM5)](https://github.com/pleriche/FastMM5). `[Delphi]` Fast replacement memory manager for Embarcadero Delphi applications that scales well across multiple threads and CPU cores, is not prone to memory fragmentation, and supports shared memory without the use of external .DLL files. Version 5 is a complete rewrite of FastMM.

* [Delphi64RTL ![GitHub Repo Stars](https://img.shields.io/github/stars/RDP1974/Delphi64RTL) ![GitHub last commit](https://img.shields.io/github/last-commit/RDP1974/Delphi64RTL)](https://github.com/RDP1974/Delphi64RTL). `[Delphi]` Object Pascal wrappers from Intel Integrated Performance Primitives and Intel Threading Building Blocks royalty-free packages. Includes lock-free scalable allocator, simd enabled rtl subset routines (memory fill, copy, compare) and accelerated zlib compression
...
* [OmniThreadLibrary ![GitHub Repo Stars](https://img.shields.io/github/stars/gabr42/OmniThreadLibrary) ![GitHub last commit](https://img.shields.io/github/last-commit/gabr42/OmniThreadLibrary)](https://github.com/gabr42/OmniThreadLibrary). `[Delphi]` Simple to use threading library for Delphi.
// *Easy integration of async processes in your app*

* [Delphi Detours Library ![GitHub Repo Stars](https://img.shields.io/github/stars/mahdisafsafi/delphi-detours-library) ![GitHub last commit](https://img.shields.io/github/last-commit/mahdisafsafi/delphi-detours-library)](https://github.com/mahdisafsafi/delphi-detours-library). `[Delphi]` `[FPC]` Library allowing you to hook Delphi functions and object methods and Windows API functions. It provides an easy way to insert and remove hook.
...
* [MemoryModule ![GitHub Repo Stars](https://img.shields.io/github/stars/Fr0sT-Brutal/Delphi_MemoryModule) ![GitHub last commit](https://img.shields.io/github/last-commit/Fr0sT-Brutal/Delphi_MemoryModule)](https://github.com/Fr0sT-Brutal/Delphi_MemoryModule). `[Delphi]` `[FPC]` With the MemoryModule engine you can store all required DLLs inside your binary to keep it standalone. Additional hook units allow transparent using of MM engine thus allowing switching MM/WinAPI loading as well as enabling 3rd party dynamic-load DLL interfaces that are unaware of MM (tested with Interbase Express components and Firebird client library). MemoryModule is a Pascal port of Joachim Bauch's C MemoryModule.

* [DirectoryWatcher ![GitHub Repo Stars](https://img.shields.io/github/stars/Wosi/DirectoryWatcher) ![GitHub last commit](https://img.shields.io/github/last-commit/Wosi/DirectoryWatcher)](https://github.com/Wosi/DirectoryWatcher). `[Delphi]` Watch changes in directories on different platforms (Windows/Linux/Mac OS).

* [ezthreads ![GitHub Repo Stars](https://img.shields.io/github/stars/mr-highball/ezthreads) ![GitHub last commit](https://img.shields.io/github/last-commit/mr-highball/ezthreads)](https://github.com/mr-highball/ezthreads). `[FPC]` simple to use threading library

* [AsyncCalls ![GitHub Repo Stars](https://img.shields.io/github/stars/ahausladen/AsyncCalls) ![GitHub last commit](https://img.shields.io/github/last-commit/ahausladen/AsyncCalls)](https://github.com/ahausladen/AsyncCalls). `[Delphi]` Asynchronous function call framework

* [Storage Access Framework SAF ![GitHub Repo Stars](https://img.shields.io/github/stars/emozgun/delphi-android-SAF) ![GitHub last commit](https://img.shields.io/github/last-commit/emozgun/delphi-android-SAF)](https://github.com/emozgun/delphi-android-SAF). `[Delphi]` Android Scoped Storage : Storage Access Framework SAF API
...
* [SynMustache ![GitHub Repo Stars](https://img.shields.io/github/stars/synopse/dmustache) ![GitHub last commit](https://img.shields.io/github/last-commit/synopse/dmustache)](https://github.com/synopse/dmustache). `[Delphi]` `[FPC]` Delphi implementation of the Mustache template language, supporting Delphi 6 up to Delphi 10 Seattle (and FPC/Lazarus compilation).
...
* [MustaPAS ![GitHub Repo Stars](https://img.shields.io/github/stars/leledumbo/mustapas) ![GitHub last commit](https://img.shields.io/github/last-commit/leledumbo/mustapas)](https://github.com/leledumbo/mustapas). `[Delphi]` `[FPC]` Mustache implementation in simple procedural Pascal.

* [Sempare Template Engine ![GitHub Repo Stars](https://img.shields.io/github/stars/sempare/sempare-delphi-template-engine) ![GitHub last commit](https://img.shields.io/github/last-commit/sempare/sempare-delphi-template-engine)](https://github.com/sempare/sempare-delphi-template-engine). `[Delphi]` The template engine allows for flexible text manipulation. It can be used for generating email, html, source code, xml, configuration, etc. It is very easy to use, flexible and extensible, where templates are readable and maintainable. It supports: conditions, looping, custom functions and referencing data via RTTI. XE4, XE8+

* [DVD Chief Template Engine ![GitHub Repo Stars](https://img.shields.io/github/stars/Fr0sT-Brutal/TemplateEngine) ![GitHub last commit](https://img.shields.io/github/last-commit/Fr0sT-Brutal/TemplateEngine)](https://github.com/Fr0sT-Brutal/TemplateEngine). `[Delphi]` `[FPC]` Fork of abandoned implementation of PHP Smarty template engine for Delphi by [DVD Chief](http://dvdchief.com/delphi).

* [liquid-delphi ![GitHub Repo Stars](https://img.shields.io/github/stars/arimateia/liquid-delphi) ![GitHub last commit](https://img.shields.io/github/last-commit/arimateia/liquid-delphi)](https://github.com/arimateia/liquid-delphi). `[Delphi]` Delphi port of the popular [Ruby Liquid templating language](https://shopify.github.io/liquid) and dotLiquid implementation. It is a separate project that aims to retain the same template syntax as the original, while using delphi coding conventions where possible.

* [Simple Template Engine for Free Pascal ![GitHub Repo Stars](https://img.shields.io/github/stars/sash-rc/ste) ![GitHub last commit](https://img.shields.io/github/last-commit/sash-rc/ste)](https://github.com/sash-rc/ste). `[FPC]` Fast engine to generate text (html, xml, or any markup) with tags/variables in Object/Free Pascal (probably delphi compatible). IF/ELSE blocks. FOR blocks (dataset iteration). Per-tag callbacks. Nested blocks.

## Logging

* [Log4d ![GitHub Repo Stars](https://img.shields.io/github/stars/landrix/Log4d-for-Delphi) ![GitHub last commit](https://img.shields.io/github/last-commit/landrix/Log4d-for-Delphi)](https://github.com/landrix/Log4d-for-Delphi). `[Delphi]` `[FPC]` Implementation of logging system for Delphi, based on Log4j.

* [TraceTool](http://tracetool.sourceforge.net/). `[Delphi]` C#, C++, Delphi, ActiveX and Java trace framework and a trace viewer.

* [LoggerPro ![GitHub Repo Stars](https://img.shields.io/github/stars/danieleteti/loggerpro) ![GitHub last commit](https://img.shields.io/github/last-commit/danieleteti/loggerpro)](https://github.com/danieleteti/loggerpro). `[Delphi]` A modern and pluggable logging framework for Delphi.

* [SynLog ![GitHub Repo Stars](https://img.shields.io/github/stars/synopse/mORMot) ![GitHub last commit](https://img.shields.io/github/last-commit/synopse/mORMot)](https://github.com/synopse/mORMot/blob/master/SynLog.pas). `[Delphi]` `[FPC]` Logging functions used by Synopse projects.

* [slf4p ![GitHub Repo Stars](https://img.shields.io/github/stars/michaelJustin/slf4p) ![GitHub last commit](https://img.shields.io/github/last-commit/michaelJustin/slf4p)](https://github.com/michaelJustin/slf4p). `[Delphi]` `[FPC]` A simple logging facade with support for LazLogger, Log4D, and other logging frameworks.

* [GrijjyCloudLogger ![GitHub Repo Stars](https://img.shields.io/github/stars/grijjy/GrijjyCloudLogger) ![GitHub last commit](https://img.shields.io/github/last-commit/grijjy/GrijjyCloudLogger)](https://github.com/grijjy/GrijjyCloudLogger). `[Delphi]` Remote logging tool that allows you to send log messages over the Intranet or Internet from Windows, Linux, iOS, Android and macOS devices to a viewer running on Windows. Besides sending messages along with any data, it has numerous features including custom live watches, remote live views of objects, tracking live memory usage, object allocations, growth leaks and more.

* [QuickLogger ![GitHub Repo Stars](https://img.shields.io/github/stars/exilon/QuickLogger) ![GitHub last commit](https://img.shields.io/github/last-commit/exilon/QuickLogger)](https://github.com/exilon/QuickLogger). `[Delphi]` `[FPC]` Delphi/freepascal/.NET (Windows/Linux) library for logging on files, console, memory, email, rest, telegram, slack, eventlog, redis, ide debug messages and throw events.

* [jachLog ![GitHub Repo Stars](https://img.shields.io/github/stars/jachguate/jachLogMgr) ![GitHub last commit](https://img.shields.io/github/last-commit/jachguate/jachLogMgr)](https://github.com/jachguate/jachLogMgr). `[Delphi]` pure pascal, flexible, extensible and lightweight library to add logging capabilities to your Delphi applications. Multiple log destinations supported. The library supports multithreaded applications and is itself multithreaded to minimize the impact writing the log may have on the performance on mission critical applications.
...
* [Big Decimal Math ![GitHub Repo Stars](https://img.shields.io/github/stars/benibela/bigdecimalmath) ![GitHub last commit](https://img.shields.io/github/last-commit/benibela/bigdecimalmath)](https://github.com/benibela/bigdecimalmath). `[Delphi]` This unit provides a arbitrary precision BCD float number type. It can be used like any numeric type and supports: At least numbers between 10-2147483647 to 102147483647 with 2147483647 decimal digit precision; All standard arithmetic and comparison operators; Rounding functions (floor, ceil, to-even, ..); Some more advanced operations, e.g. power and sqrt.

* [TIntX ![GitHub Repo Stars](https://img.shields.io/github/stars/Xor-el/IntXLib4Pascal) ![GitHub last commit](https://img.shields.io/github/last-commit/Xor-el/IntXLib4Pascal)](https://github.com/Xor-el/IntXLib4Pascal). `[Delphi]` `[FPC]` Pascal port of IntX arbitrary precision Integer library with fast, about O(N * log N) multiplication/division algorithms implementation. It provides all the basic arithmetic operations on Integers, comparing, bitwise shifting etc. It also allows parsing numbers in different bases and converting them to string, also in any base. The advantage of this library is its fast multiplication, division and from base/to base conversion algorithms. all the fast versions of the algorithms are based on fast multiplication of big Integers using Fast Hartley Transform which runs for O(N * log N * log log N) time instead of classic O(N^2).

* [DelphiBigNumberXLib ![GitHub Repo Stars](https://img.shields.io/github/stars/Xor-el/DelphiBigNumberXLib) ![GitHub last commit](https://img.shields.io/github/last-commit/Xor-el/DelphiBigNumberXLib)](https://github.com/Xor-el/DelphiBigNumberXLib). `[Delphi]` Arbitrary Precision Library for Delphi with Support for Integer and Floating Point Computations.

* [FastMath ![GitHub Repo Stars](https://img.shields.io/github/stars/neslib/FastMath) ![GitHub last commit](https://img.shields.io/github/last-commit/neslib/FastMath)](https://github.com/neslib/FastMath). `[Delphi]` Delphi math library that is optimized for fast performance (sometimes at the cost of not performing error checking or losing a little accuracy). It uses hand-optimized assembly code to achieve much better performance then the equivalent functions provided by the Delphi RTL.
...
* [TCommandLineReader ![GitHub Repo Stars](https://img.shields.io/github/stars/benibela/rcmdline) ![GitHub last commit](https://img.shields.io/github/last-commit/benibela/rcmdline)](https://github.com/benibela/rcmdline). `[Delphi]` `[FPC]` This unit provides an advanced, platform-independent command line parser for Lazarus and Delphi. It checks for allowed options, automatically prints a help with a list of all of them, and - contrary to the parser in the rtl - behaves the same on Windows and Linux.

* [CommandLineParser ![GitHub Repo Stars](https://img.shields.io/github/stars/VSoftTechnologies/VSoft.CommandLineParser) ![GitHub last commit](https://img.shields.io/github/last-commit/VSoftTechnologies/VSoft.CommandLineParser)](https://github.com/VSoftTechnologies/VSoft.CommandLineParser). `[Delphi]` Simple Command Line Options Parser - spawned from the DUnitX Project.

* [GpCommandLineParser ![GitHub Repo Stars](https://img.shields.io/github/stars/gabr42/GpDelphiUnits) ![GitHub last commit](https://img.shields.io/github/last-commit/gabr42/GpDelphiUnits)](https://github.com/gabr42/GpDelphiUnits/blob/master/src/GpCommandLineParser.pas). `[Delphi]` Attribute based command line parser.

* [JPL.CmdLineParser ![GitHub Repo Stars](https://img.shields.io/github/stars/jackdp/JPLib) ![GitHub last commit](https://img.shields.io/github/last-commit/jackdp/JPLib)](https://github.com/jackdp/JPLib/blob/master/Base/JPL.CmdLineParser.pas). `[Delphi]` `[FPC]` Command-line parser for Delphi and Free Pascal

* [Nullpobug.ArgumentParser ![GitHub Repo Stars](https://img.shields.io/github/stars/tokibito/delphi-argparse) ![GitHub last commit](https://img.shields.io/github/last-commit/tokibito/delphi-argparse)](https://github.com/tokibito/delphi-argparse). `[Delphi]` `[FPC]` Command-line parser for Delphi and Free Pascal


## Other non-visual

* [TRegExpr ![GitHub Repo Stars](https://img.shields.io/github/stars/andgineer/TRegExpr) ![GitHub last commit](https://img.shields.io/github/last-commit/andgineer/TRegExpr)](https://github.com/andgineer/TRegExpr). `[Delphi]` `[FPC]` Regular expressions engine in pure Object Pascal.

* [FLRE ![GitHub Repo Stars](https://img.shields.io/github/stars/BeRo1985/flre) ![GitHub last commit](https://img.shields.io/github/last-commit/BeRo1985/flre)](https://github.com/BeRo1985/flre). `[Delphi]` `[FPC]` FLRE ( F ast L ight R egular E xpressions) is a fast, safe and efficient regular expression library, which is implemented in Object Pascal (Delphi and Free Pascal) but which is even usable from other languages like C/C++ and so on.

* [OnGuard](http://sourceforge.net/projects/tponguard) ([Alternate ![GitHub Repo Stars](https://img.shields.io/github/stars/TurboPack/OnGuard-VCL) ![GitHub last commit](https://img.shields.io/github/last-commit/TurboPack/OnGuard-VCL)](https://github.com/TurboPack/OnGuard-VCL) and maintained version for recent compiler version only). `[Delphi]` Library to create demo versions of your Borland Delphi & C++Builder applications. Create demo versions that are time-limited, feature-limited, limited to a certain number of uses, or limited to a certain # of concurrent network users.
// *Second link points to an adapted version for newest compiler versions.*

* [StringSimilarity ![GitHub Repo Stars](https://img.shields.io/github/stars/chaosben/theunknownones) ![GitHub last commit](https://img.shields.io/github/last-commit/chaosben/theunknownones)](https://github.com/chaosben/theunknownones). `[Delphi]` Package designed for some fuzzy and phonetic string comparison algorithms. So far implemented are the following algorithms: DamerauLevenshtein, Koelner Phonetik, SoundEx, Metaphone, DoubleMetaphone, NGram, Dice, JaroWinkler, NeedlemanWunch, SmithWatermanGotoh, MongeElkan.
...
* [byterage ![GitHub Repo Stars](https://img.shields.io/github/stars/quartexNOR/byterage) ![GitHub last commit](https://img.shields.io/github/last-commit/quartexNOR/byterage)](https://github.com/quartexNOR/byterage). `[Delphi]` Object pascal class library designed to remove some of the limitations of streams. The framework is very simple to use, with only one common ancestor class (TBRBuffer) which defines a set of storage agnostic mechanisms for allocating, scaling, inserting, deleting and otherwise manipulating a segment of raw binary data.

* [stateless ![GitHub Repo Stars](https://img.shields.io/github/stars/SirRufo/stateless) ![GitHub last commit](https://img.shields.io/github/last-commit/SirRufo/stateless)](https://github.com/SirRufo/stateless). `[Delphi]` Simple library for creating state machines in Delphi code.

* [GenericTree ![GitHub Repo Stars](https://img.shields.io/github/stars/davidberneda/GenericTree) ![GitHub last commit](https://img.shields.io/github/last-commit/davidberneda/GenericTree)](https://github.com/davidberneda/GenericTree). `[Delphi]` Delphi implementation of a generic Tree structure.

* [DHibernate ![GitHub Repo Stars](https://img.shields.io/github/stars/thecocce/delphi-hibernate) ![GitHub last commit](https://img.shields.io/github/last-commit/thecocce/delphi-hibernate)](https://github.com/thecocce/delphi-hibernate). `[Delphi]` Object Persistent Framework based on Hibernate and NHibernate for Delphi.
// *Abandoned since 2012*

* [UniConv ![GitHub Repo Stars](https://img.shields.io/github/stars/d-mozulyov/UniConv) ![GitHub last commit](https://img.shields.io/github/last-commit/d-mozulyov/UniConv)](https://github.com/d-mozulyov/UniConv). `[Delphi]` `[FPC]` Universal text conversion library is a universal quick and compact library intended for conversion, comparison and change of the register of text in concordance with the latest standards of the Unicode Consortium. The librarys function greatly resembles ICU, libiconv and Windows.kernel which are de facto standard for popular operating systems.

* [CachedBuffers ![GitHub Repo Stars](https://img.shields.io/github/stars/d-mozulyov/CachedBuffers) ![GitHub last commit](https://img.shields.io/github/last-commit/d-mozulyov/CachedBuffers)](https://github.com/d-mozulyov/CachedBuffers). `[Delphi]` `[FPC]` The library is irreplaceable for the tasks of sequential data reading or writing, especially if the requirements for the performance are increased and there are much data.

* [CachedTexts ![GitHub Repo Stars](https://img.shields.io/github/stars/d-mozulyov/CachedTexts) ![GitHub last commit](https://img.shields.io/github/last-commit/d-mozulyov/CachedTexts)](https://github.com/d-mozulyov/CachedTexts). `[Delphi]` `[FPC]` Powerful and compact cross-platform library aimed at parsing and generating of text data with the maximum possible performance. Depends on the two other libraries: CachedBuffers and UniConv.

* [ZEXMLSS ![GitHub Repo Stars](https://img.shields.io/github/stars/Avemey/zexmlss) ![GitHub last commit](https://img.shields.io/github/last-commit/Avemey/zexmlss)](https://github.com/Avemey/zexmlss). `[Delphi]` `[FPC]` Lazarus/Delphi component for read/write ods, excel xml, xlsx.

* [PasMP ![GitHub Repo Stars](https://img.shields.io/github/stars/BeRo1985/pasmp) ![GitHub last commit](https://img.shields.io/github/last-commit/BeRo1985/pasmp)](https://github.com/BeRo1985/pasmp). `[Delphi]` `[FPC]` Parallel-processing/multi-processing library for Object Pascal.
...
* [GpDelphiUnits ![GitHub Repo Stars](https://img.shields.io/github/stars/gabr42/GpDelphiUnits) ![GitHub last commit](https://img.shields.io/github/last-commit/gabr42/GpDelphiUnits)](https://github.com/gabr42/GpDelphiUnits). `[Delphi]` Collection of useful Delphi units. Various TList descendants, TList-compatible, and TList-similar classes. Dynamically allocated, O(1) enqueue and dequeue, threadsafe, microlocking queue. Interface to 64-bit file functions with some added functionality. String hash, table and dictionary. Collection of Win32/Win64 wrappers and helper functions. Time Zone Routines. Embedded file system.

* [BaseNcodingPascal ![GitHub Repo Stars](https://img.shields.io/github/stars/Xor-el/BaseNcodingPascal) ![GitHub last commit](https://img.shields.io/github/last-commit/Xor-el/BaseNcodingPascal)](https://github.com/Xor-el/BaseNcodingPascal). `[Delphi]` `[FPC]` Library for encoding of binary data into strings using base32, base85, base128 and other algorithms for FPC and Delphi.

* [ByteSizeLibPascal ![GitHub Repo Stars](https://img.shields.io/github/stars/Xor-el/ByteSizeLibPascal) ![GitHub last commit](https://img.shields.io/github/last-commit/Xor-el/ByteSizeLibPascal)](https://github.com/Xor-el/ByteSizeLibPascal). `[Delphi]` `[FPC]` TByteSize is a utility "record" that makes byte size representation in code easier by removing ambiguity of the value being represented.

* [EmailValidationPascal ![GitHub Repo Stars](https://img.shields.io/github/stars/Xor-el/EmailValidationPascal) ![GitHub last commit](https://img.shields.io/github/last-commit/Xor-el/EmailValidationPascal)](https://github.com/Xor-el/EmailValidationPascal). `[Delphi]` `[FPC]` Simple Class for Validating Email Address Syntax in Pascal/Delphi.
...
* [HTMLBuilder ![GitHub Repo Stars](https://img.shields.io/github/stars/guitorres/htmlbuilder) ![GitHub last commit](https://img.shields.io/github/last-commit/guitorres/htmlbuilder)](https://github.com/guitorres/htmlbuilder). `[Delphi]` Build simplified html with pascal code.

* [FreePascal Generics.Collections ![GitHub Repo Stars](https://img.shields.io/github/stars/maciej-izak/generics.collections) ![GitHub last commit](https://img.shields.io/github/last-commit/maciej-izak/generics.collections)](https://github.com/maciej-izak/generics.collections). `[FPC]` FreePascal Generics.Collections library (TList, TDictionary, THashMap and more)

* [FuzzyWuzzy.pas ![GitHub Repo Stars](https://img.shields.io/github/stars/DavidMoraisFerreira/FuzzyWuzzy.pas) ![GitHub last commit](https://img.shields.io/github/last-commit/DavidMoraisFerreira/FuzzyWuzzy.pas)](https://github.com/DavidMoraisFerreira/FuzzyWuzzy.pas). `[FPC]` Port of the well-known Python fuzzy string matching package that uses the Levenshtein distance to compute differences between string sequences.

* [GS.Core ![GitHub Repo Stars](https://img.shields.io/github/stars/VincentGsell/GS.Core) ![GitHub last commit](https://img.shields.io/github/last-commit/VincentGsell/GS.Core)](https://github.com/VincentGsell/GS.Core). `[Delphi]` `[FPC]` Core functions shared by several projects.
// *Thread Pool, file operations, Key<>Value database, JSON lib, etc*

* [PascalTZ ![GitHub Repo Stars](https://img.shields.io/github/stars/dezlov/PascalTZ) ![GitHub last commit](https://img.shields.io/github/last-commit/dezlov/PascalTZ)](https://github.com/dezlov/PascalTZ). `[FPC]` Pascal Time Zone allows you to convert between local times in various time zones and GMT/UTC, taking into account historical changes to time zone rules.

* [Charset Enigma ![GitHub Repo Stars](https://img.shields.io/github/stars/ms301/charset-enigma) ![GitHub last commit](https://img.shields.io/github/last-commit/ms301/charset-enigma)](https://github.com/ms301/charset-enigma). `[Delphi]` Delphi charset detector Community Edition

* [DelphiPatterns ![GitHub Repo Stars](https://img.shields.io/github/stars/jimmckeeth/DelphiPatterns) ![GitHub last commit](https://img.shields.io/github/last-commit/jimmckeeth/DelphiPatterns)](https://github.com/jimmckeeth/DelphiPatterns). `[Delphi]` Complete set of design patterns implemented in Delphi language

* [Markdown Processor for Pascal ![GitHub Repo Stars](https://img.shields.io/github/stars/grahamegrieve/delphi-markdown) ![GitHub last commit](https://img.shields.io/github/last-commit/grahamegrieve/delphi-markdown)](https://github.com/grahamegrieve/delphi-markdown). `[Delphi]` `[FPC]` This is a Pascal (Delphi) library that processes to markdown to HTML

* [Coroutine-based multithreading library ![GitHub Repo Stars](https://img.shields.io/github/stars/Purik/AIO) ![GitHub last commit](https://img.shields.io/github/last-commit/Purik/AIO)](https://github.com/Purik/AIO). `[Delphi]` AIO implement procedural oriented programming (POP) style in Delphi. It means developer can combine advantages of OOP and POP, splitting logic to multiple state machines, schedule them to threads, connect them by communication channels like in GoLang

* [Rapid.Generics ![GitHub Repo Stars](https://img.shields.io/github/stars/d-mozulyov/Rapid.Generics) ![GitHub last commit](https://img.shields.io/github/last-commit/d-mozulyov/Rapid.Generics)](https://github.com/d-mozulyov/Rapid.Generics). `[Delphi]` Rapid generics/defaults equivalent classes for Delphi (XE8+)

* [TZDB ![GitHub Repo Stars](https://img.shields.io/github/stars/pavkam/tzdb) ![GitHub last commit](https://img.shields.io/github/last-commit/pavkam/tzdb)](https://github.com/pavkam/tzdb). `[Delphi]` `[FPC]` IANA Time Zone Database for Delphi/FreePascal

* [PascalUtils ![GitHub Repo Stars](https://img.shields.io/github/stars/isemenkov/pascalutils) ![GitHub last commit](https://img.shields.io/github/last-commit/isemenkov/pascalutils)](https://github.com/isemenkov/pascalutils). `[Delphi]` `[FPC]` Delphi and object pascal library of utils data structures

* [libPasC-Algorithms ![GitHub Repo Stars](https://img.shields.io/github/stars/isemenkov/libpasc-algorithms) ![GitHub last commit](https://img.shields.io/github/last-commit/isemenkov/libpasc-algorithms)](https://github.com/isemenkov/libpasc-algorithms). `[Delphi]` `[FPC]` Delphi and object pascal library of common data structures and algorithms. Library rewritten from c-algorithms repository and other sources.

* [Delphi-Hunspell ![GitHub Repo Stars](https://img.shields.io/github/stars/darianmiller/Delphi-Hunspell) ![GitHub last commit](https://img.shields.io/github/last-commit/darianmiller/Delphi-Hunspell)](https://github.com/darianmiller/Delphi-Hunspell). `[Delphi]` Simple [Hunspell](http://hunspell.github.io) spell checking engine wrapper for Delphi.
...
* [Delphi LightSaber-CoreLib ![GitHub Repo Stars](https://img.shields.io/github/stars/GodModeUser/Delphi-LightSaber-CoreLib) ![GitHub last commit](https://img.shields.io/github/last-commit/GodModeUser/Delphi-LightSaber-CoreLib)](https://github.com/GodModeUser/Delphi-LightSaber-CoreLib). `[Delphi]` Lightweight alternative to Jedi library. Simple, crystal clear, non-obfuscated, fully commented code. No external dependencies. Hundreds of super useful functions for file/folder/disk manipulation, fast (buffered) binary file access, string conversions, OS version detection, etc.

* [LAMW ![GitHub Repo Stars](https://img.shields.io/github/stars/jmpessoa/lazandroidmodulewizard) ![GitHub last commit](https://img.shields.io/github/last-commit/jmpessoa/lazandroidmodulewizard)](https://github.com/jmpessoa/lazandroidmodulewizard). `[FPC]` Lazarus Android Module Wizard to create JNI Android loadable module (.so) and Android Apk using Lazarus/Free Pascal.

* [DCContainers ![GitHub Repo Stars](https://img.shields.io/github/stars/dsapolska/dccontainers) ![GitHub last commit](https://img.shields.io/github/last-commit/dsapolska/dccontainers)](https://github.com/dsapolska/dccontainers). `[Delphi]` Containers library with maps and sets based on red-black tree

* [DOSCommand ![GitHub Repo Stars](https://img.shields.io/github/stars/TurboPack/DOSCommand) ![GitHub last commit](https://img.shields.io/github/last-commit/TurboPack/DOSCommand)](https://github.com/TurboPack/DOSCommand). `[Delphi]` Component lets you execute a dos program (exe, com or batch file) and catch the ouput in order to put it in a memo or in a listbox, ... You can also send inputs.

* [TDiff ![GitHub Repo Stars](https://img.shields.io/github/stars/rickard67/TextDiff) ![GitHub last commit](https://img.shields.io/github/last-commit/rickard67/TextDiff)](https://github.com/rickard67/TextDiff). `[Delphi]` `[FPC]` Text compare component for Delphi and Free Pascal. Dramatically simplify programming tasks that require calculations of 'shortest path' or 'longest common sequence' as typically required in file compare utilities.

* [GraphQL for Delphi ![GitHub Repo Stars](https://img.shields.io/github/stars/lminuti/graphql) ![GitHub last commit](https://img.shields.io/github/last-commit/lminuti/graphql)](https://github.com/lminuti/graphql). `[Delphi]` Simple implementation for GraphQL, a query language for APIs created by Facebook. GraphQL is a query language for your API and a server-side runtime for executing queries using a type system you define for your data. GraphQL isn't tied to any specific database or storage engine and is instead backed by your existing code and data.

* [GraphQL Constructor ![GitHub Repo Stars](https://img.shields.io/github/stars/HemulGM/GraphQL) ![GitHub last commit](https://img.shields.io/github/last-commit/HemulGM/GraphQL)](https://github.com/HemulGM/GraphQL). `[Delphi]` GraphQL Constructor (constructor only)

* [ACBr (Commercial Automation Brazil)](https://sourceforge.net/projects/acbr/) ([GitHub mirror ![GitHub Repo Stars](https://img.shields.io/github/stars/ProjetoACBr/ACBr) ![GitHub last commit](https://img.shields.io/github/last-commit/ProjetoACBr/ACBr)](https://github.com/ProjetoACBr/ACBr), [Organization page in GitHub](https://github.com/Projeto-ACBr-Oficial). `[Delphi]` `[FPC]` Set of components and libraries for Delphi and Lazarus, designed to simplify the development of commercial automation systems in Brazil. It is widely used by developers who need to integrate their software with fiscal obligations and automation equipment
...
* [The Drag and Drop Component Suite ![GitHub Repo Stars](https://img.shields.io/github/stars/landrix/The-Drag-and-Drop-Component-Suite-for-Delphi) ![GitHub last commit](https://img.shields.io/github/last-commit/landrix/The-Drag-and-Drop-Component-Suite-for-Delphi)](https://github.com/landrix/The-Drag-and-Drop-Component-Suite-for-Delphi). `[Delphi]` VCL component library that enables your Delphi and C++Builder applications to support COM based drag and drop and integrate with the Windows clipboard.

* [TSMBIOS ![GitHub Repo Stars](https://img.shields.io/github/stars/RRUZ/tsmbios) ![GitHub last commit](https://img.shields.io/github/last-commit/RRUZ/tsmbios)](https://github.com/RRUZ/tsmbios). `[Delphi]` `[FPC]` Allows access the System Management BIOS (SMBIOS) using the Object Pascal language (Delphi or Free Pascal). The SMBIOS (System Management BIOS) is a standard developed by the DMTF. The information stored in the SMBIOS includes devices manufacturer, model name, serial number, BIOS version, asset tag, processors, ports and device memory installed.
...
* [WindowsAutorun ![GitHub Repo Stars](https://img.shields.io/github/stars/ms301/WindowsAutorun) ![GitHub last commit](https://img.shields.io/github/last-commit/ms301/WindowsAutorun)](https://github.com/ms301/WindowsAutorun). `[Delphi]` Helps you manage autoload in Windows OS.

* [ActiveDirectory4Delphi ![GitHub Repo Stars](https://img.shields.io/github/stars/EdZava/VCL-ActiveDirectory4Delphi) ![GitHub last commit](https://img.shields.io/github/last-commit/EdZava/VCL-ActiveDirectory4Delphi)](https://github.com/EdZava/VCL-ActiveDirectory4Delphi). `[Delphi]` Delphi basic library for validation and authentication of LDAP users in Active Directory.

* [SVGShellExtensions ![GitHub Repo Stars](https://img.shields.io/github/stars/EtheaDev/SVGShellExtensions) ![GitHub last commit](https://img.shields.io/github/last-commit/EtheaDev/SVGShellExtensions)](https://github.com/EtheaDev/SVGShellExtensions). `[Delphi]` Shell extensions for SVG files (Preview Panel, Thumbnail Icon, SVG Editor)

* [MarkdownShellExtensions ![GitHub Repo Stars](https://img.shields.io/github/stars/EtheaDev/MarkdownShellExtensions) ![GitHub last commit](https://img.shields.io/github/last-commit/EtheaDev/MarkdownShellExtensions)](https://github.com/EtheaDev/MarkdownShellExtensions). `[Delphi]` Markdown file Shell Extensions for Windows Explorer plus a Markdown file editor with instant preview
...
* [FortesReport ![GitHub Repo Stars](https://img.shields.io/github/stars/fortesinformatica/fortesreport-ce) ![GitHub last commit](https://img.shields.io/github/last-commit/fortesinformatica/fortesreport-ce)](https://github.com/fortesinformatica/fortesreport-ce). `[Delphi]` The FortesReport is a powerful report generator available as a package of components for Delphi.

* [mORMotReport ![GitHub Repo Stars](https://img.shields.io/github/stars/synopse/mORMot) ![GitHub last commit](https://img.shields.io/github/last-commit/synopse/mORMot)](https://github.com/synopse/mORMot/blob/master/SQLite3/mORMotReport.pas) ([docs](http://synopse.info/files/html/api-1.18/mORMotReport.html)). `[Delphi]` Fast and efficient code-based reporting component, with preview form and PDF export.

* [Kryvich's Delphi Reporter ![GitHub Repo Stars](https://img.shields.io/github/stars/Kryuski/kryvich-delphi-reporter) ![GitHub last commit](https://img.shields.io/github/last-commit/Kryuski/kryvich-delphi-reporter)](https://github.com/Kryuski/kryvich-delphi-reporter). `[Delphi]` Simple but powerful reporting tool for Embarcadero's (CodeGear, Borland) Delphi. It generates reports in TXT, RTF, HTML and XML formats based on custom templates and information from any TDataSet compatible data sets.


## Unit Testing ##

* [DUnitX ![GitHub Repo Stars](https://img.shields.io/github/stars/VSoftTechnologies/DUnitX) ![GitHub last commit](https://img.shields.io/github/last-commit/VSoftTechnologies/DUnitX)](https://github.com/VSoftTechnologies/DUnitX). `[Delphi]` New test framework, taking ideas from DUnit, NUnit and other test frameworks. It is designed to work with Delphi 2010 or later, it makes use of language/RTL features that are not available in older versions of Delphi.
...
* [DelphiSpec ![GitHub Repo Stars](https://img.shields.io/github/stars/RomanYankovsky/DelphiSpec) ![GitHub last commit](https://img.shields.io/github/last-commit/RomanYankovsky/DelphiSpec)](https://github.com/RomanYankovsky/DelphiSpec). `[Delphi]` Library for running automated tests written in plain language. Because they're written in plain language, they can be read by anyone on your team. Because they can be read by anyone, you can use them to help improve communication, collaboration and trust on your team.

* [Delphi-Mocks ![GitHub Repo Stars](https://img.shields.io/github/stars/VSoftTechnologies/Delphi-Mocks) ![GitHub last commit](https://img.shields.io/github/last-commit/VSoftTechnologies/Delphi-Mocks)](https://github.com/VSoftTechnologies/Delphi-Mocks). `[Delphi]` Simple mocking framework for Delphi XE2 or later. Allow you to mock both classes and interfaces for testing.

* [DUnit-XML ![GitHub Repo Stars](https://img.shields.io/github/stars/VSoftTechnologies/DUnit-XML) ![GitHub last commit](https://img.shields.io/github/last-commit/VSoftTechnologies/DUnit-XML)](https://github.com/VSoftTechnologies/DUnit-XML). `[Delphi]` Test runner that allows DUnit Tests to output NUnit compatible XML.

* [Smoketest ![GitHub Repo Stars](https://img.shields.io/github/stars/deltics/delphi.libs) ![GitHub last commit](https://img.shields.io/github/last-commit/deltics/delphi.libs)](https://github.com/deltics/delphi.libs/tree/master/smoketest). `[Delphi]` Framework for writing tests and performance benchmarks using the Delphi language for Microsoft Windows. It has been tested on all versions of Delphi from 7 thru to 2010.

* [SynTests ![GitHub Repo Stars](https://img.shields.io/github/stars/synopse/mORMot) ![GitHub last commit](https://img.shields.io/github/last-commit/synopse/mORMot)](https://github.com/synopse/mORMot/blob/master/SynTests.pas). `[Delphi]` `[FPC]` Unit test functions including mocks and stubs.

* [OpenCTF ![GitHub Repo Stars](https://img.shields.io/github/stars/michaelJustin/openctf) ![GitHub last commit](https://img.shields.io/github/last-commit/michaelJustin/openctf)](https://github.com/michaelJustin/openctf). `[Delphi]` (Previous [homepage](http://web.archive.org/web/20090418162025/https://sourceforge.net/projects/openctf/)) Test framework add-on for Embarcadero Delphi which performs automatic checks of all components in Forms (or DataModules). It provides an easy way to build automatic quality checks for large projects where many components have to pass repeated tests. OpenCTF is based on the DUnit open source test framework and extends it by specialized test classes and helper functions.

* [DelphiUIAutomation ![GitHub Repo Stars](https://img.shields.io/github/stars/jhc-systems/DelphiUIAutomation) ![GitHub last commit](https://img.shields.io/github/last-commit/jhc-systems/DelphiUIAutomation)](https://github.com/jhc-systems/DelphiUIAutomation). `[Delphi]` Delphi classes that wrap the MS UIAutomation library. DelphiUIAutomation is a framework for automating rich client applications based on Win32 (and specifically tested with Delphi XE5). It is written in Delphi XE5 and it requires no use of scripting languages. It provides a consistent object-oriented API, hiding the complexity of Microsoft's UIAutomation library and windows messages.

* [DelphiCodeCoverageWizardPlus ![GitHub Repo Stars](https://img.shields.io/github/stars/MHumm/delphi-code-coverage-wizard-plus) ![GitHub last commit](https://img.shields.io/github/last-commit/MHumm/delphi-code-coverage-wizard-plus)](https://github.com/MHumm/delphi-code-coverage-wizard-plus). `[Delphi]` GUI wizard for creating a batch file to call the commandline code coverage tool. Includes a project format for easier change of settings later on. Includes binaries of the code coverage tool itssel.
...
* [JclDebug (part of Project JEDI) ![GitHub Repo Stars](https://img.shields.io/github/stars/project-jedi/jcl) ![GitHub last commit](https://img.shields.io/github/last-commit/project-jedi/jcl)](https://github.com/project-jedi/jcl/blob/master/jcl/source/windows/JclDebug.pas). `[Delphi]` `[FPC]` Tracing, MAP file parser, exception report generation, exception stack traces.

* [DebugEngine ![GitHub Repo Stars](https://img.shields.io/github/stars/MahdiSafsafi/DebugEngine) ![GitHub last commit](https://img.shields.io/github/last-commit/MahdiSafsafi/DebugEngine)](https://github.com/MahdiSafsafi/DebugEngine). `[Delphi]` Collection of utilities related to debug stuff (stack trace, CPU registers snapshot, debug info, etc). Accessing Delphi debug info, Getting address of symbol from its name, Delphi map parsing and map converter to binary format, Smart stack trace, Delphi exception stack trace hook, etc.

* [ObjectDebugger ![GitHub Repo Stars](https://img.shields.io/github/stars/marcocantu/ObjectDebugger) ![GitHub last commit](https://img.shields.io/github/last-commit/marcocantu/ObjectDebugger)](https://github.com/marcocantu/ObjectDebugger). `[Delphi]` Run-time Object Inspector for Delphi VCL applications.

* [Capstone4Delphi ![GitHub Repo Stars](https://img.shields.io/github/stars/Pigrecos/Capstone4Delphi) ![GitHub last commit](https://img.shields.io/github/last-commit/Pigrecos/Capstone4Delphi)](https://github.com/Pigrecos/Capstone4Delphi). `[Delphi]` [Capstone Disassembler Library](http://www.capstone-engine.org/) Binding for Delphi
...
* [ResEd ![GitHub Repo Stars](https://img.shields.io/github/stars/chaosben/theunknownones) ![GitHub last commit](https://img.shields.io/github/last-commit/chaosben/theunknownones)](https://github.com/chaosben/theunknownones). Expert for Delphi 2005, 2006, 2007, 2009, 2010 and XE. This expert is designed for editing the resource files (.res; .resx) that are linked to the active project. It will automatically search for all occurrences of {$R xyz.res} lines and will open/create resourcefiles for them. The expert registers itself in the menubar of Delphi under View.

* [Parnassus Bookmarks](https://parnassus.co/delphi-tools/bookmarks). IDE plugin that extends bookmark functionality.

* [DelphiSettingManager ![GitHub Repo Stars](https://img.shields.io/github/stars/Arvur/DelphiSettingManager) ![GitHub last commit](https://img.shields.io/github/last-commit/Arvur/DelphiSettingManager)](https://github.com/Arvur/DelphiSettingManager). Multiple IDE profiles for Delphi (up to XE6). Allows to install multiple versions of the same component or different component sets for different projects.

* [Delphinus ![GitHub Repo Stars](https://img.shields.io/github/stars/Memnarch/Delphinus) ![GitHub last commit](https://img.shields.io/github/last-commit/Memnarch/Delphinus)](https://github.com/Memnarch/Delphinus). New Packagemanager which runs on Delphi XE and newer and uses GitHub as a Backend to Provide the packages.
...
* [Delphi IDE Explorer ![GitHub Repo Stars](https://img.shields.io/github/stars/DGH2112/Delphi-IDE-Explorer) ![GitHub last commit](https://img.shields.io/github/last-commit/DGH2112/Delphi-IDE-Explorer)](https://github.com/DGH2112/Delphi-IDE-Explorer). Wizard / expert / plugin that allows you to browser the internal fields, methods, properties and events of the IDE.
// *Mainly useful for developers of IDE experts*

* [Multi-RAD Studio IDE Expert Manager ![GitHub Repo Stars](https://img.shields.io/github/stars/DGH2112/Expert-Manager) ![GitHub last commit](https://img.shields.io/github/last-commit/DGH2112/Expert-Manager)](https://github.com/DGH2112/Expert-Manager). Application allows you to manage the experts and packages loadsed into multiple versions of RAD Studio

* [OTA Interface Search ![GitHub Repo Stars](https://img.shields.io/github/stars/DGH2112/OTA-Interface-Search) ![GitHub last commit](https://img.shields.io/github/last-commit/DGH2112/OTA-Interface-Search)](https://github.com/DGH2112/OTA-Interface-Search). Application helps to find Open Tools API (OTA) interfaces, methods and properties and understand how to get to those interfaces or methods / properties of the interfaces.

* [AutoSave ![GitHub Repo Stars](https://img.shields.io/github/stars/DGH2112/Auto-Save) ![GitHub last commit](https://img.shields.io/github/last-commit/DGH2112/Auto-Save)](https://github.com/DGH2112/Auto-Save). Expert that periodically auto saves all the open modified IDE files.

* [Browse and Doc It ![GitHub Repo Stars](https://img.shields.io/github/stars/DGH2112/Browse-and-Doc-It) ![GitHub last commit](https://img.shields.io/github/last-commit/DGH2112/Browse-and-Doc-It)](https://github.com/DGH2112/Browse-and-Doc-It). RAD Studio IDE plug-in to allow you to browse your code and provide support for documentation, coding checks and metrics.

* [Integrated Testing Helper ![GitHub Repo Stars](https://img.shields.io/github/stars/DGH2112/Integrated-Testing-Helper) ![GitHub last commit](https://img.shields.io/github/last-commit/DGH2112/Integrated-Testing-Helper)](https://github.com/DGH2112/Integrated-Testing-Helper). Plugin for Delphi and RAD Studio that allows you to run command-line application before and after the compilation of you projects. It also provides the ability to zip you projects files into an archive on each compile/build and manage the application's version information.
...
* [Delphi Library Helper ![GitHub Repo Stars](https://img.shields.io/github/stars/littleearth/delphi-library-helper) ![GitHub last commit](https://img.shields.io/github/last-commit/littleearth/delphi-library-helper)](https://github.com/littleearth/delphi-library-helper) Tool to assist Delphi developers configuring library folders.

* [Mobile Image Creator ![GitHub Repo Stars](https://img.shields.io/github/stars/littleearth/mobile-image-creator) ![GitHub last commit](https://img.shields.io/github/last-commit/littleearth/mobile-image-creator)](https://github.com/littleearth/mobile-image-creator) Creating Icons and Launcher Images for Delphi Mobile Applications (Firemonkey). This is a fork of Mobile Gfx created by [Thomas Grubb of RiverSoftAVG](http://riversoftavg.com/blogs/index.php/2014/02/03/creating-icons-and-launchers-for-delphi-mobile-applications/).

* [Delphi-Adb-WiFi ![GitHub Repo Stars](https://img.shields.io/github/stars/ms301/Delphi-Adb-WiFi) ![GitHub last commit](https://img.shields.io/github/last-commit/ms301/Delphi-Adb-WiFi)](https://github.com/ms301/Delphi-Adb-WiFi). Plugin for RAD Studio, which allows launching and debugging on an Android device without connecting to a computer via USB. Works over WiFi.

* [RADSplit ![GitHub Repo Stars](https://img.shields.io/github/stars/LaKraven/RADSplit) ![GitHub last commit](https://img.shields.io/github/last-commit/LaKraven/RADSplit)](https://github.com/LaKraven/RADSplit). Dockable Split-Screen Editors for RAD Studio (Delphi and C++ Builder).

* [DzNoteEditor ![GitHub Repo Stars](https://img.shields.io/github/stars/digao-dalpiaz/DzNoteEditor) ![GitHub last commit](https://img.shields.io/github/last-commit/digao-dalpiaz/DzNoteEditor)](https://github.com/digao-dalpiaz/DzNoteEditor). Delphi Property Editor for TStrings supporting formatted languages with syntax highlight.
...
* [Pascal ![GitHub Repo Stars](https://img.shields.io/github/stars/alefragnani/vscode-language-pascal) ![GitHub last commit](https://img.shields.io/github/last-commit/alefragnani/vscode-language-pascal)](https://github.com/alefragnani/vscode-language-pascal) and [Pascal Formatter ![GitHub Repo Stars](https://img.shields.io/github/stars/alefragnani/vscode-pascal-formatter) ![GitHub last commit](https://img.shields.io/github/last-commit/alefragnani/vscode-pascal-formatter)](https://github.com/alefragnani/vscode-pascal-formatter). Open source extensions created for Visual Studio Code that add Pascal support.

* [Intellij IDEA Object Pascal plugin ![GitHub Repo Stars](https://img.shields.io/github/stars/casteng/i-pascal) ![GitHub last commit](https://img.shields.io/github/last-commit/casteng/i-pascal)](https://github.com/casteng/i-pascal). `[Delphi]` `[FPC]` A free Object Pascal language plugin for IntelliJ IDEA


## Documentation

* [SynProject ![GitHub Repo Stars](https://img.shields.io/github/stars/synopse/SynProject) ![GitHub last commit](https://img.shields.io/github/last-commit/synopse/SynProject)](https://github.com/synopse/SynProject) ([docs](http://synopse.info/fossil/wiki?name=SynProject)). Tool for code source versioning and automated documentation of Delphi projects.
...
* [GpProfiler2017 ![GitHub Repo Stars](https://img.shields.io/github/stars/ase379/gpprofile2017) ![GitHub last commit](https://img.shields.io/github/last-commit/ase379/gpprofile2017)](https://github.com/ase379/gpprofile2017). `[Delphi]` Source code instrumenting profiler for Delphi XE and higher. Other forks support older versions.
...
* [Delphi Code Coverage ![GitHub Repo Stars](https://img.shields.io/github/stars/DelphiCodeCoverage/DelphiCodeCoverage) ![GitHub last commit](https://img.shields.io/github/last-commit/DelphiCodeCoverage/DelphiCodeCoverage)](https://github.com/DelphiCodeCoverage/DelphiCodeCoverage). `[Delphi]` Simple Code Coverage tool for Delphi that creates code coverage reports based on detailed MAP files.
...
* [delphiunitsizes ![GitHub Repo Stars](https://img.shields.io/github/stars/VilleKrumlinde/delphiunitsizes) ![GitHub last commit](https://img.shields.io/github/last-commit/VilleKrumlinde/delphiunitsizes)](https://github.com/VilleKrumlinde/delphiunitsizes). `[Delphi]` Tool to display the sizes of each unit in a Delphi executable. Shows the size of each unit that is included in a Delphi exe-file. It also shows an approximate size of each symbol (classes, methods, procedures etc) in a unit.
...
* [Spider ![GitHub Repo Stars](https://img.shields.io/github/stars/yavfast/dbg-spider) ![GitHub last commit](https://img.shields.io/github/last-commit/yavfast/dbg-spider)](https://github.com/yavfast/dbg-spider). `[Delphi]` Real time profiler for Delphi applications
...
* [WinSparkle](https://winsparkle.org) and its [Delphi wrapper ![GitHub Repo Stars](https://img.shields.io/github/stars/jkour/neSparkleComponent) ![GitHub last commit](https://img.shields.io/github/last-commit/jkour/neSparkleComponent)](https://github.com/jkour/neSparkleComponent). WinSparkle is an easy-to-use software update library for Windows developers. WinSparkle is a heavily (to the point of being its almost-port) inspired by the Sparkle framework originally by Andy Matuschak that became the de facto standard for software updates on macOS.
...
* [WMI Delphi Code Creator ![GitHub Repo Stars](https://img.shields.io/github/stars/RRUZ/wmi-delphi-code-creator) ![GitHub last commit](https://img.shields.io/github/last-commit/RRUZ/wmi-delphi-code-creator)](https://github.com/RRUZ/wmi-delphi-code-creator). Allows you to generate Object Pascal, Oxygene, C++ and C# code to access the WMI (Windows Management Instrumentation) classes, events and methods. Also includes a set of tools to explorer and Query the content of the WMI.

* [Delphi Preview Handler ![GitHub Repo Stars](https://img.shields.io/github/stars/RRUZ/delphi-preview-handler) ![GitHub last commit](https://img.shields.io/github/last-commit/RRUZ/delphi-preview-handler)](https://github.com/RRUZ/delphi-preview-handler). Preview handler for Windows Vista, 7 and 8 which allow you read your object pascal, C++ and Assembly code with Syntax highlighting without open in a editor

* [Delphi Dev. Shell Tools ![GitHub Repo Stars](https://img.shields.io/github/stars/RRUZ/delphi-dev-shell-tools) ![GitHub last commit](https://img.shields.io/github/last-commit/RRUZ/delphi-dev-shell-tools)](https://github.com/RRUZ/delphi-dev-shell-tools). Windows shell extension with useful tasks for Object Pascal Developers (Delphi, Free Pascal).

* [Delphi.gitignore ![GitHub Repo Stars](https://img.shields.io/github/stars/github/gitignore) ![GitHub last commit](https://img.shields.io/github/last-commit/github/gitignore)](https://github.com/github/gitignore). .gitignore templates for Delphi. There is also one for Lazarus.
...
* [Delphi Unit Tests ![GitHub Repo Stars](https://img.shields.io/github/stars/NickHodges/DelphiUnitTests) ![GitHub last commit](https://img.shields.io/github/last-commit/NickHodges/DelphiUnitTests)](https://github.com/NickHodges/DelphiUnitTests). Set of unit tests for Delphi's libraries. Delphi community members are encouraged to fork the repository, add tests, and create a pull request. Embarcadero employees are particularly encouraged to add tests from the internal tests that are run with official Delphi builds.
...
* [Chet - C Header Translator for Delphi ![GitHub Repo Stars](https://img.shields.io/github/stars/neslib/Chet) ![GitHub last commit](https://img.shields.io/github/last-commit/neslib/Chet)](https://github.com/neslib/Chet). Chet is a .h-to-.pas translator powered by libclang for Delphi. Uses the Clang compiler to parse header files, resulting in more accurate translations that require fewer manual adjustments.

* [Boss ![GitHub Repo Stars](https://img.shields.io/github/stars/HashLoad/boss) ![GitHub last commit](https://img.shields.io/github/last-commit/HashLoad/boss)](https://github.com/HashLoad/boss). Dependency Manager for Delphi projects.
...
* [DFMJSON ![GitHub Repo Stars](https://img.shields.io/github/stars/masonwheeler/DFMJSON) ![GitHub last commit](https://img.shields.io/github/last-commit/masonwheeler/DFMJSON)](https://github.com/masonwheeler/DFMJSON). `[Delphi]` Library to convert between Delphi's .DFM (or .FMX) format and JSON. It can be used to parse a DFM file into an Abstract Syntax Tree in JSON, which can then be edited and the results turned back to DFM format.
