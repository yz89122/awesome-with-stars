...
A repo of complete Reflex examples can be found [here. ![GitHub Repo Stars](https://img.shields.io/github/stars/reflex-dev/reflex-examples) ![GitHub last commit](https://img.shields.io/github/last-commit/reflex-dev/reflex-examples)](https://github.com/reflex-dev/reflex-examples)

Reflex's own website was built using Reflex! See [code on GitHub. ![GitHub Repo Stars](https://img.shields.io/github/stars/reflex-dev/reflex-web) ![GitHub last commit](https://img.shields.io/github/last-commit/reflex-dev/reflex-web)](https://github.com/reflex-dev/reflex-web)
...
- [Embed Checkout in Reflex ![GitHub Repo Stars](https://img.shields.io/github/stars/joyhchen/reflex-embedded-checkout) ![GitHub last commit](https://img.shields.io/github/last-commit/joyhchen/reflex-embedded-checkout)](https://github.com/joyhchen/reflex-embedded-checkout) - Stripe embedded checkout implementation
