...
- [Apache APISIX (⭐15k) ![GitHub Repo Stars](https://img.shields.io/github/stars/apache/apisix) ![GitHub last commit](https://img.shields.io/github/last-commit/apache/apisix)](https://github.com/apache/apisix) - A high-performance, dynamic gateway featuring real-time traffic management and powerful plugin integrations.
...
- [Envoy Gateway (⭐2.3k) ![GitHub Repo Stars](https://img.shields.io/github/stars/envoyproxy/gateway) ![GitHub last commit](https://img.shields.io/github/last-commit/envoyproxy/gateway)](https://github.com/envoyproxy/gateway) - CNCF Envoy-based gateway with Gateway API, mTLS, JWT, and other built-ins.
- [Gloo Edge (⭐139) ![GitHub Repo Stars](https://img.shields.io/github/stars/solo-io/gloo) ![GitHub last commit](https://img.shields.io/github/last-commit/solo-io/gloo)](https://github.com/solo-io/gloo) - An Envoy Proxy–based gateway offering advanced traffic control, enhanced security, and observability for microservices ecosystems.
...
- API clients
   ...
   - [Bruno (⭐39k) ![GitHub Repo Stars](https://img.shields.io/github/stars/usebruno/bruno) ![GitHub last commit](https://img.shields.io/github/last-commit/usebruno/bruno)](https://github.com/usebruno/bruno) - A fast, offline API client designed for git-friendly workflows and seamless testing.
   ...
   - [Requestly (⭐5.8k) ![GitHub Repo Stars](https://img.shields.io/github/stars/requestly/requestly) ![GitHub last commit](https://img.shields.io/github/last-commit/requestly/requestly)](https://github.com/requestly/requestly) - Lightweight Git-Friendly API Client Built for Modern Developers.
...
- MQ clients
   ...
   - [kcat (⭐5.6k) ![GitHub Repo Stars](https://img.shields.io/github/stars/edenhill/kcat) ![GitHub last commit](https://img.shields.io/github/last-commit/edenhill/kcat)](https://github.com/edenhill/kcat) - A lightweight command-line tool for Apache Kafka, providing efficient message production and consumption.
   - [MQTT Explorer (⭐3.6k) ![GitHub Repo Stars](https://img.shields.io/github/stars/thomasnordquist/MQTT-Explorer) ![GitHub last commit](https://img.shields.io/github/last-commit/thomasnordquist/MQTT-Explorer)](https://github.com/thomasnordquist/MQTT-Explorer) - A detailed MQTT client delivering structured topic visualization and intuitive debugging.
...
- Mocking tools
   ...
   - [Imposter (⭐400) ![GitHub Repo Stars](https://img.shields.io/github/stars/outofcoffee/imposter) ![GitHub last commit](https://img.shields.io/github/last-commit/outofcoffee/imposter)](https://github.com/outofcoffee/imposter) - A flexible mock server supporting REST, OpenAPI, SOAP, and more to simulate diverse API behaviors.
   - [Microcks (⭐1.7k) ![GitHub Repo Stars](https://img.shields.io/github/stars/microcks/microcks) ![GitHub last commit](https://img.shields.io/github/last-commit/microcks/microcks)](https://github.com/microcks/microcks) - A Kubernetes-native tool for API mocking and testing that supports AsyncAPI, OpenAPI, and Postman Collections.
   ...
   - [Mockbin (⭐131) ![GitHub Repo Stars](https://img.shields.io/github/stars/zuplo/mockbin) ![GitHub last commit](https://img.shields.io/github/last-commit/zuplo/mockbin)](https://github.com/zuplo/mockbin) - A simple endpoint generator for testing HTTP requests with real-time logging and feedback.
   - [Mockoon (⭐7.9k) ![GitHub Repo Stars](https://img.shields.io/github/stars/mockoon/mockoon) ![GitHub last commit](https://img.shields.io/github/last-commit/mockoon/mockoon)](https://github.com/mockoon/mockoon) - A user-friendly tool for designing and running mock REST APIs with real-time simulation and easy setup.
   ...
   - [Prism (⭐4.7k) ![GitHub Repo Stars](https://img.shields.io/github/stars/stoplightio/prism) ![GitHub last commit](https://img.shields.io/github/last-commit/stoplightio/prism)](https://github.com/stoplightio/prism) - An open-source HTTP mock server that replicates API behavior for early testing and validation.
   - [WireMock (⭐7k) ![GitHub Repo Stars](https://img.shields.io/github/stars/tomakehurst/wiremock) ![GitHub last commit](https://img.shields.io/github/last-commit/tomakehurst/wiremock)](https://github.com/tomakehurst/wiremock) - A robust and flexible API mocking tool delivering reliable, real-time simulation for comprehensive testing.
- Testing tools and frameworks
   - [Apache JMeter (⭐9.1k) ![GitHub Repo Stars](https://img.shields.io/github/stars/apache/jmeter) ![GitHub last commit](https://img.shields.io/github/last-commit/apache/jmeter)](https://github.com/apache/jmeter) - A feature-rich tool for load testing and performance analysis across diverse web applications and services.
...
- [Estuary Flow (⭐858) ![GitHub Repo Stars](https://img.shields.io/github/stars/estuary/flow) ![GitHub last commit](https://img.shields.io/github/last-commit/estuary/flow)](https://github.com/estuary/flow) - Versatile, scalable platform that provides both real-time and batch data integration for ETL and ELT pipelines.
...
- [Apache ActiveMQ Artemis (⭐996) ![GitHub Repo Stars](https://img.shields.io/github/stars/apache/activemq-artemis) ![GitHub last commit](https://img.shields.io/github/last-commit/apache/activemq-artemis)](https://github.com/apache/activemq-artemis) - Next-generation message broker from Apache ActiveMQ with high performance, clustering support, and multi-protocol capabilities.
...
- [LavinMQ (⭐831) ![GitHub Repo Stars](https://img.shields.io/github/stars/cloudamqp/lavinmq) ![GitHub last commit](https://img.shields.io/github/last-commit/cloudamqp/lavinmq)](https://github.com/cloudamqp/lavinmq) - High-performance message queue server implementing AMQP 0-9-1 and MQTT protocols, built with Crystal for exceptional throughput and minimal resource usage.
- [NATS (⭐18k) ![GitHub Repo Stars](https://img.shields.io/github/stars/nats-io/gnatsd) ![GitHub last commit](https://img.shields.io/github/last-commit/nats-io/gnatsd)](https://github.com/nats-io/gnatsd) - Lightweight, high-performance messaging system ideal for microservices and cloud-native architectures.
...
- [n8n (⭐163k) ![GitHub Repo Stars](https://img.shields.io/github/stars/n8n-io/n8n) ![GitHub last commit](https://img.shields.io/github/last-commit/n8n-io/n8n)](https://github.com/n8n-io/n8n) - Open-source workflow automation tool with 400+ connectors, giving you full control over your data and integrations.
...
- [Bonita (⭐169) ![GitHub Repo Stars](https://img.shields.io/github/stars/bonitasoft/bonita-engine) ![GitHub last commit](https://img.shields.io/github/last-commit/bonitasoft/bonita-engine)](https://github.com/bonitasoft/bonita-engine) - Open-source BPMN engine with a designer interface to build and automate complex business processes.
- [Cadence (⭐9k) ![GitHub Repo Stars](https://img.shields.io/github/stars/uber/cadence) ![GitHub last commit](https://img.shields.io/github/last-commit/uber/cadence)](https://github.com/uber/cadence) - Fault-tolerant, stateful platform that reliably orchestrates long-running workflows and complex applications.
...
- [StackStorm (⭐6.3k) ![GitHub Repo Stars](https://img.shields.io/github/stars/StackStorm/st2) ![GitHub last commit](https://img.shields.io/github/last-commit/StackStorm/st2)](https://github.com/StackStorm/st2) - Robust automation engine that combines sensors, triggers, and workflows to orchestrate complex IT processes.
- [Temporal (⭐17k) ![GitHub Repo Stars](https://img.shields.io/github/stars/temporalio/temporal) ![GitHub last commit](https://img.shields.io/github/last-commit/temporalio/temporal)](https://github.com/temporalio/temporal) - Open-source workflow-as-code platform designed for building reliable, scalable, and fault-tolerant applications. 
