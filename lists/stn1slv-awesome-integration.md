...
- [Estuary Flow (⭐908) ![GitHub Repo Stars](https://img.shields.io/github/stars/estuary/flow) ![GitHub last commit](https://img.shields.io/github/last-commit/estuary/flow)](https://github.com/estuary/flow) - Versatile, scalable platform that provides both real-time and batch data integration for ETL and ELT pipelines.
