...
- API clients
   - [Advanced REST Client (⭐1.4k) ![GitHub Repo Stars](https://img.shields.io/github/stars/advanced-rest-client/arc-electron) ![GitHub last commit](https://img.shields.io/github/last-commit/advanced-rest-client/arc-electron)](https://github.com/advanced-rest-client/arc-electron) - A robust open-source API client for testing and debugging RESTful services with an intuitive interface.
   ...
   - [posting (⭐11k) ![GitHub Repo Stars](https://img.shields.io/github/stars/darrenburns/posting) ![GitHub last commit](https://img.shields.io/github/last-commit/darrenburns/posting)](https://github.com/darrenburns/posting) - A modern, terminal-based API client designed for efficient and seamless API interactions.
   ...
   - [resty (⭐2.6k) ![GitHub Repo Stars](https://img.shields.io/github/stars/micha/resty) ![GitHub last commit](https://img.shields.io/github/last-commit/micha/resty)](https://github.com/micha/resty) - A Lua-based HTTP client framework providing an interactive shell for streamlined REST service testing.
...
- Mocking tools
   ...
   - [Imposter (⭐408) ![GitHub Repo Stars](https://img.shields.io/github/stars/outofcoffee/imposter) ![GitHub last commit](https://img.shields.io/github/last-commit/outofcoffee/imposter)](https://github.com/outofcoffee/imposter) - A flexible mock server supporting REST, OpenAPI, SOAP, and more to simulate diverse API behaviors.
   ...
   - [Mockbin (⭐141) ![GitHub Repo Stars](https://img.shields.io/github/stars/zuplo/mockbin) ![GitHub last commit](https://img.shields.io/github/last-commit/zuplo/mockbin)](https://github.com/zuplo/mockbin) - A simple endpoint generator for testing HTTP requests with real-time logging and feedback.
   ...
   - [WireMock (⭐7.2k) ![GitHub Repo Stars](https://img.shields.io/github/stars/tomakehurst/wiremock) ![GitHub last commit](https://img.shields.io/github/last-commit/tomakehurst/wiremock)](https://github.com/tomakehurst/wiremock) - A robust and flexible API mocking tool delivering reliable, real-time simulation for comprehensive testing.
...
- [Easy Rules (⭐5.2k) ![GitHub Repo Stars](https://img.shields.io/github/stars/j-easy/easy-rules) ![GitHub last commit](https://img.shields.io/github/last-commit/j-easy/easy-rules)](https://github.com/j-easy/easy-rules) - Lightweight Java-based rules engine designed for straightforward rule processing and rapid decision automation.
...
- [Estuary Flow (⭐932) ![GitHub Repo Stars](https://img.shields.io/github/stars/estuary/flow) ![GitHub last commit](https://img.shields.io/github/last-commit/estuary/flow)](https://github.com/estuary/flow) - Versatile, scalable platform that provides both real-time and batch data integration for ETL and ELT pipelines.
...
- [LavinMQ (⭐958) ![GitHub Repo Stars](https://img.shields.io/github/stars/cloudamqp/lavinmq) ![GitHub last commit](https://img.shields.io/github/last-commit/cloudamqp/lavinmq)](https://github.com/cloudamqp/lavinmq) - High-performance message queue server implementing AMQP 0-9-1 and MQTT protocols, built with Crystal for exceptional throughput and minimal resource usage.
- [NATS (⭐19k) ![GitHub Repo Stars](https://img.shields.io/github/stars/nats-io/gnatsd) ![GitHub last commit](https://img.shields.io/github/last-commit/nats-io/gnatsd)](https://github.com/nats-io/gnatsd) - Lightweight, high-performance messaging system ideal for microservices and cloud-native architectures.
...
- [n8n (⭐190k) ![GitHub Repo Stars](https://img.shields.io/github/stars/n8n-io/n8n) ![GitHub last commit](https://img.shields.io/github/last-commit/n8n-io/n8n)](https://github.com/n8n-io/n8n) - Open-source workflow automation tool with 400+ connectors, giving you full control over your data and integrations.
...
- [Camunda (⭐4.2k) ![GitHub Repo Stars](https://img.shields.io/github/stars/camunda/camunda-bpm-platform) ![GitHub last commit](https://img.shields.io/github/last-commit/camunda/camunda-bpm-platform)](https://github.com/camunda/camunda-bpm-platform) - Flexible workflow and decision automation platform designed for scalable business process management.
- [Conductor (⭐12k) ![GitHub Repo Stars](https://img.shields.io/github/stars/Netflix/conductor) ![GitHub last commit](https://img.shields.io/github/last-commit/Netflix/conductor)](https://github.com/Netflix/conductor) - Cloud-based orchestration engine that manages microservices workflows, streamlining complex process automation.
