...
- [KrakenD API Gateway (⭐2.5k) ![GitHub Repo Stars](https://img.shields.io/github/stars/devopsfaith/krakend-ce) ![GitHub last commit](https://img.shields.io/github/last-commit/devopsfaith/krakend-ce)](https://github.com/devopsfaith/krakend-ce) - An ultra-high performance gateway with efficient middleware configuration, robust security, and seamless scaling.
- [Ocelot (⭐8.6k) ![GitHub Repo Stars](https://img.shields.io/github/stars/ThreeMammals/Ocelot) ![GitHub last commit](https://img.shields.io/github/last-commit/ThreeMammals/Ocelot)](https://github.com/ThreeMammals/Ocelot) - A .NET-based gateway offering intuitive routing and easy integration for lightweight API management.
...
- Testing tools and frameworks
   ...
   - [Gatling (⭐6.8k) ![GitHub Repo Stars](https://img.shields.io/github/stars/gatling/gatling) ![GitHub last commit](https://img.shields.io/github/last-commit/gatling/gatling)](https://github.com/gatling/gatling) - A powerful load testing framework with a developer-friendly DSL that delivers detailed performance metrics.
...
- [Estuary Flow (⭐909) ![GitHub Repo Stars](https://img.shields.io/github/stars/estuary/flow) ![GitHub last commit](https://img.shields.io/github/last-commit/estuary/flow)](https://github.com/estuary/flow) - Versatile, scalable platform that provides both real-time and batch data integration for ETL and ELT pipelines.
...
- [n8n (⭐184k) ![GitHub Repo Stars](https://img.shields.io/github/stars/n8n-io/n8n) ![GitHub last commit](https://img.shields.io/github/last-commit/n8n-io/n8n)](https://github.com/n8n-io/n8n) - Open-source workflow automation tool with 400+ connectors, giving you full control over your data and integrations.
