...
- [Estuary Flow (⭐938) ![GitHub Repo Stars](https://img.shields.io/github/stars/estuary/flow) ![GitHub last commit](https://img.shields.io/github/last-commit/estuary/flow)](https://github.com/estuary/flow) - Versatile, scalable platform that provides both real-time and batch data integration for ETL and ELT pipelines.
...
- [Karapace (⭐620) ![GitHub Repo Stars](https://img.shields.io/github/stars/Aiven-Open/karapace) ![GitHub last commit](https://img.shields.io/github/last-commit/Aiven-Open/karapace)](https://github.com/Aiven-Open/karapace) - Open-source, drop-in replacement for Confluent Schema Registry and the Kafka REST API.
...
- [n8n (⭐193k) ![GitHub Repo Stars](https://img.shields.io/github/stars/n8n-io/n8n) ![GitHub last commit](https://img.shields.io/github/last-commit/n8n-io/n8n)](https://github.com/n8n-io/n8n) - Open-source workflow automation tool with 400+ connectors, giving you full control over your data and integrations.
...
- [ksqlDB (⭐305) ![GitHub Repo Stars](https://img.shields.io/github/stars/confluentinc/ksql) ![GitHub last commit](https://img.shields.io/github/last-commit/confluentinc/ksql)](https://github.com/confluentinc/ksql) - Database purpose-built for stream processing applications on Kafka, queried with SQL.
