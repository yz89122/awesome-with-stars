...
- [Zally (⭐947) ![GitHub Repo Stars](https://img.shields.io/github/stars/zalando/zally) ![GitHub last commit](https://img.shields.io/github/last-commit/zalando/zally)](https://github.com/zalando/zally) - Ensure the quality of your OpenAPI specs with this linter tool that provides extensive analysis and feedback.
...
- API clients
   ...
   - [Bruno (⭐41k) ![GitHub Repo Stars](https://img.shields.io/github/stars/usebruno/bruno) ![GitHub last commit](https://img.shields.io/github/last-commit/usebruno/bruno)](https://github.com/usebruno/bruno) - A fast, offline API client designed for git-friendly workflows and seamless testing.
   - [curl (⭐40k) ![GitHub Repo Stars](https://img.shields.io/github/stars/curl/curl) ![GitHub last commit](https://img.shields.io/github/last-commit/curl/curl)](https://github.com/curl/curl) - A versatile command-line tool for data transfer across multiple protocols, essential for quick API testing.
   - [curlie (⭐3.5k) ![GitHub Repo Stars](https://img.shields.io/github/stars/rs/curlie) ![GitHub last commit](https://img.shields.io/github/last-commit/rs/curlie)](https://github.com/rs/curlie) - A modern, user-friendly frontend to curl that combines simplicity with powerful performance.
   ...
   - [Hoppscotch (⭐77k) ![GitHub Repo Stars](https://img.shields.io/github/stars/hoppscotch/hoppscotch) ![GitHub last commit](https://img.shields.io/github/last-commit/hoppscotch/hoppscotch)](https://github.com/hoppscotch/hoppscotch) - A lightweight, web-based API development tool offering real-time testing with an intuitive interface.
   - [Insomnia (⭐37k) ![GitHub Repo Stars](https://img.shields.io/github/stars/Kong/insomnia) ![GitHub last commit](https://img.shields.io/github/last-commit/Kong/insomnia)](https://github.com/Kong/insomnia) - A cross-platform client that streamlines API debugging and testing for both REST and GraphQL services.
   ...
   - [Requestly (⭐6.4k) ![GitHub Repo Stars](https://img.shields.io/github/stars/requestly/requestly) ![GitHub last commit](https://img.shields.io/github/last-commit/requestly/requestly)](https://github.com/requestly/requestly) - Lightweight Git-Friendly API Client Built for Modern Developers.
...
- Mocking tools
   ...
   - [Imposter (⭐402) ![GitHub Repo Stars](https://img.shields.io/github/stars/outofcoffee/imposter) ![GitHub last commit](https://img.shields.io/github/last-commit/outofcoffee/imposter)](https://github.com/outofcoffee/imposter) - A flexible mock server supporting REST, OpenAPI, SOAP, and more to simulate diverse API behaviors.
   ...
   - [Mockbin (⭐135) ![GitHub Repo Stars](https://img.shields.io/github/stars/zuplo/mockbin) ![GitHub last commit](https://img.shields.io/github/last-commit/zuplo/mockbin)](https://github.com/zuplo/mockbin) - A simple endpoint generator for testing HTTP requests with real-time logging and feedback.
   - [Mockoon (⭐8k) ![GitHub Repo Stars](https://img.shields.io/github/stars/mockoon/mockoon) ![GitHub last commit](https://img.shields.io/github/last-commit/mockoon/mockoon)](https://github.com/mockoon/mockoon) - A user-friendly tool for designing and running mock REST APIs with real-time simulation and easy setup.
...
- [Estuary Flow (⭐884) ![GitHub Repo Stars](https://img.shields.io/github/stars/estuary/flow) ![GitHub last commit](https://img.shields.io/github/last-commit/estuary/flow)](https://github.com/estuary/flow) - Versatile, scalable platform that provides both real-time and batch data integration for ETL and ELT pipelines.
...
- [EMQX (⭐15k) ![GitHub Repo Stars](https://img.shields.io/github/stars/emqx/emqx) ![GitHub last commit](https://img.shields.io/github/last-commit/emqx/emqx)](https://github.com/emqx/emqx) - High-performance MQTT broker built for IoT and industrial applications, ensuring scalable message delivery.
...
- [OpenRPA (⭐2.8k) ![GitHub Repo Stars](https://img.shields.io/github/stars/open-rpa/openrpa) ![GitHub last commit](https://img.shields.io/github/last-commit/open-rpa/openrpa)](https://github.com/open-rpa/openrpa) - Enterprise-grade, open-source robotic process automation suite. 
...
- [n8n (⭐176k) ![GitHub Repo Stars](https://img.shields.io/github/stars/n8n-io/n8n) ![GitHub last commit](https://img.shields.io/github/last-commit/n8n-io/n8n)](https://github.com/n8n-io/n8n) - Open-source workflow automation tool with 400+ connectors, giving you full control over your data and integrations.
...
- [Bonita (⭐172) ![GitHub Repo Stars](https://img.shields.io/github/stars/bonitasoft/bonita-engine) ![GitHub last commit](https://img.shields.io/github/last-commit/bonitasoft/bonita-engine)](https://github.com/bonitasoft/bonita-engine) - Open-source BPMN engine with a designer interface to build and automate complex business processes.
- [Cadence (⭐9.1k) ![GitHub Repo Stars](https://img.shields.io/github/stars/uber/cadence) ![GitHub last commit](https://img.shields.io/github/last-commit/uber/cadence)](https://github.com/uber/cadence) - Fault-tolerant, stateful platform that reliably orchestrates long-running workflows and complex applications.
...
- [Prefect (⭐21k) ![GitHub Repo Stars](https://img.shields.io/github/stars/PrefectHQ/prefect) ![GitHub last commit](https://img.shields.io/github/last-commit/PrefectHQ/prefect)](https://github.com/PrefectHQ/prefect) - Modern, developer-friendly orchestration tool optimized for data pipelines and complex workflows.
