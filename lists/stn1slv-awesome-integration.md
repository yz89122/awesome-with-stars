...
- [Zally (⭐890) ![GitHub Repo Stars](https://img.shields.io/github/stars/zalando/zally) ![GitHub last commit](https://img.shields.io/github/last-commit/zalando/zally)](https://github.com/zalando/zally) - Ensure the quality of your OpenAPI specs with this linter tool that provides extensive analysis and feedback.
...
- API clients
  ...
  - [Bruno (⭐22k) ![GitHub Repo Stars](https://img.shields.io/github/stars/usebruno/bruno) ![GitHub last commit](https://img.shields.io/github/last-commit/usebruno/bruno)](https://github.com/usebruno/bruno) - A fast, git-friendly, and offline-only opensource API client.
...
- MQ clients
  ...
  - [kcat (⭐5.3k) ![GitHub Repo Stars](https://img.shields.io/github/stars/edenhill/kcat) ![GitHub last commit](https://img.shields.io/github/last-commit/edenhill/kcat)](https://github.com/edenhill/kcat) - Generic non-JVM producer and consumer for Apache Kafka, functioning as a netcat for Kafka.
...
- Mocking tools
  ...
  - [WireMock (⭐6.2k) ![GitHub Repo Stars](https://img.shields.io/github/stars/tomakehurst/wiremock) ![GitHub last commit](https://img.shields.io/github/last-commit/tomakehurst/wiremock)](https://github.com/tomakehurst/wiremock) - Mock your APIs for fast, robust, and comprehensive testing.
- Testing tools and frameworks
  - [Apache JMeter (⭐8.1k) ![GitHub Repo Stars](https://img.shields.io/github/stars/apache/jmeter) ![GitHub last commit](https://img.shields.io/github/last-commit/apache/jmeter)](https://github.com/apache/jmeter) - Open-source Java-based load testing tool that can be used to test the performance and scalability of web applications, databases, and other network services.
...
- [Apache NiFi (⭐4.6k) ![GitHub Repo Stars](https://img.shields.io/github/stars/apache/nifi) ![GitHub last commit](https://img.shields.io/github/last-commit/apache/nifi)](https://github.com/apache/nifi) - An automated data integration platform that efficiently moves data between disparate systems.
...
- [Bonita (⭐148) ![GitHub Repo Stars](https://img.shields.io/github/stars/bonitasoft/bonita-engine) ![GitHub last commit](https://img.shields.io/github/last-commit/bonitasoft/bonita-engine)](https://github.com/bonitasoft/bonita-engine) - An open-source BPMN engine that comes with a designer and optional development environment, making it easier to build and automate complex business processes.
- [Cadence (⭐8k) ![GitHub Repo Stars](https://img.shields.io/github/stars/uber/cadence) ![GitHub last commit](https://img.shields.io/github/last-commit/uber/cadence)](https://github.com/uber/cadence) - A fault-tolerant, stateful code platform that makes it easier to build and manage complex, long-running applications.
