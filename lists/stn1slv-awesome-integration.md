...
- [Zally (⭐860) ![GitHub Repo Stars](https://img.shields.io/github/stars/zalando/zally) ![GitHub last commit](https://img.shields.io/github/last-commit/zalando/zally)](https://github.com/zalando/zally) - Ensure the quality of your OpenAPI specs with this linter tool that provides extensive analysis and feedback.
...
- [Apache APISIX (⭐13k) ![GitHub Repo Stars](https://img.shields.io/github/stars/apache/apisix) ![GitHub last commit](https://img.shields.io/github/last-commit/apache/apisix)](https://github.com/apache/apisix) - A dynamic, real-time, and high-performance API Gateway that leverages Apache plugins for enhanced functionality.
- [Gloo Edge (⭐3.9k) ![GitHub Repo Stars](https://img.shields.io/github/stars/solo-io/gloo) ![GitHub last commit](https://img.shields.io/github/last-commit/solo-io/gloo)](https://github.com/solo-io/gloo) - An Envoy Proxy-based API Gateway that provides advanced traffic management, security, and observability features for modern microservices architectures.
...
- API clients
  ...
  - [curlie (⭐2.5k) ![GitHub Repo Stars](https://img.shields.io/github/stars/rs/curlie) ![GitHub last commit](https://img.shields.io/github/last-commit/rs/curlie)](https://github.com/rs/curlie) - Frontend to curl with the ease of use of httpie without compromising on performance and features.
  - [HTTPie (⭐30k) ![GitHub Repo Stars](https://img.shields.io/github/stars/httpie/httpie) ![GitHub last commit](https://img.shields.io/github/last-commit/httpie/httpie)](https://github.com/httpie/httpie) - User-friendly command-line HTTP client that simplifies HTTP request/response inspection and manipulation.
  - [Insomnia (⭐31k) ![GitHub Repo Stars](https://img.shields.io/github/stars/Kong/insomnia) ![GitHub last commit](https://img.shields.io/github/last-commit/Kong/insomnia)](https://github.com/Kong/insomnia) - Cross-platform HTTP and GraphQL client designed to make API testing and debugging easier.
...
- MQ clients
  - [JMSToolBox (⭐185) ![GitHub Repo Stars](https://img.shields.io/github/stars/jmstoolbox/jmstoolbox) ![GitHub last commit](https://img.shields.io/github/last-commit/jmstoolbox/jmstoolbox)](https://github.com/jmstoolbox/jmstoolbox) - Universal JMS client designed to interact with a wide range of JMS-based message brokers.
...
- Mocking tools
  ...
  - [Mockoon (⭐5.5k) ![GitHub Repo Stars](https://img.shields.io/github/stars/mockoon/mockoon) ![GitHub last commit](https://img.shields.io/github/last-commit/mockoon/mockoon)](https://github.com/mockoon/mockoon) - Easy-to-use tool for designing and running mock REST APIs.
  - [MockServer (⭐4.3k) ![GitHub Repo Stars](https://img.shields.io/github/stars/mock-server/mockserver) ![GitHub last commit](https://img.shields.io/github/last-commit/mock-server/mockserver)](https://github.com/mock-server/mockserver) - Easy mocking of any system you integrate with via HTTP or HTTPS.
...
- Testing tools and frameworks
  ...
  - [Schemathesis (⭐1.9k) ![GitHub Repo Stars](https://img.shields.io/github/stars/schemathesis/schemathesis) ![GitHub last commit](https://img.shields.io/github/last-commit/schemathesis/schemathesis)](https://github.com/schemathesis/schemathesis) - Python library for property-based testing of API schemas.
...
- [Apache NiFi (⭐4.1k) ![GitHub Repo Stars](https://img.shields.io/github/stars/apache/nifi) ![GitHub last commit](https://img.shields.io/github/last-commit/apache/nifi)](https://github.com/apache/nifi) - An automated data integration platform that efficiently moves data between disparate systems.
