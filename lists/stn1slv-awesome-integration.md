...
- API clients
   ...
   - [posting (⭐10k) ![GitHub Repo Stars](https://img.shields.io/github/stars/darrenburns/posting) ![GitHub last commit](https://img.shields.io/github/last-commit/darrenburns/posting)](https://github.com/darrenburns/posting) - A modern, terminal-based API client designed for efficient and seamless API interactions.
   ...
   - [Requestly (⭐5.6k) ![GitHub Repo Stars](https://img.shields.io/github/stars/requestly/requestly) ![GitHub last commit](https://img.shields.io/github/last-commit/requestly/requestly)](https://github.com/requestly/requestly) - Lightweight Git-Friendly API Client Built for Modern Developers.
...
- Mocking tools
   ...
   - [Imposter (⭐398) ![GitHub Repo Stars](https://img.shields.io/github/stars/outofcoffee/imposter) ![GitHub last commit](https://img.shields.io/github/last-commit/outofcoffee/imposter)](https://github.com/outofcoffee/imposter) - A flexible mock server supporting REST, OpenAPI, SOAP, and more to simulate diverse API behaviors.
   ...
   - [Mockbin (⭐129) ![GitHub Repo Stars](https://img.shields.io/github/stars/zuplo/mockbin) ![GitHub last commit](https://img.shields.io/github/last-commit/zuplo/mockbin)](https://github.com/zuplo/mockbin) - A simple endpoint generator for testing HTTP requests with real-time logging and feedback.
...
- [Estuary Flow (⭐854) ![GitHub Repo Stars](https://img.shields.io/github/stars/estuary/flow) ![GitHub last commit](https://img.shields.io/github/last-commit/estuary/flow)](https://github.com/estuary/flow) - Versatile, scalable platform that provides both real-time and batch data integration for ETL and ELT pipelines.
...
- [Apache Pulsar (⭐14k) ![GitHub Repo Stars](https://img.shields.io/github/stars/apache/pulsar) ![GitHub last commit](https://img.shields.io/github/last-commit/apache/pulsar)](https://github.com/apache/pulsar) - Versatile pub/sub and streaming platform offering scalable, low-latency messaging for modern applications.
...
- [OpenRPA (⭐2.7k) ![GitHub Repo Stars](https://img.shields.io/github/stars/open-rpa/openrpa) ![GitHub last commit](https://img.shields.io/github/last-commit/open-rpa/openrpa)](https://github.com/open-rpa/openrpa) - Enterprise-grade, open-source robotic process automation suite. 
...
- [n8n (⭐161k) ![GitHub Repo Stars](https://img.shields.io/github/stars/n8n-io/n8n) ![GitHub last commit](https://img.shields.io/github/last-commit/n8n-io/n8n)](https://github.com/n8n-io/n8n) - Open-source workflow automation tool with 400+ connectors, giving you full control over your data and integrations.
