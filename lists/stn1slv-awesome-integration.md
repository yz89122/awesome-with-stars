...
- [Envoy Gateway (⭐2.4k) ![GitHub Repo Stars](https://img.shields.io/github/stars/envoyproxy/gateway) ![GitHub last commit](https://img.shields.io/github/last-commit/envoyproxy/gateway)](https://github.com/envoyproxy/gateway) - CNCF Envoy-based gateway with Gateway API, mTLS, JWT, and other built-ins.
- [Gloo Edge (⭐146) ![GitHub Repo Stars](https://img.shields.io/github/stars/solo-io/gloo) ![GitHub last commit](https://img.shields.io/github/last-commit/solo-io/gloo)](https://github.com/solo-io/gloo) - An Envoy Proxy–based gateway offering advanced traffic control, enhanced security, and observability for microservices ecosystems.
...
- API clients
   ...
   - [Requestly (⭐6.1k) ![GitHub Repo Stars](https://img.shields.io/github/stars/requestly/requestly) ![GitHub last commit](https://img.shields.io/github/last-commit/requestly/requestly)](https://github.com/requestly/requestly) - Lightweight Git-Friendly API Client Built for Modern Developers.
...
- Mocking tools
   ...
   - [Mockbin (⭐133) ![GitHub Repo Stars](https://img.shields.io/github/stars/zuplo/mockbin) ![GitHub last commit](https://img.shields.io/github/last-commit/zuplo/mockbin)](https://github.com/zuplo/mockbin) - A simple endpoint generator for testing HTTP requests with real-time logging and feedback.
...
- [Estuary Flow (⭐867) ![GitHub Repo Stars](https://img.shields.io/github/stars/estuary/flow) ![GitHub last commit](https://img.shields.io/github/last-commit/estuary/flow)](https://github.com/estuary/flow) - Versatile, scalable platform that provides both real-time and batch data integration for ETL and ELT pipelines.
...
- [n8n (⭐170k) ![GitHub Repo Stars](https://img.shields.io/github/stars/n8n-io/n8n) ![GitHub last commit](https://img.shields.io/github/last-commit/n8n-io/n8n)](https://github.com/n8n-io/n8n) - Open-source workflow automation tool with 400+ connectors, giving you full control over your data and integrations.
