...
- [Swagger Editor (⭐9.2k) ![GitHub Repo Stars](https://img.shields.io/github/stars/swagger-api/swagger-editor) ![GitHub last commit](https://img.shields.io/github/last-commit/swagger-api/swagger-editor)](https://github.com/swagger-api/swagger-editor) - Create, describe, and document your API with ease using this open source editor built specifically for OpenAPI-based APIs.
- [Zally (⭐936) ![GitHub Repo Stars](https://img.shields.io/github/stars/zalando/zally) ![GitHub last commit](https://img.shields.io/github/last-commit/zalando/zally)](https://github.com/zalando/zally) - Ensure the quality of your OpenAPI specs with this linter tool that provides extensive analysis and feedback.
...
- [Apache ShenYu (⭐8.6k) ![GitHub Repo Stars](https://img.shields.io/github/stars/apache/shenyu) ![GitHub last commit](https://img.shields.io/github/last-commit/apache/shenyu)](https://github.com/apache/shenyu) - A Java-native gateway excelling in protocol conversion, service proxying, and comprehensive API governance.
...
- API clients
   ...
   - [Bruno (⭐37k) ![GitHub Repo Stars](https://img.shields.io/github/stars/usebruno/bruno) ![GitHub last commit](https://img.shields.io/github/last-commit/usebruno/bruno)](https://github.com/usebruno/bruno) - A fast, offline API client designed for git-friendly workflows and seamless testing.
...
- Mocking tools
   ...
   - [Mockbin (⭐120) ![GitHub Repo Stars](https://img.shields.io/github/stars/zuplo/mockbin) ![GitHub last commit](https://img.shields.io/github/last-commit/zuplo/mockbin)](https://github.com/zuplo/mockbin) - A simple endpoint generator for testing HTTP requests with real-time logging and feedback.
   - [Mockoon (⭐7.7k) ![GitHub Repo Stars](https://img.shields.io/github/stars/mockoon/mockoon) ![GitHub last commit](https://img.shields.io/github/last-commit/mockoon/mockoon)](https://github.com/mockoon/mockoon) - A user-friendly tool for designing and running mock REST APIs with real-time simulation and easy setup.
...
- Testing tools and frameworks
   ...
   - [Gatling (⭐6.7k) ![GitHub Repo Stars](https://img.shields.io/github/stars/gatling/gatling) ![GitHub last commit](https://img.shields.io/github/last-commit/gatling/gatling)](https://github.com/gatling/gatling) - A powerful load testing framework with a developer-friendly DSL that delivers detailed performance metrics.
   ...
   - [Grafana k6 (⭐28k) ![GitHub Repo Stars](https://img.shields.io/github/stars/grafana/k6) ![GitHub last commit](https://img.shields.io/github/last-commit/grafana/k6)](https://github.com/grafana/k6) - Open-source, JS-scriptable load-testing tool for CI/CD.
   - [Karate (⭐8.6k) ![GitHub Repo Stars](https://img.shields.io/github/stars/karatelabs/karate) ![GitHub last commit](https://img.shields.io/github/last-commit/karatelabs/karate)](https://github.com/karatelabs/karate) - A unified testing framework that merges API automation, mocking, and performance testing with simple, expressive syntax.
...
- [Estuary Flow (⭐821) ![GitHub Repo Stars](https://img.shields.io/github/stars/estuary/flow) ![GitHub last commit](https://img.shields.io/github/last-commit/estuary/flow)](https://github.com/estuary/flow) - Versatile, scalable platform that provides both real-time and batch data integration for ETL and ELT pipelines.
...
- [n8n (⭐144k) ![GitHub Repo Stars](https://img.shields.io/github/stars/n8n-io/n8n) ![GitHub last commit](https://img.shields.io/github/last-commit/n8n-io/n8n)](https://github.com/n8n-io/n8n) - Open-source workflow automation tool with 400+ connectors, giving you full control over your data and integrations.
...
- [Cadence (⭐8.8k) ![GitHub Repo Stars](https://img.shields.io/github/stars/uber/cadence) ![GitHub last commit](https://img.shields.io/github/last-commit/uber/cadence)](https://github.com/uber/cadence) - Fault-tolerant, stateful platform that reliably orchestrates long-running workflows and complex applications.
