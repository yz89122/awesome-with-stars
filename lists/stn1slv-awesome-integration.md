...
- [Ocelot (⭐8.4k) ![GitHub Repo Stars](https://img.shields.io/github/stars/ThreeMammals/Ocelot) ![GitHub last commit](https://img.shields.io/github/last-commit/ThreeMammals/Ocelot)](https://github.com/ThreeMammals/Ocelot) - A .NET-based gateway offering intuitive routing and easy integration for lightweight API management.
...
- API clients
   ...
   - [HTTPie (⭐34k) ![GitHub Repo Stars](https://img.shields.io/github/stars/httpie/httpie) ![GitHub last commit](https://img.shields.io/github/last-commit/httpie/httpie)](https://github.com/httpie/httpie) - An intuitive CLI HTTP client that simplifies crafting API requests and inspecting responses.
   - [Hoppscotch (⭐69k) ![GitHub Repo Stars](https://img.shields.io/github/stars/hoppscotch/hoppscotch) ![GitHub last commit](https://img.shields.io/github/last-commit/hoppscotch/hoppscotch)](https://github.com/hoppscotch/hoppscotch) - A lightweight, web-based API development tool offering real-time testing with an intuitive interface.
   ...
   - [posting (⭐8.2k) ![GitHub Repo Stars](https://img.shields.io/github/stars/darrenburns/posting) ![GitHub last commit](https://img.shields.io/github/last-commit/darrenburns/posting)](https://github.com/darrenburns/posting) - A modern, terminal-based API client designed for efficient and seamless API interactions.
...
- Mocking tools
   ...
   - [Imposter (⭐382) ![GitHub Repo Stars](https://img.shields.io/github/stars/outofcoffee/imposter) ![GitHub last commit](https://img.shields.io/github/last-commit/outofcoffee/imposter)](https://github.com/outofcoffee/imposter) - A flexible mock server supporting REST, OpenAPI, SOAP, and more to simulate diverse API behaviors.
...
- [n8n (⭐66k) ![GitHub Repo Stars](https://img.shields.io/github/stars/n8n-io/n8n) ![GitHub last commit](https://img.shields.io/github/last-commit/n8n-io/n8n)](https://github.com/n8n-io/n8n) - Open-source workflow automation tool with 400+ connectors, giving you full control over your data and integrations.
