...
- [oasdiff (⭐1.2k) ![GitHub Repo Stars](https://img.shields.io/github/stars/oasdiff/oasdiff) ![GitHub last commit](https://img.shields.io/github/last-commit/oasdiff/oasdiff)](https://github.com/oasdiff/oasdiff) - Compare OpenAPI specs and detect breaking changes, with changelog generation in multiple output formats.
...
- [vacuum (⭐1k) ![GitHub Repo Stars](https://img.shields.io/github/stars/daveshanley/vacuum) ![GitHub last commit](https://img.shields.io/github/last-commit/daveshanley/vacuum)](https://github.com/daveshanley/vacuum) - An ultra-fast OpenAPI linter and quality analysis tool, compatible with Spectral rulesets.
- [Zally (⭐944) ![GitHub Repo Stars](https://img.shields.io/github/stars/zalando/zally) ![GitHub last commit](https://img.shields.io/github/last-commit/zalando/zally)](https://github.com/zalando/zally) - Ensure the quality of your OpenAPI specs with this linter tool that provides extensive analysis and feedback.
...
- [Apache ShenYu (⭐8.7k) ![GitHub Repo Stars](https://img.shields.io/github/stars/apache/shenyu) ![GitHub last commit](https://img.shields.io/github/last-commit/apache/shenyu)](https://github.com/apache/shenyu) - A Java-native gateway excelling in protocol conversion, service proxying, and comprehensive API governance.
- [Envoy Gateway (⭐2.8k) ![GitHub Repo Stars](https://img.shields.io/github/stars/envoyproxy/gateway) ![GitHub last commit](https://img.shields.io/github/last-commit/envoyproxy/gateway)](https://github.com/envoyproxy/gateway) - CNCF Envoy-based gateway with Gateway API, mTLS, JWT, and other built-ins.
- [Gloo Edge (⭐164) ![GitHub Repo Stars](https://img.shields.io/github/stars/solo-io/gloo) ![GitHub last commit](https://img.shields.io/github/last-commit/solo-io/gloo)](https://github.com/solo-io/gloo) - An Envoy Proxy–based gateway offering advanced traffic control, enhanced security, and observability for microservices ecosystems.
- [Higress (⭐8.7k) ![GitHub Repo Stars](https://img.shields.io/github/stars/higress-group/higress) ![GitHub last commit](https://img.shields.io/github/last-commit/higress-group/higress)](https://github.com/higress-group/higress) - A next-generation cloud-native gateway based on Envoy and Istio, offering high performance, easy-to-use, and rich plugin extensibility.
...
- [KrakenD API Gateway (⭐2.6k) ![GitHub Repo Stars](https://img.shields.io/github/stars/devopsfaith/krakend-ce) ![GitHub last commit](https://img.shields.io/github/last-commit/devopsfaith/krakend-ce)](https://github.com/devopsfaith/krakend-ce) - An ultra-high performance gateway with efficient middleware configuration, robust security, and seamless scaling.
...
- API clients
   - [Bruno (⭐45k) ![GitHub Repo Stars](https://img.shields.io/github/stars/usebruno/bruno) ![GitHub last commit](https://img.shields.io/github/last-commit/usebruno/bruno)](https://github.com/usebruno/bruno) - A fast, offline API client designed for git-friendly workflows and seamless testing.
   ...
   - [curlie (⭐3.6k) ![GitHub Repo Stars](https://img.shields.io/github/stars/rs/curlie) ![GitHub last commit](https://img.shields.io/github/last-commit/rs/curlie)](https://github.com/rs/curlie) - A modern, user-friendly frontend to curl that combines simplicity with powerful performance.
...
- Mocking tools
   ...
   - [Imposter (⭐410) ![GitHub Repo Stars](https://img.shields.io/github/stars/outofcoffee/imposter) ![GitHub last commit](https://img.shields.io/github/last-commit/outofcoffee/imposter)](https://github.com/outofcoffee/imposter) - A flexible mock server supporting REST, OpenAPI, SOAP, and more to simulate diverse API behaviors.
   - [Microcks (⭐1.9k) ![GitHub Repo Stars](https://img.shields.io/github/stars/microcks/microcks) ![GitHub last commit](https://img.shields.io/github/last-commit/microcks/microcks)](https://github.com/microcks/microcks) - A Kubernetes-native tool for API mocking and testing that supports AsyncAPI, OpenAPI, and Postman Collections.
...
- Testing tools and frameworks
   ...
   - [Grafana k6 (⭐30k) ![GitHub Repo Stars](https://img.shields.io/github/stars/grafana/k6) ![GitHub last commit](https://img.shields.io/github/last-commit/grafana/k6)](https://github.com/grafana/k6) - Open-source, JS-scriptable load-testing tool for CI/CD.
   - [Karate (⭐8.8k) ![GitHub Repo Stars](https://img.shields.io/github/stars/karatelabs/karate) ![GitHub last commit](https://img.shields.io/github/last-commit/karatelabs/karate)](https://github.com/karatelabs/karate) - A unified testing framework that merges API automation, mocking, and performance testing with simple, expressive syntax.
...
- [OpenAS2 (⭐232) ![GitHub Repo Stars](https://img.shields.io/github/stars/OpenAS2/OpenAs2App) ![GitHub last commit](https://img.shields.io/github/last-commit/OpenAS2/OpenAs2App)](https://github.com/OpenAS2/OpenAs2App) - Java-based open-source implementation of the AS2 protocol for secure, signed, and encrypted document exchange over HTTP.
- [phase4 (⭐223) ![GitHub Repo Stars](https://img.shields.io/github/stars/phax/phase4) ![GitHub last commit](https://img.shields.io/github/last-commit/phax/phase4)](https://github.com/phax/phase4) - Embeddable, lightweight Java library implementing the AS4 messaging protocol, including the Peppol and CEF/eDelivery profiles.
- [Smooks (⭐416) ![GitHub Repo Stars](https://img.shields.io/github/stars/smooks/smooks) ![GitHub last commit](https://img.shields.io/github/last-commit/smooks/smooks)](https://github.com/smooks/smooks) - Extensible Java framework for processing and transforming structured data such as EDI, XML, CSV, and JSON.
...
- [PeerDB (⭐3.1k) ![GitHub Repo Stars](https://img.shields.io/github/stars/PeerDB-io/peerdb) ![GitHub last commit](https://img.shields.io/github/last-commit/PeerDB-io/peerdb)](https://github.com/PeerDB-io/peerdb) - Postgres-first CDC platform for fast, simple replication from PostgreSQL to data warehouses, queues, and storage.
...
- [Conduit (⭐601) ![GitHub Repo Stars](https://img.shields.io/github/stars/ConduitIO/conduit) ![GitHub last commit](https://img.shields.io/github/last-commit/ConduitIO/conduit)](https://github.com/ConduitIO/conduit) - Lightweight data integration tool written in Go that streams data between systems using built-in or standalone connectors, with Kafka Connect compatibility.
- [dlt (⭐5.5k) ![GitHub Repo Stars](https://img.shields.io/github/stars/dlt-hub/dlt) ![GitHub last commit](https://img.shields.io/github/last-commit/dlt-hub/dlt)](https://github.com/dlt-hub/dlt) - Open-source Python library for building data pipelines as code, with schema evolution and incremental loading out of the box.
- [Estuary Flow (⭐940) ![GitHub Repo Stars](https://img.shields.io/github/stars/estuary/flow) ![GitHub last commit](https://img.shields.io/github/last-commit/estuary/flow)](https://github.com/estuary/flow) - Versatile, scalable platform that provides both real-time and batch data integration for ETL and ELT pipelines.
...
- [Apache Artemis (⭐1k) ![GitHub Repo Stars](https://img.shields.io/github/stars/apache/artemis) ![GitHub last commit](https://img.shields.io/github/last-commit/apache/artemis)](https://github.com/apache/artemis) - A multi-protocol message broker, supporting various industry standard protocols such as AMQP 1.0, MQTT 3.1.1, MQTT 5, and STOMP.
...
- [OpenRPA (⭐2.9k) ![GitHub Repo Stars](https://img.shields.io/github/stars/open-rpa/openrpa) ![GitHub last commit](https://img.shields.io/github/last-commit/open-rpa/openrpa)](https://github.com/open-rpa/openrpa) - Enterprise-grade, open-source robotic process automation suite. 
...
- [Karapace (⭐619) ![GitHub Repo Stars](https://img.shields.io/github/stars/Aiven-Open/karapace) ![GitHub last commit](https://img.shields.io/github/last-commit/Aiven-Open/karapace)](https://github.com/Aiven-Open/karapace) - Open-source, drop-in replacement for Confluent Schema Registry and the Kafka REST API.
...
- [n8n (⭐194k) ![GitHub Repo Stars](https://img.shields.io/github/stars/n8n-io/n8n) ![GitHub last commit](https://img.shields.io/github/last-commit/n8n-io/n8n)](https://github.com/n8n-io/n8n) - Open-source workflow automation tool with 400+ connectors, giving you full control over your data and integrations.
...
- [Camunda (⭐4.1k) ![GitHub Repo Stars](https://img.shields.io/github/stars/camunda/camunda) ![GitHub last commit](https://img.shields.io/github/last-commit/camunda/camunda)](https://github.com/camunda/camunda) - Process orchestration platform built on the horizontally scalable Zeebe engine, with full BPMN and DMN support.
- [Conductor (���31k) ![GitHub Repo Stars](https://img.shields.io/github/stars/conductor-oss/conductor) ![GitHub last commit](https://img.shields.io/github/last-commit/conductor-oss/conductor)](https://github.com/conductor-oss/conductor) - Durable workflow orchestration engine originally built at Netflix, now maintained by the community after the original repository was archived.
...
- [Inngest (⭐5.5k) ![GitHub Repo Stars](https://img.shields.io/github/stars/inngest/inngest) ![GitHub last commit](https://img.shields.io/github/last-commit/inngest/inngest)](https://github.com/inngest/inngest) - Event-driven durable execution platform that runs reliable step functions inside your existing services.
