...
- [glslify ![GitHub Repo Stars](https://img.shields.io/github/stars/stackgl/glslify) ![GitHub last commit](https://img.shields.io/github/last-commit/stackgl/glslify)](https://github.com/stackgl/glslify) - npm modules compiled into WebGL shaders
...
## sound
- [doppler ![GitHub Repo Stars](https://img.shields.io/github/stars/DanielRapp/doppler) ![GitHub last commit](https://img.shields.io/github/last-commit/DanielRapp/doppler)](https://github.com/DanielRapp/doppler) - detect motion with the doppler effect using only the microphone and speakers
- [speak.js ![GitHub Repo Stars](https://img.shields.io/github/stars/mattytemple/speak-js) ![GitHub last commit](https://img.shields.io/github/last-commit/mattytemple/speak-js)](https://github.com/mattytemple/speak-js) - text-to-speech on the web
...
- [vantage.js ![GitHub Repo Stars](https://img.shields.io/github/stars/dthree/vantage) ![GitHub last commit](https://img.shields.io/github/last-commit/dthree/vantage)](https://github.com/dthree/vantage) - CLI + SSH + REPL for Node
- [cash ![GitHub Repo Stars](https://img.shields.io/github/stars/dthree/cash) ![GitHub last commit](https://img.shields.io/github/last-commit/dthree/cash)](https://github.com/dthree/cash) - Cross-platform Linux commands in pure ES6

## virtual machines
- [jsemu ![GitHub Repo Stars](https://img.shields.io/github/stars/fcambus/jsemu) ![GitHub last commit](https://img.shields.io/github/last-commit/fcambus/jsemu)](https://github.com/fcambus/jsemu) - A list of emulators written in the JavaScript
...
- [doppio ![GitHub Repo Stars](https://img.shields.io/github/stars/plasma-umass/doppio) ![GitHub last commit](https://img.shields.io/github/last-commit/plasma-umass/doppio)](https://github.com/plasma-umass/doppio) - actively updated jvm in node.js, written in TypeScript
