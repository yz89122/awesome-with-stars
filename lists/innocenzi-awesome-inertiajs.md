...
- [Kitchen sink ![GitHub Repo Stars](https://img.shields.io/github/stars/inertiajs/demo-v3) ![GitHub last commit](https://img.shields.io/github/last-commit/inertiajs/demo-v3)](https://github.com/inertiajs/demo-v3) - Demonstration application made with Laravel and Vue.
...
- `💜` [Vue.js ![GitHub Repo Stars](https://img.shields.io/github/stars/inertiajs/inertia) ![GitHub last commit](https://img.shields.io/github/last-commit/inertiajs/inertia)](https://github.com/inertiajs/inertia/tree/master/packages/vue3)
- `💜` [React ![GitHub Repo Stars](https://img.shields.io/github/stars/inertiajs/inertia) ![GitHub last commit](https://img.shields.io/github/last-commit/inertiajs/inertia)](https://github.com/inertiajs/inertia/tree/master/packages/react)
- `💜` [Svelte ![GitHub Repo Stars](https://img.shields.io/github/stars/inertiajs/inertia) ![GitHub last commit](https://img.shields.io/github/last-commit/inertiajs/inertia)](https://github.com/inertiajs/inertia/tree/master/packages/svelte)
...
- `💜` [Django ![GitHub Repo Stars](https://img.shields.io/github/stars/inertiajs/inertia-django) ![GitHub last commit](https://img.shields.io/github/last-commit/inertiajs/inertia-django)](https://github.com/inertiajs/inertia-django)
- `💜` [Phoenix ![GitHub Repo Stars](https://img.shields.io/github/stars/inertiajs/inertia-phoenix) ![GitHub last commit](https://img.shields.io/github/last-commit/inertiajs/inertia-phoenix)](https://github.com/inertiajs/inertia-phoenix)
- `⭐` [Adonis ![GitHub Repo Stars](https://img.shields.io/github/stars/adonisjs/inertia) ![GitHub last commit](https://img.shields.io/github/last-commit/adonisjs/inertia)](https://github.com/adonisjs/inertia)
...
- `⭐` [Data ![GitHub Repo Stars](https://img.shields.io/github/stars/spatie/laravel-data) ![GitHub last commit](https://img.shields.io/github/last-commit/spatie/laravel-data)](https://github.com/spatie/laravel-data) - Larave package for working with data objects, with built-in support for Inertia.
