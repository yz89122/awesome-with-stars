...
- [FeatureFlags plugin ![GitHub Repo Stars](https://img.shields.io/github/stars/orca-services/cakephp-feature-flags) ![GitHub last commit](https://img.shields.io/github/last-commit/orca-services/cakephp-feature-flags)](https://github.com/orca-services/cakephp-feature-flags) - A plugin for managing feature flags in your code.
...
- [Setup:Maintenance ![GitHub Repo Stars](https://img.shields.io/github/stars/dereuromark/cakephp-setup) ![GitHub last commit](https://img.shields.io/github/last-commit/dereuromark/cakephp-setup)](https://github.com/dereuromark/cakephp-setup/blob/master/docs/maintenance/index.md) - Maintenance shell to go into maintenance mode for all requests with optional IP whitelisting.
...
- [Menu plugin ![GitHub Repo Stars](https://img.shields.io/github/stars/dereuromark/cakephp-menu) ![GitHub last commit](https://img.shields.io/github/last-commit/dereuromark/cakephp-menu)](https://github.com/dereuromark/cakephp-menu) - Composable menu builder and renderer for nested navigation, active-state matching, and breadcrumbs - and zero dependencies.
...
- [CakeUid ![GitHub Repo Stars](https://img.shields.io/github/stars/josbeir/cakephp-uid) ![GitHub last commit](https://img.shields.io/github/last-commit/josbeir/cakephp-uid)](https://github.com/josbeir/cakephp-uid) - A collection of UID field types for your Tables (UUIDV4, UUIDV6, UUIDV7, ULID).
...
- [LatteView plugin ![GitHub Repo Stars](https://img.shields.io/github/stars/josbeir/cakephp-latte-view) ![GitHub last commit](https://img.shields.io/github/last-commit/josbeir/cakephp-latte-view)](https://github.com/josbeir/cakephp-latte-view) - A plugin providing Latte template engine integration.
...
- [TailwindUi plugin ![GitHub Repo Stars](https://img.shields.io/github/stars/dereuromark/cakephp-tailwind-ui) ![GitHub last commit](https://img.shields.io/github/last-commit/dereuromark/cakephp-tailwind-ui)](https://github.com/dereuromark/cakephp-tailwind-ui) - Tailwind CSS / DaisyUI (or KTUI/Metronic) integration for form, pagination, flash, and breadcrumb helpers.
- [TemplaterDefaults plugin ![GitHub Repo Stars](https://img.shields.io/github/stars/josbeir/cakephp-templater-defaults) ![GitHub last commit](https://img.shields.io/github/last-commit/josbeir/cakephp-templater-defaults)](https://github.com/josbeir/cakephp-templater-defaults) - Allows the use of default HTML attributes within CakePHP's string template system.
