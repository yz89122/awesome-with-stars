...
- [Github repository ![GitHub Repo Stars](https://img.shields.io/github/stars/marionettejs/backbone.marionette) ![GitHub last commit](https://img.shields.io/github/last-commit/marionettejs/backbone.marionette)](https://github.com/marionettejs/backbone.marionette)
...
- [Marionette Inspector ![GitHub Repo Stars](https://img.shields.io/github/stars/marionettejs/marionette.inspector) ![GitHub last commit](https://img.shields.io/github/last-commit/marionettejs/marionette.inspector)](https://github.com/marionettejs/marionette.inspector)
- [Yeoman generator for Marionette.js ![GitHub Repo Stars](https://img.shields.io/github/stars/mrichard/generator-marionette) ![GitHub last commit](https://img.shields.io/github/last-commit/mrichard/generator-marionette)](https://github.com/mrichard/generator-marionette)
- [Marionette CLI ![GitHub Repo Stars](https://img.shields.io/github/stars/denar90/marionette-cli) ![GitHub last commit](https://img.shields.io/github/last-commit/denar90/marionette-cli)](https://github.com/denar90/marionette-cli)
...
- [Marionette Require Boilerplate ![GitHub Repo Stars](https://img.shields.io/github/stars/BoilerplateMVC/Marionette-Require-Boilerplate) ![GitHub last commit](https://img.shields.io/github/last-commit/BoilerplateMVC/Marionette-Require-Boilerplate)](https://github.com/BoilerplateMVC/Marionette-Require-Boilerplate)
- [Marionette Contact Manager ![GitHub Repo Stars](https://img.shields.io/github/stars/dmytroyarmak/marionette-contact-manager) ![GitHub last commit](https://img.shields.io/github/last-commit/dmytroyarmak/marionette-contact-manager)](https://github.com/dmytroyarmak/marionette-contact-manager) - Continuation of development "Backbone Contact Manager" but using Marionette.js
- [Marionette, Require, and Gulp.js Boilerplate ![GitHub Repo Stars](https://img.shields.io/github/stars/jroeckle/Marionette-Require-Gulpjs-Boilerplate) ![GitHub last commit](https://img.shields.io/github/last-commit/jroeckle/Marionette-Require-Gulpjs-Boilerplate)](https://github.com/jroeckle/Marionette-Require-Gulpjs-Boilerplate) - A Lightweight boilerplate originally project based off "Marionette Require Boilerplate", with Gulp.js integration instead of Grunt.js
- [MarionetteJS + RequireJS + Twitter Bootstrap ![GitHub Repo Stars](https://img.shields.io/github/stars/ajaxray/marionette-boilerplate) ![GitHub last commit](https://img.shields.io/github/last-commit/ajaxray/marionette-boilerplate)](https://github.com/ajaxray/marionette-boilerplate) - Let's start the dance! This boilerplate is a ready setup for starting your next awesome javascript app in minutes
- [Marionette Gentle Introduction ![GitHub Repo Stars](https://img.shields.io/github/stars/davidsulc/marionette-gentle-introduction) ![GitHub last commit](https://img.shields.io/github/last-commit/davidsulc/marionette-gentle-introduction)](https://github.com/davidsulc/marionette-gentle-introduction)
- [Marionette Wires ![GitHub Repo Stars](https://img.shields.io/github/stars/thejameskyle/marionette-wires) ![GitHub last commit](https://img.shields.io/github/last-commit/thejameskyle/marionette-wires)](https://github.com/thejameskyle/marionette-wires)
- [Marionette Cookbook ![GitHub Repo Stars](https://img.shields.io/github/stars/MarionetteLabs/marionette-cookbook) ![GitHub last commit](https://img.shields.io/github/last-commit/MarionetteLabs/marionette-cookbook)](https://github.com/MarionetteLabs/marionette-cookbook)
- [MarionetteJS + Brunch + Babel/ES6 ![GitHub Repo Stars](https://img.shields.io/github/stars/denar90/brunch-with-marionettejs) ![GitHub last commit](https://img.shields.io/github/last-commit/denar90/brunch-with-marionettejs)](https://github.com/denar90/brunch-with-marionettejs)
- [A Place to Write About Technical Subjects on the Web ![GitHub Repo Stars](https://img.shields.io/github/stars/jmeas/gistbook) ![GitHub last commit](https://img.shields.io/github/last-commit/jmeas/gistbook)](https://github.com/jmeas/gistbook)
- [The Front End App for edit.sx ![GitHub Repo Stars](https://img.shields.io/github/stars/samccone/edit.sx-frontend) ![GitHub last commit](https://img.shields.io/github/last-commit/samccone/edit.sx-frontend)](https://github.com/samccone/edit.sx-frontend)
- [Streamus ![GitHub Repo Stars](https://img.shields.io/github/stars/MeoMix/StreamusChromeExtension) ![GitHub last commit](https://img.shields.io/github/last-commit/MeoMix/StreamusChromeExtension)](https://github.com/MeoMix/StreamusChromeExtension)
- [Marionette-Integrations ![GitHub Repo Stars](https://img.shields.io/github/stars/marionettejs/marionette-integrations) ![GitHub last commit](https://img.shields.io/github/last-commit/marionettejs/marionette-integrations)](https://github.com/marionettejs/marionette-integrations) - example marionette apps using several different asset management tools
- [ES6 Marionette Project ![GitHub Repo Stars](https://img.shields.io/github/stars/abiee/es6-marionette) ![GitHub last commit](https://img.shields.io/github/last-commit/abiee/es6-marionette)](https://github.com/abiee/es6-marionette)
- [Todo List ![GitHub Repo Stars](https://img.shields.io/github/stars/tastejs/todomvc) ![GitHub last commit](https://img.shields.io/github/last-commit/tastejs/todomvc)](https://github.com/tastejs/todomvc/tree/master/examples/backbone_marionette) - TodoMVC example
- [Webpack-Marionette ![GitHub Repo Stars](https://img.shields.io/github/stars/alexpsi/webpack-marionette) ![GitHub last commit](https://img.shields.io/github/last-commit/alexpsi/webpack-marionette)](https://github.com/alexpsi/webpack-marionette) A small boilerplate introducing webpack and es6 features to a Marionette/Backbone application, contains a sample CRUD application of an editable Cookbook.


## Libraries

- [Marionette State ![GitHub Repo Stars](https://img.shields.io/github/stars/Squareknot/marionette.state) ![GitHub last commit](https://img.shields.io/github/last-commit/Squareknot/marionette.state)](https://github.com/Squareknot/marionette.state)
- [Marionette Virtual Dom ![GitHub Repo Stars](https://img.shields.io/github/stars/tiagorg/marionette-vdom) ![GitHub last commit](https://img.shields.io/github/last-commit/tiagorg/marionette-vdom)](https://github.com/tiagorg/marionette-vdom)
- [Marionette Form View ![GitHub Repo Stars](https://img.shields.io/github/stars/viverae/marionette.formview) ![GitHub last commit](https://img.shields.io/github/last-commit/viverae/marionette.formview)](https://github.com/viverae/marionette.formview)
- [A Better Router for Backbone and Marionette Applications ![GitHub Repo Stars](https://img.shields.io/github/stars/Betterment/backbone.blazer) ![GitHub last commit](https://img.shields.io/github/last-commit/Betterment/backbone.blazer)](https://github.com/Betterment/backbone.blazer)
- [Marionette.Toolkit ![GitHub Repo Stars](https://img.shields.io/github/stars/RoundingWellOS/marionette.toolkit) ![GitHub last commit](https://img.shields.io/github/last-commit/RoundingWellOS/marionette.toolkit)](https://github.com/RoundingWellOS/marionette.toolkit) - A collection of opinionated Backbone.Marionette extensions for large scale application architecture.
- [Orchestra ![GitHub Repo Stars](https://img.shields.io/github/stars/BedeGaming/orchestra) ![GitHub last commit](https://img.shields.io/github/last-commit/BedeGaming/orchestra)](https://github.com/BedeGaming/orchestra) - Client-side app orchestration framework
