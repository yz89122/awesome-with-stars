...
- [canvas-lms ![GitHub Repo Stars](https://img.shields.io/github/stars/instructure/canvas-lms) ![GitHub last commit](https://img.shields.io/github/last-commit/instructure/canvas-lms)](https://github.com/instructure/canvas-lms) - A learning management app.
...
- [dgidb ![GitHub Repo Stars](https://img.shields.io/github/stars/dgidb/dgidb) ![GitHub last commit](https://img.shields.io/github/last-commit/dgidb/dgidb)](https://github.com/dgidb/dgidb) - A drug gene interaction platform - using Rails 6.0
...
- [eol ![GitHub Repo Stars](https://img.shields.io/github/stars/EOL/deprecated_eol) ![GitHub last commit](https://img.shields.io/github/last-commit/EOL/deprecated_eol)](https://github.com/EOL/deprecated_eol) - An encyclopedia app - using Rails 3.2
...
- [fairmondo ![GitHub Repo Stars](https://img.shields.io/github/stars/fairmondo/fairmondo) ![GitHub last commit](https://img.shields.io/github/last-commit/fairmondo/fairmondo)](https://github.com/fairmondo/fairmondo) - A marketplace app (using Rails 5.1).
...
- [freeATS ![GitHub Repo Stars](https://img.shields.io/github/stars/freeats/freeats) ![GitHub last commit](https://img.shields.io/github/last-commit/freeats/freeats)](https://github.com/freeats/freeats/) - An open source applicant tracking system with self-hosting capabilities (using Rails 7.1).
...
- [Gwirian ![GitHub Repo Stars](https://img.shields.io/github/stars/theacmada/gwirian) ![GitHub last commit](https://img.shields.io/github/last-commit/theacmada/gwirian)](https://github.com/theacmada/gwirian) - A modern BDD feature and scenario management (using Rails 8.0).
- [growstuff ![GitHub Repo Stars](https://img.shields.io/github/stars/Growstuff/growstuff) ![GitHub last commit](https://img.shields.io/github/last-commit/Growstuff/growstuff)](https://github.com/Growstuff/growstuff) - A data management app for food gardeners (using Rails 6.1).
- [hackershare ![GitHub Repo Stars](https://img.shields.io/github/stars/hackershare/hackershare) ![GitHub last commit](https://img.shields.io/github/last-commit/hackershare/hackershare)](https://github.com/hackershare/hackershare) - Social bookmarks website for hackers (using Rails 7.0).
...
- [helpy ![GitHub Repo Stars](https://img.shields.io/github/stars/helpyio/helpy) ![GitHub last commit](https://img.shields.io/github/last-commit/helpyio/helpy)](https://github.com/helpyio/helpy) - A customer support app (using Rails 4.2).
- [hitobito ![GitHub Repo Stars](https://img.shields.io/github/stars/hitobito/hitobito) ![GitHub last commit](https://img.shields.io/github/last-commit/hitobito/hitobito)](https://github.com/hitobito/hitobito) - An event organization app (using Rails 6.1).
...
- [Listopia ![GitHub Repo Stars](https://img.shields.io/github/stars/spaquet/listopia) ![GitHub last commit](https://img.shields.io/github/last-commit/spaquet/listopia)](https://github.com/spaquet/listopia) - A modern list / task management app (using Rails 8).
- [lobsters ![GitHub Repo Stars](https://img.shields.io/github/stars/lobsters/lobsters) ![GitHub last commit](https://img.shields.io/github/last-commit/lobsters/lobsters)](https://github.com/lobsters/lobsters) - A link aggregation app (using Rails 8.1). - [:earth_africa:](https://lobste.rs)
...
- [maybe ![GitHub Repo Stars](https://img.shields.io/github/stars/maybe-finance/maybe) ![GitHub last commit](https://img.shields.io/github/last-commit/maybe-finance/maybe)](https://github.com/maybe-finance/maybe) - The personal finance app for everyone (using Rails 7.2.2).
...
- [obl.ong ![GitHub Repo Stars](https://img.shields.io/github/stars/obl-ong/admin) ![GitHub last commit](https://img.shields.io/github/last-commit/obl-ong/admin)](https://github.com/obl-ong/admin) - A multi-tenant subdomain control panel (using Rails 7.1)
...
- [redmine ![GitHub Repo Stars](https://img.shields.io/github/stars/edavis10/redmine) ![GitHub last commit](https://img.shields.io/github/last-commit/edavis10/redmine)](https://github.com/edavis10/redmine) - A project management app (using Rails 6.1).
...
- [active_admin_prism ![GitHub Repo Stars](https://img.shields.io/github/stars/ramlaxmanyadav/active_admin_prism) ![GitHub last commit](https://img.shields.io/github/last-commit/ramlaxmanyadav/active_admin_prism)](https://github.com/ramlaxmanyadav/active_admin_prism) - An ActiveAdmin theme that replaces the default top navigation with a collapsible left sidebar, restyling panels, tables & Formtastic forms into a modern card-based look. [:red_circle:](https://rubygems.org/gems/active_admin_prism)
...
- [activerecord-postgresql-branched ![GitHub Repo Stars](https://img.shields.io/github/stars/carldaws/activerecord-postgresql-branched) ![GitHub last commit](https://img.shields.io/github/last-commit/carldaws/activerecord-postgresql-branched)](https://github.com/carldaws/activerecord-postgresql-branched) - Database adapter that gives each git branch its own PostgreSQL schema. [:red_circle:](https://rubygems.org/gems/activerecord-postgresql-branched)
...
- [db_validator ![GitHub Repo Stars](https://img.shields.io/github/stars/krzysztoff1/db-validator) ![GitHub last commit](https://img.shields.io/github/last-commit/krzysztoff1/db-validator)](https://github.com/krzysztoff1/db-validator) - A gem to find records in your database that do not meet model validation requirements. [:red_circle:](https://rubygems.org/gems/db_validator)
...
- [kreds ![GitHub Repo Stars](https://img.shields.io/github/stars/enjaku4/kreds) ![GitHub last commit](https://img.shields.io/github/last-commit/enjaku4/kreds)](https://github.com/enjaku4/kreds) - A shorthand for Rails credentials access. [:red_circle:](https://rubygems.org/gems/kreds)
...
- [scryer ![GitHub Repo Stars](https://img.shields.io/github/stars/ramlaxmanyadav/scryer) ![GitHub last commit](https://img.shields.io/github/last-commit/ramlaxmanyadav/scryer)](https://github.com/ramlaxmanyadav/scryer) - A security auditing & static analysis tool that scans Rails apps for vulnerabilities, performance issues, and code quality problems. [:red_circle:](https://rubygems.org/gems/scryer)
...
- [sidemail ![GitHub Repo Stars](https://img.shields.io/github/stars/sidemail/sidemail-sdk-ruby) ![GitHub last commit](https://img.shields.io/github/last-commit/sidemail/sidemail-sdk-ruby)](https://github.com/sidemail/sidemail-sdk-ruby) – A gem for sending and managing application emails. [:red_circle:](https://rubygems.org/gems/sidemail)
...
- [subflag-rails ![GitHub Repo Stars](https://img.shields.io/github/stars/subflag/sdk) ![GitHub last commit](https://img.shields.io/github/last-commit/subflag/sdk)](https://github.com/subflag/sdk/tree/main/packages/subflag-rails) - A gem for feature flags and dynamic config that uses ActiveRecord. [🔴](https://rubygems.org/gems/subflag-rails)
- [tidewave ![GitHub Repo Stars](https://img.shields.io/github/stars/tidewave-ai/tidewave_rails) ![GitHub last commit](https://img.shields.io/github/last-commit/tidewave-ai/tidewave_rails)](https://github.com/tidewave-ai/tidewave_rails) - MCP server for agentic Rails development, runtime-level tools for your agent to talk to your running app. [:red_circle:](https://rubygems.org/gems/tidewave)
...
- [veri ![GitHub Repo Stars](https://img.shields.io/github/stars/brownboxdev/veri) ![GitHub last commit](https://img.shields.io/github/last-commit/brownboxdev/veri)](https://github.com/brownboxdev/veri) - A gem for cookie-based authentication with fine-grained session control and management. [:red_circle:](https://rubygems.org/gems/veri)
...
- [nativeapptemplateapi ![GitHub Repo Stars](https://img.shields.io/github/stars/nativeapptemplate/nativeapptemplateapi) ![GitHub last commit](https://img.shields.io/github/last-commit/nativeapptemplate/nativeapptemplateapi)](https://github.com/nativeapptemplate/nativeapptemplateapi) - A Rails 8.1 multi-tenant API backend for native iOS (Swift/SwiftUI) and Android (Kotlin/Compose) apps. Uses acts_as_tenant, devise_token_auth, Pundit, Solid Queue/Cache/Cable, and PostgreSQL (using Rails 8.1).
- [prism_demo ![GitHub Repo Stars](https://img.shields.io/github/stars/ramlaxmanyadav/prism_demo) ![GitHub last commit](https://img.shields.io/github/last-commit/ramlaxmanyadav/prism_demo)](https://github.com/ramlaxmanyadav/prism_demo) - Sample app for testing and previewing the Prism ActiveAdmin theme; a minimal Rails app pre-wired with active_admin_prism and seeded with dummy data.
...
- [rails-rocket-sheep ![GitHub Repo Stars](https://img.shields.io/github/stars/PositiveControl/rails-rocket-sheep) ![GitHub last commit](https://img.shields.io/github/last-commit/PositiveControl/rails-rocket-sheep)](https://github.com/PositiveControl/rails-rocket-sheep) - Application template for building with AI coding agents (Claude Code, Cursor, Codex); generates a CLAUDE.md and AGENTS.md, one-convention-per-file rules, workflow commands, and CI gates (using Rails 8.0).
