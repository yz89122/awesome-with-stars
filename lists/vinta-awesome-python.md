...
- Agent Skills
  ...
  - [graphify ![GitHub Repo Stars](https://img.shields.io/github/stars/safishamsi/graphify) ![GitHub last commit](https://img.shields.io/github/last-commit/safishamsi/graphify)](https://github.com/safishamsi/graphify) - Turn any folder of code, SQL schemas, docs, papers, images, or videos into a queryable knowledge graph.
  - [nuwa-skill ![GitHub Repo Stars](https://img.shields.io/github/stars/alchaincyf/nuwa-skill) ![GitHub last commit](https://img.shields.io/github/last-commit/alchaincyf/nuwa-skill)](https://github.com/alchaincyf/nuwa-skill/blob/main/README_EN.md) - Nuwa distills the thinking of anyone — let Musk, Naval, Munger, and Feynman work for you.
...
- Orchestration
  - [ag2 ![GitHub Repo Stars](https://img.shields.io/github/stars/ag2ai/ag2) ![GitHub last commit](https://img.shields.io/github/last-commit/ag2ai/ag2)](https://github.com/ag2ai/ag2) - An open-source AgentOS for multi-agent orchestration and building agentic AI systems.
  ...
  - [bernstein ![GitHub Repo Stars](https://img.shields.io/github/stars/sipyourdrink-ltd/bernstein) ![GitHub last commit](https://img.shields.io/github/last-commit/sipyourdrink-ltd/bernstein)](https://github.com/sipyourdrink-ltd/bernstein) - A deterministic Python orchestrator for CLI coding agents (Claude Code, Codex, Gemini CLI, and 40+ more) with parallel git worktrees and an HMAC-signed audit chain.
  - [bindu ![GitHub Repo Stars](https://img.shields.io/github/stars/getbindu/Bindu) ![GitHub last commit](https://img.shields.io/github/last-commit/getbindu/Bindu)](https://github.com/getbindu/Bindu) - A framework that wraps any agent handler with DID-based cryptographic identity, A2A JSON-RPC over HTTP, OAuth2 auth, x402 (USDC) payments, and a built-in operator inbox.
  ...
  - [livetalking ![GitHub Repo Stars](https://img.shields.io/github/stars/lipku/livetalking) ![GitHub last commit](https://img.shields.io/github/last-commit/lipku/livetalking)](https://github.com/lipku/livetalking) - A framework for real time interactive streaming digital human.
  ...
  - [promptise ![GitHub Repo Stars](https://img.shields.io/github/stars/promptise-com/foundry) ![GitHub last commit](https://img.shields.io/github/last-commit/promptise-com/foundry)](https://github.com/promptise-com/foundry) - A framework for building end-to-end production-ready agentic systems, scalable & secure MCP's and autonomous agents.
  ...
  - [smolagents ![GitHub Repo Stars](https://img.shields.io/github/stars/huggingface/smolagents) ![GitHub last commit](https://img.shields.io/github/last-commit/huggingface/smolagents)](https://github.com/huggingface/smolagents) - A lightweight library to build agents and multi-agent workflows with minimal code.
...
- Data Layer
  - [entroly ![GitHub Repo Stars](https://img.shields.io/github/stars/juyterman1000/entroly) ![GitHub last commit](https://img.shields.io/github/last-commit/juyterman1000/entroly)](https://github.com/juyterman1000/entroly) - An auditable context control plane that optimizes prompt context, stabilizes cache prefixes, and verifies answers locally with WITNESS.
  ...
  - [lumen ![GitHub Repo Stars](https://img.shields.io/github/stars/holoviz/lumen) ![GitHub last commit](https://img.shields.io/github/last-commit/holoviz/lumen)](https://github.com/holoviz/lumen) - An agent framework for conversational analysis of SQL, dataframe and multidimensional array data.
  ...
  - [outlines ![GitHub Repo Stars](https://img.shields.io/github/stars/dottxt-ai/outlines) ![GitHub last commit](https://img.shields.io/github/last-commit/dottxt-ai/outlines)](https://github.com/dottxt-ai/outlines) - Structured text generation for LLMs with JSON schema, regex, and grammar-constrained decoding.
- Pre-trained Models and Inference
  ...
  - [liter-llm ![GitHub Repo Stars](https://img.shields.io/github/stars/xberg-io/liter-llm) ![GitHub last commit](https://img.shields.io/github/last-commit/xberg-io/liter-llm)](https://github.com/xberg-io/liter-llm) - A universal LLM API client with a Rust core, calling 142+ providers through a single OpenAI-compatible interface, with a built-in proxy and MCP server.
...
- Speech
  ...
  - [SenseVoice ![GitHub Repo Stars](https://img.shields.io/github/stars/FunAudioLLM/SenseVoice) ![GitHub last commit](https://img.shields.io/github/last-commit/FunAudioLLM/SenseVoice)](https://github.com/FunAudioLLM/SenseVoice) - A multilingual speech understanding model for speech recognition, language identification, emotion recognition, and audio event detection.
  ...
  - [voxcpm ![GitHub Repo Stars](https://img.shields.io/github/stars/OpenBMB/VoxCPM) ![GitHub last commit](https://img.shields.io/github/last-commit/OpenBMB/VoxCPM)](https://github.com/OpenBMB/VoxCPM) - A tokenizer-free text-to-speech foundation model for multilingual speech generation and voice cloning.
...
- [TabGAN ![GitHub Repo Stars](https://img.shields.io/github/stars/Diyago/Tabular-data-generation) ![GitHub last commit](https://img.shields.io/github/last-commit/Diyago/Tabular-data-generation)](https://github.com/Diyago/Tabular-data-generation) - Synthetic tabular data generation using GANs, Diffusion Models, and LLMs.
...
- ASGI
  - [daphne ![GitHub Repo Stars](https://img.shields.io/github/stars/django/daphne) ![GitHub last commit](https://img.shields.io/github/last-commit/django/daphne)](https://github.com/django/daphne) - An HTTP, HTTP/2 and WebSocket protocol server for ASGI and ASGI-HTTP.
...
- RPC
  ...
  - [rpyc ![GitHub Repo Stars](https://img.shields.io/github/stars/tomerfiliba-org/rpyc) ![GitHub last commit](https://img.shields.io/github/last-commit/tomerfiliba-org/rpyc)](https://github.com/tomerfiliba-org/rpyc) (Remote Python Call) - A transparent and symmetric RPC library for Python.
...
- [picows ![GitHub Repo Stars](https://img.shields.io/github/stars/tarasko/picows) ![GitHub last commit](https://img.shields.io/github/last-commit/tarasko/picows)](https://github.com/tarasko/picows) - Fastest WebSocket clients and servers with a frame level interface for the most demanding use-cases.
...
- [httptap ![GitHub Repo Stars](https://img.shields.io/github/stars/ozeranskii/httptap) ![GitHub last commit](https://img.shields.io/github/last-commit/ozeranskii/httptap)](https://github.com/ozeranskii/httptap) - Dissects an HTTP request into DNS, TCP, TLS, wait, and transfer phases and renders the timings as a waterfall.
...
- Plotting
  ...
  - [bqplot ![GitHub Repo Stars](https://img.shields.io/github/stars/bqplot/bqplot) ![GitHub last commit](https://img.shields.io/github/last-commit/bqplot/bqplot)](https://github.com/bqplot/bqplot) - Interactive Plotting Library for the Jupyter Notebook.
...
- Other
  ...
  - [kubesdk ![GitHub Repo Stars](https://img.shields.io/github/stars/puzl-cloud/kubesdk) ![GitHub last commit](https://img.shields.io/github/last-commit/puzl-cloud/kubesdk)](https://github.com/puzl-cloud/kubesdk) - A modern async-first Kubernetes client and API model generator.
...
- [SpiffWorkflow ![GitHub Repo Stars](https://img.shields.io/github/stars/sartography/SpiffWorkflow) ![GitHub last commit](https://img.shields.io/github/last-commit/sartography/SpiffWorkflow)](https://github.com/sartography/SpiffWorkflow) - A powerful workflow engine implemented in pure Python.
...
- Productivity Tools
  ...
  - [kaydet ![GitHub Repo Stars](https://img.shields.io/github/stars/miratcan/kaydet) ![GitHub last commit](https://img.shields.io/github/last-commit/miratcan/kaydet)](https://github.com/miratcan/kaydet) - Queryable personal database and terminal diary with SQLite search, tags, metadata, and AI integration via MCP.
...
- Web-based
  - [buridan/ui ![GitHub Repo Stars](https://img.shields.io/github/stars/LineIndent/ui) ![GitHub last commit](https://img.shields.io/github/last-commit/LineIndent/ui)](https://github.com/LineIndent/ui) - Composable, themeable components designed for Reflex. Extend, override, and ship without fighting the framework. Open source. 
...
- General
  ...
  - [textdistance ![GitHub Repo Stars](https://img.shields.io/github/stars/life4/textdistance) ![GitHub last commit](https://img.shields.io/github/last-commit/life4/textdistance)](https://github.com/life4/textdistance) - Compute distance between sequences with 30+ algorithms.
...
- [html-to-markdown ![GitHub Repo Stars](https://img.shields.io/github/stars/xberg-io/html-to-markdown) ![GitHub last commit](https://img.shields.io/github/last-commit/xberg-io/html-to-markdown)](https://github.com/xberg-io/html-to-markdown) - A fast, CommonMark-compliant HTML to Markdown converter with a Rust core, tolerant of malformed HTML.
...
- MS Office
  ...
  - [xlwings ![GitHub Repo Stars](https://img.shields.io/github/stars/xlwings/xlwings) ![GitHub last commit](https://img.shields.io/github/last-commit/xlwings/xlwings)](https://github.com/xlwings/xlwings) - A BSD-licensed library that makes it easy to call Python from Excel and vice versa.
- PDF
...
- Audio
  - [birdnet ![GitHub Repo Stars](https://img.shields.io/github/stars/birdnet-team/BirdNET-Analyzer) ![GitHub last commit](https://img.shields.io/github/last-commit/birdnet-team/BirdNET-Analyzer)](https://github.com/birdnet-team/BirdNET-Analyzer) - Deep learning framework for acoustic species detection; identifies bird species from audio recordings using TensorFlow.
...
- [synology-api ![GitHub Repo Stars](https://img.shields.io/github/stars/N4S4/synology-api) ![GitHub last commit](https://img.shields.io/github/last-commit/N4S4/synology-api)](https://github.com/N4S4/synology-api) - Python wrapper for Synology NAS APIs: Surveillance Station, File Station, Download Station, Docker, and 50+ other endpoints.
