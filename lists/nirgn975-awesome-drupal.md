...
- [Yo Hedley! ![GitHub Repo Stars](https://img.shields.io/github/stars/Gizra/generator-hedley) ![GitHub last commit](https://img.shields.io/github/last-commit/Gizra/generator-hedley)](https://github.com/Gizra/generator-hedley) - Scaffold a headless Drupal backend, Angular app client, and Behat tests.
- [DDEV-Local ![GitHub Repo Stars](https://img.shields.io/github/stars/drud/ddev) ![GitHub last commit](https://img.shields.io/github/last-commit/drud/ddev)](https://github.com/drud/ddev) - A Docker-based tool to create and manage local development environments. Use for other PHP apps too. Also see the [Get Started Guide](https://www.drud.com/get-started/) 
...
- [Solr Script ![GitHub Repo Stars](https://img.shields.io/github/stars/RoySegall/solr-script) ![GitHub last commit](https://img.shields.io/github/last-commit/RoySegall/solr-script)](https://github.com/RoySegall/solr-script) - Handy script to install Apache Solr.
- [Ubuntu development environment setup ![GitHub Repo Stars](https://img.shields.io/github/stars/Gizra/KnowledgeBase) ![GitHub last commit](https://img.shields.io/github/last-commit/Gizra/KnowledgeBase)](https://github.com/Gizra/KnowledgeBase/wiki/Ubuntu-and-development-environment-setup) - Provides steps for configuring ubuntu so it will be ready for PHP and Drupal development.
- [MacOS: New Machine configuration ![GitHub Repo Stars](https://img.shields.io/github/stars/Gizra/KnowledgeBase) ![GitHub last commit](https://img.shields.io/github/last-commit/Gizra/KnowledgeBase)](https://github.com/Gizra/KnowledgeBase/wiki/MacOS:-New-Machine) - Provides files and scripts for configuring MacOS for development.
