...
- [Wardley maps - Topographical intelligence in business](https://medium.com/wardleymaps) - Creative Commons book by [Simon Wardley](https://twitter.com/swardley).
  - E-book - PDF and Kindle [downloads ![GitHub Repo Stars](https://img.shields.io/github/stars/andrewharmellaw/wardley-maps-book) ![GitHub last commit](https://img.shields.io/github/last-commit/andrewharmellaw/wardley-maps-book)](https://github.com/andrewharmellaw/wardley-maps-book/releases).
...
- [OnlineWardleyMaps ![GitHub Repo Stars](https://img.shields.io/github/stars/damonsk/onlinewardleymaps) ![GitHub last commit](https://img.shields.io/github/last-commit/damonsk/onlinewardleymaps)](https://github.com/damonsk/onlinewardleymaps) - Online open source mapping tool. For updates follow [@MapsAsCode](https://twitter.com/MapsAsCode) on Twitter. Hosted version available [here](https://onlinewardleymaps.com/). Online documentation [Wardley Maps as Code](https://docs.onlinewardleymaps.com/).
...
- [Wardley Maps for Obsidian.md ![GitHub Repo Stars](https://img.shields.io/github/stars/damonsk/obsidian-wardley-maps) ![GitHub last commit](https://img.shields.io/github/last-commit/damonsk/obsidian-wardley-maps)](https://github.com/damonsk/obsidian-wardley-maps) - Render and edit Wardley maps within Obsidian.md. This community plugin leverages the engine from OnlineWardleyMaps.com. Online documentation [Wardley Maps as Code](https://docs.onlinewardleymaps.com/).
- [Wardley Maps for Jupyter Notebooks (ipywardley) ![GitHub Repo Stars](https://img.shields.io/github/stars/anjackson/ipywardley) ![GitHub last commit](https://img.shields.io/github/last-commit/anjackson/ipywardley)](https://github.com/anjackson/ipywardley) - A plugin for generating Wardley maps in Jupyter Notebooks.
...
- [Go-Wardley ![GitHub Repo Stars](https://img.shields.io/github/stars/DavidGamba/go-wardley) ![GitHub last commit](https://img.shields.io/github/last-commit/DavidGamba/go-wardley)](https://github.com/DavidGamba/go-wardley) - Generates a Wardley map in SVG format from a HCL-based map description file.
...
- [Doctrine ![GitHub Repo Stars](https://img.shields.io/github/stars/cdaniel/doctrine) ![GitHub last commit](https://img.shields.io/github/last-commit/cdaniel/doctrine)](https://github.com/cdaniel/doctrine/) - A simple tool for visualising how competitive a company is in light of Wardley's doctrine. Hosted version available [here](https://doctrine.wardleymaps.com/).
...
- [cli-owm ![GitHub Repo Stars](https://img.shields.io/github/stars/monkeypants/cli-owm) ![GitHub last commit](https://img.shields.io/github/last-commit/monkeypants/cli-owm)](https://github.com/monkeypants/cli-owm) - Command-line tool that renders OnlineWardleyMaps DSL text to SVG. Pipes stdin to stdout, ships as npm package and standalone binaries. Uses the OnlineWardleyMaps parser.
...
- [wardley-omnigraffle ![GitHub Repo Stars](https://img.shields.io/github/stars/harrylove/wardley-omnigraffle) ![GitHub last commit](https://img.shields.io/github/last-commit/harrylove/wardley-omnigraffle)](https://github.com/harrylove/wardley-omnigraffle) - Wardley mapping stencils for OmniGraffle.
- [Wardley Maps in LaTeX ![GitHub Repo Stars](https://img.shields.io/github/stars/latticecut/Wardley_Chapter2_Finding_a_path) ![GitHub last commit](https://img.shields.io/github/last-commit/latticecut/Wardley_Chapter2_Finding_a_path)](https://github.com/latticecut/Wardley_Chapter2_Finding_a_path) - Figures 8 and 11 from the book by Simon Wardley to demonstrate drawing Wardley maps in LaTeX.
- [yEd Palette ![GitHub Repo Stars](https://img.shields.io/github/stars/colugo/yed-wardley) ![GitHub last commit](https://img.shields.io/github/last-commit/colugo/yed-wardley)](https://github.com/colugo/yed-wardley) - Wardley maps palette for yEd.
...
- [Wardley Maps Battle Camp ![GitHub Repo Stars](https://img.shields.io/github/stars/simalexan/battlecamp) ![GitHub last commit](https://img.shields.io/github/last-commit/simalexan/battlecamp)](https://github.com/simalexan/battlecamp) - Workshop rules, cards and materials.
- [Workshop Building Block - New Year's Eve Party ![GitHub Repo Stars](https://img.shields.io/github/stars/LeadingEdgeForum/faciliator-pack) ![GitHub last commit](https://img.shields.io/github/last-commit/LeadingEdgeForum/faciliator-pack)](https://github.com/LeadingEdgeForum/faciliator-pack/blob/main/WorkshopBuildingBlock-NewYearsEveParty.md) - Help workshop participants gain confidence in mapping in a business-neutral environment.
