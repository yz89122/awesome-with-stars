...
- [SpeziBluetooth ![GitHub Repo Stars](https://img.shields.io/github/stars/StanfordSpezi/SpeziBluetooth) ![GitHub last commit](https://img.shields.io/github/last-commit/StanfordSpezi/SpeziBluetooth)](https://github.com/StanfordSpezi/SpeziBluetooth) - Connect and communicate with Bluetooth devices using modern programming paradigms.
...
- [niimbot-web-bluetooth ![GitHub Repo Stars](https://img.shields.io/github/stars/iscarelli/niimbot-web-bluetooth) ![GitHub last commit](https://img.shields.io/github/last-commit/iscarelli/niimbot-web-bluetooth)](https://github.com/iscarelli/niimbot-web-bluetooth) - Zero-dependency Web Bluetooth driver for NIIMBOT thermal label printers, with reverse-engineered protocol documentation.
