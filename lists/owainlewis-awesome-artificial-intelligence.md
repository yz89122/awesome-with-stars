...
- [FunASR ![GitHub Repo Stars](https://img.shields.io/github/stars/modelscope/FunASR) ![GitHub last commit](https://img.shields.io/github/last-commit/modelscope/FunASR)](https://github.com/modelscope/FunASR): Speech recognition toolkit with streaming ASR, VAD, punctuation, speaker diarization, and OpenAI-compatible serving for voice AI applications.
