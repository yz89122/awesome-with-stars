...
- [Awesome DeepSeek Agent ![GitHub Repo Stars](https://img.shields.io/github/stars/deepseek-ai/awesome-deepseek-agent) ![GitHub last commit](https://img.shields.io/github/last-commit/deepseek-ai/awesome-deepseek-agent)](https://github.com/deepseek-ai/awesome-deepseek-agent): DeepSeek's official setup guides for integrating its models with coding agents including Claude Code, Codex, Cline, OpenCode, and Pi.
...
- [12-Factor Agents ![GitHub Repo Stars](https://img.shields.io/github/stars/humanlayer/12-factor-agents) ![GitHub last commit](https://img.shields.io/github/last-commit/humanlayer/12-factor-agents)](https://github.com/humanlayer/12-factor-agents): Practical principles for building controllable LLM applications around deterministic software.
...
- [Docling ![GitHub Repo Stars](https://img.shields.io/github/stars/docling-project/docling) ![GitHub last commit](https://img.shields.io/github/last-commit/docling-project/docling)](https://github.com/docling-project/docling): Document parsing and conversion for AI applications.
...
- [OpenAI Evals ![GitHub Repo Stars](https://img.shields.io/github/stars/openai/evals) ![GitHub last commit](https://img.shields.io/github/last-commit/openai/evals)](https://github.com/openai/evals): An open-source framework and registry for evaluating language models and systems.
...
- [Neo ![GitHub Repo Stars](https://img.shields.io/github/stars/owainlewis/neo) ![GitHub last commit](https://img.shields.io/github/last-commit/owainlewis/neo)](https://github.com/owainlewis/neo): Owain Lewis's open-source, workflow-first terminal coding agent with subagents, skills, sandboxed tools, and multiple model providers.
- [Claude Code](https://code.claude.com/): A terminal agent with hooks, subagents, skills, and repository-level instructions.
- [Codex CLI ![GitHub Repo Stars](https://img.shields.io/github/stars/openai/codex) ![GitHub last commit](https://img.shields.io/github/last-commit/openai/codex)](https://github.com/openai/codex): An open-source terminal agent with sandbox and approval controls.
- [Gemini CLI ![GitHub Repo Stars](https://img.shields.io/github/stars/google-gemini/gemini-cli) ![GitHub last commit](https://img.shields.io/github/last-commit/google-gemini/gemini-cli)](https://github.com/google-gemini/gemini-cli): An open-source terminal agent built around Gemini and extensible tools.
...
- [Cline ![GitHub Repo Stars](https://img.shields.io/github/stars/cline/cline) ![GitHub last commit](https://img.shields.io/github/last-commit/cline/cline)](https://github.com/cline/cline): An open-source coding agent available as an editor extension, CLI, and SDK.
...
- [Blueprint ![GitHub Repo Stars](https://img.shields.io/github/stars/owainlewis/blueprint) ![GitHub last commit](https://img.shields.io/github/last-commit/owainlewis/blueprint)](https://github.com/owainlewis/blueprint/tree/main/skills): Owain Lewis's open-source set of focused agent skills for designing, implementing, testing, reviewing, and shipping software changes.
...
The maintainer is also building [Factory ![GitHub Repo Stars](https://img.shields.io/github/stars/owainlewis/factory) ![GitHub last commit](https://img.shields.io/github/last-commit/owainlewis/factory)](https://github.com/owainlewis/factory), a developer-preview control plane for scheduling and coordinating Pi, Codex, and Claude Code workers across Git repositories.
