...
- [Algorand Protocol Specs ![GitHub Repo Stars](https://img.shields.io/github/stars/algorandfoundation/specs) ![GitHub last commit](https://img.shields.io/github/last-commit/algorandfoundation/specs)](https://github.com/algorandfoundation/specs) - Protocol-level specification documents for the Algorand platform.
...
- [algokit-utils-py ![GitHub Repo Stars](https://img.shields.io/github/stars/algorandfoundation/algokit-utils-py) ![GitHub last commit](https://img.shields.io/github/last-commit/algorandfoundation/algokit-utils-py)](https://github.com/algorandfoundation/algokit-utils-py) - Algorand AlgoKit Utils for Python.
- [algokit-core ![GitHub Repo Stars](https://img.shields.io/github/stars/algorandfoundation/algokit-core) ![GitHub last commit](https://img.shields.io/github/last-commit/algorandfoundation/algokit-core)](https://github.com/algorandfoundation/algokit-core) - Multi-language core primitives (Rust + FFI bindings) powering higher-level AlgoKit tooling (crypto, encoding, protocol logic).
- [algokit-utils-ts ![GitHub Repo Stars](https://img.shields.io/github/stars/algorandfoundation/algokit-utils-ts) ![GitHub last commit](https://img.shields.io/github/last-commit/algorandfoundation/algokit-utils-ts)](https://github.com/algorandfoundation/algokit-utils-ts) - Algorand AlgoKit Utils for TypeScript.
- [algokit-client-generator-py ![GitHub Repo Stars](https://img.shields.io/github/stars/algorandfoundation/algokit-client-generator-py) ![GitHub last commit](https://img.shields.io/github/last-commit/algorandfoundation/algokit-client-generator-py)](https://github.com/algorandfoundation/algokit-client-generator-py) - Algorand AlgoKit Typed Client Generator for Python.
- [algokit-client-generator-ts ![GitHub Repo Stars](https://img.shields.io/github/stars/algorandfoundation/algokit-client-generator-ts) ![GitHub last commit](https://img.shields.io/github/last-commit/algorandfoundation/algokit-client-generator-ts)](https://github.com/algorandfoundation/algokit-client-generator-ts) - Algorand AlgoKit Typed Client Generator for TypeScript.
- [puya ![GitHub Repo Stars](https://img.shields.io/github/stars/algorandfoundation/puya) ![GitHub last commit](https://img.shields.io/github/last-commit/algorandfoundation/puya)](https://github.com/algorandfoundation/puya) - An official Python to TEAL compiler that allows you to write code to execute on the Algorand Virtual Machine (AVM) with Python syntax.
- [puya-ts ![GitHub Repo Stars](https://img.shields.io/github/stars/algorandfoundation/puya-ts) ![GitHub last commit](https://img.shields.io/github/last-commit/algorandfoundation/puya-ts)](https://github.com/algorandfoundation/puya-ts) - An official TypeScript to TEAL compiler frontend, leveraging the core puya compiler, allows you to write code to execute on the Algorand Virtual Machine (AVM) with TypeScript syntax.
- [algorand-python-testing ![GitHub Repo Stars](https://img.shields.io/github/stars/algorandfoundation/algorand-python-testing) ![GitHub last commit](https://img.shields.io/github/last-commit/algorandfoundation/algorand-python-testing)](https://github.com/algorandfoundation/algorand-python-testing) - A Python library for unit testing Algorand Python smart contracts without the need to interact with the Algorand Blockchain.
- [algorand-TypeScript-testing ![GitHub Repo Stars](https://img.shields.io/github/stars/algorandfoundation/algorand-TypeScript-testing) ![GitHub last commit](https://img.shields.io/github/last-commit/algorandfoundation/algorand-TypeScript-testing)](https://github.com/algorandfoundation/algorand-TypeScript-testing) - A TypeScript library for unit testing Algorand smart contracts without the need to interact with the Algorand Blockchain.
- [algokit-avm-vscode-debugger ![GitHub Repo Stars](https://img.shields.io/github/stars/algorandfoundation/algokit-avm-vscode-debugger) ![GitHub last commit](https://img.shields.io/github/last-commit/algorandfoundation/algokit-avm-vscode-debugger)](https://github.com/algorandfoundation/algokit-avm-vscode-debugger) - VSCode extension for line‑by‑line debugging of Algorand Python, TypeScript, TealScript and raw TEAL smart contracts via AVM traces.
...
- [algokit-TypeScript-template ![GitHub Repo Stars](https://img.shields.io/github/stars/algorandfoundation/algokit-TypeScript-template) ![GitHub last commit](https://img.shields.io/github/last-commit/algorandfoundation/algokit-TypeScript-template)](https://github.com/algorandfoundation/algokit-TypeScript-template) - Official AlgoKit's Algorand TypeScript template provides a production-ready baseline for developing and deploying smart contracts in TypeScript.
...
- [Algorand School ![GitHub Repo Stars](https://img.shields.io/github/stars/cusma/algorand-school) ![GitHub last commit](https://img.shields.io/github/last-commit/cusma/algorand-school)](https://github.com/cusma/algorand-school) - Crash course slide deck.
...
- [Zero to Hero Blockchain Algorand ![GitHub Repo Stars](https://img.shields.io/github/stars/VKappaKV/Zero-To-Hero-blockchain-Algorand) ![GitHub last commit](https://img.shields.io/github/last-commit/VKappaKV/Zero-To-Hero-blockchain-Algorand)](https://github.com/VKappaKV/Zero-To-Hero-blockchain-Algorand) - Curated learning path for Algorand developers.
...
- [TinyBar App ![GitHub Repo Stars](https://img.shields.io/github/stars/aorumbayev/tinybar) ![GitHub last commit](https://img.shields.io/github/last-commit/aorumbayev/tinybar)](https://github.com/aorumbayev/tinybar) - A tiny macOS menu bar app for tracking ASA prices from TinyMan.
...
- [galvanity ![GitHub Repo Stars](https://img.shields.io/github/stars/shmutalov/galvanity) ![GitHub last commit](https://img.shields.io/github/last-commit/shmutalov/galvanity)](https://github.com/shmutalov/galvanity) - Go-based Algorand vanity address generator.
...
- [txnDuck ![GitHub Repo Stars](https://img.shields.io/github/stars/No-Cash-7970/txnDuck) ![GitHub last commit](https://img.shields.io/github/last-commit/No-Cash-7970/txnDuck)](https://github.com/No-Cash-7970/txnDuck) - Transaction building tool for Algorand blockchain.
- [lazylora ![GitHub Repo Stars](https://img.shields.io/github/stars/aorumbayev/lazylora) ![GitHub last commit](https://img.shields.io/github/last-commit/aorumbayev/lazylora)](https://github.com/aorumbayev/lazylora) - Terminal UI for exploring Algorand blockchain.
...
- [solid-algo-wallets ![GitHub Repo Stars](https://img.shields.io/github/stars/SilentRhetoric/solid-algo-wallets) ![GitHub last commit](https://img.shields.io/github/last-commit/SilentRhetoric/solid-algo-wallets)](https://github.com/SilentRhetoric/solid-algo-wallets) - SolidJS wallet integration library for Algorand.
...
- [beaker ![GitHub Repo Stars](https://img.shields.io/github/stars/algorandfoundation/beaker) ![GitHub last commit](https://img.shields.io/github/last-commit/algorandfoundation/beaker)](https://github.com/algorandfoundation/beaker) - Pythonic smart contract framework (PyTEAL DSL wrappers, client + testing utilities). (Canonical repo)
...
- [d-asa ![GitHub Repo Stars](https://img.shields.io/github/stars/cusma/d-asa) ![GitHub last commit](https://img.shields.io/github/last-commit/cusma/d-asa)](https://github.com/cusma/d-asa) - Debt Algorand Standard Application providing reference implementations and interfaces for tokenizing debt instruments (bonds, loans, commercial papers) that conform to ACTUS standards.


### CLI

- [AlgoRun ![GitHub Repo Stars](https://img.shields.io/github/stars/algorandfoundation/algorun) ![GitHub last commit](https://img.shields.io/github/last-commit/algorandfoundation/algorun)](https://github.com/algorandfoundation/algorun) - Simple CLI utility for setting up and starting an Algorand MainNet participation node.
...
- [algokit-avm-debugger ![GitHub Repo Stars](https://img.shields.io/github/stars/algorandfoundation/algokit-avm-debugger) ![GitHub last commit](https://img.shields.io/github/last-commit/algorandfoundation/algokit-avm-debugger)](https://github.com/algorandfoundation/algokit-avm-debugger) - Standalone AVM Debug Adapter Protocol implementation powering advanced contract debugging tooling.
...
- [Liquid Auth ![GitHub Repo Stars](https://img.shields.io/github/stars/algorandfoundation/liquid-auth) ![GitHub last commit](https://img.shields.io/github/last-commit/algorandfoundation/liquid-auth)](https://github.com/algorandfoundation/liquid-auth) - Self-hosted service to bind passkeys to crypto keypairs plus P2P signaling for secure peer connections.
- [Kibisis ![GitHub Repo Stars](https://img.shields.io/github/stars/kibis-is/web-extension) ![GitHub last commit](https://img.shields.io/github/last-commit/kibis-is/web-extension)](https://github.com/kibis-is/web-extension) - Open source Algorand wallet web extension built in React and TypeScript.
...
- [nodekit ![GitHub Repo Stars](https://img.shields.io/github/stars/algorandfoundation/nodekit) ![GitHub last commit](https://img.shields.io/github/last-commit/algorandfoundation/nodekit)](https://github.com/algorandfoundation/nodekit) - Terminal user interface for running and managing Algorand nodes locally.
...
- [reti ![GitHub Repo Stars](https://img.shields.io/github/stars/algorandfoundation/reti) ![GitHub last commit](https://img.shields.io/github/last-commit/algorandfoundation/reti)](https://github.com/algorandfoundation/reti) - Contracts, Node Daemon, and UI for Algorand 'The Reti' consensus incentives, enabling decentralized staking pools to broaden participation and enhance network security.
...
- [Tenset Security ![GitHub Repo Stars](https://img.shields.io/github/stars/tenset-security/audits) ![GitHub last commit](https://img.shields.io/github/last-commit/tenset-security/audits)](https://github.com/tenset-security/audits) - Comprising a team of Web3 Security Researchers, Tenset Security is dedicated to leaving no stone unturned in their pursuit of security excellence. They have a [proven track record of success](https://twitter.com/algoworld_nft/status/1691891473166279042) in discovering high-severity vulnerabilities specifically within Algorand projects, emphasizing their expertise and commitment to the Algorand ecosystem.
...
- [algorand-mcp ![GitHub Repo Stars](https://img.shields.io/github/stars/GoPlausible/algorand-mcp) ![GitHub last commit](https://img.shields.io/github/last-commit/GoPlausible/algorand-mcp)](https://github.com/GoPlausible/algorand-mcp) - Algorand Model Context Protocol (Server & Client) by GoPlausible.
...
- [ARC4 ![GitHub Repo Stars](https://img.shields.io/github/stars/algorandfoundation/ARCs) ![GitHub last commit](https://img.shields.io/github/last-commit/algorandfoundation/ARCs)](https://github.com/algorandfoundation/ARCs/blob/main/ARCs/arc-0004.md) - Application Binary Interface.
- [ARC32 ![GitHub Repo Stars](https://img.shields.io/github/stars/algorandfoundation/ARCs) ![GitHub last commit](https://img.shields.io/github/last-commit/algorandfoundation/ARCs)](https://github.com/algorandfoundation/ARCs/blob/main/ARCs/arc-0032.md) - Application Specification.
- [ARC56 ![GitHub Repo Stars](https://img.shields.io/github/stars/algorandfoundation/ARCs) ![GitHub last commit](https://img.shields.io/github/last-commit/algorandfoundation/ARCs)](https://github.com/algorandfoundation/ARCs/blob/main/ARCs/arc-0056.md) - Extended and improved Application Specification.
- [ARC69 ![GitHub Repo Stars](https://img.shields.io/github/stars/algorandfoundation/ARCs) ![GitHub last commit](https://img.shields.io/github/last-commit/algorandfoundation/ARCs)](https://github.com/algorandfoundation/ARCs/blob/main/ARCs/arc-0069.md) - One of several Algorand Standard Asset Parameters Conventions.
