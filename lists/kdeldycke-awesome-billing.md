...
- [Lago ![GitHub Repo Stars](https://img.shields.io/github/stars/getlago/lago) ![GitHub last commit](https://img.shields.io/github/last-commit/getlago/lago)](https://github.com/getlago/lago) - Open-source metering & usage-based billing in Ruby.

- [CGRateS ![GitHub Repo Stars](https://img.shields.io/github/stars/cgrates/cgrates) ![GitHub last commit](https://img.shields.io/github/last-commit/cgrates/cgrates)](https://github.com/cgrates/cgrates) - An open-source, fast (50k+ CPS) and scalable (load-balancer + replication included) real-time billing for ISPs and Telecom Operators, written in Go.
...
- [Hyperswitch ![GitHub Repo Stars](https://img.shields.io/github/stars/juspay/hyperswitch) ![GitHub last commit](https://img.shields.io/github/last-commit/juspay/hyperswitch)](https://github.com/juspay/hyperswitch) - Open-source backend for payment processing.
...
- [Metabase ![GitHub Repo Stars](https://img.shields.io/github/stars/metabase/metabase) ![GitHub last commit](https://img.shields.io/github/last-commit/metabase/metabase)](https://github.com/metabase/metabase) - An open source solution to explore and visualize data and supports lots of databases.
