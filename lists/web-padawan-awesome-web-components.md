...
- [`<aura-router>` ![GitHub Repo Stars](https://img.shields.io/github/stars/aura-ui/router) ![GitHub last commit](https://img.shields.io/github/last-commit/aura-ui/router)](https://github.com/aura-ui/router) - HTML-first client-side router web component.
...
- [`<notectl-editor>` ![GitHub Repo Stars](https://img.shields.io/github/stars/Samyssmile/notectl) ![GitHub last commit](https://img.shields.io/github/last-commit/Samyssmile/notectl)](https://github.com/Samyssmile/notectl) - Modern rich text editor with plugin architecture, immutable state, and zero-config framework-agnostic deployment.
- [`<pdfjs-viewer-element>` ![GitHub Repo Stars](https://img.shields.io/github/stars/alekswebnet/pdfjs-viewer-element) ![GitHub last commit](https://img.shields.io/github/last-commit/alekswebnet/pdfjs-viewer-element)](https://github.com/alekswebnet/pdfjs-viewer-element) - Custom element that embeds PDF.js default viewer.
- [`<phantom-ui>` ![GitHub Repo Stars](https://img.shields.io/github/stars/Aejkatappaja/phantom-ui) ![GitHub last commit](https://img.shields.io/github/last-commit/Aejkatappaja/phantom-ui)](https://github.com/Aejkatappaja/phantom-ui) - Skeleton loader that measures your real DOM to render matching shimmer placeholders.
...
- [Morpheus ![GitHub Repo Stars](https://img.shields.io/github/stars/romshark/morpheus) ![GitHub last commit](https://img.shields.io/github/last-commit/romshark/morpheus)](https://github.com/romshark/morpheus) - An experimental web components UI kit.
...
- [seele ![GitHub Repo Stars](https://img.shields.io/github/stars/vollowx/seele) ![GitHub last commit](https://img.shields.io/github/last-commit/vollowx/seele)](https://github.com/vollowx/seele) - An extensible Web Components library, with Material Design 3 components pre-provided.
...
- [Lume Element ![GitHub Repo Stars](https://img.shields.io/github/stars/lume/element) ![GitHub last commit](https://img.shields.io/github/last-commit/lume/element)](https://github.com/lume/element) - Write custom elements with reactivity and templating powered by Solid.js signals and effects.
...
- [ReadyMade ![GitHub Repo Stars](https://img.shields.io/github/stars/readymade-ui/readymade) ![GitHub last commit](https://img.shields.io/github/last-commit/readymade-ui/readymade)](https://github.com/readymade-ui/readymade/tree/main/src/modules/core) - Write custom element classes with decorators. No dependencies.
- [Snice](https://gitlab.com/Hedzer/snice) - Elegant decorators for building web components declaratively or imperatively.
- [Stencil ![GitHub Repo Stars](https://img.shields.io/github/stars/stenciljs/core) ![GitHub last commit](https://img.shields.io/github/last-commit/stenciljs/core)](https://github.com/stenciljs/core) - Compiler for generating Web Components.
...
- [pion ![GitHub Repo Stars](https://img.shields.io/github/stars/pionjs/pion) ![GitHub last commit](https://img.shields.io/github/last-commit/pionjs/pion)](https://github.com/pionjs/pion) - React's Hooks API for web components with lit-html.
...
- _2018-08-21_ [All about HTML Custom Elements ![GitHub Repo Stars](https://img.shields.io/github/stars/shawnbot/custom-elements) ![GitHub last commit](https://img.shields.io/github/last-commit/shawnbot/custom-elements)](https://github.com/shawnbot/custom-elements)
