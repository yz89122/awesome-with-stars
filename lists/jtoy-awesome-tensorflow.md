...
* [Pretty Tensor ![GitHub Repo Stars](https://img.shields.io/github/stars/google/prettytensor) ![GitHub last commit](https://img.shields.io/github/last-commit/google/prettytensor)](https://github.com/google/prettytensor) - Pretty Tensor provides a high level builder API
...
* [tf-encrypted ![GitHub Repo Stars](https://img.shields.io/github/stars/mortendahl/tf-encrypted) ![GitHub last commit](https://img.shields.io/github/last-commit/mortendahl/tf-encrypted)](https://github.com/mortendahl/tf-encrypted) - Layer on top of TensorFlow for doing machine learning on encrypted data
...
* [Machine Learning with TensorFlow 2nd edition]([http://tensorflowbook.com ![GitHub Repo Stars](https://img.shields.io/github/stars/chrismattmann/MLwithTensorFlow2ed) ![GitHub last commit](https://img.shields.io/github/last-commit/chrismattmann/MLwithTensorFlow2ed)](https://github.com/chrismattmann/MLwithTensorFlow2ed)) by [Dr. Chris A. Mattmann](http://github.com/chrismattmann/), Chief Data and Artificial Intelligence Officer at UCLA and author also of [Tika in Action](https://www.manning.com/books/tika-in-action). This book makes the math-heavy topic of AI and ML approachable and practicle to a newcomer. Updated to Tensorflow2 and the latest version of this book.
