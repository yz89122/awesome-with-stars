# Awesome Stock Resources [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) [![Support](https://img.shields.io/badge/Donate-PayPal-green.svg)](https://www.paypal.me/tonyphipps)
...
* [Mega Doodles Pack ![GitHub Repo Stars](https://img.shields.io/github/stars/MariaLetta/mega-doodles-pack) ![GitHub last commit](https://img.shields.io/github/last-commit/MariaLetta/mega-doodles-pack)](https://github.com/MariaLetta/mega-doodles-pack) - [:copyright:](https://creativecommons.org/licenses/by-sa/4.0/) Free and big CC Attribution-ShareAlike 4.0 vector pack with hand-drawn doodles for presentations, social media, blog posts and so on. 
...
* [Brick ![GitHub Repo Stars](https://img.shields.io/github/stars/alfredxing/brick) ![GitHub last commit](https://img.shields.io/github/last-commit/alfredxing/brick)](https://github.com/alfredxing/brick) - Webfonts that actually look good.
...
* [Batch Icons](http://adamwhitcroft.com/batch/) - [:copyright: ![GitHub Repo Stars](https://img.shields.io/github/stars/AdamWhitcroft/Batch) ![GitHub last commit](https://img.shields.io/github/last-commit/AdamWhitcroft/Batch)](https://github.com/AdamWhitcroft/Batch/blob/master/License.txt) Icon set of 300+ icons, which is part of [inuit.css ![GitHub Repo Stars](https://img.shields.io/github/stars/csswizardry/inuit.css) ![GitHub last commit](https://img.shields.io/github/last-commit/csswizardry/inuit.css)](https://github.com/csswizardry/inuit.css).
...
* [Fontello](http://fontello.com/) - [:copyright: ![GitHub Repo Stars](https://img.shields.io/github/stars/fontello/fontello) ![GitHub last commit](https://img.shields.io/github/last-commit/fontello/fontello)](https://github.com/fontello/fontello/wiki/What-about-license%3F) - Fontello is a tool to quickly pack vector images into webfonts. Also includes a section of stock icons.
...
* [Simple Icons](https://simpleicons.org/) -[:copyright: ![GitHub Repo Stars](https://img.shields.io/github/stars/simple-icons/simple-icons) ![GitHub last commit](https://img.shields.io/github/last-commit/simple-icons/simple-icons)](https://github.com/simple-icons/simple-icons/blob/develop/LICENSE.md) Free SVG icons for popular brands.
...
* [Topcoat Icons ![GitHub Repo Stars](https://img.shields.io/github/stars/topcoat/icons) ![GitHub last commit](https://img.shields.io/github/last-commit/topcoat/icons)](https://github.com/topcoat/icons) - [:copyright:](http://www.apache.org/licenses/LICENSE-2.0) Icons by [Topcoat](http://topcoat.io/).
...
* [Fluent UI System Icons ![GitHub Repo Stars](https://img.shields.io/github/stars/microsoft/fluentui-system-icons) ![GitHub last commit](https://img.shields.io/github/last-commit/microsoft/fluentui-system-icons)](https://github.com/microsoft/fluentui-system-icons) - [:copyright:](https://opensource.org/licenses/MIT) Fluent System Icons are a collection of familiar, friendly and modern icons from Microsoft.
