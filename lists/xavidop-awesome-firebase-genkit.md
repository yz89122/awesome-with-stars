...
4. Other Plugins
   ...
   - [`ejentum-genkit` ![GitHub Repo Stars](https://img.shields.io/github/stars/ejentum/ejentum-genkit) ![GitHub last commit](https://img.shields.io/github/last-commit/ejentum/ejentum-genkit)](https://github.com/ejentum/ejentum-genkit) - Plugin that registers four agent-callable tools (reasoning, code, anti-deception, memory) the model calls before generating. Each call returns a structured cognitive scaffold from the Ejentum Reasoning Harness.
...
- [`Genkit Kraft` ![GitHub Repo Stars](https://img.shields.io/github/stars/DEEJ4Y/genkitkraft) ![GitHub last commit](https://img.shields.io/github/last-commit/DEEJ4Y/genkitkraft)](https://github.com/DEEJ4Y/genkitkraft) - A self-hostable LLM agent platform built on the Genkit Go SDK that lets you configure, test, and deploy AI agents through a visual UI, OpenAI-compatible REST API, and MCP server support for use with AI clients like Claude.
