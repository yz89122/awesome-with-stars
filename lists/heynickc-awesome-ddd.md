...
- [Awesome Event Storming ![GitHub Repo Stars](https://img.shields.io/github/stars/mariuszgil/awesome-eventstorming) ![GitHub last commit](https://img.shields.io/github/last-commit/mariuszgil/awesome-eventstorming)](https://github.com/mariuszgil/awesome-eventstorming) - awesome list that focuses only on Event Storming.
...
- [Go DDD Template ![GitHub Repo Stars](https://img.shields.io/github/stars/sklinkert/go-ddd) ![GitHub last commit](https://img.shields.io/github/last-commit/sklinkert/go-ddd)](https://github.com/sklinkert/go-ddd) - Production-grade DDD and CQRS template with value objects, race-safe idempotent commands, domain events with a transactional outbox, and a tutorial series teaching DDD from zero.
...
### .NET (C#/F#)
- [AppointMe ![GitHub Repo Stars](https://img.shields.io/github/stars/bravodev-hub/appointme) ![GitHub last commit](https://img.shields.io/github/last-commit/bravodev-hub/appointme)](https://github.com/bravodev-hub/appointme) - A production-grade SaaS template on .NET 10, React, modular monolith, vertical slices, multitenancy, CQRS, DDD, event-driven architecture, durable messaging (outbox).
...
- [LexiQuest-Modular-DDD ![GitHub Repo Stars](https://img.shields.io/github/stars/ryletko/LexiQuest-Modular-DDD) ![GitHub last commit](https://img.shields.io/github/last-commit/ryletko/LexiQuest-Modular-DDD)](https://github.com/ryletko/LexiQuest-Modular-DDD) - Modular application built with Clean Architecture and DDD principles which is ready to quickly get splitted into microserves.
...
- [Modular.StarterTemplate ![GitHub Repo Stars](https://img.shields.io/github/stars/ryletko/Modular.StarterTemplate) ![GitHub last commit](https://img.shields.io/github/last-commit/ryletko/Modular.StarterTemplate)](https://github.com/ryletko/Modular.StarterTemplate) - Starter template for a modular application in Clean Architecture DDD style with synchronous interaction between modules within single transaction. Perfect for ERP applications.
...
- [OpenMind.DDD.Patterns ![GitHub Repo Stars](https://img.shields.io/github/stars/tung-le-lv/OpenMind.DDD.Patterns) ![GitHub last commit](https://img.shields.io/github/last-commit/tung-le-lv/OpenMind.DDD.Patterns)](https://github.com/tung-le-lv/OpenMind.DDD.Patterns) - A comprehensive C# demo of DDD tactical patterns (Entities, Value Objects, Aggregates, Domain Events) and strategic design (Bounded Contexts, Context Mapping) using an order management domain, with CQRS, Event-Driven Architecture, and MongoDB.
...
- [`txob` ![GitHub Repo Stars](https://img.shields.io/github/stars/osbytes/txob) ![GitHub last commit](https://img.shields.io/github/last-commit/osbytes/txob)](https://github.com/osbytes/txob) - Transactional outbox event processor with Postgres and MongoDB native plugins — at-least-once delivery, near-realtime wakeup signals, graceful shutdown, and horizontal scalability.
...
- [Stratara ![GitHub Repo Stars](https://img.shields.io/github/stars/yesbert/Stratara) ![GitHub last commit](https://img.shields.io/github/last-commit/yesbert/Stratara)](https://github.com/yesbert/Stratara) - CQRS and Event Sourcing framework for .NET with tamper-evident streams and tenant-aware encryption, plus integrated mediator, outbox, sagas and projections.
...
- [Deveel Repository ![GitHub Repo Stars](https://img.shields.io/github/stars/deveel/deveel.repository) ![GitHub last commit](https://img.shields.io/github/last-commit/deveel/deveel.repository)](https://github.com/deveel/deveel.repository) - A simple implementation of the Repository pattern for .NET, supporting MongoDB and Entity Framework, extending the model with further utilities (caching, paging, validation, etc.).
...
- [nestjs-hexagonal ![GitHub Repo Stars](https://img.shields.io/github/stars/Softtor/nestjs-hexagonal) ![GitHub last commit](https://img.shields.io/github/last-commit/Softtor/nestjs-hexagonal)](https://github.com/Softtor/nestjs-hexagonal) - Claude Code plugin for building NestJS bounded contexts with Hexagonal Architecture, DDD, CQRS, and event-driven patterns.
...
- [Pure Assert ![GitHub Repo Stars](https://img.shields.io/github/stars/sympol/pure-assert) ![GitHub last commit](https://img.shields.io/github/last-commit/sympol/pure-assert)](https://github.com/sympol/pure-assert) - A lightweight, zero-dependency Java library for expressive pure input assertions and domain invariants.
...
- [DDD Toolbox](https://dddtoolbox.com) - Open-source collection of modern web-based tools including Domain Storytelling and Event Storming ([Source Code ![GitHub Repo Stars](https://img.shields.io/github/stars/poulainpi/ddd-toolbox) ![GitHub last commit](https://img.shields.io/github/last-commit/poulainpi/ddd-toolbox)](https://github.com/poulainpi/ddd-toolbox)).
