...
- [Implementation status ![GitHub Repo Stars](https://img.shields.io/github/stars/gpuweb/gpuweb) ![GitHub last commit](https://img.shields.io/github/last-commit/gpuweb/gpuweb)](https://github.com/gpuweb/gpuweb/wiki/Implementation-Status) - Official W3C Group.
...
- [LearningWebGPU 教程 (Chinese) ![GitHub Repo Stars](https://img.shields.io/github/stars/hjlld/LearningWebGPU) ![GitHub last commit](https://img.shields.io/github/last-commit/hjlld/LearningWebGPU)](https://github.com/hjlld/LearningWebGPU) - By [@hjlld](https://github.com/hjlld).
...
- [RedGPU ![GitHub Repo Stars](https://img.shields.io/github/stars/redcamel/RedGPU) ![GitHub last commit](https://img.shields.io/github/last-commit/redcamel/RedGPU)](https://github.com/redcamel/RedGPU) - JavaScript WbeGPU library, by [@redcamel](https://github.com/redcamel).
- [WebGPU .NET ![GitHub Repo Stars](https://img.shields.io/github/stars/WaveEngine/WebGPU.NET) ![GitHub last commit](https://img.shields.io/github/last-commit/WaveEngine/WebGPU.NET)](https://github.com/WaveEngine/WebGPU.NET) - .NET bindings, built on top of wgpu.
...
- [Arche Graphics ![GitHub Repo Stars](https://img.shields.io/github/stars/yangfengzzz/Arche.js) ![GitHub last commit](https://img.shields.io/github/last-commit/yangfengzzz/Arche.js)](https://github.com/yangfengzzz/Arche.js) - WebGPU Graphics Engine.
...
- [GEngine ![GitHub Repo Stars](https://img.shields.io/github/stars/hpugis/GEngine) ![GitHub last commit](https://img.shields.io/github/last-commit/hpugis/GEngine)](https://github.com/hpugis/GEngine) - A basic rendering engine based on WebGPU, by junwei.gu.
- [Thimbleberry ![GitHub Repo Stars](https://img.shields.io/github/stars/mighdoll/thimbleberry) ![GitHub last commit](https://img.shields.io/github/last-commit/mighdoll/thimbleberry)](https://github.com/mighdoll/thimbleberry) - Reusuable WebGPU shaders and support functions.
- [WebRTX ![GitHub Repo Stars](https://img.shields.io/github/stars/codedhead/webrtx) ![GitHub last commit](https://img.shields.io/github/last-commit/codedhead/webrtx)](https://github.com/codedhead/webrtx) - WebGPU Ray Tracing Extension.
- [SWGPU ![GitHub Repo Stars](https://img.shields.io/github/stars/jay19240/SWGPU) ![GitHub last commit](https://img.shields.io/github/last-commit/jay19240/SWGPU)](https://github.com/jay19240/SWGPU) - A Simple WebGPU Game Engine.
...
- [WebGPU External Texture Test](https://toji.github.io/webgpu-external-test/) - By Brandon Jones - [Repository ![GitHub Repo Stars](https://img.shields.io/github/stars/toji/webgpu-external-test) ![GitHub last commit](https://img.shields.io/github/last-commit/toji/webgpu-external-test)](https://github.com/toji/webgpu-external-test)
...
- [Web Stable Diffusion](https://mlc.ai/web-stable-diffusion/#text-to-image-generation-demo) - An implementation of the image generator AI model, by CMU, OctoML, Catalyst et al - [Repository ![GitHub Repo Stars](https://img.shields.io/github/stars/mlc-ai/web-stable-diffusion) ![GitHub last commit](https://img.shields.io/github/last-commit/mlc-ai/web-stable-diffusion)](https://github.com/mlc-ai/web-stable-diffusion)
- [WebLLM](https://mlc.ai/web-llm/) - LLM inference engine, by CMU, University of Washington, OctoML, et al - [Repository ![GitHub Repo Stars](https://img.shields.io/github/stars/mlc-ai/web-llm) ![GitHub last commit](https://img.shields.io/github/last-commit/mlc-ai/web-llm)](https://github.com/mlc-ai/web-llm)
...
- [WebGPU real-time ray tracer ![GitHub Repo Stars](https://img.shields.io/github/stars/C-none/Web-RTRT) ![GitHub last commit](https://img.shields.io/github/last-commit/C-none/Web-RTRT)](https://github.com/C-none/Web-RTRT/) - A real-time ray tracer implementing ReSTIR algorithm - [Repository ![GitHub Repo Stars](https://img.shields.io/github/stars/C-none/Web-RTRT) ![GitHub last commit](https://img.shields.io/github/last-commit/C-none/Web-RTRT)](https://github.com/C-none/Web-RTRT)
