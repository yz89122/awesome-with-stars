...
moji font: ��� ༐ 💰     ༐ ⑀     🅰️ И     € ❎ ㏂ 𝔭 ᇉ     𝔬 🎏     ᵺ €     モ Ⓜ️ 🍩 🃛 ï     ℉ 𝔬 ♑ 𝔱  (Online demo: http://rupp.de/crypto_puzzles/crypto_puzzles_web.py)
...
* [JetBrains Maple Mono ![GitHub Repo Stars](https://img.shields.io/github/stars/SpaceTimee/Fusion-JetBrainsMapleMono) ![GitHub last commit](https://img.shields.io/github/last-commit/SpaceTimee/Fusion-JetBrainsMapleMono)](https://github.com/SpaceTimee/Fusion-JetBrainsMapleMono) - The free and open-source font fused with JetBrains Mono & Maple Mono
