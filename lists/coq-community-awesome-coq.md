...
- [Tree Sitter Rocq ![GitHub Repo Stars](https://img.shields.io/github/stars/lamg/tree-sitter-rocq) ![GitHub last commit](https://img.shields.io/github/last-commit/lamg/tree-sitter-rocq)](https://github.com/lamg/tree-sitter-rocq) - Partial Rocq tree-sitter grammar useful for syntax highlighting in text editors like [Helix ![GitHub Repo Stars](https://img.shields.io/github/stars/helix-editor/helix) ![GitHub last commit](https://img.shields.io/github/last-commit/helix-editor/helix)](https://github.com/helix-editor/helix), but not recommended for full parsing of Rocq code.
...
- [Rocqnavi ![GitHub Repo Stars](https://img.shields.io/github/stars/affeldt-aist/rocqnavi) ![GitHub last commit](https://img.shields.io/github/last-commit/affeldt-aist/rocqnavi)](https://github.com/affeldt-aist/rocqnavi) - Fork of coq2html that adds indexes, clickable notations, Markdown and LaTeX formatting in comments, and more.
