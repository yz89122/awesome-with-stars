...
This list covers only Python, as many are already familiar with this language. [Data Science tutorials using R ![GitHub Repo Stars](https://img.shields.io/github/stars/ujjwalkarn/DataScienceR) ![GitHub last commit](https://img.shields.io/github/last-commit/ujjwalkarn/DataScienceR)](https://github.com/ujjwalkarn/DataScienceR).
...
- [Pandas cheatsheet ![GitHub Repo Stars](https://img.shields.io/github/stars/pandas-dev/pandas) ![GitHub last commit](https://img.shields.io/github/last-commit/pandas-dev/pandas)](https://github.com/pandas-dev/pandas/blob/master/doc/cheatsheet/Pandas_Cheat_Sheet.pdf) - Quick overview over the most important functions.
...
- [Template folder structure for organizing Data Science projects ![GitHub Repo Stars](https://img.shields.io/github/stars/drivendata/cookiecutter-data-science) ![GitHub last commit](https://img.shields.io/github/last-commit/drivendata/cookiecutter-data-science)](https://github.com/drivendata/cookiecutter-data-science)
...
- [LightGBM gradient boosting framework ![GitHub Repo Stars](https://img.shields.io/github/stars/Microsoft/LightGBM) ![GitHub last commit](https://img.shields.io/github/last-commit/Microsoft/LightGBM)](https://github.com/Microsoft/LightGBM) - Successfully used in many Kaggle challenges.
...
- [Awesome Data Science ![GitHub Repo Stars](https://img.shields.io/github/stars/bulutyazilim/awesome-datascience) ![GitHub last commit](https://img.shields.io/github/last-commit/bulutyazilim/awesome-datascience)](https://github.com/bulutyazilim/awesome-datascience)
- [Data Science Python ![GitHub Repo Stars](https://img.shields.io/github/stars/ujjwalkarn/DataSciencePython) ![GitHub last commit](https://img.shields.io/github/last-commit/ujjwalkarn/DataSciencePython)](https://github.com/ujjwalkarn/DataSciencePython)
- [Machine Learning Tutorials ![GitHub Repo Stars](https://img.shields.io/github/stars/ujjwalkarn/Machine-Learning-Tutorials) ![GitHub last commit](https://img.shields.io/github/last-commit/ujjwalkarn/Machine-Learning-Tutorials)](https://github.com/ujjwalkarn/Machine-Learning-Tutorials)
