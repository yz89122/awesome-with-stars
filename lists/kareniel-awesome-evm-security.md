...
- [The Solcurity Standard ![GitHub Repo Stars](https://img.shields.io/github/stars/Rari-Capital/solcurity) ![GitHub last commit](https://img.shields.io/github/last-commit/Rari-Capital/solcurity)](https://github.com/Rari-Capital/solcurity) - Opinionated security and code quality standard for Solidity smart contracts.
...
- [KEVM ![GitHub Repo Stars](https://img.shields.io/github/stars/kframework/evm-semantics) ![GitHub last commit](https://img.shields.io/github/last-commit/kframework/evm-semantics)](https://github.com/kframework/evm-semantics) - A formal model of the EVM in the K framework.
...
- [List of Security Vulnerabilities ![GitHub Repo Stars](https://img.shields.io/github/stars/runtimeverification/verified-smart-contracts) ![GitHub last commit](https://img.shields.io/github/last-commit/runtimeverification/verified-smart-contracts)](https://github.com/runtimeverification/verified-smart-contracts/wiki/List-of-Security-Vulnerabilities) - A comprehensive list of common smart contract security vulnerabilities, compiled from various sources.
...
## Controls
- [Simple Security Toolkit ![GitHub Repo Stars](https://img.shields.io/github/stars/nascentxyz/simple-security-toolkit) ![GitHub last commit](https://img.shields.io/github/last-commit/nascentxyz/simple-security-toolkit)](https://github.com/nascentxyz/simple-security-toolkit) - Opinionated recommendations that the team at Nascent find to be appropriate,  particularly for teams developing and managing early versions of a protocol.
...
- [Building Secure Contracts ![GitHub Repo Stars](https://img.shields.io/github/stars/crytic/building-secure-contracts) ![GitHub last commit](https://img.shields.io/github/last-commit/crytic/building-secure-contracts)](https://github.com/crytic/building-secure-contracts/) - Trail of Bits' guidelines and best practices on how to write secure smart contracts.
...
- [Smart Contract Security Registry ![GitHub Repo Stars](https://img.shields.io/github/stars/ethereum-lists/contracts) ![GitHub last commit](https://img.shields.io/github/last-commit/ethereum-lists/contracts)](https://github.com/ethereum-lists/contracts) - An effort to identify deployed contracts instances given their chain and address, by listing the project they belong to.
...
- [Awesome BlockSec CTF ![GitHub Repo Stars](https://img.shields.io/github/stars/0xjeffsec/awesome-blocksec-ctf) ![GitHub last commit](https://img.shields.io/github/last-commit/0xjeffsec/awesome-blocksec-ctf)](https://github.com/0xjeffsec/awesome-blocksec-ctf) - Blockchain security Capture the Flag (CTF) competitions.
- [Awesome Buggy ERC20 Tokens ![GitHub Repo Stars](https://img.shields.io/github/stars/sec-bit/awesome-buggy-erc20-tokens) ![GitHub last commit](https://img.shields.io/github/last-commit/sec-bit/awesome-buggy-erc20-tokens)](https://github.com/sec-bit/awesome-buggy-erc20-tokens) - Vulnerabilities in ERC20 Smart Contracts With Tokens Affected.
- [Awesome Cryptoeconomics ![GitHub Repo Stars](https://img.shields.io/github/stars/jpantunes/awesome-cryptoeconomics) ![GitHub last commit](https://img.shields.io/github/last-commit/jpantunes/awesome-cryptoeconomics)](https://github.com/jpantunes/awesome-cryptoeconomics) - Cryptoeconomic research and learning materials.
- [Awesome Zero-Knowledge Proofs (ZKP) ![GitHub Repo Stars](https://img.shields.io/github/stars/matter-labs/awesome-zero-knowledge-proofs) ![GitHub last commit](https://img.shields.io/github/last-commit/matter-labs/awesome-zero-knowledge-proofs)](https://github.com/matter-labs/awesome-zero-knowledge-proofs) - A curated list of awesome things related to learning Zero-Knowledge Proofs (ZKP).
- [Officer CIA's Ultimate DeFi Research Base ![GitHub Repo Stars](https://img.shields.io/github/stars/OffcierCia/ultimate-defi-research-base) ![GitHub last commit](https://img.shields.io/github/last-commit/OffcierCia/ultimate-defi-research-base)](https://github.com/OffcierCia/ultimate-defi-research-base) - Curated DeFI & Blockchain research papers and tools.
- [Awesome MEV resources ![GitHub Repo Stars](https://img.shields.io/github/stars/0xalpharush/awesome-MEV-resources) ![GitHub last commit](https://img.shields.io/github/last-commit/0xalpharush/awesome-MEV-resources)](https://github.com/0xalpharush/awesome-MEV-resources)
