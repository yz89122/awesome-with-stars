...
- This repository contains a topic-wise curated list of Machine Learning and Deep Learning tutorials, articles and other resources. Other awesome lists can be found in this [list ![GitHub Repo Stars](https://img.shields.io/github/stars/sindresorhus/awesome) ![GitHub last commit](https://img.shields.io/github/last-commit/sindresorhus/awesome)](https://github.com/sindresorhus/awesome).

- If you want to contribute to this list, please read [Contributing Guidelines ![GitHub Repo Stars](https://img.shields.io/github/stars/ujjwalkarn/Machine-Learning-Tutorials) ![GitHub last commit](https://img.shields.io/github/last-commit/ujjwalkarn/Machine-Learning-Tutorials)](https://github.com/ujjwalkarn/Machine-Learning-Tutorials/blob/master/contributing.md).

- [Curated list of R tutorials for Data Science, NLP and Machine Learning ![GitHub Repo Stars](https://img.shields.io/github/stars/ujjwalkarn/DataScienceR) ![GitHub last commit](https://img.shields.io/github/last-commit/ujjwalkarn/DataScienceR)](https://github.com/ujjwalkarn/DataScienceR).

- [Curated list of Python tutorials for Data Science, NLP and Machine Learning ![GitHub Repo Stars](https://img.shields.io/github/stars/ujjwalkarn/DataSciencePython) ![GitHub last commit](https://img.shields.io/github/last-commit/ujjwalkarn/DataSciencePython)](https://github.com/ujjwalkarn/DataSciencePython).
...
- [AI/ML YouTube Courses ![GitHub Repo Stars](https://img.shields.io/github/stars/dair-ai/ML-YouTube-Courses) ![GitHub last commit](https://img.shields.io/github/last-commit/dair-ai/ML-YouTube-Courses)](https://github.com/dair-ai/ML-YouTube-Courses)
...
- [List of Machine Learning University Courses ![GitHub Repo Stars](https://img.shields.io/github/stars/prakhar1989/awesome-courses) ![GitHub last commit](https://img.shields.io/github/last-commit/prakhar1989/awesome-courses)](https://github.com/prakhar1989/awesome-courses#machine-learning)

- [Machine Learning for Software Engineers ![GitHub Repo Stars](https://img.shields.io/github/stars/ZuzooVn/machine-learning-for-software-engineers) ![GitHub last commit](https://img.shields.io/github/last-commit/ZuzooVn/machine-learning-for-software-engineers)](https://github.com/ZuzooVn/machine-learning-for-software-engineers)

- [Dive into Machine Learning ![GitHub Repo Stars](https://img.shields.io/github/stars/hangtwenty/dive-into-machine-learning) ![GitHub last commit](https://img.shields.io/github/last-commit/hangtwenty/dive-into-machine-learning)](https://github.com/hangtwenty/dive-into-machine-learning)

- [A curated list of awesome Machine Learning frameworks, libraries and software ![GitHub Repo Stars](https://img.shields.io/github/stars/josephmisiti/awesome-machine-learning) ![GitHub last commit](https://img.shields.io/github/last-commit/josephmisiti/awesome-machine-learning)](https://github.com/josephmisiti/awesome-machine-learning)

- [A curated list of awesome data visualization libraries and resources. ![GitHub Repo Stars](https://img.shields.io/github/stars/fasouto/awesome-dataviz) ![GitHub last commit](https://img.shields.io/github/last-commit/fasouto/awesome-dataviz)](https://github.com/fasouto/awesome-dataviz)

- [An awesome Data Science repository to learn and apply for real world problems ![GitHub Repo Stars](https://img.shields.io/github/stars/okulbilisim/awesome-datascience) ![GitHub last commit](https://img.shields.io/github/last-commit/okulbilisim/awesome-datascience)](https://github.com/okulbilisim/awesome-datascience)
...
- [TheAnalyticsEdge edX Notes and Codes ![GitHub Repo Stars](https://img.shields.io/github/stars/pedrosan/TheAnalyticsEdge) ![GitHub last commit](https://img.shields.io/github/last-commit/pedrosan/TheAnalyticsEdge)](https://github.com/pedrosan/TheAnalyticsEdge)

- [Have Fun With Machine Learning ![GitHub Repo Stars](https://img.shields.io/github/stars/humphd/have-fun-with-machine-learning) ![GitHub last commit](https://img.shields.io/github/last-commit/humphd/have-fun-with-machine-learning)](https://github.com/humphd/have-fun-with-machine-learning)
...
- [Awesome Artificial Intelligence (GitHub Repo) ![GitHub Repo Stars](https://img.shields.io/github/stars/owainlewis/awesome-artificial-intelligence) ![GitHub last commit](https://img.shields.io/github/last-commit/owainlewis/awesome-artificial-intelligence)](https://github.com/owainlewis/awesome-artificial-intelligence)
...
- [Genetic Programming](https://en.wikipedia.org/wiki/Genetic_programming)
    ...
    - [Genetic Programming in Python (GitHub) ![GitHub Repo Stars](https://img.shields.io/github/stars/trevorstephens/gplearn) ![GitHub last commit](https://img.shields.io/github/last-commit/trevorstephens/gplearn)](https://github.com/trevorstephens/gplearn)
...
- [Learn Statistics Using Python ![GitHub Repo Stars](https://img.shields.io/github/stars/rouseguy/intro2stats) ![GitHub last commit](https://img.shields.io/github/last-commit/rouseguy/intro2stats)](https://github.com/rouseguy/intro2stats) - Learn Statistics using an application-centric programming approach
...
- [Ethen's Notebook Collection ![GitHub Repo Stars](https://img.shields.io/github/stars/ethen8181/machine-learning) ![GitHub last commit](https://img.shields.io/github/last-commit/ethen8181/machine-learning)](https://github.com/ethen8181/machine-learning) - Continuously updated machine learning documentations (mainly in Python3). Contents include educational implementation of machine learning algorithms from scratch and open-source library usage
...
- [Machine Learning Cheat Sheet ![GitHub Repo Stars](https://img.shields.io/github/stars/soulmachine/machine-learning-cheat-sheet) ![GitHub last commit](https://img.shields.io/github/last-commit/soulmachine/machine-learning-cheat-sheet)](https://github.com/soulmachine/machine-learning-cheat-sheet)
...
- [Introduction to Deep Learning Using Python (GitHub) ![GitHub Repo Stars](https://img.shields.io/github/stars/rouseguy/intro2deeplearning) ![GitHub last commit](https://img.shields.io/github/last-commit/rouseguy/intro2deeplearning)](https://github.com/rouseguy/intro2deeplearning), [Good Introduction Slides](https://speakerdeck.com/bargava/introduction-to-deep-learning)
...
- Neural Machine Translation
    ...
    - **[Machine Translation Reading List ![GitHub Repo Stars](https://img.shields.io/github/stars/THUNLP-MT/MT-Reading-List) ![GitHub last commit](https://img.shields.io/github/last-commit/THUNLP-MT/MT-Reading-List)](https://github.com/THUNLP-MT/MT-Reading-List#machine-translation-reading-list)**
...
- Deep Learning Frameworks
    ...
    - [Theano](https://en.wikipedia.org/wiki/Theano_(software))
        ...
        - [All Codes ![GitHub Repo Stars](https://img.shields.io/github/stars/lisa-lab/DeepLearningTutorials) ![GitHub last commit](https://img.shields.io/github/last-commit/lisa-lab/DeepLearningTutorials)](https://github.com/lisa-lab/DeepLearningTutorials)
        
        - [Deep Learning Implementation Tutorials - Keras and Lasagne ![GitHub Repo Stars](https://img.shields.io/github/stars/vict0rsch/deep_learning) ![GitHub last commit](https://img.shields.io/github/last-commit/vict0rsch/deep_learning)](https://github.com/vict0rsch/deep_learning/)

    - [Torch](http://torch.ch/)
    
        - [Torch ML Tutorial](http://code.madbits.com/wiki/doku.php), [Code ![GitHub Repo Stars](https://img.shields.io/github/stars/torch/tutorials) ![GitHub last commit](https://img.shields.io/github/last-commit/torch/tutorials)](https://github.com/torch/tutorials)
        
        - [Intro to Torch](http://ml.informatik.uni-freiburg.de/_media/teaching/ws1415/presentation_dl_lect3.pdf)
        
        - [Learning Torch GitHub Repo ![GitHub Repo Stars](https://img.shields.io/github/stars/chetannaik/learning_torch) ![GitHub last commit](https://img.shields.io/github/last-commit/chetannaik/learning_torch)](https://github.com/chetannaik/learning_torch)
        
        - [Awesome-Torch (Repository on GitHub) ![GitHub Repo Stars](https://img.shields.io/github/stars/carpedm20/awesome-torch) ![GitHub last commit](https://img.shields.io/github/last-commit/carpedm20/awesome-torch)](https://github.com/carpedm20/awesome-torch)
        ...
        - [Torch Cheatsheet ![GitHub Repo Stars](https://img.shields.io/github/stars/torch/torch7) ![GitHub last commit](https://img.shields.io/github/last-commit/torch/torch7)](https://github.com/torch/torch7/wiki/Cheatsheet)
    ...
    - TensorFlow
        ...
        - [TensorFlow Examples for Beginners ![GitHub Repo Stars](https://img.shields.io/github/stars/aymericdamien/TensorFlow-Examples) ![GitHub last commit](https://img.shields.io/github/last-commit/aymericdamien/TensorFlow-Examples)](https://github.com/aymericdamien/TensorFlow-Examples)
        
        - [Stanford Tensorflow for Deep Learning Research Course](https://web.stanford.edu/class/cs20si/syllabus.html)
        
            - [GitHub Repo ![GitHub Repo Stars](https://img.shields.io/github/stars/chiphuyen/tf-stanford-tutorials) ![GitHub last commit](https://img.shields.io/github/last-commit/chiphuyen/tf-stanford-tutorials)](https://github.com/chiphuyen/tf-stanford-tutorials)
            
        - [Simplified Scikit-learn Style Interface to TensorFlow ![GitHub Repo Stars](https://img.shields.io/github/stars/tensorflow/skflow) ![GitHub last commit](https://img.shields.io/github/last-commit/tensorflow/skflow)](https://github.com/tensorflow/skflow)
        
        - [Learning TensorFlow GitHub Repo ![GitHub Repo Stars](https://img.shields.io/github/stars/chetannaik/learning_tensorflow) ![GitHub last commit](https://img.shields.io/github/last-commit/chetannaik/learning_tensorflow)](https://github.com/chetannaik/learning_tensorflow)
        
        - [Benchmark TensorFlow GitHub ![GitHub Repo Stars](https://img.shields.io/github/stars/soumith/convnet-benchmarks) ![GitHub last commit](https://img.shields.io/github/last-commit/soumith/convnet-benchmarks)](https://github.com/soumith/convnet-benchmarks/issues/66)
        
        - [Awesome TensorFlow List ![GitHub Repo Stars](https://img.shields.io/github/stars/jtoy/awesome-tensorflow) ![GitHub last commit](https://img.shields.io/github/last-commit/jtoy/awesome-tensorflow)](https://github.com/jtoy/awesome-tensorflow)
        
        - [TensorFlow Book ![GitHub Repo Stars](https://img.shields.io/github/stars/BinRoot/TensorFlow-Book) ![GitHub last commit](https://img.shields.io/github/last-commit/BinRoot/TensorFlow-Book)](https://github.com/BinRoot/TensorFlow-Book)
        ...
        - [Android TensorFlow Machine Learning Example](https://blog.mindorks.com/android-tensorflow-machine-learning-example-ff0e9b2654cc)
            ...
            - [GitHub Repo ![GitHub Repo Stars](https://img.shields.io/github/stars/MindorksOpenSource/AndroidTensorFlowMachineLearningExample) ![GitHub last commit](https://img.shields.io/github/last-commit/MindorksOpenSource/AndroidTensorFlowMachineLearningExample)](https://github.com/MindorksOpenSource/AndroidTensorFlowMachineLearningExample)
        - [Creating Custom Model For Android Using TensorFlow](https://blog.mindorks.com/creating-custom-model-for-android-using-tensorflow-3f963d270bfb)
            - [GitHub Repo ![GitHub Repo Stars](https://img.shields.io/github/stars/MindorksOpenSource/AndroidTensorFlowMNISTExample) ![GitHub last commit](https://img.shields.io/github/last-commit/MindorksOpenSource/AndroidTensorFlowMNISTExample)](https://github.com/MindorksOpenSource/AndroidTensorFlowMNISTExample)            
...
- Feed Forward Networks
    ...
    - [Implementing a Neural Network from scratch](http://www.wildml.com/2015/09/implementing-a-neural-network-from-scratch/), [Code ![GitHub Repo Stars](https://img.shields.io/github/stars/dennybritz/nn-from-scratch) ![GitHub last commit](https://img.shields.io/github/last-commit/dennybritz/nn-from-scratch)](https://github.com/dennybritz/nn-from-scratch)
    
    - [Speeding up your Neural Network with Theano and the gpu](http://www.wildml.com/2015/09/speeding-up-your-neural-network-with-theano-and-the-gpu/), [Code ![GitHub Repo Stars](https://img.shields.io/github/stars/dennybritz/nn-theano) ![GitHub last commit](https://img.shields.io/github/last-commit/dennybritz/nn-theano)](https://github.com/dennybritz/nn-theano)
...
- Recurrent and LSTM Networks
    - [awesome-rnn: list of resources (GitHub Repo) ![GitHub Repo Stars](https://img.shields.io/github/stars/kjw0612/awesome-rnn) ![GitHub last commit](https://img.shields.io/github/last-commit/kjw0612/awesome-rnn)](https://github.com/kjw0612/awesome-rnn)
    
    - [Recurrent Neural Net Tutorial Part 1](http://www.wildml.com/2015/09/recurrent-neural-networks-tutorial-part-1-introduction-to-rnns/), [Part 2](http://www.wildml.com/2015/09/recurrent-neural-networks-tutorial-part-2-implementing-a-language-model-rnn-with-python-numpy-and-theano/), [Part 3](http://www.wildml.com/2015/10/recurrent-neural-networks-tutorial-part-3-backpropagation-through-time-and-vanishing-gradients/), [Code ![GitHub Repo Stars](https://img.shields.io/github/stars/dennybritz/rnn-tutorial-rnnlm) ![GitHub last commit](https://img.shields.io/github/last-commit/dennybritz/rnn-tutorial-rnnlm)](https://github.com/dennybritz/rnn-tutorial-rnnlm/)
    
    - [NLP RNN Representations](http://colah.github.io/posts/2014-07-NLP-RNNs-Representations/)
    
    - [The Unreasonable effectiveness of RNNs](http://karpathy.github.io/2015/05/21/rnn-effectiveness/), [Torch Code ![GitHub Repo Stars](https://img.shields.io/github/stars/karpathy/char-rnn) ![GitHub last commit](https://img.shields.io/github/last-commit/karpathy/char-rnn)](https://github.com/karpathy/char-rnn), [Python Code](https://gist.github.com/karpathy/d4dee566867f8291f086)
    ...
    - [Music generation using RNNs (Keras) ![GitHub Repo Stars](https://img.shields.io/github/stars/MattVitelli/GRUV) ![GitHub last commit](https://img.shields.io/github/last-commit/MattVitelli/GRUV)](https://github.com/MattVitelli/GRUV)
    ...
    - Long Short Term Memory (LSTM)
        ...
        - [Torch Code for character-level language models using LSTM ![GitHub Repo Stars](https://img.shields.io/github/stars/karpathy/char-rnn) ![GitHub last commit](https://img.shields.io/github/last-commit/karpathy/char-rnn)](https://github.com/karpathy/char-rnn)
        
        - [LSTM for Kaggle EEG Detection competition (Torch Code) ![GitHub Repo Stars](https://img.shields.io/github/stars/apaszke/kaggle-grasp-and-lift) ![GitHub last commit](https://img.shields.io/github/last-commit/apaszke/kaggle-grasp-and-lift)](https://github.com/apaszke/kaggle-grasp-and-lift)
        
        - [LSTM for Sentiment Analysis in Theano](http://deeplearning.net/tutorial/lstm.html#lstm)
        
        - [Deep Learning for Visual Q&A | LSTM | CNN](http://avisingh599.github.io/deeplearning/visual-qa/), [Code ![GitHub Repo Stars](https://img.shields.io/github/stars/avisingh599/visual-qa) ![GitHub last commit](https://img.shields.io/github/last-commit/avisingh599/visual-qa)](https://github.com/avisingh599/visual-qa)
        ...
        - [Torch code for Visual Question Answering using a CNN+LSTM model ![GitHub Repo Stars](https://img.shields.io/github/stars/abhshkdz/neural-vqa) ![GitHub last commit](https://img.shields.io/github/last-commit/abhshkdz/neural-vqa)](https://github.com/abhshkdz/neural-vqa)
        
        - [LSTM for Human Activity Recognition ![GitHub Repo Stars](https://img.shields.io/github/stars/guillaume-chevalier/LSTM-Human-Activity-Recognition) ![GitHub last commit](https://img.shields.io/github/last-commit/guillaume-chevalier/LSTM-Human-Activity-Recognition)](https://github.com/guillaume-chevalier/LSTM-Human-Activity-Recognition/)
    ...
    - [Time series forecasting with Sequence-to-Sequence (seq2seq) rnn models ![GitHub Repo Stars](https://img.shields.io/github/stars/guillaume-chevalier/seq2seq-signal-prediction) ![GitHub last commit](https://img.shields.io/github/last-commit/guillaume-chevalier/seq2seq-signal-prediction)](https://github.com/guillaume-chevalier/seq2seq-signal-prediction)
...
- Restricted Boltzmann Machine
    ...
    - [RBMs in R ![GitHub Repo Stars](https://img.shields.io/github/stars/zachmayer/rbm) ![GitHub last commit](https://img.shields.io/github/last-commit/zachmayer/rbm)](https://github.com/zachmayer/rbm)
...
- Convolutional Neural Networks
    ...
    - [Awesome Deep Vision: List of Resources (GitHub) ![GitHub Repo Stars](https://img.shields.io/github/stars/kjw0612/awesome-deep-vision) ![GitHub last commit](https://img.shields.io/github/last-commit/kjw0612/awesome-deep-vision)](https://github.com/kjw0612/awesome-deep-vision)
    ...
    - [Stanford Notes](http://vision.stanford.edu/teaching/cs231n/), [Codes](http://cs231n.github.io/), [GitHub ![GitHub Repo Stars](https://img.shields.io/github/stars/cs231n/cs231n.github.io) ![GitHub last commit](https://img.shields.io/github/last-commit/cs231n/cs231n.github.io)](https://github.com/cs231n/cs231n.github.io)
...
- Network Representation Learning
    ...
    - [Awesome Graph Embedding ![GitHub Repo Stars](https://img.shields.io/github/stars/benedekrozemberczki/awesome-graph-embedding) ![GitHub last commit](https://img.shields.io/github/last-commit/benedekrozemberczki/awesome-graph-embedding)](https://github.com/benedekrozemberczki/awesome-graph-embedding)
    
    - [Awesome Network Embedding ![GitHub Repo Stars](https://img.shields.io/github/stars/chihming/awesome-network-embedding) ![GitHub last commit](https://img.shields.io/github/last-commit/chihming/awesome-network-embedding)](https://github.com/chihming/awesome-network-embedding)
    
    - [Network Representation Learning Papers](https://github.com/thunlp)
    
    - [Knowledge Representation Learning Papers ![GitHub Repo Stars](https://img.shields.io/github/stars/thunlp/KRLPapers) ![GitHub last commit](https://img.shields.io/github/last-commit/thunlp/KRLPapers)](https://github.com/thunlp/KRLPapers)
    
    - [Graph Based Deep Learning Literature ![GitHub Repo Stars](https://img.shields.io/github/stars/naganandy/graph-based-deep-learning-literature) ![GitHub last commit](https://img.shields.io/github/last-commit/naganandy/graph-based-deep-learning-literature)](https://github.com/naganandy/graph-based-deep-learning-literature)

<a name="nlp" />

## Natural Language Processing

- [A curated list of speech and natural language processing resources ![GitHub Repo Stars](https://img.shields.io/github/stars/edobashira/speech-language-processing) ![GitHub last commit](https://img.shields.io/github/last-commit/edobashira/speech-language-processing)](https://github.com/edobashira/speech-language-processing)
...
- Topic Modeling
    ...
    - [Multilingual Latent Dirichlet Allocation (LDA) ![GitHub Repo Stars](https://img.shields.io/github/stars/ArtificiAI/Multilingual-Latent-Dirichlet-Allocation-LDA) ![GitHub last commit](https://img.shields.io/github/last-commit/ArtificiAI/Multilingual-Latent-Dirichlet-Allocation-LDA)](https://github.com/ArtificiAI/Multilingual-Latent-Dirichlet-Allocation-LDA). ([Tutorial here ![GitHub Repo Stars](https://img.shields.io/github/stars/ArtificiAI/Multilingual-Latent-Dirichlet-Allocation-LDA) ![GitHub last commit](https://img.shields.io/github/last-commit/ArtificiAI/Multilingual-Latent-Dirichlet-Allocation-LDA)](https://github.com/ArtificiAI/Multilingual-Latent-Dirichlet-Allocation-LDA/blob/master/Multilingual-LDA-Pipeline-Tutorial.ipynb))

    - [Deep Belief Nets for Topic Modeling ![GitHub Repo Stars](https://img.shields.io/github/stars/larsmaaloee/deep-belief-nets-for-topic-modeling) ![GitHub last commit](https://img.shields.io/github/last-commit/larsmaaloee/deep-belief-nets-for-topic-modeling)](https://github.com/larsmaaloee/deep-belief-nets-for-topic-modeling)
    - [Gaussian LDA for Topic Models with Word Embeddings](http://www.cs.cmu.edu/~rajarshd/papers/acl2015.pdf)
    - Python
        - [Series of lecture notes for probabilistic topic models written in ipython notebook ![GitHub Repo Stars](https://img.shields.io/github/stars/arongdari/topic-model-lecture-note) ![GitHub last commit](https://img.shields.io/github/last-commit/arongdari/topic-model-lecture-note)](https://github.com/arongdari/topic-model-lecture-note)
        - [Implementation of various topic models in Python ![GitHub Repo Stars](https://img.shields.io/github/stars/arongdari/python-topic-model) ![GitHub last commit](https://img.shields.io/github/last-commit/arongdari/python-topic-model)](https://github.com/arongdari/python-topic-model)
...
## Computer Vision
- [Awesome computer vision (github) ![GitHub Repo Stars](https://img.shields.io/github/stars/jbhuang0604/awesome-computer-vision) ![GitHub last commit](https://img.shields.io/github/last-commit/jbhuang0604/awesome-computer-vision)](https://github.com/jbhuang0604/awesome-computer-vision)

- [Awesome deep vision (github) ![GitHub Repo Stars](https://img.shields.io/github/stars/kjw0612/awesome-deep-vision) ![GitHub last commit](https://img.shields.io/github/last-commit/kjw0612/awesome-deep-vision)](https://github.com/kjw0612/awesome-deep-vision)
...
- [Awesome Reinforcement Learning (GitHub) ![GitHub Repo Stars](https://img.shields.io/github/stars/aikorea/awesome-rl) ![GitHub last commit](https://img.shields.io/github/last-commit/aikorea/awesome-rl)](https://github.com/aikorea/awesome-rl)
...
- [Awesome Random Forest (GitHub)** ![GitHub Repo Stars](https://img.shields.io/github/stars/kjw0612/awesome-random-forest) ![GitHub last commit](https://img.shields.io/github/last-commit/kjw0612/awesome-random-forest)](https://github.com/kjw0612/awesome-random-forest)
...
- CatBoost
    ...
    - [Tutorial ![GitHub Repo Stars](https://img.shields.io/github/stars/catboost/tutorials) ![GitHub last commit](https://img.shields.io/github/last-commit/catboost/tutorials)](https://github.com/catboost/tutorials)
...
- [Kalman & Bayesian Filters in Python ![GitHub Repo Stars](https://img.shields.io/github/stars/rlabbe/Kalman-and-Bayesian-Filters-in-Python) ![GitHub last commit](https://img.shields.io/github/last-commit/rlabbe/Kalman-and-Bayesian-Filters-in-Python)](https://github.com/rlabbe/Kalman-and-Bayesian-Filters-in-Python)
...
- For a collection of Data Science Tutorials using R, please refer to [this list ![GitHub Repo Stars](https://img.shields.io/github/stars/ujjwalkarn/DataScienceR) ![GitHub last commit](https://img.shields.io/github/last-commit/ujjwalkarn/DataScienceR)](https://github.com/ujjwalkarn/DataScienceR).

- For a collection of Data Science Tutorials using Python, please refer to [this list ![GitHub Repo Stars](https://img.shields.io/github/stars/ujjwalkarn/DataSciencePython) ![GitHub last commit](https://img.shields.io/github/last-commit/ujjwalkarn/DataSciencePython)](https://github.com/ujjwalkarn/DataSciencePython).
