...
* [Adobe After Effects](https://www.adobe.com/products/aftereffects.htm) – The industry-standard animation and creative compositing app lets you design and deliver professional motion graphics and visual effects for film, TV, video and web:
  ...
  * [BodyMovin ![GitHub Repo Stars](https://img.shields.io/github/stars/bodymovin/bodymovin) ![GitHub last commit](https://img.shields.io/github/last-commit/bodymovin/bodymovin)](https://github.com/bodymovin/bodymovin) – Converter from AE to SVG/canvas.
...
* [Framer.js ![GitHub Repo Stars](https://img.shields.io/github/stars/koenbok/Framer) ![GitHub last commit](https://img.shields.io/github/last-commit/koenbok/Framer)](https://github.com/koenbok/Framer) – Prototyping tool for designing UI, interaction and animation.
* [Dynamics.js](http://dynamicsjs.com/) – JavaScript library to create physics-based animations.
* [Mo.js ![GitHub Repo Stars](https://img.shields.io/github/stars/legomushroom/mojs) ![GitHub last commit](https://img.shields.io/github/last-commit/legomushroom/mojs)](https://github.com/legomushroom/mojs) – Motion graphics toolbelt for the web.
...
* [Animate Plus ![GitHub Repo Stars](https://img.shields.io/github/stars/bendc/animateplus) ![GitHub last commit](https://img.shields.io/github/last-commit/bendc/animateplus)](https://github.com/bendc/animateplus) – CSS and SVG animation library for modern browsers, performant and lightweight (3KB gzipped), making it particularly well-suited for mobile.
* [Gravitas.js ![GitHub Repo Stars](https://img.shields.io/github/stars/iamralpht/gravitas.js) ![GitHub last commit](https://img.shields.io/github/last-commit/iamralpht/gravitas.js)](https://github.com/iamralpht/gravitas.js) – Super fast physics simulations for JavaScript.
...
**Collected with :heart: by Artur Kornakov and [these awesome guys ![GitHub Repo Stars](https://img.shields.io/github/stars/fliptheweb/motion-ui-design) ![GitHub last commit](https://img.shields.io/github/last-commit/fliptheweb/motion-ui-design)](https://github.com/fliptheweb/motion-ui-design/graphs/contributors)**
