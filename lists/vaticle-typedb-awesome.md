...
- [`go-typeql` ![GitHub Repo Stars](https://img.shields.io/github/stars/CaliLuke/go-typeql) ![GitHub last commit](https://img.shields.io/github/last-commit/CaliLuke/go-typeql)](https://github.com/CaliLuke/go-typeql) - A Go ORM for TypeDB 3.x with type-safe CRUD, query building, migrations, and code generation.
- [`skills` ![GitHub Repo Stars](https://img.shields.io/github/stars/typedb/typedb-skills) ![GitHub last commit](https://img.shields.io/github/last-commit/typedb/typedb-skills)](https://github.com/typedb/typedb-skills) - A collection of agent skills, including a TypeDB skill for agent workflows.
