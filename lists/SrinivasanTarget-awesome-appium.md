...
## Server
- [Appium ![GitHub Repo Stars](https://img.shields.io/github/stars/appium/appium) ![GitHub last commit](https://img.shields.io/github/last-commit/appium/appium)](https://github.com/appium/appium/blob/master/docs/en/about-appium/intro.md) - Appium is an open source, cross-platform test automation tool for native, hybrid and mobile web and desktop apps, tested on simulators (iOS), emulators (Android), and real devices (iOS, Android, Windows, Mac).

## Clients
- [Ruby ![GitHub Repo Stars](https://img.shields.io/github/stars/appium/ruby_lib) ![GitHub last commit](https://img.shields.io/github/last-commit/appium/ruby_lib)](https://github.com/appium/ruby_lib)
- [Python ![GitHub Repo Stars](https://img.shields.io/github/stars/appium/python-client) ![GitHub last commit](https://img.shields.io/github/last-commit/appium/python-client)](https://github.com/appium/python-client)
- [Java ![GitHub Repo Stars](https://img.shields.io/github/stars/appium/java-client) ![GitHub last commit](https://img.shields.io/github/last-commit/appium/java-client)](https://github.com/appium/java-client)
- [JavaScript](http://webdriver.io/)
- [Objective C ![GitHub Repo Stars](https://img.shields.io/github/stars/appium/selenium-objective-c) ![GitHub last commit](https://img.shields.io/github/last-commit/appium/selenium-objective-c)](https://github.com/appium/selenium-objective-c)
- [PHP ![GitHub Repo Stars](https://img.shields.io/github/stars/appium/php-client) ![GitHub last commit](https://img.shields.io/github/last-commit/appium/php-client)](https://github.com/appium/php-client)
- [C# (.NET) ![GitHub Repo Stars](https://img.shields.io/github/stars/appium/appium-dotnet-driver) ![GitHub last commit](https://img.shields.io/github/last-commit/appium/appium-dotnet-driver)](https://github.com/appium/appium-dotnet-driver)
- [RobotFramework ![GitHub Repo Stars](https://img.shields.io/github/stars/jollychang/robotframework-appiumlibrary) ![GitHub last commit](https://img.shields.io/github/last-commit/jollychang/robotframework-appiumlibrary)](https://github.com/jollychang/robotframework-appiumlibrary)

## Inspectors
- [Appium Desktop ![GitHub Repo Stars](https://img.shields.io/github/stars/appium/appium-desktop) ![GitHub last commit](https://img.shields.io/github/last-commit/appium/appium-desktop)](https://github.com/appium/appium-desktop) - Appium Server and Inspector in Desktop GUIs for Mac, Windows, and Linux.
- [WebDriverAgent Inspector ![GitHub Repo Stars](https://img.shields.io/github/stars/facebook/WebDriverAgent) ![GitHub last commit](https://img.shields.io/github/last-commit/facebook/WebDriverAgent)](https://github.com/facebook/WebDriverAgent/wiki/Starting-WebDriverAgent) - A WebDriver server for iOS that runs inside the Simulator.
- [Selendroid Inspector](http://selendroid.io/inspector.html) - The web app which is embedded inside your selendroid test server.
- [Appium iOS Inspector ![GitHub Repo Stars](https://img.shields.io/github/stars/mykola-mokhnach/Appium-iOS-Inspector) ![GitHub last commit](https://img.shields.io/github/last-commit/mykola-mokhnach/Appium-iOS-Inspector)](https://github.com/mykola-mokhnach/Appium-iOS-Inspector) - The tool for iOS elements location based on the original source of Selendroid Inspector.
- [app-inspector ![GitHub Repo Stars](https://img.shields.io/github/stars/macacajs/app-inspector) ![GitHub last commit](https://img.shields.io/github/last-commit/macacajs/app-inspector)](https://github.com/macacajs/app-inspector) - Macacajs App Inspector.
...
## Workshops
- [Appium Workshop Selnium Conf 2016 ![GitHub Repo Stars](https://img.shields.io/github/stars/isonic1/appium-workshop) ![GitHub last commit](https://img.shields.io/github/last-commit/isonic1/appium-workshop)](https://github.com/isonic1/appium-workshop) - Repo for Appium Workshop at the 2016 Selenium Conference - Justin Ison.

## Cloud and Docker Solutions
- [Appium Tests in AWS Device Farm ![GitHub Repo Stars](https://img.shields.io/github/stars/awslabs/aws-device-farm-appium-tests-for-sample-app) ![GitHub last commit](https://img.shields.io/github/last-commit/awslabs/aws-device-farm-appium-tests-for-sample-app)](https://github.com/awslabs/aws-device-farm-appium-tests-for-sample-app) - Sample Appium tests runs on AWS Device Farm.
- [Appium Tests in OpenSTF Device Farm ![GitHub Repo Stars](https://img.shields.io/github/stars/openstf/stf-appium-example) ![GitHub last commit](https://img.shields.io/github/last-commit/openstf/stf-appium-example)](https://github.com/openstf/stf-appium-example) - Sample Appium tests runs on STF Device Farm.
- [Official Appium Docker Images ![GitHub Repo Stars](https://img.shields.io/github/stars/appium/appium-docker-android) ![GitHub last commit](https://img.shields.io/github/last-commit/appium/appium-docker-android)](https://github.com/appium/appium-docker-android) - DockerFile for Appium Android Real Devices.
- [Appium Docker Images ![GitHub Repo Stars](https://img.shields.io/github/stars/butomo1989/docker-android) ![GitHub last commit](https://img.shields.io/github/last-commit/butomo1989/docker-android)](https://github.com/butomo1989/docker-android) - DockerFile for Appium Android.
- [Appium Docker File ![GitHub Repo Stars](https://img.shields.io/github/stars/aluedeke/appium-android) ![GitHub last commit](https://img.shields.io/github/last-commit/aluedeke/appium-android)](https://github.com/aluedeke/appium-android) - DockerFile for Appium Android.
- [Appium Docker File ![GitHub Repo Stars](https://img.shields.io/github/stars/softsam/docker-appium) ![GitHub last commit](https://img.shields.io/github/last-commit/softsam/docker-appium)](https://github.com/softsam/docker-appium) - DockerFile for Appium Android.
...
## Test Frameworks 
- [Appium Cucumber Test ![GitHub Repo Stars](https://img.shields.io/github/stars/priyankshah217/AppiumCucumberTest) ![GitHub last commit](https://img.shields.io/github/last-commit/priyankshah217/AppiumCucumberTest)](https://github.com/priyankshah217/AppiumCucumberTest) - Sample Appium Cucumber Project.
- [Appium-Native-Crawler ![GitHub Repo Stars](https://img.shields.io/github/stars/isonic1/Appium-Native-Crawler) ![GitHub last commit](https://img.shields.io/github/last-commit/isonic1/Appium-Native-Crawler)](https://github.com/isonic1/Appium-Native-Crawler) - Appium Native Crawler CLI - Features include: Screenshots, Performance, Accessibility Detection, Google Translate, Applitools, Monkey Tester.
- [coteafs-appium ![GitHub Repo Stars](https://img.shields.io/github/stars/WasiqB/coteafs-appium) ![GitHub last commit](https://img.shields.io/github/last-commit/WasiqB/coteafs-appium)](https://github.com/WasiqB/coteafs-appium) - A tester friendly Mobile Automation Framework built on top of Appium which supports testing web and native apps for Android, iOS and Windows real or emulator Mobiles and Tablets.
- [Optimus ![GitHub Repo Stars](https://img.shields.io/github/stars/testvagrant/optimusTemplate) ![GitHub last commit](https://img.shields.io/github/last-commit/testvagrant/optimusTemplate)](https://github.com/testvagrant/optimusTemplate) - Cucumber based Mobile Automation Framework, which supports test parallelization.
- [PageObject Pattern Framework ![GitHub Repo Stars](https://img.shields.io/github/stars/saikrishna321/PageObjectPatternAppium) ![GitHub last commit](https://img.shields.io/github/last-commit/saikrishna321/PageObjectPatternAppium)](https://github.com/saikrishna321/PageObjectPatternAppium) - Sample Page Object Pattern Framework to use directly.
- [Parallel Framework Java-Client ![GitHub Repo Stars](https://img.shields.io/github/stars/saikrishna321/AppiumTestDistribution) ![GitHub last commit](https://img.shields.io/github/last-commit/saikrishna321/AppiumTestDistribution)](https://github.com/saikrishna321/AppiumTestDistribution) - Run appium tests in parallel across iOS and Android devices.
