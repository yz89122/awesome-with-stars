...
- [Miscellaneous Scripts for fixing issues with the Universal Forwarder ![GitHub Repo Stars](https://img.shields.io/github/stars/jimmyatSplunk/SplunkForwarderRepairKit) ![GitHub last commit](https://img.shields.io/github/last-commit/jimmyatSplunk/SplunkForwarderRepairKit)](https://github.com/jimmyatSplunk/SplunkForwarderRepairKit) - This kit was compiled based on common issues with Splunk deployments and managing idiosyncrasies that tend to naturally occur.
...
- [Awesome-ES ![GitHub Repo Stars](https://img.shields.io/github/stars/sduff/awesome-es) ![GitHub last commit](https://img.shields.io/github/last-commit/sduff/awesome-es)](https://github.com/sduff/awesome-es/) - An Awesome list for all things Enterprise Security.
...
- [Awesome-ITSI ![GitHub Repo Stars](https://img.shields.io/github/stars/sduff/awesome-itsi) ![GitHub last commit](https://img.shields.io/github/last-commit/sduff/awesome-itsi)](https://github.com/sduff/awesome-itsi/) - An Awesome list for all things IT Service Intelligence.
...
- [Vladimir's GitHub](https://github.com/hire-vladimir/) - Code for a number of Splunk resources, including [CIM Validation ![GitHub Repo Stars](https://img.shields.io/github/stars/hire-vladimir/SA-cim_vladiator) ![GitHub last commit](https://img.shields.io/github/last-commit/hire-vladimir/SA-cim_vladiator)](https://github.com/hire-vladimir/SA-cim_vladiator).
