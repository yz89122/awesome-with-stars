...
A curated list of computer history videos, documentaries and related folklore maintained by [Thomas Watson](https://twitter.com/wa7son). Inspired by the [awesome list thing ![GitHub Repo Stars](https://img.shields.io/github/stars/sindresorhus/awesome) ![GitHub last commit](https://img.shields.io/github/last-commit/sindresorhus/awesome)](https://github.com/sindresorhus/awesome).

[Pull Requests ![GitHub Repo Stars](https://img.shields.io/github/stars/watson/awesome-computer-history) ![GitHub last commit](https://img.shields.io/github/last-commit/watson/awesome-computer-history)](https://github.com/watson/awesome-computer-history/edit/master/README.md) are welcome.
...
- [Apollo 11 Guidance Computer ![GitHub Repo Stars](https://img.shields.io/github/stars/chrislgarry/Apollo-11) ![GitHub last commit](https://img.shields.io/github/last-commit/chrislgarry/Apollo-11)](https://github.com/chrislgarry/Apollo-11) (1969) - Original Apollo 11 Guidance Computer (AGC) source code for the command and lunar modules
- [C compiler](https://www.bell-labs.com/usr/dmr/www/primevalC.html) (1972) - The earliest known versions of Dennis Ritchie's first C compiler ([GitHub code mirror ![GitHub Repo Stars](https://img.shields.io/github/stars/mortdeus/legacy-cc) ![GitHub last commit](https://img.shields.io/github/last-commit/mortdeus/legacy-cc)](https://github.com/mortdeus/legacy-cc))
- [UNIX ![GitHub Repo Stars](https://img.shields.io/github/stars/dspinellis/unix-history-repo) ![GitHub last commit](https://img.shields.io/github/last-commit/dspinellis/unix-history-repo)](https://github.com/dspinellis/unix-history-repo/tree/Research-Release) (1972) - Continuous Unix commit history from 1972 until today
- [MS-DOS ![GitHub Repo Stars](https://img.shields.io/github/stars/Microsoft/MS-DOS) ![GitHub last commit](https://img.shields.io/github/last-commit/Microsoft/MS-DOS)](https://github.com/Microsoft/MS-DOS) (1982, 1983) - Version 1.25 and 2.0
