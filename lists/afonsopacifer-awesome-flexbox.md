...
* [Sass flex mixin ![GitHub Repo Stars](https://img.shields.io/github/stars/mastastealth/sass-flex-mixin) ![GitHub last commit](https://img.shields.io/github/last-commit/mastastealth/sass-flex-mixin)](https://github.com/mastastealth/sass-flex-mixin)
* [Stylus flex mixin ![GitHub Repo Stars](https://img.shields.io/github/stars/differui/stylus-flex-mixin) ![GitHub last commit](https://img.shields.io/github/last-commit/differui/stylus-flex-mixin)](https://github.com/differui/stylus-flex-mixin)

#### Polyfills
* [Flexibility ![GitHub Repo Stars](https://img.shields.io/github/stars/10up/flexibility) ![GitHub last commit](https://img.shields.io/github/last-commit/10up/flexibility)](https://github.com/10up/flexibility):metal:
* [Flexie ![GitHub Repo Stars](https://img.shields.io/github/stars/doctyper/flexie) ![GitHub last commit](https://img.shields.io/github/last-commit/doctyper/flexie)](https://github.com/doctyper/flexie)
* [Reflexie ![GitHub Repo Stars](https://img.shields.io/github/stars/doctyper/reflexie) ![GitHub last commit](https://img.shields.io/github/last-commit/doctyper/reflexie)](https://github.com/doctyper/reflexie)
...
* [CSS Flexbox snippets for Atom ![GitHub Repo Stars](https://img.shields.io/github/stars/brenopolanski/css-flexbox-atom-snippets) ![GitHub last commit](https://img.shields.io/github/last-commit/brenopolanski/css-flexbox-atom-snippets)](https://github.com/brenopolanski/css-flexbox-atom-snippets)
* [CSS Flexbox snippets for Sublime Text 2/3 ![GitHub Repo Stars](https://img.shields.io/github/stars/brenopolanski/css-flexbox-sublime-snippets) ![GitHub last commit](https://img.shields.io/github/last-commit/brenopolanski/css-flexbox-sublime-snippets)](https://github.com/brenopolanski/css-flexbox-sublime-snippets)
* [Fibonacci ![GitHub Repo Stars](https://img.shields.io/github/stars/maxsteenbergen/Fibonacci) ![GitHub last commit](https://img.shields.io/github/last-commit/maxsteenbergen/Fibonacci)](https://github.com/maxsteenbergen/Fibonacci)
...
* [Bem grid ![GitHub Repo Stars](https://img.shields.io/github/stars/bem-incubator/bem-grid) ![GitHub last commit](https://img.shields.io/github/last-commit/bem-incubator/bem-grid)](https://github.com/bem-incubator/bem-grid)
* [Flexboxgrid ![GitHub Repo Stars](https://img.shields.io/github/stars/kristoferjoseph/flexboxgrid) ![GitHub last commit](https://img.shields.io/github/last-commit/kristoferjoseph/flexboxgrid)](https://github.com/kristoferjoseph/flexboxgrid):metal:
* [Flex Grid Framework](https://afonsopacifer.github.io/flex-grid-framework/):metal:
* [Flexbox Grid for Stylus](http://stylusgrid.com)
* [Fuux ![GitHub Repo Stars](https://img.shields.io/github/stars/henriquecustodia/fuux) ![GitHub last commit](https://img.shields.io/github/last-commit/henriquecustodia/fuux)](https://github.com/henriquecustodia/fuux) - Fuux is a Flexbox library that uses the same flexbox interface like classes.
* [Ginger Grid ![GitHub Repo Stars](https://img.shields.io/github/stars/erwstout/ginger) ![GitHub last commit](https://img.shields.io/github/last-commit/erwstout/ginger)](https://github.com/erwstout/ginger/) - A Flexbox grid framework named after a cute dog.
...
* [flex-box ![GitHub Repo Stars](https://img.shields.io/github/stars/potch/flex-box) ![GitHub last commit](https://img.shields.io/github/last-commit/potch/flex-box)](https://github.com/potch/flex-box) - A Custom Element to make the basics of flexbox easier to use.
* [Flexbugs ![GitHub Repo Stars](https://img.shields.io/github/stars/philipwalton/flexbugs) ![GitHub last commit](https://img.shields.io/github/last-commit/philipwalton/flexbugs)](https://github.com/philipwalton/flexbugs) - A community-curated list of flexbox issues and cross-browser workarounds for them.
...
* [Flexbox layout ![GitHub Repo Stars](https://img.shields.io/github/stars/google/flexbox-layout) ![GitHub last commit](https://img.shields.io/github/last-commit/google/flexbox-layout)](https://github.com/google/flexbox-layout) - FlexboxLayout is a library project which brings the similar capabilities of CSS Flexible Box Layout Module to Android.
* [FlexLayout for iOS ![GitHub Repo Stars](https://img.shields.io/github/stars/lucdion/FlexLayout) ![GitHub last commit](https://img.shields.io/github/last-commit/lucdion/FlexLayout)](https://github.com/lucdion/FlexLayout) - FlexLayout brings flexbox to iOS using Swift. Concise, intuitive & chainable syntax.
* [grid-styled ![GitHub Repo Stars](https://img.shields.io/github/stars/jxnblk/grid-styled) ![GitHub last commit](https://img.shields.io/github/last-commit/jxnblk/grid-styled)](https://github.com/jxnblk/grid-styled) - Flexbox based responsive ReactJS grid system built with styled-components
...
* [Post Apocalypse Flexbox ![GitHub Repo Stars](https://img.shields.io/github/stars/afonsopacifer/post-apocalypse-flexbox) ![GitHub last commit](https://img.shields.io/github/last-commit/afonsopacifer/post-apocalypse-flexbox)](https://github.com/afonsopacifer/post-apocalypse-flexbox)
* [React-flexbox ![GitHub Repo Stars](https://img.shields.io/github/stars/tcoopman/react-flexbox) ![GitHub last commit](https://img.shields.io/github/last-commit/tcoopman/react-flexbox)](https://github.com/tcoopman/react-flexbox) - Implementation of css flexbox in react with inline styles.
* [Reflexbox ![GitHub Repo Stars](https://img.shields.io/github/stars/jxnblk/reflexbox) ![GitHub last commit](https://img.shields.io/github/last-commit/jxnblk/reflexbox)](https://github.com/jxnblk/reflexbox) - Responsive React flexbox grid system higher order component.
* [Solved by flexbox ![GitHub Repo Stars](https://img.shields.io/github/stars/philipwalton/solved-by-flexbox) ![GitHub last commit](https://img.shields.io/github/last-commit/philipwalton/solved-by-flexbox)](https://github.com/philipwalton/solved-by-flexbox) - A showcase of problems once hard or impossible to solve with CSS alone, now made trivially easy with Flexbox.:metal:
...
## Contributing
Want to contribute? [Follow these recommendations ![GitHub Repo Stars](https://img.shields.io/github/stars/afonsopacifer/awesome-flexbox) ![GitHub last commit](https://img.shields.io/github/last-commit/afonsopacifer/awesome-flexbox)](https://github.com/afonsopacifer/awesome-flexbox/blob/master/contributing.md).

## License
[MIT License ![GitHub Repo Stars](https://img.shields.io/github/stars/afonsopacifer/awesome-flexbox) ![GitHub last commit](https://img.shields.io/github/last-commit/afonsopacifer/awesome-flexbox)](https://github.com/afonsopacifer/awesome-flexbox/blob/master/license.md) © [Afonso Pacifer](https://afonsopacifer.github.io/)
