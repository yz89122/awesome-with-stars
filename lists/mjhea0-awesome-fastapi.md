...
- [FastAdmin ![GitHub Repo Stars](https://img.shields.io/github/stars/vsdudakov/fastadmin) ![GitHub last commit](https://img.shields.io/github/last-commit/vsdudakov/fastadmin)](https://github.com/vsdudakov/fastadmin) - Easy-to-use admin dashboard for FastAPI (also Flask and Django), inspired by Django Admin.
...
- [SQLAlchemy Admin ![GitHub Repo Stars](https://img.shields.io/github/stars/smithyhq/sqladmin) ![GitHub last commit](https://img.shields.io/github/last-commit/smithyhq/sqladmin)](https://github.com/smithyhq/sqladmin) - Admin Panel for FastAPI/Starlette that works with SQLAlchemy models.
...
- [FastAPI Casbin Auth ![GitHub Repo Stars](https://img.shields.io/github/stars/apache/casbin-python-fastapi-casbin-auth) ![GitHub last commit](https://img.shields.io/github/last-commit/apache/casbin-python-fastapi-casbin-auth)](https://github.com/apache/casbin-python-fastapi-casbin-auth) - Authorization which supports various access control models like RBAC, ReBAC and ABAC through Casbin.
...
- [FastAPI Login ![GitHub Repo Stars](https://img.shields.io/github/stars/maxrdu/fastapi_login) ![GitHub last commit](https://img.shields.io/github/last-commit/maxrdu/fastapi_login)](https://github.com/maxrdu/fastapi_login) - Account management and authentication (based on [Flask-Login ![GitHub Repo Stars](https://img.shields.io/github/stars/maxcountryman/flask-login) ![GitHub last commit](https://img.shields.io/github/last-commit/maxcountryman/flask-login)](https://github.com/maxcountryman/flask-login)).
...
- [FastAPI Zitadel Auth ![GitHub Repo Stars](https://img.shields.io/github/stars/cleanenergyexchange/fastapi-zitadel-auth) ![GitHub last commit](https://img.shields.io/github/last-commit/cleanenergyexchange/fastapi-zitadel-auth)](https://github.com/cleanenergyexchange/fastapi-zitadel-auth) - OAuth2 using the IAM platform [Zitadel ![GitHub Repo Stars](https://img.shields.io/github/stars/zitadel/zitadel) ![GitHub last commit](https://img.shields.io/github/last-commit/zitadel/zitadel)](https://github.com/zitadel/zitadel).
...
- [secure ![GitHub Repo Stars](https://img.shields.io/github/stars/TypeError/secure) ![GitHub last commit](https://img.shields.io/github/last-commit/TypeError/secure)](https://github.com/TypeError/secure) - Define and apply HTTP security headers consistently in FastAPI apps using ASGI middleware and a single configuration object.
...
- [Beanie ![GitHub Repo Stars](https://img.shields.io/github/stars/BeanieODM/beanie) ![GitHub last commit](https://img.shields.io/github/last-commit/BeanieODM/beanie)](https://github.com/BeanieODM/beanie) - Asynchronous Python ODM for MongoDB, based on [Motor](https://motor.readthedocs.io/en/stable/) and [Pydantic](https://pydantic.dev/docs/), which supports data and schema migrations out of the box.
...
- [modern-di ![GitHub Repo Stars](https://img.shields.io/github/stars/modern-python/modern-di) ![GitHub last commit](https://img.shields.io/github/last-commit/modern-python/modern-di)](https://github.com/modern-python/modern-di) - Dependency injection framework with IoC container and scopes, with a [FastAPI integration ![GitHub Repo Stars](https://img.shields.io/github/stars/modern-python/modern-di-fastapi) ![GitHub last commit](https://img.shields.io/github/last-commit/modern-python/modern-di-fastapi)](https://github.com/modern-python/modern-di-fastapi).
- [Wireup ![GitHub Repo Stars](https://img.shields.io/github/stars/maldoinc/wireup) ![GitHub last commit](https://img.shields.io/github/last-commit/maldoinc/wireup)](https://github.com/maldoinc/wireup) - Inject dependencies with zero runtime overhead in FastAPI; Share dependencies across web, cli or other interfaces.
...
- [FastAPI FastCRUD ![GitHub Repo Stars](https://img.shields.io/github/stars/benavlabs/fastcrud) ![GitHub last commit](https://img.shields.io/github/last-commit/benavlabs/fastcrud)](https://github.com/benavlabs/fastcrud)) - Robust async CRUD operations and flexible endpoint creation utilities.
...
- [FastAPI Injectable ![GitHub Repo Stars](https://img.shields.io/github/stars/JasperSui/fastapi-injectable) ![GitHub last commit](https://img.shields.io/github/last-commit/JasperSui/fastapi-injectable)](https://github.com/JasperSui/fastapi-injectable) - Use FastAPI's dependency injection outside route handlers in CLI tools, background tasks, workers, and more.
...
- [FastAPI Viewsets ![GitHub Repo Stars](https://img.shields.io/github/stars/svalench/fastapi_viewsets) ![GitHub last commit](https://img.shields.io/github/last-commit/svalench/fastapi_viewsets)](https://github.com/svalench/fastapi_viewsets) - Django REST Framework-inspired ViewSets for FastAPI, enabling class-based CRUD endpoint organization with automatic route registration.
...
- [Pydantic Resolve ![GitHub Repo Stars](https://img.shields.io/github/stars/KLR-Pattern/pydantic-resolve) ![GitHub last commit](https://img.shields.io/github/last-commit/KLR-Pattern/pydantic-resolve)](https://github.com/KLR-Pattern/pydantic-resolve) -  Turns pydantic class into a powerful composable computing container by introducing resolve and post-process hooks.
...
, which includes FastAPI, React, SQLModel, PostgreSQL, Docker, GitHub Actions, automatic HTTPS, and more (developed by the creator of FastAPI, [Sebasti��n Ramírez](https://github.com/tiangolo)).
...
- [FastAPI + SQLAlchemy 2 + PostgreSQL Template ![GitHub Repo Stars](https://img.shields.io/github/stars/modern-python/fastapi-sqlalchemy-template) ![GitHub last commit](https://img.shields.io/github/last-commit/modern-python/fastapi-sqlalchemy-template)](https://github.com/modern-python/fastapi-sqlalchemy-template) - Dockerized starter with dependency injection (modern-di), Alembic migrations, and a justfile workflow.
...
- [FastAPI Agent Blueprint ![GitHub Repo Stars](https://img.shields.io/github/stars/Mr-DooSun/fastapi-agent-blueprint) ![GitHub last commit](https://img.shields.io/github/last-commit/Mr-DooSun/fastapi-agent-blueprint)](https://github.com/Mr-DooSun/fastapi-agent-blueprint) - DDD layered template where generic base classes give async CRUD with no boilerplate, domains self-register on discovery, and pre-commit hooks block cross-layer imports at commit time.
...
- [FuturamaAPI ![GitHub Repo Stars](https://img.shields.io/github/stars/koldakov/futuramaapi) ![GitHub last commit](https://img.shields.io/github/last-commit/koldakov/futuramaapi)](https://github.com/koldakov/futuramaapi) - A REST and GraphQL playground built with best practices, providing WebSockets, SSE, callbacks, secret messages, and more.
