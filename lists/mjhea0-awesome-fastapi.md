...
- [FastAPI Casbin Auth ![GitHub Repo Stars](https://img.shields.io/github/stars/officialpycasbin/fastapi-casbin-auth) ![GitHub last commit](https://img.shields.io/github/last-commit/officialpycasbin/fastapi-casbin-auth)](https://github.com/officialpycasbin/fastapi-casbin-auth) - Authorization which supports various access control models like RBAC, ReBAC and ABAC through Casbin.
