...
* [Open Container Specifications ![GitHub Repo Stars](https://img.shields.io/github/stars/opencontainers/specs) ![GitHub last commit](https://img.shields.io/github/last-commit/opencontainers/specs)](https://github.com/opencontainers/specs)  
This project is where the Open Container Initiative Specifications are written. This is a work in progress. 
* [App Container basics ![GitHub Repo Stars](https://img.shields.io/github/stars/coreos/rkt) ![GitHub last commit](https://img.shields.io/github/last-commit/coreos/rkt)](https://github.com/coreos/rkt/blob/master/Documentation/app-container.md)  
...
* [Nulecule Specification ![GitHub Repo Stars](https://img.shields.io/github/stars/projectatomic/atomicapp) ![GitHub last commit](https://img.shields.io/github/last-commit/projectatomic/atomicapp)](https://github.com/projectatomic/atomicapp/tree/master/docs/spec)  
...
* [Cloud Native Application Bundle Specification ![GitHub Repo Stars](https://img.shields.io/github/stars/deislabs/cnab-spec) ![GitHub last commit](https://img.shields.io/github/last-commit/deislabs/cnab-spec)](https://github.com/deislabs/cnab-spec)  
...
* [Warden ![GitHub Repo Stars](https://img.shields.io/github/stars/cloudfoundry/warden) ![GitHub last commit](https://img.shields.io/github/last-commit/cloudfoundry/warden)](https://github.com/cloudfoundry/warden)  
...
* [Photon ![GitHub Repo Stars](https://img.shields.io/github/stars/vmware/photon) ![GitHub last commit](https://img.shields.io/github/last-commit/vmware/photon)](https://github.com/vmware/photon)  
...
* [Docker ![GitHub Repo Stars](https://img.shields.io/github/stars/veggiemonk/awesome-docker) ![GitHub last commit](https://img.shields.io/github/last-commit/veggiemonk/awesome-docker)](https://github.com/veggiemonk/awesome-docker#cloud-infrastructure)  
An open platform for distributed applications for developers and sysadmins. **Standard de facto**.
* [LXD ![GitHub Repo Stars](https://img.shields.io/github/stars/lxc/lxd) ![GitHub last commit](https://img.shields.io/github/last-commit/lxc/lxd)](https://github.com/lxc/lxd)  
...
* [MultiDocker ![GitHub Repo Stars](https://img.shields.io/github/stars/marty90/multidocker) ![GitHub last commit](https://img.shields.io/github/last-commit/marty90/multidocker)](https://github.com/marty90/multidocker)  
Create a secure multi-user Docker machine, where each user is segregated into an indepentent container.
* [Lithos ![GitHub Repo Stars](https://img.shields.io/github/stars/tailhook/lithos) ![GitHub last commit](https://img.shields.io/github/last-commit/tailhook/lithos)](https://github.com/tailhook/lithos/)  
...
* [runc ![GitHub Repo Stars](https://img.shields.io/github/stars/opencontainers/runc) ![GitHub last commit](https://img.shields.io/github/last-commit/opencontainers/runc)](https://github.com/opencontainers/runc)  
runc is a CLI tool for spawning and running containers according to the OCS specification.
* [Bocker ![GitHub Repo Stars](https://img.shields.io/github/stars/p8952/bocker) ![GitHub last commit](https://img.shields.io/github/last-commit/p8952/bocker)](https://github.com/p8952/bocker)  
Docker implemented in around 100 lines of bash.
* [Rocket ![GitHub Repo Stars](https://img.shields.io/github/stars/coreos/rkt) ![GitHub last commit](https://img.shields.io/github/last-commit/coreos/rkt)](https://github.com/coreos/rkt)  
...
* [LXC ![GitHub Repo Stars](https://img.shields.io/github/stars/lxc/lxc) ![GitHub last commit](https://img.shields.io/github/last-commit/lxc/lxc)](https://github.com/lxc/lxc)  
LXC is the well known set of tools, templates, library and language bindings. It's pretty low level, very flexible and covers just about every containment feature supported by the upstream kernel.
* [Vagga ![GitHub Repo Stars](https://img.shields.io/github/stars/tailhook/vagga) ![GitHub last commit](https://img.shields.io/github/last-commit/tailhook/vagga)](https://github.com/tailhook/vagga)  
Vagga is a fully-userspace container engine inspired by Vagrant and Docker, specialized for development environments.
* [libct ![GitHub Repo Stars](https://img.shields.io/github/stars/xemul/libct) ![GitHub last commit](https://img.shields.io/github/last-commit/xemul/libct)](https://github.com/xemul/libct)  
...
* [porto ![GitHub Repo Stars](https://img.shields.io/github/stars/yandex/porto) ![GitHub last commit](https://img.shields.io/github/last-commit/yandex/porto)](https://github.com/yandex/porto)  
...
* [udocker ![GitHub Repo Stars](https://img.shields.io/github/stars/indigo-dc/udocker) ![GitHub last commit](https://img.shields.io/github/last-commit/indigo-dc/udocker)](https://github.com/indigo-dc/udocker)  
A basic user tool to execute simple containers in batch or interactive systems without root privileges.
* [Let Me Contain That For You ![GitHub Repo Stars](https://img.shields.io/github/stars/google/lmctfy) ![GitHub last commit](https://img.shields.io/github/last-commit/google/lmctfy)](https://github.com/google/lmctfy)  
LMCTFY is the open source version of Google’s container stack, which provides Linux application containers.
* [cc-oci-runtime ![GitHub Repo Stars](https://img.shields.io/github/stars/01org/cc-oci-runtime) ![GitHub last commit](https://img.shields.io/github/last-commit/01org/cc-oci-runtime)](https://github.com/01org/cc-oci-runtime)  
Intel Clear Linux OCI (Open Containers Initiative) compatible runtime.
* [railcar ![GitHub Repo Stars](https://img.shields.io/github/stars/oracle/railcar) ![GitHub last commit](https://img.shields.io/github/last-commit/oracle/railcar)](https://github.com/oracle/railcar)  
...
* [plash ![GitHub Repo Stars](https://img.shields.io/github/stars/ihucos/plash) ![GitHub last commit](https://img.shields.io/github/last-commit/ihucos/plash)](https://github.com/ihucos/plash/)  
Lightweight, rootless containers.
* [runv ![GitHub Repo Stars](https://img.shields.io/github/stars/hyperhq/runv) ![GitHub last commit](https://img.shields.io/github/last-commit/hyperhq/runv)](https://github.com/hyperhq/runv)  
Hypervisor-based (KVM, Xen, QEMU) Runtime for OCI. Security by isolation.
* [podman ![GitHub Repo Stars](https://img.shields.io/github/stars/containers/libpod) ![GitHub last commit](https://img.shields.io/github/last-commit/containers/libpod)](https://github.com/containers/libpod)  
Full management of container lifecycle.
* [firecracker ![GitHub Repo Stars](https://img.shields.io/github/stars/firecracker-microvm/firecracker) ![GitHub last commit](https://img.shields.io/github/last-commit/firecracker-microvm/firecracker)](https://github.com/firecracker-microvm/firecracker)  
Firecracker runs workloads in lightweight virtual machines, called microVMs, which combine the security and isolation properties provided by hardware virtualization technology with the speed and flexibility of containers.
* [sysbox ![GitHub Repo Stars](https://img.shields.io/github/stars/nestybox/sysbox) ![GitHub last commit](https://img.shields.io/github/last-commit/nestybox/sysbox)](https://github.com/nestybox/sysbox)  
...
* [youki ![GitHub Repo Stars](https://img.shields.io/github/stars/containers/youki) ![GitHub last commit](https://img.shields.io/github/last-commit/containers/youki)](https://github.com/containers/youki)  
A container runtime written in Rust.
* [footloose ![GitHub Repo Stars](https://img.shields.io/github/stars/weaveworks/footloose) ![GitHub last commit](https://img.shields.io/github/last-commit/weaveworks/footloose)](https://github.com/weaveworks/footloose)  
...
* [NsJail ![GitHub Repo Stars](https://img.shields.io/github/stars/google/nsjail) ![GitHub last commit](https://img.shields.io/github/last-commit/google/nsjail)](https://github.com/google/nsjail)  
...
* [Subuser ![GitHub Repo Stars](https://img.shields.io/github/stars/subuser-security/subuser) ![GitHub last commit](https://img.shields.io/github/last-commit/subuser-security/subuser)](https://github.com/subuser-security/subuser)  
...
* [Bubblewrap ![GitHub Repo Stars](https://img.shields.io/github/stars/projectatomic/bubblewrap) ![GitHub last commit](https://img.shields.io/github/last-commit/projectatomic/bubblewrap)](https://github.com/projectatomic/bubblewrap)  
...
* [singularity ![GitHub Repo Stars](https://img.shields.io/github/stars/singularityware/singularity) ![GitHub last commit](https://img.shields.io/github/last-commit/singularityware/singularity)](https://github.com/singularityware/singularity)  
Universal application containers for Linux.
* [Lxroot ![GitHub Repo Stars](https://img.shields.io/github/stars/parke/lxroot) ![GitHub last commit](https://img.shields.io/github/last-commit/parke/lxroot)](https://github.com/parke/lxroot)  
...
* [python-nsenter ![GitHub Repo Stars](https://img.shields.io/github/stars/zalando/python-nsenter) ![GitHub last commit](https://img.shields.io/github/last-commit/zalando/python-nsenter)](https://github.com/zalando/python-nsenter)  
...
* [pyspaces ![GitHub Repo Stars](https://img.shields.io/github/stars/Friz-zy/pyspaces) ![GitHub last commit](https://img.shields.io/github/last-commit/Friz-zy/pyspaces)](https://github.com/Friz-zy/pyspaces)  
...
* [container-diff ![GitHub Repo Stars](https://img.shields.io/github/stars/GoogleCloudPlatform/container-diff) ![GitHub last commit](https://img.shields.io/github/last-commit/GoogleCloudPlatform/container-diff)](https://github.com/GoogleCloudPlatform/container-diff)  
A tool for analyzing and comparing container images.
* [buildah ![GitHub Repo Stars](https://img.shields.io/github/stars/projectatomic/buildah) ![GitHub last commit](https://img.shields.io/github/last-commit/projectatomic/buildah)](https://github.com/projectatomic/buildah)  
A tool which facilitates building OCI container images.
* [skopeo ![GitHub Repo Stars](https://img.shields.io/github/stars/projectatomic/skopeo) ![GitHub last commit](https://img.shields.io/github/last-commit/projectatomic/skopeo)](https://github.com/projectatomic/skopeo)  
Work with remote images registries - retrieving information, images, signing content.
* [img ![GitHub Repo Stars](https://img.shields.io/github/stars/jessfraz/img) ![GitHub last commit](https://img.shields.io/github/last-commit/jessfraz/img)](https://github.com/jessfraz/img)  
Standalone, daemon-less, unprivileged Dockerfile and OCI compatible container image builder.
* [dgr ![GitHub Repo Stars](https://img.shields.io/github/stars/blablacar/dgr) ![GitHub last commit](https://img.shields.io/github/last-commit/blablacar/dgr)](https://github.com/blablacar/dgr)  
...
* [Whaler ![GitHub Repo Stars](https://img.shields.io/github/stars/P3GLEG/Whaler) ![GitHub last commit](https://img.shields.io/github/last-commit/P3GLEG/Whaler)](https://github.com/P3GLEG/Whaler)  
Whaler is designed to reverse engineer a Docker Image into the Dockerfile that created it.
* [dive ![GitHub Repo Stars](https://img.shields.io/github/stars/wagoodman/dive) ![GitHub last commit](https://img.shields.io/github/last-commit/wagoodman/dive)](https://github.com/wagoodman/dive)  
A tool for exploring each layer in a docker image.
* [go-containerregistry ![GitHub Repo Stars](https://img.shields.io/github/stars/google/go-containerregistry) ![GitHub last commit](https://img.shields.io/github/last-commit/google/go-containerregistry)](https://github.com/google/go-containerregistry)  
Go library and CLIs for working with container registries.
* [kaniko ![GitHub Repo Stars](https://img.shields.io/github/stars/GoogleContainerTools/kaniko) ![GitHub last commit](https://img.shields.io/github/last-commit/GoogleContainerTools/kaniko)](https://github.com/GoogleContainerTools/kaniko)  
Kaniko is a tool to build container images from a Dockerfile, inside a container or Kubernetes cluster.
* [umoci](https://umo.ci/)  
Umoci is a tool to manipulate OCI container images, and can be used as a rudimentary build tool.
* [docker pushrm ![GitHub Repo Stars](https://img.shields.io/github/stars/christian-korneck/docker-pushrm) ![GitHub last commit](https://img.shields.io/github/last-commit/christian-korneck/docker-pushrm)](https://github.com/christian-korneck/docker-pushrm)  
...
* [Liman ![GitHub Repo Stars](https://img.shields.io/github/stars/salihciftci/liman) ![GitHub last commit](https://img.shields.io/github/last-commit/salihciftci/liman)](https://github.com/salihciftci/liman)  
Basic docker monitoring web application.
* [portainer ![GitHub Repo Stars](https://img.shields.io/github/stars/portainer/portainer) ![GitHub last commit](https://img.shields.io/github/last-commit/portainer/portainer)](https://github.com/portainer/portainer)  
Lightweight Docker management UI.
* [swarmpit ![GitHub Repo Stars](https://img.shields.io/github/stars/swarmpit/swarmpit) ![GitHub last commit](https://img.shields.io/github/last-commit/swarmpit/swarmpit)](https://github.com/swarmpit/swarmpit)  
...
* [Docker bench security ![GitHub Repo Stars](https://img.shields.io/github/stars/docker/docker-bench-security) ![GitHub last commit](https://img.shields.io/github/last-commit/docker/docker-bench-security)](https://github.com/docker/docker-bench-security)  
...
* [bane ![GitHub Repo Stars](https://img.shields.io/github/stars/jfrazelle/bane) ![GitHub last commit](https://img.shields.io/github/last-commit/jfrazelle/bane)](https://github.com/jfrazelle/bane)  
Custom AppArmor profile generator for docker containers.
* [OpenSCAP ![GitHub Repo Stars](https://img.shields.io/github/stars/OpenSCAP/container-compliance) ![GitHub last commit](https://img.shields.io/github/last-commit/OpenSCAP/container-compliance)](https://github.com/OpenSCAP/container-compliance)  
...
* [drydock ![GitHub Repo Stars](https://img.shields.io/github/stars/zuBux/drydock) ![GitHub last commit](https://img.shields.io/github/last-commit/zuBux/drydock)](https://github.com/zuBux/drydock)  
...
* [goss ![GitHub Repo Stars](https://img.shields.io/github/stars/aelsabbahy/goss) ![GitHub last commit](https://img.shields.io/github/last-commit/aelsabbahy/goss)](https://github.com/aelsabbahy/goss)  
Quick and Easy server testing/validation.
* [sockguard ![GitHub Repo Stars](https://img.shields.io/github/stars/buildkite/sockguard) ![GitHub last commit](https://img.shields.io/github/last-commit/buildkite/sockguard)](https://github.com/buildkite/sockguard)  
A proxy for docker.sock that enforces access control and isolated privileges.
* [gvisor ![GitHub Repo Stars](https://img.shields.io/github/stars/google/gvisor) ![GitHub last commit](https://img.shields.io/github/last-commit/google/gvisor)](https://github.com/google/gvisor)  
gVisor is a user-space kernel, written in Go, that implements a substantial portion of the Linux system surface. It includes an Open Container Initiative (OCI) runtime called runsc that provides an isolation boundary between the application and the host kernel. The runsc runtime integrates with Docker and Kubernetes, making it simple to run sandboxed containers.
* [docker-explorer ![GitHub Repo Stars](https://img.shields.io/github/stars/google/docker-explorer) ![GitHub last commit](https://img.shields.io/github/last-commit/google/docker-explorer)](https://github.com/google/docker-explorer/)  
A tool to help forensicate offline docker acquisitions.
* [oci-seccomp-bpf-hook ![GitHub Repo Stars](https://img.shields.io/github/stars/containers/oci-seccomp-bpf-hook) ![GitHub last commit](https://img.shields.io/github/last-commit/containers/oci-seccomp-bpf-hook)](https://github.com/containers/oci-seccomp-bpf-hook)  
...
* [sysdig-container-ecosystem ![GitHub Repo Stars](https://img.shields.io/github/stars/draios/sysdig-container-ecosystem) ![GitHub last commit](https://img.shields.io/github/last-commit/draios/sysdig-container-ecosystem)](https://github.com/draios/sysdig-container-ecosystem)  
