...
- [Unicons ![GitHub Repo Stars](https://img.shields.io/github/stars/iconscout/unicons) ![GitHub last commit](https://img.shields.io/github/last-commit/iconscout/unicons)](https://github.com/iconscout/unicons#readme) - 1000+ pixel-perfect vector icons and icon font for your next project. ([Website](https://iconscout.com/unicons))
...
- [GeoIcons ![GitHub Repo Stars](https://img.shields.io/github/stars/getgeoicons/geoicons) ![GitHub last commit](https://img.shields.io/github/last-commit/getgeoicons/geoicons)](https://github.com/getgeoicons/geoicons#readme) - Geographic map icons as tree-shakable SVG components. ([Website](https://geoicons.io))
...
- [Unicon ![GitHub Repo Stars](https://img.shields.io/github/stars/WebRenew/unicon) ![GitHub last commit](https://img.shields.io/github/last-commit/WebRenew/unicon)](https://github.com/WebRenew/unicon#readme) - Browse 20,000+ icons from 9 libraries and copy only what you need—like shadcn/ui for icons. ([Website](https://unicon.webrenew.com))
