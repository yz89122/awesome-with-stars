...
- [gql ![GitHub Repo Stars](https://img.shields.io/github/stars/kadirpekel/gql) ![GitHub last commit](https://img.shields.io/github/last-commit/kadirpekel/gql)](https://github.com/kadirpekel/gql) - Code first graphql (graphql-go/graphql) schema builder.
...
- [graphql-go-tools ![GitHub Repo Stars](https://img.shields.io/github/stars/wundergraph/graphql-go-tools) ![GitHub last commit](https://img.shields.io/github/last-commit/wundergraph/graphql-go-tools)](https://github.com/wundergraph/graphql-go-tools) - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
- [Thunder ![GitHub Repo Stars](https://img.shields.io/github/stars/Raezil/Thunder) ![GitHub last commit](https://img.shields.io/github/last-commit/Raezil/Thunder)](https://github.com/Raezil/Thunder) - A scalable microservices framework powered by Go, gRPC-Gateway, Prisma, and Kubernetes. It exposes REST, gRPC and Graphql
- [grpc-graphql-gateway ![GitHub Repo Stars](https://img.shields.io/github/stars/ysugimoto/grpc-graphql-gateway) ![GitHub last commit](https://img.shields.io/github/last-commit/ysugimoto/grpc-graphql-gateway)](https://github.com/ysugimoto/grpc-graphql-gateway) - A protoc plugin that generates graphql execution code from Protocol Buffers. 
<a name="go-example" />
