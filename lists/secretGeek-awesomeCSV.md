...
- [ParaText ![GitHub Repo Stars](https://img.shields.io/github/stars/wiseio/paratext) ![GitHub last commit](https://img.shields.io/github/last-commit/wiseio/paratext)](https://github.com/wiseio/paratext) - CSV parsing at 2.5 GB per second.
- [CSVGet ![GitHub Repo Stars](https://img.shields.io/github/stars/fizx/csvget) ![GitHub last commit](https://img.shields.io/github/last-commit/fizx/csvget)](http://github.com/fizx/csvget/tree/master) - Get structured data from sites as CSV.
...
- [graph-cli ![GitHub Repo Stars](https://img.shields.io/github/stars/mcastorina/graph-cli) ![GitHub last commit](https://img.shields.io/github/last-commit/mcastorina/graph-cli)](https://github.com/mcastorina/graph-cli) - Flexible command line tool to create graphs from CSV data.
...
- [Csvlint.go ![GitHub Repo Stars](https://img.shields.io/github/stars/Clever/csvlint) ![GitHub last commit](https://img.shields.io/github/last-commit/Clever/csvlint)](https://github.com/Clever/csvlint) - Command line tool for validating CSV files against RFC 4180.
- [csvstudio](http://www.csvstudio.com/) - A smart app to repair syntax errors in very large CSV files.
- [scrubcsv ![GitHub Repo Stars](https://img.shields.io/github/stars/faradayio/scrubcsv) ![GitHub last commit](https://img.shields.io/github/last-commit/faradayio/scrubcsv)](https://github.com/faradayio/scrubcsv) - Remove bad records from a CSV file and normalize (requires rust)
- [reconcile-csv ![GitHub Repo Stars](https://img.shields.io/github/stars/OpenRefine/reconcile-csv) ![GitHub last commit](https://img.shields.io/github/last-commit/OpenRefine/reconcile-csv)](https://github.com/OpenRefine/reconcile-csv/blob/master/README.md) - Find relationships between a set of related CSVs
...
- [PSKit Query ![GitHub Repo Stars](https://img.shields.io/github/stars/dfinke/PSKit) ![GitHub last commit](https://img.shields.io/github/last-commit/dfinke/PSKit)](https://github.com/dfinke/PSKit#sql-query) &mdash; Powershell module lets you run simple queries over objects, including imported with csv

### Convert to or from CSV

- [CSV to Table ![GitHub Repo Stars](https://img.shields.io/github/stars/vividvilla/csvtotable) ![GitHub last commit](https://img.shields.io/github/last-commit/vividvilla/csvtotable)](https://github.com/vividvilla/csvtotable) - Convert CSV files to searchable and sortable HTML table.
...
- [awesome-public-datasets ![GitHub Repo Stars](https://img.shields.io/github/stars/awesomedata/awesome-public-datasets) ![GitHub last commit](https://img.shields.io/github/last-commit/awesomedata/awesome-public-datasets)](https://github.com/awesomedata/awesome-public-datasets) - A topic-centric list of high-quality open datasets in public domains.
...
- [CSVY ![GitHub Repo Stars](https://img.shields.io/github/stars/csvy/csvy.github.io) ![GitHub last commit](https://img.shields.io/github/last-commit/csvy/csvy.github.io)](https://github.com/csvy/csvy.github.io/blob/master/index.md) - A standard for adding a YAML header to CSV files to describe their format

## META: Other similar lists

- [structured-text-tools ![GitHub Repo Stars](https://img.shields.io/github/stars/dbohdan/structured-text-tools) ![GitHub last commit](https://img.shields.io/github/last-commit/dbohdan/structured-text-tools)](https://github.com/dbohdan/structured-text-tools) - List of command line tools for manipulating CSV / XML / HTML / JSON / INI etc.
