...
- [SAP Machine Java ![GitHub Repo Stars](https://img.shields.io/github/stars/SAP/SapMachine) ![GitHub last commit](https://img.shields.io/github/last-commit/SAP/SapMachine)](https://github.com/SAP/SapMachine) - A dedicated Java version for SAP Commerce.
- [SAP Commerce Gradle Plugin ![GitHub Repo Stars](https://img.shields.io/github/stars/SAP/commerce-gradle-plugin) ![GitHub last commit](https://img.shields.io/github/last-commit/SAP/commerce-gradle-plugin)](https://github.com/SAP/commerce-gradle-plugin) - Gradle plugin support SAP Commerce folder structure.
- [SAP Spartacus ![GitHub Repo Stars](https://img.shields.io/github/stars/SAP/spartacus) ![GitHub last commit](https://img.shields.io/github/last-commit/SAP/spartacus)](https://github.com/SAP/spartacus) - Rebranded as SAP Composable Storefront. 

_These are interesting GitHub Repositories about SAP Commerce/Hybris._  

- [Flexible search builder ![GitHub Repo Stars](https://img.shields.io/github/stars/avrilfanomar/flexiblesearchbuilder) ![GitHub last commit](https://img.shields.io/github/last-commit/avrilfanomar/flexiblesearchbuilder)](https://github.com/avrilfanomar/flexiblesearchbuilder)
- [Y-scripts ![GitHub Repo Stars](https://img.shields.io/github/stars/sergaks/y-scripts) ![GitHub last commit](https://img.shields.io/github/last-commit/sergaks/y-scripts)](https://github.com/sergaks/y-scripts)

_Search by Tags on GitHub._

- [Hybris ![GitHub Repo Stars](https://img.shields.io/github/stars/topics/hybris) ![GitHub last commit](https://img.shields.io/github/last-commit/topics/hybris)](https://github.com/topics/hybris)
- [SAP Hybris ![GitHub Repo Stars](https://img.shields.io/github/stars/topics/sap-hybris) ![GitHub last commit](https://img.shields.io/github/last-commit/topics/sap-hybris)](https://github.com/topics/sap-hybris)
- [SAP Commerce ![GitHub Repo Stars](https://img.shields.io/github/stars/topics/sap-commerce) ![GitHub last commit](https://img.shields.io/github/last-commit/topics/sap-commerce)](https://github.com/topics/sap-commerce)
- [SAP Commerce Cloud ![GitHub Repo Stars](https://img.shields.io/github/stars/topics/sap-commerce-cloud) ![GitHub last commit](https://img.shields.io/github/last-commit/topics/sap-commerce-cloud)](https://github.com/topics/sap-commerce-cloud)
