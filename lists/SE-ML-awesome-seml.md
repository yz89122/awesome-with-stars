...
- [Alibi Detect ![GitHub Repo Stars](https://img.shields.io/github/stars/SeldonIO/alibi-detect) ![GitHub last commit](https://img.shields.io/github/last-commit/SeldonIO/alibi-detect)](https://github.com/SeldonIO/alibi-detect) - Python library focused on outlier, adversarial and drift detection.
- [Archai ![GitHub Repo Stars](https://img.shields.io/github/stars/microsoft/archai) ![GitHub last commit](https://img.shields.io/github/last-commit/microsoft/archai)](https://github.com/microsoft/archai) - Neural architecture search.
...
- [Great Expectations ![GitHub Repo Stars](https://img.shields.io/github/stars/great-expectations/great_expectations) ![GitHub last commit](https://img.shields.io/github/last-commit/great-expectations/great_expectations)](https://github.com/great-expectations/great_expectations) - Data validation and testing with integration in pipelines.
- [HParams ![GitHub Repo Stars](https://img.shields.io/github/stars/PetrochukM/HParams) ![GitHub last commit](https://img.shields.io/github/last-commit/PetrochukM/HParams)](https://github.com/PetrochukM/HParams) - A thoughtful approach to configuration management for machine learning projects.
- [Kubeflow](https://www.kubeflow.org/) - A platform for data scientists who want to build and experiment with ML pipelines.
- [Label Studio ![GitHub Repo Stars](https://img.shields.io/github/stars/heartexlabs/label-studio) ![GitHub last commit](https://img.shields.io/github/last-commit/heartexlabs/label-studio)](https://github.com/heartexlabs/label-studio) - A multi-type data labeling and annotation tool with standardized output format.
- [LiFT ![GitHub Repo Stars](https://img.shields.io/github/stars/linkedin/LiFT) ![GitHub last commit](https://img.shields.io/github/last-commit/linkedin/LiFT)](https://github.com/linkedin/LiFT) - Linkedin fairness toolkit.
- [MLFlow](https://mlflow.org/) - Manage the ML lifecycle, including experimentation, deployment, and a central model registry.
- [Model Card Toolkit ![GitHub Repo Stars](https://img.shields.io/github/stars/tensorflow/model-card-toolkit) ![GitHub last commit](https://img.shields.io/github/last-commit/tensorflow/model-card-toolkit)](https://github.com/tensorflow/model-card-toolkit) - Streamlines and automates the generation of model cards; for model documentation.
- [Neptune.ai](https://neptune.ai/) - Experiment tracking tool bringing organization and collaboration to data science projects.
- [Neuraxle ![GitHub Repo Stars](https://img.shields.io/github/stars/Neuraxio/Neuraxle) ![GitHub last commit](https://img.shields.io/github/last-commit/Neuraxio/Neuraxle)](https://github.com/Neuraxio/Neuraxle) -  Sklearn-like framework for hyperparameter tuning and AutoML in deep learning projects.
...
- [REVISE: REvealing VIsual biaSEs ![GitHub Repo Stars](https://img.shields.io/github/stars/princetonvisualai/revise-tool) ![GitHub last commit](https://img.shields.io/github/last-commit/princetonvisualai/revise-tool)](https://github.com/princetonvisualai/revise-tool) - Automatically detect bias in visual data sets.
- [Robustness Metrics ![GitHub Repo Stars](https://img.shields.io/github/stars/google-research/robustness_metrics) ![GitHub last commit](https://img.shields.io/github/last-commit/google-research/robustness_metrics)](https://github.com/google-research/robustness_metrics) - Lightweight modules to evaluate the robustness of classification models.
- [Seldon Core ![GitHub Repo Stars](https://img.shields.io/github/stars/SeldonIO/seldon-core) ![GitHub last commit](https://img.shields.io/github/last-commit/SeldonIO/seldon-core)](https://github.com/SeldonIO/seldon-core) - An MLOps framework to package, deploy, monitor and manage thousands of production machine learning models on Kubernetes.
...
- [Tensorflow Data Validation (TFDV) ![GitHub Repo Stars](https://img.shields.io/github/stars/tensorflow/data-validation) ![GitHub last commit](https://img.shields.io/github/last-commit/tensorflow/data-validation)](https://github.com/tensorflow/data-validation) - Library for exploring and validating machine learning data. Similar to Great Expectations, but for Tensorflow data.
