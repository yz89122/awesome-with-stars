...
- [obfus.h ![GitHub Repo Stars](https://img.shields.io/github/stars/DosX-dev/obfus.h) ![GitHub last commit](https://img.shields.io/github/last-commit/DosX-dev/obfus.h)](https://github.com/DosX-dev/obfus.h) - Macro-header for compile-time C obfuscation/virtualization (tcc, win x86/x64)
...
- [OSX_Packer ![GitHub Repo Stars](https://img.shields.io/github/stars/AlysonBee/OSX_Packer) ![GitHub last commit](https://img.shields.io/github/last-commit/AlysonBee/OSX_Packer)](https://github.com/AlysonBee/OSX_Packer) - Binary packer for the Mach-O file format.
...
- [VirtualMachineObfuscationPoC ![GitHub Repo Stars](https://img.shields.io/github/stars/eaglx/VirtualMachineObfuscationPoC) ![GitHub last commit](https://img.shields.io/github/last-commit/eaglx/VirtualMachineObfuscationPoC)](https://github.com/eaglx/VirtualMachineObfuscationPoC) - Obfuscation method using virtual machine.
