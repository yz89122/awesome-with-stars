...
- :earth_americas: [Awesome executable packing ![GitHub Repo Stars](https://img.shields.io/github/stars/packing-box/awesome-executable-packing) ![GitHub last commit](https://img.shields.io/github/last-commit/packing-box/awesome-executable-packing)](https://github.com/packing-box/awesome-executable-packing)
- :earth_americas: [Awesome LLVM security ![GitHub Repo Stars](https://img.shields.io/github/stars/gmh5225/awesome-llvm-security) ![GitHub last commit](https://img.shields.io/github/last-commit/gmh5225/awesome-llvm-security)](https://github.com/gmh5225/awesome-llvm-security)
...
- :earth_americas: [OllyDbg OEP finder scripts ![GitHub Repo Stars](https://img.shields.io/github/stars/dubuqingfeng/ollydbg-script) ![GitHub last commit](https://img.shields.io/github/last-commit/dubuqingfeng/ollydbg-script)](https://github.com/dubuqingfeng/ollydbg-script)
...
- [BODMAS ![GitHub Repo Stars](https://img.shields.io/github/stars/whyisyoung/BODMAS) ![GitHub last commit](https://img.shields.io/github/last-commit/whyisyoung/BODMAS)](https://github.com/whyisyoung/BODMAS) - Code for our DLS'21 paper - BODMAS: An Open Dataset for Learning based Temporal Analysis of PE Malware.
...
- [Dataset of Packed ELF ![GitHub Repo Stars](https://img.shields.io/github/stars/dhondta/dataset-packed-elf) ![GitHub last commit](https://img.shields.io/github/last-commit/dhondta/dataset-packed-elf)](https://github.com/dhondta/dataset-packed-elf) - Compilation of packed ELF samples.
...
- [Ember2024 ![GitHub Repo Stars](https://img.shields.io/github/stars/futurecomputing4ai/ember2024) ![GitHub last commit](https://img.shields.io/github/last-commit/futurecomputing4ai/ember2024)](https://github.com/futurecomputing4ai/ember2024) - Update to the EMBER2017 and EMBER2018 datasets.
...
- [Malware Archive ![GitHub Repo Stars](https://img.shields.io/github/stars/jstrosch/malware-samples) ![GitHub last commit](https://img.shields.io/github/last-commit/jstrosch/malware-samples)](https://github.com/jstrosch/malware-samples) - Malware samples, analysis exercises and other interesting resources.
...
- [ASM Guard ![GitHub Repo Stars](https://img.shields.io/github/stars/DosX-dev/ASM-Guard) ![GitHub last commit](https://img.shields.io/github/last-commit/DosX-dev/ASM-Guard)](https://github.com/DosX-dev/ASM-Guard) - Packer utility for compressing and complicating reversing compiled native code (native files), protecting resources, adding DRM, and packing into an optimized loader.
...
- [Backpack ![GitHub Repo Stars](https://img.shields.io/github/stars/Enelg52/Backpack) ![GitHub last commit](https://img.shields.io/github/last-commit/Enelg52/Backpack)](https://github.com/Enelg52/Backpack)
...
- [ELF Packer ![GitHub Repo Stars](https://img.shields.io/github/stars/telepath9000/elf-packer) ![GitHub last commit](https://img.shields.io/github/last-commit/telepath9000/elf-packer)](https://github.com/telepath9000/elf-packer) - Encrypts 64-bit elf files that decrypt at runtime.
...
- [ELF-Packer ![GitHub Repo Stars](https://img.shields.io/github/stars/glen-mac/ELF-Packer) ![GitHub last commit](https://img.shields.io/github/last-commit/glen-mac/ELF-Packer)](https://github.com/glen-mac/ELF-Packer) - Simple Polymorphic x86_64 Runtime Code Segment Cryptor.
...
- [ELFkickers ![GitHub Repo Stars](https://img.shields.io/github/stars/BR903/ELFkickers) ![GitHub last commit](https://img.shields.io/github/last-commit/BR903/ELFkickers)](https://github.com/BR903/ELFkickers) - A collection of programs that access and manipulate ELF files.
...
- [oplzkwp ![GitHub Repo Stars](https://img.shields.io/github/stars/tweksteen/oplzkwp) ![GitHub last commit](https://img.shields.io/github/last-commit/tweksteen/oplzkwp)](https://github.com/tweksteen/oplzkwp) - Library for ELF obfuscation ; it uses PRESENT and blake244 to encrypt your payload on the fly.
...
- [Pakkero ![GitHub Repo Stars](https://img.shields.io/github/stars/89luca89/pakkero) ![GitHub last commit](https://img.shields.io/github/last-commit/89luca89/pakkero)](https://github.com/89luca89/pakkero) - Binary packer written in Go made for fun and educational purpose.
- [Pakr ![GitHub Repo Stars](https://img.shields.io/github/stars/iangcarroll/pakr) ![GitHub last commit](https://img.shields.io/github/last-commit/iangcarroll/pakr)](https://github.com/iangcarroll/pakr) - In-memory packer for macOS Mach-O bundles.
...
- [PEzor ![GitHub Repo Stars](https://img.shields.io/github/stars/phra/PEzor) ![GitHub last commit](https://img.shields.io/github/last-commit/phra/PEzor)](https://github.com/phra/PEzor) - Open-Source Shellcode & PE Packer.
- [pocrypt ![GitHub Repo Stars](https://img.shields.io/github/stars/picoflamingo/pocrypt) ![GitHub last commit](https://img.shields.io/github/last-commit/picoflamingo/pocrypt)](https://github.com/picoflamingo/pocrypt) - Naive Proof of Concept Crypter for GNU/Linux ELF64.
- [ProtectMyTooling ![GitHub Repo Stars](https://img.shields.io/github/stars/mgeeky/ProtectMyTooling) ![GitHub last commit](https://img.shields.io/github/last-commit/mgeeky/ProtectMyTooling)](https://github.com/mgeeky/ProtectMyTooling) - Multi-Packer wrapper letting us daisy-chain various packers, obfuscators and other Red Team oriented weaponry.
- [ps2-packer ![GitHub Repo Stars](https://img.shields.io/github/stars/ps2dev/ps2-packer) ![GitHub last commit](https://img.shields.io/github/last-commit/ps2dev/ps2-packer)](https://github.com/ps2dev/ps2-packer) - Create packed ELF files to run on the PS2.
...
- [sherlocked ![GitHub Repo Stars](https://img.shields.io/github/stars/elfmaster/sherlocked) ![GitHub last commit](https://img.shields.io/github/last-commit/elfmaster/sherlocked)](https://github.com/elfmaster/sherlocked)
...
- [TinyLoad ![GitHub Repo Stars](https://img.shields.io/github/stars/iamsopotatoe-coder/TinyLoad) ![GitHub last commit](https://img.shields.io/github/last-commit/iamsopotatoe-coder/TinyLoad)](https://github.com/iamsopotatoe-coder/TinyLoad) - Simple PE packer for Windows that compresses and encrypts executables with a custom virtual machine into a self-extracting stub.
...
- [Woody Wood Packer ![GitHub Repo Stars](https://img.shields.io/github/stars/Jibus22/woody_woodpacker) ![GitHub last commit](https://img.shields.io/github/last-commit/Jibus22/woody_woodpacker)](https://github.com/Jibus22/woody_woodpacker) - ELF packer - encrypt and inject self-decryption code into executable ELF binary target.
...
- [XyrisPack ![GitHub Repo Stars](https://img.shields.io/github/stars/01Xyris/XyrisPack) ![GitHub last commit](https://img.shields.io/github/last-commit/01Xyris/XyrisPack)](https://github.com/01Xyris/XyrisPack)
- [zELF ![GitHub Repo Stars](https://img.shields.io/github/stars/seb3773/zelf) ![GitHub last commit](https://img.shields.io/github/last-commit/seb3773/zelf)](https://github.com/seb3773/zelf) - A modular ELF64 packer for Linux x86_64 featuring 22 compression codecs, ML-based codec selection, and support for both static and PIE binaries.
...
- [Android Unpacker ![GitHub Repo Stars](https://img.shields.io/github/stars/strazzere/android-unpacker) ![GitHub last commit](https://img.shields.io/github/last-commit/strazzere/android-unpacker)](https://github.com/strazzere/android-unpacker) - Presented at Defcon 22: Android Hacker Protection Level 0.
...
- [Cave-Finder ![GitHub Repo Stars](https://img.shields.io/github/stars/adamhlt/Cave-Finder) ![GitHub last commit](https://img.shields.io/github/last-commit/adamhlt/Cave-Finder)](https://github.com/adamhlt/Cave-Finder) - Tool to find code cave in PE image (x86 / x64) - Find empty space to place code in PE files.
...
- [Gym-Malware ![GitHub Repo Stars](https://img.shields.io/github/stars/endgameinc/gym-malware) ![GitHub last commit](https://img.shields.io/github/last-commit/endgameinc/gym-malware)](https://github.com/endgameinc/gym-malware) - This is a malware manipulation environment for OpenAI's gym.
...
- [NotPacked++ ![GitHub Repo Stars](https://img.shields.io/github/stars/packing-box/packer-masking-tool) ![GitHub last commit](https://img.shields.io/github/last-commit/packing-box/packer-masking-tool)](https://github.com/packing-box/packer-masking-tool) - Attack tool for altering packed samples so that they evade static packing detection.
...
- [PANDI ![GitHub Repo Stars](https://img.shields.io/github/stars/dimitriwauters/PANDI) ![GitHub last commit](https://img.shields.io/github/last-commit/dimitriwauters/PANDI)](https://github.com/dimitriwauters/PANDI) - Dynamic packing detection solution built on top of PANDA.
...
- [PEPack ![GitHub Repo Stars](https://img.shields.io/github/stars/mentebinaria/readpe) ![GitHub last commit](https://img.shields.io/github/last-commit/mentebinaria/readpe)](https://github.com/mentebinaria/readpe) - PE file packer detection tool, part of the Unix package "pev".
...
- [SecML Malware ![GitHub Repo Stars](https://img.shields.io/github/stars/pralab/secml_malware) ![GitHub last commit](https://img.shields.io/github/last-commit/pralab/secml_malware)](https://github.com/pralab/secml_malware) - Create adversarial attacks against machine learning Windows malware detectors.
