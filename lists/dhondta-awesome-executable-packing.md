...
- :earth_americas: [Mach-O file format reference ![GitHub Repo Stars](https://img.shields.io/github/stars/aidansteele/osx-abi-macho-file-format-reference) ![GitHub last commit](https://img.shields.io/github/last-commit/aidansteele/osx-abi-macho-file-format-reference)](https://github.com/aidansteele/osx-abi-macho-file-format-reference)
...
- :pushpin: [Writing a simple PE packer in detail ![GitHub Repo Stars](https://img.shields.io/github/stars/levanvn/Packer_Simple-1) ![GitHub last commit](https://img.shields.io/github/last-commit/levanvn/Packer_Simple-1)](https://github.com/levanvn/Packer_Simple-1)
...
- [Dataset of Packed ELF ![GitHub Repo Stars](https://img.shields.io/github/stars/dhondta/dataset-packed-elf) ![GitHub last commit](https://img.shields.io/github/last-commit/dhondta/dataset-packed-elf)](https://github.com/dhondta/dataset-packed-elf) - Dataset of packed ELF samples.
- [Dataset of Packed PE ![GitHub Repo Stars](https://img.shields.io/github/stars/dhondta/dataset-packed-pe) ![GitHub last commit](https://img.shields.io/github/last-commit/dhondta/dataset-packed-pe)](https://github.com/dhondta/dataset-packed-pe) - Sanitized version of the original dataset, PackingData, removing packed samples from the Notpacked folder but also samples in packer folders that failed to be packed (having a same hash as the original unpacked executable).
- [Ember ![GitHub Repo Stars](https://img.shields.io/github/stars/elastic/ember) ![GitHub last commit](https://img.shields.io/github/last-commit/elastic/ember)](https://github.com/elastic/ember) - Collection of features from PE files that serve as a benchmark dataset for researchers.
- [FFRI Dataset Scripts ![GitHub Repo Stars](https://img.shields.io/github/stars/FFRI/ffridataset-scripts) ![GitHub last commit](https://img.shields.io/github/last-commit/FFRI/ffridataset-scripts)](https://github.com/FFRI/ffridataset-scripts) - Make datasets like FFRI Dataset.
- [MaleX ![GitHub Repo Stars](https://img.shields.io/github/stars/Mayachitra-Inc/MaleX) ![GitHub last commit](https://img.shields.io/github/last-commit/Mayachitra-Inc/MaleX)](https://github.com/Mayachitra-Inc/MaleX) - Curated dataset of malware and benign Windows executable samples for malware researchers containing 1,044,394 Windows executable binaries and corresponding image representations with 864,669 labelled as malware and 179,725 as benign.
...
- [MalwareGallery ![GitHub Repo Stars](https://img.shields.io/github/stars/BaRRaKudaRain/MalwareGallery) ![GitHub last commit](https://img.shields.io/github/last-commit/BaRRaKudaRain/MalwareGallery)](https://github.com/BaRRaKudaRain/MalwareGallery) - Yet another malware collection in the Internet.
...
- [PackingData ![GitHub Repo Stars](https://img.shields.io/github/stars/chesvectain/PackingData) ![GitHub last commit](https://img.shields.io/github/last-commit/chesvectain/PackingData)](https://github.com/chesvectain/PackingData) - Original dataset with sample PE files packed with a large variety of packers, including ASPack, BeRoEXEPacker, exe32pack, eXpressor, FSG, JDPack, MEW, Molebox, MPRESS, Neolite, NSPack, Pckman, PECompact, PEtite, RLPack, UPX, WinUpack, Yoda's Crypter and Yoda's Protector.
- [Packware ![GitHub Repo Stars](https://img.shields.io/github/stars/ucsb-seclab/packware) ![GitHub last commit](https://img.shields.io/github/last-commit/ucsb-seclab/packware)](https://github.com/ucsb-seclab/packware) - Datasets and codes that are needed to reproduce the experiments in the paper "When Malware is Packing Heat".
- [RCE Lab ![GitHub Repo Stars](https://img.shields.io/github/stars/apuromafo/RCE_Lab) ![GitHub last commit](https://img.shields.io/github/last-commit/apuromafo/RCE_Lab)](https://github.com/apuromafo/RCE_Lab) - Crackme's, keygenme's, serialme's ; the "tuts4you" folder contains many packed binaries.
...
- [BangCle ![GitHub Repo Stars](https://img.shields.io/github/stars/woxihuannisja/Bangcle) ![GitHub last commit](https://img.shields.io/github/last-commit/woxihuannisja/Bangcle)](https://github.com/woxihuannisja/Bangcle) - Protection tool using the second generation Android Hardening Protection, loading the encrypted DEX file from memory dynamically.
...
- [ConfuserEx ![GitHub Repo Stars](https://img.shields.io/github/stars/mkaring/ConfuserEx) ![GitHub last commit](https://img.shields.io/github/last-commit/mkaring/ConfuserEx)](https://github.com/mkaring/ConfuserEx) - An open-source, free protector for .NET applications.
- [Crinkler ![GitHub Repo Stars](https://img.shields.io/github/stars/runestubbe/Crinkler) ![GitHub last commit](https://img.shields.io/github/last-commit/runestubbe/Crinkler)](https://github.com/runestubbe/Crinkler) - Compressing linker for Windows, specifically targeted towards executables with a size of just a few kilobytes.
...
- [ELFCrypt ![GitHub Repo Stars](https://img.shields.io/github/stars/droberson/ELFcrypt) ![GitHub last commit](https://img.shields.io/github/last-commit/droberson/ELFcrypt)](https://github.com/droberson/ELFcrypt) - Simple ELF crypter using RC4 encryption.
- [ELFuck ![GitHub Repo Stars](https://img.shields.io/github/stars/timhsutw/elfuck) ![GitHub last commit](https://img.shields.io/github/last-commit/timhsutw/elfuck)](https://github.com/timhsutw/elfuck) - ELF packer for i386 original version from sk2 by sd.
...
- [Eronona-Packer ![GitHub Repo Stars](https://img.shields.io/github/stars/Eronana/packer) ![GitHub last commit](https://img.shields.io/github/last-commit/Eronana/packer)](https://github.com/Eronana/packer) - This is a packer for exe under win32.
...
- [MidgetPack ![GitHub Repo Stars](https://img.shields.io/github/stars/arisada/midgetpack) ![GitHub last commit](https://img.shields.io/github/last-commit/arisada/midgetpack)](https://github.com/arisada/midgetpack) - Midgetpack is a binary packer for ELF binaries, such as burneye, upx or other tools.
...
- [NetCrypt ![GitHub Repo Stars](https://img.shields.io/github/stars/friedkiwi/netcrypt) ![GitHub last commit](https://img.shields.io/github/last-commit/friedkiwi/netcrypt)](https://github.com/friedkiwi/netcrypt) - A proof-of-concept packer for .NET executables, designed to provide a starting point to explain the basic principles of runtime packing.
...
- [Origami ![GitHub Repo Stars](https://img.shields.io/github/stars/dr4k0nia/Origami) ![GitHub last commit](https://img.shields.io/github/last-commit/dr4k0nia/Origami)](https://github.com/dr4k0nia/Origami) - Packer compressing .net assemblies, (ab)using the PE format for data storage.
- [Pakkero ![GitHub Repo Stars](https://img.shields.io/github/stars/89luca89/pakkero) ![GitHub last commit](https://img.shields.io/github/last-commit/89luca89/pakkero)](https://github.com/89luca89/pakkero) - Pakkero is a binary packer written in Go made for fun and educational purpose.
- [Papaw ![GitHub Repo Stars](https://img.shields.io/github/stars/dimkr/papaw) ![GitHub last commit](https://img.shields.io/github/last-commit/dimkr/papaw)](https://github.com/dimkr/papaw) - Permissively-licensed packer for ELF executables using LZMA Zstandard or Deflate compression.
- [PE-Packer ![GitHub Repo Stars](https://img.shields.io/github/stars/czs108/PE-Packer) ![GitHub last commit](https://img.shields.io/github/last-commit/czs108/PE-Packer)](https://github.com/czs108/PE-Packer) - Simple packer for Windows 32-bits PE files.
- [PE-Toy ![GitHub Repo Stars](https://img.shields.io/github/stars/r0ngwe1/petoy) ![GitHub last commit](https://img.shields.io/github/last-commit/r0ngwe1/petoy)](https://github.com/r0ngwe1/petoy) - A PE file packer.
...
- [PePacker ![GitHub Repo Stars](https://img.shields.io/github/stars/SamLarenN/PePacker) ![GitHub last commit](https://img.shields.io/github/last-commit/SamLarenN/PePacker)](https://github.com/SamLarenN/PePacker) - Simple PE Packer Which Encrypts .text Section I release a simple PE file packer which encrypts the .text section and adds a decryption stub to the end of the last section.
...
- [Silent-Packer ![GitHub Repo Stars](https://img.shields.io/github/stars/SilentVoid13/Silent_Packer) ![GitHub last commit](https://img.shields.io/github/last-commit/SilentVoid13/Silent_Packer)](https://github.com/SilentVoid13/Silent_Packer) - Silent Packer is an ELF / PE packer written in pure C.
- [Simple-PE32-Packer ![GitHub Repo Stars](https://img.shields.io/github/stars/z3r0d4y5/Simple-PE32-Packer) ![GitHub last commit](https://img.shields.io/github/last-commit/z3r0d4y5/Simple-PE32-Packer)](https://github.com/z3r0d4y5/Simple-PE32-Packer) - Simple PE32 Packer with aPLib compression library.
- [SimpleDPack ![GitHub Repo Stars](https://img.shields.io/github/stars/YuriSizuku/SimpleDpack) ![GitHub last commit](https://img.shields.io/github/last-commit/YuriSizuku/SimpleDpack)](https://github.com/YuriSizuku/SimpleDpack) - A very simple windows EXE packing tool for learning or investigating PE structure.
...
- [theArk ![GitHub Repo Stars](https://img.shields.io/github/stars/aaaddress1/theArk) ![GitHub last commit](https://img.shields.io/github/last-commit/aaaddress1/theArk)](https://github.com/aaaddress1/theArk) - Windows x86 PE Packer In C++.
...
- [VMPROTECT ![GitHub Repo Stars](https://img.shields.io/github/stars/eaglx/VMPROTECT) ![GitHub last commit](https://img.shields.io/github/last-commit/eaglx/VMPROTECT)](https://github.com/eaglx/VMPROTECT) - Obfuscation method using virtual machine.
...
- [Ward ![GitHub Repo Stars](https://img.shields.io/github/stars/ex0dus-0x/ward) ![GitHub last commit](https://img.shields.io/github/last-commit/ex0dus-0x/ward)](https://github.com/ex0dus-0x/ward) - Simple implementation of an ELF packer that creates stealthy droppers for loading malicious ELFs in-memory.
- [xorPacker ![GitHub Repo Stars](https://img.shields.io/github/stars/nqntmqmqmb/xorPacker) ![GitHub last commit](https://img.shields.io/github/last-commit/nqntmqmqmb/xorPacker)](https://github.com/nqntmqmqmb/xorPacker) - Simple packer working with all PE files which cipher your exe with a XOR implementation.
...
- [CauseWay Compressor ![GitHub Repo Stars](https://img.shields.io/github/stars/tkchia/causeway) ![GitHub last commit](https://img.shields.io/github/last-commit/tkchia/causeway)](https://github.com/tkchia/causeway/tree/1ead4be14c9e536262e225f090b40b0c6cded286/watcom) - DOS EXE compressor.
...
- [Morphine ![GitHub Repo Stars](https://img.shields.io/github/stars/bowlofstew/rootkit.com) ![GitHub last commit](https://img.shields.io/github/last-commit/bowlofstew/rootkit.com)](https://github.com/bowlofstew/rootkit.com/blob/master/hf/Morphine27) - Application for PE files encryption.
...
- [Android Unpacker ![GitHub Repo Stars](https://img.shields.io/github/stars/strazzere/android-unpacker) ![GitHub last commit](https://img.shields.io/github/last-commit/strazzere/android-unpacker)](https://github.com/strazzere/android-unpacker) - Android Unpacker presented at Defcon 22: Android Hacker Protection Level 0.
...
- [Capa ![GitHub Repo Stars](https://img.shields.io/github/stars/mandiant/capa) ![GitHub last commit](https://img.shields.io/github/last-commit/mandiant/capa)](https://github.com/mandiant/capa) - Open-source tool to identify capabilities in PE, ELF or .NET executable files.
...
- [de4js ![GitHub Repo Stars](https://img.shields.io/github/stars/lelinhtinh/de4js) ![GitHub last commit](https://img.shields.io/github/last-commit/lelinhtinh/de4js)](https://github.com/lelinhtinh/de4js) - JavaScript Deobfuscator and Unpacker.
...
- [DIE ![GitHub Repo Stars](https://img.shields.io/github/stars/horsicq/DIE-engine) ![GitHub last commit](https://img.shields.io/github/last-commit/horsicq/DIE-engine)](https://github.com/horsicq/DIE-engine/releases) - Detect It Easy ; Program for determining types of files.
- [DSFF ![GitHub Repo Stars](https://img.shields.io/github/stars/packing-box/python-dsff) ![GitHub last commit](https://img.shields.io/github/last-commit/packing-box/python-dsff)](https://github.com/packing-box/python-dsff) - DataSet File Format for exchanging datasets and converting to ARFF (for use with Weka), CSV or Packing-Box's dataset structure.
...
- [EXEInfo-PE ![GitHub Repo Stars](https://img.shields.io/github/stars/ExeinfoASL/ASL) ![GitHub last commit](https://img.shields.io/github/last-commit/ExeinfoASL/ASL)](https://github.com/ExeinfoASL/ASL) - Fast detector for executable PE files.
...
- [FUU ![GitHub Repo Stars](https://img.shields.io/github/stars/crackinglandia/fuu) ![GitHub last commit](https://img.shields.io/github/last-commit/crackinglandia/fuu)](https://github.com/crackinglandia/fuu) - Fast Universal Unpacker.
...
- [LIEF ![GitHub Repo Stars](https://img.shields.io/github/stars/lief-project/LIEF) ![GitHub last commit](https://img.shields.io/github/last-commit/lief-project/LIEF)](https://github.com/lief-project/LIEF) - Library to Instrument Executable Formats ; Python package for parsing PE, ELF, Mach-O and DEX formats, modifying and rebuilding executables.
...
- [Malheur ![GitHub Repo Stars](https://img.shields.io/github/stars/rieck/malheur) ![GitHub last commit](https://img.shields.io/github/last-commit/rieck/malheur)](https://github.com/rieck/malheur) - Tool for the automatic analysis of malware behavior (recorded from malicious software in a sandbox environment).
- [MalUnpack ![GitHub Repo Stars](https://img.shields.io/github/stars/hasherezade/mal_unpack) ![GitHub last commit](https://img.shields.io/github/last-commit/hasherezade/mal_unpack)](https://github.com/hasherezade/mal_unpack) - Dynamic unpacker based on PE-sieve.
- [Manalyze ![GitHub Repo Stars](https://img.shields.io/github/stars/JusticeRage/Manalyze) ![GitHub last commit](https://img.shields.io/github/last-commit/JusticeRage/Manalyze)](https://github.com/JusticeRage/Manalyze) - Robust parser for PE files with a flexible plugin architecture which allows users to statically analyze files in-depth.
...
- [.NET Deobfuscator ![GitHub Repo Stars](https://img.shields.io/github/stars/NotPrab/.NET-Deobfuscator) ![GitHub last commit](https://img.shields.io/github/last-commit/NotPrab/.NET-Deobfuscator)](https://github.com/NotPrab/.NET-Deobfuscator) - List of .NET Deobfuscators and Unpackers.
- [Oedipus ![GitHub Repo Stars](https://img.shields.io/github/stars/tum-i4/Oedipus) ![GitHub last commit](https://img.shields.io/github/last-commit/tum-i4/Oedipus)](https://github.com/tum-i4/Oedipus) - A Python framework that uses machine learning algorithms to implement the metadata recovery attack against obfuscated programs.
- [OEPdet](https://ieeexplore.ieee.org/abstract/document/7782073) - Automated original-entry-point detector.
- [OllyDbg Scripts ![GitHub Repo Stars](https://img.shields.io/github/stars/xshows/ollydbg-script) ![GitHub last commit](https://img.shields.io/github/last-commit/xshows/ollydbg-script)](https://github.com/xshows/ollydbg-script) - Collection of OllyDbg scripts for unpacking many different packers.
...
- [PackerAttacker ![GitHub Repo Stars](https://img.shields.io/github/stars/BromiumLabs/PackerAttacker) ![GitHub last commit](https://img.shields.io/github/last-commit/BromiumLabs/PackerAttacker)](https://github.com/BromiumLabs/PackerAttacker) - Tool that uses memory and code hooks to detect packers.
...
- [PackerGrind ![GitHub Repo Stars](https://img.shields.io/github/stars/rewhy/adaptiveunpacker) ![GitHub last commit](https://img.shields.io/github/last-commit/rewhy/adaptiveunpacker)](https://github.com/rewhy/adaptiveunpacker) - Adaptive unpacking tool for tracking packing bahaviors and unpacking Android packed apps.
- [PackerID ![GitHub Repo Stars](https://img.shields.io/github/stars/sooshie/packerid) ![GitHub last commit](https://img.shields.io/github/last-commit/sooshie/packerid)](https://github.com/sooshie/packerid) - Fork of packerid.py using PEid signatures and featuring additional output types, formats, digital signature extraction, and disassembly support.
- [PackID ![GitHub Repo Stars](https://img.shields.io/github/stars/mesaleh/PackiD) ![GitHub last commit](https://img.shields.io/github/last-commit/mesaleh/PackiD)](https://github.com/mesaleh/PackiD) - Packer identification multiplatform tool/library using the same database syntax as PEiD.
- [Packing-Box ![GitHub Repo Stars](https://img.shields.io/github/stars/dhondta/docker-packing-box) ![GitHub last commit](https://img.shields.io/github/last-commit/dhondta/docker-packing-box)](https://github.com/dhondta/docker-packing-box) - Docker image gathering many packing-related tools and for making datasets of packed executables for use with machine learning.
- [PANDA ![GitHub Repo Stars](https://img.shields.io/github/stars/panda-re/panda) ![GitHub last commit](https://img.shields.io/github/last-commit/panda-re/panda)](https://github.com/panda-re/panda) - Platform for Architecture-Neutral Dynamic Analysis.
...
- [PE-bear ![GitHub Repo Stars](https://img.shields.io/github/stars/hasherezade/pe-bear-releases) ![GitHub last commit](https://img.shields.io/github/last-commit/hasherezade/pe-bear-releases)](https://github.com/hasherezade/pe-bear-releases) - Freeware reversing tool for PE files aimed to deliver fast and flexible “first view” for malware analysts, stable and capable to handle malformed PE files.
...
- [PEPack ![GitHub Repo Stars](https://img.shields.io/github/stars/merces/pev) ![GitHub last commit](https://img.shields.io/github/last-commit/merces/pev)](https://github.com/merces/pev) - PE file packer detection tool, part of the Unix package "pev".
- [PEscan](https://tzworks.com/prototype_page.php?proto_id=15) - CLI tool to scan PE files to identify how they were constructed.
- [PETools ![GitHub Repo Stars](https://img.shields.io/github/stars/petoolse/petools) ![GitHub last commit](https://img.shields.io/github/last-commit/petoolse/petools)](https://github.com/petoolse/petools) - Old-school reverse engineering tool (with a long history since 2002) for manipulating PE files.
...
- [PINdemonium ![GitHub Repo Stars](https://img.shields.io/github/stars/Phat3/PINdemonium) ![GitHub last commit](https://img.shields.io/github/last-commit/Phat3/PINdemonium)](https://github.com/Phat3/PINdemonium) - Unpacker for PE files exploiting the capabilities of PIN.
- [PolyUnpack ![GitHub Repo Stars](https://img.shields.io/github/stars/PlatonovIvan/PolyUnpack) ![GitHub last commit](https://img.shields.io/github/last-commit/PlatonovIvan/PolyUnpack)](https://github.com/PlatonovIvan/PolyUnpack) - Implemention attempt of the general approach for extracting the original hidden code of PE files without any heuristic assumptions.
- [PortEx ![GitHub Repo Stars](https://img.shields.io/github/stars/katjahahn/PortEx) ![GitHub last commit](https://img.shields.io/github/last-commit/katjahahn/PortEx)](https://github.com/katjahahn/PortEx) - Java library for static malware analysis of PE files with a focus on PE malformation robustness and anomaly detection.
...
- [RetDec ![GitHub Repo Stars](https://img.shields.io/github/stars/avast/retdec) ![GitHub last commit](https://img.shields.io/github/last-commit/avast/retdec)](https://github.com/avast/retdec) - Retargetable machine-code decompiler based on LLVM.
...
- [ShowStopper ![GitHub Repo Stars](https://img.shields.io/github/stars/CheckPointSW/showstopper) ![GitHub last commit](https://img.shields.io/github/last-commit/CheckPointSW/showstopper)](https://github.com/CheckPointSW/showstopper) - Tool to help malware researchers explore and test anti-debug techniques or verify debugger plugins or other solutions that clash with standard anti-debug methods.
...
- [Triton ![GitHub Repo Stars](https://img.shields.io/github/stars/jonathansalwan/Triton) ![GitHub last commit](https://img.shields.io/github/last-commit/jonathansalwan/Triton)](https://github.com/jonathansalwan/Triton) - Dynamic binary analysis library.
...
- [Unipacker ![GitHub Repo Stars](https://img.shields.io/github/stars/unipacker/unipacker) ![GitHub last commit](https://img.shields.io/github/last-commit/unipacker/unipacker)](https://github.com/unipacker/unipacker) - Automatic and platform-independent unpacker for Windows binaries based on emulation.
