...
- [Codaptor ![GitHub Repo Stars](https://img.shields.io/github/stars/180Protocol/codaptor) ![GitHub last commit](https://img.shields.io/github/last-commit/180Protocol/codaptor)](https://github.com/180Protocol/codaptor) - Create REST API for any CorDapp running on a Corda node automatically.
- [Corbeans](https://manosbatsis.github.io/corbeans) - Corda integration for Spring Boot.
- [Cordage ![GitHub Repo Stars](https://img.shields.io/github/stars/LayerXcom/cordage) ![GitHub last commit](https://img.shields.io/github/last-commit/LayerXcom/cordage)](https://github.com/LayerXcom/cordage) - Provide modules that make the interoperability possible between Corda and other blockchains without further trusted third party.
...
- [Cordentity ![GitHub Repo Stars](https://img.shields.io/github/stars/hyperledger-labs/cordentity) ![GitHub last commit](https://img.shields.io/github/last-commit/hyperledger-labs/cordentity)](https://github.com/hyperledger-labs/cordentity) - Integrate [Hyperledger Indy](https://www.hyperledger.org/projects/hyperledger-indy) capabilities into Corda.
- [DAML for Corda ![GitHub Repo Stars](https://img.shields.io/github/stars/chainstack/awesome-corda) ![GitHub last commit](https://img.shields.io/github/last-commit/chainstack/awesome-corda)](https://github.com/chainstack/awesome-corda) - DAML smart contracts for Corda.
...
- [PyCorda ![GitHub Repo Stars](https://img.shields.io/github/stars/chainhaus/pycorda) ![GitHub last commit](https://img.shields.io/github/last-commit/chainhaus/pycorda)](https://github.com/chainhaus/pycorda) - Access node and vault data for analytics using pandas DataFrames.
...
- [Testacles ![GitHub Repo Stars](https://img.shields.io/github/stars/manosbatsis/corda-testacles) ![GitHub last commit](https://img.shields.io/github/last-commit/manosbatsis/corda-testacles)](https://github.com/manosbatsis/corda-testacles) - Tools to grow CorDapp test suites.
- [Vaultaire](https://manosbatsis.github.io/vaultaire/) - Query DSL and data access utilities for Corda developers.
- [VS Code Corda extension ![GitHub Repo Stars](https://img.shields.io/github/stars/corda/vscode-corda) ![GitHub last commit](https://img.shields.io/github/last-commit/corda/vscode-corda)](https://github.com/corda/vscode-corda) - VS Code tools for developing CorDapps on the Corda platform.
...
- [Splunk App for Corda ![GitHub Repo Stars](https://img.shields.io/github/stars/splunkdlt/splunk-app-for-corda) ![GitHub last commit](https://img.shields.io/github/last-commit/splunkdlt/splunk-app-for-corda)](https://github.com/splunkdlt/splunk-app-for-corda) - Splunk official integration app for Corda monitoring. 

## Tutorials

- [Official Corda tutorials](https://docs.corda.net/tutorials-index.html) - Learn to build and run CorDapps.
- [Sample CorDapps ![GitHub Repo Stars](https://img.shields.io/github/stars/corda/samples) ![GitHub last commit](https://img.shields.io/github/last-commit/corda/samples)](https://github.com/corda/samples/) - Explore the code of sample CorDapps targeting various uses.
...
- [Credit scoring ![GitHub Repo Stars](https://img.shields.io/github/stars/rafaelazeredo/creditbank) ![GitHub last commit](https://img.shields.io/github/last-commit/rafaelazeredo/creditbank)](https://github.com/rafaelazeredo/creditbank) - A credit scoring service between the user and retail banks.
- [Auction ![GitHub Repo Stars](https://img.shields.io/github/stars/ashutoshmeher-r3/auction-cordapp) ![GitHub last commit](https://img.shields.io/github/last-commit/ashutoshmeher-r3/auction-cordapp)](https://github.com/ashutoshmeher-r3/auction-cordapp) - A demo auction CorDapp.
- [Private health insurance management ![GitHub Repo Stars](https://img.shields.io/github/stars/corda-codeclub/marge) ![GitHub last commit](https://img.shields.io/github/last-commit/corda-codeclub/marge)](https://github.com/corda-codeclub/marge) - A private health insurance CorDapp.
- [Sustainable fishing rights ![GitHub Repo Stars](https://img.shields.io/github/stars/joeldudleyr3/olive-oyl) ![GitHub last commit](https://img.shields.io/github/last-commit/joeldudleyr3/olive-oyl)](https://github.com/joeldudleyr3/olive-oyl) - A CorDapp to manage fishing rights.
