...
- [College ROI Dataset ![GitHub Repo Stars](https://img.shields.io/github/stars/thomasthinks/college-roi-data) ![GitHub last commit](https://img.shields.io/github/last-commit/thomasthinks/college-roi-data)](https://github.com/thomasthinks/college-roi-data) - Lifetime return-on-investment estimates for 29,700 US bachelor's programs across 3,392 colleges, built from FREOPP, IPEDS, and BEA regional price data. 5 CSVs with data dictionary, CC BY 4.0, Zenodo DOI.
