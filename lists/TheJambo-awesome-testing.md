...
- [SpecTest ![GitHub Repo Stars](https://img.shields.io/github/stars/justiceo/spectest) ![GitHub last commit](https://img.shields.io/github/last-commit/justiceo/spectest)](https://github.com/justiceo/spectest) - Truly declarative API testing framework in Js, or plain JSON.
- [Tests Coverage Tool ![GitHub Repo Stars](https://img.shields.io/github/stars/Nikita-Filonov/tests-coverage-tool) ![GitHub last commit](https://img.shields.io/github/last-commit/Nikita-Filonov/tests-coverage-tool)](https://github.com/Nikita-Filonov/tests-coverage-tool) - Ultimate tool to measure gRPC service coverage from tests.
...
- [fakecloud ![GitHub Repo Stars](https://img.shields.io/github/stars/faiscadev/fakecloud) ![GitHub last commit](https://img.shields.io/github/last-commit/faiscadev/fakecloud)](https://github.com/faiscadev/fakecloud) - Free, open-source local AWS cloud emulator for integration tests, with 23 services at 100% conformance and first-party test-assertion SDKs in 6 languages.
...
- [Drengr Runner ![GitHub Repo Stars](https://img.shields.io/github/stars/SharminSirajudeen/drengr-runner) ![GitHub last commit](https://img.shields.io/github/last-commit/SharminSirajudeen/drengr-runner)](https://github.com/SharminSirajudeen/drengr-runner) - Drive an iOS simulator over HTTP from any language. A 479-line Swift XCTest target replacing WebDriverAgent on simulators. Apache-2.0.
...
- [VertaaUX CLI ![GitHub Repo Stars](https://img.shields.io/github/stars/VertaaUX/cli) ![GitHub last commit](https://img.shields.io/github/last-commit/VertaaUX/cli)](https://github.com/VertaaUX/cli) - UX, accessibility, and conversion audits from the terminal and CI, with score-based quality gates and PR regression detection.
...
- [And others ![GitHub Repo Stars](https://img.shields.io/github/stars/ChristoWolf/awesome-testing-blogs) ![GitHub last commit](https://img.shields.io/github/last-commit/ChristoWolf/awesome-testing-blogs)](https://github.com/ChristoWolf/awesome-testing-blogs)
...
- [Awesome AI Testing ![GitHub Repo Stars](https://img.shields.io/github/stars/tugkanboz/awesome-ai-testing) ![GitHub last commit](https://img.shields.io/github/last-commit/tugkanboz/awesome-ai-testing)](https://github.com/tugkanboz/awesome-ai-testing) - A curated list of AI-powered testing tools, frameworks, and resources for QA engineers, covering test generation, self-healing automation, MCP-based testing, and LLM-as-judge evaluation.
...
- [Awesome Behave ![GitHub Repo Stars](https://img.shields.io/github/stars/MathiasPaulenko/awesome-behave) ![GitHub last commit](https://img.shields.io/github/last-commit/MathiasPaulenko/awesome-behave)](https://github.com/MathiasPaulenko/awesome-behave#readme) - A curated list of Behave resources, tools, and libraries for Python BDD.
