...
## Codes
- [BiDAF ![GitHub Repo Stars](https://img.shields.io/github/stars/allenai/bi-att-flow) ![GitHub last commit](https://img.shields.io/github/last-commit/allenai/bi-att-flow)](https://github.com/allenai/bi-att-flow) - Bi-Directional Attention Flow (BIDAF) network is a multi-stage hierarchical process that represents the context at different levels of granularity and uses bi-directional attention flow mechanism to obtain a query-aware context representation without early summarization. 
  - Official; Tensorflow v1.2
  - [Paper](https://arxiv.org/pdf/1611.01603.pdf)
- [QANet ![GitHub Repo Stars](https://img.shields.io/github/stars/NLPLearn/QANet) ![GitHub last commit](https://img.shields.io/github/last-commit/NLPLearn/QANet)](https://github.com/NLPLearn/QANet) - A Q&A architecture does not require recurrent networks: Its encoder consists exclusively of convolution and self-attention, where convolution models local interactions and self-attention models global interactions.
  - Google; Unofficial; Tensorflow v1.5
  - [Paper](#qanet)
- [R-Net ![GitHub Repo Stars](https://img.shields.io/github/stars/HKUST-KnowComp/R-Net) ![GitHub last commit](https://img.shields.io/github/last-commit/HKUST-KnowComp/R-Net)](https://github.com/HKUST-KnowComp/R-Net) - An end-to-end neural networks model for reading comprehension style question answering, which aims to answer questions from a given passage.
...
- [R-Net-in-Keras ![GitHub Repo Stars](https://img.shields.io/github/stars/YerevaNN/R-NET-in-Keras) ![GitHub last commit](https://img.shields.io/github/last-commit/YerevaNN/R-NET-in-Keras)](https://github.com/YerevaNN/R-NET-in-Keras) - R-NET re-implementation in Keras.
  - MS; Unofficial; Keras v2.0.6
  - [Paper](https://www.microsoft.com/en-us/research/wp-content/uploads/2017/05/r-net.pdf)
- [DrQA ![GitHub Repo Stars](https://img.shields.io/github/stars/hitvoice/DrQA) ![GitHub last commit](https://img.shields.io/github/last-commit/hitvoice/DrQA)](https://github.com/hitvoice/DrQA) - DrQA is a system for reading comprehension applied to open-domain question answering.
  - Facebook; Official; Pytorch v0.4
  - [Paper](#drqa)
- [BERT ![GitHub Repo Stars](https://img.shields.io/github/stars/google-research/bert) ![GitHub last commit](https://img.shields.io/github/last-commit/google-research/bert)](https://github.com/google-research/bert) - A new language representation model which stands for Bidirectional Encoder Representations from Transformers. Unlike recent language representation models, BERT is designed to pre-train deep bidirectional representations by jointly conditioning on both left and right context in all layers. 
...
## Slides
- [Question Answering with Knowledge Bases, Web and Beyond ![GitHub Repo Stars](https://img.shields.io/github/stars/scottyih/Slides) ![GitHub last commit](https://img.shields.io/github/last-commit/scottyih/Slides)](https://github.com/scottyih/Slides/blob/master/QA%20Tutorial.pdf) - By Scott Wen-tau Yih & Hao Ma | Microsoft Research | 2016.
...
## Dataset Collections
- [NLIWOD's Question answering datasets ![GitHub Repo Stars](https://img.shields.io/github/stars/dice-group/NLIWOD) ![GitHub last commit](https://img.shields.io/github/last-commit/dice-group/NLIWOD)](https://github.com/dice-group/NLIWOD/tree/master/qa.datasets)
- [karthinkncode's Datasets for Natural Language Processing ![GitHub Repo Stars](https://img.shields.io/github/stars/karthikncode/nlp-datasets) ![GitHub last commit](https://img.shields.io/github/last-commit/karthikncode/nlp-datasets)](https://github.com/karthikncode/nlp-datasets)
...
- [CODAH Dataset ![GitHub Repo Stars](https://img.shields.io/github/stars/Websail-NU/CODAH) ![GitHub last commit](https://img.shields.io/github/last-commit/Websail-NU/CODAH)](https://github.com/Websail-NU/CODAH)
- [DeepMind Q&A Dataset; CNN/Daily Mail ![GitHub Repo Stars](https://img.shields.io/github/stars/deepmind/rc-data) ![GitHub last commit](https://img.shields.io/github/last-commit/deepmind/rc-data)](https://github.com/deepmind/rc-data)
...
- [ELI5 ![GitHub Repo Stars](https://img.shields.io/github/stars/facebookresearch/ELI5) ![GitHub last commit](https://img.shields.io/github/last-commit/facebookresearch/ELI5)](https://github.com/facebookresearch/ELI5)
  - Paper: https://arxiv.org/abs/1907.09190
- [GraphQuestions ![GitHub Repo Stars](https://img.shields.io/github/stars/ysu1989/GraphQuestions) ![GitHub last commit](https://img.shields.io/github/last-commit/ysu1989/GraphQuestions)](https://github.com/ysu1989/GraphQuestions)
...
- [NarrativeQA ![GitHub Repo Stars](https://img.shields.io/github/stars/deepmind/narrativeqa) ![GitHub last commit](https://img.shields.io/github/last-commit/deepmind/narrativeqa)](https://github.com/deepmind/narrativeqa)
...
- [NewsQA ![GitHub Repo Stars](https://img.shields.io/github/stars/Maluuba/newsqa) ![GitHub last commit](https://img.shields.io/github/last-commit/Maluuba/newsqa)](https://github.com/Maluuba/newsqa)
