...
- [Libraries ![GitHub Repo Stars](https://img.shields.io/github/stars/CodyReichert/awesome-cl) ![GitHub last commit](https://img.shields.io/github/last-commit/CodyReichert/awesome-cl)](https://github.com/CodyReichert/awesome-cl)
  - [Curated Libraries ![GitHub Repo Stars](https://img.shields.io/github/stars/vindarel/curated-awesome-cl) ![GitHub last commit](https://img.shields.io/github/last-commit/vindarel/curated-awesome-cl)](https://github.com/vindarel/curated-awesome-cl) - Forked and updated from the above list.
- [Software ![GitHub Repo Stars](https://img.shields.io/github/stars/azzamsa/awesome-cl-software) ![GitHub last commit](https://img.shields.io/github/last-commit/azzamsa/awesome-cl-software)](https://github.com/azzamsa/awesome-cl-software)
...
- [Common Lisp Koans ![GitHub Repo Stars](https://img.shields.io/github/stars/google/lisp-koans) ![GitHub last commit](https://img.shields.io/github/last-commit/google/lisp-koans)](https://github.com/google/lisp-koans) - Not exactly a book, but a set of koans to help you learn the language.
...
- [Paradigms of Artificial Intelligence Programming by Peter Norvig ![GitHub Repo Stars](https://img.shields.io/github/stars/norvig/paip-lisp) ![GitHub last commit](https://img.shields.io/github/last-commit/norvig/paip-lisp)](https://github.com/norvig/paip-lisp) - Has many interesting applications of Lisp, but is no longer a good reference for AI.
