...
*A curated collection of links for economists. Part of the ["Awesome X" series ![GitHub Repo Stars](https://img.shields.io/github/stars/sindresorhus/awesome) ![GitHub last commit](https://img.shields.io/github/last-commit/sindresorhus/awesome)](https://github.com/sindresorhus/awesome).*
...
* [economics-book ![GitHub Repo Stars](https://img.shields.io/github/stars/philschatz/economics-book) ![GitHub last commit](https://img.shields.io/github/last-commit/philschatz/economics-book)](https://github.com/philschatz/economics-book) - Economics Textbook (Openstax).
* [econpizza ![GitHub Repo Stars](https://img.shields.io/github/stars/gboehl/econpizza) ![GitHub last commit](https://img.shields.io/github/last-commit/gboehl/econpizza)](https://github.com/gboehl/econpizza) - Toolbox to solve and simulate nonlinear models with heterogeneous agents.
* [fecon235 ![GitHub Repo Stars](https://img.shields.io/github/stars/rsvp/fecon235) ![GitHub last commit](https://img.shields.io/github/last-commit/rsvp/fecon235)](https://github.com/rsvp/fecon235) - Computational tools for financial economics, Python code base and tutorials using Jupyter notebooks, includes data retrieval, graphics, and optimization.
* [macro_puzzles ![GitHub Repo Stars](https://img.shields.io/github/stars/gboehl/macro_puzzles) ![GitHub last commit](https://img.shields.io/github/last-commit/gboehl/macro_puzzles)](https://github.com/gboehl/macro_puzzles) - A list of puzzles in macroeconomics.
* [pydsge ![GitHub Repo Stars](https://img.shields.io/github/stars/gboehl/pydsge) ![GitHub last commit](https://img.shields.io/github/last-commit/gboehl/pydsge)](https://github.com/gboehl/pydsge) - Tools to solve, filter, and estimate DSGE models with occasionally binding constraints.
* [pyeconomics ![GitHub Repo Stars](https://img.shields.io/github/stars/davidrpugh/pyeconomics) ![GitHub last commit](https://img.shields.io/github/last-commit/davidrpugh/pyeconomics)](https://github.com/davidrpugh/pyeconomics) - Computational economics in Python.
* [QuantEcon](https://github.com/QuantEcon/) - A library for quantitative economics.
* [quantecon_nyu_2016 ![GitHub Repo Stars](https://img.shields.io/github/stars/jstac/quantecon_nyu_2016) ![GitHub last commit](https://img.shields.io/github/last-commit/jstac/quantecon_nyu_2016)](https://github.com/jstac/quantecon_nyu_2016) - Topics in Computational Economics
* [VFI Toolkit](https://github.com/vfitoolkit) - Matlab toolkit for Value Function Iteration on GPU.
* [zice-2014 ![GitHub Repo Stars](https://img.shields.io/github/stars/davidrpugh/zice-2014) ![GitHub last commit](https://img.shields.io/github/last-commit/davidrpugh/zice-2014)](https://github.com/davidrpugh/zice-2014) - Course materials for Zurich Initiative for Computational Economics (ZICE) 2014.
