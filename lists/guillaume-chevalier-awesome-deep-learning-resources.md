...
<p align="center">
  <img src="https://github.com/guillaume-chevalier/awesome-deep-learning-resources/raw/main/google_trends.png" width="792" height="424" />
</p>
...
- [Neuraxle, a framwework for machine learning pipelines ![GitHub Repo Stars](https://img.shields.io/github/stars/Neuraxio/Neuraxle) ![GitHub last commit](https://img.shields.io/github/last-commit/Neuraxio/Neuraxle)](https://github.com/Neuraxio/Neuraxle) - The best framework for structuring and deploying your machine learning projects, and which is also compatible with most framework (e.g.: Scikit-Learn, TensorFlow, PyTorch, Keras, and so forth).
- [TensorFlow's GitHub repository ![GitHub Repo Stars](https://img.shields.io/github/stars/tensorflow/tensorflow) ![GitHub last commit](https://img.shields.io/github/last-commit/tensorflow/tensorflow)](https://github.com/tensorflow/tensorflow) - Most known deep learning framework, both high-level and low-level while staying flexible.
- [skflow ![GitHub Repo Stars](https://img.shields.io/github/stars/tensorflow/skflow) ![GitHub last commit](https://img.shields.io/github/last-commit/tensorflow/skflow)](https://github.com/tensorflow/skflow) - TensorFlow wrapper à la scikit-learn.
...
- [carpedm20/NTM-tensorflow ![GitHub Repo Stars](https://img.shields.io/github/stars/carpedm20/NTM-tensorflow) ![GitHub last commit](https://img.shields.io/github/last-commit/carpedm20/NTM-tensorflow)](https://github.com/carpedm20/NTM-tensorflow) - Neural Turing Machine TensorFlow implementation.
...
- [LSTM for Human Activity Recognition (HAR) ![GitHub Repo Stars](https://img.shields.io/github/stars/guillaume-chevalier/LSTM-Human-Activity-Recognition) ![GitHub last commit](https://img.shields.io/github/last-commit/guillaume-chevalier/LSTM-Human-Activity-Recognition)](https://github.com/guillaume-chevalier/LSTM-Human-Activity-Recognition) - Tutorial of mine on using LSTMs on time series for classification.
- [Deep stacked residual bidirectional LSTMs for HAR ![GitHub Repo Stars](https://img.shields.io/github/stars/guillaume-chevalier/HAR-stacked-residual-bidir-LSTMs) ![GitHub last commit](https://img.shields.io/github/last-commit/guillaume-chevalier/HAR-stacked-residual-bidir-LSTMs)](https://github.com/guillaume-chevalier/HAR-stacked-residual-bidir-LSTMs) - Improvements on the previous project.
- [Sequence to Sequence (seq2seq) Recurrent Neural Network (RNN) for Time Series Prediction ![GitHub Repo Stars](https://img.shields.io/github/stars/guillaume-chevalier/seq2seq-signal-prediction) ![GitHub last commit](https://img.shields.io/github/last-commit/guillaume-chevalier/seq2seq-signal-prediction)](https://github.com/guillaume-chevalier/seq2seq-signal-prediction) - Tutorial of mine on how to predict temporal sequences of numbers - that may be multichannel.
- [Hyperopt for a Keras CNN on CIFAR-100 ![GitHub Repo Stars](https://img.shields.io/github/stars/guillaume-chevalier/Hyperopt-Keras-CNN-CIFAR-100) ![GitHub last commit](https://img.shields.io/github/last-commit/guillaume-chevalier/Hyperopt-Keras-CNN-CIFAR-100)](https://github.com/guillaume-chevalier/Hyperopt-Keras-CNN-CIFAR-100) - Auto (meta) optimizing a neural net (and its architecture) on the CIFAR-100 dataset.
...
- [Smoothly Blend Image Patches ![GitHub Repo Stars](https://img.shields.io/github/stars/guillaume-chevalier/Smoothly-Blend-Image-Patches) ![GitHub last commit](https://img.shields.io/github/last-commit/guillaume-chevalier/Smoothly-Blend-Image-Patches)](https://github.com/guillaume-chevalier/Smoothly-Blend-Image-Patches) - Smooth patch merger for [semantic segmentation with a U-Net](https://vooban.com/en/tips-articles-geek-stuff/satellite-image-segmentation-workflow-with-u-net/).
- [Self Governing Neural Networks (SGNN): the Projection Layer ![GitHub Repo Stars](https://img.shields.io/github/stars/guillaume-chevalier/SGNN-Self-Governing-Neural-Networks-Projection-Layer) ![GitHub last commit](https://img.shields.io/github/last-commit/guillaume-chevalier/SGNN-Self-Governing-Neural-Networks-Projection-Layer)](https://github.com/guillaume-chevalier/SGNN-Self-Governing-Neural-Networks-Projection-Layer) - With this, you can use words in your deep learning models without training nor loading embeddings.
- [Neuraxle ![GitHub Repo Stars](https://img.shields.io/github/stars/Neuraxio/Neuraxle) ![GitHub last commit](https://img.shields.io/github/last-commit/Neuraxio/Neuraxle)](https://github.com/Neuraxio/Neuraxle) - Neuraxle is a Machine Learning (ML) library for building neat pipelines, providing the right abstractions to both ease research, development, and deployment of your ML applications.
- [Clean Machine Learning, a Coding Kata ![GitHub Repo Stars](https://img.shields.io/github/stars/Neuraxio/Kata-Clean-Machine-Learning-From-Dirty-Code) ![GitHub last commit](https://img.shields.io/github/last-commit/Neuraxio/Kata-Clean-Machine-Learning-From-Dirty-Code)](https://github.com/Neuraxio/Kata-Clean-Machine-Learning-From-Dirty-Code) - Learn the good design patterns to use for doing Machine Learning the good way, by practicing.
...
- [Awesome Public Datasets ![GitHub Repo Stars](https://img.shields.io/github/stars/caesar0301/awesome-public-datasets) ![GitHub last commit](https://img.shields.io/github/last-commit/caesar0301/awesome-public-datasets)](https://github.com/caesar0301/awesome-public-datasets) - An awesome list of public datasets.
...
- [Filtering signal, plotting the STFT and the Laplace transform ![GitHub Repo Stars](https://img.shields.io/github/stars/guillaume-chevalier/filtering-stft-and-laplace-transform) ![GitHub last commit](https://img.shields.io/github/last-commit/guillaume-chevalier/filtering-stft-and-laplace-transform)](https://github.com/guillaume-chevalier/filtering-stft-and-laplace-transform) - Simple Python demo on signal processing.
...
- [Self-Governing Neural Networks for On-Device Short Text Classification](http://aclweb.org/anthology/D18-1105) - This paper is the sequel to the ProjectionNet just above. The SGNN is elaborated on the ProjectionNet, and the optimizations are detailed more in-depth (also see my [attempt to reproduce the paper in code ![GitHub Repo Stars](https://img.shields.io/github/stars/guillaume-chevalier/SGNN-Self-Governing-Neural-Networks-Projection-Layer) ![GitHub last commit](https://img.shields.io/github/last-commit/guillaume-chevalier/SGNN-Self-Governing-Neural-Networks-Projection-Layer)](https://github.com/guillaume-chevalier/SGNN-Self-Governing-Neural-Networks-Projection-Layer) and watch [the talks' recording](https://vimeo.com/305197775)).
...
- [Awesome Neuraxle ![GitHub Repo Stars](https://img.shields.io/github/stars/Neuraxio/Awesome-Neuraxle) ![GitHub last commit](https://img.shields.io/github/last-commit/Neuraxio/Awesome-Neuraxle)](https://github.com/Neuraxio/Awesome-Neuraxle) - An awesome list for Neuraxle, a ML Framework for coding clean production-level ML pipelines.
