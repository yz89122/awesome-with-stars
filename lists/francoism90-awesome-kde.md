...
- [KCast ![GitHub Repo Stars](https://img.shields.io/github/stars/Agundur-KDE/KCast) ![GitHub last commit](https://img.shields.io/github/last-commit/Agundur-KDE/KCast)](https://github.com/Agundur-KDE/KCast) - A Plasma 6 widget to cast video files or YouTube URLs to a Chromecast device.
...
- [dictee ![GitHub Repo Stars](https://img.shields.io/github/stars/rcspam/dictee) ![GitHub last commit](https://img.shields.io/github/last-commit/rcspam/dictee)](https://github.com/rcspam/dictee) - Push-to-talk voice dictation with KDE Plasma 6 plasmoid, PyQt6 setup wizard, and tray icon. 4 ASR backends (Parakeet, Vosk, Whisper, Canary), post-processing pipeline, translation. 100% local, 25+ languages.
...
- [LocalTranslate ![GitHub Repo Stars](https://img.shields.io/github/stars/terslang/LocalTranslate) ![GitHub last commit](https://img.shields.io/github/last-commit/terslang/LocalTranslate)](https://github.com/terslang/LocalTranslate) - Offline translation app built with Qt Quick that makes use of Firefox's [neural translation models ![GitHub Repo Stars](https://img.shields.io/github/stars/mozilla/firefox-translations-models) ![GitHub last commit](https://img.shields.io/github/last-commit/mozilla/firefox-translations-models)](https://github.com/mozilla/firefox-translations-models).
