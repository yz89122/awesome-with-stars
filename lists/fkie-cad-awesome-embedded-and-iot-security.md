...
- [FwAnalyzer ![GitHub Repo Stars](https://img.shields.io/github/stars/cruise-automation/fwanalyzer) ![GitHub last commit](https://img.shields.io/github/last-commit/cruise-automation/fwanalyzer)](https://github.com/cruise-automation/fwanalyzer) - Analyze security of firmware based on customized rules. Intended as additional step in DevSecOps, similar to CI.
- [HAL – The Hardware Analyzer ![GitHub Repo Stars](https://img.shields.io/github/stars/emsec/hal) ![GitHub last commit](https://img.shields.io/github/last-commit/emsec/hal)](https://github.com/emsec/hal) - A comprehensive reverse engineering and manipulation framework for gate-level netlists.
- [HomePWN ![GitHub Repo Stars](https://img.shields.io/github/stars/ElevenPaths/HomePWN) ![GitHub last commit](https://img.shields.io/github/last-commit/ElevenPaths/HomePWN)](https://github.com/ElevenPaths/HomePWN) - Swiss Army Knife for Pentesting of IoT Devices.
...
- [Killerbee ![GitHub Repo Stars](https://img.shields.io/github/stars/riverloopsec/killerbee) ![GitHub last commit](https://img.shields.io/github/last-commit/riverloopsec/killerbee)](https://github.com/riverloopsec/killerbee) - Framework for Testing & Auditing ZigBee and IEEE 802.15.4 Networks.
- [PRET ![GitHub Repo Stars](https://img.shields.io/github/stars/RUB-NDS/PRET) ![GitHub last commit](https://img.shields.io/github/last-commit/RUB-NDS/PRET)](https://github.com/RUB-NDS/PRET) - Printer Exploitation Toolkit.
- [Routersploit ![GitHub Repo Stars](https://img.shields.io/github/stars/threat9/routersploit) ![GitHub last commit](https://img.shields.io/github/last-commit/threat9/routersploit)](https://github.com/threat9/routersploit) - Framework dedicated to exploit embedded devices.

### Analysis Tools

- [Binwalk ![GitHub Repo Stars](https://img.shields.io/github/stars/ReFirmLabs/binwalk) ![GitHub last commit](https://img.shields.io/github/last-commit/ReFirmLabs/binwalk)](https://github.com/ReFirmLabs/binwalk) - Searches a binary for "interesting" stuff, as well as extracts arbitrary files.
- [cwe\_checker ![GitHub Repo Stars](https://img.shields.io/github/stars/fkie-cad/cwe_checker) ![GitHub last commit](https://img.shields.io/github/last-commit/fkie-cad/cwe_checker)](https://github.com/fkie-cad/cwe_checker) - Finds vulnerable patterns in binary executables - ELF support for x86, ARM, and MIPS, experimental bare-metal support.
- [emba ![GitHub Repo Stars](https://img.shields.io/github/stars/e-m-b-a/emba) ![GitHub last commit](https://img.shields.io/github/last-commit/e-m-b-a/emba)](https://github.com/e-m-b-a/emba) - Analyze Linux-based firmware of embedded devices.
- [Firmadyne ![GitHub Repo Stars](https://img.shields.io/github/stars/firmadyne/firmadyne) ![GitHub last commit](https://img.shields.io/github/last-commit/firmadyne/firmadyne)](https://github.com/firmadyne/firmadyne) - Tries to emulate and pentest a firmware.
- [Firmwalker ![GitHub Repo Stars](https://img.shields.io/github/stars/craigz28/firmwalker) ![GitHub last commit](https://img.shields.io/github/last-commit/craigz28/firmwalker)](https://github.com/craigz28/firmwalker) - Searches extracted firmware images for interesting files and information.
- [Firmware Slap ![GitHub Repo Stars](https://img.shields.io/github/stars/ChrisTheCoolHut/Firmware_Slap) ![GitHub last commit](https://img.shields.io/github/last-commit/ChrisTheCoolHut/Firmware_Slap)](https://github.com/ChrisTheCoolHut/Firmware_Slap) - Discovering vulnerabilities in firmware through concolic analysis and function clustering.
...
- [Radare2 ![GitHub Repo Stars](https://img.shields.io/github/stars/radare/radare2) ![GitHub last commit](https://img.shields.io/github/last-commit/radare/radare2)](https://github.com/radare/radare2) - Software Reverse Engineering framework, also handles popular formats and arbitrary binaries, has an extensive command line toolset.
- [Trommel ![GitHub Repo Stars](https://img.shields.io/github/stars/CERTCC/trommel) ![GitHub last commit](https://img.shields.io/github/last-commit/CERTCC/trommel)](https://github.com/CERTCC/trommel) - Searches extracted firmware images for interesting files and information.

### Extraction Tools

- [FACT Extractor ![GitHub Repo Stars](https://img.shields.io/github/stars/fkie-cad/fact_extractor) ![GitHub last commit](https://img.shields.io/github/last-commit/fkie-cad/fact_extractor)](https://github.com/fkie-cad/fact_extractor) - Detects container format automatically and executes the corresponding extraction tool.
- [Firmware Mod Kit ![GitHub Repo Stars](https://img.shields.io/github/stars/rampageX/firmware-mod-kit) ![GitHub last commit](https://img.shields.io/github/last-commit/rampageX/firmware-mod-kit)](https://github.com/rampageX/firmware-mod-kit/wiki) - Extraction tools for several container formats.
...
- [JTAGenum ![GitHub Repo Stars](https://img.shields.io/github/stars/cyphunk/JTAGenum) ![GitHub last commit](https://img.shields.io/github/last-commit/cyphunk/JTAGenum)](https://github.com/cyphunk/JTAGenum) - Add JTAG capabilities to an Arduino.
- [OpenOCD](http://openocd.org/) - Free and Open On-Chip Debugging, In-System Programming and Boundary-Scan Testing.

### Misc Tools

- [Cotopaxi ![GitHub Repo Stars](https://img.shields.io/github/stars/Samsung/cotopaxi) ![GitHub last commit](https://img.shields.io/github/last-commit/Samsung/cotopaxi)](https://github.com/Samsung/cotopaxi) - Set of tools for security testing of Internet of Things devices using specific network IoT protocols.
- [dumpflash ![GitHub Repo Stars](https://img.shields.io/github/stars/ohjeongwook/dumpflash) ![GitHub last commit](https://img.shields.io/github/last-commit/ohjeongwook/dumpflash)](https://github.com/ohjeongwook/dumpflash) - Low-level NAND Flash dump and parsing utility.
- [flashrom ![GitHub Repo Stars](https://img.shields.io/github/stars/flashrom/flashrom) ![GitHub last commit](https://img.shields.io/github/last-commit/flashrom/flashrom)](https://github.com/flashrom/flashrom) - Tool for detecting, reading, writing, verifying and erasing flash chips.
- [Samsung Firmware Magic ![GitHub Repo Stars](https://img.shields.io/github/stars/chrivers/samsung-firmware-magic) ![GitHub last commit](https://img.shields.io/github/last-commit/chrivers/samsung-firmware-magic)](https://github.com/chrivers/samsung-firmware-magic) - Decrypt Samsung SSD firmware updates.
...
- [Glasgow ![GitHub Repo Stars](https://img.shields.io/github/stars/GlasgowEmbedded/Glasgow) ![GitHub last commit](https://img.shields.io/github/last-commit/GlasgowEmbedded/Glasgow)](https://github.com/GlasgowEmbedded/Glasgow) - Tool for exploring and debugging different digital interfaces.
...
- 2019, Yago Hansen: [The Hacker's Hardware Toolkit: The best collection of hardware gadgets for Red Team hackers, Pentesters and security researchers ![GitHub Repo Stars](https://img.shields.io/github/stars/yadox666/The-Hackers-Hardware-Toolkit) ![GitHub last commit](https://img.shields.io/github/last-commit/yadox666/The-Hackers-Hardware-Toolkit)](https://github.com/yadox666/The-Hackers-Hardware-Toolkit/blob/master/TheHackersHardwareToolkit.pdf)
...
- 2018, Mark Carney: [Pentesting Hardware - A Practical Handbook (DRAFT) ![GitHub Repo Stars](https://img.shields.io/github/stars/unprovable/PentestHardware) ![GitHub last commit](https://img.shields.io/github/last-commit/unprovable/PentestHardware)](https://github.com/unprovable/PentestHardware)
...
- [CSAW Embedded Security Challenge 2019 ![GitHub Repo Stars](https://img.shields.io/github/stars/TrustworthyComputing/csaw_esc_2019) ![GitHub last commit](https://img.shields.io/github/last-commit/TrustworthyComputing/csaw_esc_2019)](https://github.com/TrustworthyComputing/csaw_esc_2019) - CSAW 2019 Embedded Security Challenge (ESC).
- [Embedded Security CTF](https://microcorruption.com) - Microcorruption: Embedded Security CTF.
- [Hardware Hacking 101 ![GitHub Repo Stars](https://img.shields.io/github/stars/rdomanski/hardware_hacking) ![GitHub last commit](https://img.shields.io/github/last-commit/rdomanski/hardware_hacking)](https://github.com/rdomanski/hardware_hacking/tree/master/my_talks/Hardware_Hacking_101) - Workshop @ BSides Munich 2019.
- [IoTGoat ![GitHub Repo Stars](https://img.shields.io/github/stars/scriptingxss/IoTGoat) ![GitHub last commit](https://img.shields.io/github/last-commit/scriptingxss/IoTGoat)](https://github.com/scriptingxss/IoTGoat) - IoTGoat is a deliberately insecure firmware based on OpenWrt.
- [Rhme-2015 ![GitHub Repo Stars](https://img.shields.io/github/stars/Riscure/RHme-2015) ![GitHub last commit](https://img.shields.io/github/last-commit/Riscure/RHme-2015)](https://github.com/Riscure/RHme-2015) - First riscure Hack me hardware CTF challenge.
- [Rhme-2016 ![GitHub Repo Stars](https://img.shields.io/github/stars/Riscure/Rhme-2016) ![GitHub last commit](https://img.shields.io/github/last-commit/Riscure/Rhme-2016)](https://github.com/Riscure/Rhme-2016) - Riscure Hack me 2 is a low level hardware CTF challenge.
- [Rhme-2017/2018 ![GitHub Repo Stars](https://img.shields.io/github/stars/Riscure/Rhme-2017) ![GitHub last commit](https://img.shields.io/github/last-commit/Riscure/Rhme-2017)](https://github.com/Riscure/Rhme-2017) - Riscure Hack Me 3 embedded hardware CTF 2017-2018.
