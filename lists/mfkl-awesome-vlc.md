...
- [LibVLC LLM Skill ![GitHub Repo Stars](https://img.shields.io/github/stars/mfkl/libvlc-skill) ![GitHub last commit](https://img.shields.io/github/last-commit/mfkl/libvlc-skill)](https://github.com/mfkl/libvlc-skill) - A Claude Code plugin that gives AI coding assistants deep knowledge of the libvlc API (both 3.x and 4.x), the multimedia framework behind VLC media player.
## Ebook
