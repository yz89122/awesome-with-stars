...
- [Human Protein Atlas](https://www.proteinatlas.org/humanproteome/subcellular) - Among other assays, the HPA performed confocal imaging of displaying the location of more than 2/3 of human proteins in cell lines. [Raw images ![GitHub Repo Stars](https://img.shields.io/github/stars/CellProfiling/HPA-competition) ![GitHub last commit](https://img.shields.io/github/last-commit/CellProfiling/HPA-competition)](https://github.com/CellProfiling/HPA-competition#script-to-download-hpav18) or [infered protein subcellular locations](https://www.proteinatlas.org/about/download) can be downloaded.
...
- [Haghighi et al. 2021](https://doi.org/10.1038/s41592-022-01667-0) - Cell painting matched to L1000 profiles in 4 experiments, including compound and genetic screens ([Details on GitHub ![GitHub Repo Stars](https://img.shields.io/github/stars/carpenterlab/2021_Haghighi_submitted) ![GitHub last commit](https://img.shields.io/github/last-commit/carpenterlab/2021_Haghighi_submitted)](https://github.com/carpenterlab/2021_Haghighi_submitted)).

### Genetic Perturbations

- [Singh et al. 2015](https://doi.org/10.1371/journal.pone.0131370) - 3,072 cell painting profiles from 41 genes knocked down with RNA interference (RNAi) in U2OS cells ([Access from GitHub ![GitHub Repo Stars](https://img.shields.io/github/stars/carpenterlab/2016_bray_natprot) ![GitHub last commit](https://img.shields.io/github/last-commit/carpenterlab/2016_bray_natprot)](https://github.com/carpenterlab/2016_bray_natprot/blob/6dcdcf72cd90bb2dbf238b3ecf94691246d8f104/supplementary_files/profiles.csv.zip)).
...
- Unpublished - 3,456 cell painting profiles from CRISPR experiments knocking down 59 genes in A549, ES2, and HCC44 cells ([Access from GitHub ![GitHub Repo Stars](https://img.shields.io/github/stars/broadinstitute/cell-health) ![GitHub last commit](https://img.shields.io/github/last-commit/broadinstitute/cell-health)](https://github.com/broadinstitute/cell-health/tree/master/0.generate-profiles/data/profiles)).
...
- [Cytominer ![GitHub Repo Stars](https://img.shields.io/github/stars/cytomining/cytominer) ![GitHub last commit](https://img.shields.io/github/last-commit/cytomining/cytominer)](https://github.com/cytomining/cytominer) - Methods for image-based cell profiling in R.
...
- [BioProfiling.jl ![GitHub Repo Stars](https://img.shields.io/github/stars/menchelab/BioProfiling.jl) ![GitHub last commit](https://img.shields.io/github/last-commit/menchelab/BioProfiling.jl)](https://github.com/menchelab/BioProfiling.jl) - Toolkit for filtering and curation of morphological profiles in Julia.
- [PyCytominer ![GitHub Repo Stars](https://img.shields.io/github/stars/cytomining/pycytominer) ![GitHub last commit](https://img.shields.io/github/last-commit/cytomining/pycytominer)](https://github.com/cytomining/pycytominer) - Methods for image-based cell profiling in Python.
- [ImJoy](https://imjoy.io) - A platform compiling tool for deep-learning based image analyses with a GUI.
- [histoCAT ![GitHub Repo Stars](https://img.shields.io/github/stars/BodenmillerGroup/histoCAT) ![GitHub last commit](https://img.shields.io/github/last-commit/BodenmillerGroup/histoCAT)](https://github.com/BodenmillerGroup/histoCAT) - Toolbox to extract quantitative phenotypic descriptors and contextual information for histology and multiplex imaging.
