...
TensorFlow.js is [an open source software library ![GitHub Repo Stars](https://img.shields.io/github/stars/tensorflow/tfjs) ![GitHub last commit](https://img.shields.io/github/last-commit/tensorflow/tfjs)](https://github.com/tensorflow/tfjs) to develop machine learning models in JavaScript, and use machine learning
...
- [TensorFlow.js gallery ![GitHub Repo Stars](https://img.shields.io/github/stars/tensorflow/tfjs) ![GitHub last commit](https://img.shields.io/github/last-commit/tensorflow/tfjs)](https://github.com/tensorflow/tfjs/blob/master/GALLERY.md) -  A collection of TensorFlow.js projects, tutorials, videos, and more.
...
- [Official tfjs models on TensorFlow.js repo ![GitHub Repo Stars](https://img.shields.io/github/stars/tensorflow/tfjs-models) ![GitHub last commit](https://img.shields.io/github/last-commit/tensorflow/tfjs-models)](https://github.com/tensorflow/tfjs-models) - Pretrained models for TensorFlow.js.
...
- [Official tfjs examples repo ![GitHub Repo Stars](https://img.shields.io/github/stars/tensorflow/tfjs-examples) ![GitHub last commit](https://img.shields.io/github/last-commit/tensorflow/tfjs-examples)](https://github.com/tensorflow/tfjs-examples) - Examples built with TensorFlow.js!
...
- [Handwritten Digit Classification ![GitHub Repo Stars](https://img.shields.io/github/stars/aaronhma/ngconf-2020) ![GitHub last commit](https://img.shields.io/github/last-commit/aaronhma/ngconf-2020)](https://github.com/aaronhma/ngconf-2020) - A showcase project for [NgConf 2020](https://www.ng-conf.org/) talk on **A Journey into the World of Machine Learning with TensorFlow.js**.
- [NSFWJS - Indecent Content Checker ![GitHub Repo Stars](https://img.shields.io/github/stars/infinitered/nsfwjs) ![GitHub last commit](https://img.shields.io/github/last-commit/infinitered/nsfwjs)](https://github.com/infinitered/nsfwjs) - A friendly library to check images to see if they are indecent content on either the client or the server!
...
- [TensorFlow.js ![GitHub Repo Stars](https://img.shields.io/github/stars/tensorflow/tfjs) ![GitHub last commit](https://img.shields.io/github/last-commit/tensorflow/tfjs)](https://github.com/tensorflow/tfjs) - A WebGL accelerated JavaScript library for training and deploying ML models.
- [ml5.js](https://ml5js.org/) - Friendly machine learning for the web.
- [face-api.js ![GitHub Repo Stars](https://img.shields.io/github/stars/justadudewhohacks/face-api.js) ![GitHub last commit](https://img.shields.io/github/last-commit/justadudewhohacks/face-api.js)](https://github.com/justadudewhohacks/face-api.js) - JavaScript API for face detection and face recognition in the browser and Node.js with tensorflow.js.
- [handtrack.js ![GitHub Repo Stars](https://img.shields.io/github/stars/victordibia/handtrack.js) ![GitHub last commit](https://img.shields.io/github/last-commit/victordibia/handtrack.js)](https://github.com/victordibia/handtrack.js/) - A library for prototyping realtime hand detection (bounding box), directly in the browser.
...
**NOTE: In order to create an community that is welcome for all, ALL contributors MUST agree to the [Code of Conduct ![GitHub Repo Stars](https://img.shields.io/github/stars/aaronhma/awesome-tensorflow-js) ![GitHub last commit](https://img.shields.io/github/last-commit/aaronhma/awesome-tensorflow-js)](https://github.com/aaronhma/awesome-tensorflow-js/blob/master/CODE_OF_CONDUCT.md).**
