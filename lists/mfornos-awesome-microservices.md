...
- [Baucis ![GitHub Repo Stars](https://img.shields.io/github/stars/wprl/baucis) ![GitHub last commit](https://img.shields.io/github/last-commit/wprl/baucis)](https://github.com/wprl/baucis) - To build and maintain scalable HATEOAS/Level 3 REST APIs.
