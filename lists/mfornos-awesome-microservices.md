...
- [1Backend ![GitHub Repo Stars](https://img.shields.io/github/stars/1backend/1backend) ![GitHub last commit](https://img.shields.io/github/last-commit/1backend/1backend)](https://github.com/1backend/1backend) - AI-native microservices platform.
- [Jolie](https://jolie-lang.org) - Open source microservice-oriented programming language.
- [OpenWhisk ![GitHub Repo Stars](https://img.shields.io/github/stars/apache/openwhisk) ![GitHub last commit](https://img.shields.io/github/last-commit/apache/openwhisk)](https://github.com/apache/openwhisk) - Serverless, open source cloud platform that executes functions in response to events at any scale.
...
- [Ice ![GitHub Repo Stars](https://img.shields.io/github/stars/zeroc-ice/ice) ![GitHub last commit](https://img.shields.io/github/last-commit/zeroc-ice/ice)](https://github.com/zeroc-ice/ice) - Comprehensive RPC framework with support for C++, C#, Java, JavaScript, Python, and more.
...
- [Pears ![GitHub Repo Stars](https://img.shields.io/github/stars/holepunchto/pear) ![GitHub last commit](https://img.shields.io/github/last-commit/holepunchto/pear)](https://github.com/holepunchto/pear) - Peer-to-peer runtime, development and deployment.
...
- [uSockets ![GitHub Repo Stars](https://img.shields.io/github/stars/uNetworking/uSockets) ![GitHub last commit](https://img.shields.io/github/last-commit/uNetworking/uSockets)](https://github.com/uNetworking/uSockets) - Miniscule cross-platform eventing, networking & crypto for async applications.

### C++
<!-- #c-1 anchor -->

- [Cap’n Proto RPC](https://capnproto.org/cxxrpc.html) - The Cap’n Proto C++ RPC implementation.
- [C++ Micro Services ![GitHub Repo Stars](https://img.shields.io/github/stars/CppMicroServices/CppMicroServices) ![GitHub last commit](https://img.shields.io/github/last-commit/CppMicroServices/CppMicroServices)](https://github.com/CppMicroServices/CppMicroServices) - An OSGi-like C++ dynamic module system and service registry.
...
- [uWebSockets ![GitHub Repo Stars](https://img.shields.io/github/stars/uNetworking/uWebSockets) ![GitHub last commit](https://img.shields.io/github/last-commit/uNetworking/uWebSockets)](https://github.com/uNetworking/uWebSockets) - Simple, secure & standards compliant web server for the most demanding of applications.
...
- [Lura ![GitHub Repo Stars](https://img.shields.io/github/stars/luraproject/lura) ![GitHub last commit](https://img.shields.io/github/last-commit/luraproject/lura)](https://github.com/luraproject/lura) - Framework to build ultra performance API Gateways with middlewares.
...
- [ActiveJ ![GitHub Repo Stars](https://img.shields.io/github/stars/activej/activej) ![GitHub last commit](https://img.shields.io/github/last-commit/activej/activej)](https://github.com/activej/activej) - Lightweight and fast library for complex high-load distributed applications and Memcached-like solutions.
...
- [Dropwizard ![GitHub Repo Stars](https://img.shields.io/github/stars/dropwizard/dropwizard) ![GitHub last commit](https://img.shields.io/github/last-commit/dropwizard/dropwizard)](https://github.com/dropwizard/dropwizard) - Java framework for developing ops-friendly, high-performance, RESTful web services.
...
- [tRPC ![GitHub Repo Stars](https://img.shields.io/github/stars/trpc/trpc) ![GitHub last commit](https://img.shields.io/github/last-commit/trpc/trpc)](https://github.com/trpc/trpc) - End-to-end typesafe APIs.
...
- [Aiohttp ![GitHub Repo Stars](https://img.shields.io/github/stars/aio-libs/aiohttp) ![GitHub last commit](https://img.shields.io/github/last-commit/aio-libs/aiohttp)](https://github.com/aio-libs/aiohttp) - HTTP client/server for asyncio.
...
- [Sanic ![GitHub Repo Stars](https://img.shields.io/github/stars/sanic-org/sanic) ![GitHub last commit](https://img.shields.io/github/last-commit/sanic-org/sanic)](https://github.com/sanic-org/sanic) - Sanic is a Flask-like Python 3.5+ web server that's written to go fast.
...
- [Wtx ![GitHub Repo Stars](https://img.shields.io/github/stars/c410-f3r/wtx) ![GitHub last commit](https://img.shields.io/github/last-commit/c410-f3r/wtx)](https://github.com/c410-f3r/wtx) - HTTP/2 client/server framework.
...
- [Pingora ![GitHub Repo Stars](https://img.shields.io/github/stars/cloudflare/pingora) ![GitHub last commit](https://img.shields.io/github/last-commit/cloudflare/pingora)](https://github.com/cloudflare/pingora) - A library for building fast, reliable and evolvable network services.
...
- [Inngest ![GitHub Repo Stars](https://img.shields.io/github/stars/inngest/inngest) ![GitHub last commit](https://img.shields.io/github/last-commit/inngest/inngest)](https://github.com/inngest/inngest) - Durable functions for reliable background logic, from background jobs to complex workflows.
...
- [Valkey ![GitHub Repo Stars](https://img.shields.io/github/stars/valkey-io/valkey) ![GitHub last commit](https://img.shields.io/github/last-commit/valkey-io/valkey)](https://github.com/valkey-io/valkey) - A new project to resume development on the formerly open-source Redis project.
...
- [OWASP Agent Memory Guard ![GitHub Repo Stars](https://img.shields.io/github/stars/OWASP/www-project-agent-memory-guard) ![GitHub last commit](https://img.shields.io/github/last-commit/OWASP/www-project-agent-memory-guard)](https://github.com/OWASP/www-project-agent-memory-guard) — Runtime defense layer for AI agent memory poisoning (OWASP ASI06). Detects tampered memory entries, prompt injection in memory paths, and secret leakage. YAML policies, microsecond latency, zero external dependencies.
...
- [Lite³ ![GitHub Repo Stars](https://img.shields.io/github/stars/fastserial/lite3) ![GitHub last commit](https://img.shields.io/github/last-commit/fastserial/lite3)](https://github.com/fastserial/lite3) - JSON-compatible zero-copy serialization format.
...
- [yyjson ![GitHub Repo Stars](https://img.shields.io/github/stars/ibireme/yyjson) ![GitHub last commit](https://img.shields.io/github/last-commit/ibireme/yyjson)](https://github.com/ibireme/yyjson) - The fastest JSON library in C.
...
### Async
- [AsyncAPI ![GitHub Repo Stars](https://img.shields.io/github/stars/asyncapi/spec) ![GitHub last commit](https://img.shields.io/github/last-commit/asyncapi/spec)](https://github.com/asyncapi/spec) - AsyncAPI specification, the industry standard for defining asynchronous APIs.
...
- [Scalar ![GitHub Repo Stars](https://img.shields.io/github/stars/scalar/scalar) ![GitHub last commit](https://img.shields.io/github/last-commit/scalar/scalar)](https://github.com/scalar/scalar) - Open-source API platform: beautiful API references and 1st-class OpenAPI/Swagger support.
