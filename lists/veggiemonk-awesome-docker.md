...
- [Dofigen ![GitHub Repo Stars](https://img.shields.io/github/stars/lenra-io/dofigen) ![GitHub last commit](https://img.shields.io/github/last-commit/lenra-io/dofigen)](https://github.com/lenra-io/dofigen) - A Dockerfile generator using a simplified description in YAML or JSON format.
...
- [doco-cd ![GitHub Repo Stars](https://img.shields.io/github/stars/kimdre/doco-cd) ![GitHub last commit](https://img.shields.io/github/last-commit/kimdre/doco-cd)](https://github.com/kimdre/doco-cd) - Lightweight GitOps and Continuous Deployment tool to deploy Docker Compose projects and Swarm stacks using polling and webhooks.
...
- [OpenRun ![GitHub Repo Stars](https://img.shields.io/github/stars/openrundev/openrun) ![GitHub last commit](https://img.shields.io/github/last-commit/openrundev/openrun)](https://github.com/openrundev/openrun) - Builds, deploys, proxies, authenticates and auto-pauses web apps with Docker or Kubernetes.
...
- [resq ![GitHub Repo Stars](https://img.shields.io/github/stars/mashb1t/resq) ![GitHub last commit](https://img.shields.io/github/last-commit/mashb1t/resq)](https://github.com/mashb1t/resq) - Restic-powered Docker backups for volumes, databases, and .env files, with or without stopping containers. Works with local, SSH, or any S3 compatible storage.
...
- [docker-exporter ![GitHub Repo Stars](https://img.shields.io/github/stars/dlepaux/docker-exporter) ![GitHub last commit](https://img.shields.io/github/last-commit/dlepaux/docker-exporter)](https://github.com/dlepaux/docker-exporter) - Lightweight Prometheus exporter for Docker container metrics written in Rust. Correct cgroup v2 memory working set on ARM64 (Raspberry Pi 5), runs non-root with a read-only socket, ~7 MiB idle RAM.
...
- [InfraCanvas ![GitHub Repo Stars](https://img.shields.io/github/stars/bytestrix/InfraCanvas) ![GitHub last commit](https://img.shields.io/github/last-commit/bytestrix/InfraCanvas)](https://github.com/bytestrix/InfraCanvas) - Live visual map of containers, pods, volumes, and networks on any Linux server. Single binary, WebSocket-powered live updates.
...
- [compose-lint ![GitHub Repo Stars](https://img.shields.io/github/stars/tmatens/compose-lint) ![GitHub last commit](https://img.shields.io/github/last-commit/tmatens/compose-lint)](https://github.com/tmatens/compose-lint) - Lints Docker Compose files for security misconfigurations — privileged containers, unpinned images, Docker socket mounts, plaintext credentials — grounded in OWASP and the CIS Docker Benchmark.
- [container-explorer ![GitHub Repo Stars](https://img.shields.io/github/stars/google/container-explorer) ![GitHub last commit](https://img.shields.io/github/last-commit/google/container-explorer)](https://github.com/google/container-explorer) - Forensic utility to explore Docker and containerd container details from mounted disk images.
...
- [Gantry (Desktop) ![GitHub Repo Stars](https://img.shields.io/github/stars/getgantry/gantry) ![GitHub last commit](https://img.shields.io/github/last-commit/getgantry/gantry)](https://github.com/getgantry/gantry) - Native macOS app (SwiftUI, no Electron) for managing and monitoring Docker hosts, local and over SSH: fleet dashboard, live logs and stats, exec terminal, file browser, and a bundled MCP server for AI agents.
...
- [bosun ![GitHub Repo Stars](https://img.shields.io/github/stars/psychedelicdevx/bosun) ![GitHub last commit](https://img.shields.io/github/last-commit/psychedelicdevx/bosun)](https://github.com/psychedelicdevx/bosun) - A keyboard-driven terminal UI for Docker with compose project grouping, live logs, stats, and shell access.
...
- [DockTUI ![GitHub Repo Stars](https://img.shields.io/github/stars/strmax195-hue/docktui) ![GitHub last commit](https://img.shields.io/github/last-commit/strmax195-hue/docktui)](https://github.com/strmax195-hue/docktui) - Fast, zero-dependency terminal dashboard for Docker and Compose.
- [dockup ![GitHub Repo Stars](https://img.shields.io/github/stars/paulo-amaral/dockup) ![GitHub last commit](https://img.shields.io/github/last-commit/paulo-amaral/dockup)](https://github.com/paulo-amaral/dockup) - TUI to install, harden and maintain container runtimes: Docker Engine + Compose v2, NVIDIA Container Toolkit, Podman and Apple container, with a CIS-inspired security audit.
...
- [layerx ![GitHub Repo Stars](https://img.shields.io/github/stars/deveshctl/layerx) ![GitHub last commit](https://img.shields.io/github/last-commit/deveshctl/layerx)](https://github.com/deveshctl/layerx) - Inspect container image layers in a TUI — browse filesystem diffs, view file contents inline, sort by size, extract individual files, and gate CI on efficiency thresholds. Supports Docker, Podman, and OCI archives.
...
- [Docker Commander ![GitHub Repo Stars](https://img.shields.io/github/stars/koduj-dev/docker-commander) ![GitHub last commit](https://img.shields.io/github/last-commit/koduj-dev/docker-commander)](https://github.com/koduj-dev/docker-commander) - A self-hosted Docker management and monitoring UI with multi-host support, Compose management, aggregated logs, alerts, RBAC, vulnerability scanning, and MCP integration.
...
- [DockScope ![GitHub Repo Stars](https://img.shields.io/github/stars/ManuelR-T/dockscope) ![GitHub last commit](https://img.shields.io/github/last-commit/ManuelR-T/dockscope)](https://github.com/ManuelR-T/dockscope) - Visualizes Docker containers in a 3D dependency graph with live metrics, logs, and an in-browser terminal.
...
- [Self Hosted Runner ![GitHub Repo Stars](https://img.shields.io/github/stars/youssefbrr/self-hosted-runner) ![GitHub last commit](https://img.shields.io/github/last-commit/youssefbrr/self-hosted-runner)](https://github.com/youssefbrr/self-hosted-runner) - Dockerized solution for setting up a self-hosted GitHub Actions runner with support for Linux, macOS, and Windows.
...
- [Laradock ![GitHub Repo Stars](https://img.shields.io/github/stars/laradock/laradock) ![GitHub last commit](https://img.shields.io/github/last-commit/laradock/laradock)](https://github.com/laradock/laradock) - Full PHP development environment based on Docker, running Nginx/Apache, PHP, MySQL, Redis and more as swappable Compose services.
