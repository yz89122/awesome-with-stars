...
-   [werf ![GitHub Repo Stars](https://img.shields.io/github/stars/werf/werf) ![GitHub last commit](https://img.shields.io/github/last-commit/werf/werf)](https://github.com/werf/werf) - werf is a CI/CD tool for building Docker images efficiently and deploying them to Kubernetes using GitOps by [@flant](https://github.com/flant)
...
- [Axibase Collector ![GitHub Repo Stars](https://img.shields.io/github/stars/axibase/docker-axibase-collector) ![GitHub last commit](https://img.shields.io/github/last-commit/axibase/docker-axibase-collector)](https://github.com/axibase/docker-axibase-collector) - Axibase Collector streams performance counters, configuration changes and lifecycle events from the Docker engine(s) into Axibase Time Series Database for roll-up dashboards and integration with upstream monitoring systems.
...
- [Logspout ![GitHub Repo Stars](https://img.shields.io/github/stars/gliderlabs/logspout) ![GitHub last commit](https://img.shields.io/github/last-commit/gliderlabs/logspout)](https://github.com/gliderlabs/logspout) - Log routing for Docker container logs by [@gliderlabs][gliderlabs]
...
-   [Empire ![GitHub Repo Stars](https://img.shields.io/github/stars/remind101/empire) ![GitHub last commit](https://img.shields.io/github/last-commit/remind101/empire)](https://github.com/remind101/empire) - A PaaS built on top of Amazon EC2 Container Service (ECS)
...
-   [docker.vim ![GitHub Repo Stars](https://img.shields.io/github/stars/skanehira/docker.vim) ![GitHub last commit](https://img.shields.io/github/last-commit/skanehira/docker.vim)](https://github.com/skanehira/docker.vim) - Manage docker containers and images in Vim. By [@skanehira]
...
-   [Dockeron ![GitHub Repo Stars](https://img.shields.io/github/stars/dockeron/dockeron) ![GitHub last commit](https://img.shields.io/github/last-commit/dockeron/dockeron)](https://github.com/dockeron/dockeron) - A project built on Electron + Vue.js for Docker on desktop. [@fluency03](https://github.com/fluency03)
...
-   [ctop (2) ![GitHub Repo Stars](https://img.shields.io/github/stars/bcicen/ctop) ![GitHub last commit](https://img.shields.io/github/last-commit/bcicen/ctop)](https://github.com/bcicen/ctop) - Top-like interface for container metrics (Golang) by [@bcicen](https://github.com/bcicen/)
...
-   [Docker-mon ![GitHub Repo Stars](https://img.shields.io/github/stars/icecrime/docker-mon) ![GitHub last commit](https://img.shields.io/github/last-commit/icecrime/docker-mon)](https://github.com/icecrime/docker-mon) :skull: - Console-based Docker monitoring by [@icecrime](https://github.com/icecrime)
...
-   [Derrick ![GitHub Repo Stars](https://img.shields.io/github/stars/alibaba/derrick) ![GitHub last commit](https://img.shields.io/github/last-commit/alibaba/derrick)](https://github.com/alibaba/derrick) - A tool help you to automate the generation of Dockerfile and dockerize application by scanning the code. By [@alibaba](https://github.com/alibaba).
-   [dlayer ![GitHub Repo Stars](https://img.shields.io/github/stars/orisano/dlayer) ![GitHub last commit](https://img.shields.io/github/last-commit/orisano/dlayer)](https://github.com/orisano/dlayer) - docker layer analyzer by [@orisano](https://github.com/orisano)
-   [docker-companion ![GitHub Repo Stars](https://img.shields.io/github/stars/mudler/docker-companion) ![GitHub last commit](https://img.shields.io/github/last-commit/mudler/docker-companion)](https://github.com/mudler/docker-companion) - A command line tool written in Golang to squash and unpack docker images by [@mudler](https://github.com/mudler/)
-   [docker-make ![GitHub Repo Stars](https://img.shields.io/github/stars/CtripCloud/docker-make) ![GitHub last commit](https://img.shields.io/github/last-commit/CtripCloud/docker-make)](https://github.com/CtripCloud/docker-make) - Build, tag,and push a bunch of related docker images via a single command.
...
-   [DockerMake ![GitHub Repo Stars](https://img.shields.io/github/stars/avirshup/DockerMake) ![GitHub last commit](https://img.shields.io/github/last-commit/avirshup/DockerMake)](https://github.com/avirshup/DockerMake) - A reproducible Docker image build system for complex software stacks. By [@avirshup](https://github.com/avirshup)
...
-   [Dockly ![GitHub Repo Stars](https://img.shields.io/github/stars/swipely/dockly) ![GitHub last commit](https://img.shields.io/github/last-commit/swipely/dockly)](https://github.com/swipely/dockly) - Dockly is a gem made to ease the pain of packaging an application in Docker by [@swipely](https://github.com/swipely/)
-   [dockramp ![GitHub Repo Stars](https://img.shields.io/github/stars/jlhawn/dockramp) ![GitHub last commit](https://img.shields.io/github/last-commit/jlhawn/dockramp)](https://github.com/jlhawn/dockramp) :skull: - Proof of Concept: A Client Driven Docker Image Builder by [@jlhawn](https://github.com/jlhawn)
...
-   [HPC Container Maker ![GitHub Repo Stars](https://img.shields.io/github/stars/NVIDIA/hpc-container-maker) ![GitHub last commit](https://img.shields.io/github/last-commit/NVIDIA/hpc-container-maker)](https://github.com/NVIDIA/hpc-container-maker) - Generates Dockerfiles from a high level Python recipe, including building blocks for High-Performance Computing components by [@NVIDIA][nvidia]
-   [img ![GitHub Repo Stars](https://img.shields.io/github/stars/genuinetools/img) ![GitHub last commit](https://img.shields.io/github/last-commit/genuinetools/img)](https://github.com/genuinetools/img) - Standalone, daemon-less, unprivileged Dockerfile and OCI compatible container image builder by [@genuinetools][genuinetools]
-   [kaniko ![GitHub Repo Stars](https://img.shields.io/github/stars/GoogleContainerTools/kaniko) ![GitHub last commit](https://img.shields.io/github/last-commit/GoogleContainerTools/kaniko)](https://github.com/GoogleContainerTools/kaniko) - Build Container Images In Kubernetes. By [@GoogleContainerTools][googlecontainertools]
-   [makisu ![GitHub Repo Stars](https://img.shields.io/github/stars/uber/makisu) ![GitHub last commit](https://img.shields.io/github/last-commit/uber/makisu)](https://github.com/uber/makisu) - Uber's fast and flexible unprivileged image builder for Mesos and Kubernetes, with distributed cache support. By [@uber](https://github.com/uber)
...
-   [portainer ![GitHub Repo Stars](https://img.shields.io/github/stars/duedil-ltd/portainer) ![GitHub last commit](https://img.shields.io/github/last-commit/duedil-ltd/portainer)](https://github.com/duedil-ltd/portainer) - Apache Mesos framework for building Docker images by [@duedil-ltd](https://github.com/duedil-ltd)
...
-   [runlike ![GitHub Repo Stars](https://img.shields.io/github/stars/lavie/runlike) ![GitHub last commit](https://img.shields.io/github/last-commit/lavie/runlike)](https://github.com/lavie/runlike) - Generate `docker run`command and options from running containers by [@lavie](https://github.com/lavie)
-   [SkinnyWhale ![GitHub Repo Stars](https://img.shields.io/github/stars/djosephsen/skinnywhale) ![GitHub last commit](https://img.shields.io/github/last-commit/djosephsen/skinnywhale)](https://github.com/djosephsen/skinnywhale) :skull: - Skinnywhale helps you make smaller (as in megabytes) Docker containers.
-   [Smith ![GitHub Repo Stars](https://img.shields.io/github/stars/oracle/smith) ![GitHub last commit](https://img.shields.io/github/last-commit/oracle/smith)](https://github.com/oracle/smith) - A Micocontainer Builder and can perform multi-stage builds after the image is built [Oracle][oracle]
-   [userdef ![GitHub Repo Stars](https://img.shields.io/github/stars/theAkito/userdef) ![GitHub last commit](https://img.shields.io/github/last-commit/theAkito/userdef)](https://github.com/theAkito/userdef) - An advanced `adduser` for your Alpine based Docker images. Made by [Akito][akito]
-   [Whaler ![GitHub Repo Stars](https://img.shields.io/github/stars/P3GLEG/Whaler) ![GitHub last commit](https://img.shields.io/github/last-commit/P3GLEG/Whaler)](https://github.com/P3GLEG/Whaler) - Program to reverse Docker images into Dockerfiles by [@P3GLEG](https://github.com/P3GLEG/).
-   [Whales ![GitHub Repo Stars](https://img.shields.io/github/stars/Gueils/whales) ![GitHub last commit](https://img.shields.io/github/last-commit/Gueils/whales)](https://github.com/Gueils/whales) - A tool to automatically dockerize your applications by [@icalialabs](https://github.com/IcaliaLabs).

### Dockerfile

-   [chaperone-docker ![GitHub Repo Stars](https://img.shields.io/github/stars/garywiz/chaperone-docker) ![GitHub last commit](https://img.shields.io/github/last-commit/garywiz/chaperone-docker)](https://github.com/garywiz/chaperone-docker) - A set of images using the Chaperone process manager, including a lean Alpine image, LAMP, LEMP, and bare-bones base kits.
...
-   [dockmoor ![GitHub Repo Stars](https://img.shields.io/github/stars/MeneDev/dockmoor) ![GitHub last commit](https://img.shields.io/github/last-commit/MeneDev/dockmoor)](https://github.com/MeneDev/dockmoor) :construction: - Manage docker image references and help to create reproducible builds with Docker. By [@MeneDev](https://github.com/MeneDev)
...
-   [FROM:latest ![GitHub Repo Stars](https://img.shields.io/github/stars/replicatedhq/dockerfilelint) ![GitHub last commit](https://img.shields.io/github/last-commit/replicatedhq/dockerfilelint)](https://github.com/replicatedhq/dockerfilelint) - An opinionated Dockerfile linter by [@replicatedhq](https://github.com/replicatedhq)
-   [Hadolint ![GitHub Repo Stars](https://img.shields.io/github/stars/hadolint/hadolint) ![GitHub last commit](https://img.shields.io/github/last-commit/hadolint/hadolint)](https://github.com/hadolint/hadolint) - A Dockerfile linter that checks for best practices, common mistakes, and is also able to lint any bash written in `RUN` instructions; by [@lukasmartinelli](https://github.com/lukasmartinelli)
-   [Whale-linter ![GitHub Repo Stars](https://img.shields.io/github/stars/jeromepin/whale-linter) ![GitHub last commit](https://img.shields.io/github/last-commit/jeromepin/whale-linter)](https://github.com/jeromepin/whale-linter) - A simple and small Dockerfile linter written in Python3+ without dependencies by [@jeromepin](https://github.com/jeromepin)

### Metadata

-   [opencontainer ![GitHub Repo Stars](https://img.shields.io/github/stars/opencontainers/image-spec) ![GitHub last commit](https://img.shields.io/github/last-commit/opencontainers/image-spec)](https://github.com/opencontainers/image-spec/blob/master/annotations.md) - A convention and shared namespace for Docker labels defined by OCI Image Spec.
...
-   [cleanreg ![GitHub Repo Stars](https://img.shields.io/github/stars/hcguersoy/cleanreg) ![GitHub last commit](https://img.shields.io/github/last-commit/hcguersoy/cleanreg)](https://github.com/hcguersoy/cleanreg) - A small tool to delete image manifests from a Docker Registry implementing the API v2, dereferencing them for the GC by [@hcguersoy](https://github.com/hcguersoy)
...
-   [Docket ![GitHub Repo Stars](https://img.shields.io/github/stars/netvarun/docket) ![GitHub last commit](https://img.shields.io/github/last-commit/netvarun/docket)](https://github.com/netvarun/docket) - Custom docker registry that allows for lightning fast deploys through bittorrent by [@netvarun](https://github.com/netvarun/)
...
-   [ahab ![GitHub Repo Stars](https://img.shields.io/github/stars/instacart/ahab) ![GitHub last commit](https://img.shields.io/github/last-commit/instacart/ahab)](https://github.com/instacart/ahab) - Docker event handling with Python by [@instacart](https://github.com/instacart)
-   [clj-docker-client ![GitHub Repo Stars](https://img.shields.io/github/stars/into-docker/clj-docker-client) ![GitHub last commit](https://img.shields.io/github/last-commit/into-docker/clj-docker-client)](https://github.com/into-docker/clj-docker-client) :skull: - Idiomatic Clojure client for the Docker remote API. By [@lispyclouds][lispyclouds]
...
-   [Docker Client for JVM ![GitHub Repo Stars](https://img.shields.io/github/stars/gesellix/docker-client) ![GitHub last commit](https://img.shields.io/github/last-commit/gesellix/docker-client)](https://github.com/gesellix/docker-client) - A Docker remote api client library for the JVM, written in Groovy by [@gesellix][gesellix]
...
-   [docker-client ![GitHub Repo Stars](https://img.shields.io/github/stars/spotify/docker-client) ![GitHub last commit](https://img.shields.io/github/last-commit/spotify/docker-client)](https://github.com/spotify/docker-client) :skull: - Java client for the Docker remote API. By [@spotify][spotify]
-   [docker-it-scala ![GitHub Repo Stars](https://img.shields.io/github/stars/whisklabs/docker-it-scala) ![GitHub last commit](https://img.shields.io/github/last-commit/whisklabs/docker-it-scala)](https://github.com/whisklabs/docker-it-scala) - Docker integration testing kit with Scala by [@whisklabs](https://github.com/whisklabs)
-   [docker-java-api ![GitHub Repo Stars](https://img.shields.io/github/stars/amihaiemil/docker-java-api) ![GitHub last commit](https://img.shields.io/github/last-commit/amihaiemil/docker-java-api)](https://github.com/amihaiemil/docker-java-api) - Lightweight, truly object-oriented, Java client for Docker's API. By [@amihaiemil](https://github.com/amihaiemil)
...
-   [Docker-PowerShell ![GitHub Repo Stars](https://img.shields.io/github/stars/Microsoft/Docker-PowerShell) ![GitHub last commit](https://img.shields.io/github/last-commit/Microsoft/Docker-PowerShell)](https://github.com/Microsoft/Docker-PowerShell) - PowerShell Module for Docker
-   [Docker.DotNet ![GitHub Repo Stars](https://img.shields.io/github/stars/Microsoft/Docker.DotNet) ![GitHub last commit](https://img.shields.io/github/last-commit/Microsoft/Docker.DotNet)](https://github.com/Microsoft/Docker.DotNet) - C#/.NET HTTP client for the Docker remote API by [@ahmetb](https://github.com/ahmetb)
...
-   [dockerfile-maven ![GitHub Repo Stars](https://img.shields.io/github/stars/spotify/dockerfile-maven) ![GitHub last commit](https://img.shields.io/github/last-commit/spotify/dockerfile-maven)](https://github.com/spotify/dockerfile-maven) - A Maven plugin for building and pushing Docker images by [@spotify][spotify]
-   [dockerode ![GitHub Repo Stars](https://img.shields.io/github/stars/apocas/dockerode) ![GitHub last commit](https://img.shields.io/github/last-commit/apocas/dockerode)](https://github.com/apocas/dockerode) - Docker Remote API node.js module by [@apocas](https://github.com/apocas)
-   [DoMonit ![GitHub Repo Stars](https://img.shields.io/github/stars/eon01/DoMonit) ![GitHub last commit](https://img.shields.io/github/last-commit/eon01/DoMonit)](https://github.com/eon01/DoMonit) - A simple Docker Monitoring wrapper For Docker API
-   [go-dockerclient ![GitHub Repo Stars](https://img.shields.io/github/stars/fsouza/go-dockerclient) ![GitHub last commit](https://img.shields.io/github/last-commit/fsouza/go-dockerclient)](https://github.com/fsouza/go-dockerclient/) - Go HTTP client for the Docker remote API by [@fsouza](https://github.com/fsouza/)
-   [Gradle Docker plugin ![GitHub Repo Stars](https://img.shields.io/github/stars/gesellix/gradle-docker-plugin) ![GitHub last commit](https://img.shields.io/github/last-commit/gesellix/gradle-docker-plugin)](https://github.com/gesellix/gradle-docker-plugin) - A Docker remote api plugin for Gradle by [@gesellix][gesellix]
-   [libcompose ![GitHub Repo Stars](https://img.shields.io/github/stars/docker/libcompose) ![GitHub last commit](https://img.shields.io/github/last-commit/docker/libcompose)](https://github.com/docker/libcompose) - Go library for Docker Compose.
-   [Portainer stack utils ![GitHub Repo Stars](https://img.shields.io/github/stars/greenled/portainer-stack-utils) ![GitHub last commit](https://img.shields.io/github/last-commit/greenled/portainer-stack-utils)](https://github.com/greenled/portainer-stack-utils) :construction: - Bash script to deploy/update/undeploy Docker stacks in a Portainer instance from a docker-compose yaml file. By [@greenled](https://github.com/greenled).
-   [sbt-docker-compose ![GitHub Repo Stars](https://img.shields.io/github/stars/Tapad/sbt-docker-compose) ![GitHub last commit](https://img.shields.io/github/last-commit/Tapad/sbt-docker-compose)](https://github.com/Tapad/sbt-docker-compose) - Integrates Docker Compose functionality into sbt by [@kurtkopchik](https://github.com/kurtkopchik/)
-   [sbt-docker ![GitHub Repo Stars](https://img.shields.io/github/stars/marcuslonnberg/sbt-docker) ![GitHub last commit](https://img.shields.io/github/last-commit/marcuslonnberg/sbt-docker)](https://github.com/marcuslonnberg/sbt-docker) - Create Docker images directly from sbt by [@marcuslonnberg](https://github.com/marcuslonnberg)
...
-   [Captain ![GitHub Repo Stars](https://img.shields.io/github/stars/harbur/captain) ![GitHub last commit](https://img.shields.io/github/last-commit/harbur/captain)](https://github.com/harbur/captain) - Convert your Git workflow to Docker containers ready for Continuous Delivery by [@harbur](https://github.com/harbur).
-   [Cyclone ![GitHub Repo Stars](https://img.shields.io/github/stars/caicloud/cyclone) ![GitHub last commit](https://img.shields.io/github/last-commit/caicloud/cyclone)](https://github.com/caicloud/cyclone) - Powerful workflow engine and end-to-end pipeline solutions implemented with native Kubernetes resources by [@caicloud](https://github.com/caicloud).
...
-   [GOCD-Docker ![GitHub Repo Stars](https://img.shields.io/github/stars/gocd/gocd-docker) ![GitHub last commit](https://img.shields.io/github/last-commit/gocd/gocd-docker)](https://github.com/gocd/gocd-docker) :skull: - Go Server and Agent in docker containers to provision.
...
-   [Kraken CI ![GitHub Repo Stars](https://img.shields.io/github/stars/Kraken-CI/kraken) ![GitHub last commit](https://img.shields.io/github/last-commit/Kraken-CI/kraken)](https://github.com/Kraken-CI/kraken) - Modern CI/CD, open-source, on-premise system that is highly scalable and focused on testing. One of its executors is Docker. Developed by [@Kraken-CI](https://github.com/Kraken-CI).
-   [Microservices Continuous Deployment ![GitHub Repo Stars](https://img.shields.io/github/stars/francescou/docker-continuous-deployment) ![GitHub last commit](https://img.shields.io/github/last-commit/francescou/docker-continuous-deployment)](https://github.com/francescou/docker-continuous-deployment) - Continuous deployment of a microservices application.
-   [mu ![GitHub Repo Stars](https://img.shields.io/github/stars/stelligent/mu) ![GitHub last commit](https://img.shields.io/github/last-commit/stelligent/mu)](https://github.com/stelligent/mu) - Tool to configure CI/CD of your container applications via AWS CodePipeline, CodeBuild and ECS [@Stelligent](https://github.com/stelligent)
-   [Ouroboros ![GitHub Repo Stars](https://img.shields.io/github/stars/pyouroboros/ouroboros) ![GitHub last commit](https://img.shields.io/github/last-commit/pyouroboros/ouroboros)](https://github.com/pyouroboros/ouroboros) :skull: - Automatically update running Docker containers with notifications
-   [Popper ![GitHub Repo Stars](https://img.shields.io/github/stars/systemslab/popper) ![GitHub last commit](https://img.shields.io/github/last-commit/systemslab/popper)](https://github.com/systemslab/popper) - Github actions workflow (HCL syntax) execution engine.
-   [Screwdriver :heavy_dollar_sign:](https://screwdriver.cd/) - Yahoo's OpenSource buildplatform designed for Continous Delivery.
-   [Skipper ![GitHub Repo Stars](https://img.shields.io/github/stars/Stratoscale/skipper) ![GitHub last commit](https://img.shields.io/github/last-commit/Stratoscale/skipper)](https://github.com/Stratoscale/skipper) - Easily dockerize your Git repository by [@Stratoscale](https://github.com/Stratoscale)
-   [SwarmCI ![GitHub Repo Stars](https://img.shields.io/github/stars/ghostsquad/swarmci) ![GitHub last commit](https://img.shields.io/github/last-commit/ghostsquad/swarmci)](https://github.com/ghostsquad/swarmci) - Create a distributed, isolated task pipeline in your Docker Swarm.
-   [Watchtower ![GitHub Repo Stars](https://img.shields.io/github/stars/containrrr/watchtower) ![GitHub last commit](https://img.shields.io/github/last-commit/containrrr/watchtower)](https://github.com/containrrr/watchtower) - Automatically update running Docker containers

### Development Environment

-   [batect ![GitHub Repo Stars](https://img.shields.io/github/stars/batect/batect) ![GitHub last commit](https://img.shields.io/github/last-commit/batect/batect)](https://github.com/batect/batect) - build and testing environments as code tool: Dockerised build and testing environments made easy by [@charleskorn](https://github.com/charleskorn)
-   [Binci ![GitHub Repo Stars](https://img.shields.io/github/stars/binci/binci) ![GitHub last commit](https://img.shields.io/github/last-commit/binci/binci)](https://github.com/binci/binci) - Containerize your development workflow. (formerly DevLab by [@TechnologyAdvice](https://github.com/TechnologyAdvice))
-   [Boot2Docker ![GitHub Repo Stars](https://img.shields.io/github/stars/boot2docker/boot2docker) ![GitHub last commit](https://img.shields.io/github/last-commit/boot2docker/boot2docker)](https://github.com/boot2docker/boot2docker) :skull: - Docker for OSX and Windows
-   [coder ![GitHub Repo Stars](https://img.shields.io/github/stars/coder/coder) ![GitHub last commit](https://img.shields.io/github/last-commit/coder/coder)](https://github.com/coder/coder) - remote development machines powered by Terraform or Docker by [@coder](https://github.com/coder)
-   [construi ![GitHub Repo Stars](https://img.shields.io/github/stars/lstephen/construi) ![GitHub last commit](https://img.shields.io/github/last-commit/lstephen/construi)](https://github.com/lstephen/construi) - Run your builds inside a Docker defined environment by [@lstephen](https://github.com/lstephen)
-   [Crashcart ![GitHub Repo Stars](https://img.shields.io/github/stars/oracle/crashcart) ![GitHub last commit](https://img.shields.io/github/last-commit/oracle/crashcart)](https://github.com/oracle/crashcart) - Sideload Linux binaries into a running container for troubleshooting by [@Oracle][oracle]
-   [dde ![GitHub Repo Stars](https://img.shields.io/github/stars/whatwedo/dde) ![GitHub last commit](https://img.shields.io/github/last-commit/whatwedo/dde)](https://github.com/whatwedo/dde) :construction: - Local development environment toolset based on Docker. By [@whatwedo](https://github.com/whatwedo)
-   [Devstep ![GitHub Repo Stars](https://img.shields.io/github/stars/fgrehm/devstep) ![GitHub last commit](https://img.shields.io/github/last-commit/fgrehm/devstep)](https://github.com/fgrehm/devstep) :skull: - Development environments powered by Docker and buildpacks by [@fgrehm][fgrehm]
-   [Dinghy ![GitHub Repo Stars](https://img.shields.io/github/stars/codekitchen/dinghy) ![GitHub last commit](https://img.shields.io/github/last-commit/codekitchen/dinghy)](https://github.com/codekitchen/dinghy) - An alternative way to use Docker on Mac OS X using Docker Machine with virtualbox, vmware, xhyve or parallels
...
-   [DLite ![GitHub Repo Stars](https://img.shields.io/github/stars/nlf/dlite) ![GitHub last commit](https://img.shields.io/github/last-commit/nlf/dlite)](https://github.com/nlf/dlite) :skull: - Simplest way to use Docker on OSX, no VM needed. By [@nlf](https://github.com/nlf)
-   [dobi ![GitHub Repo Stars](https://img.shields.io/github/stars/dnephin/dobi) ![GitHub last commit](https://img.shields.io/github/last-commit/dnephin/dobi)](https://github.com/dnephin/dobi) - A build automation tool for Docker applications. By [@dnephin](https://github.com/dnephin)
...
-   [Docker osx dev ![GitHub Repo Stars](https://img.shields.io/github/stars/brikis98/docker-osx-dev) ![GitHub last commit](https://img.shields.io/github/last-commit/brikis98/docker-osx-dev)](https://github.com/brikis98/docker-osx-dev) :skull: - A productive development environment with Docker on OS X by [@brikis98](https://github.com/brikis98)
-   [Docker-Arch ![GitHub Repo Stars](https://img.shields.io/github/stars/Ph3nol/Docker-Arch) ![GitHub last commit](https://img.shields.io/github/last-commit/Ph3nol/Docker-Arch)](https://github.com/Ph3nol/Docker-Arch) - Generate Web/CLI projects Dockerized development environments, from 1 simple YAML file. By [@Ph3nol](https://github.com/ph3nol)
-   [docker-setup ![GitHub Repo Stars](https://img.shields.io/github/stars/nicholasdille/docker-setup) ![GitHub last commit](https://img.shields.io/github/last-commit/nicholasdille/docker-setup)](https://github.com/nicholasdille/docker-setup) - Install, configure and update container tools. By [@nicholasdille](https://twitter.com/nicholasdille)
...
-   [docker-vm ![GitHub Repo Stars](https://img.shields.io/github/stars/shyiko/docker-vm) ![GitHub last commit](https://img.shields.io/github/last-commit/shyiko/docker-vm)](https://github.com/shyiko/docker-vm) - Simple and transparent alternative to boot2docker (backed by Vagrant) by [@shyiko](https://github.com/shyiko)
-   [DockerBuildManagement ![GitHub Repo Stars](https://img.shields.io/github/stars/DIPSAS/DockerBuildManagement) ![GitHub last commit](https://img.shields.io/github/last-commit/DIPSAS/DockerBuildManagement)](https://github.com/DIPSAS/DockerBuildManagement) - Build Management is a python application, installed with pip. The application makes it easy to manage a build system based on Docker by configuring a single yaml file describing how to build, test, run or publish a containerized solution.
...
-   [Dusty ![GitHub Repo Stars](https://img.shields.io/github/stars/gamechanger/dusty) ![GitHub last commit](https://img.shields.io/github/last-commit/gamechanger/dusty)](https://github.com/gamechanger/dusty) - Managed Docker development environments on OS X
...
-   [footloose ![GitHub Repo Stars](https://img.shields.io/github/stars/weaveworks/footloose) ![GitHub last commit](https://img.shields.io/github/last-commit/weaveworks/footloose)](https://github.com/weaveworks/footloose) - Spin containers that look like Virtual Machines - By [@dlespiau](https://github.com/dlespiau)
-   [forward2docker ![GitHub Repo Stars](https://img.shields.io/github/stars/bsideup/forward2docker) ![GitHub last commit](https://img.shields.io/github/last-commit/bsideup/forward2docker)](https://github.com/bsideup/forward2docker) :skull: - Utility to auto forward a port from localhost into ports on Docker containers running in a boot2docker VM by [@bsideup](https://github.com/bsideup)
...
-   [Kitt ![GitHub Repo Stars](https://img.shields.io/github/stars/senges/kitt) ![GitHub last commit](https://img.shields.io/github/last-commit/senges/kitt)](https://github.com/senges/kitt) - A portable and disposable Shell environment, based on Docker and Nix. By [@senges](https://github.com/senges)
-   [Lando ![GitHub Repo Stars](https://img.shields.io/github/stars/lando/lando) ![GitHub last commit](https://img.shields.io/github/last-commit/lando/lando)](https://github.com/lando/lando) - Lando is for developers who want to quickly specify and painlessly spin up the services and tools needed to develop their projects. By [Tandem](https://thinktandem.io/)
...
-   [caduc ![GitHub Repo Stars](https://img.shields.io/github/stars/tjamet/caduc) ![GitHub last commit](https://img.shields.io/github/last-commit/tjamet/caduc)](https://github.com/tjamet/caduc) - A docker garbage collector cleaning stuff you did not use recently
-   [Docker Clean ![GitHub Repo Stars](https://img.shields.io/github/stars/ZZROTDesign/docker-clean) ![GitHub last commit](https://img.shields.io/github/last-commit/ZZROTDesign/docker-clean)](https://github.com/ZZROTDesign/docker-clean) - A script that cleans Docker containers, images and volumes by [@zzrotdesign](https://github.com/ZZROTDesign)
-   [docker_gc ![GitHub Repo Stars](https://img.shields.io/github/stars/pdacity/docker_gc) ![GitHub last commit](https://img.shields.io/github/last-commit/pdacity/docker_gc)](https://github.com/pdacity/docker_gc) - Image for automatic removing unused Docker Swarm objects. Also works just as Docker Service by [@pdacity](https://github.com/pdacity)
-   [Docker-cleanup ![GitHub Repo Stars](https://img.shields.io/github/stars/meltwater/docker-cleanup) ![GitHub last commit](https://img.shields.io/github/last-commit/meltwater/docker-cleanup)](https://github.com/meltwater/docker-cleanup) :skull: - Automatic Docker image, container and volume cleanup by [@meltwater](https://github.com/meltwater)
...
-   [docker-garby ![GitHub Repo Stars](https://img.shields.io/github/stars/konstruktoid/docker-garby) ![GitHub last commit](https://img.shields.io/github/last-commit/konstruktoid/docker-garby)](https://github.com/konstruktoid/docker-garby) - Docker garbage collection script by [@konstruktoid](https://github.com/konstruktoid).
-   [docker-gc ![GitHub Repo Stars](https://img.shields.io/github/stars/spotify/docker-gc) ![GitHub last commit](https://img.shields.io/github/last-commit/spotify/docker-gc)](https://github.com/spotify/docker-gc) :skull: - A cron job that will delete old stopped containers and unused images by [@spotify][spotify]
-   [sherdock ![GitHub Repo Stars](https://img.shields.io/github/stars/rancher/sherdock) ![GitHub last commit](https://img.shields.io/github/last-commit/rancher/sherdock)](https://github.com/rancher/sherdock) :skull: - Automatic GC of images based on regexp by [@rancher][rancher]

### Serverless

-   [AMP ![GitHub Repo Stars](https://img.shields.io/github/stars/appcelerator-archive/amp) ![GitHub last commit](https://img.shields.io/github/last-commit/appcelerator-archive/amp)](https://github.com/appcelerator-archive/amp) :skull: - The open source unified CaaS/FaaS platform for Docker, batteries included. By [@Appcelerator](https://github.com/appcelerator-archive)
...
-   [dgoss ![GitHub Repo Stars](https://img.shields.io/github/stars/aelsabbahy/goss) ![GitHub last commit](https://img.shields.io/github/last-commit/aelsabbahy/goss)](https://github.com/aelsabbahy/goss/tree/master/extras/dgoss) - A fast YAML based tool for validating docker containers.
-   [DockerSpec ![GitHub Repo Stars](https://img.shields.io/github/stars/zuazo/dockerspec) ![GitHub last commit](https://img.shields.io/github/last-commit/zuazo/dockerspec)](https://github.com/zuazo/dockerspec) - A small Ruby Gem to run RSpec and Serverspec, Infrataster and Capybara tests against Dockerfiles or Docker images easily. By [@zuazo](https://github.com/zuazo)
-   [Dockunit ![GitHub Repo Stars](https://img.shields.io/github/stars/dockunit/platform) ![GitHub last commit](https://img.shields.io/github/last-commit/dockunit/platform)](https://github.com/dockunit/platform) :skull: - Docker based integration tests. A simple Node based utility for running Docker based unit tests. By [@dockunit](https://github.com/dockunit)
-   [EZDC ![GitHub Repo Stars](https://img.shields.io/github/stars/lynchborg/ezdc) ![GitHub last commit](https://img.shields.io/github/last-commit/lynchborg/ezdc)](https://github.com/lynchborg/ezdc) - Golang test harness for easily setting up tests that rely on services in a docker-compose.yml. By [@byrnedo]
...
-   [Azk ![GitHub Repo Stars](https://img.shields.io/github/stars/azukiapp/azk) ![GitHub last commit](https://img.shields.io/github/last-commit/azukiapp/azk)](https://github.com/azukiapp/azk) - Orchestrate development environments on your local machine by [@azukiapp](https://github.com/azukiapp)
-   [Beluga ![GitHub Repo Stars](https://img.shields.io/github/stars/cortexmedia/Beluga) ![GitHub last commit](https://img.shields.io/github/last-commit/cortexmedia/Beluga)](https://github.com/cortexmedia/Beluga) :skull: - CLI to deploy docker containers on a single server or low amount of servers. By [@cortextmedia](https://github.com/cortexmedia)
-   [dexec ![GitHub Repo Stars](https://img.shields.io/github/stars/docker-exec/dexec) ![GitHub last commit](https://img.shields.io/github/last-commit/docker-exec/dexec)](https://github.com/docker-exec/dexec) - Command line interface written in Go for running code with Docker Exec images.
-   [dockerized ![GitHub Repo Stars](https://img.shields.io/github/stars/benzaita/dockerized-cli) ![GitHub last commit](https://img.shields.io/github/last-commit/benzaita/dockerized-cli)](https://github.com/benzaita/dockerized-cli) - Seamlessly execute commands in a container.
-   [Dray ![GitHub Repo Stars](https://img.shields.io/github/stars/CenturyLinkLabs/dray) ![GitHub last commit](https://img.shields.io/github/last-commit/CenturyLinkLabs/dray)](https://github.com/CenturyLinkLabs/dray) - An engine for managing the execution of container-based workflows by [@CenturyLinkLabs][centurylinklabs]
-   [FuGu ![GitHub Repo Stars](https://img.shields.io/github/stars/mattes/fugu) ![GitHub last commit](https://img.shields.io/github/last-commit/mattes/fugu)](https://github.com/mattes/fugu) :skull: - Docker run wrapper without orchestration by [@mattes](https://github.com/mattes)
...
-   [Shutit ![GitHub Repo Stars](https://img.shields.io/github/stars/ianmiell/shutit) ![GitHub last commit](https://img.shields.io/github/last-commit/ianmiell/shutit)](https://github.com/ianmiell/shutit) - Tool for building and maintaining complex Docker deployments by [@ianmiell](https://github.com/ianmiell)
...
-   [T.A.D.S. boilerplate ![GitHub Repo Stars](https://img.shields.io/github/stars/Thomvaill/tads-boilerplate) ![GitHub last commit](https://img.shields.io/github/last-commit/Thomvaill/tads-boilerplate)](https://github.com/Thomvaill/tads-boilerplate) - The power of Ansible and Terraform + the simplicity of Docker Swarm = Infrastructure as Code and DevOps best practices. By [@Thomvaill](https://github.com/Thomvaill)
-   [Terraform cloud-init config ![GitHub Repo Stars](https://img.shields.io/github/stars/christippett/terraform-cloudinit-container-server) ![GitHub last commit](https://img.shields.io/github/last-commit/christippett/terraform-cloudinit-container-server)](https://github.com/christippett/terraform-cloudinit-container-server) - Terraform module for deploying a single Docker image or `docker-compose.yaml` file to any Cloud™ VM
-   [Turbo ![GitHub Repo Stars](https://img.shields.io/github/stars/ramitsurana/turbo) ![GitHub last commit](https://img.shields.io/github/last-commit/ramitsurana/turbo)](https://github.com/ramitsurana/turbo) - Simple and Powerful utility for docker. By [@ramitsurana][ramitsurana]
-   [udocker ![GitHub Repo Stars](https://img.shields.io/github/stars/indigo-dc/udocker) ![GitHub last commit](https://img.shields.io/github/last-commit/indigo-dc/udocker)](https://github.com/indigo-dc/udocker) - A tool to execute simple docker containers in batch or interactive systems without root privileges by [@inidigo-dc](https://github.com/indigo-dc)
-   [Vagrant - Docker provider](https://developer.hashicorp.com/vagrant/docs/providers/docker/basics) - Good starting point is [vagrant-docker-example ![GitHub Repo Stars](https://img.shields.io/github/stars/bubenkoff/vagrant-docker-example) ![GitHub last commit](https://img.shields.io/github/last-commit/bubenkoff/vagrant-docker-example)](https://github.com/bubenkoff/vagrant-docker-example) by [@bubenkoff](https://github.com/bubenkoff)
...
-   [SPM for Docker ![GitHub Repo Stars](https://img.shields.io/github/stars/sematext/sematext-agent-docker) ![GitHub last commit](https://img.shields.io/github/last-commit/sematext/sematext-agent-docker)](https://github.com/sematext/sematext-agent-docker) :heavy_dollar_sign: - Monitoring of host and container metrics, Docker events and logs. Automatic log parser. Anomaly Detection and alerting for metrics and logs. [@sematext](https://github.com/sematext)
...
-   [Awesome CI/CD ![GitHub Repo Stars](https://img.shields.io/github/stars/cicdops/awesome-ciandcd) ![GitHub last commit](https://img.shields.io/github/last-commit/cicdops/awesome-ciandcd)](https://github.com/cicdops/awesome-ciandcd) - Not specific to docker but relevant.
...
-   [Dockerfile best practices ![GitHub Repo Stars](https://img.shields.io/github/stars/hexops/dockerfile) ![GitHub last commit](https://img.shields.io/github/last-commit/hexops/dockerfile)](https://github.com/hexops/dockerfile) - This repository has best-practices for writing Dockerfiles
