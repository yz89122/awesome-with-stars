...
- [pindock ![GitHub Repo Stars](https://img.shields.io/github/stars/deadnews/pindock) ![GitHub last commit](https://img.shields.io/github/last-commit/deadnews/pindock)](https://github.com/deadnews/pindock) - Pin and update Docker image digests in Dockerfiles and compose files. By [deadnews](https://github.com/deadnews).
...
- [easydocker ![GitHub Repo Stars](https://img.shields.io/github/stars/joao-zanutto/easydocker) ![GitHub last commit](https://img.shields.io/github/last-commit/joao-zanutto/easydocker)](https://github.com/joao-zanutto/easydocker) - A Terminal UI highly inpired by k9s levaraging beatiful BubbleTea graphics. By [joao-zanutto](https://github.com/joao-zanutto).
