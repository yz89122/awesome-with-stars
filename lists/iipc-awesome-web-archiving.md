...
* [ArchiveBox ![GitHub Repo Stars](https://img.shields.io/github/stars/ArchiveBox/ArchiveBox) ![GitHub last commit](https://img.shields.io/github/last-commit/ArchiveBox/ArchiveBox)](https://github.com/ArchiveBox/ArchiveBox) - A tool which maintains an additive archive from RSS feeds, bookmarks, and links using wget, Chrome headless, and other methods (formerly `Bookmark Archiver`). *(In Development)*
...
* [Cairn ![GitHub Repo Stars](https://img.shields.io/github/stars/wabarc/cairn) ![GitHub last commit](https://img.shields.io/github/last-commit/wabarc/cairn)](https://github.com/wabarc/cairn) - A npm package and CLI tool for saving webpages as single HTML files. It does not produce WARC or WACZ archives. *(Stable)*
...
* [crau ![GitHub Repo Stars](https://img.shields.io/github/stars/turicas/crau) ![GitHub last commit](https://img.shields.io/github/last-commit/turicas/crau)](https://github.com/turicas/crau) - A lightweight command-line tool for archiving the Web and playing archives: you just need a list of URLs. The name "crau" stems from the Brazilian pronounciation of "crawl". *(Stable)*
...
* [Wpull ![GitHub Repo Stars](https://img.shields.io/github/stars/ArchiveTeam/wpull) ![GitHub last commit](https://img.shields.io/github/last-commit/ArchiveTeam/wpull)](https://github.com/ArchiveTeam/wpull) - A Wget-compatible (or remake/clone/replacement/alternative) web downloader and crawler. *(Stable)*
...
* [bagnabit2warc ![GitHub Repo Stars](https://img.shields.io/github/stars/internetarchive/bagnabit2warc) ![GitHub last commit](https://img.shields.io/github/last-commit/internetarchive/bagnabit2warc)](https://github.com/internetarchive/bagnabit2warc) - Convert a [bag-nabit ![GitHub Repo Stars](https://img.shields.io/github/stars/harvard-lil/bag-nabit) ![GitHub last commit](https://img.shields.io/github/last-commit/harvard-lil/bag-nabit)](https://github.com/harvard-lil/bag-nabit) dataset stored in a ZIP into a full-content WARC.
...
* [duckdb_warc ![GitHub Repo Stars](https://img.shields.io/github/stars/midwork-finds-jobs/duckdb_warc) ![GitHub last commit](https://img.shields.io/github/last-commit/midwork-finds-jobs/duckdb_warc)](https://github.com/midwork-finds-jobs/duckdb_warc) - DuckDB extension to query WARC files. *(In Development)*
* [duckdb-web-archive-cdx ![GitHub Repo Stars](https://img.shields.io/github/stars/midwork-finds-jobs/duckdb-web-archive) ![GitHub last commit](https://img.shields.io/github/last-commit/midwork-finds-jobs/duckdb-web-archive)](https://github.com/midwork-finds-jobs/duckdb-web-archive) - DuckDB extension to query the Internet Archive and CommonCrawl CDX APIs directly from SQL. *(In Development)*
...
* [warcbench ![GitHub Repo Stars](https://img.shields.io/github/stars/harvard-lil/warcbench) ![GitHub last commit](https://img.shields.io/github/last-commit/harvard-lil/warcbench)](https://github.com/harvard-lil/warcbench) - A tool for exploring, analyzing, transforming, recombining, and extracting data from WARC (Web ARChive) files.
...
* [warc ![GitHub Repo Stars](https://img.shields.io/github/stars/jedireza/warc) ![GitHub last commit](https://img.shields.io/github/last-commit/jedireza/warc)](https://github.com/jedireza/warc) - A Rust library for reading and writing WARC files. *(Stable)*
...
* [Archives Unleashed Toolkit ![GitHub Repo Stars](https://img.shields.io/github/stars/archivesunleashed/aut) ![GitHub last commit](https://img.shields.io/github/last-commit/archivesunleashed/aut)](https://github.com/archivesunleashed/aut) - An open-source platform for analyzing web archives with Apache Spark. *(Stable)*
...
* [FlameShot ![GitHub Repo Stars](https://img.shields.io/github/stars/flameshot-org/flameshot) ![GitHub last commit](https://img.shields.io/github/last-commit/flameshot-org/flameshot)](https://github.com/flameshot-org/flameshot) - Screen capture and annotation on Ubuntu.
...
* [Zotero Robust Links Extension ![GitHub Repo Stars](https://img.shields.io/github/stars/lanl/Zotero-Robust-Links-Extension) ![GitHub last commit](https://img.shields.io/github/last-commit/lanl/Zotero-Robust-Links-Extension)](https://github.com/lanl/Zotero-Robust-Links-Extension) - A [Zotero](https://www.zotero.org/) extension that submits to and reads from web archives. Supercedes [leonkt/zotero-memento ![GitHub Repo Stars](https://img.shields.io/github/stars/leonkt/zotero-memento) ![GitHub last commit](https://img.shields.io/github/last-commit/leonkt/zotero-memento)](https://github.com/leonkt/zotero-memento).

## Community Resources

### Other Awesome Lists

* [Web Archiving Community ![GitHub Repo Stars](https://img.shields.io/github/stars/ArchiveBox/ArchiveBox) ![GitHub last commit](https://img.shields.io/github/last-commit/ArchiveBox/ArchiveBox)](https://github.com/ArchiveBox/ArchiveBox/wiki/Web-Archiving-Community)
...
* [Dead-Web Index ![GitHub Repo Stars](https://img.shields.io/github/stars/Crawlora-org/dead-web-index-data) ![GitHub last commit](https://img.shields.io/github/last-commit/Crawlora-org/dead-web-index-data)](https://github.com/Crawlora-org/dead-web-index-data) - Reachability labels (alive / blocked / dead) for the top 10 million domains, two probe arms (polite HTTP and a browser TLS fingerprint), 2026. CC BY 4.0, JSONL.
