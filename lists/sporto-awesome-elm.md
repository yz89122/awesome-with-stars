...
* [elm-gql ![GitHub Repo Stars](https://img.shields.io/github/stars/vendrinc/elm-gql) ![GitHub last commit](https://img.shields.io/github/last-commit/vendrinc/elm-gql)](https://github.com/vendrinc/elm-gql) - Generate GraphQl client code from GraphQL queries
...
* [elm-starter ![GitHub Repo Stars](https://img.shields.io/github/stars/lucamug/elm-starter) ![GitHub last commit](https://img.shields.io/github/last-commit/lucamug/elm-starter)](https://github.com/lucamug/elm-starter) - An experimental Elm-based bootstrapper that can also be plugged into already existing Elm applications.
...
* [Elm Format ![GitHub Repo Stars](https://img.shields.io/github/stars/avh4/elm-format) ![GitHub last commit](https://img.shields.io/github/last-commit/avh4/elm-format)](https://github.com/avh4/elm-format) - Automatic Elm code formatter adhering to [Elm Style Guide](https://elm-lang.org/docs/style-guide).
...
* [LSP-elm ![GitHub Repo Stars](https://img.shields.io/github/stars/sublimelsp/LSP-elm) ![GitHub last commit](https://img.shields.io/github/last-commit/sublimelsp/LSP-elm)](https://github.com/sublimelsp/LSP-elm) - Elm Language Server for Sublime (Recommended).
...
* [Flame ![GitHub Repo Stars](https://img.shields.io/github/stars/easafe/purescript-flame) ![GitHub last commit](https://img.shields.io/github/last-commit/easafe/purescript-flame)](https://github.com/easafe/purescript-flame) - A library that provides The Elm Architecture in PureScript.
* [Hyperapp ![GitHub Repo Stars](https://img.shields.io/github/stars/jorgebucaran/hyperapp) ![GitHub last commit](https://img.shields.io/github/last-commit/jorgebucaran/hyperapp)](https://github.com/jorgebucaran/hyperapp) - A library that provide The Elm Architecture in JavaScript.
...
* [Lustre ![GitHub Repo Stars](https://img.shields.io/github/stars/lustre-labs/lustre) ![GitHub last commit](https://img.shields.io/github/last-commit/lustre-labs/lustre)](https://github.com/lustre-labs/lustre) - A library that provides The Elm Architecture in Gleam.
* [Miso ![GitHub Repo Stars](https://img.shields.io/github/stars/dmjio/miso) ![GitHub last commit](https://img.shields.io/github/last-commit/dmjio/miso)](https://github.com/dmjio/miso) - A library that provides The Elm Architecture in Haskell.
* [Mobius ![GitHub Repo Stars](https://img.shields.io/github/stars/spotify/mobius) ![GitHub last commit](https://img.shields.io/github/last-commit/spotify/mobius)](https://github.com/spotify/mobius) - Elm-like abstractions for android apps, created by Spotify.
* [React-tea-cup ![GitHub Repo Stars](https://img.shields.io/github/stars/vankeisb/react-tea-cup) ![GitHub last commit](https://img.shields.io/github/last-commit/vankeisb/react-tea-cup)](https://github.com/vankeisb/react-tea-cup) - A thin library that provides The Elm Architecture in react, used by IBM.
* [Redux](https://redux.js.org/introduction/prior-art) - A predictable state container for JavaScript apps.
* [Roc ![GitHub Repo Stars](https://img.shields.io/github/stars/roc-lang/roc) ![GitHub last commit](https://img.shields.io/github/last-commit/roc-lang/roc)](https://github.com/roc-lang/roc) - A language that targets WebAssembly and machine code inspired by Elm.
* [Sauron ![GitHub Repo Stars](https://img.shields.io/github/stars/ivanceras/sauron) ![GitHub last commit](https://img.shields.io/github/last-commit/ivanceras/sauron)](https://github.com/ivanceras/sauron) - A library that provides The Elm Architecture in Rust targeting the web.
