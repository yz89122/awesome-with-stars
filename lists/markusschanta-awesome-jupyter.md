...
- [JupyterLite ![GitHub Repo Stars](https://img.shields.io/github/stars/jupyterlite/jupyterlite) ![GitHub last commit](https://img.shields.io/github/last-commit/jupyterlite/jupyterlite)](https://github.com/jupyterlite/jupyterlite) - Jupyter distribution that runs entirely in the browser.
...
- [ipygame ![GitHub Repo Stars](https://img.shields.io/github/stars/Kamuyin/ipygame) ![GitHub last commit](https://img.shields.io/github/last-commit/Kamuyin/ipygame)](https://github.com/Kamuyin/ipygame) - A pygame-compatible reimplementation for Jupyter notebooks.
...
- [FlexViz ![GitHub Repo Stars](https://img.shields.io/github/stars/flex-analytics/flexviz) ![GitHub last commit](https://img.shields.io/github/last-commit/flex-analytics/flexviz)](https://github.com/flex-analytics/flexviz) - Interactive cross-filter dashboards for datasets that are too large for the browser.
...
- [K3D-jupyter ![GitHub Repo Stars](https://img.shields.io/github/stars/K3D-tools/K3D-jupyter) ![GitHub last commit](https://img.shields.io/github/last-commit/K3D-tools/K3D-jupyter)](https://github.com/K3D-tools/K3D-jupyter) - WebGL 3D plotting: meshes, isosurfaces, volumes, voxels and point clouds from NumPy arrays.
...
- [torchvista ![GitHub Repo Stars](https://img.shields.io/github/stars/sachinhosmani/torchvista) ![GitHub last commit](https://img.shields.io/github/last-commit/sachinhosmani/torchvista)](https://github.com/sachinhosmani/torchvista) - Interactive tool to visualize the forward pass of PyTorch models as a graph in notebooks.
...
- [buckaroo ![GitHub Repo Stars](https://img.shields.io/github/stars/buckaroo-data/buckaroo) ![GitHub last commit](https://img.shields.io/github/last-commit/buckaroo-data/buckaroo)](https://github.com/buckaroo-data/buckaroo) - GUI Data Wrangling tool for Jupyter and pandas.
...
- [jupyterlab-git ![GitHub Repo Stars](https://img.shields.io/github/stars/jupyterlab/jupyterlab-git) ![GitHub last commit](https://img.shields.io/github/last-commit/jupyterlab/jupyterlab-git)](https://github.com/jupyterlab/jupyterlab-git) - Extension for Git integration.
...
- [devscholar ![GitHub Repo Stars](https://img.shields.io/github/stars/pallaprolus/devscholar-jupyter) ![GitHub last commit](https://img.shields.io/github/last-commit/pallaprolus/devscholar-jupyter)](https://github.com/pallaprolus/devscholar-jupyter) - Hover metadata, PDF preview and BibTeX export for paper references (arXiv, DOI) in notebook cells.
...
- [jupyter-resource-usage ![GitHub Repo Stars](https://img.shields.io/github/stars/jupyter-server/jupyter-resource-usage) ![GitHub last commit](https://img.shields.io/github/last-commit/jupyter-server/jupyter-resource-usage)](https://github.com/jupyter-server/jupyter-resource-usage) - Extension to display system metrics.
...
- [Jupyter Notebook Validator Operator ![GitHub Repo Stars](https://img.shields.io/github/stars/tosin2013/jupyter-notebook-validator-operator) ![GitHub last commit](https://img.shields.io/github/last-commit/tosin2013/jupyter-notebook-validator-operator)](https://github.com/tosin2013/jupyter-notebook-validator-operator) - Kubernetes operator for validation against golden baselines and model endpoints.
...
- [pointblank ![GitHub Repo Stars](https://img.shields.io/github/stars/posit-dev/pointblank) ![GitHub last commit](https://img.shields.io/github/last-commit/posit-dev/pointblank)](https://github.com/posit-dev/pointblank) - Notebook-friendly testing of DataFrames and database tables for data quality purposes.
...
- [jupyter-shopsavvy ![GitHub Repo Stars](https://img.shields.io/github/stars/shopsavvy/jupyter-shopsavvy) ![GitHub last commit](https://img.shields.io/github/last-commit/shopsavvy/jupyter-shopsavvy)](https://github.com/shopsavvy/jupyter-shopsavvy) - Magic commands for product search, price comparison/history charts using the ShopSavvy API.
