...
* [Sublime Text + R-Box ![GitHub Repo Stars](https://img.shields.io/github/stars/randy3k/R-Box) ![GitHub last commit](https://img.shields.io/github/last-commit/randy3k/R-Box)](http://github.com/randy3k/R-Box/) - Add-on package for Sublime Text 2/3.
...
* [Vim-R ![GitHub Repo Stars](https://img.shields.io/github/stars/vim-scripts/Vim-R-plugin) ![GitHub last commit](https://img.shields.io/github/last-commit/vim-scripts/Vim-R-plugin)](https://github.com/vim-scripts/Vim-R-plugin) - Vim plugin for R.
* [Nvim-R ![GitHub Repo Stars](https://img.shields.io/github/stars/jalvesaq/Nvim-R) ![GitHub last commit](https://img.shields.io/github/last-commit/jalvesaq/Nvim-R)](https://github.com/jalvesaq/Nvim-R) - Neovim plugin for R.
...
* [snakecase ![GitHub Repo Stars](https://img.shields.io/github/stars/Tazinho/snakecase) ![GitHub last commit](https://img.shields.io/github/last-commit/Tazinho/snakecase)](https://github.com/Tazinho/snakecase) - Automatically parse and convert strings into cases like snake or camel among others.
...
* [ggtree ![GitHub Repo Stars](https://img.shields.io/github/stars/GuangchuangYu/ggtree) ![GitHub last commit](https://img.shields.io/github/last-commit/GuangchuangYu/ggtree)](https://github.com/GuangchuangYu/ggtree) - Visualization and annotation of phylogenetic tree.
...
* [drake ![GitHub Repo Stars](https://img.shields.io/github/stars/ropensci/drake) ![GitHub last commit](https://img.shields.io/github/last-commit/ropensci/drake)](https://github.com/ropensci/drake) - An [rOpenSci](https://ropensci.org/) package for reproducible data science workflows too big for [knitr](http://yihui.name/knitr/).
...
* [spacetime ![GitHub Repo Stars](https://img.shields.io/github/stars/edzer/spacetime) ![GitHub last commit](https://img.shields.io/github/last-commit/edzer/spacetime)](https://github.com/edzer/spacetime) - R classes and methods for spatio-temporal data.
...
* [packrat ![GitHub Repo Stars](https://img.shields.io/github/stars/rstudio/packrat) ![GitHub last commit](https://img.shields.io/github/last-commit/rstudio/packrat)](https://github.com/rstudio/packrat) - Make your R projects more isolated, portable, and reproducible.
...
* [modules ![GitHub Repo Stars](https://img.shields.io/github/stars/klmr/modules) ![GitHub last commit](https://img.shields.io/github/last-commit/klmr/modules)](https://github.com/klmr/modules) - An alternative (Python style) module system for R.
...
* [RStudio Addins ![GitHub Repo Stars](https://img.shields.io/github/stars/daattali/rstudio-addins) ![GitHub last commit](https://img.shields.io/github/last-commit/daattali/rstudio-addins)](https://github.com/daattali/rstudio-addins) - List of RStudio addins.
...
* [Readings in Applied Data Science ![GitHub Repo Stars](https://img.shields.io/github/stars/hadley/stats337) ![GitHub last commit](https://img.shields.io/github/last-commit/hadley/stats337)](https://github.com/hadley/stats337) - These readings reflect Hadley's personal thoughts about applied data science.
...
* [Books ![GitHub Repo Stars](https://img.shields.io/github/stars/RomanTsegelskyi/rbooks) ![GitHub last commit](https://img.shields.io/github/last-commit/RomanTsegelskyi/rbooks)](https://github.com/RomanTsegelskyi/rbooks) - List of R Books.
* [ggplot2 Extensions](https://ggplot2-exts.github.io/ggiraph.html) - Showcases of ggplot2 extensions.
* [Natural Language Processing <img src="https://assets-cdn.github.com/images/icons/emoji/unicode/1f1e8-1f1f3.png" width="20" heigth="20" align="absmiddle" class="emoji" alt=":cn:"> ![GitHub Repo Stars](https://img.shields.io/github/stars/BZRLC/R-notes) ![GitHub last commit](https://img.shields.io/github/last-commit/BZRLC/R-notes)](https://github.com/BZRLC/R-notes/blob/master/NLP/readme.md) - NLP related resources in R. @Chinese
* [Network Analysis ![GitHub Repo Stars](https://img.shields.io/github/stars/briatte/awesome-network-analysis) ![GitHub last commit](https://img.shields.io/github/last-commit/briatte/awesome-network-analysis)](https://github.com/briatte/awesome-network-analysis) - Network Analysis related resources.
* [Open Data ![GitHub Repo Stars](https://img.shields.io/github/stars/ropensci/opendata) ![GitHub last commit](https://img.shields.io/github/last-commit/ropensci/opendata)](https://github.com/ropensci/opendata) - Using R to obtain, parse, manipulate, create, and share open data.
* [Posts ![GitHub Repo Stars](https://img.shields.io/github/stars/qinwf/awesome-R) ![GitHub last commit](https://img.shields.io/github/last-commit/qinwf/awesome-R)](https://github.com/qinwf/awesome-R/blob/master/misc/posts.md) - Great R blog posts or Rticles.
* [Package Development ![GitHub Repo Stars](https://img.shields.io/github/stars/ropensci/PackageDevelopment) ![GitHub last commit](https://img.shields.io/github/last-commit/ropensci/PackageDevelopment)](https://github.com/ropensci/PackageDevelopment) - R packages to improve package development.
* [R Project Conferences](https://www.r-project.org/conferences.html) -  Information about useR! Conferences and DSC Conferences.
* [RStartHere ![GitHub Repo Stars](https://img.shields.io/github/stars/rstudio/RStartHere) ![GitHub last commit](https://img.shields.io/github/last-commit/rstudio/RStartHere)](https://github.com/rstudio/RStartHere) - A guide to some of the most useful R packages, organized by workflow.
* [RStudio Addins ![GitHub Repo Stars](https://img.shields.io/github/stars/daattali/addinslist) ![GitHub last commit](https://img.shields.io/github/last-commit/daattali/addinslist)](https://github.com/daattali/addinslist) - List of RStudio addins.
* [Topic Models ![GitHub Repo Stars](https://img.shields.io/github/stars/trinker/topicmodels_learning) ![GitHub last commit](https://img.shields.io/github/last-commit/trinker/topicmodels_learning)](https://github.com/trinker/topicmodels_learning) - Topic Models learning and R related resources.
* [Web Technologies ![GitHub Repo Stars](https://img.shields.io/github/stars/ropensci/webservices) ![GitHub last commit](https://img.shields.io/github/last-commit/ropensci/webservices)](https://github.com/ropensci/webservices) - Information about how to use R and the world wide web together.
...
* [fable ![GitHub Repo Stars](https://img.shields.io/github/stars/tidyverts/fable) ![GitHub last commit](https://img.shields.io/github/last-commit/tidyverts/fable)](https://github.com/tidyverts/fable) - univariate and multivariate time series forecasting models ![fable](https://cranlogs.r-pkg.org/badges/fable)
* [r2d3](https://rstudio.github.io/r2d3/) - R Interface to D3 Visualizations ![r2d3](https://cranlogs.r-pkg.org/badges/r2d3)
* [rstats-ed ![GitHub Repo Stars](https://img.shields.io/github/stars/rstudio-education/rstats-ed) ![GitHub last commit](https://img.shields.io/github/last-commit/rstudio-education/rstats-ed)](https://github.com/rstudio-education/rstats-ed) - List of courses teaching R
...
* [tidyverse ![GitHub Repo Stars](https://img.shields.io/github/stars/tidyverse/tidyverse) ![GitHub last commit](https://img.shields.io/github/last-commit/tidyverse/tidyverse)](https://github.com/tidyverse/tidyverse) - Easily install and load packages from the tidyverse
* [purrr ![GitHub Repo Stars](https://img.shields.io/github/stars/tidyverse/purrr) ![GitHub last commit](https://img.shields.io/github/last-commit/tidyverse/purrr)](https://github.com/tidyverse/purrr) - A functional programming toolkit for R
* [hrbrthemes ![GitHub Repo Stars](https://img.shields.io/github/stars/hrbrmstr/hrbrthemes) ![GitHub last commit](https://img.shields.io/github/last-commit/hrbrmstr/hrbrthemes)](https://github.com/hrbrmstr/hrbrthemes) -  🔏 Opinionated, typographic-centric ggplot2 themes and theme components
* [xaringan ![GitHub Repo Stars](https://img.shields.io/github/stars/yihui/xaringan) ![GitHub last commit](https://img.shields.io/github/last-commit/yihui/xaringan)](https://github.com/yihui/xaringan) - Create HTML5 slides with R Markdown and the JavaScript library
* [blogdown ![GitHub Repo Stars](https://img.shields.io/github/stars/rstudio/blogdown) ![GitHub last commit](https://img.shields.io/github/last-commit/rstudio/blogdown)](https://github.com/rstudio/blogdown) - Create Blogs and Websites with R Markdown
* [glue ![GitHub Repo Stars](https://img.shields.io/github/stars/tidyverse/glue) ![GitHub last commit](https://img.shields.io/github/last-commit/tidyverse/glue)](https://github.com/tidyverse/glue) -  Glue strings to data in R. Small, fast, dependency free interpreted string literals.
* [covr ![GitHub Repo Stars](https://img.shields.io/github/stars/jimhester/covr) ![GitHub last commit](https://img.shields.io/github/last-commit/jimhester/covr)](https://github.com/jimhester/covr) - Test coverage reports for R
...
* [reprex ![GitHub Repo Stars](https://img.shields.io/github/stars/jennybc/reprex) ![GitHub last commit](https://img.shields.io/github/last-commit/jennybc/reprex)](https://github.com/jennybc/reprex) - Render bits of R code for sharing, e.g., on GitHub or StackOverflow.
* [reticulate ![GitHub Repo Stars](https://img.shields.io/github/stars/rstudio/reticulate) ![GitHub last commit](https://img.shields.io/github/last-commit/rstudio/reticulate)](https://github.com/rstudio/reticulate) - R Interface to Python
* [tensorflow ![GitHub Repo Stars](https://img.shields.io/github/stars/rstudio/tensorflow) ![GitHub last commit](https://img.shields.io/github/last-commit/rstudio/tensorflow)](https://github.com/rstudio/tensorflow) -  TensorFlow for R
* [utf8 ![GitHub Repo Stars](https://img.shields.io/github/stars/patperry/r-utf8) ![GitHub last commit](https://img.shields.io/github/last-commit/patperry/r-utf8)](https://github.com/patperry/r-utf8) - Manipulating and printing UTF-8 text that fixes multiple bugs in R's UTF-8 handling.
* [Patchwork ![GitHub Repo Stars](https://img.shields.io/github/stars/thomasp85/patchwork) ![GitHub last commit](https://img.shields.io/github/last-commit/thomasp85/patchwork)](https://github.com/thomasp85/patchwork) - Combine separate ggplots into the same graphic.
...
* [awesome-rshiny ![GitHub Repo Stars](https://img.shields.io/github/stars/grabear/awesome-rshiny) ![GitHub last commit](https://img.shields.io/github/last-commit/grabear/awesome-rshiny)](https://github.com/grabear/awesome-rshiny)
