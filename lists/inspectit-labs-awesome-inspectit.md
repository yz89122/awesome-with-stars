...
* [GitHub Repository ![GitHub Repo Stars](https://img.shields.io/github/stars/inspectIT/inspectIT) ![GitHub last commit](https://img.shields.io/github/last-commit/inspectIT/inspectIT)](https://github.com/inspectIT/inspectIT) - inspectIT's source code repository.
...
* [inspectIT Workshop ![GitHub Repo Stars](https://img.shields.io/github/stars/inspectit-labs/workshop) ![GitHub last commit](https://img.shields.io/github/last-commit/inspectit-labs/workshop)](https://github.com/inspectit-labs/workshop) - Hands-on workshop about inspectIT and its setup, configuration and usage.
...
* [ColdFusion Markup Language Profile ![GitHub Repo Stars](https://img.shields.io/github/stars/ghedwards/cfml-inspectIT) ![GitHub last commit](https://img.shields.io/github/last-commit/ghedwards/cfml-inspectIT)](https://github.com/ghedwards/cfml-inspectIT) - Profile for tracking function calls in CFML.

## Uncategorized

* [Sample Application for inspectIT ![GitHub Repo Stars](https://img.shields.io/github/stars/inspectit-labs/spring-petclinic-microservices) ![GitHub last commit](https://img.shields.io/github/last-commit/inspectit-labs/spring-petclinic-microservices)](https://github.com/inspectit-labs/spring-petclinic-microservices) - Sample application for demonstration purposes, based on the Spring Petclinic.
* [Grafana Dashboards for inspectIT ![GitHub Repo Stars](https://img.shields.io/github/stars/inspectit-labs/dashboards) ![GitHub last commit](https://img.shields.io/github/last-commit/inspectit-labs/dashboards)](https://github.com/inspectit-labs/dashboards) - GitHub repository containing Grafana dashboards for visualizing data from inspectIT.
