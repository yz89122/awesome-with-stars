...
- [XNAT](https://www.xnat.org/) - An extensible open-source imaging informatics software platform dedicated to imaging-based research.
  - [DAX ![GitHub Repo Stars](https://img.shields.io/github/stars/VUIIS/dax) ![GitHub last commit](https://img.shields.io/github/last-commit/VUIIS/dax)](https://github.com/VUIIS/dax) - Distributed Automation for XNAT: use containerization w/YAML defined input/output.
...
- [mrQA ![GitHub Repo Stars](https://img.shields.io/github/stars/Open-Minds-Lab/mrQA) ![GitHub last commit](https://img.shields.io/github/last-commit/Open-Minds-Lab/mrQA)](https://github.com/Open-Minds-Lab/mrQA) - Tools for quality assurance in medical imaging datasets, including protocol compliance.
- [bids-validator ![GitHub Repo Stars](https://img.shields.io/github/stars/bids-standard/bids-validator) ![GitHub last commit](https://img.shields.io/github/last-commit/bids-standard/bids-validator)](https://github.com/bids-standard/bids-validator/) - Validator for the Brain Imaging Data Structure.
...
- [HALFpipe ![GitHub Repo Stars](https://img.shields.io/github/stars/HALFpipe/HALFpipe) ![GitHub last commit](https://img.shields.io/github/last-commit/HALFpipe/HALFpipe)](https://github.com/HALFpipe/HALFpipe) - User-friendly software that facilitates reproducible analysis of fMRI data.
...
- [fmri_processing_scripts ![GitHub Repo Stars](https://img.shields.io/github/stars/LabNeuroCogDevel/fmri_processing_scripts) ![GitHub last commit](https://img.shields.io/github/last-commit/LabNeuroCogDevel/fmri_processing_scripts)](https://github.com/LabNeuroCogDevel/fmri_processing_scripts) - Legacy pipeline for maximal preprocessing.
...
- [dcm2niix ![GitHub Repo Stars](https://img.shields.io/github/stars/rordenlab/dcm2niix) ![GitHub last commit](https://img.shields.io/github/last-commit/rordenlab/dcm2niix)](https://github.com/rordenlab/dcm2niix) - DICOM to NIfTI converter.
- [heudiconv ![GitHub Repo Stars](https://img.shields.io/github/stars/nipy/heudiconv) ![GitHub last commit](https://img.shields.io/github/last-commit/nipy/heudiconv)](https://github.com/nipy/heudiconv/) - A flexible DICOM converter for organizing brain imaging data into structured directory layouts.
...
<!--lint ignore double-link-->
- [`dcmdirtab`, `dcmtab_bids`](https://lncd.github.io/lncdtools/BIDS/) - CLI focused, regular expression based, and iteration friendly BIDS conversion pipeline from [lncdtools ![GitHub Repo Stars](https://img.shields.io/github/stars/lncd/lncdtools) ![GitHub last commit](https://img.shields.io/github/last-commit/lncd/lncdtools)](https://github.com/lncd/lncdtools/).
...
- [med2image ![GitHub Repo Stars](https://img.shields.io/github/stars/FNNDSC/med2image) ![GitHub last commit](https://img.shields.io/github/last-commit/FNNDSC/med2image)](https://github.com/FNNDSC/med2image/pulls) - Python CLI tool for generating jpg or png images from DICOM or nifti files.
...
- [datalad ![GitHub Repo Stars](https://img.shields.io/github/stars/datalad/datalad) ![GitHub last commit](https://img.shields.io/github/last-commit/datalad/datalad)](https://github.com/datalad/datalad) - Keep code, data, containers under control with git and git-annex. Esp `datalad run --input=... --output=...`.
...
<!--lint ignore double-link-->
- [`niinote` ![GitHub Repo Stars](https://img.shields.io/github/stars/lncd/lncdtools) ![GitHub last commit](https://img.shields.io/github/last-commit/lncd/lncdtools)](https://github.com/lncd/lncdtools/blob/master/niinote) - Add AFNI nifti XML history to header to run and record any command. Part of [lncdtools ![GitHub Repo Stars](https://img.shields.io/github/stars/lncd/lncdtools) ![GitHub last commit](https://img.shields.io/github/last-commit/lncd/lncdtools)](https://github.com/lncd/lncdtools/).
...
- [lcmodel ![GitHub Repo Stars](https://img.shields.io/github/stars/schorschinho/LCModel) ![GitHub last commit](https://img.shields.io/github/last-commit/schorschinho/LCModel)](https://github.com/schorschinho/LCModel) - Implements linear-combination modeling of magnetic resonance spectroscopy data.
...
- [Osprey ![GitHub Repo Stars](https://img.shields.io/github/stars/schorschinho/osprey) ![GitHub last commit](https://img.shields.io/github/last-commit/schorschinho/osprey)](https://github.com/schorschinho/osprey) - An all-in-one software suite for state-of-the art processing and quantitative analysis of in-vivo magnetic resonance spectroscopy (MRS) data.
...
#### Misc
- [hurst ![GitHub Repo Stars](https://img.shields.io/github/stars/elifesciences-publications/ei_hurst) ![GitHub last commit](https://img.shields.io/github/last-commit/elifesciences-publications/ei_hurst)](https://github.com/elifesciences-publications/ei_hurst/) - Algorithm to assess intrinsic excitation-inhibition imbalance in MR ([Trakoshis et al, eLife, 2020](http://doi.org/10.7554/eLife.55684)).
<!--lint ignore double-link-->
- [tat2](https://lncd.github.io/lncdtools/tat2/) - Time-averaged T2* wrapper script using AFNI binaries from [lncdtools ![GitHub Repo Stars](https://img.shields.io/github/stars/lncd/lncdtools) ![GitHub last commit](https://img.shields.io/github/last-commit/lncd/lncdtools)](https://github.com/lncd/lncdtools/).
...
### R
- [oro.nifti ![GitHub Repo Stars](https://img.shields.io/github/stars/bjw34032/oro.nifti) ![GitHub last commit](https://img.shields.io/github/last-commit/bjw34032/oro.nifti)](https://github.com/bjw34032/oro.nifti) - Functions for the input/output and visualization of medical imaging data that follow either the ANALYZE, NIfTI or AFNI formats.

### MATLAB

<!--lint ignore double-link-->
- [SPM](https://www.fil.ion.ucl.ac.uk/spm/) - Statistical Parametric Mapping refers to the construction and assessment of spatially extended statistical processes used to test hypotheses about functional imaging data.
- [`imtool3D_td` ![GitHub Repo Stars](https://img.shields.io/github/stars/tanguyduval/imtool3D_td) ![GitHub last commit](https://img.shields.io/github/last-commit/tanguyduval/imtool3D_td)](https://github.com/tanguyduval/imtool3D_td) - 3D Image Viewer with ROI tools for Matlab (NIFTI viewer, Manual segmentation).
...
- [Online Neuroimaging Resources ![GitHub Repo Stars](https://img.shields.io/github/stars/Remi-Gau/online_neuroimaging_resources) ![GitHub last commit](https://img.shields.io/github/last-commit/Remi-Gau/online_neuroimaging_resources)](https://github.com/Remi-Gau/online_neuroimaging_resources) - A laundry list of online resources for MRI, fMRI, EEG, MEG.
