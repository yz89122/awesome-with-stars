...
- 💙 [Just-in-time ![GitHub Repo stars](https://img.shields.io/github/stars/tailwindlabs/tailwindcss-jit) ![GitHub last commit](https://img.shields.io/github/last-commit/tailwindlabs/tailwindcss-jit)](https://github.com/tailwindlabs/tailwindcss-jit) - Just-in-time compiler for Tailwind CSS.
...
- 💼 [Gap ![GitHub Repo stars](https://img.shields.io/github/stars/benface/tailwindcss-gap) ![GitHub last commit](https://img.shields.io/github/last-commit/benface/tailwindcss-gap)](https://github.com/benface/tailwindcss-gap) - Adds `gap` utilities.
...
- 💼 [Hyphens ![GitHub Repo stars](https://img.shields.io/github/stars/philippbosch/tailwindcss-hyphens) ![GitHub last commit](https://img.shields.io/github/last-commit/philippbosch/tailwindcss-hyphens)](https://github.com/philippbosch/tailwindcss-hyphens) - Adds `hyphens` utilities.
...
- 🧬 [Alpha ![GitHub Repo stars](https://img.shields.io/github/stars/bradlc/tailwindcss-alpha) ![GitHub last commit](https://img.shields.io/github/last-commit/bradlc/tailwindcss-alpha)](https://github.com/bradlc/tailwindcss-alpha) - Adds alpha color variants.
...
- 🧬 [Marker ![GitHub Repo stars](https://img.shields.io/github/stars/RadishIO/tailwindcss-marker) ![GitHub last commit](https://img.shields.io/github/last-commit/RadishIO/tailwindcss-marker)](https://github.com/RadishIO/tailwindcss-marker) - Provides utilities for styling lists and `<summary>` markers.
...
- 🛑💼 [Caret Color ![GitHub Repo stars](https://img.shields.io/github/stars/GraxMonzo/tailwind-caret-color) ![GitHub last commit](https://img.shields.io/github/last-commit/GraxMonzo/tailwind-caret-color)](https://github.com/GraxMonzo/tailwind-caret-color) - Adds `caret` color utilities.
- 🛑💼 [Caret Color ![GitHub Repo stars](https://img.shields.io/github/stars/naoray/tailwind-caret-color) ![GitHub last commit](https://img.shields.io/github/last-commit/naoray/tailwind-caret-color)](https://github.com/naoray/tailwind-caret-color) - Adds `caret` color utilities.
...
- 🅰 [typed-tailwind ![GitHub Repo stars](https://img.shields.io/github/stars/dvkndn/typed-tailwind) ![GitHub last commit](https://img.shields.io/github/last-commit/dvkndn/typed-tailwind)](https://github.com/dvkndn/typed-tailwind) - TypeScript typings for Tailwind CSS.
...
- 🧩 [Date picker ![GitHub Repo stars](https://img.shields.io/github/stars/kenhyuwa/vue-tailwind-picker) ![GitHub last commit](https://img.shields.io/github/last-commit/kenhyuwa/vue-tailwind-picker)](https://github.com/kenhyuwa/vue-tailwind-picker) - Datepicker component for Vue.js using Tailwind CSS.
...
- 📁 [Resume ![GitHub Repo stars](https://img.shields.io/github/stars/Thomashighbaugh/resume) ![GitHub last commit](https://img.shields.io/github/last-commit/Thomashighbaugh/resume)](https://github.com/Thomashighbaugh/resume) - A stylized resume template built with Tailwind CSS, featuring a nifty hero-pattern background and custom font.
...
- [Statusfy ![GitHub Repo stars](https://img.shields.io/github/stars/bazzite/statusfy) ![GitHub last commit](https://img.shields.io/github/last-commit/bazzite/statusfy)](https://github.com/bazzite/statusfy) - Status page system using Tailwind CSS.
