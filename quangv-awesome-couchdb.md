...
- [Linux tuning for better CouchDB performance ![GitHub Repo stars](https://img.shields.io/github/stars/assafmo/couchdb-linux-performance) ![GitHub last commit](https://img.shields.io/github/last-commit/assafmo/couchdb-linux-performance)](https://github.com/assafmo/couchdb-linux-performance)
...
- [eHealth Africa](https://github.com/eHealthAfrica) - Big user of CouchDB, check out their [best practices ![GitHub Repo stars](https://img.shields.io/github/stars/eHealthAfrica/couchdb-best-practices) ![GitHub last commit](https://img.shields.io/github/last-commit/eHealthAfrica/couchdb-best-practices)](https://github.com/eHealthAfrica/couchdb-best-practices).
