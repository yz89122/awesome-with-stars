...
- [Web Vitals ![GitHub Repo stars](https://img.shields.io/github/stars/GoogleChrome/web-vitals?style=social)](https://github.com/GoogleChrome/web-vitals) - Open Source Library to collect Field Data.
...
- Is it happening? - Did the navigation start successfully? Has the server responded? (e.g [FCP ![GitHub Repo stars](https://img.shields.io/github/stars/csabapalfi/awesome-web-performance-metrics?style=social)](https://github.com/csabapalfi/awesome-web-performance-metrics/#first-contentful-paint-fcp))
- Is it useful/meaningful? - Has enough content rendered that users can engage with it? (e.g. [LCP ![GitHub Repo stars](https://img.shields.io/github/stars/csabapalfi/awesome-web-performance-metrics?style=social)](https://github.com/csabapalfi/awesome-web-performance-metrics/#largest-contentful-paint-lcp))
- Is it usable - Can users interact with the page, or is it still busy loading? (e.g [TBT ![GitHub Repo stars](https://img.shields.io/github/stars/csabapalfi/awesome-web-performance-metrics?style=social)](https://github.com/csabapalfi/awesome-web-performance-metrics/#total-blocking-time-tbt))
...
- [Spec - LCP - W3C ![GitHub Repo stars](https://img.shields.io/github/stars/WICG/largest-contentful-paint?style=social)](https://github.com/WICG/largest-contentful-paint#readme)
...
- [Spec - Layout Instability API - W3C ![GitHub Repo stars](https://img.shields.io/github/stars/WICG/layout-instability?style=social)](https://github.com/WICG/layout-instability)
...
- Lab: WPT
- Field: Chrome 77+
- [Docs - Last Painted Hero - WPT ![GitHub Repo stars](https://img.shields.io/github/stars/WPO-Foundation/webpagetest?style=social)](https://github.com/WPO-Foundation/webpagetest/blob/master/docs/Metrics/HeroElements.md)
...
- [Polyfill - FID ![GitHub Repo stars](https://img.shields.io/github/stars/GoogleChromeLabs/first-input-delay?style=social)](https://github.com/GoogleChromeLabs/first-input-delay)
...
- [Which third party scripts are most excessive ![GitHub Repo stars](https://img.shields.io/github/stars/patrickhulce/third-party-web?style=social)](https://github.com/patrickhulce/third-party-web)
