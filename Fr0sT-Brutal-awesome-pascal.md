...
* [ZenGL ![GitHub Repo stars](https://img.shields.io/github/stars/andru-kun/zengl) ![GitHub last commit](https://img.shields.io/github/last-commit/andru-kun/zengl)](https://github.com/andru-kun/zengl). `[Delphi]` `[FPC]` OpenGL Cross-platform game development library written in Pascal, designed to provide necessary functionality for rendering 2D-graphics, handling input, sound output, etc.
...
* [Castle Game Engine ![GitHub Repo stars](https://img.shields.io/github/stars/castle-engine/castle-engine) ![GitHub last commit](https://img.shields.io/github/last-commit/castle-engine/castle-engine)](https://github.com/castle-engine/castle-engine). `[FPC]` Complete Pascal Game Engine. Cross-platform 3D and 2D game engine with a lot of graphic effects and a scene graph based on X3D.
...
* [TelegAPI ![GitHub Repo stars](https://img.shields.io/github/stars/ms301/TelegAPI) ![GitHub last commit](https://img.shields.io/github/last-commit/ms301/TelegAPI)](https://github.com/ms301/TelegAPI). `[Delphi]` Library for working with Telegram messenger Bot API in Delphi.
...
* [Rest-Dataware-Componentes ![GitHub Repo stars](https://img.shields.io/github/stars/Rest-Dataware/RDW-Componente) ![GitHub last commit](https://img.shields.io/github/last-commit/Rest-Dataware/RDW-Componente)](https://github.com/Rest-Dataware/RDW-Componente). `[Delphi]` `[FPC]` Was created to facilitate the creation of CRUDs in the same model that we created applications for Client / Server Database. With REST DW, you no longer have to worry about creating SQL Insertion, Deletion, Read and Execution methods via Webservice; Simply add a RESTDataBase connection component and add a RESTClientSQL component that will already have your SQL solution fully functional as it did back in the day and with all the power of modern REST / JSON technology with data compression and everything the language can offer.
...
* [ATTabs ![GitHub Repo stars](https://img.shields.io/github/stars/Alexey-T/ATTabs) ![GitHub last commit](https://img.shields.io/github/last-commit/Alexey-T/ATTabs)](https://github.com/Alexey-T/ATTabs). `[Delphi]` `[FPC]` Delphi/Lazarus component for lite tabs. OS independent, fully custom drawn.
...
* [BCEditor ![GitHub Repo stars](https://img.shields.io/github/stars/bonecode/BCEditor) ![GitHub last commit](https://img.shields.io/github/last-commit/bonecode/BCEditor)](https://github.com/bonecode/BCEditor). `[Delphi]` Syntax highlighting edit control with code folding, minimap, external JSON highlighter and color scheme files, etc.
...
* [Dam ![GitHub Repo stars](https://img.shields.io/github/stars/digao-dalpiaz/Dam) ![GitHub last commit](https://img.shields.io/github/last-commit/digao-dalpiaz/Dam)](https://github.com/digao-dalpiaz/Dam). `[Delphi]` Delphi Message Dialogs with Formatted Text.
...
* [HTML parser ![GitHub Repo stars](https://img.shields.io/github/stars/ying32/htmlparser) ![GitHub last commit](https://img.shields.io/github/last-commit/ying32/htmlparser)](https://github.com/ying32/htmlparser). `[Delphi]` HTML parser. Supports Windows, MacOSX, iOS, Android platform. Comments in Chinese
