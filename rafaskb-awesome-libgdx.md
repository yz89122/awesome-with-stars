...
### Controllers
- [Controllers ![GitHub Repo stars](https://img.shields.io/github/stars/libgdx/libgdx) ![GitHub last commit](https://img.shields.io/github/last-commit/libgdx/libgdx)](https://github.com/libgdx/libgdx/wiki/Controllers) - Adds support to gamepads and joysticks.
...
### Physics
- [Box2D ![GitHub Repo stars](https://img.shields.io/github/stars/libgdx/libgdx) ![GitHub last commit](https://img.shields.io/github/last-commit/libgdx/libgdx)](https://github.com/libgdx/libgdx/wiki/Box2d) - One of the most popular physics libraries for 2D games.
- [Bullet ![GitHub Repo stars](https://img.shields.io/github/stars/libgdx/libgdx) ![GitHub last commit](https://img.shields.io/github/last-commit/libgdx/libgdx)](https://github.com/libgdx/libgdx/wiki/Bullet-physics) - 3D Collision Detection and Rigid Body Dynamics Library.
...
- [gdx-liftoff ![GitHub Repo stars](https://img.shields.io/github/stars/tommyettinger/gdx-liftoff) ![GitHub last commit](https://img.shields.io/github/last-commit/tommyettinger/gdx-liftoff)](https://github.com/tommyettinger/gdx-liftoff) - A modern setup tool for libGDX that uses the current Gradle 5.x series.
...
### User Interface
- [Freetype ![GitHub Repo stars](https://img.shields.io/github/stars/libgdx/libgdx) ![GitHub last commit](https://img.shields.io/github/last-commit/libgdx/libgdx)](https://github.com/libgdx/libgdx/wiki/Gdx-freetype) - Generate BitmapFonts of your desired size on the fly from lightweight .ttf font files.
...
- [libgdx-graph ![GitHub Repo stars](https://img.shields.io/github/stars/marcinsc/libgdx-graph) ![GitHub last commit](https://img.shields.io/github/last-commit/marcinsc/libgdx-graph)](https://github.com/marcinsc/libgdx-graph) - Provides a GUI to design your rendering pipeline and shaders, and a library to easily incorporate them into your games. [Guide here](https://www.youtube.com/channel/UCzbGLy819RyOkKb_kmV2kCA) 
...
- [gdx-jnigen ![GitHub Repo stars](https://img.shields.io/github/stars/libgdx/libgdx) ![GitHub last commit](https://img.shields.io/github/last-commit/libgdx/libgdx)](https://github.com/libgdx/libgdx/tree/master/extensions/gdx-jnigen) - Small library that allows C/C++ code to be written inline with Java source code.
...
- [Official libGDX Wiki ![GitHub Repo stars](https://img.shields.io/github/stars/libgdx/libgdx) ![GitHub last commit](https://img.shields.io/github/last-commit/libgdx/libgdx)](https://github.com/libgdx/libgdx/wiki) - Official libGDX wiki that contains a huge amount of information.
...
- [libGDX External Tutorials ![GitHub Repo stars](https://img.shields.io/github/stars/libgdx/libgdx) ![GitHub last commit](https://img.shields.io/github/last-commit/libgdx/libgdx)](https://github.com/libgdx/libgdx/wiki/External-tutorials) - Big list of official unofficial tutorials.
