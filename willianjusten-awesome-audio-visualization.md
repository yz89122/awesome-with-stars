...
- [Cava ![GitHub Repo stars](https://img.shields.io/github/stars/karlstav/cava) ![GitHub last commit](https://img.shields.io/github/last-commit/karlstav/cava)](https://github.com/karlstav/cava#latency-notes) - A cross-platform terminal visualizer. 
...
- [VR Ondes Martenot ![GitHub Repo stars](https://img.shields.io/github/stars/elifer5000/vr-ondes-martenot) ![GitHub last commit](https://img.shields.io/github/last-commit/elifer5000/vr-ondes-martenot)](https://github.com/elifer5000/vr-ondes-martenot) - A playable rendition of the Ondes Martenot in Virtual Reality.
...
- [Weekly Music Visualizations ![GitHub Repo stars](https://img.shields.io/github/stars/surayashivji/WeeklyGraphics) ![GitHub last commit](https://img.shields.io/github/last-commit/surayashivji/WeeklyGraphics)](https://github.com/surayashivji/WeeklyGraphics) Weekly music visualization experiments built with Three.js and p5.js by Suraya Shivji.
- [Audio Visualizer ![GitHub Repo stars](https://img.shields.io/github/stars/Teoxoy/audio-visualizer) ![GitHub last commit](https://img.shields.io/github/last-commit/Teoxoy/audio-visualizer)](https://github.com/Teoxoy/audio-visualizer) - An interesting web audio visualizer built with Pixi.js.
...
- [YouTube Musical Spectrum ![GitHub Repo stars](https://img.shields.io/github/stars/mfcc64/youtube-musical-spectrum) ![GitHub last commit](https://img.shields.io/github/last-commit/mfcc64/youtube-musical-spectrum)](https://github.com/mfcc64/youtube-musical-spectrum) - A browser extension that offers audio visualization on your YouTube page with nice musical notes.
...
- [web-audio-analyser ![GitHub Repo stars](https://img.shields.io/github/stars/hughsk/web-audio-analyser) ![GitHub last commit](https://img.shields.io/github/last-commit/hughsk/web-audio-analyser)](https://github.com/hughsk/web-audio-analyser) - A thin wrapper around the Web Audio API that takes an <audio> element and gives you its waveform/frequency data in return.
- [web-audio-player ![GitHub Repo stars](https://img.shields.io/github/stars/Jam3/web-audio-player) ![GitHub last commit](https://img.shields.io/github/last-commit/Jam3/web-audio-player)](https://github.com/Jam3/web-audio-player) - A cross-browser Web Audio player.
- [web-media-playback ![GitHub Repo stars](https://img.shields.io/github/stars/hughsk/web-media-playback) ![GitHub last commit](https://img.shields.io/github/last-commit/hughsk/web-media-playback)](https://github.com/hughsk/web-media-playback) - Retrieve playback and buffering information about audio or video playing in the browser.
- [Pizzicato.js](https://alemangui.github.io/pizzicato/) - Simplify the way you create and manipulate sounds via the Web Audio API.
- [ThreeAudio.js ![GitHub Repo stars](https://img.shields.io/github/stars/unconed/ThreeAudio.js) ![GitHub last commit](https://img.shields.io/github/last-commit/unconed/ThreeAudio.js)](https://github.com/unconed/ThreeAudio.js) - Helps you create music visualizations in Three.js or tQuery.
- [Beeplay.js](https://watilde.github.io/beeplay/) - Write a song In JavaScript.
- [MIDI.js ![GitHub Repo stars](https://img.shields.io/github/stars/mudcube/MIDI.js) ![GitHub last commit](https://img.shields.io/github/last-commit/mudcube/MIDI.js)](https://github.com/mudcube/MIDI.js/) - Making life easy to create a MIDI-app on the web.
- [Beep.js ![GitHub Repo stars](https://img.shields.io/github/stars/stewdio/beep.js) ![GitHub last commit](https://img.shields.io/github/last-commit/stewdio/beep.js)](https://github.com/stewdio/beep.js) - A JavaScript toolkit for building browser-based synthesizers.
- [p5.sound ![GitHub Repo stars](https://img.shields.io/github/stars/processing/p5.js-sound) ![GitHub last commit](https://img.shields.io/github/last-commit/processing/p5.js-sound)](https://github.com/processing/p5.js-sound) - Brings the Processing approach to Web Audio and p5.js.
...
- [wav ![GitHub Repo stars](https://img.shields.io/github/stars/go-audio/wav) ![GitHub last commit](https://img.shields.io/github/last-commit/go-audio/wav)](https://github.com/go-audio/wav) - Battle tested Wav decoder/encoder
- [standardized-audio-context ![GitHub Repo stars](https://img.shields.io/github/stars/chrisguttandin/standardized-audio-context) ![GitHub last commit](https://img.shields.io/github/last-commit/chrisguttandin/standardized-audio-context)](https://github.com/chrisguttandin/standardized-audio-context) - A cross-browser implementation of the AudioContext which aims to closely follow the standard.
- [web-audio-beat-detector ![GitHub Repo stars](https://img.shields.io/github/stars/chrisguttandin/web-audio-beat-detector) ![GitHub last commit](https://img.shields.io/github/last-commit/chrisguttandin/web-audio-beat-detector)](https://github.com/chrisguttandin/web-audio-beat-detector) - A beat detection utility which is using the Web Audio API.
- [meyda ![GitHub Repo stars](https://img.shields.io/github/stars/meyda/meyda) ![GitHub last commit](https://img.shields.io/github/last-commit/meyda/meyda)](https://github.com/meyda/meyda) - Audio feature extraction for JavaScript.
...
- [Pixi.js ![GitHub Repo stars](https://img.shields.io/github/stars/pixijs/pixi.js) ![GitHub last commit](https://img.shields.io/github/last-commit/pixijs/pixi.js)](https://github.com/pixijs/pixi.js/) - A fast lightweight 2D library that works across all devices. The Pixi renderer allows everyone to enjoy the power of hardware acceleration without prior knowledge of WebGL.
...
- [Web Audio Extension ![GitHub Repo stars](https://img.shields.io/github/stars/spite/WebAudioExtension) ![GitHub last commit](https://img.shields.io/github/last-commit/spite/WebAudioExtension)](https://github.com/spite/WebAudioExtension) - A Chrome extension to play with Web Audio.
...
- [The Force ![GitHub Repo stars](https://img.shields.io/github/stars/shawnlawson/The_Force) ![GitHub last commit](https://img.shields.io/github/last-commit/shawnlawson/The_Force)](https://github.com/shawnlawson/The_Force) - Live coded shader editing with audio input.
- [Hylogen ![GitHub Repo stars](https://img.shields.io/github/stars/sleexyz/hylogen) ![GitHub last commit](https://img.shields.io/github/last-commit/sleexyz/hylogen)](https://github.com/sleexyz/hylogen) - Purely functional language embedded in Haskell for expressive live coding of fragment shaders (with audio input).
...
- [Clubber.js ![GitHub Repo stars](https://img.shields.io/github/stars/wizgrav/clubber) ![GitHub last commit](https://img.shields.io/github/last-commit/wizgrav/clubber)](https://github.com/wizgrav/clubber) - Application of music theory in audio reactive visualizations.
...
- [wavebell ![GitHub Repo stars](https://img.shields.io/github/stars/skylerlee/wavebell) ![GitHub last commit](https://img.shields.io/github/last-commit/skylerlee/wavebell)](https://github.com/skylerlee/wavebell) - A javascript voice recorder with realtime waveform, using web microphone
...
- [Slang ![GitHub Repo stars](https://img.shields.io/github/stars/kylestetz/slang) ![GitHub last commit](https://img.shields.io/github/last-commit/kylestetz/slang)](https://github.com/kylestetz/slang) - An audio programming language built in JS
