...
- [relint ![GitHub Repo stars](https://img.shields.io/github/stars/codingjoe/relint) ![GitHub last commit](https://img.shields.io/github/last-commit/codingjoe/relint)](https://github.com/codingjoe/relint) :warning: - A static file linter that allows you to write custom rules using regular expressions (RegEx).
