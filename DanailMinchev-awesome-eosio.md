...
- [eoscommunity/Eden ![GitHub Repo stars](https://img.shields.io/github/stars/eoscommunity/Eden) ![GitHub last commit](https://img.shields.io/github/last-commit/eoscommunity/Eden)](https://github.com/eoscommunity/Eden)
...
- [Greymass eos voter ![GitHub Repo stars](https://img.shields.io/github/stars/greymass/eos-voter) ![GitHub last commit](https://img.shields.io/github/last-commit/greymass/eos-voter)](https://github.com/greymass/eos-voter)
  - [greymass/eos-voter ![GitHub Repo stars](https://img.shields.io/github/stars/greymass/eos-voter) ![GitHub last commit](https://img.shields.io/github/last-commit/greymass/eos-voter)](https://github.com/greymass/eos-voter) - Official GitHub.
...
- [eosc](https://www.eoscanada.com/en/tools/eosc)
  - [eoscanada/eosc ![GitHub Repo stars](https://img.shields.io/github/stars/eoscanada/eosc) ![GitHub last commit](https://img.shields.io/github/last-commit/eoscanada/eosc)](https://github.com/eoscanada/eosc) - Official GitHub.
...
- [Cypherglass LENS](https://www.cypherglass.com/lens/)
  - [cypherglassdotcom/glasslens ![GitHub Repo stars](https://img.shields.io/github/stars/cypherglassdotcom/glasslens) ![GitHub last commit](https://img.shields.io/github/last-commit/cypherglassdotcom/glasslens)](https://github.com/cypherglassdotcom/glasslens) - Official GitHub.
...
- [EOSIO/eosio-explorer ![GitHub Repo stars](https://img.shields.io/github/stars/EOSIO/eosio-explorer) ![GitHub last commit](https://img.shields.io/github/last-commit/EOSIO/eosio-explorer)](https://github.com/EOSIO/eosio-explorer) - An application providing Web GUI to communicate with EOSIO blockchain in a local development environment.
...
- [EOS Resource Planner](https://www.eosrp.io/) - EOSIO Resource Planner and Calculator.
  - [eosnewyork/erp ![GitHub Repo stars](https://img.shields.io/github/stars/eosnewyork/erp) ![GitHub last commit](https://img.shields.io/github/last-commit/eosnewyork/erp)](https://github.com/eosnewyork/erp) - Official GitHub.
...
- [EOSRPC API Wrapper for Elixir ![GitHub Repo stars](https://img.shields.io/github/stars/BeSpiral/eosrpc-elixir-wrapper) ![GitHub last commit](https://img.shields.io/github/last-commit/BeSpiral/eosrpc-elixir-wrapper)](https://github.com/BeSpiral/eosrpc-elixir-wrapper) - Elixir library.
...
- [EOS Factory](http://eosfactory.io/) - Python-based EOSIO smart-contract development & unit testing framework.
  - [tokenika/eosfactory ![GitHub Repo stars](https://img.shields.io/github/stars/tokenika/eosfactory) ![GitHub last commit](https://img.shields.io/github/last-commit/tokenika/eosfactory)](https://github.com/tokenika/eosfactory) - Official GitHub.
...
- [eos-helm ![GitHub Repo stars](https://img.shields.io/github/stars/activeeos/eos-helm) ![GitHub last commit](https://img.shields.io/github/last-commit/activeeos/eos-helm)](https://github.com/activeeos/eos-helm) - Kubernetes Helm charts for the EOS smart contracts platform.
...
- [Octopus ![GitHub Repo stars](https://img.shields.io/github/stars/quoscient/octopus) ![GitHub last commit](https://img.shields.io/github/last-commit/quoscient/octopus)](https://github.com/quoscient/octopus) - Security Analysis tool for WebAssembly and Blockchain Smart Contracts (BTC/ETH/NEO/EOS).
- [owdin/secure-enclave-keosd ![GitHub Repo stars](https://img.shields.io/github/stars/owdin/secure-enclave-keosd) ![GitHub last commit](https://img.shields.io/github/last-commit/owdin/secure-enclave-keosd)](https://github.com/owdin/secure-enclave-keosd) - EOSIO keosd with Touch ID Secure Enclave.
- [mixbytes/node-eosjs-signature-provider ![GitHub Repo stars](https://img.shields.io/github/stars/mixbytes/node-eosjs-signature-provider) ![GitHub last commit](https://img.shields.io/github/last-commit/mixbytes/node-eosjs-signature-provider)](https://github.com/mixbytes/node-eosjs-signature-provider) - Fast eosjs signature provider implementation for nodejs based on C++ N-API addon.
...
- [EOS Jungle Testnet](http://jungle.cryptolions.io/)
  - [CryptoLions/EOS-Jungle-Testnet ![GitHub Repo stars](https://img.shields.io/github/stars/CryptoLions/EOS-Jungle-Testnet) ![GitHub last commit](https://img.shields.io/github/last-commit/CryptoLions/EOS-Jungle-Testnet)](https://github.com/CryptoLions/EOS-Jungle-Testnet) - Official GitHub.
...
- [BlockMatrixNetwork/eos-bp-failover ![GitHub Repo stars](https://img.shields.io/github/stars/BlockMatrixNetwork/eos-bp-failover) ![GitHub last commit](https://img.shields.io/github/last-commit/BlockMatrixNetwork/eos-bp-failover)](https://github.com/BlockMatrixNetwork/eos-bp-failover) - EOSIO Block Producer Failover Scripts.
...
- [MonsterEOS](https://monstereos.io/)
  - [leordev/monstereos ![GitHub Repo stars](https://img.shields.io/github/stars/leordev/monstereos) ![GitHub last commit](https://img.shields.io/github/last-commit/leordev/monstereos)](https://github.com/leordev/monstereos) - Official GitHub.
...
- [Telos](https://telosfoundation.io/)
  ...
  - [Sqrl ![GitHub Repo stars](https://img.shields.io/github/stars/Telos-Foundation/Sqrl) ![GitHub last commit](https://img.shields.io/github/last-commit/Telos-Foundation/Sqrl)](https://github.com/Telos-Foundation/Sqrl) - Telos Full Wallet & Governance DApp.
