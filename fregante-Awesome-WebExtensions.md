...
- [webextension-polyfill-ts ![GitHub Repo stars](https://img.shields.io/github/stars/Lusito/webextension-polyfill-ts) ![GitHub last commit](https://img.shields.io/github/last-commit/Lusito/webextension-polyfill-ts)](https://github.com/Lusito/webextension-polyfill-ts) - *TypeScript-ready* polyfill to support the standardized promise based API in the `browser` namespace.
