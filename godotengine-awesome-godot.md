...
- [SMRT-Godot ![GitHub Repo stars](https://img.shields.io/github/stars/brunosxs/SMRT-Godot) ![GitHub last commit](https://img.shields.io/github/last-commit/brunosxs/SMRT-Godot)](https://github.com/brunosxs/SMRT-Godot) - A dialog system and editor fairly customizable, a nice fit for story-driven games (Godot 3.x).
...
- [GDGotm ![GitHub Repo stars](https://img.shields.io/github/stars/PlayGotm/GDGotm) ![GitHub last commit](https://img.shields.io/github/last-commit/PlayGotm/GDGotm)](https://github.com/PlayGotm/GDGotm/tree/master/gotm) - GDScript API for [gotm.io](https://gotm.io/).
...
- [Mitigate-IK ![GitHub Repo stars](https://img.shields.io/github/stars/Kylogias/godot-mitigate-ik) ![GitHub last commit](https://img.shields.io/github/last-commit/Kylogias/godot-mitigate-ik)](https://github.com/Kylogias/godot-mitigate-ik) - Mitigates the scaling effects of SkeletonIK.
...
- [Universal Sky ![GitHub Repo stars](https://img.shields.io/github/stars/7leodev/UniversalSky) ![GitHub last commit](https://img.shields.io/github/last-commit/7leodev/UniversalSky)](https://github.com/7leodev/UniversalSky) - Adds a Dynamic Sky and Time of Day.
...
- [gdscript-pp ![GitHub Repo stars](https://img.shields.io/github/stars/nonunknown/gdscript-pp) ![GitHub last commit](https://img.shields.io/github/last-commit/nonunknown/gdscript-pp)](https://github.com/nonunknown/gdscript-pp) - Translates GDScript to GDNative C++ (WIP).
