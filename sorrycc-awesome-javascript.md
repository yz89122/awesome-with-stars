...
* [curl ![GitHub Repo stars](https://img.shields.io/github/stars/cujojs/curl) ![GitHub last commit](https://img.shields.io/github/last-commit/cujojs/curl)](https://github.com/cujojs/curl) - A small, fast, extensible module loader that handles AMD, CommonJS Modules/1.1, CSS, HTML/text, and legacy scripts.
...
* [browserify ![GitHub Repo stars](https://img.shields.io/github/stars/substack/node-browserify) ![GitHub last commit](https://img.shields.io/github/last-commit/substack/node-browserify)](https://github.com/substack/node-browserify) - Browserify lets you require('modules') in the browser by bundling up all of your dependencies.
...
* [handlebars.js ![GitHub Repo stars](https://img.shields.io/github/stars/wycats/handlebars.js) ![GitHub last commit](https://img.shields.io/github/last-commit/wycats/handlebars.js)](https://github.com/wycats/handlebars.js/) - An extension to the Mustache templating language.
...
* [vis ![GitHub Repo stars](https://img.shields.io/github/stars/almende/vis) ![GitHub last commit](https://img.shields.io/github/last-commit/almende/vis)](https://github.com/almende/vis) - Dynamic, browser-based visualization library.
...
* [ramda ![GitHub Repo stars](https://img.shields.io/github/stars/CrossEye/ramda) ![GitHub last commit](https://img.shields.io/github/last-commit/CrossEye/ramda)](https://github.com/CrossEye/ramda) - A practical functional library for JavaScript programmers.
...
* [mesh ![GitHub Repo stars](https://img.shields.io/github/stars/crcn/mesh.js) ![GitHub last commit](https://img.shields.io/github/last-commit/crcn/mesh.js)](https://github.com/crcn/mesh.js) - Streamable data synchronization utility.
...
* [chardin.js ![GitHub Repo stars](https://img.shields.io/github/stars/heelhook/chardin.js) ![GitHub last commit](https://img.shields.io/github/last-commit/heelhook/chardin.js)](https://github.com/heelhook/chardin.js) - Simple overlay instructions for your apps.
* [pageguide ![GitHub Repo stars](https://img.shields.io/github/stars/tracelytics/pageguide) ![GitHub last commit](https://img.shields.io/github/last-commit/tracelytics/pageguide)](https://github.com/tracelytics/pageguide) - An interactive guide for web page elements using jQuery and CSS3.
...
* [unslider ![GitHub Repo stars](https://img.shields.io/github/stars/idiot/unslider) ![GitHub last commit](https://img.shields.io/github/last-commit/idiot/unslider)](https://github.com/idiot/unslider) - The simplest jQuery slider there is.
...
* [awesomplete ![GitHub Repo stars](https://img.shields.io/github/stars/LeaVerou/awesomplete) ![GitHub last commit](https://img.shields.io/github/last-commit/LeaVerou/awesomplete)](https://github.com/LeaVerou/awesomplete) - Ultra lightweight, usable, beautiful autocomplete with zero dependencies. - http://leaverou.github.io/awesomplete
...
* [datedropper ![GitHub Repo stars](https://img.shields.io/github/stars/felicegattuso/datedropper) ![GitHub last commit](https://img.shields.io/github/last-commit/felicegattuso/datedropper)](https://github.com/felicegattuso/datedropper) - datedropper is a jQuery plugin that provides a quick and easy way to manage dates for input fields.
...
* [form ![GitHub Repo stars](https://img.shields.io/github/stars/malsup/form) ![GitHub last commit](https://img.shields.io/github/last-commit/malsup/form)](https://github.com/malsup/form) - jQuery Form Plugin.
 ...
 * [html5media ![GitHub Repo stars](https://img.shields.io/github/stars/etianen/html5media) ![GitHub last commit](https://img.shields.io/github/last-commit/etianen/html5media)](https://github.com/etianen/html5media) - Enables <video> and <audio> tags in all major browsers. <https://html5media.info/>
...
* [impress.js ![GitHub Repo stars](https://img.shields.io/github/stars/impress/impress.js) ![GitHub last commit](https://img.shields.io/github/last-commit/impress/impress.js)](https://github.com/impress/impress.js) - Make Prezi-like presentations with CSS3 transformations/transitions in an HTML document.
...
* [shuffle-images ![GitHub Repo stars](https://img.shields.io/github/stars/peachananr/shuffle-images) ![GitHub last commit](https://img.shields.io/github/last-commit/peachananr/shuffle-images)](https://github.com/peachananr/shuffle-images) - The Simplest Way to shuffle through images in a Creative Way http://www.thepetedesign.com/demos/shuffle-images_demo.html
* [smoothState.js ![GitHub Repo stars](https://img.shields.io/github/stars/miguel-perez/smoothState.js) ![GitHub last commit](https://img.shields.io/github/last-commit/miguel-perez/smoothState.js)](https://github.com/miguel-perez/smoothState.js) - Unobtrusive page transitions with jQuery. http://smoothstate.com/
...
* [survey.js ![GitHub Repo stars](https://img.shields.io/github/stars/surveyjs/surveyjs) ![GitHub last commit](https://img.shields.io/github/last-commit/surveyjs/surveyjs)](https://github.com/surveyjs/surveyjs) - JavaScript Survey Engine. It uses JSON for survey metadata and results. http://surveyjs.org/
* [Array Explorer ![GitHub Repo stars](https://img.shields.io/github/stars/sdras/array-explorer) ![GitHub last commit](https://img.shields.io/github/last-commit/sdras/array-explorer)](https://github.com/sdras/array-explorer) and [Object Explorer](https://sdras.github.io/object-explorer/) - Resources to help figure out what native JavaScript method would be best to use at any given time
