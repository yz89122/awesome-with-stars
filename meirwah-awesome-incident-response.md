...
* [DFIRTrack ![GitHub Repo stars](https://img.shields.io/github/stars/stuhli/dfirtrack) ![GitHub last commit](https://img.shields.io/github/last-commit/stuhli/dfirtrack)](https://github.com/stuhli/dfirtrack) - Incident Response tracking application handling one major incident with a lot of affected systems as it is often observed in APT cases.
