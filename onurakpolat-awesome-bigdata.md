...
A curated list of awesome big data frameworks, resources and other awesomeness. Inspired by [awesome-php ![GitHub Repo stars](https://img.shields.io/github/stars/ziadoz/awesome-php) ![GitHub last commit](https://img.shields.io/github/last-commit/ziadoz/awesome-php)](https://github.com/ziadoz/awesome-php), [awesome-python ![GitHub Repo stars](https://img.shields.io/github/stars/vinta/awesome-python) ![GitHub last commit](https://img.shields.io/github/last-commit/vinta/awesome-python)](https://github.com/vinta/awesome-python), [awesome-ruby ![GitHub Repo stars](https://img.shields.io/github/stars/Sdogruyol/awesome-ruby) ![GitHub last commit](https://img.shields.io/github/last-commit/Sdogruyol/awesome-ruby)](https://github.com/Sdogruyol/awesome-ruby), [hadoopecosystemtable](http://hadoopecosystemtable.github.io/) & [big-data](http://usefulstuff.io/big-data/).
...
* [Bistro ![GitHub Repo stars](https://img.shields.io/github/stars/facebook/bistro) ![GitHub last commit](https://img.shields.io/github/last-commit/facebook/bistro)](https://github.com/facebook/bistro) - general-purpose data processing engine for both batch and stream analytics. It is based on a novel data model, which represents data via *functions* and processes data via *column operations* as opposed to having only set operations in conventional approaches like MapReduce or SQL.
...
* [Tigon ![GitHub Repo stars](https://img.shields.io/github/stars/caskdata/tigon) ![GitHub last commit](https://img.shields.io/github/last-commit/caskdata/tigon)](https://github.com/caskdata/tigon) - High Throughput Real-time Stream Processing Framework.
...
* [Smooks ![GitHub Repo stars](https://img.shields.io/github/stars/smooks/smooks) ![GitHub last commit](https://img.shields.io/github/last-commit/smooks/smooks)](https://github.com/smooks/smooks) - An extensible Java framework for building XML and non-XML (CSV, EDI, Java, etc...) streaming applications.

## Distributed Programming

* [AddThis Hydra ![GitHub Repo stars](https://img.shields.io/github/stars/addthis/hydra) ![GitHub last commit](https://img.shields.io/github/last-commit/addthis/hydra)](https://github.com/addthis/hydra) - distributed data processing and storage system originally developed at AddThis.
...
* [Damballa Parkour ![GitHub Repo stars](https://img.shields.io/github/stars/damballa/parkour) ![GitHub last commit](https://img.shields.io/github/last-commit/damballa/parkour)](https://github.com/damballa/parkour) - MapReduce library for Clojure.
* [Datasalt Pangool ![GitHub Repo stars](https://img.shields.io/github/stars/datasalt/pangool) ![GitHub last commit](https://img.shields.io/github/last-commit/datasalt/pangool)](https://github.com/datasalt/pangool) - alternative MapReduce paradigm.
...
* [Netflix PigPen ![GitHub Repo stars](https://img.shields.io/github/stars/Netflix/PigPen) ![GitHub last commit](https://img.shields.io/github/last-commit/Netflix/PigPen)](https://github.com/Netflix/PigPen) - map-reduce for Clojure which compiles to Apache Pig.
...
* [Ray ![GitHub Repo stars](https://img.shields.io/github/stars/ray-project/ray) ![GitHub last commit](https://img.shields.io/github/last-commit/ray-project/ray)](https://github.com/ray-project/ray) - A fast and simple framework for building and running distributed applications. 
* [Rackerlabs Blueflood](http://blueflood.io/) - multi-tenant distributed metric processing system
* [Skale ![GitHub Repo stars](https://img.shields.io/github/stars/skale-me/skale-engine) ![GitHub last commit](https://img.shields.io/github/last-commit/skale-me/skale-engine)](https://github.com/skale-me/skale-engine) - High performance distributed data processing in NodeJS.
...
* [streamsx.topology ![GitHub Repo stars](https://img.shields.io/github/stars/IBMStreams/streamsx.topology) ![GitHub last commit](https://img.shields.io/github/last-commit/IBMStreams/streamsx.topology)](https://github.com/IBMStreams/streamsx.topology) - Libraries to enable building IBM Streams application in Java, Python or Scala.
* [Tuktu ![GitHub Repo stars](https://img.shields.io/github/stars/UnderstandLingBV/Tuktu) ![GitHub last commit](https://img.shields.io/github/last-commit/UnderstandLingBV/Tuktu)](https://github.com/UnderstandLingBV/Tuktu) - Easy-to-use platform for batch and streaming computation, built using Scala, Akka and Play!
* [Twitter Heron ![GitHub Repo stars](https://img.shields.io/github/stars/twitter/heron) ![GitHub last commit](https://img.shields.io/github/last-commit/twitter/heron)](https://github.com/twitter/heron) - Heron is a realtime, distributed, fault-tolerant stream processing engine from Twitter replacing Storm.
* [Twitter Scalding ![GitHub Repo stars](https://img.shields.io/github/stars/twitter/scalding) ![GitHub last commit](https://img.shields.io/github/last-commit/twitter/scalding)](https://github.com/twitter/scalding) - Scala library for Map Reduce jobs, built on Cascading.
* [Twitter Summingbird ![GitHub Repo stars](https://img.shields.io/github/stars/twitter/summingbird) ![GitHub last commit](https://img.shields.io/github/last-commit/twitter/summingbird)](https://github.com/twitter/summingbird) - Streaming MapReduce with Scalding and Storm, by Twitter.
...
* [Ambry ![GitHub Repo stars](https://img.shields.io/github/stars/linkedin/ambry) ![GitHub last commit](https://img.shields.io/github/last-commit/linkedin/ambry)](https://github.com/linkedin/ambry) - a distributed object store that supports storage of trillion of small immutable objects as well as billions of large objects.
...
* [Seaweed-FS ![GitHub Repo stars](https://img.shields.io/github/stars/chrislusf/seaweedfs) ![GitHub last commit](https://img.shields.io/github/last-commit/chrislusf/seaweedfs)](https://github.com/chrislusf/seaweedfs) - simple and highly scalable distributed file system.
...
* [Baidu File System ![GitHub Repo stars](https://img.shields.io/github/stars/baidu/bfs) ![GitHub last commit](https://img.shields.io/github/last-commit/baidu/bfs)](https://github.com/baidu/bfs) - distributed filesystem.
...
* [Baidu Tera ![GitHub Repo stars](https://img.shields.io/github/stars/baidu/tera) ![GitHub last commit](https://img.shields.io/github/last-commit/baidu/tera)](https://github.com/baidu/tera) - an Internet-scale database, inspired by BigTable.
...
* [InfiniDB ![GitHub Repo stars](https://img.shields.io/github/stars/infinidb/infinidb) ![GitHub last commit](https://img.shields.io/github/last-commit/infinidb/infinidb)](https://github.com/infinidb/infinidb/) - is accessed through a MySQL interface and use massive parallel processing to parallelize queries.
* [Tephra ![GitHub Repo stars](https://img.shields.io/github/stars/caskdata/tephra) ![GitHub last commit](https://img.shields.io/github/last-commit/caskdata/tephra)](https://github.com/caskdata/tephra) - Transactions for HBase.
...
* [Bolt ![GitHub Repo stars](https://img.shields.io/github/stars/boltdb/bolt) ![GitHub last commit](https://img.shields.io/github/last-commit/boltdb/bolt)](https://github.com/boltdb/bolt) - an embedded key-value database for Go.
* [BTDB ![GitHub Repo stars](https://img.shields.io/github/stars/Bobris/BTDB) ![GitHub last commit](https://img.shields.io/github/last-commit/Bobris/BTDB)](https://github.com/Bobris/BTDB) - Key Value Database in .Net with Object DB Layer, RPC, dynamic IL and much more
* [BuntDB ![GitHub Repo stars](https://img.shields.io/github/stars/tidwall/buntdb) ![GitHub last commit](https://img.shields.io/github/last-commit/tidwall/buntdb)](https://github.com/tidwall/buntdb) - a fast, embeddable, in-memory key/value database for Go with custom indexing and geospatial support.
* [Edis ![GitHub Repo stars](https://img.shields.io/github/stars/cbd/edis) ![GitHub last commit](https://img.shields.io/github/last-commit/cbd/edis)](https://github.com/cbd/edis) - is a protocol-compatible Server replacement for Redis.
* [ElephantDB ![GitHub Repo stars](https://img.shields.io/github/stars/nathanmarz/elephantdb) ![GitHub last commit](https://img.shields.io/github/last-commit/nathanmarz/elephantdb)](https://github.com/nathanmarz/elephantdb) - Distributed database specialized in exporting data from Hadoop.
* [EventStore](https://geteventstore.com/) - distributed time series database.
* [GhostDB ![GitHub Repo stars](https://img.shields.io/github/stars/jakekgrog/GhostDB) ![GitHub last commit](https://img.shields.io/github/last-commit/jakekgrog/GhostDB)](https://github.com/jakekgrog/GhostDB) - a distributed, in-memory, general purpose key-value data store that delivers microsecond performance at any scale.
* [Graviton ![GitHub Repo stars](https://img.shields.io/github/stars/deroproject/graviton) ![GitHub last commit](https://img.shields.io/github/last-commit/deroproject/graviton)](https://github.com/deroproject/graviton) - a simple, fast, versioned, authenticated, embeddable key-value store database in pure Go(lang).
* [GridDB ![GitHub Repo stars](https://img.shields.io/github/stars/griddb/griddb_nosql) ![GitHub last commit](https://img.shields.io/github/last-commit/griddb/griddb_nosql)](https://github.com/griddb/griddb_nosql) - suitable for sensor data stored in a timeseries.
* [HyperDex ![GitHub Repo stars](https://img.shields.io/github/stars/rescrv/HyperDex) ![GitHub last commit](https://img.shields.io/github/last-commit/rescrv/HyperDex)](https://github.com/rescrv/HyperDex) - a scalable, next generation key-value and document store with a wide array of features, including consistency, fault tolerance and high performance.
...
* [LinkedIn Krati ![GitHub Repo stars](https://img.shields.io/github/stars/linkedin-sna/sna-page) ![GitHub last commit](https://img.shields.io/github/last-commit/linkedin-sna/sna-page)](https://github.com/linkedin-sna/sna-page/tree/master/krati) - is a simple persistent data store with very low latency and high throughput.
...
* [Riak ![GitHub Repo stars](https://img.shields.io/github/stars/basho/riak) ![GitHub last commit](https://img.shields.io/github/last-commit/basho/riak)](https://github.com/basho/riak) - a decentralized datastore.
* [Storehaus ![GitHub Repo stars](https://img.shields.io/github/stars/twitter/storehaus) ![GitHub last commit](https://img.shields.io/github/last-commit/twitter/storehaus)](https://github.com/twitter/storehaus) - library to work with asynchronous key value stores, by Twitter.
* [SummitDB ![GitHub Repo stars](https://img.shields.io/github/stars/tidwall/summitdb) ![GitHub last commit](https://img.shields.io/github/last-commit/tidwall/summitdb)](https://github.com/tidwall/summitdb) - an in-memory, NoSQL key/value database, with disk persistance and using the Raft consensus algorithm.
* [Tarantool ![GitHub Repo stars](https://img.shields.io/github/stars/tarantool/tarantool) ![GitHub last commit](https://img.shields.io/github/last-commit/tarantool/tarantool)](https://github.com/tarantool/tarantool) - an efficient NoSQL database and a Lua application server.
* [TiKV ![GitHub Repo stars](https://img.shields.io/github/stars/pingcap/tikv) ![GitHub last commit](https://img.shields.io/github/last-commit/pingcap/tikv)](https://github.com/pingcap/tikv) - a distributed key-value database powered by Rust and inspired by Google Spanner and HBase.
* [Tile38 ![GitHub Repo stars](https://img.shields.io/github/stars/tidwall/tile38) ![GitHub last commit](https://img.shields.io/github/last-commit/tidwall/tile38)](https://github.com/tidwall/tile38) - a geolocation data store, spatial index, and realtime geofence, supporting a variety of object types including latitude/longitude points, bounding boxes, XYZ tiles, Geohashes, and GeoJSON
* [TreodeDB ![GitHub Repo stars](https://img.shields.io/github/stars/Treode/store) ![GitHub last commit](https://img.shields.io/github/last-commit/Treode/store)](https://github.com/Treode/store) - key-value store that's replicated and sharded and provides atomic multirow writes.
...
* [DGraph ![GitHub Repo stars](https://img.shields.io/github/stars/dgraph-io/dgraph) ![GitHub last commit](https://img.shields.io/github/last-commit/dgraph-io/dgraph)](https://github.com/dgraph-io/dgraph) - A scalable, distributed, low latency, high throughput graph database aimed at providing Google production level scale and throughput, with low enough latency to be serving real time user queries, over terabytes of structured data.
* [EliasDB ![GitHub Repo stars](https://img.shields.io/github/stars/krotik/eliasdb) ![GitHub last commit](https://img.shields.io/github/last-commit/krotik/eliasdb)](https://github.com/krotik/eliasdb) - a lightweight graph based database that does not require any third-party libraries.
...
* [GCHQ Gaffer ![GitHub Repo stars](https://img.shields.io/github/stars/gchq/Gaffer) ![GitHub last commit](https://img.shields.io/github/last-commit/gchq/Gaffer)](https://github.com/gchq/Gaffer) - Gaffer by GCHQ is a framework that makes it easy to store large-scale graphs in which the nodes and edges have statistics.
* [Google Cayley ![GitHub Repo stars](https://img.shields.io/github/stars/cayleygraph/cayley) ![GitHub last commit](https://img.shields.io/github/last-commit/cayleygraph/cayley)](https://github.com/cayleygraph/cayley) - open-source graph database.
...
* [Gremlin ![GitHub Repo stars](https://img.shields.io/github/stars/tinkerpop/gremlin) ![GitHub last commit](https://img.shields.io/github/last-commit/tinkerpop/gremlin)](https://github.com/tinkerpop/gremlin) - graph traversal Language.
* [Infovore ![GitHub Repo stars](https://img.shields.io/github/stars/paulhoule/infovore) ![GitHub last commit](https://img.shields.io/github/last-commit/paulhoule/infovore)](https://github.com/paulhoule/infovore) - RDF-centric Map/Reduce framework.
...
* [Microsoft Graph Engine ![GitHub Repo stars](https://img.shields.io/github/stars/Microsoft/GraphEngine) ![GitHub last commit](https://img.shields.io/github/last-commit/Microsoft/GraphEngine)](https://github.com/Microsoft/GraphEngine) - a distributed in-memory data processing engine, underpinned by a strongly-typed in-memory key-value store and a general distributed computation engine.
* [Neo4j](https://neo4j.com/) - graph database written entirely in Java.
* [OrientDB](http://orientdb.com/) - document and graph database.
* [Phoebus ![GitHub Repo stars](https://img.shields.io/github/stars/xslogic/phoebus) ![GitHub last commit](https://img.shields.io/github/last-commit/xslogic/phoebus)](https://github.com/xslogic/phoebus) - framework for large scale graph processing.
* [Titan](http://thinkaurelius.github.io/titan/) - distributed graph database, built over Cassandra.
* [Twitter FlockDB ![GitHub Repo stars](https://img.shields.io/github/stars/twitter-archive/flockdb) ![GitHub last commit](https://img.shields.io/github/last-commit/twitter-archive/flockdb)](https://github.com/twitter-archive/flockdb) - distributed graph database.
...
* [IndexR ![GitHub Repo stars](https://img.shields.io/github/stars/shunfei/indexr) ![GitHub last commit](https://img.shields.io/github/last-commit/shunfei/indexr)](https://github.com/shunfei/indexr) - an open-source columnar storage format for fast & realtime analytic with big data.
* [LocustDB ![GitHub Repo stars](https://img.shields.io/github/stars/cswinter/LocustDB) ![GitHub last commit](https://img.shields.io/github/last-commit/cswinter/LocustDB)](https://github.com/cswinter/LocustDB) - an experimental analytics database aiming to set a new standard for query performance on commodity hardware. 
...
* [ActorDB ![GitHub Repo stars](https://img.shields.io/github/stars/biokoda/actordb) ![GitHub last commit](https://img.shields.io/github/last-commit/biokoda/actordb)](https://github.com/biokoda/actordb) - a distributed SQL database with the scalability of a KV store, while keeping the query capabilities of a relational database.
* [Amazon RedShift](http://aws.amazon.com/redshift/) - data warehouse service, based on PostgreSQL.
* [BayesDB ![GitHub Repo stars](https://img.shields.io/github/stars/probcomp/BayesDB) ![GitHub last commit](https://img.shields.io/github/last-commit/probcomp/BayesDB)](https://github.com/probcomp/BayesDB) - statistic oriented SQL database.
...
* [Comdb2 ![GitHub Repo stars](https://img.shields.io/github/stars/bloomberg/comdb2) ![GitHub last commit](https://img.shields.io/github/last-commit/bloomberg/comdb2)](https://github.com/bloomberg/comdb2) - a clustered RDBMS built on optimistic concurrency control techniques.
...
* [Haeinsa ![GitHub Repo stars](https://img.shields.io/github/stars/VCNC/haeinsa) ![GitHub last commit](https://img.shields.io/github/last-commit/VCNC/haeinsa)](https://github.com/VCNC/haeinsa) - linearly scalable multi-row, multi-table transaction library for HBase based on Percolator.
...
* [KarelDB ![GitHub Repo stars](https://img.shields.io/github/stars/rayokota/kareldb) ![GitHub last commit](https://img.shields.io/github/last-commit/rayokota/kareldb)](https://github.com/rayokota/kareldb) - a relational database backed by Apache Kafka.
...
* [yugabyteDB ![GitHub Repo stars](https://img.shields.io/github/stars/YugaByte/yugabyte-db) ![GitHub last commit](https://img.shields.io/github/last-commit/YugaByte/yugabyte-db)](https://github.com/YugaByte/yugabyte-db) - open source, high-performance, distributed SQL database compatible with PostgreSQL.
...
* [Kairosdb ![GitHub Repo stars](https://img.shields.io/github/stars/kairosdb/kairosdb) ![GitHub last commit](https://img.shields.io/github/last-commit/kairosdb/kairosdb)](https://github.com/kairosdb/kairosdb) - similar to OpenTSDB but allows for Cassandra.
...
* [TDengine ![GitHub Repo stars](https://img.shields.io/github/stars/taosdata/TDengine) ![GitHub last commit](https://img.shields.io/github/last-commit/taosdata/TDengine)](https://github.com/taosdata/TDengine/) - a time series database in C utilizing unique features of IoT to improve read/write throughput and reduce space needed to store data
...
* [Beringei ![GitHub Repo stars](https://img.shields.io/github/stars/facebookincubator/beringei) ![GitHub last commit](https://img.shields.io/github/last-commit/facebookincubator/beringei)](https://github.com/facebookincubator/beringei) - Facebook's in-memory time-series database.
* [TrailDB](http://traildb.io/) - an efficient tool for storing and querying series of events.
* [Druid ![GitHub Repo stars](https://img.shields.io/github/stars/druid-io/druid) ![GitHub last commit](https://img.shields.io/github/last-commit/druid-io/druid)](https://github.com/druid-io/druid/) Column oriented distributed data store ideal for powering interactive applications
...
* [SiriDB ![GitHub Repo stars](https://img.shields.io/github/stars/transceptor-technology/siridb-server) ![GitHub last commit](https://img.shields.io/github/last-commit/transceptor-technology/siridb-server)](https://github.com/transceptor-technology/siridb-server) Highly-scalable, robust and fast, open source time series database with cluster functionality.
* [Thanos ![GitHub Repo stars](https://img.shields.io/github/stars/improbable-eng/thanos) ![GitHub last commit](https://img.shields.io/github/last-commit/improbable-eng/thanos)](https://github.com/improbable-eng/thanos) - Thanos is a set of components to create a highly available metric system with unlimited storage capacity using multiple (existing) Prometheus deployments.
* [VictoriaMetrics ![GitHub Repo stars](https://img.shields.io/github/stars/VictoriaMetrics/VictoriaMetrics) ![GitHub last commit](https://img.shields.io/github/last-commit/VictoriaMetrics/VictoriaMetrics)](https://github.com/VictoriaMetrics/VictoriaMetrics) - fast, scalable and resource-effective open-source TSDB compatible with Prometheus. Single-node and cluster versions included
...
* [Materialize ![GitHub Repo stars](https://img.shields.io/github/stars/materializeinc/materialize) ![GitHub last commit](https://img.shields.io/github/last-commit/materializeinc/materialize)](https://github.com/materializeinc/materialize) - is a streaming database for real-time applications using SQL for queries and supporting a large fraction of PostgreSQL.
...
* [Spark Catalyst ![GitHub Repo stars](https://img.shields.io/github/stars/apache/spark) ![GitHub last commit](https://img.shields.io/github/last-commit/apache/spark)](https://github.com/apache/spark/tree/master/sql) - is a Query Optimization Framework for Spark and Shark.
...
* [Apache Pulsar ![GitHub Repo stars](https://img.shields.io/github/stars/apache/pulsar) ![GitHub last commit](https://img.shields.io/github/last-commit/apache/pulsar)](https://github.com/apache/pulsar) - a distributed pub-sub messaging platform with a very flexible messaging model and an intuitive client API.
...
* [Facebook Scribe ![GitHub Repo stars](https://img.shields.io/github/stars/facebookarchive/scribe) ![GitHub last commit](https://img.shields.io/github/last-commit/facebookarchive/scribe)](https://github.com/facebookarchive/scribe) - streamed log data aggregator.
* [Fluentd](http://www.fluentd.org) - tool to collect events and logs.
* [Gazette ![GitHub Repo stars](https://img.shields.io/github/stars/gazette/core) ![GitHub last commit](https://img.shields.io/github/last-commit/gazette/core)](https://github.com/gazette/core) - Distributed streaming infrastructure built on cloud storage which makes it easy to mix and match batch and streaming paradigms.
...
* [Heka ![GitHub Repo stars](https://img.shields.io/github/stars/mozilla-services/heka) ![GitHub last commit](https://img.shields.io/github/last-commit/mozilla-services/heka)](https://github.com/mozilla-services/heka) - open source stream processing software system.
* [HIHO ![GitHub Repo stars](https://img.shields.io/github/stars/sonalgoyal/hiho) ![GitHub last commit](https://img.shields.io/github/last-commit/sonalgoyal/hiho)](https://github.com/sonalgoyal/hiho) - framework for connecting disparate data sources with Hadoop.
* [Kestrel ![GitHub Repo stars](https://img.shields.io/github/stars/papertrail/kestrel) ![GitHub last commit](https://img.shields.io/github/last-commit/papertrail/kestrel)](https://github.com/papertrail/kestrel) - distributed message queue system.
* [LinkedIn Databus](https://engineering.linkedin.com/data) - stream of change capture events for a database.
* [LinkedIn Kamikaze ![GitHub Repo stars](https://img.shields.io/github/stars/linkedin/kamikaze) ![GitHub last commit](https://img.shields.io/github/last-commit/linkedin/kamikaze)](https://github.com/linkedin/kamikaze) - utility package for compressing sorted integer arrays.
* [LinkedIn White Elephant ![GitHub Repo stars](https://img.shields.io/github/stars/linkedin/white-elephant) ![GitHub last commit](https://img.shields.io/github/last-commit/linkedin/white-elephant)](https://github.com/linkedin/white-elephant) - log aggregator and dashboard.
* [Logstash](https://www.elastic.co/products/logstash) - a tool for managing events and logs.
* [Netflix Suro ![GitHub Repo stars](https://img.shields.io/github/stars/Netflix/suro) ![GitHub last commit](https://img.shields.io/github/last-commit/Netflix/suro)](https://github.com/Netflix/suro) - log agregattor like Storm and Samza based on Chukwa.
* [Pinterest Secor ![GitHub Repo stars](https://img.shields.io/github/stars/pinterest/secor) ![GitHub last commit](https://img.shields.io/github/last-commit/pinterest/secor)](https://github.com/pinterest/secor) - is a service implementing Kafka log persistance.
* [Linkedin Gobblin ![GitHub Repo stars](https://img.shields.io/github/stars/linkedin/gobblin) ![GitHub last commit](https://img.shields.io/github/last-commit/linkedin/gobblin)](https://github.com/linkedin/gobblin) - linkedin's universal data ingestion framework.
* [Skizze ![GitHub Repo stars](https://img.shields.io/github/stars/skizzehq/skizze) ![GitHub last commit](https://img.shields.io/github/last-commit/skizzehq/skizze)](https://github.com/skizzehq/skizze) - sketch data store to deal with all problems around counting and sketching using probabilistic data-structures.
* [StreamSets Data Collector ![GitHub Repo stars](https://img.shields.io/github/stars/streamsets/datacollector) ![GitHub last commit](https://img.shields.io/github/last-commit/streamsets/datacollector)](https://github.com/streamsets/datacollector) - continuous big data ingest infrastructure with a simple to use IDE.
...
* [Mara ![GitHub Repo stars](https://img.shields.io/github/stars/mara/data-integration) ![GitHub last commit](https://img.shields.io/github/last-commit/mara/data-integration)](https://github.com/mara/data-integration) - A lightweight opinionated ETL framework, halfway between plain scripts and Apache Airflow
...
* [Spotify Luigi ![GitHub Repo stars](https://img.shields.io/github/stars/spotify/luigi) ![GitHub last commit](https://img.shields.io/github/last-commit/spotify/luigi)](https://github.com/spotify/luigi) - a Python package for building complex pipelines of batch jobs. It handles dependency resolution, workflow management, visualization, handling failures, command line integration, and much more.
* [Spring XD ![GitHub Repo stars](https://img.shields.io/github/stars/spring-projects/spring-xd) ![GitHub last commit](https://img.shields.io/github/last-commit/spring-projects/spring-xd)](https://github.com/spring-projects/spring-xd) - distributed and extensible system for data ingestion, real time analytics, batch processing, and data export.
* [Twitter Elephant Bird ![GitHub Repo stars](https://img.shields.io/github/stars/twitter/elephant-bird) ![GitHub last commit](https://img.shields.io/github/last-commit/twitter/elephant-bird)](https://github.com/twitter/elephant-bird) - libraries for working with LZOP-compressed data.
* [Twitter Finagle](https://twitter.github.io/finagle/) - asynchronous network stack for the JVM.

## Scheduling

* [Apache Airflow ![GitHub Repo stars](https://img.shields.io/github/stars/apache/incubator-airflow) ![GitHub last commit](https://img.shields.io/github/last-commit/apache/incubator-airflow)](https://github.com/apache/incubator-airflow) - a platform to programmatically author, schedule and monitor workflows.
...
* [Cronicle ![GitHub Repo stars](https://img.shields.io/github/stars/jhuckaby/Cronicle) ![GitHub last commit](https://img.shields.io/github/last-commit/jhuckaby/Cronicle)](https://github.com/jhuckaby/Cronicle) - Distributed, easy to install, NodeJS based, task scheduler
* [Dagster ![GitHub Repo stars](https://img.shields.io/github/stars/dagster-io/dagster) ![GitHub last commit](https://img.shields.io/github/last-commit/dagster-io/dagster)](https://github.com/dagster-io/dagster) - a data orchestrator for machine learning, analytics, and ETL.
* [Linkedin Azkaban](https://azkaban.github.io/) - batch workflow job scheduler.
* [Schedoscope ![GitHub Repo stars](https://img.shields.io/github/stars/ottogroup/schedoscope) ![GitHub last commit](https://img.shields.io/github/last-commit/ottogroup/schedoscope)](https://github.com/ottogroup/schedoscope) - Scala DSL for agile scheduling of Hadoop jobs.
* [Sparrow ![GitHub Repo stars](https://img.shields.io/github/stars/radlab/sparrow) ![GitHub last commit](https://img.shields.io/github/last-commit/radlab/sparrow)](https://github.com/radlab/sparrow) - scheduling platform.


## Machine Learning

* [Azure ML Studio](https://studio.azureml.net/) - Cloud-based AzureML, R, Python Machine Learning platform
* [brain ![GitHub Repo stars](https://img.shields.io/github/stars/harthur/brain) ![GitHub last commit](https://img.shields.io/github/last-commit/harthur/brain)](https://github.com/harthur/brain) - Neural networks in JavaScript.
* [Oryx ![GitHub Repo stars](https://img.shields.io/github/stars/OryxProject/oryx) ![GitHub last commit](https://img.shields.io/github/last-commit/OryxProject/oryx)](https://github.com/OryxProject/oryx) - Lambda architecture on Apache Spark, Apache Kafka for real-time large scale machine learning.
...
* [DataVec ![GitHub Repo stars](https://img.shields.io/github/stars/deeplearning4j/DataVec) ![GitHub last commit](https://img.shields.io/github/last-commit/deeplearning4j/DataVec)](https://github.com/deeplearning4j/DataVec) - A vectorization and data preprocessing library for deep learning in Java and Scala. Part of the Deeplearning4j ecosystem. 
...
* [Decider ![GitHub Repo stars](https://img.shields.io/github/stars/danielsdeleo/Decider) ![GitHub last commit](https://img.shields.io/github/last-commit/danielsdeleo/Decider)](https://github.com/danielsdeleo/Decider) - Flexible and Extensible Machine Learning in Ruby.
...
* [Etsy Conjecture ![GitHub Repo stars](https://img.shields.io/github/stars/etsy/Conjecture) ![GitHub last commit](https://img.shields.io/github/last-commit/etsy/Conjecture)](https://github.com/etsy/Conjecture) - scalable Machine Learning in Scalding.
...
* [H2O ![GitHub Repo stars](https://img.shields.io/github/stars/h2oai/h2o-3) ![GitHub last commit](https://img.shields.io/github/last-commit/h2oai/h2o-3)](https://github.com/h2oai/h2o-3/) - statistical, machine learning and math runtime with Hadoop. R and Python.
* [Karate Club ![GitHub Repo stars](https://img.shields.io/github/stars/benedekrozemberczki/karateclub) ![GitHub last commit](https://img.shields.io/github/last-commit/benedekrozemberczki/karateclub)](https://github.com/benedekrozemberczki/karateclub) - An unsupervised machine learning library for graph structured data. Python
* [Keras ![GitHub Repo stars](https://img.shields.io/github/stars/fchollet/keras) ![GitHub last commit](https://img.shields.io/github/last-commit/fchollet/keras)](https://github.com/fchollet/keras) - An intuitive neural net API inspired by Torch that runs atop Theano and Tensorflow.
* [Lambdo ![GitHub Repo stars](https://img.shields.io/github/stars/johnsonc/lambdo) ![GitHub last commit](https://img.shields.io/github/last-commit/johnsonc/lambdo)](https://github.com/johnsonc/lambdo) - Lambdo is a workflow engine which significantly simplifies the analysis process by unifying feature engineering and machine learning operations.
* [Little Ball of Fur ![GitHub Repo stars](https://img.shields.io/github/stars/benedekrozemberczki/littleballoffur) ![GitHub last commit](https://img.shields.io/github/last-commit/benedekrozemberczki/littleballoffur)](https://github.com/benedekrozemberczki/littleballoffur) - A subsampling library for graph structured data. Python
...
* [MLPNeuralNet ![GitHub Repo stars](https://img.shields.io/github/stars/nikolaypavlov/MLPNeuralNet) ![GitHub last commit](https://img.shields.io/github/last-commit/nikolaypavlov/MLPNeuralNet)](https://github.com/nikolaypavlov/MLPNeuralNet) - Fast multilayer perceptron neural network library for iOS and Mac OS X.
* [ML Workspace ![GitHub Repo stars](https://img.shields.io/github/stars/ml-tooling/ml-workspace) ![GitHub last commit](https://img.shields.io/github/last-commit/ml-tooling/ml-workspace)](https://github.com/ml-tooling/ml-workspace) - All-in-one web-based IDE specialized for machine learning and data science.
...
* [ND4J ![GitHub Repo stars](https://img.shields.io/github/stars/deeplearning4j/nd4j) ![GitHub last commit](https://img.shields.io/github/last-commit/deeplearning4j/nd4j)](https://github.com/deeplearning4j/nd4j) - A matrix library for the JVM. Numpy for Java. 
* [nupic ![GitHub Repo stars](https://img.shields.io/github/stars/numenta/nupic) ![GitHub last commit](https://img.shields.io/github/last-commit/numenta/nupic)](https://github.com/numenta/nupic) - Numenta Platform for Intelligent Computing: a brain-inspired machine intelligence platform, and biologically accurate neural network based on cortical learning algorithms.
...
* [RL4J ![GitHub Repo stars](https://img.shields.io/github/stars/deeplearning4j/rl4j) ![GitHub last commit](https://img.shields.io/github/last-commit/deeplearning4j/rl4j)](https://github.com/deeplearning4j/rl4j) - Reinforcement learning for Java and Scala. Includes Deep-Q learning and A3C algorithms, and integrates with Open AI's Gym. Runs in the Deeplearning4j ecosystem. 
* [SAMOA](http://samoa.incubator.apache.org/) - distributed streaming machine learning framework.
* [scikit-learn ![GitHub Repo stars](https://img.shields.io/github/stars/scikit-learn/scikit-learn) ![GitHub last commit](https://img.shields.io/github/last-commit/scikit-learn/scikit-learn)](https://github.com/scikit-learn/scikit-learn) - scikit-learn: machine learning in Python.
...
* [TensorFlow ![GitHub Repo stars](https://img.shields.io/github/stars/tensorflow/tensorflow) ![GitHub last commit](https://img.shields.io/github/last-commit/tensorflow/tensorflow)](https://github.com/tensorflow/tensorflow) - Library from Google for machine learning using data flow graphs.
...
* [Velox ![GitHub Repo stars](https://img.shields.io/github/stars/amplab/velox-modelserver) ![GitHub last commit](https://img.shields.io/github/last-commit/amplab/velox-modelserver)](https://github.com/amplab/velox-modelserver) - System for serving machine learning predictions.
* [Vowpal Wabbit ![GitHub Repo stars](https://img.shields.io/github/stars/JohnLangford/vowpal_wabbit) ![GitHub last commit](https://img.shields.io/github/last-commit/JohnLangford/vowpal_wabbit)](https://github.com/JohnLangford/vowpal_wabbit/wiki) - learning system sponsored by Microsoft and Yahoo!.
...
* [Berkeley SWIM Benchmark ![GitHub Repo stars](https://img.shields.io/github/stars/SWIMProjectUCB/SWIM) ![GitHub last commit](https://img.shields.io/github/last-commit/SWIMProjectUCB/SWIM)](https://github.com/SWIMProjectUCB/SWIM/wiki) - real-world big data workload benchmark.
* [Intel HiBench ![GitHub Repo stars](https://img.shields.io/github/stars/intel-hadoop/HiBench) ![GitHub last commit](https://img.shields.io/github/last-commit/intel-hadoop/HiBench)](https://github.com/intel-hadoop/HiBench) - a Hadoop benchmark suite.
...
* [Deeplearning4j Benchmarks ![GitHub Repo stars](https://img.shields.io/github/stars/deeplearning4j/dl4j-benchmark) ![GitHub last commit](https://img.shields.io/github/last-commit/deeplearning4j/dl4j-benchmark)](https://github.com/deeplearning4j/dl4j-benchmark)
...
* [BDA ![GitHub Repo stars](https://img.shields.io/github/stars/kotobukki/BDA) ![GitHub last commit](https://img.shields.io/github/last-commit/kotobukki/BDA)](https://github.com/kotobukki/BDA/) - The vulnerability detector for Hadoop and Spark
...
* [Apache Slider ![GitHub Repo stars](https://img.shields.io/github/stars/apache/incubator-slider) ![GitHub last commit](https://img.shields.io/github/last-commit/apache/incubator-slider)](https://github.com/apache/incubator-slider) - is a YARN application to deploy existing distributed applications on YARN.
...
* [Marathon ![GitHub Repo stars](https://img.shields.io/github/stars/mesosphere/marathon) ![GitHub last commit](https://img.shields.io/github/last-commit/mesosphere/marathon)](https://github.com/mesosphere/marathon) - Mesos framework for long-running services.
* [Linkis ![GitHub Repo stars](https://img.shields.io/github/stars/WeBankFinTech/Linkis) ![GitHub last commit](https://img.shields.io/github/last-commit/WeBankFinTech/Linkis)](https://github.com/WeBankFinTech/Linkis) - Linkis helps easily connect to various back-end computation/storage engines.

## Applications

* [411 ![GitHub Repo stars](https://img.shields.io/github/stars/etsy/411) ![GitHub last commit](https://img.shields.io/github/last-commit/etsy/411)](https://github.com/etsy/411) - an web application for alert management resulting from scheduled searches into Elasticsearch.
* [Adobe spindle ![GitHub Repo stars](https://img.shields.io/github/stars/adobe-research/spindle) ![GitHub last commit](https://img.shields.io/github/last-commit/adobe-research/spindle)](https://github.com/adobe-research/spindle) - Next-generation web analytics processing with Scala, Spark, and Parquet.
...
* [Argus ![GitHub Repo stars](https://img.shields.io/github/stars/salesforce/Argus) ![GitHub last commit](https://img.shields.io/github/last-commit/salesforce/Argus)](https://github.com/salesforce/Argus) - Time series monitoring and alerting platform.
* [AthenaX ![GitHub Repo stars](https://img.shields.io/github/stars/uber/AthenaX) ![GitHub last commit](https://img.shields.io/github/last-commit/uber/AthenaX)](https://github.com/uber/AthenaX) - a streaming analytics platform that enables users to run production-quality, large scale streaming analytics using Structured Query Language (SQL).
* [Atlas ![GitHub Repo stars](https://img.shields.io/github/stars/Netflix/atlas) ![GitHub last commit](https://img.shields.io/github/last-commit/Netflix/atlas)](https://github.com/Netflix/atlas) - a backend for managing dimensional time series data.
...
* [ElastAert ![GitHub Repo stars](https://img.shields.io/github/stars/Yelp/elastalert) ![GitHub last commit](https://img.shields.io/github/last-commit/Yelp/elastalert)](https://github.com/Yelp/elastalert) - ElastAlert is a simple framework for alerting on anomalies, spikes, or other patterns of interest from data in ElasticSearch.
* [Eventhub ![GitHub Repo stars](https://img.shields.io/github/stars/Codecademy/EventHub) ![GitHub last commit](https://img.shields.io/github/last-commit/Codecademy/EventHub)](https://github.com/Codecademy/EventHub) - open source event analytics platform.
* [HASH](https://hash.ai) - open source simulation and visualization platform.
* [Hermes ![GitHub Repo stars](https://img.shields.io/github/stars/allegro/hermes) ![GitHub last commit](https://img.shields.io/github/last-commit/allegro/hermes)](https://github.com/allegro/hermes) - asynchronous message broker built on top of Kafka.
...
* [Kapacitor ![GitHub Repo stars](https://img.shields.io/github/stars/influxdata/kapacitor) ![GitHub last commit](https://img.shields.io/github/last-commit/influxdata/kapacitor)](https://github.com/influxdata/kapacitor) - an open source framework for processing, monitoring, and alerting on time series data.
* [Kylin](http://kylin.apache.org/) - open source Distributed Analytics Engine from eBay.
* [PivotalR ![GitHub Repo stars](https://img.shields.io/github/stars/pivotalsoftware/PivotalR) ![GitHub last commit](https://img.shields.io/github/last-commit/pivotalsoftware/PivotalR)](https://github.com/pivotalsoftware/PivotalR) - R on Pivotal HD / HAWQ and PostgreSQL.
* [Rakam ![GitHub Repo stars](https://img.shields.io/github/stars/rakam-io/rakam) ![GitHub last commit](https://img.shields.io/github/last-commit/rakam-io/rakam)](https://github.com/rakam-io/rakam) - open-source real-time custom analytics platform powered by Postgresql, Kinesis and PrestoDB. 
* [Qubole](https://www.qubole.com/) - auto-scaling Hadoop cluster, built-in data connectors.
* [SnappyData ![GitHub Repo stars](https://img.shields.io/github/stars/SnappyDataInc/snappydata) ![GitHub last commit](https://img.shields.io/github/last-commit/SnappyDataInc/snappydata)](https://github.com/SnappyDataInc/snappydata) - a distributed in-memory data store for real-time operational analytics, delivering stream analytics, OLTP (online transaction processing) and OLAP (online analytical processing) built on Spark in a single integrated cluster.
* [Snowplow ![GitHub Repo stars](https://img.shields.io/github/stars/snowplow/snowplow) ![GitHub last commit](https://img.shields.io/github/last-commit/snowplow/snowplow)](https://github.com/snowplow/snowplow) - enterprise-strength web and event analytics, powered by Hadoop, Kinesis, Redshift and Postgres.
...
* [Elassandra ![GitHub Repo stars](https://img.shields.io/github/stars/strapdata/elassandra) ![GitHub last commit](https://img.shields.io/github/last-commit/strapdata/elassandra)](https://github.com/strapdata/elassandra) - is a fork of Elasticsearch modified to run on top of Apache Cassandra in a scalable and resilient peer-to-peer architecture.
...
* [LinkedIn Cleo ![GitHub Repo stars](https://img.shields.io/github/stars/linkedin/cleo) ![GitHub last commit](https://img.shields.io/github/last-commit/linkedin/cleo)](https://github.com/linkedin/cleo) - is a flexible software library for enabling rapid development of partial, out-of-order and real-time typeahead search.
* [LinkedIn Galene](https://engineering.linkedin.com/search/did-you-mean-galene) - search architecture at LinkedIn.
* [LinkedIn Zoie ![GitHub Repo stars](https://img.shields.io/github/stars/senseidb/zoie) ![GitHub last commit](https://img.shields.io/github/last-commit/senseidb/zoie)](https://github.com/senseidb/zoie) - is a realtime search/indexing system written in Java.
...
* [Facebook Faiss ![GitHub Repo stars](https://img.shields.io/github/stars/facebookresearch/faiss) ![GitHub last commit](https://img.shields.io/github/last-commit/facebookresearch/faiss)](https://github.com/facebookresearch/faiss) - is a library for efficient similarity search and clustering of dense vectors. It contains algorithms that search in sets of vectors of any size, up to ones that possibly do not fit in RAM. It also contains supporting code for evaluation and parameter tuning. Faiss is written in C++ with complete wrappers for Python/numpy.
* [Annoy ![GitHub Repo stars](https://img.shields.io/github/stars/spotify/annoy) ![GitHub last commit](https://img.shields.io/github/last-commit/spotify/annoy)](https://github.com/spotify/annoy) - is a C++ library with Python bindings to search for points in space that are close to a given query point. It also creates large read-only file-based data structures that are mmapped into memory so that many processes may share the same data.
* [Weaviate ![GitHub Repo stars](https://img.shields.io/github/stars/semi-technologies/weaviate) ![GitHub last commit](https://img.shields.io/github/last-commit/semi-technologies/weaviate)](https://github.com/semi-technologies/weaviate) - Weaviate is a GraphQL-based semantic search engine with build-in (word) embeddings.
...
* [Twemproxy ![GitHub Repo stars](https://img.shields.io/github/stars/twitter/twemproxy) ![GitHub last commit](https://img.shields.io/github/last-commit/twitter/twemproxy)](https://github.com/twitter/twemproxy) - A fast, light-weight proxy for memcached and redis.
* [Twitter Fatcache ![GitHub Repo stars](https://img.shields.io/github/stars/twitter/fatcache) ![GitHub last commit](https://img.shields.io/github/last-commit/twitter/fatcache)](https://github.com/twitter/fatcache) - key/value cache for flash storage.
* [Twitter Twemcache ![GitHub Repo stars](https://img.shields.io/github/stars/twitter/twemcache) ![GitHub last commit](https://img.shields.io/github/last-commit/twitter/twemcache)](https://github.com/twitter/twemcache) - fork of Memcache.
...
* [HanoiDB ![GitHub Repo stars](https://img.shields.io/github/stars/krestenkrab/hanoidb) ![GitHub last commit](https://img.shields.io/github/last-commit/krestenkrab/hanoidb)](https://github.com/krestenkrab/hanoidb) - Erlang LSM BTree Storage.
* [LevelDB ![GitHub Repo stars](https://img.shields.io/github/stars/google/leveldb) ![GitHub last commit](https://img.shields.io/github/last-commit/google/leveldb)](https://github.com/google/leveldb) - a fast key-value storage library written at Google that provides an ordered mapping from string keys to string values.
...
* [Blazer ![GitHub Repo stars](https://img.shields.io/github/stars/ankane/blazer) ![GitHub last commit](https://img.shields.io/github/last-commit/ankane/blazer)](https://github.com/ankane/blazer) - business intelligence made simple.
...
* [Metabase ![GitHub Repo stars](https://img.shields.io/github/stars/metabase/metabase) ![GitHub last commit](https://img.shields.io/github/last-commit/metabase/metabase)](https://github.com/metabase/metabase) - The simplest, fastest way to get business intelligence and analytics to everyone in your company.
...
* [Airpal ![GitHub Repo stars](https://img.shields.io/github/stars/airbnb/airpal) ![GitHub last commit](https://img.shields.io/github/last-commit/airbnb/airpal)](https://github.com/airbnb/airpal) - Web UI for PrestoDB.
...
* [Banana ![GitHub Repo stars](https://img.shields.io/github/stars/LucidWorks/banana) ![GitHub last commit](https://img.shields.io/github/last-commit/LucidWorks/banana)](https://github.com/LucidWorks/banana) - visualize logs and time-stamped data stored in Solr. Port of Kibana.
* [Bloomery ![GitHub Repo stars](https://img.shields.io/github/stars/ufukomer/bloomery) ![GitHub last commit](https://img.shields.io/github/last-commit/ufukomer/bloomery)](https://github.com/ufukomer/bloomery) - Web UI for Impala.
...
* [CartoDB ![GitHub Repo stars](https://img.shields.io/github/stars/CartoDB/cartodb) ![GitHub last commit](https://img.shields.io/github/last-commit/CartoDB/cartodb)](https://github.com/CartoDB/cartodb) - open-source or freemium hosting for geospatial databases with powerful front-end editing capabilities and a robust API.
...
* [Chartist.js ![GitHub Repo stars](https://img.shields.io/github/stars/gionkunz/chartist-js) ![GitHub last commit](https://img.shields.io/github/last-commit/gionkunz/chartist-js)](https://github.com/gionkunz/chartist-js) - another open source HTML5 Charts visualization.
...
* [Cubism ![GitHub Repo stars](https://img.shields.io/github/stars/square/cubism) ![GitHub last commit](https://img.shields.io/github/last-commit/square/cubism)](https://github.com/square/cubism) - JavaScript library for time series visualization.
...
* [D3.compose ![GitHub Repo stars](https://img.shields.io/github/stars/CSNW/d3.compose) ![GitHub last commit](https://img.shields.io/github/last-commit/CSNW/d3.compose)](https://github.com/CSNW/d3.compose) - Compose complex, data-driven visualizations from reusable charts and components.
* [D3Plus](http://d3plus.org) - A fairly robust set of reusable charts and styles for d3.js.
* [Dash ![GitHub Repo stars](https://img.shields.io/github/stars/plotly/dash) ![GitHub last commit](https://img.shields.io/github/last-commit/plotly/dash)](https://github.com/plotly/dash) - Analytical Web Apps for Python, R, Julia, and Jupyter. Built on top of plotly, no JS required
* [Dekart](https://dekart.xyz/) - Large scale geospatial analytics for Google BigQuery based on Kepler.gl.
...
* [Echarts ![GitHub Repo stars](https://img.shields.io/github/stars/ecomfe/echarts) ![GitHub last commit](https://img.shields.io/github/last-commit/ecomfe/echarts)](https://github.com/ecomfe/echarts) - Baidus enterprise charts.
...
* [Freeboard ![GitHub Repo stars](https://img.shields.io/github/stars/Freeboard/freeboard) ![GitHub last commit](https://img.shields.io/github/last-commit/Freeboard/freeboard)](https://github.com/Freeboard/freeboard) - pen source real-time dashboard builder for IOT and other web mashups.
* [Gephi ![GitHub Repo stars](https://img.shields.io/github/stars/gephi/gephi) ![GitHub last commit](https://img.shields.io/github/last-commit/gephi/gephi)](https://github.com/gephi/gephi) - An award-winning open-source platform for visualizing and manipulating large graphs and network connections. It's like Photoshop, but for graphs. Available for Windows and Mac OS X.
...
* [Plotly.js ![GitHub Repo stars](https://img.shields.io/github/stars/plotly/plotly.js) ![GitHub last commit](https://img.shields.io/github/last-commit/plotly/plotly.js)](https://github.com/plotly/plotly.js) The open source javascript graphing library that powers plotly.
* [Recline ![GitHub Repo stars](https://img.shields.io/github/stars/okfn/recline) ![GitHub last commit](https://img.shields.io/github/last-commit/okfn/recline)](https://github.com/okfn/recline) - simple but powerful library for building data applications in pure Javascript and HTML.
* [Redash ![GitHub Repo stars](https://img.shields.io/github/stars/getredash/redash) ![GitHub last commit](https://img.shields.io/github/last-commit/getredash/redash)](https://github.com/getredash/redash) - open-source platform to query and visualize data.
* [ReCharts](http://recharts.org/) - A composable charting library built on React components
* [Shiny](http://shiny.rstudio.com/) - a web application framework for R.
* [Sigma.js ![GitHub Repo stars](https://img.shields.io/github/stars/jacomyal/sigma.js) ![GitHub last commit](https://img.shields.io/github/last-commit/jacomyal/sigma.js)](https://github.com/jacomyal/sigma.js) - JavaScript library dedicated to graph drawing.
* [Superset ![GitHub Repo stars](https://img.shields.io/github/stars/apache/incubator-superset) ![GitHub last commit](https://img.shields.io/github/last-commit/apache/incubator-superset)](https://github.com/apache/incubator-superset) - a data exploration platform designed to be visual, intuitive and interactive, making it easy to slice, dice and visualize data and perform analytics at the speed of thought.
...
* [Zeppelin ![GitHub Repo stars](https://img.shields.io/github/stars/ZEPL/zeppelin) ![GitHub last commit](https://img.shields.io/github/last-commit/ZEPL/zeppelin)](https://github.com/ZEPL/zeppelin) - a notebook-style collaborative data analysis.
* [Zing Charts](https://www.zingchart.com/) - JavaScript charting library for big data.
* [DataSphere Studio ![GitHub Repo stars](https://img.shields.io/github/stars/WeBankFinTech/DataSphereStudio) ![GitHub last commit](https://img.shields.io/github/last-commit/WeBankFinTech/DataSphereStudio)](https://github.com/WeBankFinTech/DataSphereStudio) - one-stop data application development management portal.
...
* [NetLytics ![GitHub Repo stars](https://img.shields.io/github/stars/marty90/netlytics) ![GitHub last commit](https://img.shields.io/github/last-commit/marty90/netlytics)](https://github.com/marty90/netlytics/) - Analytics platform to process network data on Spark.
...
# Other Awesome Lists
- Other awesome lists [awesome-awesomeness ![GitHub Repo stars](https://img.shields.io/github/stars/bayandin/awesome-awesomeness) ![GitHub last commit](https://img.shields.io/github/last-commit/bayandin/awesome-awesomeness)](https://github.com/bayandin/awesome-awesomeness).
- Even more lists [awesome ![GitHub Repo stars](https://img.shields.io/github/stars/sindresorhus/awesome) ![GitHub last commit](https://img.shields.io/github/last-commit/sindresorhus/awesome)](https://github.com/sindresorhus/awesome).
- Another list? [list ![GitHub Repo stars](https://img.shields.io/github/stars/jnv/lists) ![GitHub last commit](https://img.shields.io/github/last-commit/jnv/lists)](https://github.com/jnv/lists).
- WTF! [awesome-awesome-awesome ![GitHub Repo stars](https://img.shields.io/github/stars/t3chnoboy/awesome-awesome-awesome) ![GitHub last commit](https://img.shields.io/github/last-commit/t3chnoboy/awesome-awesome-awesome)](https://github.com/t3chnoboy/awesome-awesome-awesome).
- Analytics [awesome-analytics ![GitHub Repo stars](https://img.shields.io/github/stars/onurakpolat/awesome-analytics) ![GitHub last commit](https://img.shields.io/github/last-commit/onurakpolat/awesome-analytics)](https://github.com/onurakpolat/awesome-analytics).
- Public Datasets [awesome-public-datasets ![GitHub Repo stars](https://img.shields.io/github/stars/awesomedata/awesome-public-datasets) ![GitHub last commit](https://img.shields.io/github/last-commit/awesomedata/awesome-public-datasets)](https://github.com/awesomedata/awesome-public-datasets).
- Graph Classification [awesome-graph-classification ![GitHub Repo stars](https://img.shields.io/github/stars/benedekrozemberczki/awesome-graph-classification) ![GitHub last commit](https://img.shields.io/github/last-commit/benedekrozemberczki/awesome-graph-classification)](https://github.com/benedekrozemberczki/awesome-graph-classification).
- Network Embedding [awesome-network-embedding ![GitHub Repo stars](https://img.shields.io/github/stars/chihming/awesome-network-embedding) ![GitHub last commit](https://img.shields.io/github/last-commit/chihming/awesome-network-embedding)](https://github.com/chihming/awesome-network-embedding).
- Community Detection [awesome-community-detection ![GitHub Repo stars](https://img.shields.io/github/stars/benedekrozemberczki/awesome-community-detection) ![GitHub last commit](https://img.shields.io/github/last-commit/benedekrozemberczki/awesome-community-detection)](https://github.com/benedekrozemberczki/awesome-community-detection).
- Decision Tree Papers [awesome-decision-tree-papers ![GitHub Repo stars](https://img.shields.io/github/stars/benedekrozemberczki/awesome-decision-tree-papers) ![GitHub last commit](https://img.shields.io/github/last-commit/benedekrozemberczki/awesome-decision-tree-papers)](https://github.com/benedekrozemberczki/awesome-decision-tree-papers).
- Fraud Detection Papers [awesome-fraud-detection-papers ![GitHub Repo stars](https://img.shields.io/github/stars/benedekrozemberczki/awesome-fraud-detection-papers) ![GitHub last commit](https://img.shields.io/github/last-commit/benedekrozemberczki/awesome-fraud-detection-papers)](https://github.com/benedekrozemberczki/awesome-fraud-detection-papers).
- Gradient Boosting Papers [awesome-gradient-boosting-papers ![GitHub Repo stars](https://img.shields.io/github/stars/benedekrozemberczki/awesome-gradient-boosting-papers) ![GitHub last commit](https://img.shields.io/github/last-commit/benedekrozemberczki/awesome-gradient-boosting-papers)](https://github.com/benedekrozemberczki/awesome-gradient-boosting-papers).
- Monte Carlo Tree Search Papers [awesome-monte-carlo-tree-search-papers ![GitHub Repo stars](https://img.shields.io/github/stars/benedekrozemberczki/awesome-monte-carlo-tree-search-papers) ![GitHub last commit](https://img.shields.io/github/last-commit/benedekrozemberczki/awesome-monte-carlo-tree-search-papers)](https://github.com/benedekrozemberczki/awesome-monte-carlo-tree-search-papers).
- Kafka [awesome-kafka ![GitHub Repo stars](https://img.shields.io/github/stars/monksy/awesome-kafka) ![GitHub last commit](https://img.shields.io/github/last-commit/monksy/awesome-kafka)](https://github.com/monksy/awesome-kafka).
- [Google Bigtable ![GitHub Repo stars](https://img.shields.io/github/stars/zrosenbauer/awesome-bigtable) ![GitHub last commit](https://img.shields.io/github/last-commit/zrosenbauer/awesome-bigtable)](https://github.com/zrosenbauer/awesome-bigtable).
