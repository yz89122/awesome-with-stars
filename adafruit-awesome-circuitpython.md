...
- [CircuitPython GitHub Repository ![GitHub Repo stars](https://img.shields.io/github/stars/adafruit/circuitpython) ![GitHub last commit](https://img.shields.io/github/last-commit/adafruit/circuitpython)](https://github.com/adafruit/circuitpython) - The source code for CircuitPython on GitHub.
- [Adafruit CircuitPython Libraries ![GitHub Repo stars](https://img.shields.io/github/stars/adafruit/Adafruit_CircuitPython_Bundle) ![GitHub last commit](https://img.shields.io/github/last-commit/adafruit/Adafruit_CircuitPython_Bundle)](https://github.com/adafruit/Adafruit_CircuitPython_Bundle/blob/master/circuitpython_library_list.md) - Current Adafruit CircuitPython Libraries. There are over 150+ libraries available. More on Libraries on [CircuitPython.org](https://circuitpython.org/libraries).
...
- [CircuitPython Cheat Sheet ![GitHub Repo stars](https://img.shields.io/github/stars/adafruit/awesome-circuitpython) ![GitHub last commit](https://img.shields.io/github/last-commit/adafruit/awesome-circuitpython)](https://github.com/adafruit/awesome-circuitpython/blob/master/cheatsheet/CircuitPython_Cheatsheet.md) - Dave Astels's helpful cheat sheet on CircuitPython.
...
- [Electronic Cats](https://electroniccats.com/) - CatWAN USB Stick, Meow Meow, [Escornabot Match ![GitHub Repo stars](https://img.shields.io/github/stars/ElectronicCats/Escornabot-Makech) ![GitHub last commit](https://img.shields.io/github/last-commit/ElectronicCats/Escornabot-Makech)](https://github.com/ElectronicCats/Escornabot-Makech).
...
- [Max Holliday ![GitHub Repo stars](https://img.shields.io/github/stars/RoboticExplorationLab/sprite) ![GitHub last commit](https://img.shields.io/github/last-commit/RoboticExplorationLab/sprite)](https://github.com/RoboticExplorationLab/sprite) - KickSat Sprite, SAM32.
...
- Oddly Specific Objects - [The Open Book ![GitHub Repo stars](https://img.shields.io/github/stars/joeycastillo/The-Open-Book) ![GitHub last commit](https://img.shields.io/github/last-commit/joeycastillo/The-Open-Book)](https://github.com/joeycastillo/The-Open-Book)
...
- Sarfata - [ShIRtty Board ![GitHub Repo stars](https://img.shields.io/github/stars/sarfata/shirtty-addon) ![GitHub last commit](https://img.shields.io/github/last-commit/sarfata/shirtty-addon)](https://github.com/sarfata/shirtty-addon)
- Scott Shawcroft - [Python powered GameBoy-compatible cartridge ![GitHub Repo stars](https://img.shields.io/github/stars/chickadee-tech/pygb) ![GitHub last commit](https://img.shields.io/github/last-commit/chickadee-tech/pygb)](https://github.com/chickadee-tech/pygb)
- noGarage - [Ndbit6]()
...
Adding new boards to the CircuitPython list on [circuitpython.org](https://circuitpython.org): Please do a pull request on GitHub at [https://github.com/adafruit/circuitpython ![GitHub Repo stars](https://img.shields.io/github/stars/adafruit/circuitpython) ![GitHub last commit](https://img.shields.io/github/last-commit/adafruit/circuitpython)](https://github.com/adafruit/circuitpython). CircuitPython developers may help get the correct pin data and other information to map a new board.
...
- [Contribute to newsletter ![GitHub Repo stars](https://img.shields.io/github/stars/adafruit/circuitpython-weekly-newsletter) ![GitHub last commit](https://img.shields.io/github/last-commit/adafruit/circuitpython-weekly-newsletter)](https://github.com/adafruit/circuitpython-weekly-newsletter) - Guidelines on contributing to the newsletter.
