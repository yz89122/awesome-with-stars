...
- [DDD/CQRS/ES Slack ![GitHub Repo stars](https://img.shields.io/github/stars/ddd-cqrs-es/slack-community) ![GitHub last commit](https://img.shields.io/github/last-commit/ddd-cqrs-es/slack-community)](https://github.com/ddd-cqrs-es/slack-community) - A slack team for those who want to chat about Domain-Driven Design, CQRS, Event Sourcing and sometimes random things. Main channel is language and framework agnostic.
