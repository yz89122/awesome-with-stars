...
- [Coax ![GitHub Repo stars](https://img.shields.io/github/stars/microsoft/coax) ![GitHub last commit](https://img.shields.io/github/last-commit/microsoft/coax)](https://github.com/microsoft/coax) - Turn RL papers into code, the easy way. <img src="https://img.shields.io/github/stars/microsoft/coax?style=social" align="center">
...
- [Vision Transformer ![GitHub Repo stars](https://img.shields.io/github/stars/google-research/vision_transformer) ![GitHub last commit](https://img.shields.io/github/last-commit/google-research/vision_transformer)](https://github.com/google-research/vision_transformer) - Official implementation in Flax of [_An Image is Worth 16x16 Words: Transformers for Image Recognition at Scale_](https://arxiv.org/abs/2010.11929).
...
- [Big Transfer (BiT) ![GitHub Repo stars](https://img.shields.io/github/stars/google-research/big_transfer) ![GitHub last commit](https://img.shields.io/github/last-commit/google-research/big_transfer)](https://github.com/google-research/big_transfer) - Implementation of [Big Transfer (BiT): General Visual Representation Learning](https://arxiv.org/abs/1912.11370).
