...
- [Purple Pi ![GitHub Repo stars](https://img.shields.io/github/stars/nschloe/purple-pi) ![GitHub last commit](https://img.shields.io/github/last-commit/nschloe/purple-pi)](https://github.com/nschloe/purple-pi) - Browser extension that lets you use LaTeX in GitHub pages, StackOverflow etc. ![foss]
...
- [IntelliJ](https://www.jetbrains.com/idea/)
	- [TeXiFy-IDEA ![GitHub Repo stars](https://img.shields.io/github/stars/Ruben-Sten/TeXiFy-IDEA) ![GitHub last commit](https://img.shields.io/github/last-commit/Ruben-Sten/TeXiFy-IDEA)](https://github.com/Ruben-Sten/TeXiFy-IDEA) - Free LaTeX plugin for IntelliJ IDEA. ![foss]
...
- [Papis ![GitHub Repo stars](https://img.shields.io/github/stars/alejandrogallo/papis) ![GitHub last commit](https://img.shields.io/github/last-commit/alejandrogallo/papis)](https://github.com/alejandrogallo/papis) - Extremely customizable,
...
- [Arara](https://www.ctan.org/pkg/arara) ([GitHub repo ![GitHub Repo stars](https://img.shields.io/github/stars/cereda/arara) ![GitHub last commit](https://img.shields.io/github/last-commit/cereda/arara)](https://github.com/cereda/arara)) - Simple tool that allows you to specify which tools to call inside your document and it can be extended quite easily. ![foss]
...
- [latex-makefile ![GitHub Repo stars](https://img.shields.io/github/stars/alejandrogallo/latex-makefile) ![GitHub last commit](https://img.shields.io/github/last-commit/alejandrogallo/latex-makefile)](https://github.com/alejandrogallo/latex-makefile) - `Makefile` based build tool that attempts to be as general and lightweight as possible. ![foss]
...
- [TikzEdt](http://www.tikzedt.org) (also: [GitHub repo ![GitHub Repo stars](https://img.shields.io/github/stars/hchapman/tikzedt) ![GitHub last commit](https://img.shields.io/github/last-commit/hchapman/tikzedt)](https://github.com/hchapman/tikzedt)) - WYSIWYG and text-based editor for TikZ pictures. ![foss]
...
- [Begin LaTeX in minutes ![GitHub Repo stars](https://img.shields.io/github/stars/LewisVo/Begin-Latex-in-minutes) ![GitHub last commit](https://img.shields.io/github/last-commit/LewisVo/Begin-Latex-in-minutes)](https://github.com/LewisVo/Begin-Latex-in-minutes) - Brief intro to LaTeX for beginners that helps you use LaTeX with ease.
