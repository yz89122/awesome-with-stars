...
* [Elasticsearch Hadoop ![GitHub Repo stars](https://img.shields.io/github/stars/elastic/elasticsearch-hadoop) ![GitHub last commit](https://img.shields.io/github/last-commit/elastic/elasticsearch-hadoop)](https://github.com/elastic/elasticsearch-hadoop) - Elasticsearch real-time search and analytics natively integrated with Hadoop. Supports Map/Reduce, Cascading, Apache Hive and Apache Pig.
* [hadoopy ![GitHub Repo stars](https://img.shields.io/github/stars/bwhite/hadoopy) ![GitHub last commit](https://img.shields.io/github/last-commit/bwhite/hadoopy)](https://github.com/bwhite/hadoopy) - Python MapReduce library written in Cython. 
* [mrjob ![GitHub Repo stars](https://img.shields.io/github/stars/Yelp/mrjob) ![GitHub last commit](https://img.shields.io/github/last-commit/Yelp/mrjob)](https://github.com/Yelp/mrjob/) - mrjob is a Python 2.5+ package that helps you write and run Hadoop Streaming jobs.
* [pydoop](http://pydoop.sourceforge.net/) - Pydoop is a package that provides a Python API for Hadoop.
* [hdfs-du ![GitHub Repo stars](https://img.shields.io/github/stars/twitter/hdfs-du) ![GitHub last commit](https://img.shields.io/github/last-commit/twitter/hdfs-du)](https://github.com/twitter/hdfs-du) - HDFS-DU is an interactive visualization of the Hadoop distributed file system. 
* [White Elephant ![GitHub Repo stars](https://img.shields.io/github/stars/linkedin/white-elephant) ![GitHub last commit](https://img.shields.io/github/last-commit/linkedin/white-elephant)](https://github.com/linkedin/white-elephant) - Hadoop log aggregator and dashboard
* [Genie ![GitHub Repo stars](https://img.shields.io/github/stars/Netflix/genie) ![GitHub last commit](https://img.shields.io/github/last-commit/Netflix/genie)](https://github.com/Netflix/genie) - Genie provides REST-ful APIs to run Hadoop, Hive and Pig jobs, and to manage multiple Hadoop resources and perform job submissions across them.
...
* [Crunch ![GitHub Repo stars](https://img.shields.io/github/stars/jondot/crunch) ![GitHub last commit](https://img.shields.io/github/last-commit/jondot/crunch)](https://github.com/jondot/crunch) - Go-based toolkit for ETL and feature extraction on Hadoop
...
* [mpich2-yarn ![GitHub Repo stars](https://img.shields.io/github/stars/alibaba/mpich2-yarn) ![GitHub last commit](https://img.shields.io/github/last-commit/alibaba/mpich2-yarn)](https://github.com/alibaba/mpich2-yarn) - Running MPICH2 on Yarn
...
* [happybase ![GitHub Repo stars](https://img.shields.io/github/stars/wbolster/happybase) ![GitHub last commit](https://img.shields.io/github/last-commit/wbolster/happybase)](https://github.com/wbolster/happybase) - A developer-friendly Python library to interact with Apache HBase.
* [Hannibal ![GitHub Repo stars](https://img.shields.io/github/stars/sentric/hannibal) ![GitHub last commit](https://img.shields.io/github/last-commit/sentric/hannibal)](https://github.com/sentric/hannibal) - Hannibal is tool to help monitor and maintain HBase-Clusters that are configured for manual splitting.
* [Haeinsa ![GitHub Repo stars](https://img.shields.io/github/stars/VCNC/haeinsa) ![GitHub last commit](https://img.shields.io/github/last-commit/VCNC/haeinsa)](https://github.com/VCNC/haeinsa) - Haeinsa is linearly scalable multi-row, multi-table transaction library for HBase
...
* [Confluent Schema registry for Kafka ![GitHub Repo stars](https://img.shields.io/github/stars/confluentinc/schema-registry) ![GitHub last commit](https://img.shields.io/github/last-commit/confluentinc/schema-registry)](https://github.com/confluentinc/schema-registry) - Schema Registry provides a serving layer for your metadata. It provides a RESTful interface for storing and retrieving Avro schemas.
* [Hortonworks Schema Registry ![GitHub Repo stars](https://img.shields.io/github/stars/hortonworks/registry) ![GitHub last commit](https://img.shields.io/github/last-commit/hortonworks/registry)](https://github.com/hortonworks/registry) - Schema Registry is a framework to build metadata repositories.
...
* [Apache AirFlow ![GitHub Repo stars](https://img.shields.io/github/stars/apache/incubator-airflow) ![GitHub last commit](https://img.shields.io/github/last-commit/apache/incubator-airflow)](https://github.com/apache/incubator-airflow) - Airflow is a workflow automation and scheduling system that can be used to author and manage data pipelines
...
* [Suro ![GitHub Repo stars](https://img.shields.io/github/stars/Netflix/suro) ![GitHub last commit](https://img.shields.io/github/last-commit/Netflix/suro)](https://github.com/Netflix/suro) - Netflix's distributed Data Pipeline
* [Apache Sqoop](http://sqoop.apache.org) - Apache Sqoop
* [Apache Kafka](http://kafka.apache.org/) - Apache Kafka
* [Gobblin from LinkedIn ![GitHub Repo stars](https://img.shields.io/github/stars/linkedin/gobblin) ![GitHub last commit](https://img.shields.io/github/last-commit/linkedin/gobblin)](https://github.com/linkedin/gobblin) - Universal data ingestion framework for Hadoop
...
* [vahara ![GitHub Repo stars](https://img.shields.io/github/stars/thedatachef/varaha) ![GitHub last commit](https://img.shields.io/github/last-commit/thedatachef/varaha)](https://github.com/thedatachef/varaha) - Machine learning and natural language processing with Apache Pig
* [packetpig ![GitHub Repo stars](https://img.shields.io/github/stars/packetloop/packetpig) ![GitHub last commit](https://img.shields.io/github/last-commit/packetloop/packetpig)](https://github.com/packetloop/packetpig) - Open Source Big Data Security Analytics
* [akela ![GitHub Repo stars](https://img.shields.io/github/stars/mozilla-metrics/akela) ![GitHub last commit](https://img.shields.io/github/last-commit/mozilla-metrics/akela)](https://github.com/mozilla-metrics/akela) - Mozilla's utility library for Hadoop, HBase, Pig, etc.
...
* [Lipstick ![GitHub Repo stars](https://img.shields.io/github/stars/Netflix/Lipstick) ![GitHub last commit](https://img.shields.io/github/last-commit/Netflix/Lipstick)](https://github.com/Netflix/Lipstick) - Pig workflow visualization tool. [Introducing Lipstick on A(pache) Pig](http://techblog.netflix.com/2013/06/introducing-lipstick-on-apache-pig.html)
* [PigPen ![GitHub Repo stars](https://img.shields.io/github/stars/Netflix/PigPen) ![GitHub last commit](https://img.shields.io/github/last-commit/Netflix/PigPen)](https://github.com/Netflix/PigPen) - PigPen is map-reduce for Clojure, or distributed Clojure. It compiles to Apache Pig, but you don't need to know much about Pig to use it.

## Libraries and Tools

* [Kite Software Development Kit](http://kitesdk.org/) - A set of libraries, tools, examples, and documentation
* [gohadoop ![GitHub Repo stars](https://img.shields.io/github/stars/hortonworks/gohadoop) ![GitHub last commit](https://img.shields.io/github/last-commit/hortonworks/gohadoop)](https://github.com/hortonworks/gohadoop) - Native go clients for Apache Hadoop YARN.
...
* [Elephant Bird ![GitHub Repo stars](https://img.shields.io/github/stars/twitter/elephant-bird) ![GitHub last commit](https://img.shields.io/github/last-commit/twitter/elephant-bird)](https://github.com/twitter/elephant-bird) - Twitter's collection of LZO and Protocol Buffer-related Hadoop, Pig, Hive, and HBase code.
* [Spring for Apache Hadoop](http://projects.spring.io/spring-hadoop/)
* [hdfs - A native go client for HDFS ![GitHub Repo stars](https://img.shields.io/github/stars/colinmarc/hdfs) ![GitHub last commit](https://img.shields.io/github/last-commit/colinmarc/hdfs)](https://github.com/colinmarc/hdfs)
...
* [Schema Registry UI ![GitHub Repo stars](https://img.shields.io/github/stars/Landoop/schema-registry-ui) ![GitHub last commit](https://img.shields.io/github/last-commit/Landoop/schema-registry-ui)](https://github.com/Landoop/schema-registry-ui) - Web tool for the Confluent Schema Registry in order to create / view / search / evolve / view history & configure Avro schemas of your Kafka cluster.
...
* [ankush ![GitHub Repo stars](https://img.shields.io/github/stars/impetus-opensource/ankush) ![GitHub last commit](https://img.shields.io/github/last-commit/impetus-opensource/ankush)](https://github.com/impetus-opensource/ankush) - A big data cluster management tool that creates and manages clusters of different technologies.
...
* [inviso ![GitHub Repo stars](https://img.shields.io/github/stars/Netflix/inviso) ![GitHub last commit](https://img.shields.io/github/last-commit/Netflix/inviso)](https://github.com/Netflix/inviso) - Inviso is a lightweight tool that provides the ability to search for Hadoop jobs, visualize the performance, and view cluster utilization.
...
* [Banana ![GitHub Repo stars](https://img.shields.io/github/stars/LucidWorks/banana) ![GitHub last commit](https://img.shields.io/github/last-commit/LucidWorks/banana)](https://github.com/LucidWorks/banana) - Kibana port for Apache Solr
...
* [Project Rhino ![GitHub Repo stars](https://img.shields.io/github/stars/intel-hadoop/project-rhino) ![GitHub last commit](https://img.shields.io/github/last-commit/intel-hadoop/project-rhino)](https://github.com/intel-hadoop/project-rhino) - Intel's open source effort to enhance the existing data protection capabilities of the Hadoop ecosystem to address security and compliance challenges, and contribute the code back to Apache.

## Benchmark

* [Big Data Benchmark](https://amplab.cs.berkeley.edu/benchmark/)
* [HiBench ![GitHub Repo stars](https://img.shields.io/github/stars/intel-hadoop/HiBench) ![GitHub last commit](https://img.shields.io/github/last-commit/intel-hadoop/HiBench)](https://github.com/intel-hadoop/HiBench)
* [Big-Bench ![GitHub Repo stars](https://img.shields.io/github/stars/intel-hadoop/Big-Data-Benchmark-for-Big-Bench) ![GitHub last commit](https://img.shields.io/github/last-commit/intel-hadoop/Big-Data-Benchmark-for-Big-Bench)](https://github.com/intel-hadoop/Big-Data-Benchmark-for-Big-Bench)
* [YCSB ![GitHub Repo stars](https://img.shields.io/github/stars/brianfrankcooper/YCSB) ![GitHub last commit](https://img.shields.io/github/last-commit/brianfrankcooper/YCSB)](https://github.com/brianfrankcooper/YCSB) - The Yahoo! Cloud Serving Benchmark (YCSB) is an open-source specification and program suite for evaluating retrieval and maintenance capabilities of computer programs. It is often used to compare relative performance of NoSQL database management systems.

## Machine learning and Big Data analytics

* [Apache Mahout](http://mahout.apache.org)
* [Oryx 2 ![GitHub Repo stars](https://img.shields.io/github/stars/OryxProject/oryx) ![GitHub last commit](https://img.shields.io/github/last-commit/OryxProject/oryx)](https://github.com/OryxProject/oryx) - Lambda architecture on Spark, Kafka for real-time large scale machine learning
...
* [RHadoop ![GitHub Repo stars](https://img.shields.io/github/stars/RevolutionAnalytics/RHadoop) ![GitHub last commit](https://img.shields.io/github/last-commit/RevolutionAnalytics/RHadoop)](https://github.com/RevolutionAnalytics/RHadoop/wiki) including RHDFS, RHBase, RMR2, plyrmr
 ...
 * Libraries and tools
     ...
     * [shib ![GitHub Repo stars](https://img.shields.io/github/stars/tagomoris/shib) ![GitHub last commit](https://img.shields.io/github/last-commit/tagomoris/shib)](https://github.com/tagomoris/shib) - WebUI for query engines: Hive and Presto
     ...
     * [HiveRunner ![GitHub Repo stars](https://img.shields.io/github/stars/klarna/HiveRunner) ![GitHub last commit](https://img.shields.io/github/last-commit/klarna/HiveRunner)](https://github.com/klarna/HiveRunner) - An Open Source unit test framework for hadoop hive queries based on JUnit4
     * [Beetest ![GitHub Repo stars](https://img.shields.io/github/stars/kawaa/Beetest) ![GitHub last commit](https://img.shields.io/github/last-commit/kawaa/Beetest)](https://github.com/kawaa/Beetest) - A super simple utility for testing Apache Hive scripts locally for non-Java developers.
     * [Hive_test ![GitHub Repo stars](https://img.shields.io/github/stars/edwardcapriolo/hive_test) ![GitHub last commit](https://img.shields.io/github/last-commit/edwardcapriolo/hive_test)](https://github.com/edwardcapriolo/hive_test)- Unit test framework for hive and hive-service
* Flume Plugins
  * [Flume MongoDB Sink ![GitHub Repo stars](https://img.shields.io/github/stars/leonlee/flume-ng-mongodb-sink) ![GitHub last commit](https://img.shields.io/github/last-commit/leonlee/flume-ng-mongodb-sink)](https://github.com/leonlee/flume-ng-mongodb-sink)
  * [Flume RabbitMQ source and sink ![GitHub Repo stars](https://img.shields.io/github/stars/jcustenborder/flume-ng-rabbitmq) ![GitHub last commit](https://img.shields.io/github/last-commit/jcustenborder/flume-ng-rabbitmq)](https://github.com/jcustenborder/flume-ng-rabbitmq)
  * [Flume UDP Source ![GitHub Repo stars](https://img.shields.io/github/stars/whitepages/flume-udp-source) ![GitHub last commit](https://img.shields.io/github/last-commit/whitepages/flume-udp-source)](https://github.com/whitepages/flume-udp-source)
  * [.Net FlumeNG Clients ![GitHub Repo stars](https://img.shields.io/github/stars/marksl/DotNetFlumeNG.Clients) ![GitHub last commit](https://img.shields.io/github/last-commit/marksl/DotNetFlumeNG.Clients)](https://github.com/marksl/DotNetFlumeNG.Clients)
