...
This is a great introduction to the Linux command line. - [@4iar ![GitHub Repo stars](https://img.shields.io/github/stars/4iar/)

> You've experienced the shiny, point-and-click surface of your Linux computer—now dive below and explore its depths with the power of the command line.

?style=social)](https://github.com/4iar/)
...
* [Blackbox ![GitHub Repo stars](https://img.shields.io/github/stars/bradleythughes/blackbox?style=social)](https://github.com/bradleythughes/blackbox) - Lightweight window manager for the X window system, without library dependencies. Built using C++.
* [bspwm ![GitHub Repo stars](https://img.shields.io/github/stars/baskerville/bspwm?style=social)](https://github.com/baskerville/bspwm) - Tiling window manager that represents windows as the leaves of a full binary tree.
...
If you're looking for some pro-tips for your favorite text editor, you might be interested in [awesome-atom ![GitHub Repo stars](https://img.shields.io/github/stars/mehcode/awesome-atom?style=social)](https://github.com/mehcode/awesome-atom), [sublime-bookmarks ![GitHub Repo stars](https://img.shields.io/github/stars/dreikanter/sublime-bookmarks?style=social)](https://github.com/dreikanter/sublime-bookmarks), [vim-galore ![GitHub Repo stars](https://img.shields.io/github/stars/mhinz/vim-galore?style=social)](https://github.com/mhinz/vim-galore), [awesome-emacs ![GitHub Repo stars](https://img.shields.io/github/stars/emacs-tw/awesome-emacs?style=social)](https://github.com/emacs-tw/awesome-emacs), or [awesome-vscode ![GitHub Repo stars](https://img.shields.io/github/stars/viatsko/awesome-vscode?style=social)](https://github.com/viatsko/awesome-vscode).
...
* [Spice-Up ![GitHub Repo stars](https://img.shields.io/github/stars/Philip-Scott/Spice-up?style=social)](https://github.com/Philip-Scott/Spice-up) - Desktop presentation app.
...
* [Caprine ![GitHub Repo stars](https://img.shields.io/github/stars/sindresorhus/caprine?style=social)](https://github.com/sindresorhus/caprine/) - Facebook's Messenger client with some added privacy features.
* [PB for Desktop ![GitHub Repo stars](https://img.shields.io/github/stars/sidneys/pb-for-desktop?style=social)](https://github.com/sidneys/pb-for-desktop) - Pushbullet client.
* [ramme ![GitHub Repo stars](https://img.shields.io/github/stars/terkelg/ramme?style=social)](https://github.com/terkelg/ramme) - Instagram client.
* [Whatever ![GitHub Repo stars](https://img.shields.io/github/stars/CellarD0-0r/whatever?style=social)](https://github.com/CellarD0-0r/whatever) - Evernote client based on the web version.
...
* [dnfdragora ![GitHub Repo stars](https://img.shields.io/github/stars/manatools/dnfdragora?style=social)](https://github.com/manatools/dnfdragora) (Fedora) - A GUI for the `dnf` package manager.
* [Yay ![GitHub Repo stars](https://img.shields.io/github/stars/Jguer/yay?style=social)](https://github.com/Jguer/yay) (Arch) - Yay is one of the many wrappers to `pacman` which automatically downloads and installs packages from AUR, a full list can be found [here](https://wiki.archlinux.org/index.php/AUR_helpers).
* [Aura ![GitHub Repo stars](https://img.shields.io/github/stars/aurapm/aura?style=social)](https://github.com/aurapm/aura) (Arch) - Secure, multilingual package manager.

Distro-independent:

* [AppImageKit ![GitHub Repo stars](https://img.shields.io/github/stars/probonopd/AppImageKit?style=social)](https://github.com/probonopd/AppImageKit) - Using AppImageKit you can package applications in the [AppImage](http://appimage.org/) format that runs on common Linux-based operating systems, such as RHEL, CentOS, Ubuntu, Fedora, debian and derivatives; one app = one file.

### Console-based Applications and Tools

You might also be interested in checking out [awesome-shell ![GitHub Repo stars](https://img.shields.io/github/stars/alebcay/awesome-shell?style=social)](https://github.com/alebcay/awesome-shell), [awesome-bash ![GitHub Repo stars](https://img.shields.io/github/stars/awesome-lists/awesome-bash?style=social)](https://github.com/awesome-lists/awesome-bash), [awesome-zsh-plugins ![GitHub Repo stars](https://img.shields.io/github/stars/unixorn/awesome-zsh-plugins?style=social)](https://github.com/unixorn/awesome-zsh-plugins) or [awesome-fish ![GitHub Repo stars](https://img.shields.io/github/stars/jbucaran/awesome-fish?style=social)](https://github.com/jbucaran/awesome-fish).

* [cmus](https://cmus.github.io/) - Small, fast and powerful console music player.
* [fuck ![GitHub Repo stars](https://img.shields.io/github/stars/nvbn/thefuck?style=social)](https://github.com/nvbn/thefuck) - Command line tool which corrects your previously mistyped command.
...
* [ranger ![GitHub Repo stars](https://img.shields.io/github/stars/ranger/ranger?style=social)](https://github.com/ranger/ranger) - Vim-inspired file manager for the console.
* [screenFetch ![GitHub Repo stars](https://img.shields.io/github/stars/KittyKatt/screenFetch?style=social)](https://github.com/KittyKatt/screenFetch) - Fetches system/theme information in terminal.
* [shellcheck ![GitHub Repo stars](https://img.shields.io/github/stars/koalaman/shellcheck?style=social)](https://github.com/koalaman/shellcheck) - Static analysis tool for shell scripts.
* [speed-test ![GitHub Repo stars](https://img.shields.io/github/stars/sindresorhus/speed-test?style=social)](https://github.com/sindresorhus/speed-test) - Test your Internet connection speed and ping using [speedtest.net](http://www.speedtest.net/).
* [testdisk](http://www.cgsecurity.org/wiki/TestDisk) - A tool for disk partition recovery.
* [tig ![GitHub Repo stars](https://img.shields.io/github/stars/jonas/tig?style=social)](https://github.com/jonas/tig) - Text-mode interface for git. It functions mainly as a Git repository browser.
...
* [vtop ![GitHub Repo stars](https://img.shields.io/github/stars/MrRio/vtop?style=social)](https://github.com/MrRio/vtop) - Easily-extendable activity monitor.
* [wavemon ![GitHub Repo stars](https://img.shields.io/github/stars/uoaerg/wavemon?style=social)](https://github.com/uoaerg/wavemon) - Monitoring application for wireless network devices.
* [youtube-dl ![GitHub Repo stars](https://img.shields.io/github/stars/rg3/youtube-dl?style=social)](https://github.com/rg3/youtube-dl) - A tool to download videos from YouTube and other video sites.
