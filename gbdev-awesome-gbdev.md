...
- [GBDK](http://gbdk.sourceforge.net/) - A set of tools that enable to develop in **C**. Includes a set of libraries for the most common requirements and generates ready ROM files. Last updated in 2001. [Documentation](http://gbdk.sourceforge.net/doc/gbdk-doc.pdf).
  - [GBDK-2020 ![GitHub Repo stars](https://img.shields.io/github/stars/Zal0/gbdk-2020) ![GitHub last commit](https://img.shields.io/github/last-commit/Zal0/gbdk-2020)](https://github.com/Zal0/gbdk-2020/) - A modernized GBDK with updated SDCC toolchain (supports ROM banking), bug fixes, documentation and other improvements. Supports Windows, Linux and macOS.
  - [gbdk-osx ![GitHub Repo stars](https://img.shields.io/github/stars/x43x61x69/gbdk-osx) ![GitHub last commit](https://img.shields.io/github/last-commit/x43x61x69/gbdk-osx)](https://github.com/x43x61x69/gbdk-osx) - Patched GBDK 2.96a for the latest compilers on macOS.
  - [gbdk-n ![GitHub Repo stars](https://img.shields.io/github/stars/rotmoset/gbdk-n) ![GitHub last commit](https://img.shields.io/github/last-commit/rotmoset/gbdk-n)](https://github.com/rotmoset/gbdk-n) - Aims to update the gbdk libraries to be compatible with new versions of SDCC and provide helpers for building roms. Does not support ROM banking, thus limiting ROM size to 32K.
...
- [gb-template ![GitHub Repo stars](https://img.shields.io/github/stars/exezin/gb-template) ![GitHub last commit](https://img.shields.io/github/last-commit/exezin/gb-template)](https://github.com/exezin/gb-template) - A template with basic functions such as joypad input, DMA transfers, and map/tile data loading.
...
- [PlantBoy ![GitHub Repo stars](https://img.shields.io/github/stars/siObyte/PlantBoy) ![GitHub last commit](https://img.shields.io/github/last-commit/siObyte/PlantBoy)](https://github.com/siObyte/PlantBoy)
...
- [Super Princess' 2092 Exodus ![GitHub Repo stars](https://img.shields.io/github/stars/Zal0/gbjam2016) ![GitHub last commit](https://img.shields.io/github/last-commit/Zal0/gbjam2016)](https://github.com/Zal0/gbjam2016)
...
- [Tobu Tobu Girl ![GitHub Repo stars](https://img.shields.io/github/stars/SimonLarsen/tobutobugirl) ![GitHub last commit](https://img.shields.io/github/last-commit/SimonLarsen/tobutobugirl)](https://github.com/SimonLarsen/tobutobugirl) - An arcade platformer for the Game Boy.
...
- [DMA hijacking ![GitHub Repo stars](https://img.shields.io/github/stars/avivace/awesome-gbdev) ![GitHub last commit](https://img.shields.io/github/last-commit/avivace/awesome-gbdev)](https://github.com/avivace/awesome-gbdev/blob/master/articles/dma_hijacking.md) - A simple technique that allows you to run custom code in most GB/SGB/CGB games, provided you have an ACE exploit.
