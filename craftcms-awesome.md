...
### Contributing
Please take a quick look at the [contribution guidelines](CONTRIBUTING.md) first. If you see an article or resource here that is no longer maintained or is not a good fit, please submit a pull request to improve this file. Also, ideas for more categories [are needed ![GitHub Repo stars](https://img.shields.io/github/stars/chasegiunta/awesome-craft) ![GitHub last commit](https://img.shields.io/github/last-commit/chasegiunta/awesome-craft)](https://github.com/chasegiunta/awesome-craft/issues/2)! Thank you to all contributors; you rock!
...
- [Issues & Feedback ![GitHub Repo stars](https://img.shields.io/github/stars/craftcms/cms) ![GitHub last commit](https://img.shields.io/github/last-commit/craftcms/cms)](https://github.com/craftcms/cms/issues) - Post feature ideas and bug reports.
