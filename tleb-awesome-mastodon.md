...
* [Tooty ![GitHub Repo stars](https://img.shields.io/github/stars/n1k0/tooty) ![GitHub last commit](https://img.shields.io/github/last-commit/n1k0/tooty)](https://github.com/n1k0/tooty) - Experimental multi-account Mastodon Web client (Elm).
* [toot ![GitHub Repo stars](https://img.shields.io/github/stars/ihabunek/toot) ![GitHub last commit](https://img.shields.io/github/last-commit/ihabunek/toot)](https://github.com/ihabunek/toot) - Mastodon CLI client (Python).
* [madonctl ![GitHub Repo stars](https://img.shields.io/github/stars/McKael/madonctl) ![GitHub last commit](https://img.shields.io/github/last-commit/McKael/madonctl)](https://github.com/McKael/madonctl) - Mastodon CLI client (Go).
* [naumanni ![GitHub Repo stars](https://img.shields.io/github/stars/naumanni/naumanni) ![GitHub last commit](https://img.shields.io/github/last-commit/naumanni/naumanni)](https://github.com/naumanni/naumanni) - Web user interface specially designed for Mastodon.
* [Tooter ![GitHub Repo stars](https://img.shields.io/github/stars/dysk0/harbour-tooter) ![GitHub last commit](https://img.shields.io/github/last-commit/dysk0/harbour-tooter)](https://github.com/dysk0/harbour-tooter) - Native client for SailfishOS.
* [Fedilab](https://framagit.org/tom79/fedilab) - Android client.
* [Pinafore ![GitHub Repo stars](https://img.shields.io/github/stars/nolanlawson/pinafore) ![GitHub last commit](https://img.shields.io/github/last-commit/nolanlawson/pinafore)](https://github.com/nolanlawson/pinafore) - Alternative web client for Mastodon, focused on speed and simplicity.
* [Tootle ![GitHub Repo stars](https://img.shields.io/github/stars/bleakgrey/tootle) ![GitHub last commit](https://img.shields.io/github/last-commit/bleakgrey/tootle)](https://github.com/bleakgrey/tootle) - Simple Mastodon client designed for elementary OS.
...
* [Forget](https://forget.codl.fr/about/) - Delete toots after a user defined period of time (Python [source code ![GitHub Repo stars](https://img.shields.io/github/stars/codl/forget) ![GitHub last commit](https://img.shields.io/github/last-commit/codl/forget)](https://github.com/codl/forget/)).
* [Mastodon Toot Bookmarklet](https://rknightuk.github.io/mastodon-toot-bookmarklet/) - Bookmarklet to toot the current page ([source code ![GitHub Repo stars](https://img.shields.io/github/stars/rknightuk/mastodon-toot-bookmarklet) ![GitHub last commit](https://img.shields.io/github/last-commit/rknightuk/mastodon-toot-bookmarklet)](https://github.com/rknightuk/mastodon-toot-bookmarklet/))
* [Mastodon – Simplified Federation!](https://addons.mozilla.org/firefox/addon/mastodon-simplified-federation/) - Redirect clicks on remote follow/interaction buttons to your own instance ([source code ![GitHub Repo stars](https://img.shields.io/github/stars/rugk/mastodon-simplified-federation) ![GitHub last commit](https://img.shields.io/github/last-commit/rugk/mastodon-simplified-federation)](https://github.com/rugk/mastodon-simplified-federation)).
* [Fediverse Explorer](https://fediverse.0qz.fun/) - Trending hashtags and popular toots, regenerated every hour.
* [Mastodon #nowplaying Toot Bookmarklet](https://nowplaying.resynth1943.net) - Bookmarklet to toot the music you're currently listening to. Works with YouTube. ([source code ![GitHub Repo stars](https://img.shields.io/github/stars/resynth1943/mastodon-nowplaying-toot-bookmarklet) ![GitHub last commit](https://img.shields.io/github/last-commit/resynth1943/mastodon-nowplaying-toot-bookmarklet)](https://github.com/resynth1943/mastodon-nowplaying-toot-bookmarklet))
...
* [usercount ![GitHub Repo stars](https://img.shields.io/github/stars/josefkenny/usercount) ![GitHub last commit](https://img.shields.io/github/last-commit/josefkenny/usercount)](https://github.com/josefkenny/usercount) - Bot which posts user statistics to Mastodon (Python).
...
* [hnbot ![GitHub Repo stars](https://img.shields.io/github/stars/raymestalez/mastodon-hnbot) ![GitHub last commit](https://img.shields.io/github/last-commit/raymestalez/mastodon-hnbot)](https://github.com/raymestalez/mastodon-hnbot) - Posts the Hacker News stories with 100+ points (Python).
...
* [Welcome Bot ![GitHub Repo stars](https://img.shields.io/github/stars/indyhall/mastodon-welcome-bot) ![GitHub last commit](https://img.shields.io/github/last-commit/indyhall/mastodon-welcome-bot)](https://github.com/indyhall/mastodon-welcome-bot) - Automatically send a welcome DM to new users (Python).
...
* [Mastodon.py ![GitHub Repo stars](https://img.shields.io/github/stars/halcy/Mastodon.py) ![GitHub last commit](https://img.shields.io/github/last-commit/halcy/Mastodon.py)](https://github.com/halcy/Mastodon.py) - Python wrapper for the Mastodon API.
* [Megalodon ![GitHub Repo stars](https://img.shields.io/github/stars/h3poteto/megalodon) ![GitHub last commit](https://img.shields.io/github/last-commit/h3poteto/megalodon)](https://github.com/h3poteto/megalodon) - Mastodon API client library for node.js.
