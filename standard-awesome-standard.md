...
Documenting the explosion of packages in the [`standard` ![GitHub Repo stars](https://img.shields.io/github/stars/feross/standard) ![GitHub last commit](https://img.shields.io/github/last-commit/feross/standard)](https://github.com/feross/standard) ecosystem!
...
- **[npm packages that use standard (full list) ![GitHub Repo stars](https://img.shields.io/github/stars/feross/standard-packages) ![GitHub last commit](https://img.shields.io/github/last-commit/feross/standard-packages)](https://github.com/feross/standard-packages/blob/master/all.json)** - List of packages that use `standard`
...
- **[prettier-standard](https://www.npmjs.com/package/prettier-standard)** - format with [prettier ![GitHub Repo stars](https://img.shields.io/github/stars/prettier/prettier) ![GitHub last commit](https://img.shields.io/github/last-commit/prettier/prettier)](https://github.com/prettier/prettier) configured to standard rules
...
- Every major text editor has a plugin or built-in support for `standard`. See the [full list ![GitHub Repo stars](https://img.shields.io/github/stars/standard/standard) ![GitHub last commit](https://img.shields.io/github/last-commit/standard/standard)](https://github.com/standard/standard#are-there-text-editor-plugins) of supported editors.
...
- Brackets: **[brackets-standard ![GitHub Repo stars](https://img.shields.io/github/stars/ishamf/brackets-standard) ![GitHub last commit](https://img.shields.io/github/last-commit/ishamf/brackets-standard)](https://github.com/ishamf/brackets-standard/)** - linter
- Emacs: see [readme ![GitHub Repo stars](https://img.shields.io/github/stars/standard/standard) ![GitHub last commit](https://img.shields.io/github/last-commit/standard/standard)](https://github.com/standard/standard#emacs)
...
- Vim: see [readme ![GitHub Repo stars](https://img.shields.io/github/stars/standard/standard) ![GitHub last commit](https://img.shields.io/github/last-commit/standard/standard)](https://github.com/standard/standard#vim)
...
- WebStorm (PhpStorm, IntelliJ, RubyMine, JetBrains, etc.): built-in support. see [readme ![GitHub Repo stars](https://img.shields.io/github/stars/standard/standard) ![GitHub last commit](https://img.shields.io/github/last-commit/standard/standard)](https://github.com/standard/standard#webstorm-phpstorm-intellij-rubymine-jetbrains-etc)
...
- **[wemake-frontend-styleguide ![GitHub Repo stars](https://img.shields.io/github/stars/wemake-services/wemake-frontend-styleguide) ![GitHub last commit](https://img.shields.io/github/last-commit/wemake-services/wemake-frontend-styleguide)](https://github.com/wemake-services/wemake-frontend-styleguide)** - JavaScript & TypeScript & Vue & JsDoc & Scss style guides based on standard tools. Very strict!
...
- **[videojs-standard](https://www.npmjs.com/package/videojs-standard)** - fork by the [video.js ![GitHub Repo stars](https://img.shields.io/github/stars/videojs/video.js) ![GitHub last commit](https://img.shields.io/github/last-commit/videojs/video.js)](https://github.com/videojs/video.js) team
