...
- [MFEM](https://mfem.org) - Free, lightweight, scalable C++ library for finite element methods.
  (C++, LGPL 2.1, [GitHub ![GitHub Repo stars](https://img.shields.io/github/stars/mfem/mfem) ![GitHub last commit](https://img.shields.io/github/last-commit/mfem/mfem)](https://github.com/mfem/mfem))
...
- [pygalmesh ![GitHub Repo stars](https://img.shields.io/github/stars/nschloe/pygalmesh) ![GitHub last commit](https://img.shields.io/github/last-commit/nschloe/pygalmesh)](https://github.com/nschloe/pygalmesh) - Python interface for CGAL's 3D meshing capabilities.
  (Python, GPL 3, GitHub)
...
- [Triangle](https://www.cs.cmu.edu/~quake/triangle.html) - Two-dimensional quality mesh generator and Delaunay triangulator.
  (C, *nonfree software*)
- [optimesh ![GitHub Repo stars](https://img.shields.io/github/stars/nschloe/optimesh) ![GitHub last commit](https://img.shields.io/github/last-commit/nschloe/optimesh)](https://github.com/nschloe/optimesh) - Triangular mesh smoothing.
  (Python, GPL 3, GitHub)
...
- [dmsh ![GitHub Repo stars](https://img.shields.io/github/stars/nschloe/dmsh) ![GitHub last commit](https://img.shields.io/github/last-commit/nschloe/dmsh)](https://github.com/nschloe/dmsh) - Simple generator for unstructured triangular meshes, inspired by distmesh.
  (Python, GPL 3, GitHub)
...
- [meshplex ![GitHub Repo stars](https://img.shields.io/github/stars/nschloe/meshplex) ![GitHub last commit](https://img.shields.io/github/last-commit/nschloe/meshplex)](https://github.com/nschloe/meshplex) - Fast tools for simplex meshes. (Python, GPL 3, GitHub)
...
- [KryPy ![GitHub Repo stars](https://img.shields.io/github/stars/andrenarchy/krypy) ![GitHub last commit](https://img.shields.io/github/last-commit/andrenarchy/krypy)](https://github.com/andrenarchy/krypy) - Krylov subspace methods for the solution of linear algebraic systems.
  (Python, MIT, GitHub)
...
- [quadpy ![GitHub Repo stars](https://img.shields.io/github/stars/nschloe/quadpy) ![GitHub last commit](https://img.shields.io/github/last-commit/nschloe/quadpy)](https://github.com/nschloe/quadpy) - Numerical integration (quadrature, cubature) in Python.
  (Python, GPL 3, GitHub)
...
- [accupy ![GitHub Repo stars](https://img.shields.io/github/stars/nschloe/accupy) ![GitHub last commit](https://img.shields.io/github/last-commit/nschloe/accupy)](https://github.com/nschloe/accupy) - Accurate sums and dot products for Python.
  (Python, GPL 3, GitHub)
...
- [orthopy ![GitHub Repo stars](https://img.shields.io/github/stars/nschloe/orthopy) ![GitHub last commit](https://img.shields.io/github/last-commit/nschloe/orthopy)](https://github.com/nschloe/orthopy) - Compute orthogonal polynomials efficiently.
  (Python, GPL 3, GitHub)
