...
- [Komanda](https://komanda.io) - Designed for people who write code (beta). ([source ![GitHub Repo stars](https://img.shields.io/github/stars/mephux/komanda) ![GitHub last commit](https://img.shields.io/github/last-commit/mephux/komanda)](https://github.com/mephux/komanda)) `Linux`
...
- [Convos](https://convos.chat) - Always online web IRC client. ([source ![GitHub Repo stars](https://img.shields.io/github/stars/convos-chat/convos) ![GitHub last commit](https://img.shields.io/github/last-commit/convos-chat/convos)](https://github.com/convos-chat/convos), [demo](https://demo.convos.chat)) `Perl` `JavaScript` `Web`
...
- [toxirc ![GitHub Repo stars](https://img.shields.io/github/stars/endoffile78/toxirc) ![GitHub last commit](https://img.shields.io/github/last-commit/endoffile78/toxirc)](https://github.com/endoffile78/toxirc) - Tox ↔ IRC. `C`
...
- [matterbridge ![GitHub Repo stars](https://img.shields.io/github/stars/42wim/matterbridge) ![GitHub last commit](https://img.shields.io/github/last-commit/42wim/matterbridge)](https://github.com/42wim/matterbridge) - IRC ↔ Mattermost ↔ Discord ↔ XMPP ↔ Gitter ↔ Slack ↔ Discord ↔ Telegram ↔ ... `Go`
...
...and [contributors ![GitHub Repo stars](https://img.shields.io/github/stars/davisonio/awesome-irc) ![GitHub last commit](https://img.shields.io/github/last-commit/davisonio/awesome-irc)](https://github.com/davisonio/awesome-irc/graphs/contributors).

**[Contributions are welcome! ![GitHub Repo stars](https://img.shields.io/github/stars/davisonio/awesome-irc) ![GitHub last commit](https://img.shields.io/github/last-commit/davisonio/awesome-irc)](https://github.com/davisonio/awesome-irc/blob/master/contributing.md)**
