...
<!-- double-link - [cassandra-sstable-tools ![GitHub Repo stars](https://img.shields.io/github/stars/instaclustr/cassandra-sstable-tools) ![GitHub last commit](https://img.shields.io/github/last-commit/instaclustr/cassandra-sstable-tools)](https://github.com/instaclustr/cassandra-sstable-tools) - Tools for working with sstables. -->
<!-- double-link - [sstable tools ![GitHub Repo stars](https://img.shields.io/github/stars/tolbertam/sstable-tools) ![GitHub last commit](https://img.shields.io/github/last-commit/tolbertam/sstable-tools)](https://github.com/tolbertam/sstable-tools) - A toolkit for parsing, creating and doing other fun stuff with Cassandra 3.x SSTables. -->
...
<!-- !LoyaltyOne's repos are now all private 404 - [CloudFormation Cassandra AWS ![GitHub Repo stars](https://img.shields.io/github/stars/LoyaltyOne/cassandra-aws) ![GitHub last commit](https://img.shields.io/github/last-commit/LoyaltyOne/cassandra-aws)](https://github.com/LoyaltyOne/cassandra-aws) - A cassandra cluster for development using Cloud Formation. -->
...
<!-- !Seems to be unmaintained now, build failing tags - [rackerlabs/blueflood ![GitHub Repo stars](https://img.shields.io/github/stars/rackerlabs/blueflood) ![GitHub last commit](https://img.shields.io/github/last-commit/rackerlabs/blueflood)](https://github.com/rackerlabs/blueflood) - GitHub resources for blueflood. -->
...
<!-- double-link - [scalar-labs/scalardb ![GitHub Repo stars](https://img.shields.io/github/stars/scalar-labs/scalardb) ![GitHub last commit](https://img.shields.io/github/last-commit/scalar-labs/scalardb)](https://github.com/scalar-labs/scalardb) - Library that makes non-ACID distributed databases/storages ACID-compliant. -->
...
<!-- double-link - [Express-Cassandra ![GitHub Repo stars](https://img.shields.io/github/stars/masumsoft/express-cassandra) ![GitHub last commit](https://img.shields.io/github/last-commit/masumsoft/express-cassandra)](https://github.com/masumsoft/express-cassandra) - Cassandra ORM/ODM/OGM for Node.js with Elassandra & JanusGraph Support. -->
<!-- double-link - [Instaclustr Esop ![GitHub Repo stars](https://img.shields.io/github/stars/instaclustr/esop) ![GitHub last commit](https://img.shields.io/github/last-commit/instaclustr/esop)](https://github.com/instaclustr/esop) - Swiss knife for backup and restore of your node to GCP, Azure, S3, Ceph etc. Supports backup and restoration of commit logs too. Esop is embedded in [Instaclustr Icarus ![GitHub Repo stars](https://img.shields.io/github/stars/instaclustr/icarus) ![GitHub last commit](https://img.shields.io/github/last-commit/instaclustr/icarus)](https://github.com/instaclustr/icarus) sidecar so you may backup and restore your cluster remotely and on-the-fly with any disruption. -->
<!-- double-link - [Instaclustr LDAP Authenticator ![GitHub Repo stars](https://img.shields.io/github/stars/instaclustr/cassandra-ldap) ![GitHub last commit](https://img.shields.io/github/last-commit/instaclustr/cassandra-ldap)](https://github.com/instaclustr/cassandra-ldap) - LDAP Authenticator for Cassandra. -->
...
<!-- double-link - [FiloDB ![GitHub Repo stars](https://img.shields.io/github/stars/filodb/FiloDB) ![GitHub last commit](https://img.shields.io/github/last-commit/filodb/FiloDB)](https://github.com/filodb/FiloDB) - High-performance distributed analytical database + Spark SQL queries + built for streaming.  -->
...
<!-- 404 moved or made private - [Cassandra Scripts ![GitHub Repo stars](https://img.shields.io/github/stars/bart613/cassandra) ![GitHub last commit](https://img.shields.io/github/last-commit/bart613/cassandra)](https://github.com/bart613/cassandra) - Python based cassandra ops scripts to monitor cfstats. -->
