...
### Perl
 - [mongo-perl-driver ![GitHub Repo stars](https://img.shields.io/github/stars/mongodb-labs/mongo-perl-driver) ![GitHub last commit](https://img.shields.io/github/last-commit/mongodb-labs/mongo-perl-driver)](https://github.com/mongodb-labs/mongo-perl-driver) - Official Perl driver

### PHP
 - [Doctrine MongoDB ![GitHub Repo stars](https://img.shields.io/github/stars/doctrine/mongodb) ![GitHub last commit](https://img.shields.io/github/last-commit/doctrine/mongodb)](https://github.com/doctrine/mongodb) - Wrapper around the native PHP Mongo PECL extension to provide additional functionality
 - [eloquent-mongodb-repository ![GitHub Repo stars](https://img.shields.io/github/stars/nilportugues/eloquent-mongodb-repository) ![GitHub last commit](https://img.shields.io/github/last-commit/nilportugues/eloquent-mongodb-repository)](https://github.com/nilportugues/eloquent-mongodb-repository) - Repository implementation built on top of laravel-mongodb
 - [laravel-mongodb ![GitHub Repo stars](https://img.shields.io/github/stars/jenssegers/laravel-mongodb) ![GitHub last commit](https://img.shields.io/github/last-commit/jenssegers/laravel-mongodb)](https://github.com/jenssegers/laravel-mongodb) - Eloquent model and query builder for Laravel
 - [mongodb-repository ![GitHub Repo stars](https://img.shields.io/github/stars/nilportugues/mongodb-repository) ![GitHub last commit](https://img.shields.io/github/last-commit/nilportugues/mongodb-repository)](https://github.com/nilportugues/mongodb-repository) - Repository implementation
 - [PHPMongo ODM ![GitHub Repo stars](https://img.shields.io/github/stars/sokil/php-mongo) ![GitHub last commit](https://img.shields.io/github/last-commit/sokil/php-mongo)](https://github.com/sokil/php-mongo) - ODM based on the PHP Mongo PECL extension
 - [PHPMongo Migrator ![GitHub Repo stars](https://img.shields.io/github/stars/sokil/php-mongo-migrator) ![GitHub last commit](https://img.shields.io/github/last-commit/sokil/php-mongo-migrator)](https://github.com/sokil/php-mongo-migrator) - Migration tool based on PHPMongo ODM
 - [pecl/mongodb ![GitHub Repo stars](https://img.shields.io/github/stars/mongodb/mongo-php-driver) ![GitHub last commit](https://img.shields.io/github/last-commit/mongodb/mongo-php-driver)](https://github.com/mongodb/mongo-php-driver) - Official PHP driver
 - [yadm ![GitHub Repo stars](https://img.shields.io/github/stars/formapro/yadm) ![GitHub last commit](https://img.shields.io/github/last-commit/formapro/yadm)](https://github.com/formapro/yadm) - Fast schemaless ODM
...
### Python
 ...
 - [Motor ![GitHub Repo stars](https://img.shields.io/github/stars/mongodb/motor) ![GitHub last commit](https://img.shields.io/github/last-commit/mongodb/motor)](https://github.com/mongodb/motor) - Non-blocking Python driver for Tornado or asyncio
 - [PyMongo ![GitHub Repo stars](https://img.shields.io/github/stars/mongodb/mongo-python-driver) ![GitHub last commit](https://img.shields.io/github/last-commit/mongodb/mongo-python-driver)](https://github.com/mongodb/mongo-python-driver) - Official (and recommended) Python driver
...
### Deployment
 ...
 - [Dockerfile ![GitHub Repo stars](https://img.shields.io/github/stars/dockerfile/mongodb) ![GitHub last commit](https://img.shields.io/github/last-commit/dockerfile/mongodb)](https://github.com/dockerfile/mongodb)
...
### Desktop
 ...
 - [Nosqlclient ![GitHub Repo stars](https://img.shields.io/github/stars/nosqlclient/nosqlclient) ![GitHub last commit](https://img.shields.io/github/last-commit/nosqlclient/nosqlclient)](https://github.com/nosqlclient/nosqlclient) - Cross-platform, self hosted and easy to use management tool (formerly Mongoclient)
 - [QueryAssist](https://queryassist.com) - Modern and powerful GUI tool, cross-platform and easy-to-use
 - [Robo 3T ![GitHub Repo stars](https://img.shields.io/github/stars/Studio3T/robomongo) ![GitHub last commit](https://img.shields.io/github/last-commit/Studio3T/robomongo)](https://github.com/Studio3T/robomongo) - Free, native and cross-platform shell-centric GUI (formerly Robomongo)
...
### Shell
 - [mongo-hacker ![GitHub Repo stars](https://img.shields.io/github/stars/TylerBrock/mongo-hacker) ![GitHub last commit](https://img.shields.io/github/last-commit/TylerBrock/mongo-hacker)](https://github.com/TylerBrock/mongo-hacker) - MongoDB shell enhancements
