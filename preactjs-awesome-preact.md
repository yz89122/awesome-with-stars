...
- [Preact Boilerplate ![GitHub Repo stars](https://img.shields.io/github/stars/therealparmesh/preact-boilerplate) ![GitHub last commit](https://img.shields.io/github/last-commit/therealparmesh/preact-boilerplate)](https://github.com/therealparmesh/preact-boilerplate) - Absolutely minimal Preact starter project, powered by Parcel.
...
- [**macOS Web**](https://macos.now.sh) - macOS Big Sur Desktop experience for Web, built with Preact and Vite _([Github project ![GitHub Repo stars](https://img.shields.io/github/stars/PuruVJ/macos-web) ![GitHub last commit](https://img.shields.io/github/last-commit/PuruVJ/macos-web)](https://github.com/PuruVJ/macos-web))_
