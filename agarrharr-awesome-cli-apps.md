...
- [nehm ![GitHub Repo stars](https://img.shields.io/github/stars/bogem/nehm) ![GitHub last commit](https://img.shields.io/github/last-commit/bogem/nehm)](https://github.com/bogem/nehm) - Download tracks from SoundCloud.
...
- [playx ![GitHub Repo stars](https://img.shields.io/github/stars/NISH1001/playx) ![GitHub last commit](https://img.shields.io/github/last-commit/NISH1001/playx)](https://github.com/NISH1001/playx) - Stream songs/playlists from various sources.
...
- [TTYtter ![GitHub Repo stars](https://img.shields.io/github/stars/oysttyer/oysttyer) ![GitHub last commit](https://img.shields.io/github/last-commit/oysttyer/oysttyer)](https://github.com/oysttyer/oysttyer) - Twitter client.
...
- [cgasm ![GitHub Repo stars](https://img.shields.io/github/stars/bnagy/cgasm) ![GitHub last commit](https://img.shields.io/github/last-commit/bnagy/cgasm)](https://github.com/bnagy/cgasm) - Gives x86 assembly documentation.
...
- [neovim ![GitHub Repo stars](https://img.shields.io/github/stars/neovim/neovim) ![GitHub last commit](https://img.shields.io/github/last-commit/neovim/neovim)](https://github.com/neovim/neovim) - Vim fork focused on extensibility and usability.
...
- [caniuse-cmd ![GitHub Repo stars](https://img.shields.io/github/stars/sgentle/caniuse-cmd) ![GitHub last commit](https://img.shields.io/github/last-commit/sgentle/caniuse-cmd)](https://github.com/sgentle/caniuse-cmd) - Search [caniuse.com](caniuse.com) about browser support of feature.
- [is-up-cli ![GitHub Repo stars](https://img.shields.io/github/stars/sindresorhus/is-up-cli) ![GitHub last commit](https://img.shields.io/github/last-commit/sindresorhus/is-up-cli)](https://github.com/sindresorhus/is-up-cli) - Check whether a website is up.
...
- [acmetool ![GitHub Repo stars](https://img.shields.io/github/stars/hlandau/acme) ![GitHub last commit](https://img.shields.io/github/last-commit/hlandau/acme)](https://github.com/hlandau/acme) - An automatic certificate acquisition tool for ACME (Let's Encrypt).
- [loadtest ![GitHub Repo stars](https://img.shields.io/github/stars/alexfernandez/loadtest) ![GitHub last commit](https://img.shields.io/github/last-commit/alexfernandez/loadtest)](https://github.com/alexfernandez/loadtest) - Runs a load test on the selected URL. Easy to extend minimally for your own ends.
- [wp-cli ![GitHub Repo stars](https://img.shields.io/github/stars/wp-cli/wp-cli) ![GitHub last commit](https://img.shields.io/github/last-commit/wp-cli/wp-cli)](https://github.com/wp-cli/wp-cli) - Manage WordPress installations, update plugins, set up multisite installs and much more.
- [diff2html-cli ![GitHub Repo stars](https://img.shields.io/github/stars/rtfpessoa/diff2html-cli) ![GitHub last commit](https://img.shields.io/github/last-commit/rtfpessoa/diff2html-cli)](https://github.com/rtfpessoa/diff2html-cli) - Parse git diffs as JSON and generate pretty HTML.
- [HTTPie ![GitHub Repo stars](https://img.shields.io/github/stars/jkbrzt/httpie) ![GitHub last commit](https://img.shields.io/github/last-commit/jkbrzt/httpie)](https://github.com/jkbrzt/httpie) - A user-friendly HTTP client.
- [serve ![GitHub Repo stars](https://img.shields.io/github/stars/zeit/serve) ![GitHub last commit](https://img.shields.io/github/last-commit/zeit/serve)](https://github.com/zeit/serve) - Easy to use static file server with features like https, CORS and GZIP compression.
...
- [shell2http ![GitHub Repo stars](https://img.shields.io/github/stars/msoap/shell2http) ![GitHub last commit](https://img.shields.io/github/last-commit/msoap/shell2http)](https://github.com/msoap/shell2http) - Execute shell commands via HTTP server.
...
- [mevn-cli ![GitHub Repo stars](https://img.shields.io/github/stars/madlabsinc/mevn-cli) ![GitHub last commit](https://img.shields.io/github/last-commit/madlabsinc/mevn-cli)](http://github.com/madlabsinc/mevn-cli) - Light speed setup for MEVN (Mongo Express Vue Node) Apps.
...
- [AutoScreenshotUploader ![GitHub Repo stars](https://img.shields.io/github/stars/yask123/AutoScreenshotUploader) ![GitHub last commit](https://img.shields.io/github/last-commit/yask123/AutoScreenshotUploader)](https://github.com/yask123/AutoScreenshotUploader) - Capture and upload screenshots to imgur.
...
- [g3l ![GitHub Repo stars](https://img.shields.io/github/stars/svtek/g3l) ![GitHub last commit](https://img.shields.io/github/last-commit/svtek/g3l)](https://github.com/svtek/g3l) - Easiest git cli in the w0rld!
...
- [googler ![GitHub Repo stars](https://img.shields.io/github/stars/jarun/googler) ![GitHub last commit](https://img.shields.io/github/last-commit/jarun/googler)](https://github.com/jarun/googler) - Google from the terminal.
- [papis ![GitHub Repo stars](https://img.shields.io/github/stars/alejandrogallo/papis) ![GitHub last commit](https://img.shields.io/github/last-commit/alejandrogallo/papis)](http://github.com/alejandrogallo/papis) - Extensible document and bibliography manager.
...
- [mdp ![GitHub Repo stars](https://img.shields.io/github/stars/visit1985/mdp) ![GitHub last commit](https://img.shields.io/github/last-commit/visit1985/mdp)](https://github.com/visit1985/mdp) - A command-line based markdown presentation tool.
...
- [archive-type-cli ![GitHub Repo stars](https://img.shields.io/github/stars/kevva/archive-type-cli) ![GitHub last commit](https://img.shields.io/github/last-commit/kevva/archive-type-cli)](https://github.com/kevva/archive-type-cli) - Detect archive type for a file or stdin.
...
- [wego ![GitHub Repo stars](https://img.shields.io/github/stars/schachmat/wego) ![GitHub last commit](https://img.shields.io/github/last-commit/schachmat/wego)](https://github.com/schachmat/wego) - Get the weather.
- [weather-cli ![GitHub Repo stars](https://img.shields.io/github/stars/riyadhalnur/weather-cli) ![GitHub last commit](https://img.shields.io/github/last-commit/riyadhalnur/weather-cli)](https://github.com/riyadhalnur/weather-cli) - Check the weather.
...
- [app-path-cli ![GitHub Repo stars](https://img.shields.io/github/stars/sindresorhus/app-path-cli) ![GitHub last commit](https://img.shields.io/github/last-commit/sindresorhus/app-path-cli)](https://github.com/sindresorhus/app-path-cli) - Get the path to an app.
- [bundle-id-cli ![GitHub Repo stars](https://img.shields.io/github/stars/sindresorhus/bundle-id-cli) ![GitHub last commit](https://img.shields.io/github/last-commit/sindresorhus/bundle-id-cli)](https://github.com/sindresorhus/bundle-id-cli) - Get bundle identifier from a bundle name: Safari → com.apple.Safari.
- [bundle-name-cli ![GitHub Repo stars](https://img.shields.io/github/stars/sindresorhus/bundle-name-cli) ![GitHub last commit](https://img.shields.io/github/last-commit/sindresorhus/bundle-name-cli)](https://github.com/sindresorhus/bundle-name-cli) - Get bundle name from a bundle identifier: com.apple.Safari → Safari.
- [lnfs-cli ![GitHub Repo stars](https://img.shields.io/github/stars/kevva/lnfs-cli) ![GitHub last commit](https://img.shields.io/github/last-commit/kevva/lnfs-cli)](https://github.com/kevva/lnfs-cli) - Safely force create symlinks.
- [osx-version-cli ![GitHub Repo stars](https://img.shields.io/github/stars/sindresorhus/osx-version-cli) ![GitHub last commit](https://img.shields.io/github/last-commit/sindresorhus/osx-version-cli)](https://github.com/sindresorhus/osx-version-cli) - Get the macOS version.
...
- [website-popup-cli ![GitHub Repo stars](https://img.shields.io/github/stars/sindresorhus/website-popup-cli) ![GitHub last commit](https://img.shields.io/github/last-commit/sindresorhus/website-popup-cli)](https://github.com/sindresorhus/website-popup-cli) - Open a website in a popup.
...
- [splash-cli ![GitHub Repo stars](https://img.shields.io/github/stars/rawnly/splash-cli) ![GitHub last commit](https://img.shields.io/github/last-commit/rawnly/splash-cli)](https://github.com/rawnly/splash-cli) - Beautiful wallpapers from Unsplash.
...
- [exa ![GitHub Repo stars](https://img.shields.io/github/stars/ogham/exa) ![GitHub last commit](https://img.shields.io/github/last-commit/ogham/exa)](https://github.com/ogham/exa) - Improved version of `ls`.
...
- [fasd ![GitHub Repo stars](https://img.shields.io/github/stars/clvv/fasd) ![GitHub last commit](https://img.shields.io/github/last-commit/clvv/fasd)](https://github.com/clvv/fasd) - Command-line productivity booster, offers quick access to files and directories, inspired by autojump, z and v.
...
- [CLI GitHub ![GitHub Repo stars](https://img.shields.io/github/stars/IonicaBizau/cli-github) ![GitHub last commit](https://img.shields.io/github/last-commit/IonicaBizau/cli-github)](https://github.com/IonicaBizau/cli-github) - :tv: A fancy GitHub client for command line.
- [Gistup ![GitHub Repo stars](https://img.shields.io/github/stars/mbostock/gistup) ![GitHub last commit](https://img.shields.io/github/last-commit/mbostock/gistup)](https://github.com/mbostock/gistup) - Create a gist from terminal, then use git to update it.
- [git commander ![GitHub Repo stars](https://img.shields.io/github/stars/golbin/git-commander) ![GitHub last commit](https://img.shields.io/github/last-commit/golbin/git-commander)](https://github.com/golbin/git-commander) - A git tool with a easy terminal interface.
- [git-stats ![GitHub Repo stars](https://img.shields.io/github/stars/IonicaBizau/git-stats) ![GitHub last commit](https://img.shields.io/github/last-commit/IonicaBizau/git-stats)](https://github.com/IonicaBizau/git-stats) - :four_leaf_clover: A GitHub-like contributions calendar, but locally, with all your git commits.
- [hub ![GitHub Repo stars](https://img.shields.io/github/stars/github/hub) ![GitHub last commit](https://img.shields.io/github/last-commit/github/hub)](https://github.com/github/hub) - A command-line wrapper for git that makes you better at GitHub.
...
- [git-labelmaker ![GitHub Repo stars](https://img.shields.io/github/stars/himynameisdave/git-labelmaker) ![GitHub last commit](https://img.shields.io/github/last-commit/himynameisdave/git-labelmaker)](https://github.com/himynameisdave/git-labelmaker) - Edit GitHub labels from the command line.
...
- [gitlab-cli ![GitHub Repo stars](https://img.shields.io/github/stars/vishwanatharondekar/gitlab-cli) ![GitHub last commit](https://img.shields.io/github/last-commit/vishwanatharondekar/gitlab-cli)](https://github.com/vishwanatharondekar/gitlab-cli) - gitlab cli for creating merge request from the command line.
- [git-extras ![GitHub Repo stars](https://img.shields.io/github/stars/tj/git-extras) ![GitHub last commit](https://img.shields.io/github/last-commit/tj/git-extras)](https://github.com/tj/git-extras) - Little git extras like git-ignore, git-setup, git-changelog, git-release, git-effort and more.
- [gita ![GitHub Repo stars](https://img.shields.io/github/stars/nosarthur/gita) ![GitHub last commit](https://img.shields.io/github/last-commit/nosarthur/gita)](https://github.com/nosarthur/gita) - Manage multiple git repos side by side for sanity.
- [readme-md-generator ![GitHub Repo stars](https://img.shields.io/github/stars/kefranabg/readme-md-generator) ![GitHub last commit](https://img.shields.io/github/last-commit/kefranabg/readme-md-generator)](https://github.com/kefranabg/readme-md-generator) - Generate README.md files interactively.
...
- [asciinema ![GitHub Repo stars](https://img.shields.io/github/stars/asciinema/asciinema) ![GitHub last commit](https://img.shields.io/github/last-commit/asciinema/asciinema)](https://github.com/asciinema/asciinema) - Terminal session recorder and the best companion of asciinema.org.
...
- [SVGO ![GitHub Repo stars](https://img.shields.io/github/stars/svg/svgo) ![GitHub last commit](https://img.shields.io/github/last-commit/svg/svgo)](https://github.com/svg/svgo) - SVG Optimizer is a Nodejs-based tool for optimizing SVG vector graphics files.

## Screensavers

- [cmatrix ![GitHub Repo stars](https://img.shields.io/github/stars/Treri/cmatrix) ![GitHub last commit](https://img.shields.io/github/last-commit/Treri/cmatrix)](https://github.com/Treri/cmatrix) - Show a scrolling 'Matrix' like screen.
- [pipes.sh ![GitHub Repo stars](https://img.shields.io/github/stars/pipeseroni/pipes.sh) ![GitHub last commit](https://img.shields.io/github/last-commit/pipeseroni/pipes.sh)](https://github.com/pipeseroni/pipes.sh) - Shows random pipes that grow across the screen.
- [YuleLog ![GitHub Repo stars](https://img.shields.io/github/stars/Duroktar/YuleLog) ![GitHub last commit](https://img.shields.io/github/last-commit/Duroktar/YuleLog)](https://github.com/Duroktar/YuleLog) - Terminal based Christmas YuleLog fireplace.
- [cli-fireplace ![GitHub Repo stars](https://img.shields.io/github/stars/dolsup/cli-fireplace) ![GitHub last commit](https://img.shields.io/github/last-commit/dolsup/cli-fireplace)](https://github.com/dolsup/cli-fireplace) - Shows digital fireplace.

## Graphics
- [cli-mandelbrot ![GitHub Repo stars](https://img.shields.io/github/stars/danyshaanan/cli-mandelbrot) ![GitHub last commit](https://img.shields.io/github/last-commit/danyshaanan/cli-mandelbrot)](https://github.com/danyshaanan/cli-mandelbrot) - A cli for traversing the Mandelbrot fractal.
...
- [cowsay ![GitHub Repo stars](https://img.shields.io/github/stars/tnalpgge/rank-amateur-cowsay) ![GitHub last commit](https://img.shields.io/github/last-commit/tnalpgge/rank-amateur-cowsay)](https://github.com/tnalpgge/rank-amateur-cowsay) - A configurable talking cow (and other animals).
...
- [detect-indent-cli ![GitHub Repo stars](https://img.shields.io/github/stars/sindresorhus/detect-indent-cli) ![GitHub last commit](https://img.shields.io/github/last-commit/sindresorhus/detect-indent-cli)](https://github.com/sindresorhus/detect-indent-cli) - Detect the indentation of code.
- [fullname-cli ![GitHub Repo stars](https://img.shields.io/github/stars/sindresorhus/fullname-cli) ![GitHub last commit](https://img.shields.io/github/last-commit/sindresorhus/fullname-cli)](https://github.com/sindresorhus/fullname-cli) - Get the fullname of the current user.
...
- [HASHA -cli ![GitHub Repo stars](https://img.shields.io/github/stars/sindresorhus/hasha-cli) ![GitHub last commit](https://img.shields.io/github/last-commit/sindresorhus/hasha-cli)](https://github.com/sindresorhus/hasha-cli) - Hashing made simple. Get the hash of text or stdin.
...
- [leven-cli ![GitHub Repo stars](https://img.shields.io/github/stars/sindresorhus/leven-cli) ![GitHub last commit](https://img.shields.io/github/last-commit/sindresorhus/leven-cli)](https://github.com/sindresorhus/leven-cli) - Measure the difference between two strings using the Levenshtein distance algorithm.
...
- [medium-cli ![GitHub Repo stars](https://img.shields.io/github/stars/djadmin/medium-cli) ![GitHub last commit](https://img.shields.io/github/last-commit/djadmin/medium-cli)](https://github.com/djadmin/medium-cli) - Read [medium.com](https://medium.com/) stories within your terminal, also gives top stories.
- [open-shortcut-cli ![GitHub Repo stars](https://img.shields.io/github/stars/sindresorhus/open-shortcut-cli) ![GitHub last commit](https://img.shields.io/github/last-commit/sindresorhus/open-shortcut-cli)](https://github.com/sindresorhus/open-shortcut-cli) - Open the URL from a web shortcut file in the browser.
- [shortcut-url-cli ![GitHub Repo stars](https://img.shields.io/github/stars/sindresorhus/shortcut-url-cli) ![GitHub last commit](https://img.shields.io/github/last-commit/sindresorhus/shortcut-url-cli)](https://github.com/sindresorhus/shortcut-url-cli) - Get the URL from a web shortcut file.
- [to-double-quotes ![GitHub Repo stars](https://img.shields.io/github/stars/sindresorhus/to-double-quotes-cli) ![GitHub last commit](https://img.shields.io/github/last-commit/sindresorhus/to-double-quotes-cli)](https://github.com/sindresorhus/to-double-quotes-cli) - Convert matching single-quotes to double-quotes: I 'love' unicorns => I "love" unicorns.
- [to-single-quotes ![GitHub Repo stars](https://img.shields.io/github/stars/sindresorhus/to-single-quotes-cli) ![GitHub last commit](https://img.shields.io/github/last-commit/sindresorhus/to-single-quotes-cli)](https://github.com/sindresorhus/to-single-quotes-cli) - Convert matching double-quotes to single-quotes: I "love" unicorns → I 'love' unicorns.
- [gdb-dashboard ![GitHub Repo stars](https://img.shields.io/github/stars/cyrus-and/gdb-dashboard) ![GitHub last commit](https://img.shields.io/github/last-commit/cyrus-and/gdb-dashboard)](https://github.com/cyrus-and/gdb-dashboard) - Modular visual interface for GDB in Python.
...
- [google-wifi-status ![GitHub Repo stars](https://img.shields.io/github/stars/joelgeorgev/google-wifi-status) ![GitHub last commit](https://img.shields.io/github/last-commit/joelgeorgev/google-wifi-status)](https://github.com/joelgeorgev/google-wifi-status) - A Node.js CLI app that displays status of your Google Wifi / OnHub router.
- [calories ![GitHub Repo stars](https://img.shields.io/github/stars/zupzup/calories) ![GitHub last commit](https://img.shields.io/github/last-commit/zupzup/calories)](https://github.com/zupzup/calories) - Calories and weight tracker.
- [trino ![GitHub Repo stars](https://img.shields.io/github/stars/eneserdogan/trino) ![GitHub last commit](https://img.shields.io/github/last-commit/eneserdogan/trino)](https://github.com/eneserdogan/trino) - Trino CLI allows a quick and easy translation of words and phrases entered in the command line.
- [alex ![GitHub Repo stars](https://img.shields.io/github/stars/wooorm/alex) ![GitHub last commit](https://img.shields.io/github/last-commit/wooorm/alex)](https://github.com/wooorm/alex) - This enhances texts with checking for insensitive, inconsiderate writing by catching many possible offences.
- [xiringuito ![GitHub Repo stars](https://img.shields.io/github/stars/ivanilves/xiringuito) ![GitHub last commit](https://img.shields.io/github/last-commit/ivanilves/xiringuito)](https://github.com/ivanilves/xiringuito) - A "poor man's VPN". An SSH-based "VPN" that's easy to install, but with slower performance than a real VPN.
- [nasa-cli ![GitHub Repo stars](https://img.shields.io/github/stars/xxczaki/nasa-cli) ![GitHub last commit](https://img.shields.io/github/last-commit/xxczaki/nasa-cli)](https://github.com/xxczaki/nasa-cli) - Download NASA Picture of the Day from your terminal.
- [googlr ![GitHub Repo stars](https://img.shields.io/github/stars/Camji55/googlr) ![GitHub last commit](https://img.shields.io/github/last-commit/Camji55/googlr)](https://github.com/Camji55/googlr) - Search Google from the command line.
