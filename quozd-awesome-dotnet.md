...
* [MVC.Template ![GitHub Repo stars](https://img.shields.io/github/stars/NonFactors/AspNetCore.Template) ![GitHub last commit](https://img.shields.io/github/last-commit/NonFactors/AspNetCore.Template)](https://github.com/NonFactors/AspNetCore.Template) - ASP.NET Core MVC project starter template.
...
* [DotNetOpenAuth ![GitHub Repo stars](https://img.shields.io/github/stars/DotNetOpenAuth/DotNetOpenAuth) ![GitHub last commit](https://img.shields.io/github/last-commit/DotNetOpenAuth/DotNetOpenAuth)](https://github.com/DotNetOpenAuth/DotNetOpenAuth) - A C# implementation of the OpenID, OAuth and InfoCard protocols
...
* [JustCli ![GitHub Repo stars](https://img.shields.io/github/stars/jden123/JustCli) ![GitHub last commit](https://img.shields.io/github/last-commit/jden123/JustCli)](https://github.com/jden123/JustCli) - That’s just a quick way to create your own command line tool.
...
* [Piranha CMS ![GitHub Repo stars](https://img.shields.io/github/stars/PiranhaCMS/Piranha) ![GitHub last commit](https://img.shields.io/github/last-commit/PiranhaCMS/Piranha)](https://github.com/PiranhaCMS/Piranha) - Piranha is the fun, fast and lightweight .NET framework for developing cms-based web applications with an extra bite. It's built on ASP.NET MVC and Web Pages and is fully compatible with both Visual Studio and WebMatrix. https://piranhacms.org
...
* [Bridge.NET ![GitHub Repo stars](https://img.shields.io/github/stars/bridgedotnet/Bridge) ![GitHub last commit](https://img.shields.io/github/last-commit/bridgedotnet/Bridge)](https://github.com/bridgedotnet/Bridge) - Open Source C# to JavaScript Compiler https://bridge.net/
...
* [Storage.Net ![GitHub Repo stars](https://img.shields.io/github/stars/aloneguid/storage) ![GitHub last commit](https://img.shields.io/github/last-commit/aloneguid/storage)](https://github.com/aloneguid/storage) - Generic storage abstractions and implementations for popular cloud storage providers like Amazon S3, Azure Service Bus, Azure Event Hub, Azure Storage, Azure Data Lake Store and many others.
...
* [.NEXT Raft ![GitHub Repo stars](https://img.shields.io/github/stars/sakno/dotNext) ![GitHub last commit](https://img.shields.io/github/last-commit/sakno/dotNext)](https://github.com/sakno/dotNext/tree/master/src/cluster) - Raft implementation for .NET and ASP.NET Core that allows to build clustered microservices powered by distributed consensus and replication
...
* [Paypal Merchant SDK ![GitHub Repo stars](https://img.shields.io/github/stars/paypal/merchant-sdk-dotnet) ![GitHub last commit](https://img.shields.io/github/last-commit/paypal/merchant-sdk-dotnet)](https://github.com/paypal/merchant-sdk-dotnet) - Official PayPal Merchant SDK for .NET
* [NopCommerce ![GitHub Repo stars](https://img.shields.io/github/stars/nopSolutions/nopCommerce) ![GitHub last commit](https://img.shields.io/github/last-commit/nopSolutions/nopCommerce)](https://github.com/nopSolutions/nopCommerce) - nopCommerce. Free open-source e-commerce shopping cart (ASP.NET Core)
...
* [SmartStoreNET ![GitHub Repo stars](https://img.shields.io/github/stars/smartstore/SmartStoreNET) ![GitHub last commit](https://img.shields.io/github/last-commit/smartstore/SmartStoreNET)](https://github.com/smartstore/SmartStoreNET) - Free ASP.NET MVC e-commerce Shopping Cart Solution
...
* [Square ![GitHub Repo stars](https://img.shields.io/github/stars/square/connect-csharp-sdk) ![GitHub last commit](https://img.shields.io/github/last-commit/square/connect-csharp-sdk)](https://github.com/square/connect-csharp-sdk) - The official SDK for Square payments and other Square APIs.
...
* [NGraphics ![GitHub Repo stars](https://img.shields.io/github/stars/praeclarum/NGraphics) ![GitHub last commit](https://img.shields.io/github/last-commit/praeclarum/NGraphics)](https://github.com/praeclarum/NGraphics) - NGraphics is a cross-platform library for rendering vector graphics on .NET
...
* [Live-Charts ![GitHub Repo stars](https://img.shields.io/github/stars/Live-Charts/Live-Charts) ![GitHub last commit](https://img.shields.io/github/last-commit/Live-Charts/Live-Charts)](https://github.com/Live-Charts/Live-Charts) - An Animated, MVVM oriented and modern charting library
...
* [Silk.NET ![GitHub Repo stars](https://img.shields.io/github/stars/Ultz/Silk.NET) ![GitHub last commit](https://img.shields.io/github/last-commit/Ultz/Silk.NET)](https://github.com/Ultz/Silk.NET) - A cross-platform, high-performance, low-level .NET Standard wrapper for many advanced APIs such as OpenGL, OpenCL, OpenAL, OpenXR, Assimp, GLFW, as well as many others. In addition to wrapping over Native APIs, it also comes with its own Windowing and Input abstraction. This makes game and application development with Silk.NET a breeze, and has pretty much everything a 3D application developer would need.
* [Veldrid ![GitHub Repo stars](https://img.shields.io/github/stars/mellinoe/veldrid) ![GitHub last commit](https://img.shields.io/github/last-commit/mellinoe/veldrid)](https://github.com/mellinoe/veldrid) - A low-level, portable graphics and compute library for .NET
* [RealTimeGraphX ![GitHub Repo stars](https://img.shields.io/github/stars/royben/RealTimeGraphX) ![GitHub last commit](https://img.shields.io/github/last-commit/royben/RealTimeGraphX)](https://github.com/royben/RealTimeGraphX) - RealTimeGraphX is a data type agnostic, high performance plotting library for WPF, UWP and soon, Xamarin Forms.

## GUI

* [HandyControl ![GitHub Repo stars](https://img.shields.io/github/stars/HandyOrg/HandyControl) ![GitHub last commit](https://img.shields.io/github/last-commit/HandyOrg/HandyControl)](https://github.com/HandyOrg/HandyControl) - Contains some simple and commonly used WPF controls
...
* [QtSharp ![GitHub Repo stars](https://img.shields.io/github/stars/ddobrev/QtSharp) ![GitHub last commit](https://img.shields.io/github/last-commit/ddobrev/QtSharp)](https://github.com/ddobrev/QtSharp) - Mono/.NET Bindings for Qt
...
* [MahApps.Metro ![GitHub Repo stars](https://img.shields.io/github/stars/MahApps/MahApps.Metro) ![GitHub last commit](https://img.shields.io/github/last-commit/MahApps/MahApps.Metro)](https://github.com/MahApps/MahApps.Metro) - Toolkit for creating Metro-styled WPF apps
* [Callisto ![GitHub Repo stars](https://img.shields.io/github/stars/timheuer/callisto) ![GitHub last commit](https://img.shields.io/github/last-commit/timheuer/callisto)](https://github.com/timheuer/callisto) - A control toolkit for Windows 8 XAML applications. Contains some UI controls to make it easier to create Windows UI style apps for the Windows Store in accordance with Windows UI guidelines.
...
* [AvalonEdit ![GitHub Repo stars](https://img.shields.io/github/stars/icsharpcode/AvalonEdit) ![GitHub last commit](https://img.shields.io/github/last-commit/icsharpcode/AvalonEdit)](https://github.com/icsharpcode/AvalonEdit) - The WPF-based text editor component used in SharpDevelop
* [XWT ![GitHub Repo stars](https://img.shields.io/github/stars/mono/xwt) ![GitHub last commit](https://img.shields.io/github/last-commit/mono/xwt)](https://github.com/mono/xwt) - A cross-platform UI toolkit for creating desktop applications with .NET and Mono
* [Gtk# ![GitHub Repo stars](https://img.shields.io/github/stars/mono/gtk-sharp) ![GitHub last commit](https://img.shields.io/github/last-commit/mono/gtk-sharp)](https://github.com/mono/gtk-sharp) - Gtk# is a Mono/.NET binding to the cross platform Gtk+ GUI toolkit and the foundation of most GUI apps built with Mono
* [MaterialDesignInXamlToolkit](http://materialdesigninxaml.net/) - Toolkit for creating Material Design styled WPF apps
* [Eto.Forms ![GitHub Repo stars](https://img.shields.io/github/stars/picoe/Eto) ![GitHub last commit](https://img.shields.io/github/last-commit/picoe/Eto)](https://github.com/picoe/Eto) - Cross-platform GUI framework for desktop and mobile applications in .NET and Mono
* [Dragablz ![GitHub Repo stars](https://img.shields.io/github/stars/ButchersBoy/Dragablz) ![GitHub last commit](https://img.shields.io/github/last-commit/ButchersBoy/Dragablz)](https://github.com/ButchersBoy/Dragablz) - Dragable, tearable WPF tab control (similar to Chrome) which supports layouts and is full themeable, including themese compatible with MahApps and Material Design.
* [Fluent.Ribbon ![GitHub Repo stars](https://img.shields.io/github/stars/fluentribbon/Fluent.Ribbon) ![GitHub last commit](https://img.shields.io/github/last-commit/fluentribbon/Fluent.Ribbon)](https://github.com/fluentribbon/Fluent.Ribbon) - Fluent Ribbon Control Suite is a library that implements an Office- and Windows 8-like Ribbon for WPF.
* [Office Ribbon ![GitHub Repo stars](https://img.shields.io/github/stars/RibbonWinForms/RibbonWinForms) ![GitHub last commit](https://img.shields.io/github/last-commit/RibbonWinForms/RibbonWinForms)](https://github.com/RibbonWinForms/RibbonWinForms) - A library that implements MS Office Ribbon for WinForms.
...
* [Xamarin.Forms ![GitHub Repo stars](https://img.shields.io/github/stars/xamarin/Xamarin.Forms) ![GitHub last commit](https://img.shields.io/github/last-commit/xamarin/Xamarin.Forms)](https://github.com/xamarin/Xamarin.Forms) - Build native UIs for iOS, Android and Windows from a single, shared C# codebase.
* [SciterSharp ![GitHub Repo stars](https://img.shields.io/github/stars/ramon-mendes/SciterSharp) ![GitHub last commit](https://img.shields.io/github/last-commit/ramon-mendes/SciterSharp)](https://github.com/ramon-mendes/SciterSharp) - Create .NET cross-platform desktop apps using not just HTML, but all features of Sciter engine: CSS3, SVG, scripting, AJAX, &lt;video&gt;... Sciter is free for commercial use
...
* [Modern UI for WPF - MUI ![GitHub Repo stars](https://img.shields.io/github/stars/firstfloorsoftware/mui) ![GitHub last commit](https://img.shields.io/github/last-commit/firstfloorsoftware/mui)](https://github.com/firstfloorsoftware/mui) - Set of controls and styles to convert WPF applications into a great looking Modern UI apps.
...
* [Ooui ![GitHub Repo stars](https://img.shields.io/github/stars/praeclarum/Ooui) ![GitHub last commit](https://img.shields.io/github/last-commit/praeclarum/Ooui)](https://github.com/praeclarum/Ooui) - A small cross-platform UI library that brings the simplicity of native UI development to the web
...
* [Windows UI Library ![GitHub Repo stars](https://img.shields.io/github/stars/microsoft/microsoft-ui-xaml) ![GitHub last commit](https://img.shields.io/github/last-commit/microsoft/microsoft-ui-xaml)](https://github.com/microsoft/microsoft-ui-xaml) - The Windows UI Library (WinUI) provides official native Microsoft UI controls and features for Windows UWP apps.
...
* [Ookii.Dialogs.Wpf ![GitHub Repo stars](https://img.shields.io/github/stars/augustoproiete/ookii-dialogs-wpf) ![GitHub last commit](https://img.shields.io/github/last-commit/augustoproiete/ookii-dialogs-wpf)](https://github.com/augustoproiete/ookii-dialogs-wpf) - Enable WPF applications to access common Windows dialogs such as task dialogs, credential dialog, progress dialog, folder browser dialog, and more
* [Ookii.Dialogs.WinForms ![GitHub Repo stars](https://img.shields.io/github/stars/augustoproiete/ookii-dialogs-winforms) ![GitHub last commit](https://img.shields.io/github/last-commit/augustoproiete/ookii-dialogs-winforms)](https://github.com/augustoproiete/ookii-dialogs-winforms) - Enable Windows Forms applications to access common Windows dialogs such as task dialogs, credential dialog, progress dialog, folder browser dialog, and more

## HTML and CSS

* [AngleSharp ![GitHub Repo stars](https://img.shields.io/github/stars/AngleSharp/AngleSharp) ![GitHub last commit](https://img.shields.io/github/last-commit/AngleSharp/AngleSharp)](https://github.com/AngleSharp/AngleSharp) - Complete HTML5 DOM and CSS3 OM construction
* [dotless ![GitHub Repo stars](https://img.shields.io/github/stars/dotless/dotless) ![GitHub last commit](https://img.shields.io/github/last-commit/dotless/dotless)](https://github.com/dotless/dotless) - .NET port of the Ruby Less CSS lib http://www.dotlesscss.org
* [ExCSS ![GitHub Repo stars](https://img.shields.io/github/stars/TylerBrinks/ExCSS) ![GitHub last commit](https://img.shields.io/github/last-commit/TylerBrinks/ExCSS)](https://github.com/TylerBrinks/ExCSS) - CSS3 parser library for C#
...
* [LibSass Host ![GitHub Repo stars](https://img.shields.io/github/stars/Taritsyn/LibSassHost) ![GitHub last commit](https://img.shields.io/github/last-commit/Taritsyn/LibSassHost)](https://github.com/Taritsyn/LibSassHost) - .NET wrapper around the [libSass](https://sass-lang.com/libsass) library with the ability to support a virtual file system
* [LtGt ![GitHub Repo stars](https://img.shields.io/github/stars/Tyrrrz/LtGt) ![GitHub last commit](https://img.shields.io/github/last-commit/Tyrrrz/LtGt)](https://github.com/Tyrrrz/LtGt) - lightweight HTML processor, can be used to parse and navigate DOM, handles CSS selectors, can convert to Linq2Xml, easily extensible, and more.
...
* [Http.fs ![GitHub Repo stars](https://img.shields.io/github/stars/haf/Http.fs) ![GitHub last commit](https://img.shields.io/github/last-commit/haf/Http.fs)](https://github.com/haf/Http.fs) - A functional HTTP client for F#.
...
* [EasyHttp ![GitHub Repo stars](https://img.shields.io/github/stars/EasyHttp/EasyHttp) ![GitHub last commit](https://img.shields.io/github/last-commit/EasyHttp/EasyHttp)](https://github.com/EasyHttp/EasyHttp) - HTTP library for C#
...
* [HttpClientGoodies ![GitHub Repo stars](https://img.shields.io/github/stars/jeffijoe/httpclientgoodies.net) ![GitHub last commit](https://img.shields.io/github/last-commit/jeffijoe/httpclientgoodies.net)](https://github.com/jeffijoe/httpclientgoodies.net) - utilities for working with `HttpClient`
* [CoreRPC ![GitHub Repo stars](https://img.shields.io/github/stars/kekekeks/CoreRPC) ![GitHub last commit](https://img.shields.io/github/last-commit/kekekeks/CoreRPC)](https://github.com/kekekeks/CoreRPC) - Extensible library for WCF-like RPC targeting netstandard1.3. Compatible with .NET, Mono and .NET Core.
...
* [AvalonStudio ![GitHub Repo stars](https://img.shields.io/github/stars/VitalElement/AvalonStudio) ![GitHub last commit](https://img.shields.io/github/last-commit/VitalElement/AvalonStudio)](https://github.com/VitalElement/AvalonStudio) - An extensible, cross platform IDE written in C# for Embedded C/C++, .NET Core, Avalonia and Typescript
* [SharpDevelop ![GitHub Repo stars](https://img.shields.io/github/stars/icsharpcode/SharpDevelop) ![GitHub last commit](https://img.shields.io/github/last-commit/icsharpcode/SharpDevelop)](https://github.com/icsharpcode/SharpDevelop) - A free IDE for .NET programming languages
* [MonoDevelop ![GitHub Repo stars](https://img.shields.io/github/stars/mono/monodevelop) ![GitHub last commit](https://img.shields.io/github/last-commit/mono/monodevelop)](https://github.com/mono/monodevelop) - MonoDevelop is a cross-platform IDE mostly aimed at Mono/.NET developers
...
* [ImageProcessor ![GitHub Repo stars](https://img.shields.io/github/stars/JimBobSquarePants/ImageProcessor) ![GitHub last commit](https://img.shields.io/github/last-commit/JimBobSquarePants/ImageProcessor)](https://github.com/JimBobSquarePants/ImageProcessor) - Open-source .NET library to manipulate images on-the-fly.
* [ImageSharp ![GitHub Repo stars](https://img.shields.io/github/stars/SixLabors/ImageSharp) ![GitHub last commit](https://img.shields.io/github/last-commit/SixLabors/ImageSharp)](https://github.com/SixLabors/ImageSharp) - Fully managed cross-platform library for processing of image files.
* [DynamicImage](https://dynamicimage.apphb.com/) - High-performance open-source image manipulation library for ASP.NET.
* [MetadataExtractor ![GitHub Repo stars](https://img.shields.io/github/stars/drewnoakes/metadata-extractor-dotnet) ![GitHub last commit](https://img.shields.io/github/last-commit/drewnoakes/metadata-extractor-dotnet)](https://github.com/drewnoakes/metadata-extractor-dotnet) - Extracts Exif, IPTC, XMP, ICC and other metadata from image files.
* [Emgu CV](http://www.emgu.com/wiki/index.php/Main_Page) - Cross-platform .NET wrapper for the OpenCV library.
* [DotImaging ![GitHub Repo stars](https://img.shields.io/github/stars/dajuric/dot-imaging) ![GitHub last commit](https://img.shields.io/github/last-commit/dajuric/dot-imaging)](https://github.com/dajuric/dot-imaging) - Minimalistic .NET imaging portable platform
* [Magick.NET ![GitHub Repo stars](https://img.shields.io/github/stars/dlemstra/Magick.NET) ![GitHub last commit](https://img.shields.io/github/last-commit/dlemstra/Magick.NET)](https://github.com/dlemstra/Magick.NET) - .NET wrapper for the ImageMagick library.
* [OpenCvSharp ![GitHub Repo stars](https://img.shields.io/github/stars/shimat/opencvsharp) ![GitHub last commit](https://img.shields.io/github/last-commit/shimat/opencvsharp)](https://github.com/shimat/opencvsharp/) - Cross platform wrapper of OpenCV for .NET Framework.
...
* [Squirrel ![GitHub Repo stars](https://img.shields.io/github/stars/squirrel/squirrel.windows) ![GitHub last commit](https://img.shields.io/github/last-commit/squirrel/squirrel.windows)](https://github.com/squirrel/squirrel.windows) - Squirrel is both a set of tools and a library, to completely manage both installation and updating your desktop Windows application.
* [Chocolatey ![GitHub Repo stars](https://img.shields.io/github/stars/chocolatey/choco) ![GitHub last commit](https://img.shields.io/github/last-commit/chocolatey/choco)](https://github.com/chocolatey/choco) - like `yum` or `apt-get`, but for Windows.
* [Wax](https://marketplace.visualstudio.com/items?itemName=TomEnglert.Wax) - An interactive editor for WiX projects.
* [Onova ![GitHub Repo stars](https://img.shields.io/github/stars/Tyrrrz/Onova) ![GitHub last commit](https://img.shields.io/github/last-commit/Tyrrrz/Onova)](https://github.com/Tyrrrz/Onova) - An unopinionated auto-update framework for desktop applications.

## Interactive programming

* [.NET Interactive ![GitHub Repo stars](https://img.shields.io/github/stars/dotnet/interactive) ![GitHub last commit](https://img.shields.io/github/last-commit/dotnet/interactive)](https://github.com/dotnet/interactive) - .NET Interactive takes the power of .NET and embeds it into your interactive experiences.

## Internationalization

* [i18n ![GitHub Repo stars](https://img.shields.io/github/stars/turquoiseowl/i18n) ![GitHub last commit](https://img.shields.io/github/last-commit/turquoiseowl/i18n)](https://github.com/turquoiseowl/i18n) - Smart internationalization for ASP.NET MVC
* [MessageFormat.NET ![GitHub Repo stars](https://img.shields.io/github/stars/jeffijoe/MessageFormat.NET) ![GitHub last commit](https://img.shields.io/github/last-commit/jeffijoe/MessageFormat.NET)](https://github.com/jeffijoe/MessageFormat.NET) - ICU MessageFormat implementation in .NET lets you write contextual UI messages (PCL library)
* [ResX Resource Manager ![GitHub Repo stars](https://img.shields.io/github/stars/dotnet/ResXResourceManager) ![GitHub last commit](https://img.shields.io/github/last-commit/dotnet/ResXResourceManager)](https://github.com/dotnet/ResXResourceManager) - The most popular free tool to localize all kind of applications with resx-based resources.

## Interoperability

* [CppSharp ![GitHub Repo stars](https://img.shields.io/github/stars/mono/CppSharp) ![GitHub last commit](https://img.shields.io/github/last-commit/mono/CppSharp)](https://github.com/mono/CppSharp) - Tools to surface C++ APIs to C#
* [Sharpen ![GitHub Repo stars](https://img.shields.io/github/stars/mono/sharpen) ![GitHub last commit](https://img.shields.io/github/last-commit/mono/sharpen)](https://github.com/mono/sharpen) - Sharpen is an Eclipse plugin created by db4o that allows you to convert your Java project into C#
* [CXXI ![GitHub Repo stars](https://img.shields.io/github/stars/mono/cxxi) ![GitHub last commit](https://img.shields.io/github/last-commit/mono/cxxi)](https://github.com/mono/cxxi) - C++ interop framework
* [pythonnet ![GitHub Repo stars](https://img.shields.io/github/stars/pythonnet/pythonnet) ![GitHub last commit](https://img.shields.io/github/last-commit/pythonnet/pythonnet)](https://github.com/pythonnet/pythonnet) - Python and .NET interop framework
* [PInvoke Interop Assistant ![GitHub Repo stars](https://img.shields.io/github/stars/jaredpar/pinvoke-interop-assistant) ![GitHub last commit](https://img.shields.io/github/last-commit/jaredpar/pinvoke-interop-assistant)](https://github.com/jaredpar/pinvoke-interop-assistant) - Converts C to managed P/Invoke signatures or verse visa.
* [pinvoke ![GitHub Repo stars](https://img.shields.io/github/stars/dotnet/pinvoke) ![GitHub last commit](https://img.shields.io/github/last-commit/dotnet/pinvoke)](https://github.com/dotnet/pinvoke) - A library containing P/Invoke code for latest Windows OS.
* [LegacyWrapper ![GitHub Repo stars](https://img.shields.io/github/stars/CodefoundryDE/LegacyWrapper) ![GitHub last commit](https://img.shields.io/github/last-commit/CodefoundryDE/LegacyWrapper)](https://github.com/CodefoundryDE/LegacyWrapper) - LegacyWrapper uses a wrapper process to call DLLs from a process of the opposing architecture (x86 or AMD64).
* [Pyrolite ![GitHub Repo stars](https://img.shields.io/github/stars/irmen/Pyrolite) ![GitHub last commit](https://img.shields.io/github/last-commit/irmen/Pyrolite)](https://github.com/irmen/Pyrolite) - This library allows your Java or .NET program to interface very easily with
the Python world. It uses the Pyro protocol to call methods on remote objects.

## IoC

* [Castle Windsor ![GitHub Repo stars](https://img.shields.io/github/stars/castleproject/Windsor) ![GitHub last commit](https://img.shields.io/github/last-commit/castleproject/Windsor)](https://github.com/castleproject/Windsor) - Castle Windsor is best of breed, mature Inversion of Control container available for .NET and Silverlight
* [Unity ![GitHub Repo stars](https://img.shields.io/github/stars/unitycontainer/unity) ![GitHub last commit](https://img.shields.io/github/last-commit/unitycontainer/unity)](https://github.com/unitycontainer/unity) - Lightweight extensible dependency injection container with support for constructor, property, and method call injection
* [Autofac ![GitHub Repo stars](https://img.shields.io/github/stars/autofac/Autofac) ![GitHub last commit](https://img.shields.io/github/last-commit/autofac/Autofac)](https://github.com/autofac/Autofac) - An addictive .NET IoC container
* [DryIoc ![GitHub Repo stars](https://img.shields.io/github/stars/dadhi/DryIoc) ![GitHub last commit](https://img.shields.io/github/last-commit/dadhi/DryIoc)](https://github.com/dadhi/DryIoc) - Simple, fast all fully featured IoC container.
* [Ninject ![GitHub Repo stars](https://img.shields.io/github/stars/ninject/ninject) ![GitHub last commit](https://img.shields.io/github/last-commit/ninject/ninject)](https://github.com/ninject/ninject) - The ninja of .NET dependency injectors
* [Spring.Net ![GitHub Repo stars](https://img.shields.io/github/stars/spring-projects/spring-net) ![GitHub last commit](https://img.shields.io/github/last-commit/spring-projects/spring-net)](https://github.com/spring-projects/spring-net) - Spring.NET is an open source application framework that makes building  enterprise .NET applications easier
...
* [LightInject ![GitHub Repo stars](https://img.shields.io/github/stars/seesharper/LightInject) ![GitHub last commit](https://img.shields.io/github/last-commit/seesharper/LightInject)](https://github.com/seesharper/LightInject) - A ultra lightweight IoC container
* [Simple Injector ![GitHub Repo stars](https://img.shields.io/github/stars/simpleinjector/SimpleInjector) ![GitHub last commit](https://img.shields.io/github/last-commit/simpleinjector/SimpleInjector)](https://github.com/simpleinjector/SimpleInjector) - Simple Injector is an easy-to-use Dependency Injection (DI) library for .NET 4+ that supports Silverlight 4+, Windows Phone 8, Windows 8 including Universal apps and Mono.
* [Microsoft.Extensions.DependencyInjection ![GitHub Repo stars](https://img.shields.io/github/stars/aspnet/DependencyInjection) ![GitHub last commit](https://img.shields.io/github/last-commit/aspnet/DependencyInjection)](https://github.com/aspnet/DependencyInjection) - The default IoC container for ASP.NET Core applications.
...
* [VS MEF ![GitHub Repo stars](https://img.shields.io/github/stars/Microsoft/vs-mef) ![GitHub last commit](https://img.shields.io/github/last-commit/Microsoft/vs-mef)](https://github.com/Microsoft/vs-mef) - Managed Extensibility Framework (MEF) implementation used by Visual Studio.
* [TinyIoC ![GitHub Repo stars](https://img.shields.io/github/stars/grumpydev/TinyIoC) ![GitHub last commit](https://img.shields.io/github/last-commit/grumpydev/TinyIoC)](https://github.com/grumpydev/TinyIoC) - An easy to use, hassle free, Inversion of Control Container for small projects, libraries and beginners alike.
...
* [ClearScript ![GitHub Repo stars](https://img.shields.io/github/stars/Microsoft/ClearScript) ![GitHub last commit](https://img.shields.io/github/last-commit/Microsoft/ClearScript)](https://github.com/Microsoft/ClearScript) - A library that makes it easy to add scripting to your .NET applications. It currently supports JavaScript (via V8 and JScript) and VBScript.
* [Edge.js ![GitHub Repo stars](https://img.shields.io/github/stars/tjanczuk/edge) ![GitHub last commit](https://img.shields.io/github/last-commit/tjanczuk/edge)](https://github.com/tjanczuk/edge) - Run .NET and Node.js code in-process on Windows, macOS, and Linux
* [Jint ![GitHub Repo stars](https://img.shields.io/github/stars/sebastienros/jint) ![GitHub last commit](https://img.shields.io/github/last-commit/sebastienros/jint)](https://github.com/sebastienros/jint) - JavaScript interpreter for .NET which provides full ECMA 5.1 compliance and can run on any .NET platform.
* [Jurassic ![GitHub Repo stars](https://img.shields.io/github/stars/paulbartrum/jurassic) ![GitHub last commit](https://img.shields.io/github/last-commit/paulbartrum/jurassic)](https://github.com/paulbartrum/jurassic) - A implementation of the ECMAScript language and runtime. It aims to provide the best performing and most standards-compliant implementation of JavaScript for .NET.

## Logging

* [Essential Diagnostics ![GitHub Repo stars](https://img.shields.io/github/stars/sgryphon/essential-diagnostics) ![GitHub last commit](https://img.shields.io/github/last-commit/sgryphon/essential-diagnostics)](https://github.com/sgryphon/essential-diagnostics) - Extends the inbuilt features of System.Diagnostics namespace to provide flexible logging
* [NLog ![GitHub Repo stars](https://img.shields.io/github/stars/nlog/NLog) ![GitHub last commit](https://img.shields.io/github/last-commit/nlog/NLog)](https://github.com/nlog/NLog/) - NLog - Advanced .NET and Silverlight logging
* [Logazmic ![GitHub Repo stars](https://img.shields.io/github/stars/ihtfw/Logazmic) ![GitHub last commit](https://img.shields.io/github/last-commit/ihtfw/Logazmic)](https://github.com/ihtfw/Logazmic) - Open source NLog viewer for Windows
* [ELMAH](https://elmah.github.io/) - Official ELMAH site
* [Elmah MVC ![GitHub Repo stars](https://img.shields.io/github/stars/alexbeletsky/elmah-mvc) ![GitHub last commit](https://img.shields.io/github/last-commit/alexbeletsky/elmah-mvc)](https://github.com/alexbeletsky/elmah-mvc) - Elmah for MVC
* [Logary ![GitHub Repo stars](https://img.shields.io/github/stars/logary/logary) ![GitHub last commit](https://img.shields.io/github/last-commit/logary/logary)](https://github.com/logary/logary) - Logary is a high performance, multi-target logging, metric, tracing and health-check library for Mono and .NET. .NET's answer to DropWizard. Supports many targets, built for micro-services.
...
* [Rollbar.NET ![GitHub Repo stars](https://img.shields.io/github/stars/rollbar/Rollbar.NET) ![GitHub last commit](https://img.shields.io/github/last-commit/rollbar/Rollbar.NET)](https://github.com/rollbar/Rollbar.NET) - Simplifies real-time remote error monitoring while using Rollbar.com. Open-source Rollbar Notifier SDK for any .NET-based technology stack. The SDK that can be used in any application built on the following .NET versions: .NET Core 2.0+, .NET Standard 2.0+, .NET Full Framework 4.5.1+, Mono, Xamarin, and, in general, any implementation of the .NET Standard 2.0+. It simplifies building data payloads based on exception data, tracing data, informational messages, and telemetry data and sends the payloads to the Rollbar API for remote monitoring and analysis of the hosting application's behavior.
* [Sentry ![GitHub Repo stars](https://img.shields.io/github/stars/getsentry/sentry-dotnet) ![GitHub last commit](https://img.shields.io/github/last-commit/getsentry/sentry-dotnet)](https://github.com/getsentry/sentry-dotnet) - .NET SDK for [Sentry](https://sentry.io/welcome/) Open-source error tracking that helps developers monitor and fix crashes in real time..
* [Serilog ![GitHub Repo stars](https://img.shields.io/github/stars/serilog/serilog) ![GitHub last commit](https://img.shields.io/github/last-commit/serilog/serilog)](https://github.com/serilog/serilog) - A no-nonsense logging library for the NoSQL era. Combines the best of traditional and structured diagnostic logging in an easy-to-use package.
* [StackExchange.Exceptional ![GitHub Repo stars](https://img.shields.io/github/stars/NickCraver/StackExchange.Exceptional) ![GitHub last commit](https://img.shields.io/github/last-commit/NickCraver/StackExchange.Exceptional)](https://github.com/NickCraver/StackExchange.Exceptional) - Error handler used for the Stack Exchange network
* [Semantic Logging Application Block (SLAB) ![GitHub Repo stars](https://img.shields.io/github/stars/MicrosoftArchive/semantic-logging) ![GitHub last commit](https://img.shields.io/github/last-commit/MicrosoftArchive/semantic-logging)](https://github.com/MicrosoftArchive/semantic-logging) - Extends the inbuilt features of System.Diagnostics.Tracing namespace (EventSource class) to log to several sinks including Azure Tables, Databases, files (JSON, XML, text). Supports in-process and out-of-process logging through ETW, and Rx for real-time filtering/aggregating of events.
* [Foundatio ![GitHub Repo stars](https://img.shields.io/github/stars/FoundatioFx/Foundatio) ![GitHub last commit](https://img.shields.io/github/last-commit/FoundatioFx/Foundatio)](https://github.com/FoundatioFx/Foundatio#logging) - A fluent logging API that can be used to log messages throughout your application.
* [Exceptionless ![GitHub Repo stars](https://img.shields.io/github/stars/exceptionless/Exceptionless.Net) ![GitHub last commit](https://img.shields.io/github/last-commit/exceptionless/Exceptionless.Net)](https://github.com/exceptionless/Exceptionless.Net) - Exceptionless .NET Client
...
* [Accord.NET Extensions ![GitHub Repo stars](https://img.shields.io/github/stars/dajuric/accord-net-extensions) ![GitHub last commit](https://img.shields.io/github/last-commit/dajuric/accord-net-extensions)](https://github.com/dajuric/accord-net-extensions) - Advanced image processing and computer vision algorithms made as fluent extensions.
...
* [numl ![GitHub Repo stars](https://img.shields.io/github/stars/sethjuarez/numl) ![GitHub last commit](https://img.shields.io/github/last-commit/sethjuarez/numl)](https://github.com/sethjuarez/numl) - Designed to include the most popular supervised and unsupervised learning algorithms while minimizing the friction involved with creating the predictive models.
...
* [Spreads ![GitHub Repo stars](https://img.shields.io/github/stars/Spreads/Spreads) ![GitHub last commit](https://img.shields.io/github/last-commit/Spreads/Spreads)](https://github.com/Spreads/Spreads/) - Series and Panels for Real-time and Exploratory Analysis of Data Streams. Spreads library is optimized for performance and memory usage. It is several times faster than other open source projects.
...
* [Synapses ![GitHub Repo stars](https://img.shields.io/github/stars/mrdimosthenis/Synapses) ![GitHub last commit](https://img.shields.io/github/last-commit/mrdimosthenis/Synapses)](https://github.com/mrdimosthenis/Synapses) - An in-memory neural network library written in F#.
...
* [CommonMark.NET ![GitHub Repo stars](https://img.shields.io/github/stars/Knagis/CommonMark.NET) ![GitHub last commit](https://img.shields.io/github/last-commit/Knagis/CommonMark.NET)](https://github.com/Knagis/CommonMark.NET) - Implementation of CommonMark specification in C# for converting Markdown documents to HTML. Optimized for maximum performance and portability.
* [markdig ![GitHub Repo stars](https://img.shields.io/github/stars/lunet-io/markdig) ![GitHub last commit](https://img.shields.io/github/last-commit/lunet-io/markdig)](https://github.com/lunet-io/markdig) - A fast, powerful, CommonMark compliant, extensible Markdown processor for .NET.

## Mail

* [FluentEmail ![GitHub Repo stars](https://img.shields.io/github/stars/lukencode/FluentEmail) ![GitHub last commit](https://img.shields.io/github/last-commit/lukencode/FluentEmail)](https://github.com/lukencode/FluentEmail) - A fluent wrapper for System.Net.Mail with Razor templating support.
* [MailKit ![GitHub Repo stars](https://img.shields.io/github/stars/jstedfast/MailKit) ![GitHub last commit](https://img.shields.io/github/last-commit/jstedfast/MailKit)](https://github.com/jstedfast/MailKit) - A complete cross-platform mail stack including IMAP, POP3, SMTP, authentication and more. Built on top of MimeKit.
* [MimeKit ![GitHub Repo stars](https://img.shields.io/github/stars/jstedfast/MimeKit) ![GitHub last commit](https://img.shields.io/github/last-commit/jstedfast/MimeKit)](https://github.com/jstedfast/MimeKit) - A cross-platform .NET MIME creation and parser library with support for S/MIME, PGP, TNEF and Unix mbox spools.
...
* [UnitConversion ![GitHub Repo stars](https://img.shields.io/github/stars/atulmish/UnitConversion) ![GitHub last commit](https://img.shields.io/github/last-commit/atulmish/UnitConversion)](https://github.com/atulmish/UnitConversion) - Expansible Unit Conversion Library for .NET Core and .NET Framework
...
* [AutoDiff ![GitHub Repo stars](https://img.shields.io/github/stars/alexshtf/autodiff) ![GitHub last commit](https://img.shields.io/github/last-commit/alexshtf/autodiff)](https://github.com/alexshtf/autodiff) - AutoDiff is a library for quickly computing gradients of functions defined by expressions. Mainly useful in numerical optimization
* [GeometRi ![GitHub Repo stars](https://img.shields.io/github/stars/RiSearcher/GeometRi.CSharp) ![GitHub last commit](https://img.shields.io/github/last-commit/RiSearcher/GeometRi.CSharp)](https://github.com/RiSearcher/GeometRi.CSharp) - Simple and lightweight computational geometry library for .Net
...
* [CSCore ![GitHub Repo stars](https://img.shields.io/github/stars/filoe/cscore) ![GitHub last commit](https://img.shields.io/github/last-commit/filoe/cscore)](https://github.com/filoe/cscore) - An advanced audio library, supporting playback/recording, decoding/encoding and processing of audio data in realtime (effects, visualizations, ...).
* [TagLib# ![GitHub Repo stars](https://img.shields.io/github/stars/mono/taglib-sharp) ![GitHub last commit](https://img.shields.io/github/last-commit/mono/taglib-sharp)](https://github.com/mono/taglib-sharp) - TagLib# (aka taglib-sharp) is a library for reading and writing
...
* [C# StatsD Client ![GitHub Repo stars](https://img.shields.io/github/stars/Pereingo/statsd-csharp-client) ![GitHub last commit](https://img.shields.io/github/last-commit/Pereingo/statsd-csharp-client)](https://github.com/Pereingo/statsd-csharp-client) - C# client for Etsy's StatsD
* [Foundatio ![GitHub Repo stars](https://img.shields.io/github/stars/FoundatioFx/Foundatio) ![GitHub last commit](https://img.shields.io/github/last-commit/FoundatioFx/Foundatio)](https://github.com/FoundatioFx/Foundatio#metrics) - A common interface with in-memory, Redis, StatsD, and Metrics.NET implementations.

## Micro Framework
* [.NET Micro Framework Interpreter ![GitHub Repo stars](https://img.shields.io/github/stars/NETMF/netmf-interpreter) ![GitHub last commit](https://img.shields.io/github/last-commit/NETMF/netmf-interpreter)](https://github.com/NETMF/netmf-interpreter) - Microsoft® .NET Micro Framework (NETMF) for developing embedded applications on small devices using Visual Studio
...
* [Hashids.net ![GitHub Repo stars](https://img.shields.io/github/stars/ullmark/hashids.net) ![GitHub last commit](https://img.shields.io/github/last-commit/ullmark/hashids.net)](https://github.com/ullmark/hashids.net) - Generate short unique ids from integers, as per https://hashids.org
...
* [FlatMapper ![GitHub Repo stars](https://img.shields.io/github/stars/joaomatossilva/FlatMapper) ![GitHub last commit](https://img.shields.io/github/last-commit/joaomatossilva/FlatMapper)](https://github.com/joaomatossilva/FlatMapper) - A library to import and export data from and to plain text files in a LINQ-compatible way.
...
* [Valit ![GitHub Repo stars](https://img.shields.io/github/stars/valit-stack/Valit) ![GitHub last commit](https://img.shields.io/github/last-commit/valit-stack/Valit)](https://github.com/valit-stack/Valit) - Valit is dead simple, fluent validation for .NET Core.
...
* [LINQPad.QueryPlanVisualizer ![GitHub Repo stars](https://img.shields.io/github/stars/Giorgi/LINQPad.QueryPlanVisualizer) ![GitHub last commit](https://img.shields.io/github/last-commit/Giorgi/LINQPad.QueryPlanVisualizer)](https://github.com/Giorgi/LINQPad.QueryPlanVisualizer/)  - View SQL Server and Postgres query plans directly inside LINQPad.
* [Polly ![GitHub Repo stars](https://img.shields.io/github/stars/App-vNext/Polly) ![GitHub last commit](https://img.shields.io/github/last-commit/App-vNext/Polly)](https://github.com/App-vNext/Polly) - Express transient-exception-handling and resilience policies such as Retry, Wait-and-Retry, Circuit Breaker, and Bulkhead Isolation in a fluent manner. Fully thread-safe and full async support.  (4.0 / 4.5 / .NET Core / .NET Standard / Xamarin).
* [Rant ![GitHub Repo stars](https://img.shields.io/github/stars/TheBerkin/rant3) ![GitHub last commit](https://img.shields.io/github/last-commit/TheBerkin/rant3)](https://github.com/TheBerkin/rant3) - The Rant Procedural Text Generation DSL
* [ScriptCS ![GitHub Repo stars](https://img.shields.io/github/stars/scriptcs/scriptcs) ![GitHub last commit](https://img.shields.io/github/last-commit/scriptcs/scriptcs)](https://github.com/scriptcs/scriptcs) - Write C# apps with a text editor, NuGet and the power of Roslyn!
* [Shielded ![GitHub Repo stars](https://img.shields.io/github/stars/jbakic/Shielded) ![GitHub last commit](https://img.shields.io/github/last-commit/jbakic/Shielded)](https://github.com/jbakic/Shielded) - Software Transactional Memory (STM) implementation for .NET
...
* [ReactJS.NET ![GitHub Repo stars](https://img.shields.io/github/stars/reactjs/React.NET) ![GitHub last commit](https://img.shields.io/github/last-commit/reactjs/React.NET)](https://github.com/reactjs/React.NET) - ReactJS.NET is a library that makes it easier to use Babel along with Facebook's React and JSX from C#.
...
* [TypeShape ![GitHub Repo stars](https://img.shields.io/github/stars/eiriktsarpalis/TypeShape) ![GitHub last commit](https://img.shields.io/github/last-commit/eiriktsarpalis/TypeShape)](https://github.com/eiriktsarpalis/TypeShape) - TypeShape is a small, extensible F# library for practical generic programming
* [Streams ![GitHub Repo stars](https://img.shields.io/github/stars/nessos/Streams) ![GitHub last commit](https://img.shields.io/github/last-commit/nessos/Streams)](https://github.com/nessos/Streams) - A lightweight F#/C# library for efficient functional-style pipelines on streams of data.
* [Warden ![GitHub Repo stars](https://img.shields.io/github/stars/warden-stack/Warden) ![GitHub last commit](https://img.shields.io/github/last-commit/warden-stack/Warden)](https://github.com/warden-stack/Warden) - Define "health checks" for your applications, resources and infrastructure. Keep your Warden on the watch
* [ByteSize ![GitHub Repo stars](https://img.shields.io/github/stars/omar/ByteSize) ![GitHub last commit](https://img.shields.io/github/last-commit/omar/ByteSize)](https://github.com/omar/ByteSize) - ByteSize is a utility class that makes byte size representation in code easier by removing ambiguity of the value being represented. ByteSize is to bytes what System.TimeSpan is to time.
* [Jot ![GitHub Repo stars](https://img.shields.io/github/stars/anakic/jot) ![GitHub last commit](https://img.shields.io/github/last-commit/anakic/jot)](https://github.com/anakic/jot) - a library for persisting and restoring application state (a better alternative to .settings files).
...
* [HidLibrary ![GitHub Repo stars](https://img.shields.io/github/stars/mikeobrien/HidLibrary) ![GitHub last commit](https://img.shields.io/github/last-commit/mikeobrien/HidLibrary)](https://github.com/mikeobrien/HidLibrary) - This library enables you to enumerate and communicate with Hid compatible USB devices in .NET.
* [SystemWrapper ![GitHub Repo stars](https://img.shields.io/github/stars/jozefizso/SystemWrapper) ![GitHub last commit](https://img.shields.io/github/last-commit/jozefizso/SystemWrapper)](https://github.com/jozefizso/SystemWrapper) - SystemWrapper is .NET library for easier testing of system APIs.
...
* [DeviceId ![GitHub Repo stars](https://img.shields.io/github/stars/MatthewKing/DeviceId) ![GitHub last commit](https://img.shields.io/github/last-commit/MatthewKing/DeviceId)](https://github.com/MatthewKing/DeviceId) - Generate a 'device ID' that can be used to uniquely identify a computer.
* [DeviceDetector.NET ![GitHub Repo stars](https://img.shields.io/github/stars/totpero/DeviceDetector.NET) ![GitHub last commit](https://img.shields.io/github/last-commit/totpero/DeviceDetector.NET)](https://github.com/totpero/DeviceDetector.NET) - The Universal Device Detection library will parse any User Agent and detect the browser, operating system, device used (desktop, tablet, mobile, tv, cars, console, etc.), brand and model.
* [NaturalSort.Extension ![GitHub Repo stars](https://img.shields.io/github/stars/tompazourek/NaturalSort.Extension) ![GitHub last commit](https://img.shields.io/github/last-commit/tompazourek/NaturalSort.Extension)](https://github.com/tompazourek/NaturalSort.Extension) - Extension method for StringComparer that adds support for natural sorting (e.g. "abc1", "abc2", "abc10" instead of "abc1", "abc10", "abc2").
* [Coravel ![GitHub Repo stars](https://img.shields.io/github/stars/jamesmh/coravel) ![GitHub last commit](https://img.shields.io/github/last-commit/jamesmh/coravel)](https://github.com/jamesmh/coravel) Near-zero config .NET Core library that makes Task Scheduling, Caching, Queuing, Mailing, Event Broadcasting (and more) a breeze!
* [Quickenshtein ![GitHub Repo stars](https://img.shields.io/github/stars/Turnerj/Quickenshtein) ![GitHub last commit](https://img.shields.io/github/last-commit/Turnerj/Quickenshtein)](https://github.com/Turnerj/Quickenshtein) - An extremely quick and memory efficient Levenshtein Distance calculator with SIMD and Threading support
* [Infinity Crawler ![GitHub Repo stars](https://img.shields.io/github/stars/TurnerSoftware/InfinityCrawler) ![GitHub last commit](https://img.shields.io/github/last-commit/TurnerSoftware/InfinityCrawler)](https://github.com/TurnerSoftware/InfinityCrawler) - A simple but powerful web crawler library for .NET

## MVVM

* [Caliburn.Micro ![GitHub Repo stars](https://img.shields.io/github/stars/Caliburn-Micro/Caliburn.Micro) ![GitHub last commit](https://img.shields.io/github/last-commit/Caliburn-Micro/Caliburn.Micro)](https://github.com/Caliburn-Micro/Caliburn.Micro) - A small, yet powerful framework, designed for building applications across all XAML platforms. Its strong support for MV* patterns will enable you to build your solution quickly, without the need to sacrifice code quality or testability.
* [MVVM Light Toolkit ![GitHub Repo stars](https://img.shields.io/github/stars/lbugnion/mvvmlight) ![GitHub last commit](https://img.shields.io/github/last-commit/lbugnion/mvvmlight)](https://github.com/lbugnion/mvvmlight) - The main purpose of the toolkit is to accelerate the creation and development of MVVM applications in WPF, Silverlight, Windows Store (RT) and for Windows Phone
...
* [Prism ![GitHub Repo stars](https://img.shields.io/github/stars/PrismLibrary/Prism) ![GitHub last commit](https://img.shields.io/github/last-commit/PrismLibrary/Prism)](https://github.com/PrismLibrary/Prism) - A cross-platform desktop and mobile MVVM development framework.
* [Win Application Framework (WAF) ![GitHub Repo stars](https://img.shields.io/github/stars/jbe2277/waf) ![GitHub last commit](https://img.shields.io/github/last-commit/jbe2277/waf)](https://github.com/jbe2277/waf) - A lightweight Framework that helps you to create well structured WPF and UWP Applications. It supports you in applying a Layered Architecture and the Model-View-ViewModel pattern.
* [MVVMCross ![GitHub Repo stars](https://img.shields.io/github/stars/MvvmCross/MvvmCross) ![GitHub last commit](https://img.shields.io/github/last-commit/MvvmCross/MvvmCross)](https://github.com/MvvmCross/MvvmCross) - Cross-platform mvvm mobile development framework for WPF, Silverlight for WP7 and WP8, Mono for Android, MonoTouch for iOS, Windows Universal projects (WPA8.1 and Windows 8.1 Store apps). Makes extensive use of Portable Class Libraries (PCL) to provide maintainable cross platform C# native applications.
* [Stylet ![GitHub Repo stars](https://img.shields.io/github/stars/canton7/stylet) ![GitHub last commit](https://img.shields.io/github/last-commit/canton7/stylet)](https://github.com/canton7/stylet/) - Minimal MVVM framework inspired by Caliburn Micro, with good documentation, high test coverage, and its own IoC container
* [Gemini ![GitHub Repo stars](https://img.shields.io/github/stars/tgjones/gemini) ![GitHub last commit](https://img.shields.io/github/last-commit/tgjones/gemini)](https://github.com/tgjones/gemini) - IDE framework similar in concept to the Visual Studio Shell. Built on WPF, AvalonDock, and Caliburn Micro.
* [Toms Toolbox ![GitHub Repo stars](https://img.shields.io/github/stars/tom-englert/TomsToolbox) ![GitHub last commit](https://img.shields.io/github/last-commit/tom-englert/TomsToolbox)](https://github.com/tom-englert/TomsToolbox) - Visual Composition framework to easily build modularized MVVM applications based on the [Managed Extensibility Framework (MEF)](https://docs.microsoft.com/en-us/dotnet/framework/mef/).
* [MVVM Dialogs ![GitHub Repo stars](https://img.shields.io/github/stars/FantasticFiasco/mvvm-dialogs) ![GitHub last commit](https://img.shields.io/github/last-commit/FantasticFiasco/mvvm-dialogs)](https://github.com/FantasticFiasco/mvvm-dialogs) - Framework simplifying the concept of opening dialogs from a view model when using MVVM in WPF or UWP.
* [Smaragd ![GitHub Repo stars](https://img.shields.io/github/stars/nkristek/Smaragd) ![GitHub last commit](https://img.shields.io/github/last-commit/nkristek/Smaragd)](https://github.com/nkristek/Smaragd) - A platform-independent, lightweight library for developing .NET applications using the MVVM architecture.
* [EBind ![GitHub Repo stars](https://img.shields.io/github/stars/SIDOVSKY/EBind) ![GitHub last commit](https://img.shields.io/github/last-commit/SIDOVSKY/EBind)](https://github.com/SIDOVSKY/EBind) - A concise, fast and feature-rich .NET data binding solution.

## Networking

* [NetCoreServer ![GitHub Repo stars](https://img.shields.io/github/stars/chronoxor/NetCoreServer) ![GitHub last commit](https://img.shields.io/github/last-commit/chronoxor/NetCoreServer)](https://github.com/chronoxor/NetCoreServer) - Ultra fast and low latency asynchronous socket server & client C# .NET Core library with support TCP, SSL, UDP, HTTP, HTTPS, WebSocket protocols and 10K connections problem solution (NETStandard).
...
* [AutoMapper ![GitHub Repo stars](https://img.shields.io/github/stars/AutoMapper/AutoMapper) ![GitHub last commit](https://img.shields.io/github/last-commit/AutoMapper/AutoMapper)](https://github.com/AutoMapper/AutoMapper) - A convention-based object-object mapper in .NET. https://automapper.org
* [TinyMapper ![GitHub Repo stars](https://img.shields.io/github/stars/TinyMapper/TinyMapper) ![GitHub last commit](https://img.shields.io/github/last-commit/TinyMapper/TinyMapper)](https://github.com/TinyMapper/TinyMapper) - A tiny and quick object mapper for .NET.
* [ExpressMapper ![GitHub Repo stars](https://img.shields.io/github/stars/fluentsprings/ExpressMapper) ![GitHub last commit](https://img.shields.io/github/last-commit/fluentsprings/ExpressMapper)](https://github.com/fluentsprings/ExpressMapper) - A lightweight, lighting fast .NET mapper to map one type of object(s) to another in automated and easy way. ExpressMapper relies completely on the expression trees.
* [AgileMapper ![GitHub Repo stars](https://img.shields.io/github/stars/agileobjects/AgileMapper) ![GitHub last commit](https://img.shields.io/github/last-commit/agileobjects/AgileMapper)](https://github.com/agileobjects/AgileMapper) - A zero-configuration Object-Object mapper supporting .NET Standard 1.0
* [Mapster ![GitHub Repo stars](https://img.shields.io/github/stars/MapsterMapper/Mapster) ![GitHub last commit](https://img.shields.io/github/last-commit/MapsterMapper/Mapster)](https://github.com/MapsterMapper/Mapster) - A high performance object mapper in .net

## Office

* [ExcelDna ![GitHub Repo stars](https://img.shields.io/github/stars/Excel-DNA/ExcelDna) ![GitHub last commit](https://img.shields.io/github/last-commit/Excel-DNA/ExcelDna)](https://github.com/Excel-DNA/ExcelDna) - ExcelDna makes it easier to create and deploy Excel Add-Ins using C#, F# or VB .NET
* [ClosedXML ![GitHub Repo stars](https://img.shields.io/github/stars/ClosedXML/ClosedXML) ![GitHub last commit](https://img.shields.io/github/last-commit/ClosedXML/ClosedXML)](https://github.com/ClosedXML/ClosedXML) - ClosedXML makes it easier for developers to create Excel 2007/2010 files
* [NPOI ![GitHub Repo stars](https://img.shields.io/github/stars/tonyqus/npoi) ![GitHub last commit](https://img.shields.io/github/last-commit/tonyqus/npoi)](https://github.com/tonyqus/npoi) - This project is the .NET version of POI Java project at https://poi.apache.org/.
* [EPPlus ![GitHub Repo stars](https://img.shields.io/github/stars/JanKallman/EPPlus) ![GitHub last commit](https://img.shields.io/github/last-commit/JanKallman/EPPlus)](https://github.com/JanKallman/EPPlus) - EPPlus is a .NET library that reads and writes Excel 2007/2010 files using the Open Office XML format (xlsx).
...
* [DocX ![GitHub Repo stars](https://img.shields.io/github/stars/xceedsoftware/DocX) ![GitHub last commit](https://img.shields.io/github/last-commit/xceedsoftware/DocX)](https://github.com/xceedsoftware/DocX) - DocX is a .NET library that allows developers to manipulate Word 2007/2010/2013 files, it does not require Microsoft Word or Office to be installed.
...
* [NetOffice ![GitHub Repo stars](https://img.shields.io/github/stars/NetOfficeFw/NetOffice) ![GitHub last commit](https://img.shields.io/github/last-commit/NetOfficeFw/NetOffice)](https://github.com/NetOfficeFw/NetOffice) - .NET wrapper assemblies for Microsoft Office applications.
...
* [Entity Framework 6 ![GitHub Repo stars](https://img.shields.io/github/stars/dotnet/ef6) ![GitHub last commit](https://img.shields.io/github/last-commit/dotnet/ef6)](https://github.com/dotnet/ef6) - Object-relational mapper that enables .NET developers to work with relational data using domain-specific objects
* [Entity Framework Core ![GitHub Repo stars](https://img.shields.io/github/stars/dotnet/efcore) ![GitHub last commit](https://img.shields.io/github/last-commit/dotnet/efcore)](https://github.com/dotnet/efcore) - Object-relational mapper that enables .NET developers to work with relational data using domain-specific objects
* [EntityFramework.Exceptions ![GitHub Repo stars](https://img.shields.io/github/stars/Giorgi/EntityFramework.Exceptions) ![GitHub last commit](https://img.shields.io/github/last-commit/Giorgi/EntityFramework.Exceptions)](https://github.com/Giorgi/EntityFramework.Exceptions) - Use typed Exceptions for Entity Framework Core when your SQL query violates database constraints in SqlServer, MySql, PostgreSQL or SQLite
...
* [ServiceStack.OrmLite ![GitHub Repo stars](https://img.shields.io/github/stars/ServiceStack/ServiceStack.OrmLite) ![GitHub last commit](https://img.shields.io/github/last-commit/ServiceStack/ServiceStack.OrmLite)](https://github.com/ServiceStack/ServiceStack.OrmLite) - Light, simple and fast convention-based POCO ORM **[[Free for OSS ![GitHub Repo stars](https://img.shields.io/github/stars/ServiceStack/ServiceStack.OrmLite) ![GitHub last commit](https://img.shields.io/github/last-commit/ServiceStack/ServiceStack.OrmLite)](https://github.com/ServiceStack/ServiceStack.OrmLite/blob/master/license.txt)]** **[$]**
* [Massive ![GitHub Repo stars](https://img.shields.io/github/stars/FransBouma/Massive) ![GitHub last commit](https://img.shields.io/github/last-commit/FransBouma/Massive)](https://github.com/FransBouma/Massive) - A small, happy, data access tool that will love you forever.
* [LINQ to DB ![GitHub Repo stars](https://img.shields.io/github/stars/linq2db/linq2db) ![GitHub last commit](https://img.shields.io/github/last-commit/linq2db/linq2db)](https://github.com/linq2db/linq2db) - The fastest LINQ database access library offering a simple, light, fast, and type-safe layer between your POCO objects and your database.
* [MicroLite ORM ![GitHub Repo stars](https://img.shields.io/github/stars/MicroLite-ORM/MicroLite) ![GitHub last commit](https://img.shields.io/github/last-commit/MicroLite-ORM/MicroLite)](https://github.com/MicroLite-ORM/MicroLite) MicroLite ORM is a micro Object Relational Mapper for the .NET framework. It is designed to be easy to use, extensible and testable.
* [PetaPoco ![GitHub Repo stars](https://img.shields.io/github/stars/CollaboratingPlatypus/PetaPoco) ![GitHub last commit](https://img.shields.io/github/last-commit/CollaboratingPlatypus/PetaPoco)](https://github.com/CollaboratingPlatypus/PetaPoco) - A tiny ORM-ish thing for your POCOs
* [AsyncPoco ![GitHub Repo stars](https://img.shields.io/github/stars/tmenier/AsyncPoco) ![GitHub last commit](https://img.shields.io/github/last-commit/tmenier/AsyncPoco)](https://github.com/tmenier/AsyncPoco) - A long-"awaited" fully asynchronous PetaPoco fork
* [NPoco ![GitHub Repo stars](https://img.shields.io/github/stars/schotime/NPoco) ![GitHub last commit](https://img.shields.io/github/last-commit/schotime/NPoco)](https://github.com/schotime/NPoco) - Simple microORM that maps the results of a query onto a POCO object. Based on Schotime's branch of PetaPoco
* [Limebean ![GitHub Repo stars](https://img.shields.io/github/stars/Nick-Lucas/LimeBean) ![GitHub last commit](https://img.shields.io/github/last-commit/Nick-Lucas/LimeBean)](https://github.com/Nick-Lucas/LimeBean) - Hybrid ORM which uses SQL fragments and doesn't require Model Classes.
...
* [Insight.Database ![GitHub Repo stars](https://img.shields.io/github/stars/jonwagner/Insight.Database) ![GitHub last commit](https://img.shields.io/github/last-commit/jonwagner/Insight.Database)](https://github.com/jonwagner/Insight.Database) - Insight.Database is a fast, lightweight, micro-ORM for .NET
...
* [SmartSql ![GitHub Repo stars](https://img.shields.io/github/stars/dotnetcore/SmartSql) ![GitHub last commit](https://img.shields.io/github/last-commit/dotnetcore/SmartSql)](https://github.com/dotnetcore/SmartSql) - SmartSql = MyBatis + Cache（Memory | Redis）+ ZooKeeper + R / W Splitting + Dynamic Repository ....
...
* [BaGet ![GitHub Repo stars](https://img.shields.io/github/stars/loic-sharma/BaGet) ![GitHub last commit](https://img.shields.io/github/last-commit/loic-sharma/BaGet)](https://github.com/loic-sharma/BaGet/) - A cross-platform, lightweight NuGet and Symbol server
...
* [Paket ![GitHub Repo stars](https://img.shields.io/github/stars/fsprojects/Paket) ![GitHub last commit](https://img.shields.io/github/last-commit/fsprojects/Paket)](https://github.com/fsprojects/Paket) - A package dependency manager for .NET with support for NuGet packages and GitHub repositories. https://fsprojects.github.io/Paket/
* [Sleet ![GitHub Repo stars](https://img.shields.io/github/stars/emgarten/sleet) ![GitHub last commit](https://img.shields.io/github/last-commit/emgarten/sleet)](https://github.com/emgarten/sleet/) - A NuGet v3 static feed generator with support for AWS S3 and Azure Storage
...
* [ITextSharp ![GitHub Repo stars](https://img.shields.io/github/stars/itext/itextsharp) ![GitHub last commit](https://img.shields.io/github/last-commit/itext/itextsharp)](https://github.com/itext/itextsharp) - iText is a PDF library that allows you to CREATE, ADAPT, INSPECT and MAINTAIN documents in the Portable Document Format (PDF)**[$]** **[Free for OSS]**
* [PdfiumViewer ![GitHub Repo stars](https://img.shields.io/github/stars/pvginkel/PdfiumViewer) ![GitHub last commit](https://img.shields.io/github/last-commit/pvginkel/PdfiumViewer)](https://github.com/pvginkel/PdfiumViewer) - PdfiumViewer is a PDF viewer based on the PDFium project.
* [WkhtmlToPdf ![GitHub Repo stars](https://img.shields.io/github/stars/codaxy/wkhtmltopdf) ![GitHub last commit](https://img.shields.io/github/last-commit/codaxy/wkhtmltopdf)](https://github.com/codaxy/wkhtmltopdf) - C# wrapper around wkhtmltopdf console utility. Allow to generate preety PDF using HTML and CSS.
...
* [Glimpse ![GitHub Repo stars](https://img.shields.io/github/stars/glimpse/glimpse) ![GitHub last commit](https://img.shields.io/github/last-commit/glimpse/glimpse)](https://github.com/glimpse/glimpse) - The open source diagnostics platform for the web
* [Unchase.FluentPerformanceMeter ![GitHub Repo stars](https://img.shields.io/github/stars/unchase/Unchase.FluentPerformanceMeter) ![GitHub last commit](https://img.shields.io/github/last-commit/unchase/Unchase.FluentPerformanceMeter)](https://github.com/unchase/Unchase.FluentPerformanceMeter) - An open-source and cross-platform .Net Standard 2.0 library that is designed for the method’s performance measurement.

## Protocols

* [SSH.NET ![GitHub Repo stars](https://img.shields.io/github/stars/sshnet/SSH.NET) ![GitHub last commit](https://img.shields.io/github/last-commit/sshnet/SSH.NET)](https://github.com/sshnet/SSH.NET) - A Secure Shell (SSH) library for .NET, optimized for parallelism. Provides SSH commands, SFTP/SCP uploads and downloads, and SOCKS4/SOCKS5/HTTP proxies.
* [FluentFTP ![GitHub Repo stars](https://img.shields.io/github/stars/robinrodricks/FluentFTP) ![GitHub last commit](https://img.shields.io/github/last-commit/robinrodricks/FluentFTP)](https://github.com/robinrodricks/FluentFTP) - An FTP and FTPS library for .NET, optimized for speed. Provides extensive FTP commands, file uploads/downloads and FTP proxies.
...
* [DNS ![GitHub Repo stars](https://img.shields.io/github/stars/kapetan/dns) ![GitHub last commit](https://img.shields.io/github/last-commit/kapetan/dns)](https://github.com/kapetan/dns) - A library for parsing and serializing DNS messages. Includes a basic DNS client and server.
* [DnsClient.NET ![GitHub Repo stars](https://img.shields.io/github/stars/MichaCo/DnsClient.NET) ![GitHub last commit](https://img.shields.io/github/last-commit/MichaCo/DnsClient.NET)](https://github.com/MichaCo/DnsClient.NET) - A simple yet very powerful and high performant open source library for the .NET Framework to do DNS lookups.
...
* [RabbitMQ.NET ![GitHub Repo stars](https://img.shields.io/github/stars/rabbitmq/rabbitmq-dotnet-client) ![GitHub last commit](https://img.shields.io/github/last-commit/rabbitmq/rabbitmq-dotnet-client)](https://github.com/rabbitmq/rabbitmq-dotnet-client) - Implementation of an AMQP client library for C#, and a binding exposing AMQP services via WCF
* [NetMQ ![GitHub Repo stars](https://img.shields.io/github/stars/zeromq/netmq) ![GitHub last commit](https://img.shields.io/github/last-commit/zeromq/netmq)](https://github.com/zeromq/netmq) - NetMQ is 100% native C# port of ZeroMQ
* [MassTransit ![GitHub Repo stars](https://img.shields.io/github/stars/MassTransit/MassTransit) ![GitHub last commit](https://img.shields.io/github/last-commit/MassTransit/MassTransit)](https://github.com/MassTransit/MassTransit) - MassTransit is lean service bus implementation for building loosely coupled applications using the .NET Framework.
* [Rebus ![GitHub Repo stars](https://img.shields.io/github/stars/rebus-org/Rebus) ![GitHub last commit](https://img.shields.io/github/last-commit/rebus-org/Rebus)](https://github.com/rebus-org/Rebus) - Rebus is a lean service bus implementation for .NET, similar in nature to NServiceBus and MassTransit, only leaner
* [RestBus ![GitHub Repo stars](https://img.shields.io/github/stars/tenor/RestBus) ![GitHub last commit](https://img.shields.io/github/last-commit/tenor/RestBus)](https://github.com/tenor/RestBus) - A service-oriented .NET messaging library for RabbitMQ.
* [RawRabbit ![GitHub Repo stars](https://img.shields.io/github/stars/pardahlman/RawRabbit) ![GitHub last commit](https://img.shields.io/github/last-commit/pardahlman/RawRabbit)](https://github.com/pardahlman/RawRabbit) - A modern .NET Core library for RabbitMQ.
...
* [Kafunk ![GitHub Repo stars](https://img.shields.io/github/stars/jet/kafunk) ![GitHub last commit](https://img.shields.io/github/last-commit/jet/kafunk)](https://github.com/jet/kafunk) - F# Kafka client from Jet
...
* [Rx.NET ![GitHub Repo stars](https://img.shields.io/github/stars/dotnet/reactive) ![GitHub last commit](https://img.shields.io/github/last-commit/dotnet/reactive)](https://github.com/dotnet/reactive) - The Reactive Extensions (Rx) is a library for composing asynchronous and event-based programs using observable sequences and LINQ-style query operators
* [Dynamic Data ![GitHub Repo stars](https://img.shields.io/github/stars/reactivemarbles/DynamicData) ![GitHub last commit](https://img.shields.io/github/last-commit/reactivemarbles/DynamicData)](https://github.com/reactivemarbles/DynamicData) - Reactive Extensions (Rx) for collections

## Real-time Communications

* [SIPSorcery ![GitHub Repo stars](https://img.shields.io/github/stars/sipsorcery/sipsorcery) ![GitHub last commit](https://img.shields.io/github/last-commit/sipsorcery/sipsorcery)](https://github.com/sipsorcery/sipsorcery) - A cross platform C# .NET library supporting SIP, VoIP and WebRTC.

## Scheduling

* [FluentScheduler ![GitHub Repo stars](https://img.shields.io/github/stars/fluentscheduler/FluentScheduler) ![GitHub last commit](https://img.shields.io/github/last-commit/fluentscheduler/FluentScheduler)](https://github.com/fluentscheduler/FluentScheduler) - Task scheduler with fluent interface that runs automated jobs from your application
* [NCrontab ![GitHub Repo stars](https://img.shields.io/github/stars/atifaziz/NCrontab) ![GitHub last commit](https://img.shields.io/github/last-commit/atifaziz/NCrontab)](https://github.com/atifaziz/NCrontab) - Class library for parsing & formatting [crontab](http://crontab.org/) expressions as well as calculating occurrences of time based on a crontab schedule
* [QuartzNet ![GitHub Repo stars](https://img.shields.io/github/stars/quartznet/quartznet) ![GitHub last commit](https://img.shields.io/github/last-commit/quartznet/quartznet)](https://github.com/quartznet/quartznet) - Quartz Enterprise Scheduler .NET
* [Hangfire](https://github.com/HangfireIO) - An easy way to perform fire-and-forget, delayed and recurring tasks inside .NET apps
* [Chroniton ![GitHub Repo stars](https://img.shields.io/github/stars/leosperry/Chroniton) ![GitHub last commit](https://img.shields.io/github/last-commit/leosperry/Chroniton)](https://github.com/leosperry/Chroniton) - A simple, fully integrable, and customizable library for running strongly typed jobs (tasks) on schedules.
...
* [Wexflow ![GitHub Repo stars](https://img.shields.io/github/stars/aelassas/Wexflow) ![GitHub last commit](https://img.shields.io/github/last-commit/aelassas/Wexflow)](https://github.com/aelassas/Wexflow) - An extensible workflow engine with a cross-platform manager and designer.
...
* [AWS SDK ![GitHub Repo stars](https://img.shields.io/github/stars/aws/aws-sdk-net) ![GitHub last commit](https://img.shields.io/github/last-commit/aws/aws-sdk-net)](https://github.com/aws/aws-sdk-net) - The AWS SDK for .NET enables .NET developers to easily work with Amazon Web Services
* [Azure PowerShell ![GitHub Repo stars](https://img.shields.io/github/stars/Azure/azure-powershell) ![GitHub last commit](https://img.shields.io/github/last-commit/Azure/azure-powershell)](https://github.com/Azure/azure-powershell) - A set of PowerShell cmdlets for developers and administrators to develop, deploy and manage Microsoft Azure applications
* [Countly SDK for Windows ![GitHub Repo stars](https://img.shields.io/github/stars/Countly/countly-sdk-windows) ![GitHub last commit](https://img.shields.io/github/last-commit/Countly/countly-sdk-windows)](https://github.com/Countly/countly-sdk-windows/) - Windows SDK for Countly analytics and marketing platform for product and marketing managers
* [Octokit.NET ![GitHub Repo stars](https://img.shields.io/github/stars/octokit/octokit.net) ![GitHub last commit](https://img.shields.io/github/last-commit/octokit/octokit.net)](https://github.com/octokit/octokit.net) - A GitHub API client library for .NET
* [Dropbox.NET ![GitHub Repo stars](https://img.shields.io/github/stars/dropbox/dropbox-sdk-dotnet) ![GitHub last commit](https://img.shields.io/github/last-commit/dropbox/dropbox-sdk-dotnet)](https://github.com/dropbox/dropbox-sdk-dotnet) - Official .NET SDK for the Dropbox API
* [Getty Images API SDK ![GitHub Repo stars](https://img.shields.io/github/stars/gettyimages/gettyimages-api_dotnet) ![GitHub last commit](https://img.shields.io/github/last-commit/gettyimages/gettyimages-api_dotnet)](https://github.com/gettyimages/gettyimages-api_dotnet) - SDK for the Getty Images and iStock APIs
* [Cloudmersive APIs](https://api.cloudmersive.com/csharp-client.asp) - An API client library for .NET **[Proprietary][Free]**

## Search

* [Elasticsearch .NET ![GitHub Repo stars](https://img.shields.io/github/stars/elastic/elasticsearch-net) ![GitHub last commit](https://img.shields.io/github/last-commit/elastic/elasticsearch-net)](https://github.com/elastic/elasticsearch-net) - Elasticsearch.Net & NEST
* [PlainElastic.Net ![GitHub Repo stars](https://img.shields.io/github/stars/Yegoroff/PlainElastic.Net) ![GitHub last commit](https://img.shields.io/github/last-commit/Yegoroff/PlainElastic.Net)](https://github.com/Yegoroff/PlainElastic.Net) - Plain .NET client for ElasticSearch
* [SolrNet ![GitHub Repo stars](https://img.shields.io/github/stars/SolrNet/SolrNet) ![GitHub last commit](https://img.shields.io/github/last-commit/SolrNet/SolrNet)](https://github.com/SolrNet/SolrNet) - Solr client for .NET
* [SolrExpress ![GitHub Repo stars](https://img.shields.io/github/stars/solr-express/solr-express) ![GitHub last commit](https://img.shields.io/github/last-commit/solr-express/solr-express)](https://github.com/solr-express/solr-express) - A simple and lightweight query .NET library for Solr, in a controlled, buildable and fail fast way
...
* [Ceras ![GitHub Repo stars](https://img.shields.io/github/stars/rikimaru0345/Ceras) ![GitHub last commit](https://img.shields.io/github/last-commit/rikimaru0345/Ceras)](https://github.com/rikimaru0345/Ceras) - Ceras is a binary serializer. It converts any object into a byte[] and back. It goes above and beyond in terms of features, speed, and comfort. Supports reference loops, large/complicated inheritance chains, splitting objects into parts and more.
* [CsvExport ![GitHub Repo stars](https://img.shields.io/github/stars/jitbit/CsvExport) ![GitHub last commit](https://img.shields.io/github/last-commit/jitbit/CsvExport)](https://github.com/jitbit/CsvExport) - Very simple & lightweight CSV exporter, Excel friendly, escapes text & quotes etc.
* [Protobuf.NET ![GitHub Repo stars](https://img.shields.io/github/stars/protobuf-net/protobuf-net) ![GitHub last commit](https://img.shields.io/github/last-commit/protobuf-net/protobuf-net)](https://github.com/protobuf-net/protobuf-net) - Protocol buffers is the name of the binary serialization format used by Google for much of their data communications
* [Json.NET ![GitHub Repo stars](https://img.shields.io/github/stars/JamesNK/Newtonsoft.Json) ![GitHub last commit](https://img.shields.io/github/last-commit/JamesNK/Newtonsoft.Json)](https://github.com/JamesNK/Newtonsoft.Json) - Popular high-performance JSON framework for .NET
* [ServiceStack.Text ![GitHub Repo stars](https://img.shields.io/github/stars/ServiceStack/ServiceStack.Text) ![GitHub last commit](https://img.shields.io/github/last-commit/ServiceStack/ServiceStack.Text)](https://github.com/ServiceStack/ServiceStack.Text) - JSON, JSV and CSV Text Serializers used in servicestack.net
* [Msgpack-Cli ![GitHub Repo stars](https://img.shields.io/github/stars/msgpack/msgpack-cli) ![GitHub last commit](https://img.shields.io/github/last-commit/msgpack/msgpack-cli)](https://github.com/msgpack/msgpack-cli) - MessagePack implementation for Common Language Infrastructure
* [Jil ![GitHub Repo stars](https://img.shields.io/github/stars/kevin-montrose/Jil) ![GitHub last commit](https://img.shields.io/github/last-commit/kevin-montrose/Jil)](https://github.com/kevin-montrose/Jil) - Fast .NET JSON serializer, built on Sigil (used by StackOverflow)
* [ProtoBuf ![GitHub Repo stars](https://img.shields.io/github/stars/SilentOrbit/protobuf) ![GitHub last commit](https://img.shields.io/github/last-commit/SilentOrbit/protobuf)](https://github.com/SilentOrbit/protobuf) - Generate C# code for protocol buffer serialization from a .proto specification.
* [F# Data](https://fsharp.github.io/FSharp.Data/) - F# type providers for accessing XML, JSON, CSV and HTML files (based on sample documents) and for accessing WorldBank data
...
* [Hyperion ![GitHub Repo stars](https://img.shields.io/github/stars/akkadotnet/Hyperion) ![GitHub last commit](https://img.shields.io/github/last-commit/akkadotnet/Hyperion)](https://github.com/akkadotnet/Hyperion) - A high performance polymorphic serializer for the .NET framework.
* [FileHelpers ![GitHub Repo stars](https://img.shields.io/github/stars/MarcosMeli/FileHelpers) ![GitHub last commit](https://img.shields.io/github/last-commit/MarcosMeli/FileHelpers)](https://github.com/MarcosMeli/FileHelpers) - free and easy to use .NET library to import or export data from fixed length or delimited records in files, strings or streams.
* [FsPickler ![GitHub Repo stars](https://img.shields.io/github/stars/mbraceproject/FsPickler) ![GitHub last commit](https://img.shields.io/github/last-commit/mbraceproject/FsPickler)](https://github.com/mbraceproject/FsPickler) - A fast multi-format message serializer for .NET
* [Migrant ![GitHub Repo stars](https://img.shields.io/github/stars/antmicro/Migrant) ![GitHub last commit](https://img.shields.io/github/last-commit/antmicro/Migrant)](https://github.com/antmicro/Migrant) - Fast and flexible serialization framework usable on undecorated classes.
* [Utf8Json ![GitHub Repo stars](https://img.shields.io/github/stars/neuecc/Utf8Json) ![GitHub last commit](https://img.shields.io/github/last-commit/neuecc/Utf8Json)](https://github.com/neuecc/Utf8Json) - Fast and Zero Allocation JSON Serializer for C#(.NET, .NET Core, Unity and Xamarin), this serializer write/read directly to UTF8 binary so boostup performance.

## SMS and Phone calls

* [Twilio-csharp ![GitHub Repo stars](https://img.shields.io/github/stars/twilio/twilio-csharp) ![GitHub last commit](https://img.shields.io/github/last-commit/twilio/twilio-csharp)](https://github.com/twilio/twilio-csharp) - A C#/.NET Library for sending and receiving phone calls and text messages with Twilio.

## State machines

* [Stateless ![GitHub Repo stars](https://img.shields.io/github/stars/dotnet-state-machine/stateless) ![GitHub last commit](https://img.shields.io/github/last-commit/dotnet-state-machine/stateless)](https://github.com/dotnet-state-machine/stateless) - Create state machines and lightweight state machine-based workflows directly in .NET code
* [Automatonymous ![GitHub Repo stars](https://img.shields.io/github/stars/MassTransit/Automatonymous) ![GitHub last commit](https://img.shields.io/github/last-commit/MassTransit/Automatonymous)](https://github.com/MassTransit/Automatonymous) - A state machine library for .NET - allows you to write fluent style state machines
...
* [FsBlog ![GitHub Repo stars](https://img.shields.io/github/stars/fsprojects/FsBlog) ![GitHub last commit](https://img.shields.io/github/last-commit/fsprojects/FsBlog)](https://github.com/fsprojects/FsBlog/) - Blog aware, static site generation using F#
* [Pretzel ![GitHub Repo stars](https://img.shields.io/github/stars/Code52/pretzel) ![GitHub last commit](https://img.shields.io/github/last-commit/Code52/pretzel)](https://github.com/Code52/pretzel) - A site generation tool (and then some) for .NET platforms
...
* [Strong Namer ![GitHub Repo stars](https://img.shields.io/github/stars/dsplaisted/strongnamer) ![GitHub last commit](https://img.shields.io/github/last-commit/dsplaisted/strongnamer)](https://github.com/dsplaisted/strongnamer) - Automatically add strong names to referenced assemblies which do not already have a strong name. This will allow you to reference and use (NuGet packages with) assemblies which are not strong named from your projects that do use a strong name.
* [.NET Assembly Strong-Name Signer ![GitHub Repo stars](https://img.shields.io/github/stars/brutaldev/StrongNameSigner) ![GitHub last commit](https://img.shields.io/github/last-commit/brutaldev/StrongNameSigner)](https://github.com/brutaldev/StrongNameSigner) - Utility software to strong-name sign .NET assemblies, including assemblies you do not have the source code for.
...
* [C# Async Guidance ![GitHub Repo stars](https://img.shields.io/github/stars/davidfowl/AspNetCoreDiagnosticScenarios) ![GitHub last commit](https://img.shields.io/github/last-commit/davidfowl/AspNetCoreDiagnosticScenarios)](https://github.com/davidfowl/AspNetCoreDiagnosticScenarios/blob/master/AsyncGuidance.md) - list of problematic asynchronous patterns for .NET Core with an explanation of how to solve those issues

## Template Engine

* [RazorEngine ![GitHub Repo stars](https://img.shields.io/github/stars/Antaris/RazorEngine) ![GitHub last commit](https://img.shields.io/github/last-commit/Antaris/RazorEngine)](https://github.com/Antaris/RazorEngine) - Open source templating engine based on Microsoft's Razor parsing engine
* [RazorLight ![GitHub Repo stars](https://img.shields.io/github/stars/toddams/RazorLight) ![GitHub last commit](https://img.shields.io/github/last-commit/toddams/RazorLight)](https://github.com/toddams/RazorLight) - Open source template engine based on Microsoft's Razor parsing engine supporting .NET Standard 2.0
* [Nustache ![GitHub Repo stars](https://img.shields.io/github/stars/jdiamond/Nustache) ![GitHub last commit](https://img.shields.io/github/last-commit/jdiamond/Nustache)](https://github.com/jdiamond/Nustache) - Open source library for logic-less templates
* [Stubble ![GitHub Repo stars](https://img.shields.io/github/stars/stubbleorg/stubble) ![GitHub last commit](https://img.shields.io/github/last-commit/stubbleorg/stubble)](https://github.com/stubbleorg/stubble) - Trimmed down {{mustache}} templates in .NET. Successor of Nustache.
* [DotLiquid ![GitHub Repo stars](https://img.shields.io/github/stars/dotliquid/dotliquid) ![GitHub last commit](https://img.shields.io/github/last-commit/dotliquid/dotliquid)](https://github.com/dotliquid/dotliquid) - C# port of the Ruby Liquid templating language
* [Mustache Sharp ![GitHub Repo stars](https://img.shields.io/github/stars/jehugaleahsa/mustache-sharp) ![GitHub last commit](https://img.shields.io/github/last-commit/jehugaleahsa/mustache-sharp)](https://github.com/jehugaleahsa/mustache-sharp) - An extension of the mustache text template engine for .NET.
...
* [ArchUnitNET ![GitHub Repo stars](https://img.shields.io/github/stars/TNG/ArchUnitNET) ![GitHub last commit](https://img.shields.io/github/last-commit/TNG/ArchUnitNET)](https://github.com/TNG/ArchUnitNET) - Simple library for checking the architecture of C# code with a fluent API.
* [AutoFixture ![GitHub Repo stars](https://img.shields.io/github/stars/AutoFixture/AutoFixture) ![GitHub last commit](https://img.shields.io/github/last-commit/AutoFixture/AutoFixture)](https://github.com/AutoFixture/AutoFixture) - AutoFixture is an open source framework for .NET designed to minimize the 'Arrange' phase of your unit tests
* [BDTest ![GitHub Repo stars](https://img.shields.io/github/stars/thomhurst/BDTest) ![GitHub last commit](https://img.shields.io/github/last-commit/thomhurst/BDTest)](https://github.com/thomhurst/BDTest/wiki) - A behaviour driven testing and reporting framework!
* [BDDfy ![GitHub Repo stars](https://img.shields.io/github/stars/TestStack/TestStack.BDDfy) ![GitHub last commit](https://img.shields.io/github/last-commit/TestStack/TestStack.BDDfy)](https://github.com/TestStack/TestStack.BDDfy) - BDDfy is the simplest BDD framework EVER!
* [Bogus ![GitHub Repo stars](https://img.shields.io/github/stars/bchavez/Bogus) ![GitHub last commit](https://img.shields.io/github/last-commit/bchavez/Bogus)](https://github.com/bchavez/Bogus) - A simple and sane fake data generator for C#. Based on and ported from the famed faker.js.
* [ExpressionToCode ![GitHub Repo stars](https://img.shields.io/github/stars/EamonNerbonne/ExpressionToCode) ![GitHub last commit](https://img.shields.io/github/last-commit/EamonNerbonne/ExpressionToCode)](https://github.com/EamonNerbonne/ExpressionToCode) - Use plain C# syntax in assertions that include both the expression expression and subexpression values in the failure message.
* [FakeItEasy ![GitHub Repo stars](https://img.shields.io/github/stars/FakeItEasy/FakeItEasy) ![GitHub last commit](https://img.shields.io/github/last-commit/FakeItEasy/FakeItEasy)](https://github.com/FakeItEasy/FakeItEasy) - The easy mocking library for .NET https://fakeiteasy.github.io
* [Fluent Assertions ![GitHub Repo stars](https://img.shields.io/github/stars/fluentassertions/fluentassertions) ![GitHub last commit](https://img.shields.io/github/last-commit/fluentassertions/fluentassertions)](https://github.com/fluentassertions/fluentassertions) - A set of .NET extension methods that allow you to more naturally specify the expected outcome of a TDD or BDD-style test
* [FluentAutomation ![GitHub Repo stars](https://img.shields.io/github/stars/stirno/FluentAutomation) ![GitHub last commit](https://img.shields.io/github/last-commit/stirno/FluentAutomation)](https://github.com/stirno/FluentAutomation) - Simple Fluent API for UI Automation
...
* [Fuchu ![GitHub Repo stars](https://img.shields.io/github/stars/mausch/Fuchu) ![GitHub last commit](https://img.shields.io/github/last-commit/mausch/Fuchu)](https://github.com/mausch/Fuchu) - A unit-testing library for F# with tests-as-values which makes DSLs extremely easy to create.
* [Machine.Specifications ![GitHub Repo stars](https://img.shields.io/github/stars/machine/machine.specifications) ![GitHub last commit](https://img.shields.io/github/last-commit/machine/machine.specifications)](https://github.com/machine/machine.specifications) - Machine.Specifications (MSpec) is a context/specification framework that removes language noise and simplifies tests.
* [Moq ![GitHub Repo stars](https://img.shields.io/github/stars/Moq/moq4) ![GitHub last commit](https://img.shields.io/github/last-commit/Moq/moq4)](https://github.com/Moq/moq4) - The most popular and friendly mocking framework for .NET
* [NBuilder ![GitHub Repo stars](https://img.shields.io/github/stars/garethdown44/nbuilder) ![GitHub last commit](https://img.shields.io/github/last-commit/garethdown44/nbuilder)](https://github.com/garethdown44/nbuilder) - Rapid generation of test objects
...
* [NUnit ![GitHub Repo stars](https://img.shields.io/github/stars/nunit/nunit) ![GitHub last commit](https://img.shields.io/github/last-commit/nunit/nunit)](https://github.com/nunit/nunit) - A unit-testing framework for all .NET languages
* [Rhino Mocks ![GitHub Repo stars](https://img.shields.io/github/stars/ayende/rhino-mocks) ![GitHub last commit](https://img.shields.io/github/last-commit/ayende/rhino-mocks)](https://github.com/ayende/rhino-mocks) - Dynamic Mocking Framework for .NET
* [Shouldly ![GitHub Repo stars](https://img.shields.io/github/stars/shouldly/shouldly) ![GitHub last commit](https://img.shields.io/github/last-commit/shouldly/shouldly)](https://github.com/shouldly/shouldly) - Shouldly is an assertion framework which focuses on giving great error messages when the assertion fails while being simple and terse.
* [Snapshooter ![GitHub Repo stars](https://img.shields.io/github/stars/SwissLife-OSS/snapshooter) ![GitHub last commit](https://img.shields.io/github/last-commit/SwissLife-OSS/snapshooter)](https://github.com/SwissLife-OSS/snapshooter) - A snapshot testing tool for .NET Core and .NET Framework
* [SpecFlow ![GitHub Repo stars](https://img.shields.io/github/stars/SpecFlowOSS/SpecFlow) ![GitHub last commit](https://img.shields.io/github/last-commit/SpecFlowOSS/SpecFlow)](https://github.com/SpecFlowOSS/SpecFlow) - Binding business requirements to .Net code
* [Stryker.NET ![GitHub Repo stars](https://img.shields.io/github/stars/stryker-mutator/stryker-net) ![GitHub last commit](https://img.shields.io/github/last-commit/stryker-mutator/stryker-net)](https://github.com/stryker-mutator/stryker-net) - Mutation testing for .NET Core projects
* [xBehave.net ![GitHub Repo stars](https://img.shields.io/github/stars/xbehave/xbehave.net) ![GitHub last commit](https://img.shields.io/github/last-commit/xbehave/xbehave.net)](https://github.com/xbehave/xbehave.net) - An xUnit.net extension for describing your tests using natural language. [https://xbehave.github.io](https://xbehave.github.io)
...
* [Canopy ![GitHub Repo stars](https://img.shields.io/github/stars/lefthandedgoat/canopy) ![GitHub last commit](https://img.shields.io/github/last-commit/lefthandedgoat/canopy)](https://github.com/lefthandedgoat/canopy) - Canopy is a free, open source F# web automation and testing framework
* [Expecto ![GitHub Repo stars](https://img.shields.io/github/stars/haf/expecto) ![GitHub last commit](https://img.shields.io/github/last-commit/haf/expecto)](https://github.com/haf/expecto) - A smooth testing framework for F# with tests as values. Unit testing, property based testing, performance testing and stress testing.
...
* [Open Live Writer ![GitHub Repo stars](https://img.shields.io/github/stars/OpenLiveWriter/OpenLiveWriter) ![GitHub last commit](https://img.shields.io/github/last-commit/OpenLiveWriter/OpenLiveWriter)](https://github.com/OpenLiveWriter/OpenLiveWriter) - Blog writer which integrated with WordPress, Blogger, et. al. Open Live Writer makes it easy to write, preview, and post to your blog.
* [CodeHub ![GitHub Repo stars](https://img.shields.io/github/stars/CodeHubApp/CodeHub) ![GitHub last commit](https://img.shields.io/github/last-commit/CodeHubApp/CodeHub)](https://github.com/CodeHubApp/CodeHub) - CodeHub is the best way to browse and maintain your GitHub repositories on any iOS device!
* [ShareX ![GitHub Repo stars](https://img.shields.io/github/stars/ShareX/ShareX) ![GitHub last commit](https://img.shields.io/github/last-commit/ShareX/ShareX)](https://github.com/ShareX/ShareX) - ShareX is a free and open source program that lets you capture or record any area of your screen and share it with a single press of a key. It also allows uploading images, text or other types of files to over 80 supported destinations you can choose from.
* [Myrtille ![GitHub Repo stars](https://img.shields.io/github/stars/cedrozor/myrtille) ![GitHub last commit](https://img.shields.io/github/last-commit/cedrozor/myrtille)](https://github.com/cedrozor/myrtille) - A native HTML4/5 Remote Desktop Protocol client, HTTP gateway written in C# for .NET
...
* [Mockaco ![GitHub Repo stars](https://img.shields.io/github/stars/natenho/Mockaco) ![GitHub last commit](https://img.shields.io/github/last-commit/natenho/Mockaco)](https://github.com/natenho/Mockaco/) - API mock server with fast setup, useful to simulate HTTP responses, leveraging ASP.NET Core features, built-in fake data generation and C# scripting engine powered by Roslyn scripting API.
* [Netling ![GitHub Repo stars](https://img.shields.io/github/stars/hallatore/Netling) ![GitHub last commit](https://img.shields.io/github/last-commit/hallatore/Netling)](https://github.com/hallatore/Netling) - A load tester client for easy web testing. It is extremely fast while using little CPU or memory.
* [Papercut ![GitHub Repo stars](https://img.shields.io/github/stars/ChangemakerStudios/Papercut-SMTP) ![GitHub last commit](https://img.shields.io/github/last-commit/ChangemakerStudios/Papercut-SMTP)](https://github.com/ChangemakerStudios/Papercut-SMTP) - Papercut is an open source (.NET based) test email viewer that runs locally with a built-in SMTP server designed to receive and notify of test email messages.
* [Visual Studio Uninstaller ![GitHub Repo stars](https://img.shields.io/github/stars/Microsoft/VisualStudioUninstaller) ![GitHub last commit](https://img.shields.io/github/last-commit/Microsoft/VisualStudioUninstaller)](https://github.com/Microsoft/VisualStudioUninstaller) - Uninstall and clean up all components of Visual Studio.
...
* [SmartCode ![GitHub Repo stars](https://img.shields.io/github/stars/dotnetcore/SmartCode) ![GitHub last commit](https://img.shields.io/github/last-commit/dotnetcore/SmartCode)](https://github.com/dotnetcore/SmartCode) - SmartCode = IDataSource -> IBuildTask -> IOutput => Build Everything!!! (Including [**Code generator**])
* [NETworkManager ![GitHub Repo stars](https://img.shields.io/github/stars/BornToBeRoot/NETworkManager) ![GitHub last commit](https://img.shields.io/github/last-commit/BornToBeRoot/NETworkManager)](https://github.com/BornToBeRoot/NETworkManager) - A powerful tool for managing networks and troubleshoot network problems!
...
* [OctoLinker ![GitHub Repo stars](https://img.shields.io/github/stars/OctoLinker/OctoLinker) ![GitHub last commit](https://img.shields.io/github/last-commit/OctoLinker/OctoLinker)](https://github.com/OctoLinker/OctoLinker) - Navigate through `project.json`, `packages.config`, `*.props`, `*.targets`, and C#/F#/VB.NET project files efficiently with the OctoLinker browser extension for GitHub.
* [YARP ![GitHub Repo stars](https://img.shields.io/github/stars/microsoft/reverse-proxy) ![GitHub last commit](https://img.shields.io/github/last-commit/microsoft/reverse-proxy)](https://github.com/microsoft/reverse-proxy) - YARP is a reverse proxy toolkit for building fast proxy servers in .NET using the infrastructure from ASP.NET and .NET.
...
* [StockSharp ![GitHub Repo stars](https://img.shields.io/github/stars/StockSharp/StockSharp) ![GitHub last commit](https://img.shields.io/github/last-commit/StockSharp/StockSharp)](https://github.com/StockSharp/StockSharp) - Trading and algorithmic trading open source platform (stock markets, forex, bitcoins and options). https://stocksharp.com
...
* [FlaUI ![GitHub Repo stars](https://img.shields.io/github/stars/FlaUI/FlaUI) ![GitHub last commit](https://img.shields.io/github/last-commit/FlaUI/FlaUI)](https://github.com/FlaUI/FlaUI) - FlaUI is a .NET library which helps with automated UI testing of Windows applications (Win32, WinForms, WPF, Store Apps, ...).
* [PuppeteerSharp ![GitHub Repo stars](https://img.shields.io/github/stars/hardkoded/puppeteer-sharp) ![GitHub last commit](https://img.shields.io/github/last-commit/hardkoded/puppeteer-sharp)](https://github.com/hardkoded/puppeteer-sharp) - Puppeteer Sharp is a .NET port of the official Node.JS Puppeteer API.
* [PuppeteerSharp.Contrib ![GitHub Repo stars](https://img.shields.io/github/stars/hlaueriksson/puppeteer-sharp-contrib) ![GitHub last commit](https://img.shields.io/github/last-commit/hlaueriksson/puppeteer-sharp-contrib)](https://github.com/hlaueriksson/puppeteer-sharp-contrib) - Contributions to Puppeteer Sharp that provides a convenient way to write readable and robust browser tests.
...
* [SideWaffle ![GitHub Repo stars](https://img.shields.io/github/stars/ligershark/side-waffle) ![GitHub last commit](https://img.shields.io/github/last-commit/ligershark/side-waffle)](https://github.com/ligershark/side-waffle) - A collection of Item Templates for Visual Studio 2012/2013/2015 that makes any web developer's life much easier
...
* [CodeContracts ![GitHub Repo stars](https://img.shields.io/github/stars/Microsoft/CodeContracts) ![GitHub last commit](https://img.shields.io/github/last-commit/Microsoft/CodeContracts)](https://github.com/Microsoft/CodeContracts) - Source code for the CodeContracts tools for .NET
* [Git Diff Margin ![GitHub Repo stars](https://img.shields.io/github/stars/laurentkempe/GitDiffMargin) ![GitHub last commit](https://img.shields.io/github/last-commit/laurentkempe/GitDiffMargin)](https://github.com/laurentkempe/GitDiffMargin) - Displays live Git changes of the currently edited file on Visual Studio margin and scroll bar
...
* [Roslynator ![GitHub Repo stars](https://img.shields.io/github/stars/JosefPihrt/Roslynator) ![GitHub last commit](https://img.shields.io/github/last-commit/JosefPihrt/Roslynator)](https://github.com/JosefPihrt/Roslynator) - A collection of 500+ analyzers, refactorings and fixes for C#, powered by Roslyn
* [Unchase.Odata.Connectedservice ![GitHub Repo stars](https://img.shields.io/github/stars/unchase/Unchase.Odata.Connectedservice) ![GitHub last commit](https://img.shields.io/github/last-commit/unchase/Unchase.Odata.Connectedservice)](https://github.com/unchase/Unchase.Odata.Connectedservice) - A Visual Studio Connected Service for generating API client code in C# or VB for OData web service.
* [Unchase.OpenAPI.Connectedservice ![GitHub Repo stars](https://img.shields.io/github/stars/unchase/Unchase.OpenAPI.Connectedservice) ![GitHub last commit](https://img.shields.io/github/last-commit/unchase/Unchase.OpenAPI.Connectedservice)](https://github.com/unchase/Unchase.OpenAPI.Connectedservice) - A Visual Studio 2017/2019 extension to generate C# (TypeScript) HttpClient (or C# Controllers) code for OpenAPI web service with [NSwag ![GitHub Repo stars](https://img.shields.io/github/stars/RicoSuter/NSwag) ![GitHub last commit](https://img.shields.io/github/last-commit/RicoSuter/NSwag)](https://github.com/RicoSuter/NSwag).
...
* [DotVVM ![GitHub Repo stars](https://img.shields.io/github/stars/riganti/dotvvm) ![GitHub last commit](https://img.shields.io/github/last-commit/riganti/dotvvm)](https://github.com/riganti/dotvvm) - MVVM framework for people who don't like to write JavaScript, with OWIN and ASP.NET Core support and a free extension for Visual Studio 2015 and 2017.
* [Giraffe ![GitHub Repo stars](https://img.shields.io/github/stars/giraffe-fsharp/Giraffe) ![GitHub last commit](https://img.shields.io/github/last-commit/giraffe-fsharp/Giraffe)](https://github.com/giraffe-fsharp/Giraffe) - Functional (F#) ASP.NET Core micro framework for building rich web applications

## Web Servers

* [Kestrel ![GitHub Repo stars](https://img.shields.io/github/stars/aspnet/KestrelHttpServer) ![GitHub last commit](https://img.shields.io/github/last-commit/aspnet/KestrelHttpServer)](https://github.com/aspnet/KestrelHttpServer) -  A web server for ASP.NET Core based on libuv
...
* [Fleck ![GitHub Repo stars](https://img.shields.io/github/stars/statianzo/Fleck) ![GitHub last commit](https://img.shields.io/github/last-commit/statianzo/Fleck)](https://github.com/statianzo/Fleck) - Fleck is a WebSocket server implementation in C#. Branched from the Nugget project
* [SignalR ![GitHub Repo stars](https://img.shields.io/github/stars/SignalR/SignalR) ![GitHub last commit](https://img.shields.io/github/last-commit/SignalR/SignalR)](https://github.com/SignalR/SignalR) - Library for ASP.NET developers that makes it incredibly simple to add real-time web functionality to your applications
* [SuperSocket ![GitHub Repo stars](https://img.shields.io/github/stars/kerryjiang/SuperSocket) ![GitHub last commit](https://img.shields.io/github/last-commit/kerryjiang/SuperSocket)](https://github.com/kerryjiang/SuperSocket) - SuperSocket is a light weight extensible socket application framework
* [Websocket-Sharp ![GitHub Repo stars](https://img.shields.io/github/stars/sta/websocket-sharp) ![GitHub last commit](https://img.shields.io/github/last-commit/sta/websocket-sharp)](https://github.com/sta/websocket-sharp) - A C# implementation of the WebSocket protocol client and server
...
* [NetGain ![GitHub Repo stars](https://img.shields.io/github/stars/StackExchange/NetGain) ![GitHub last commit](https://img.shields.io/github/last-commit/StackExchange/NetGain)](https://github.com/StackExchange/NetGain) - A high performance WebSocket server library powering Stack Overflow.
* [Websockets.PCL ![GitHub Repo stars](https://img.shields.io/github/stars/NVentimiglia/Websockets.PCL) ![GitHub last commit](https://img.shields.io/github/last-commit/NVentimiglia/Websockets.PCL)](https://github.com/NVentimiglia/Websockets.PCL) - WebSockets.PCL is a portable class library, profile 259, C# WebSocket implementation.
* [Websocket.Client ![GitHub Repo stars](https://img.shields.io/github/stars/Marfusios/websocket-client) ![GitHub last commit](https://img.shields.io/github/last-commit/Marfusios/websocket-client)](https://github.com/Marfusios/websocket-client) - A multiplatform wrapper over native C# class ClientWebSocket with built-in reconnection and error handling.

## Windows Services

* [TopShelf ![GitHub Repo stars](https://img.shields.io/github/stars/Topshelf/Topshelf) ![GitHub last commit](https://img.shields.io/github/last-commit/Topshelf/Topshelf)](https://github.com/Topshelf/Topshelf) - An easy service hosting framework for building Windows services using .NET
...
* [Sprache ![GitHub Repo stars](https://img.shields.io/github/stars/sprache/Sprache) ![GitHub last commit](https://img.shields.io/github/last-commit/sprache/Sprache)](https://github.com/sprache/Sprache) - A simple, lightweight library for constructing parsers directly in C# code
...
* [C# Algorithms, Data Structures ![GitHub Repo stars](https://img.shields.io/github/stars/aalhour/C-Sharp-Algorithms) ![GitHub last commit](https://img.shields.io/github/last-commit/aalhour/C-Sharp-Algorithms)](https://github.com/aalhour/C-Sharp-Algorithms) - A list of algorithms and data structures implementations.
* [Awesome .NET Core ![GitHub Repo stars](https://img.shields.io/github/stars/thangchung/awesome-dotnet-core) ![GitHub last commit](https://img.shields.io/github/last-commit/thangchung/awesome-dotnet-core)](https://github.com/thangchung/awesome-dotnet-core) - A collection of awesome .NET core libraries, tools, frameworks and software
* [ASP.NET Core Library and Framework Support ![GitHub Repo stars](https://img.shields.io/github/stars/jpsingleton/ANCLAFS) ![GitHub last commit](https://img.shields.io/github/last-commit/jpsingleton/ANCLAFS)](https://github.com/jpsingleton/ANCLAFS) - A list of what .NET libraries and frameworks are currently supported by ASP.NET Core and .NET Core).
* [Awesome .NET Performance ![GitHub Repo stars](https://img.shields.io/github/stars/adamsitnik/awesome-dot-net-performance) ![GitHub last commit](https://img.shields.io/github/last-commit/adamsitnik/awesome-dot-net-performance)](https://github.com/adamsitnik/awesome-dot-net-performance) - A curated list of awesome .NET Performance books, courses, trainings, conference talks, blogs and most inspiring open source contributors.
* [awesome-ddd ![GitHub Repo stars](https://img.shields.io/github/stars/heynickc/awesome-ddd) ![GitHub last commit](https://img.shields.io/github/last-commit/heynickc/awesome-ddd)](https://github.com/heynickc/awesome-ddd) - A curated list of Domain-Driven Design (DDD), Command Query Responsibility Segregation (CQRS), Event Sourcing, and Event Storming resources
* [Awesome Unity ![GitHub Repo stars](https://img.shields.io/github/stars/RyanNielson/awesome-unity) ![GitHub last commit](https://img.shields.io/github/last-commit/RyanNielson/awesome-unity)](https://github.com/RyanNielson/awesome-unity) - A categorized community-driven collection of high-quality awesome Unity assets, projects, and resources.
* [Awesome Xamarin ![GitHub Repo stars](https://img.shields.io/github/stars/XamSome/awesome-xamarin) ![GitHub last commit](https://img.shields.io/github/last-commit/XamSome/awesome-xamarin)](https://github.com/XamSome/awesome-xamarin) - A collection of interesting libraries/tools for Xamarin mobile projects.
* [Awesome Roslyn ![GitHub Repo stars](https://img.shields.io/github/stars/ironcev/awesome-roslyn) ![GitHub last commit](https://img.shields.io/github/last-commit/ironcev/awesome-roslyn)](https://github.com/ironcev/awesome-roslyn) - A curated list of awesome Roslyn books, tutorials, open source projects, analyzers, code fixes, and refactorings.
...
* [Awesome .NET Core Education ![GitHub Repo stars](https://img.shields.io/github/stars/mehdihadeli/awesome-dotnet-core-education) ![GitHub last commit](https://img.shields.io/github/last-commit/mehdihadeli/awesome-dotnet-core-education)](https://github.com/mehdihadeli/awesome-dotnet-core-education) - A collection of awesome articles and resources for learning and practicing about .Net Core and its related technologies.
* [Awesome .Net Async ![GitHub Repo stars](https://img.shields.io/github/stars/mehdihadeli/awesome-dotnet-async) ![GitHub last commit](https://img.shields.io/github/last-commit/mehdihadeli/awesome-dotnet-async)](https://github.com/mehdihadeli/awesome-dotnet-async) - A Collection of useful articles and resources to learning and practicing about async, threading, and channels in .Net platform.
* [Awesome Software Architecture ![GitHub Repo stars](https://img.shields.io/github/stars/mehdihadeli/awesome-software-architecture) ![GitHub last commit](https://img.shields.io/github/last-commit/mehdihadeli/awesome-software-architecture)](https://github.com/mehdihadeli/awesome-software-architecture) - A Collection of useful articles and resources to learn and practice about software architecture, patterns, and principles.
