...
* [astar ![GitHub Repo stars](https://img.shields.io/github/stars/xiejiangzhi/astar) ![GitHub last commit](https://img.shields.io/github/last-commit/xiejiangzhi/astar)](https://github.com/xiejiangzhi/astar) - An other A* library. Any map(gird, point, mesh or infinite map) and support path cost.
...
* [LoveDebug ![GitHub Repo stars](https://img.shields.io/github/stars/Ranguna/LOVEDEBUG) ![GitHub last commit](https://img.shields.io/github/last-commit/Ranguna/LOVEDEBUG)](https://github.com/Ranguna/LOVEDEBUG) - Inline console-like debugger utility
...
* [lovelier ![GitHub Repo stars](https://img.shields.io/github/stars/patrixr/lovelier) ![GitHub last commit](https://img.shields.io/github/last-commit/patrixr/lovelier)](https://github.com/patrixr/lovelier) - A Love2D live reloader with Moonscript support
...
* [cindy ![GitHub Repo stars](https://img.shields.io/github/stars/megagrump/cindy) ![GitHub last commit](https://img.shields.io/github/last-commit/megagrump/cindy)](https://github.com/megagrump/cindy) - Use byte color values in LÖVE 11+
...
* [hump ![GitHub Repo stars](https://img.shields.io/github/stars/vrld/hump) ![GitHub last commit](https://img.shields.io/github/last-commit/vrld/hump)](https://github.com/vrld/hump) - Collection of tools for developing games with LÖVE (Gamestates, Timers/Tweens, Vectors, Classes, Signals, Cameras). Repo is inactive but improvements are in the works at [this fork ![GitHub Repo stars](https://img.shields.io/github/stars/HDictus/hump) ![GitHub last commit](https://img.shields.io/github/last-commit/HDictus/hump)](https://github.com/HDictus/hump/tree/temp-master) (branch temp-master)
...
* [rotLove ![GitHub Repo stars](https://img.shields.io/github/stars/paulofmandown/rotLove) ![GitHub last commit](https://img.shields.io/github/last-commit/paulofmandown/rotLove)](https://github.com/paulofmandown/rotLove) - Roguelike Toolkit in Love. A Love2D/lua port of rot.js
...
* [boipushy ![GitHub Repo stars](https://img.shields.io/github/stars/adnzzzzZ/boipushy) ![GitHub last commit](https://img.shields.io/github/last-commit/adnzzzzZ/boipushy)](https://github.com/adnzzzzZ/boipushy) - A simple and easy to use input handler
...
* [Windfield ![GitHub Repo stars](https://img.shields.io/github/stars/adnzzzzZ/windfield) ![GitHub last commit](https://img.shields.io/github/last-commit/adnzzzzZ/windfield)](https://github.com/adnzzzzZ/windfield) - Physics module wrapper for LÖVE
...
* [LovePotion ![GitHub Repo stars](https://img.shields.io/github/stars/TurtleP/LovePotion) ![GitHub last commit](https://img.shields.io/github/last-commit/TurtleP/LovePotion)](https://github.com/TurtleP/LovePotion) - Unofficial work-in-progress implementation of the LÖVE API for Nintendo 3DS and Nintendo Switch Homebrew
...
* [Slab ![GitHub Repo stars](https://img.shields.io/github/stars/coding-jackalope/Slab) ![GitHub last commit](https://img.shields.io/github/last-commit/coding-jackalope/Slab)](https://github.com/coding-jackalope/Slab) - Slab is an immediate mode GUI toolkit for the LÖVE framework.
...
* [love-pe ![GitHub Repo stars](https://img.shields.io/github/stars/RamiLego4Game/love-pe) ![GitHub last commit](https://img.shields.io/github/last-commit/RamiLego4Game/love-pe)](https://github.com/RamiLego4Game/love-pe) - A tool made in LÖVE for changing LÖVE icon itself
* [lovely-engine ![GitHub Repo stars](https://img.shields.io/github/stars/vinnyhorgan/lovely-engine) ![GitHub last commit](https://img.shields.io/github/last-commit/vinnyhorgan/lovely-engine)](https://github.com/vinnyhorgan/lovely-engine) - A tool that makes setting up and using Love2d easier and with Moonscript support
...
* [nativefs ![GitHub Repo stars](https://img.shields.io/github/stars/megagrump/nativefs) ![GitHub last commit](https://img.shields.io/github/last-commit/megagrump/nativefs)](https://github.com/megagrump/nativefs) - Read and write files outside of LÖVE's allowed paths
...
* [adnzzzzZ's ![GitHub Repo stars](https://img.shields.io/github/stars/adnzzzzZ/blog) ![GitHub last commit](https://img.shields.io/github/last-commit/adnzzzzZ/blog)](https://github.com/adnzzzzZ/blog) - A blog by [adnzzzzZ](https://github.com/adnzzzzZ) with articles about game development using LÖVE
...
* [Atom](https://atom.io/) - A hackable text editor for the 21st Century
	...
	* [linter-luacheck ![GitHub Repo stars](https://img.shields.io/github/stars/AtomLinter/linter-luacheck) ![GitHub last commit](https://img.shields.io/github/last-commit/AtomLinter/linter-luacheck)](https://github.com/AtomLinter/linter-luacheck) - Lint Lua on the fly, using luacheck
...
Please see [CONTRIBUTING ![GitHub Repo stars](https://img.shields.io/github/stars/love2d-community/awesome-love2d) ![GitHub last commit](https://img.shields.io/github/last-commit/love2d-community/awesome-love2d)](https://github.com/love2d-community/awesome-love2d/blob/master/CONTRIBUTING.md) for details.
