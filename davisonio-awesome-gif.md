...
- [Gifify ![GitHub Repo stars](https://img.shields.io/github/stars/vvo/gifify) ![GitHub last commit](https://img.shields.io/github/last-commit/vvo/gifify)](https://github.com/vvo/gifify) - Convert any video file to an optimized animated GIF
- [Gifify (not the same) ![GitHub Repo stars](https://img.shields.io/github/stars/jclem/gifify) ![GitHub last commit](https://img.shields.io/github/last-commit/jclem/gifify)](https://github.com/jclem/gifify) - convert screen recording into GIF
- [Gifsicle ![GitHub Repo stars](https://img.shields.io/github/stars/kornelski/giflossy) ![GitHub last commit](https://img.shields.io/github/last-commit/kornelski/giflossy)](https://github.com/kornelski/giflossy) - lossy GIF compressor
...
- [WpfAnimatedGif ![GitHub Repo stars](https://img.shields.io/github/stars/thomaslevesque/WpfAnimatedGif) ![GitHub last commit](https://img.shields.io/github/last-commit/thomaslevesque/WpfAnimatedGif)](https://github.com/thomaslevesque/WpfAnimatedGif) - A simple library to display animated GIF images in WPF
- [XamlAnimatedGif ![GitHub Repo stars](https://img.shields.io/github/stars/thomaslevesque/XamlAnimatedGif) ![GitHub last commit](https://img.shields.io/github/last-commit/thomaslevesque/XamlAnimatedGif)](https://github.com/thomaslevesque/XamlAnimatedGif) - A simple library to display animated GIF images in XAML apps (WPF, WinRT, Windows Phone)
...
- [GIFDroid ![GitHub Repo stars](https://img.shields.io/github/stars/quackware/GIFDroid) ![GitHub last commit](https://img.shields.io/github/last-commit/quackware/GIFDroid)](https://github.com/quackware/GIFDroid) - Android video to GIF converter
...
- [Gif.js ![GitHub Repo stars](https://img.shields.io/github/stars/jnordberg/gif.js) ![GitHub last commit](https://img.shields.io/github/last-commit/jnordberg/gif.js)](https://github.com/jnordberg/gif.js) - Javascript - create GIF from the DOM
- [Omggif ![GitHub Repo stars](https://img.shields.io/github/stars/deanm/omggif) ![GitHub last commit](https://img.shields.io/github/last-commit/deanm/omggif)](https://github.com/deanm/omggif) - Javascript - GIF 89a encoder and decoder
...
- [OLImageView ![GitHub Repo stars](https://img.shields.io/github/stars/dtorres/OLImageView) ![GitHub last commit](https://img.shields.io/github/last-commit/dtorres/OLImageView)](https://github.com/dtorres/OLImageView) - iOS OLImage and OLImageView support for animated GIFs
...
- [SwiftGif ![GitHub Repo stars](https://img.shields.io/github/stars/swiftgif/SwiftGif) ![GitHub last commit](https://img.shields.io/github/last-commit/swiftgif/SwiftGif)](https://github.com/swiftgif/SwiftGif) - UIImage extension with GIF support
...
- [GIFs ![GitHub Repo stars](https://img.shields.io/github/stars/orta/GIFs) ![GitHub last commit](https://img.shields.io/github/last-commit/orta/GIFs)](https://github.com/orta/GIFs) - Mac App for finding GIFs
- [VineGifR ![GitHub Repo stars](https://img.shields.io/github/stars/caraesten/VineGifR) ![GitHub last commit](https://img.shields.io/github/last-commit/caraesten/VineGifR)](https://github.com/caraesten/VineGifR ) - Mac app to turn Vine videos into GIFs
...
- [AnimatedGif ![GitHub Repo stars](https://img.shields.io/github/stars/Waitsnake/AnimatedGif) ![GitHub last commit](https://img.shields.io/github/last-commit/Waitsnake/AnimatedGif)](https://github.com/Waitsnake/AnimatedGif) - Mac Screensaver for playing GIFs
...
- [Starwars-dot-gif ![GitHub Repo stars](https://img.shields.io/github/stars/LindseyB/starwars-dot-gif) ![GitHub last commit](https://img.shields.io/github/last-commit/LindseyB/starwars-dot-gif)](https://github.com/LindseyB/starwars-dot-gif) - Python script to generate GIFs from star wars
...
- with [vid2gif](https://imgur.com/vidgif) online - [source ![GitHub Repo stars](https://img.shields.io/github/stars/jimgur/gif) ![GitHub last commit](https://img.shields.io/github/last-commit/jimgur/gif)](https://github.com/jimgur/gif)
...
```
or use [ccapture.js ![GitHub Repo stars](https://img.shields.io/github/stars/spite/ccapture.js) ![GitHub last commit](https://img.shields.io/github/last-commit/spite/ccapture.js)](https://github.com/spite/ccapture.js).
...
...and [contributors ![GitHub Repo stars](https://img.shields.io/github/stars/davisonio/awesome-gif) ![GitHub last commit](https://img.shields.io/github/last-commit/davisonio/awesome-gif)](https://github.com/davisonio/awesome-gif/graphs/contributors).

**[Contributions are welcome! ![GitHub Repo stars](https://img.shields.io/github/stars/davisonio/awesome-gif) ![GitHub last commit](https://img.shields.io/github/last-commit/davisonio/awesome-gif)](https://github.com/davisonio/awesome-gif/blob/master/contributing.md)**
...
Based on a [recovered list ![GitHub Repo stars](https://img.shields.io/github/stars/sindresorhus/awesome) ![GitHub last commit](https://img.shields.io/github/last-commit/sindresorhus/awesome)](https://github.com/sindresorhus/awesome/issues/872):
