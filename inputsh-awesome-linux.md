...
* [Blackbox ![GitHub Repo stars](https://img.shields.io/github/stars/bradleythughes/blackbox) ![GitHub last commit](https://img.shields.io/github/last-commit/bradleythughes/blackbox)](https://github.com/bradleythughes/blackbox) - Lightweight window manager for the X window system, without library dependencies. Built using C++.
* [bspwm ![GitHub Repo stars](https://img.shields.io/github/stars/baskerville/bspwm) ![GitHub last commit](https://img.shields.io/github/last-commit/baskerville/bspwm)](https://github.com/baskerville/bspwm) - Tiling window manager that represents windows as the leaves of a full binary tree.
...
If you're looking for some pro-tips for your favorite text editor, you might be interested in [awesome-atom ![GitHub Repo stars](https://img.shields.io/github/stars/mehcode/awesome-atom) ![GitHub last commit](https://img.shields.io/github/last-commit/mehcode/awesome-atom)](https://github.com/mehcode/awesome-atom), [sublime-bookmarks ![GitHub Repo stars](https://img.shields.io/github/stars/dreikanter/sublime-bookmarks) ![GitHub last commit](https://img.shields.io/github/last-commit/dreikanter/sublime-bookmarks)](https://github.com/dreikanter/sublime-bookmarks), [vim-galore ![GitHub Repo stars](https://img.shields.io/github/stars/mhinz/vim-galore) ![GitHub last commit](https://img.shields.io/github/last-commit/mhinz/vim-galore)](https://github.com/mhinz/vim-galore), [awesome-emacs ![GitHub Repo stars](https://img.shields.io/github/stars/emacs-tw/awesome-emacs) ![GitHub last commit](https://img.shields.io/github/last-commit/emacs-tw/awesome-emacs)](https://github.com/emacs-tw/awesome-emacs), or [awesome-vscode ![GitHub Repo stars](https://img.shields.io/github/stars/viatsko/awesome-vscode) ![GitHub last commit](https://img.shields.io/github/last-commit/viatsko/awesome-vscode)](https://github.com/viatsko/awesome-vscode).
...
* [Spice-Up ![GitHub Repo stars](https://img.shields.io/github/stars/Philip-Scott/Spice-up) ![GitHub last commit](https://img.shields.io/github/last-commit/Philip-Scott/Spice-up)](https://github.com/Philip-Scott/Spice-up) - Desktop presentation app.
...
* [Caprine ![GitHub Repo stars](https://img.shields.io/github/stars/sindresorhus/caprine) ![GitHub last commit](https://img.shields.io/github/last-commit/sindresorhus/caprine)](https://github.com/sindresorhus/caprine/) - Facebook's Messenger client with some added privacy features.
...
* [ramme ![GitHub Repo stars](https://img.shields.io/github/stars/terkelg/ramme) ![GitHub last commit](https://img.shields.io/github/last-commit/terkelg/ramme)](https://github.com/terkelg/ramme) - Instagram client.
* [Whatever ![GitHub Repo stars](https://img.shields.io/github/stars/CellarD0-0r/whatever) ![GitHub last commit](https://img.shields.io/github/last-commit/CellarD0-0r/whatever)](https://github.com/CellarD0-0r/whatever) - Evernote client based on the web version.
...
* [dnfdragora ![GitHub Repo stars](https://img.shields.io/github/stars/manatools/dnfdragora) ![GitHub last commit](https://img.shields.io/github/last-commit/manatools/dnfdragora)](https://github.com/manatools/dnfdragora) (Fedora) - A GUI for the `dnf` package manager.
* [Yay ![GitHub Repo stars](https://img.shields.io/github/stars/Jguer/yay) ![GitHub last commit](https://img.shields.io/github/last-commit/Jguer/yay)](https://github.com/Jguer/yay) (Arch) - Yay is one of the many wrappers to `pacman` which automatically downloads and installs packages from AUR, a full list can be found [here](https://wiki.archlinux.org/index.php/AUR_helpers).
* [Aura ![GitHub Repo stars](https://img.shields.io/github/stars/aurapm/aura) ![GitHub last commit](https://img.shields.io/github/last-commit/aurapm/aura)](https://github.com/aurapm/aura) (Arch) - Secure, multilingual package manager.

Distro-independent:

* [AppImageKit ![GitHub Repo stars](https://img.shields.io/github/stars/probonopd/AppImageKit) ![GitHub last commit](https://img.shields.io/github/last-commit/probonopd/AppImageKit)](https://github.com/probonopd/AppImageKit) - Using AppImageKit you can package applications in the [AppImage](http://appimage.org/) format that runs on common Linux-based operating systems, such as RHEL, CentOS, Ubuntu, Fedora, debian and derivatives; one app = one file.

### Console-based Applications and Tools

You might also be interested in checking out [awesome-shell ![GitHub Repo stars](https://img.shields.io/github/stars/alebcay/awesome-shell) ![GitHub last commit](https://img.shields.io/github/last-commit/alebcay/awesome-shell)](https://github.com/alebcay/awesome-shell), [awesome-bash ![GitHub Repo stars](https://img.shields.io/github/stars/awesome-lists/awesome-bash) ![GitHub last commit](https://img.shields.io/github/last-commit/awesome-lists/awesome-bash)](https://github.com/awesome-lists/awesome-bash), [awesome-zsh-plugins ![GitHub Repo stars](https://img.shields.io/github/stars/unixorn/awesome-zsh-plugins) ![GitHub last commit](https://img.shields.io/github/last-commit/unixorn/awesome-zsh-plugins)](https://github.com/unixorn/awesome-zsh-plugins) or [awesome-fish ![GitHub Repo stars](https://img.shields.io/github/stars/jbucaran/awesome-fish) ![GitHub last commit](https://img.shields.io/github/last-commit/jbucaran/awesome-fish)](https://github.com/jbucaran/awesome-fish).

* [cmus](https://cmus.github.io/) - Small, fast and powerful console music player.
* [fuck ![GitHub Repo stars](https://img.shields.io/github/stars/nvbn/thefuck) ![GitHub last commit](https://img.shields.io/github/last-commit/nvbn/thefuck)](https://github.com/nvbn/thefuck) - Command line tool which corrects your previously mistyped command.
...
* [ranger ![GitHub Repo stars](https://img.shields.io/github/stars/ranger/ranger) ![GitHub last commit](https://img.shields.io/github/last-commit/ranger/ranger)](https://github.com/ranger/ranger) - Vim-inspired file manager for the console.
* [screenFetch ![GitHub Repo stars](https://img.shields.io/github/stars/KittyKatt/screenFetch) ![GitHub last commit](https://img.shields.io/github/last-commit/KittyKatt/screenFetch)](https://github.com/KittyKatt/screenFetch) - Fetches system/theme information in terminal.
...
* [speed-test ![GitHub Repo stars](https://img.shields.io/github/stars/sindresorhus/speed-test) ![GitHub last commit](https://img.shields.io/github/last-commit/sindresorhus/speed-test)](https://github.com/sindresorhus/speed-test) - Test your Internet connection speed and ping using [speedtest.net](http://www.speedtest.net/).
* [testdisk](http://www.cgsecurity.org/wiki/TestDisk) - A tool for disk partition recovery.
* [tig ![GitHub Repo stars](https://img.shields.io/github/stars/jonas/tig) ![GitHub last commit](https://img.shields.io/github/last-commit/jonas/tig)](https://github.com/jonas/tig) - Text-mode interface for git. It functions mainly as a Git repository browser.
...
* [vtop ![GitHub Repo stars](https://img.shields.io/github/stars/MrRio/vtop) ![GitHub last commit](https://img.shields.io/github/last-commit/MrRio/vtop)](https://github.com/MrRio/vtop) - Easily-extendable activity monitor.
* [wavemon ![GitHub Repo stars](https://img.shields.io/github/stars/uoaerg/wavemon) ![GitHub last commit](https://img.shields.io/github/last-commit/uoaerg/wavemon)](https://github.com/uoaerg/wavemon) - Monitoring application for wireless network devices.
* [youtube-dl ![GitHub Repo stars](https://img.shields.io/github/stars/rg3/youtube-dl) ![GitHub last commit](https://img.shields.io/github/last-commit/rg3/youtube-dl)](https://github.com/rg3/youtube-dl) - A tool to download videos from YouTube and other video sites.
