...
* [C++ Workflow ![GitHub Repo stars](https://img.shields.io/github/stars/sogou/workflow) ![GitHub last commit](https://img.shields.io/github/last-commit/sogou/workflow)](https://github.com/sogou/workflow) - C++ Parallel Computing and Asynchronous Networking Engine. [Apache2]
...
* [CO ![GitHub Repo stars](https://img.shields.io/github/stars/idealvin/co) ![GitHub last commit](https://img.shields.io/github/last-commit/idealvin/co)](https://github.com/idealvin/co) - A collection of C++ libraries, containing a go-style coroutine library, log, JSON, RPC framework and other base components. [MIT]
...
* [AudioFile ![GitHub Repo stars](https://img.shields.io/github/stars/adamstark/AudioFile) ![GitHub last commit](https://img.shields.io/github/last-commit/adamstark/AudioFile)](https://github.com/adamstark/AudioFile) - A simple C++ library for reading and writing audio files. [GPL3]
...
* [miniaudio ![GitHub Repo stars](https://img.shields.io/github/stars/dr-soft/miniaudio) ![GitHub last commit](https://img.shields.io/github/last-commit/dr-soft/miniaudio)](https://github.com/dr-soft/miniaudio) - Single file audio playback and capture library. [Unlicense]
 ...
 * [Clara ![GitHub Repo stars](https://img.shields.io/github/stars/catchorg/Clara) ![GitHub last commit](https://img.shields.io/github/last-commit/catchorg/Clara)](https://github.com/catchorg/Clara) - A simple to use, composable, command line parser for C++ 11 and beyond. [BSL-1.0]
...
* [bit7z ![GitHub Repo stars](https://img.shields.io/github/stars/rikyoz/bit7z) ![GitHub last commit](https://img.shields.io/github/last-commit/rikyoz/bit7z)](https://github.com/rikyoz/bit7z) - A C++ static library offering a clean and simple interface to the 7-zip DLLs. [GPLv2]
...
* [Boost.Compute ![GitHub Repo stars](https://img.shields.io/github/stars/boostorg/compute) ![GitHub last commit](https://img.shields.io/github/last-commit/boostorg/compute)](https://github.com/boostorg/compute) - A C++ GPU Computing Library for OpenCL. [Boost]
...
* [Cpp-Taskflow ![GitHub Repo stars](https://img.shields.io/github/stars/cpp-taskflow/cpp-taskflow) ![GitHub last commit](https://img.shields.io/github/last-commit/cpp-taskflow/cpp-taskflow)](https://github.com/cpp-taskflow/cpp-taskflow) - Fast C++ Parallel Programming with Task Dependencies. [MIT]
...
* [Quantum ![GitHub Repo stars](https://img.shields.io/github/stars/bloomberg/quantum) ![GitHub last commit](https://img.shields.io/github/last-commit/bloomberg/quantum)](https://github.com/bloomberg/quantum) - A powerful C++ coroutine dispatcher framework built on top of [boost::coroutines2](https://www.boost.org/doc/libs/1_65_0/libs/coroutine2/doc/html/index.html).
...
* [Forest ![GitHub Repo stars](https://img.shields.io/github/stars/xorz57/forest) ![GitHub last commit](https://img.shields.io/github/last-commit/xorz57/forest)](https://github.com/xorz57/forest) - Template library implementing an AVL, a Binary Search, a KD and a Quad Tree. [MIT]
...
* [SOCI ![GitHub Repo stars](https://img.shields.io/github/stars/SOCI/soci) ![GitHub last commit](https://img.shields.io/github/last-commit/SOCI/soci)](https://github.com/SOCI/soci) - A database abstraction layer for C++. [BSL-1.0]
...
* [sqlite_orm ![GitHub Repo stars](https://img.shields.io/github/stars/fnc12/sqlite_orm) ![GitHub last commit](https://img.shields.io/github/last-commit/fnc12/sqlite_orm)](https://github.com/fnc12/sqlite_orm) - SQLite ORM light header only library for modern C++. [BSD-3-Clause]
...
* [Catch ![GitHub Repo stars](https://img.shields.io/github/stars/philsquared/Catch) ![GitHub last commit](https://img.shields.io/github/last-commit/philsquared/Catch)](https://github.com/philsquared/Catch) - A modern, C++-native, header-only, framework for unit-tests, TDD and BDD. [Boost]
* [Catch2 ![GitHub Repo stars](https://img.shields.io/github/stars/catchorg/Catch2) ![GitHub last commit](https://img.shields.io/github/last-commit/catchorg/Catch2)](https://github.com/catchorg/Catch2) - A modern, C++-native, header-only, test framework for unit-tests, TDD and BDD. [BSL-1.0]
...
* [Torque2D ![GitHub Repo stars](https://img.shields.io/github/stars/GarageGames/Torque2D) ![GitHub last commit](https://img.shields.io/github/last-commit/GarageGames/Torque2D)](https://github.com/GarageGames/Torque2D) - An open-source and cross-platform C++ engine built for 2D game development. [MIT] [website](https://www.garagegames.com/products/torque-2d)
* [Torque3D ![GitHub Repo stars](https://img.shields.io/github/stars/GarageGames/Torque3D) ![GitHub last commit](https://img.shields.io/github/last-commit/GarageGames/Torque3D)](https://github.com/GarageGames/Torque3D) - An open-source C++ engine built for 3D game development. [MIT] [website](https://www.garagegames.com/products/torque-3d)
...
* [bs::framework ![GitHub Repo stars](https://img.shields.io/github/stars/GameFoundry/bsf) ![GitHub last commit](https://img.shields.io/github/last-commit/GameFoundry/bsf)](https://github.com/GameFoundry/bsf) - Modern C++14 library for the development of real-time graphical applications. [MIT]
...
* [Skia ![GitHub Repo stars](https://img.shields.io/github/stars/google/skia) ![GitHub last commit](https://img.shields.io/github/last-commit/google/skia)](https://github.com/google/skia) - A complete 2D graphic library for drawing Text, Geometries, and Images. [BSD] [webpage](https://sites.google.com/site/skiadocs/home)
...
* [json ![GitHub Repo stars](https://img.shields.io/github/stars/nlohmann/json) ![GitHub last commit](https://img.shields.io/github/last-commit/nlohmann/json)](https://github.com/nlohmann/json) :zap: - JSON for Modern C++. [MIT]
...
* [RapidJSON ![GitHub Repo stars](https://img.shields.io/github/stars/miloyip/rapidjson) ![GitHub last commit](https://img.shields.io/github/last-commit/miloyip/rapidjson)](https://github.com/miloyip/rapidjson) :zap: - A fast JSON parser/generator for C++ with both SAX/DOM style API. [MIT]
...
* [Boost.Beast ![GitHub Repo stars](https://img.shields.io/github/stars/boostorg/beast) ![GitHub last commit](https://img.shields.io/github/last-commit/boostorg/beast)](https://github.com/boostorg/beast) :zap: - HTTP and WebSocket built on Boost.Asio in C++11. [BSL-1.0] [website](https://www.boost.org/libs/beast)
...
* [cpp-netlib/uri ![GitHub Repo stars](https://img.shields.io/github/stars/cpp-netlib/uri) ![GitHub last commit](https://img.shields.io/github/last-commit/cpp-netlib/uri)](https://github.com/cpp-netlib/uri) - URI parser/builder library for C++, compatible with RFC 3986 and RFC 3987. [BSL-1.0]
...
* [visit_struct ![GitHub Repo stars](https://img.shields.io/github/stars/cbeck88/visit_struct) ![GitHub last commit](https://img.shields.io/github/last-commit/cbeck88/visit_struct)](https://github.com/cbeck88/visit_struct) - A miniature library for struct-field reflection in C++. [BSL-1.0]
...
* [djinni ![GitHub Repo stars](https://img.shields.io/github/stars/dropbox/djinni) ![GitHub last commit](https://img.shields.io/github/last-commit/dropbox/djinni)](https://github.com/dropbox/djinni) - A tool for generating cross-language type declarations and interface bindings. [Apache2]
...
* [Crow ![GitHub Repo stars](https://img.shields.io/github/stars/ipkn/crow) ![GitHub last commit](https://img.shields.io/github/last-commit/ipkn/crow)](https://github.com/ipkn/crow) - Crow is C++ micro web framework (inspired by Python Flask). [BSD]
...
* [{fmt} ![GitHub Repo stars](https://img.shields.io/github/stars/fmtlib/fmt) ![GitHub last commit](https://img.shields.io/github/last-commit/fmtlib/fmt)](https://github.com/fmtlib/fmt) :zap: - Small, safe and fast formatting library for C++. [Simplified BSD]
...
* [stdman ![GitHub Repo stars](https://img.shields.io/github/stars/jeaye/stdman) ![GitHub last commit](https://img.shields.io/github/last-commit/jeaye/stdman)](https://github.com/jeaye/stdman) Formatted C++11/14 stdlib man pages (from cppreference). [MIT]
...
* [waf ![GitHub Repo stars](https://img.shields.io/github/stars/waf-project/waf) ![GitHub last commit](https://img.shields.io/github/last-commit/waf-project/waf)](https://github.com/waf-project/waf) - Python-based framework for configuring, compiling and installing applications. [BSD] [website](https://waf.io/)
...
* [Free C Books ![GitHub Repo stars](https://img.shields.io/github/stars/EbookFoundation/free-programming-books) ![GitHub last commit](https://img.shields.io/github/last-commit/EbookFoundation/free-programming-books)](https://github.com/EbookFoundation/free-programming-books/blob/master/books/free-programming-books.md#c) - vhf/free-programming-books/C.
* [Free C++ Books ![GitHub Repo stars](https://img.shields.io/github/stars/EbookFoundation/free-programming-books) ![GitHub last commit](https://img.shields.io/github/last-commit/EbookFoundation/free-programming-books)](https://github.com/EbookFoundation/free-programming-books/blob/master/books/free-programming-books.md#c-1) - vhf/free-programming-books/C++.
...
* [C++ Awesome Pack ![GitHub Repo stars](https://img.shields.io/github/stars/juniandotnet/cpp-awesome-pack) ![GitHub last commit](https://img.shields.io/github/last-commit/juniandotnet/cpp-awesome-pack)](https://github.com/juniandotnet/cpp-awesome-pack) - Contains some awesome c++ codes, packed in one.
