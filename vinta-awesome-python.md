...
* Static Type Annotations Generators
    ...
    * [pyannotate ![GitHub Repo stars](https://img.shields.io/github/stars/dropbox/pyannotate) ![GitHub last commit](https://img.shields.io/github/last-commit/dropbox/pyannotate)](https://github.com/dropbox/pyannotate) - Auto-generate PEP-484 annotations.
...
* [python-currencies ![GitHub Repo stars](https://img.shields.io/github/stars/Alir3z4/python-currencies) ![GitHub last commit](https://img.shields.io/github/last-commit/Alir3z4/python-currencies)](https://github.com/Alir3z4/python-currencies) - Display money format and its filthy currencies.
...
* Others
    * [flanker ![GitHub Repo stars](https://img.shields.io/github/stars/mailgun/flanker) ![GitHub last commit](https://img.shields.io/github/last-commit/mailgun/flanker)](https://github.com/mailgun/flanker) - An email address and Mime parsing library.
...
* [Pyston ![GitHub Repo stars](https://img.shields.io/github/stars/dropbox/pyston) ![GitHub last commit](https://img.shields.io/github/last-commit/dropbox/pyston)](https://github.com/dropbox/pyston) - A Python implementation using JIT techniques.
...
* [PyICU ![GitHub Repo stars](https://img.shields.io/github/stars/ovalhub/pyicu) ![GitHub last commit](https://img.shields.io/github/last-commit/ovalhub/pyicu)](https://github.com/ovalhub/pyicu) - A wrapper of International Components for Unicode C++ library ([ICU](http://site.icu-project.org/)).
...
* [django-schedule ![GitHub Repo stars](https://img.shields.io/github/stars/thauber/django-schedule) ![GitHub last commit](https://img.shields.io/github/last-commit/thauber/django-schedule)](https://github.com/thauber/django-schedule) - A calendaring app for Django.
* [doit](http://pydoit.org/) - A task runner and build tool.
* [gunnery ![GitHub Repo stars](https://img.shields.io/github/stars/gunnery/gunnery) ![GitHub last commit](https://img.shields.io/github/last-commit/gunnery/gunnery)](https://github.com/gunnery/gunnery) - Multipurpose task execution tool for distributed systems with web-based interface.
* [Joblib](https://joblib.readthedocs.io/) - A set of tools to provide lightweight pipelining in Python.
* [Plan ![GitHub Repo stars](https://img.shields.io/github/stars/fengsp/plan) ![GitHub last commit](https://img.shields.io/github/last-commit/fengsp/plan)](https://github.com/fengsp/plan) - Writing crontab file in Python like a charm.
...
* [Spiff ![GitHub Repo stars](https://img.shields.io/github/stars/knipknap/SpiffWorkflow) ![GitHub last commit](https://img.shields.io/github/last-commit/knipknap/SpiffWorkflow)](https://github.com/knipknap/SpiffWorkflow) - A powerful workflow engine implemented in pure Python.
...
* [sentry-python ![GitHub Repo stars](https://img.shields.io/github/stars/getsentry/sentry-python) ![GitHub last commit](https://img.shields.io/github/last-commit/getsentry/sentry-python)](https://github.com/getsentry/sentry-python) - Sentry SDK for Python.
* [structlog](https://www.structlog.org/en/stable/) - Structured logging made easy.

## Machine Learning

*Libraries for Machine Learning. Also see [awesome-machine-learning ![GitHub Repo stars](https://img.shields.io/github/stars/josephmisiti/awesome-machine-learning) ![GitHub last commit](https://img.shields.io/github/last-commit/josephmisiti/awesome-machine-learning)](https://github.com/josephmisiti/awesome-machine-learning#python).*
...
* [blinker ![GitHub Repo stars](https://img.shields.io/github/stars/jek/blinker) ![GitHub last commit](https://img.shields.io/github/last-commit/jek/blinker)](https://github.com/jek/blinker) - A fast Python in-process signal/event dispatching system.
...
- General
    ...
    * [pytext ![GitHub Repo stars](https://img.shields.io/github/stars/facebookresearch/pytext) ![GitHub last commit](https://img.shields.io/github/last-commit/facebookresearch/pytext)](https://github.com/facebookresearch/pytext) - A natural language modeling framework based on PyTorch.
    * [PyTorch-NLP ![GitHub Repo stars](https://img.shields.io/github/stars/PetrochukM/PyTorch-NLP) ![GitHub last commit](https://img.shields.io/github/last-commit/PetrochukM/PyTorch-NLP)](https://github.com/PetrochukM/PyTorch-NLP) - A toolkit enabling rapid deep learning NLP prototyping for research.
...
- Chinese
    ...
    * [pkuseg-python ![GitHub Repo stars](https://img.shields.io/github/stars/lancopku/pkuseg-python) ![GitHub last commit](https://img.shields.io/github/last-commit/lancopku/pkuseg-python)](https://github.com/lancopku/pkuseg-python) - A toolkit for Chinese word segmentation in various domains.
...
* [mininet ![GitHub Repo stars](https://img.shields.io/github/stars/mininet/mininet) ![GitHub last commit](https://img.shields.io/github/last-commit/mininet/mininet)](https://github.com/mininet/mininet) - A popular network emulator and API written in Python.
...
* [pox ![GitHub Repo stars](https://img.shields.io/github/stars/noxrepo/pox) ![GitHub last commit](https://img.shields.io/github/last-commit/noxrepo/pox)](https://github.com/noxrepo/pox) - A Python-based SDN control applications, such as OpenFlow SDN controllers.

## News Feed

*Libraries for building user's activities.*

* [django-activity-stream ![GitHub Repo stars](https://img.shields.io/github/stars/justquick/django-activity-stream) ![GitHub last commit](https://img.shields.io/github/last-commit/justquick/django-activity-stream)](https://github.com/justquick/django-activity-stream) - Generating generic activity streams from the actions on your site.
* [Stream Framework ![GitHub Repo stars](https://img.shields.io/github/stars/tschellenbach/Stream-Framework) ![GitHub last commit](https://img.shields.io/github/last-commit/tschellenbach/Stream-Framework)](https://github.com/tschellenbach/Stream-Framework) - Building news feed and notification systems using Cassandra and Redis.
...
* Relational Databases
    ...
    * [pydal ![GitHub Repo stars](https://img.shields.io/github/stars/web2py/pydal) ![GitHub last commit](https://img.shields.io/github/last-commit/web2py/pydal)](https://github.com/web2py/pydal/) - A pure Python Database Abstraction Layer.
* NoSQL Databases
    * [hot-redis ![GitHub Repo stars](https://img.shields.io/github/stars/stephenmcd/hot-redis) ![GitHub last commit](https://img.shields.io/github/last-commit/stephenmcd/hot-redis)](https://github.com/stephenmcd/hot-redis) - Rich Python data types for Redis.
    ...
    * [redisco ![GitHub Repo stars](https://img.shields.io/github/stars/kiddouk/redisco) ![GitHub last commit](https://img.shields.io/github/last-commit/kiddouk/redisco)](https://github.com/kiddouk/redisco) - A Python Library for Simple Models and Containers Persisted in Redis.
...
* [localshop ![GitHub Repo stars](https://img.shields.io/github/stars/jazzband/localshop) ![GitHub last commit](https://img.shields.io/github/last-commit/jazzband/localshop)](https://github.com/jazzband/localshop) - Local PyPI server (custom packages and auto-mirroring of pypi).
* [warehouse ![GitHub Repo stars](https://img.shields.io/github/stars/pypa/warehouse) ![GitHub last commit](https://img.shields.io/github/last-commit/pypa/warehouse)](https://github.com/pypa/warehouse) - Next generation Python Package Repository (PyPI).
...
* [delegator.py ![GitHub Repo stars](https://img.shields.io/github/stars/amitt001/delegator.py) ![GitHub last commit](https://img.shields.io/github/last-commit/amitt001/delegator.py)](https://github.com/amitt001/delegator.py) - [Subprocesses](https://docs.python.org/3/library/subprocess.html) for Humans 2.0.
...
* [fastFM ![GitHub Repo stars](https://img.shields.io/github/stars/ibayer/fastFM) ![GitHub last commit](https://img.shields.io/github/last-commit/ibayer/fastFM)](https://github.com/ibayer/fastFM) - A library for Factorization Machines.
...
* [libffm ![GitHub Repo stars](https://img.shields.io/github/stars/guestwalk/libffm) ![GitHub last commit](https://img.shields.io/github/last-commit/guestwalk/libffm)](https://github.com/guestwalk/libffm) - A library for Field-aware Factorization Machine (FFM).
* [lightfm ![GitHub Repo stars](https://img.shields.io/github/stars/lyst/lightfm) ![GitHub last commit](https://img.shields.io/github/last-commit/lyst/lightfm)](https://github.com/lyst/lightfm) - A Python implementation of a number of popular recommendation algorithms.
* [spotlight ![GitHub Repo stars](https://img.shields.io/github/stars/maciejkula/spotlight) ![GitHub last commit](https://img.shields.io/github/last-commit/maciejkula/spotlight)](https://github.com/maciejkula/spotlight) - Deep recommender models using PyTorch.
* [Surprise ![GitHub Repo stars](https://img.shields.io/github/stars/NicolasHug/Surprise) ![GitHub last commit](https://img.shields.io/github/last-commit/NicolasHug/Surprise)](https://github.com/NicolasHug/Surprise) - A scikit for building and analyzing recommender systems.
* [tensorrec ![GitHub Repo stars](https://img.shields.io/github/stars/jfkirk/tensorrec) ![GitHub last commit](https://img.shields.io/github/last-commit/jfkirk/tensorrec)](https://github.com/jfkirk/tensorrec) - A Recommendation Engine Framework in TensorFlow.
...
* Flask
    * [eve ![GitHub Repo stars](https://img.shields.io/github/stars/pyeve/eve) ![GitHub last commit](https://img.shields.io/github/last-commit/pyeve/eve)](https://github.com/pyeve/eve) - REST API framework powered by Flask, MongoDB and good intentions.
    * [flask-api ![GitHub Repo stars](https://img.shields.io/github/stars/flask-api/flask-api) ![GitHub last commit](https://img.shields.io/github/last-commit/flask-api/flask-api)](https://github.com/flask-api/flask-api) - Browsable Web APIs for Flask.
    * [flask-restful ![GitHub Repo stars](https://img.shields.io/github/stars/flask-restful/flask-restful) ![GitHub last commit](https://img.shields.io/github/last-commit/flask-restful/flask-restful)](https://github.com/flask-restful/flask-restful) - Quickly building REST APIs for Flask.
* Pyramid
    * [cornice ![GitHub Repo stars](https://img.shields.io/github/stars/Cornices/cornice) ![GitHub last commit](https://img.shields.io/github/last-commit/Cornices/cornice)](https://github.com/Cornices/cornice) - A RESTful framework for Pyramid.
* Framework agnostic
    ...
    * [fastapi ![GitHub Repo stars](https://img.shields.io/github/stars/tiangolo/fastapi) ![GitHub last commit](https://img.shields.io/github/last-commit/tiangolo/fastapi)](https://github.com/tiangolo/fastapi) - A modern, fast, web framework for building APIs with Python 3.6+ based on standard Python type hints.
    * [hug ![GitHub Repo stars](https://img.shields.io/github/stars/hugapi/hug) ![GitHub last commit](https://img.shields.io/github/last-commit/hugapi/hug)](https://github.com/hugapi/hug) - A Python 3 framework for cleanly exposing APIs.
    * [sandman2 ![GitHub Repo stars](https://img.shields.io/github/stars/jeffknupp/sandman2) ![GitHub last commit](https://img.shields.io/github/last-commit/jeffknupp/sandman2)](https://github.com/jeffknupp/sandman2) - Automated REST APIs for existing database-driven systems.
    * [sanic ![GitHub Repo stars](https://img.shields.io/github/stars/huge-success/sanic) ![GitHub last commit](https://img.shields.io/github/last-commit/huge-success/sanic)](https://github.com/huge-success/sanic) - A Python 3.6+ web server and web framework that's written to go fast.
...
* [PythonRobotics ![GitHub Repo stars](https://img.shields.io/github/stars/AtsushiSakai/PythonRobotics) ![GitHub last commit](https://img.shields.io/github/last-commit/AtsushiSakai/PythonRobotics)](https://github.com/AtsushiSakai/PythonRobotics) - This is a compilation of various robotics algorithms with visualizations.
...
* [RPyC ![GitHub Repo stars](https://img.shields.io/github/stars/tomerfiliba/rpyc) ![GitHub last commit](https://img.shields.io/github/last-commit/tomerfiliba/rpyc)](https://github.com/tomerfiliba/rpyc) (Remote Python Call) - A transparent and symmetric RPC library for Python
* [zeroRPC ![GitHub Repo stars](https://img.shields.io/github/stars/0rpc/zerorpc-python) ![GitHub last commit](https://img.shields.io/github/last-commit/0rpc/zerorpc-python)](https://github.com/0rpc/zerorpc-python) - zerorpc is a flexible RPC implementation based on [ZeroMQ](http://zeromq.org/) and [MessagePack](http://msgpack.org/).

## Science

*Libraries for scientific computing. Also see [Python-for-Scientists ![GitHub Repo stars](https://img.shields.io/github/stars/TomNicholas/Python-for-Scientists) ![GitHub last commit](https://img.shields.io/github/last-commit/TomNicholas/Python-for-Scientists)](https://github.com/TomNicholas/Python-for-Scientists).*
...
* [bccb ![GitHub Repo stars](https://img.shields.io/github/stars/chapmanb/bcbb) ![GitHub last commit](https://img.shields.io/github/last-commit/chapmanb/bcbb)](https://github.com/chapmanb/bcbb) - Collection of useful code related to biological analysis.
...
* [elasticsearch-dsl-py ![GitHub Repo stars](https://img.shields.io/github/stars/elastic/elasticsearch-dsl-py) ![GitHub last commit](https://img.shields.io/github/last-commit/elastic/elasticsearch-dsl-py)](https://github.com/elastic/elasticsearch-dsl-py) - The official high-level Python client for Elasticsearch.
* [elasticsearch-py](https://www.elastic.co/guide/en/elasticsearch/client/python-api/current/index.html) - The official low-level Python client for [Elasticsearch](https://www.elastic.co/products/elasticsearch).
* [pysolr ![GitHub Repo stars](https://img.shields.io/github/stars/django-haystack/pysolr) ![GitHub last commit](https://img.shields.io/github/last-commit/django-haystack/pysolr)](https://github.com/django-haystack/pysolr) - A lightweight Python wrapper for [Apache Solr](https://lucene.apache.org/solr/).
...
* [ultrajson ![GitHub Repo stars](https://img.shields.io/github/stars/esnme/ultrajson) ![GitHub last commit](https://img.shields.io/github/last-commit/esnme/ultrajson)](https://github.com/esnme/ultrajson) - A fast JSON decoder and encoder written in C with Python bindings.

## Serverless Frameworks

*Frameworks for developing serverless Python code.*

* [python-lambda ![GitHub Repo stars](https://img.shields.io/github/stars/nficano/python-lambda) ![GitHub last commit](https://img.shields.io/github/last-commit/nficano/python-lambda)](https://github.com/nficano/python-lambda) - A toolkit for developing and deploying Python code in AWS Lambda.
* [Zappa ![GitHub Repo stars](https://img.shields.io/github/stars/Miserlou/Zappa) ![GitHub last commit](https://img.shields.io/github/last-commit/Miserlou/Zappa)](https://github.com/Miserlou/Zappa) - A tool for deploying WSGI applications on AWS Lambda and API Gateway.
...
* Office
    ...
    * [unoconv ![GitHub Repo stars](https://img.shields.io/github/stars/unoconv/unoconv) ![GitHub last commit](https://img.shields.io/github/last-commit/unoconv/unoconv)](https://github.com/unoconv/unoconv) - Convert between any document format supported by LibreOffice/OpenOffice.
    ...
    * [xlwings ![GitHub Repo stars](https://img.shields.io/github/stars/ZoomerAnalytics/xlwings) ![GitHub last commit](https://img.shields.io/github/last-commit/ZoomerAnalytics/xlwings)](https://github.com/ZoomerAnalytics/xlwings) - A BSD-licensed library that makes it easy to call Python from Excel and vice versa.
...
* PDF
    * [PDFMiner ![GitHub Repo stars](https://img.shields.io/github/stars/euske/pdfminer) ![GitHub last commit](https://img.shields.io/github/last-commit/euske/pdfminer)](https://github.com/euske/pdfminer) - A tool for extracting information from PDF documents.
...
* Markdown
    ...
    * [Python-Markdown ![GitHub Repo stars](https://img.shields.io/github/stars/waylan/Python-Markdown) ![GitHub last commit](https://img.shields.io/github/last-commit/waylan/Python-Markdown)](https://github.com/waylan/Python-Markdown) - A Python implementation of John Gruber’s Markdown.
* YAML
    * [PyYAML](http://pyyaml.org/) - YAML implementations for Python.
* CSV
    * [csvkit ![GitHub Repo stars](https://img.shields.io/github/stars/wireservice/csvkit) ![GitHub last commit](https://img.shields.io/github/last-commit/wireservice/csvkit)](https://github.com/wireservice/csvkit) - Utilities for converting to and working with CSV.
* Archive
    * [unp ![GitHub Repo stars](https://img.shields.io/github/stars/mitsuhiko/unp) ![GitHub last commit](https://img.shields.io/github/last-commit/mitsuhiko/unp)](https://github.com/mitsuhiko/unp) - A command line tool that can unpack archives easily.

## Static Site Generator

*Static site generator is a software that takes some text + templates as input and produces HTML files on the output.*

* [lektor ![GitHub Repo stars](https://img.shields.io/github/stars/lektor/lektor) ![GitHub last commit](https://img.shields.io/github/last-commit/lektor/lektor)](https://github.com/lektor/lektor) - An easy to use static CMS and blog engine.
...
* [makesite ![GitHub Repo stars](https://img.shields.io/github/stars/sunainapai/makesite) ![GitHub last commit](https://img.shields.io/github/last-commit/sunainapai/makesite)](https://github.com/sunainapai/makesite) - Simple, lightweight, and magic-free static site/blog generator (< 130 lines).
...
* [django-taggit ![GitHub Repo stars](https://img.shields.io/github/stars/jazzband/django-taggit) ![GitHub last commit](https://img.shields.io/github/last-commit/jazzband/django-taggit)](https://github.com/jazzband/django-taggit) - Simple tagging for Django.
...
* [mrq ![GitHub Repo stars](https://img.shields.io/github/stars/pricingassistant/mrq) ![GitHub last commit](https://img.shields.io/github/last-commit/pricingassistant/mrq)](https://github.com/pricingassistant/mrq) - A distributed worker task queue in Python using Redis & gevent.
...
* [Jinja2 ![GitHub Repo stars](https://img.shields.io/github/stars/pallets/jinja) ![GitHub last commit](https://img.shields.io/github/last-commit/pallets/jinja)](https://github.com/pallets/jinja) - A modern and designer friendly templating language.
...
* Testing Frameworks
    ...
    * [nose2 ![GitHub Repo stars](https://img.shields.io/github/stars/nose-devs/nose2) ![GitHub last commit](https://img.shields.io/github/last-commit/nose-devs/nose2)](https://github.com/nose-devs/nose2) - The successor to `nose`, based on `unittest2.
    * [pytest](https://docs.pytest.org/en/latest/) - A mature full-featured Python testing tool.
    * [Robot Framework ![GitHub Repo stars](https://img.shields.io/github/stars/robotframework/robotframework) ![GitHub last commit](https://img.shields.io/github/last-commit/robotframework/robotframework)](https://github.com/robotframework/robotframework) - A generic test automation framework.
    * [unittest](https://docs.python.org/3/library/unittest.html) - (Python standard library) Unit testing framework.
* Test Runners
    * [green ![GitHub Repo stars](https://img.shields.io/github/stars/CleanCut/green) ![GitHub last commit](https://img.shields.io/github/last-commit/CleanCut/green)](https://github.com/CleanCut/green) - A clean, colorful test runner.
...
* GUI / Web Testing
    ...
    * [Schemathesis ![GitHub Repo stars](https://img.shields.io/github/stars/kiwicom/schemathesis) ![GitHub last commit](https://img.shields.io/github/last-commit/kiwicom/schemathesis)](https://github.com/kiwicom/schemathesis) - A tool for automatic property-based testing of web applications built with Open API / Swagger specifications.
    * [Selenium](https://pypi.org/project/selenium/) - Python bindings for [Selenium](http://www.seleniumhq.org/) WebDriver.
    * [sixpack ![GitHub Repo stars](https://img.shields.io/github/stars/seatgeek/sixpack) ![GitHub last commit](https://img.shields.io/github/last-commit/seatgeek/sixpack)](https://github.com/seatgeek/sixpack) - A language-agnostic A/B Testing framework.
    * [splinter ![GitHub Repo stars](https://img.shields.io/github/stars/cobrateam/splinter) ![GitHub last commit](https://img.shields.io/github/last-commit/cobrateam/splinter)](https://github.com/cobrateam/splinter) - Open source tool for testing web applications.
* Mock
    ...
    * [httmock ![GitHub Repo stars](https://img.shields.io/github/stars/patrys/httmock) ![GitHub last commit](https://img.shields.io/github/last-commit/patrys/httmock)](https://github.com/patrys/httmock) - A mocking library for requests for Python 2.6+ and 3.2+.
    * [httpretty ![GitHub Repo stars](https://img.shields.io/github/stars/gabrielfalcao/HTTPretty) ![GitHub last commit](https://img.shields.io/github/last-commit/gabrielfalcao/HTTPretty)](https://github.com/gabrielfalcao/HTTPretty) - HTTP request mock tool for Python.
    * [mock](https://docs.python.org/3/library/unittest.mock.html) - (Python standard library) A mocking and patching library.
    * [mocket ![GitHub Repo stars](https://img.shields.io/github/stars/mindflayer/python-mocket) ![GitHub last commit](https://img.shields.io/github/last-commit/mindflayer/python-mocket)](https://github.com/mindflayer/python-mocket) - A socket mock framework with gevent/asyncio/SSL support.
    ...
    * [VCR.py ![GitHub Repo stars](https://img.shields.io/github/stars/kevin1024/vcrpy) ![GitHub last commit](https://img.shields.io/github/last-commit/kevin1024/vcrpy)](https://github.com/kevin1024/vcrpy) - Record and replay HTTP interactions on your tests.
* Object Factories
...
* Fake Data
    * [fake2db ![GitHub Repo stars](https://img.shields.io/github/stars/emirozer/fake2db) ![GitHub last commit](https://img.shields.io/github/last-commit/emirozer/fake2db)](https://github.com/emirozer/fake2db) - Fake database generator.
...
* General
    ...
    * [ftfy ![GitHub Repo stars](https://img.shields.io/github/stars/LuminosoInsight/python-ftfy) ![GitHub last commit](https://img.shields.io/github/last-commit/LuminosoInsight/python-ftfy)](https://github.com/LuminosoInsight/python-ftfy) - Makes Unicode text less broken and more consistent automagically.
    * [fuzzywuzzy ![GitHub Repo stars](https://img.shields.io/github/stars/seatgeek/fuzzywuzzy) ![GitHub last commit](https://img.shields.io/github/last-commit/seatgeek/fuzzywuzzy)](https://github.com/seatgeek/fuzzywuzzy) - Fuzzy String Matching.
    * [Levenshtein ![GitHub Repo stars](https://img.shields.io/github/stars/ztane/python-Levenshtein) ![GitHub last commit](https://img.shields.io/github/last-commit/ztane/python-Levenshtein)](https://github.com/ztane/python-Levenshtein/) - Fast computation of Levenshtein distance and string similarity.
    ...
    * [textdistance ![GitHub Repo stars](https://img.shields.io/github/stars/orsinium/textdistance) ![GitHub last commit](https://img.shields.io/github/last-commit/orsinium/textdistance)](https://github.com/orsinium/textdistance) - Compute distance between sequences with 30+ algorithms.
    * [unidecode](https://pypi.org/project/Unidecode/) - ASCII transliterations of Unicode text.
* Slugify
    * [awesome-slugify ![GitHub Repo stars](https://img.shields.io/github/stars/dimka665/awesome-slugify) ![GitHub last commit](https://img.shields.io/github/last-commit/dimka665/awesome-slugify)](https://github.com/dimka665/awesome-slugify) - A Python slugify library that can preserve unicode.
    ...
    * [unicode-slugify ![GitHub Repo stars](https://img.shields.io/github/stars/mozilla/unicode-slugify) ![GitHub last commit](https://img.shields.io/github/last-commit/mozilla/unicode-slugify)](https://github.com/mozilla/unicode-slugify) - A slugifier that generates unicode slugs with Django as a dependency.
* Unique identifiers
...
* Parser
    * [ply ![GitHub Repo stars](https://img.shields.io/github/stars/dabeaz/ply) ![GitHub last commit](https://img.shields.io/github/last-commit/dabeaz/ply)](https://github.com/dabeaz/ply) - Implementation of lex and yacc parsing tools for Python.
    ...
    * [python-nameparser ![GitHub Repo stars](https://img.shields.io/github/stars/derek73/python-nameparser) ![GitHub last commit](https://img.shields.io/github/last-commit/derek73/python-nameparser)](https://github.com/derek73/python-nameparser) - Parsing human names into their individual components.
...
*Libraries for accessing third party services APIs. Also see [List of Python API Wrappers and Libraries ![GitHub Repo stars](https://img.shields.io/github/stars/realpython/list-of-python-api-wrappers) ![GitHub last commit](https://img.shields.io/github/last-commit/realpython/list-of-python-api-wrappers)](https://github.com/realpython/list-of-python-api-wrappers).*
...
* [django-wordpress ![GitHub Repo stars](https://img.shields.io/github/stars/istrategylabs/django-wordpress) ![GitHub last commit](https://img.shields.io/github/last-commit/istrategylabs/django-wordpress)](https://github.com/istrategylabs/django-wordpress) - WordPress models and views for Django.
* [facebook-sdk ![GitHub Repo stars](https://img.shields.io/github/stars/mobolic/facebook-sdk) ![GitHub last commit](https://img.shields.io/github/last-commit/mobolic/facebook-sdk)](https://github.com/mobolic/facebook-sdk) - Facebook Platform Python SDK.
* [google-api-python-client ![GitHub Repo stars](https://img.shields.io/github/stars/google/google-api-python-client) ![GitHub last commit](https://img.shields.io/github/last-commit/google/google-api-python-client)](https://github.com/google/google-api-python-client) - Google APIs Client Library for Python.
* [gspread ![GitHub Repo stars](https://img.shields.io/github/stars/burnash/gspread) ![GitHub last commit](https://img.shields.io/github/last-commit/burnash/gspread)](https://github.com/burnash/gspread) - Google Spreadsheets Python API.
* [twython ![GitHub Repo stars](https://img.shields.io/github/stars/ryanmcgrath/twython) ![GitHub last commit](https://img.shields.io/github/last-commit/ryanmcgrath/twython)](https://github.com/ryanmcgrath/twython) - A Python wrapper for the Twitter API.

## URL Manipulation

*Libraries for parsing URLs.*

* [furl ![GitHub Repo stars](https://img.shields.io/github/stars/gruns/furl) ![GitHub last commit](https://img.shields.io/github/last-commit/gruns/furl)](https://github.com/gruns/furl) - A small Python library that makes parsing and manipulating URLs easy.
* [purl ![GitHub Repo stars](https://img.shields.io/github/stars/codeinthehole/purl) ![GitHub last commit](https://img.shields.io/github/last-commit/codeinthehole/purl)](https://github.com/codeinthehole/purl) - A simple, immutable URL class with a clean API for interrogation and manipulation.
* [pyshorteners ![GitHub Repo stars](https://img.shields.io/github/stars/ellisonleao/pyshorteners) ![GitHub last commit](https://img.shields.io/github/last-commit/ellisonleao/pyshorteners)](https://github.com/ellisonleao/pyshorteners) - A pure Python URL shortening lib.
...
* [scikit-video ![GitHub Repo stars](https://img.shields.io/github/stars/aizvorski/scikit-video) ![GitHub last commit](https://img.shields.io/github/last-commit/aizvorski/scikit-video)](https://github.com/aizvorski/scikit-video) - Video processing routines for SciPy.
...
* [django-pipeline ![GitHub Repo stars](https://img.shields.io/github/stars/jazzband/django-pipeline) ![GitHub last commit](https://img.shields.io/github/last-commit/jazzband/django-pipeline)](https://github.com/jazzband/django-pipeline) - An asset packaging library for Django.
...
* [flask-assets ![GitHub Repo stars](https://img.shields.io/github/stars/miracle2k/flask-assets) ![GitHub last commit](https://img.shields.io/github/last-commit/miracle2k/flask-assets)](https://github.com/miracle2k/flask-assets) - Helps you integrate webassets into your Flask app.
* [webassets ![GitHub Repo stars](https://img.shields.io/github/stars/miracle2k/webassets) ![GitHub last commit](https://img.shields.io/github/last-commit/miracle2k/webassets)](https://github.com/miracle2k/webassets) - Bundles, optimizes, and manages unique cache-busting URLs for static resources.
...
* [lassie ![GitHub Repo stars](https://img.shields.io/github/stars/michaelhelmick/lassie) ![GitHub last commit](https://img.shields.io/github/last-commit/michaelhelmick/lassie)](https://github.com/michaelhelmick/lassie) - Web Content Retrieval for Humans.
* [micawber ![GitHub Repo stars](https://img.shields.io/github/stars/coleifer/micawber) ![GitHub last commit](https://img.shields.io/github/last-commit/coleifer/micawber)](https://github.com/coleifer/micawber) - A small library for extracting rich content from URLs.
* [newspaper ![GitHub Repo stars](https://img.shields.io/github/stars/codelucas/newspaper) ![GitHub last commit](https://img.shields.io/github/last-commit/codelucas/newspaper)](https://github.com/codelucas/newspaper) - News extraction, article extraction and content curation in Python.
* [python-readability ![GitHub Repo stars](https://img.shields.io/github/stars/buriy/python-readability) ![GitHub last commit](https://img.shields.io/github/last-commit/buriy/python-readability)](https://github.com/buriy/python-readability) - Fast Python port of arc90's readability tool.
* [requests-html ![GitHub Repo stars](https://img.shields.io/github/stars/psf/requests-html) ![GitHub last commit](https://img.shields.io/github/last-commit/psf/requests-html)](https://github.com/psf/requests-html) - Pythonic HTML Parsing for Humans.
* [sumy ![GitHub Repo stars](https://img.shields.io/github/stars/miso-belica/sumy) ![GitHub last commit](https://img.shields.io/github/last-commit/miso-belica/sumy)](https://github.com/miso-belica/sumy) - A module for automatic summarization of text documents and HTML pages.
* [textract ![GitHub Repo stars](https://img.shields.io/github/stars/deanmalmgren/textract) ![GitHub last commit](https://img.shields.io/github/last-commit/deanmalmgren/textract)](https://github.com/deanmalmgren/textract) - Extract text from any document, Word, PowerPoint, PDFs, etc.
* [toapi ![GitHub Repo stars](https://img.shields.io/github/stars/gaojiuli/toapi) ![GitHub last commit](https://img.shields.io/github/last-commit/gaojiuli/toapi)](https://github.com/gaojiuli/toapi) - Every web site provides APIs.

## Web Crawling

*Libraries to automate web scraping.*

* [cola ![GitHub Repo stars](https://img.shields.io/github/stars/chineking/cola) ![GitHub last commit](https://img.shields.io/github/last-commit/chineking/cola)](https://github.com/chineking/cola) - A distributed crawling framework.
...
* [portia ![GitHub Repo stars](https://img.shields.io/github/stars/scrapinghub/portia) ![GitHub last commit](https://img.shields.io/github/last-commit/scrapinghub/portia)](https://github.com/scrapinghub/portia) - Visual scraping for Scrapy.
* [pyspider ![GitHub Repo stars](https://img.shields.io/github/stars/binux/pyspider) ![GitHub last commit](https://img.shields.io/github/last-commit/binux/pyspider)](https://github.com/binux/pyspider) - A powerful spider system.
* [robobrowser ![GitHub Repo stars](https://img.shields.io/github/stars/jmcarp/robobrowser) ![GitHub last commit](https://img.shields.io/github/last-commit/jmcarp/robobrowser)](https://github.com/jmcarp/robobrowser) - A simple, Pythonic library for browsing the web without a standalone web browser.
* [scrapy](https://scrapy.org/) - A fast high-level screen scraping and web crawling framework.

## Web Frameworks

*Traditional full stack web frameworks. Also see [RESTful API ![GitHub Repo stars](https://img.shields.io/github/stars/vinta/awesome-python) ![GitHub last commit](https://img.shields.io/github/last-commit/vinta/awesome-python)](https://github.com/vinta/awesome-python#restful-api).*
...
* [websockets ![GitHub Repo stars](https://img.shields.io/github/stars/aaugustin/websockets) ![GitHub last commit](https://img.shields.io/github/last-commit/aaugustin/websockets)](https://github.com/aaugustin/websockets) - A library for building WebSocket servers and clients with a focus on correctness and simplicity.

## WSGI Servers

*WSGI-compatible web servers.*

* [bjoern ![GitHub Repo stars](https://img.shields.io/github/stars/jonashaag/bjoern) ![GitHub last commit](https://img.shields.io/github/last-commit/jonashaag/bjoern)](https://github.com/jonashaag/bjoern) - Asynchronous, very fast and written in C.
...
* [werkzeug ![GitHub Repo stars](https://img.shields.io/github/stars/pallets/werkzeug) ![GitHub last commit](https://img.shields.io/github/last-commit/pallets/werkzeug)](https://github.com/pallets/werkzeug) - A WSGI utility library for Python that powers Flask and can easily be embedded into your own projects.
...
* Tutorials
    ...
    * [Ultimate Python study guide ![GitHub Repo stars](https://img.shields.io/github/stars/huangsam/ultimate-python) ![GitHub last commit](https://img.shields.io/github/last-commit/huangsam/ultimate-python)](https://github.com/huangsam/ultimate-python)
* Libraries
    * [Awesome Python @LibHunt](https://python.libhunt.com/)
* Others
    * [Python ZEEF](https://python.zeef.com/alan.richmond)
    * [Pythonic News](https://news.python.sc/)
    * [What the f*ck Python! ![GitHub Repo stars](https://img.shields.io/github/stars/satwikkansal/wtfpython) ![GitHub last commit](https://img.shields.io/github/last-commit/satwikkansal/wtfpython)](https://github.com/satwikkansal/wtfpython)
