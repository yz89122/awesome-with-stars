...
* [(2014) Ray tracing with OpenGL Compute Shaders ![GitHub Repo stars](https://img.shields.io/github/stars/LWJGL/lwjgl3-wiki) ![GitHub last commit](https://img.shields.io/github/last-commit/LWJGL/lwjgl3-wiki)](https://github.com/LWJGL/lwjgl3-wiki/wiki/2.6.1.-Ray-tracing-with-OpenGL-Compute-Shaders-%28Part-I%29) by **Kai Burjack** - Detailed tutorial series about ray tracing using OpenGL (LWJGL).
...
* [CodeXL ![GitHub Repo stars](https://img.shields.io/github/stars/GPUOpen-Tools/CodeXL) ![GitHub last commit](https://img.shields.io/github/last-commit/GPUOpen-Tools/CodeXL)](https://github.com/GPUOpen-Tools/CodeXL) - AMD's tool suite that includes debugger, profiler and frame/shader analysis.
* [GL-SL Debugger](http://glsl-debugger.github.io) - Tool for debugging OpenGL programs.
* [GLIntercept ![GitHub Repo stars](https://img.shields.io/github/stars/dtrebilco/glintercept) ![GitHub last commit](https://img.shields.io/github/last-commit/dtrebilco/glintercept)](https://github.com/dtrebilco/glintercept) - OpenGL function call interceptor for Windows.
...
* [RenderDoc ![GitHub Repo stars](https://img.shields.io/github/stars/baldurk/renderdoc) ![GitHub last commit](https://img.shields.io/github/last-commit/baldurk/renderdoc)](https://github.com/baldurk/renderdoc) - RenderDoc is a stand-alone graphics debugging tool.
* [tracy ![GitHub Repo stars](https://img.shields.io/github/stars/wolfpld/tracy) ![GitHub last commit](https://img.shields.io/github/last-commit/wolfpld/tracy)](https://github.com/wolfpld/tracy) - A real time remote telemetry frame profiler for games and other applications.
* [vogl ![GitHub Repo stars](https://img.shields.io/github/stars/ValveSoftware/vogl) ![GitHub last commit](https://img.shields.io/github/last-commit/ValveSoftware/vogl)](https://github.com/ValveSoftware/vogl) - OpenGL capture and playback debugger developed by Valve.
...
* [GLSLbin](http://glslb.in) - Fragment shader sandbox supporting [glslify ![GitHub Repo stars](https://img.shields.io/github/stars/stackgl/glslify) ![GitHub last commit](https://img.shields.io/github/last-commit/stackgl/glslify)](https://github.com/stackgl/glslify).
...
* [assimp ![GitHub Repo stars](https://img.shields.io/github/stars/assimp/assimp) ![GitHub last commit](https://img.shields.io/github/last-commit/assimp/assimp)](https://github.com/assimp/assimp) - Portable library to import 3D models in a uniform manner.
...
* [GLFM ![GitHub Repo stars](https://img.shields.io/github/stars/brackeen/glfm) ![GitHub last commit](https://img.shields.io/github/last-commit/brackeen/glfm)](https://github.com/brackeen/glfm) - Supplies an OpenGL ES context and input events for mobile devices and the web.
* [glm](http://glm.g-truc.net/0.9.6/index.html) - Mathematics library for graphics software based on the GLSL specifications.
* [Magnum ![GitHub Repo stars](https://img.shields.io/github/stars/mosra/magnum) ![GitHub last commit](https://img.shields.io/github/last-commit/mosra/magnum)](https://github.com/mosra/magnum) - It is a 2D/3D graphics engine for modern OpenGL.
...
* [Pangolin ![GitHub Repo stars](https://img.shields.io/github/stars/stevenlovegrove/Pangolin) ![GitHub last commit](https://img.shields.io/github/last-commit/stevenlovegrove/Pangolin)](https://github.com/stevenlovegrove/Pangolin) - Lightweight portable rapid development library for managing OpenGL display / interaction and abstracting video input.
...
* [gl3w ![GitHub Repo stars](https://img.shields.io/github/stars/skaslev/gl3w) ![GitHub last commit](https://img.shields.io/github/last-commit/skaslev/gl3w)](https://github.com/skaslev/gl3w) - Simple OpenGL core profile loader.
* [glad ![GitHub Repo stars](https://img.shields.io/github/stars/Dav1dde/glad) ![GitHub last commit](https://img.shields.io/github/last-commit/Dav1dde/glad)](https://github.com/Dav1dde/glad) - Multi profile loader-generator based on the official specs.
* [glbindify ![GitHub Repo stars](https://img.shields.io/github/stars/nnesse/glbindify) ![GitHub last commit](https://img.shields.io/github/last-commit/nnesse/glbindify)](https://github.com/nnesse/glbindify) - Command line tool to generate C bindings for OpenGL, wgl, and glX.
* [glbinding ![GitHub Repo stars](https://img.shields.io/github/stars/cginternals/glbinding) ![GitHub last commit](https://img.shields.io/github/last-commit/cginternals/glbinding)](https://github.com/cginternals/glbinding) - Profile loader leveraging C++11 features to provide type safety.
...
* [3D Game Shaders For Beginners ![GitHub Repo stars](https://img.shields.io/github/stars/lettier/3d-game-shaders-for-beginners) ![GitHub last commit](https://img.shields.io/github/last-commit/lettier/3d-game-shaders-for-beginners)](https://github.com/lettier/3d-game-shaders-for-beginners) by **David Lettier**
...
* [OpenGL Examples ![GitHub Repo stars](https://img.shields.io/github/stars/McNopper/OpenGL) ![GitHub last commit](https://img.shields.io/github/last-commit/McNopper/OpenGL)](https://github.com/McNopper/OpenGL) by **Norbert Nopper**
...
* [awesome ![GitHub Repo stars](https://img.shields.io/github/stars/sindresorhus/awesome) ![GitHub last commit](https://img.shields.io/github/last-commit/sindresorhus/awesome)](https://github.com/sindresorhus/awesome) - A curated list of awesome lists.
* [awesome-computer-vision ![GitHub Repo stars](https://img.shields.io/github/stars/jbhuang0604/awesome-computer-vision) ![GitHub last commit](https://img.shields.io/github/last-commit/jbhuang0604/awesome-computer-vision)](https://github.com/jbhuang0604/awesome-computer-vision) - A curated list of awesome computer vision resources.
* [awesome-webgl ![GitHub Repo stars](https://img.shields.io/github/stars/sjfricke/awesome-webgl) ![GitHub last commit](https://img.shields.io/github/last-commit/sjfricke/awesome-webgl)](https://github.com/sjfricke/awesome-webgl) - A curated list of awesome WebGL libraries, resources and much more.
* [awesome-vulkan ![GitHub Repo stars](https://img.shields.io/github/stars/vinjn/awesome-vulkan) ![GitHub last commit](https://img.shields.io/github/last-commit/vinjn/awesome-vulkan)](https://github.com/vinjn/awesome-vulkan) - A curated list of awesome Vulkan projects and ecosystem.
* [gamedev ![GitHub Repo stars](https://img.shields.io/github/stars/ellisonleao/magictools) ![GitHub last commit](https://img.shields.io/github/last-commit/ellisonleao/magictools)](https://github.com/ellisonleao/magictools) - A awesome list about game development.
* [graphics-resources ![GitHub Repo stars](https://img.shields.io/github/stars/mattdesl/graphics-resources) ![GitHub last commit](https://img.shields.io/github/last-commit/mattdesl/graphics-resources)](https://github.com/mattdesl/graphics-resources) - A list of graphic programming resources.
...
## Contributing
Please see [CONTRIBUTING ![GitHub Repo stars](https://img.shields.io/github/stars/eug/awesome-opengl) ![GitHub last commit](https://img.shields.io/github/last-commit/eug/awesome-opengl)](https://github.com/eug/awesome-opengl/blob/master/CONTRIBUTING.md) for details.
