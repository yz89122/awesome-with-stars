...
This knowledge base cover the first columnar perimeter on the right of the cloud stack. It is one of the transversal pillar of the ecosystem, where customers, products and business meets. The [other pillar being Identity and Access Management (IAM) 👤 ![GitHub Repo stars](https://img.shields.io/github/stars/kdeldycke/awesome-iam) ![GitHub last commit](https://img.shields.io/github/last-commit/kdeldycke/awesome-iam)](https://github.com/kdeldycke/awesome-iam/).

<!--lint enable double-link-->

Here we set out the big picture: definition and strategic importance of the domain, plus some critical features.

- [Open guide to AWS Billing and Cost Management ![GitHub Repo stars](https://img.shields.io/github/stars/open-guides/og-aws) ![GitHub last commit](https://img.shields.io/github/last-commit/open-guides/og-aws)](https://github.com/open-guides/og-aws#billing-and-cost-management)
...
- [`f-license` ![GitHub Repo stars](https://img.shields.io/github/stars/furkansenharputlu/f-license) ![GitHub last commit](https://img.shields.io/github/last-commit/furkansenharputlu/f-license)](https://github.com/furkansenharputlu/f-license) - Open-source license key generation and verification tool in Go.
...
- [Akeneo PIM ![GitHub Repo stars](https://img.shields.io/github/stars/akeneo/pim-community-dev) ![GitHub last commit](https://img.shields.io/github/last-commit/akeneo/pim-community-dev)](https://github.com/akeneo/pim-community-dev) - The open-source variant of the commercial Akeneo products.

- [Pimcore ![GitHub Repo stars](https://img.shields.io/github/stars/pimcore/pimcore) ![GitHub last commit](https://img.shields.io/github/last-commit/pimcore/pimcore)](https://github.com/pimcore/pimcore)
...
- [Forecasting with sktime ![GitHub Repo stars](https://img.shields.io/github/stars/alan-turing-institute/sktime) ![GitHub last commit](https://img.shields.io/github/last-commit/alan-turing-institute/sktime)](https://github.com/alan-turing-institute/sktime/blob/master/examples/01_forecasting.ipynb) - A tutorial on how to use past data to make temporal forward predictions. And read the [difference between sktime and the Prophet project](https://news.ycombinator.com/item?id=24543861) mentionned above.

- [Komiser ![GitHub Repo stars](https://img.shields.io/github/stars/mlabouardy/komiser) ![GitHub last commit](https://img.shields.io/github/last-commit/mlabouardy/komiser)](https://github.com/mlabouardy/komiser) - Open-source tool to stay under budget by uncovering hidden costs, monitoring increases in spend, and making impactful changes based on custom recommendations.
...
- [AutoSpotting ![GitHub Repo stars](https://img.shields.io/github/stars/AutoSpotting/AutoSpotting) ![GitHub last commit](https://img.shields.io/github/last-commit/AutoSpotting/AutoSpotting)](https://github.com/AutoSpotting/AutoSpotting) - Tool that easily and reliably converts (all) your existing AutoScaling groups to cheaper spot instances.
...
- [RTB Budget Pacing Summarized ![GitHub Repo stars](https://img.shields.io/github/stars/PragmaticLab/RTB_Budget_Pacing_Summarized) ![GitHub last commit](https://img.shields.io/github/last-commit/PragmaticLab/RTB_Budget_Pacing_Summarized)](https://github.com/PragmaticLab/RTB_Budget_Pacing_Summarized) - A collection of budget pacing resources for targeted online advertisements.

- [Samsung's online ads platform/exchange war story ![GitHub Repo stars](https://img.shields.io/github/stars/eloraiby/fs-pacer) ![GitHub last commit](https://img.shields.io/github/last-commit/eloraiby/fs-pacer)](https://github.com/eloraiby/fs-pacer/blob/master/fs-pacer.md) - How to scale to 5M bid request/s, 2ms Max Response Time.
...
- [Frappe Books ![GitHub Repo stars](https://img.shields.io/github/stars/frappe/books) ![GitHub last commit](https://img.shields.io/github/last-commit/frappe/books)](https://github.com/frappe/books) - Free Desktop book-keeping software for small-businesses and freelancers.

- [Luca ![GitHub Repo stars](https://img.shields.io/github/stars/brandon-rhodes/luca) ![GitHub last commit](https://img.shields.io/github/last-commit/brandon-rhodes/luca)](https://github.com/brandon-rhodes/luca) - YAML accounting and JSON tax forms.

- [Sequence ![GitHub Repo stars](https://img.shields.io/github/stars/decimals/sequence) ![GitHub last commit](https://img.shields.io/github/last-commit/decimals/sequence)](https://github.com/decimals/sequence) - API that store, validate and reports asset movements. Also known as a Ledger. Sequence is immutable, scalable, and easy to use.
...
- [{Digital,Cloud,Electronic,Online} Services VAT Rate Database ![GitHub Repo stars](https://img.shields.io/github/stars/kdeldycke/vat-rates) ![GitHub last commit](https://img.shields.io/github/last-commit/kdeldycke/vat-rates)](https://github.com/kdeldycke/vat-rates) - Centralize applicable VAT rates on foreign online services, for each country of residence (including territorial exceptions).
...
- [Factur-X ![GitHub Repo stars](https://img.shields.io/github/stars/akretion/factur-x) ![GitHub last commit](https://img.shields.io/github/last-commit/akretion/factur-x)](https://github.com/akretion/factur-x) - Python library to support the e-invoicing standard for France and Germany.
...
- [pci-blackbox ![GitHub Repo stars](https://img.shields.io/github/stars/trustly/pci-blackbox) ![GitHub last commit](https://img.shields.io/github/last-commit/trustly/pci-blackbox)](https://github.com/trustly/pci-blackbox) - PCI-DSS compliant card system built on PostgreSQL and PL/pgSQL.
...
- [Swift Codes Repository ![GitHub Repo stars](https://img.shields.io/github/stars/PeterNotenboom/SwiftCodes) ![GitHub last commit](https://img.shields.io/github/last-commit/PeterNotenboom/SwiftCodes)](https://github.com/PeterNotenboom/SwiftCodes) - A repository that seems to scrape the website above.
...
- [Awesome List of IAM: Fraud links ![GitHub Repo stars](https://img.shields.io/github/stars/kdeldycke/awesome-iam) ![GitHub last commit](https://img.shields.io/github/last-commit/kdeldycke/awesome-iam)](https://github.com/kdeldycke/awesome-iam#fraud) - Section dedicated to fraud management related to user accounts, from our sister repository.
...
- [Awesome Credit Modeling ![GitHub Repo stars](https://img.shields.io/github/stars/mourarthur/awesome-credit-modeling) ![GitHub last commit](https://img.shields.io/github/last-commit/mourarthur/awesome-credit-modeling)](https://github.com/mourarthur/awesome-credit-modeling#readme) - How to use statistical methods to classify applicants into categories to reduce risks. Lots of inspiration and reasearch papers there to improve general scoring.
...
- [`redash` ![GitHub Repo stars](https://img.shields.io/github/stars/getredash/redash) ![GitHub last commit](https://img.shields.io/github/last-commit/getredash/redash)](https://github.com/getredash/redash) - Connect and query your data sources, build dashboards to visualize data and share them with your company.

- [Metabase ![GitHub Repo stars](https://img.shields.io/github/stars/metabase/metabase) ![GitHub last commit](https://img.shields.io/github/last-commit/metabase/metabase)](https://github.com/metabase/metabase) - Metabase is an open source solution to explore and visualize data and supports lots of databases.
...
- [EC2 Spot Price Tracker ![GitHub Repo stars](https://img.shields.io/github/stars/grosskur/ec2price) ![GitHub last commit](https://img.shields.io/github/last-commit/grosskur/ec2price)](https://github.com/grosskur/ec2price) - Web app that collects and graphs EC2 Spot Prices.
...
The [header image ![GitHub Repo stars](https://img.shields.io/github/stars/kdeldycke/awesome-billing) ![GitHub last commit](https://img.shields.io/github/last-commit/kdeldycke/awesome-billing)](https://github.com/kdeldycke/awesome-billing/blob/main/assets/awesome-billing-header.jpg) is based on a modified [photo](https://unsplash.com/photos/u2zSzMTwIjQ) by [Denny Müller](https://unsplash.com/@redaquamedia).
