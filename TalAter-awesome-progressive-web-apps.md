...
- [Awesome Service Workers ![GitHub Repo stars](https://img.shields.io/github/stars/TalAter/awesome-service-workers) ![GitHub last commit](https://img.shields.io/github/last-commit/TalAter/awesome-service-workers)](https://github.com/TalAter/awesome-service-workers) - A collection of awesome resources for learning service workers.
...
- [Awesome Service Workers ![GitHub Repo stars](https://img.shields.io/github/stars/TalAter/awesome-service-workers) ![GitHub last commit](https://img.shields.io/github/last-commit/TalAter/awesome-service-workers)](https://github.com/TalAter/awesome-service-workers/) - A curated collection of the finest service worker resources.
...
- [Background Sync Explained ![GitHub Repo stars](https://img.shields.io/github/stars/WICG/BackgroundSync) ![GitHub last commit](https://img.shields.io/github/last-commit/WICG/BackgroundSync)](https://github.com/WICG/BackgroundSync/blob/master/explainer.md) - The official "explainer" document for background sync, including one-off synchronization and periodic synchronization.
...
- [Web Share API explainer ![GitHub Repo stars](https://img.shields.io/github/stars/WICG/web-share) ![GitHub last commit](https://img.shields.io/github/last-commit/WICG/web-share)](https://github.com/WICG/web-share/blob/master/docs/explainer.md) - An explanation of the API, along with some examples. Part of the proposal doc.
- [Web Share Target API ![GitHub Repo stars](https://img.shields.io/github/stars/WICG/web-share-target) ![GitHub last commit](https://img.shields.io/github/last-commit/WICG/web-share-target)](https://github.com/WICG/web-share-target) - The proposal for the Web Share Target API, as well as a high level [explainer ![GitHub Repo stars](https://img.shields.io/github/stars/WICG/web-share-target) ![GitHub last commit](https://img.shields.io/github/last-commit/WICG/web-share-target)](https://github.com/WICG/web-share-target/blob/master/docs/explainer.md).
