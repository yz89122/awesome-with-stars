...
* [Repo for Arduino ![GitHub Repo stars](https://img.shields.io/github/stars/awslabs/aws-sdk-arduino) ![GitHub last commit](https://img.shields.io/github/last-commit/awslabs/aws-sdk-arduino)](https://github.com/awslabs/aws-sdk-arduino)
...
* [Repo :fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/brendanhay/amazonka) ![GitHub last commit](https://img.shields.io/github/last-commit/brendanhay/amazonka)](https://github.com/brendanhay/amazonka)
...
* [aws-sdk-rails :fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/aws/aws-sdk-rails) ![GitHub last commit](https://img.shields.io/github/last-commit/aws/aws-sdk-rails)](https://github.com/aws/aws-sdk-rails)
...
* [Repo :fire::fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/rusoto/rusoto) ![GitHub last commit](https://img.shields.io/github/last-commit/rusoto/rusoto)](https://github.com/rusoto/rusoto)
...
* [cfn-python-lint :fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/awslabs/cfn-python-lint) ![GitHub last commit](https://img.shields.io/github/last-commit/awslabs/cfn-python-lint)](https://github.com/awslabs/cfn-python-lint) - A tool for linting/validating CloudFormation.
...
* [cloudtools/troposphere :fire::fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/cloudtools/troposphere) ![GitHub last commit](https://img.shields.io/github/last-commit/cloudtools/troposphere)](https://github.com/cloudtools/troposphere) - Python library to create descriptions.
...
* [Stelligent/cfn_nag :fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/stelligent/cfn_nag) ![GitHub last commit](https://img.shields.io/github/last-commit/stelligent/cfn_nag)](https://github.com/stelligent/cfn_nag) - Linting tool for CloudFormation templates
...
* [logstash-input-dynamodb :fire: ![GitHub Repo stars](https://img.shields.io/github/stars/awslabs/logstash-input-dynamodb) ![GitHub last commit](https://img.shields.io/github/last-commit/awslabs/logstash-input-dynamodb)](https://github.com/awslabs/logstash-input-dynamodb) - Logstash input plugin.
...
* [eb-python-flask ![GitHub Repo stars](https://img.shields.io/github/stars/awslabs/eb-python-flask) ![GitHub last commit](https://img.shields.io/github/last-commit/awslabs/eb-python-flask)](https://github.com/awslabs/eb-python-flask) - Simple Python and Flask app.
...
* [Lumoslabs/broadside ![GitHub Repo stars](https://img.shields.io/github/stars/lumoslabs/broadside) ![GitHub last commit](https://img.shields.io/github/last-commit/lumoslabs/broadside)](https://github.com/lumoslabs/broadside) - Command line tool for deploying revisions of containerized applications.
...
* [elastic/elasticsearch-cloud-aws :fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/elastic/elasticsearch-cloud-aws) ![GitHub last commit](https://img.shields.io/github/last-commit/elastic/elasticsearch-cloud-aws)](https://github.com/elastic/elasticsearch-cloud-aws) - Plugin for Elasticsearch.
...
* [amazon-kinesis-client :fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/awslabs/amazon-kinesis-client) ![GitHub last commit](https://img.shields.io/github/last-commit/awslabs/amazon-kinesis-client)](https://github.com/awslabs/amazon-kinesis-client) Client library for Amazon Kinesis.
...
* [alestic/lambdash :fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/alestic/lambdash) ![GitHub last commit](https://img.shields.io/github/last-commit/alestic/lambdash)](https://github.com/alestic/lambdash) - Lambda shell - Run sh commands inside the Lambda environment.
...
* [jeremydaly/lambda-api :fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/jeremydaly/lambda-api) ![GitHub last commit](https://img.shields.io/github/last-commit/jeremydaly/lambda-api)](https://github.com/jeremydaly/lambda-api) - Lightweight web framework for your serverless applications.
...
* [Miserlou/Zappa :fire::fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/Miserlou/Zappa) ![GitHub last commit](https://img.shields.io/github/last-commit/Miserlou/Zappa)](https://github.com/Miserlou/Zappa) - Serverless WSGI Python Web Apps with AWS Lambda + API Gateway.
...
* [opsworks-example-cookbooks  ![GitHub Repo stars](https://img.shields.io/github/stars/awslabs/opsworks-example-cookbooks) ![GitHub last commit](https://img.shields.io/github/last-commit/awslabs/opsworks-example-cookbooks)](https://github.com/awslabs/opsworks-example-cookbooks) - Cookbooks used with the sample apps.
...
* [littlstar/s3renity :fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/littlstar/s3renity) ![GitHub last commit](https://img.shields.io/github/last-commit/littlstar/s3renity)](https://github.com/littlstar/s3renity) - Batch functions with concurrency control (each, map, reduce, filter, join)
...
* [MathieuLoutre/grunt-aws-s3 :fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/MathieuLoutre/grunt-aws-s3) ![GitHub last commit](https://img.shields.io/github/last-commit/MathieuLoutre/grunt-aws-s3)](https://github.com/MathieuLoutre/grunt-aws-s3) - Grunt plugin.
* [mickael-kerjean/filestash :fire::fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/mickael-kerjean/filestash) ![GitHub last commit](https://img.shields.io/github/last-commit/mickael-kerjean/filestash)](https://github.com/mickael-kerjean/filestash) - A modern web client for S3.
* [minio/mc :fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/minio/mc) ![GitHub last commit](https://img.shields.io/github/last-commit/minio/mc)](https://github.com/minio/mc) -  Minio Client for filesystem and cloud storage.
* [minio/minio :fire::fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/minio/minio) ![GitHub last commit](https://img.shields.io/github/last-commit/minio/minio)](https://github.com/minio/minio) - Object storage server compatible with S3.
* [mumrah/s3-multipart :fire: ![GitHub Repo stars](https://img.shields.io/github/stars/mumrah/s3-multipart) ![GitHub last commit](https://img.shields.io/github/last-commit/mumrah/s3-multipart)](https://github.com/mumrah/s3-multipart) - Parallel upload/download to S3 via Python.
* [ncw/rclone :fire::fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/ncw/rclone) ![GitHub last commit](https://img.shields.io/github/last-commit/ncw/rclone)](https://github.com/ncw/rclone) - Rsync for various cloud storage providers such as S3.
* [owocki/s3_disk_util :fire: ![GitHub Repo stars](https://img.shields.io/github/stars/owocki/s3_disk_util) ![GitHub last commit](https://img.shields.io/github/last-commit/owocki/s3_disk_util)](https://github.com/owocki/s3_disk_util) - S3 Disk usage (du) utility.
* [peak/s5cmd :fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/peak/s5cmd) ![GitHub last commit](https://img.shields.io/github/last-commit/peak/s5cmd)](https://github.com/peak/s5cmd) - Fast S3 and local filesystem execution tool with wildcard and batch command support.
* [pgherveou/gulp-awspublish :fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/pgherveou/gulp-awspublish) ![GitHub last commit](https://img.shields.io/github/last-commit/pgherveou/gulp-awspublish)](https://github.com/pgherveou/gulp-awspublish) - Gulp plugin.
* [rlmcpherson/s3gof3r :fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/rlmcpherson/s3gof3r) ![GitHub last commit](https://img.shields.io/github/last-commit/rlmcpherson/s3gof3r)](https://github.com/rlmcpherson/s3gof3r) - Fast, concurrent, streaming access, includes a CLI.
* [s3git/s3git :fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/s3git/s3git) ![GitHub last commit](https://img.shields.io/github/last-commit/s3git/s3git)](https://github.com/s3git/s3git) - CLI tool that allows you to create a distributed, decentralized and versioned repository.
* [s3fs-fuse/s3fs-fuse :fire::fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/s3fs-fuse/s3fs-fuse) ![GitHub last commit](https://img.shields.io/github/last-commit/s3fs-fuse/s3fs-fuse)](https://github.com/s3fs-fuse/s3fs-fuse) - Allows Linux and Mac OS X to mount an S3 bucket via FUSE.
* [s3tools/s3cmd :fire::fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/s3tools/s3cmd) ![GitHub last commit](https://img.shields.io/github/last-commit/s3tools/s3cmd)](https://github.com/s3tools/s3cmd) - CLI for managing S3 and CloudFront.
* [schickling/git-s3 :fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/schickling/git-s3) ![GitHub last commit](https://img.shields.io/github/last-commit/schickling/git-s3)](https://github.com/schickling/git-s3) - Deploy your git repo to a bucket.
* [sorentwo/carrierwave-aws :fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/sorentwo/carrierwave-aws) ![GitHub last commit](https://img.shields.io/github/last-commit/sorentwo/carrierwave-aws)](https://github.com/sorentwo/carrierwave-aws) - Adapter for CarrierWave.
* [spring-projects/aws-maven :fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/spring-projects/aws-maven) ![GitHub last commit](https://img.shields.io/github/last-commit/spring-projects/aws-maven)](https://github.com/spring-projects/aws-maven) -  Maven Wagon for S3.
* [tongwang/s3fs-c :fire: ![GitHub Repo stars](https://img.shields.io/github/stars/tongwang/s3fs-c) ![GitHub last commit](https://img.shields.io/github/last-commit/tongwang/s3fs-c)](https://github.com/tongwang/s3fs-c) - Mounts buckets for use on a local file system.
* [mishudark/s3-parallel-put :fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/mishudark/s3-parallel-put) ![GitHub last commit](https://img.shields.io/github/last-commit/mishudark/s3-parallel-put)](https://github.com/mishudark/s3-parallel-put) - CLI that supports parallel uploads.
* [waynehoover/s3_direct_upload :fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/waynehoover/s3_direct_upload) ![GitHub last commit](https://img.shields.io/github/last-commit/waynehoover/s3_direct_upload)](https://github.com/waynehoover/s3_direct_upload) - Direct Upload to Amazon S3 With CORS
* [weavejester/clj-aws-s3 :fire: ![GitHub Repo stars](https://img.shields.io/github/stars/weavejester/clj-aws-s3) ![GitHub last commit](https://img.shields.io/github/last-commit/weavejester/clj-aws-s3)](https://github.com/weavejester/clj-aws-s3) - Client library for Clojure.

### SES

Community Repos:

* [drewblas/aws-ses :fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/drewblas/aws-ses) ![GitHub last commit](https://img.shields.io/github/last-commit/drewblas/aws-ses)](https://github.com/drewblas/aws-ses) - Provides an easy ruby DSL & interface.
* [microapps/MoonMail :fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/microapps/MoonMail) ![GitHub last commit](https://img.shields.io/github/last-commit/microapps/MoonMail)](https://github.com/microapps/MoonMail) - Shoot billions of emails using SES and Lambda.

### Simple Workflow

AWS Repos:

* [aws-flow-ruby :fire: ![GitHub Repo stars](https://img.shields.io/github/stars/aws/aws-flow-ruby) ![GitHub last commit](https://img.shields.io/github/last-commit/aws/aws-flow-ruby)](https://github.com/aws/aws-flow-ruby) - Creates background jobs and multistep workflows.
* [aws-flow-ruby-samples ![GitHub Repo stars](https://img.shields.io/github/stars/awslabs/aws-flow-ruby-samples) ![GitHub last commit](https://img.shields.io/github/last-commit/awslabs/aws-flow-ruby-samples)](https://github.com/awslabs/aws-flow-ruby-samples) - AWS Flow Framework for Ruby samples.
* [aws-flow-ruby-opsworks-helloworld ![GitHub Repo stars](https://img.shields.io/github/stars/awslabs/aws-flow-ruby-opsworks-helloworld) ![GitHub last commit](https://img.shields.io/github/last-commit/awslabs/aws-flow-ruby-opsworks-helloworld)](https://github.com/awslabs/aws-flow-ruby-opsworks-helloworld) - Hello World sample.
...
* [rjrodger/simpledb :fire: ![GitHub Repo stars](https://img.shields.io/github/stars/rjrodger/simpledb) ![GitHub last commit](https://img.shields.io/github/last-commit/rjrodger/simpledb)](https://github.com/rjrodger/simpledb) - Node.js library.

### SNS

AWS Repos:

* [aws-php-sns-message-validator :fire: ![GitHub Repo stars](https://img.shields.io/github/stars/aws/aws-php-sns-message-validator) ![GitHub last commit](https://img.shields.io/github/last-commit/aws/aws-php-sns-message-validator)](https://github.com/aws/aws-php-sns-message-validator) - Message validation for PHP.
...
* [amazon-sqs-java-messaging-lib :fire: ![GitHub Repo stars](https://img.shields.io/github/stars/awslabs/amazon-sqs-java-messaging-lib) ![GitHub last commit](https://img.shields.io/github/last-commit/awslabs/amazon-sqs-java-messaging-lib)](https://github.com/awslabs/amazon-sqs-java-messaging-lib) - Holds the Java Message Service to communicate with SQS.

Community Repos:

* [phstc/shoryuken :fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/phstc/shoryuken) ![GitHub last commit](https://img.shields.io/github/last-commit/phstc/shoryuken)](https://github.com/phstc/shoryuken) - A super efficient SQS thread based message processor for Ruby.
...
* [donnemartin/data-science-ipython-notebooks :fire::fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/donnemartin/data-science-ipython-notebooks) ![GitHub last commit](https://img.shields.io/github/last-commit/donnemartin/data-science-ipython-notebooks)](https://github.com/donnemartin/data-science-ipython-notebooks) - Big data/data science notebooks.
* [everpeace/vagrant-mesos :fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/everpeace/vagrant-mesos) ![GitHub last commit](https://img.shields.io/github/last-commit/everpeace/vagrant-mesos)](https://github.com/everpeace/vagrant-mesos) - Spin up your Mesos Cluster with Vagrant.
* [jhorey/ferry :fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/jhorey/ferry) ![GitHub last commit](https://img.shields.io/github/last-commit/jhorey/ferry)](https://github.com/jhorey/ferry) -  Define, run, and deploy big data apps using Docker.
* [nathanmarz/storm-deploy :fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/nathanmarz/storm-deploy) ![GitHub last commit](https://img.shields.io/github/last-commit/nathanmarz/storm-deploy)](https://github.com/nathanmarz/storm-deploy) - One click deploy for Storm clusters.

### DevOps

Community Repos:

* [cloud-custodian/cloud-custodian :fire::fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/cloud-custodian/cloud-custodian) ![GitHub last commit](https://img.shields.io/github/last-commit/cloud-custodian/cloud-custodian)](https://github.com/cloud-custodian/cloud-custodian) - Rules engine for management, DSL in yaml for query, filter, and actions on resources.
* [chef-cookbooks/aws :fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/chef-cookbooks/aws) ![GitHub last commit](https://img.shields.io/github/last-commit/chef-cookbooks/aws)](https://github.com/chef-cookbooks/aws) - Development repository for aws Chef cookbook.
* [colinbjohnson/aws-missing-tools :fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/colinbjohnson/aws-missing-tools) ![GitHub last commit](https://img.shields.io/github/last-commit/colinbjohnson/aws-missing-tools)](https://github.com/colinbjohnson/aws-missing-tools) - Tools for managing resources including EC2, EBS, RDS and Route53.
* [k1LoW/awspec :fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/k1LoW/awspec) ![GitHub last commit](https://img.shields.io/github/last-commit/k1LoW/awspec)](https://github.com/k1LoW/awspec) - RSpec tests your resources.
* [mitchellh/vagrant-aws :fire::fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/mitchellh/vagrant-aws) ![GitHub last commit](https://img.shields.io/github/last-commit/mitchellh/vagrant-aws)](https://github.com/mitchellh/vagrant-aws) - Use Vagrant to manage your EC2 and VPC instances.
* [NixOS/nixops :fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/NixOS/nixops) ![GitHub last commit](https://img.shields.io/github/last-commit/NixOS/nixops)](https://github.com/NixOS/nixops) - Use NixOS to provision EC2 instances, S3 buckets, and other resources.

### Security

AWS Repos:

* [aws-sha256-agentcs ![GitHub Repo stars](https://img.shields.io/github/stars/awslabs/aws-sha256-agentcs) ![GitHub last commit](https://img.shields.io/github/last-commit/awslabs/aws-sha256-agentcs)](https://github.com/awslabs/aws-sha256-agentcs) - SHA256 Agent Compatibility Ccanner.
* [aws-tvm-anonymous ![GitHub Repo stars](https://img.shields.io/github/stars/awslabs/aws-tvm-anonymous) ![GitHub last commit](https://img.shields.io/github/last-commit/awslabs/aws-tvm-anonymous)](https://github.com/awslabs/aws-tvm-anonymous) - Token Vending Machine for Anonymous Registration.
* [aws-tvm-identity ![GitHub Repo stars](https://img.shields.io/github/stars/awslabs/aws-tvm-identity) ![GitHub last commit](https://img.shields.io/github/last-commit/awslabs/aws-tvm-identity)](https://github.com/awslabs/aws-tvm-identity) - Token Vending Machine for Identity Registration.
* [s2n :fire::fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/awslabs/s2n) ![GitHub last commit](https://img.shields.io/github/last-commit/awslabs/s2n)](https://github.com/awslabs/s2n) - An implementation of the TLS/SSL protocols.

Community Repos:

* [AdRoll/hologram :fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/AdRoll/hologram) ![GitHub last commit](https://img.shields.io/github/last-commit/AdRoll/hologram)](https://github.com/AdRoll/hologram) - Easy, painless credentials on developer laptops.
* [alex/letsencrypt-aws :fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/alex/letsencrypt-aws) ![GitHub last commit](https://img.shields.io/github/last-commit/alex/letsencrypt-aws)](https://github.com/alex/letsencrypt-aws) - Automatically provision and update certificates.
* [bridgecrewio/checkov :fire::fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/bridgecrewio/checkov) ![GitHub last commit](https://img.shields.io/github/last-commit/bridgecrewio/checkov)](https://github.com/bridgecrewio/checkov) - Terraform static analysis, verifies security best practices.
* [cloudsploit/scans :fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/cloudsploit/scans) ![GitHub last commit](https://img.shields.io/github/last-commit/cloudsploit/scans)](https://github.com/cloudsploit/scans) - Detects security risks.
* [iSECPartners/Scout2 :fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/iSECPartners/Scout2) ![GitHub last commit](https://img.shields.io/github/last-commit/iSECPartners/Scout2)](https://github.com/iSECPartners/Scout2) - Security auditing tool.
* [jordanpotti/AWSBucketDump :fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/jordanpotti/AWSBucketDump) ![GitHub last commit](https://img.shields.io/github/last-commit/jordanpotti/AWSBucketDump)](https://github.com/jordanpotti/AWSBucketDump) - Security Tool to Look For Interesting Files in S3 Buckets.
* [Netflix/bless :fire::fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/Netflix/bless) ![GitHub last commit](https://img.shields.io/github/last-commit/Netflix/bless)](https://github.com/Netflix/bless) - SSH Certificate Authority that runs as a Lambda function.
...
* [RiotGames/cloud-inquisitor :fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/RiotGames/cloud-inquisitor) ![GitHub last commit](https://img.shields.io/github/last-commit/RiotGames/cloud-inquisitor)](https://github.com/RiotGames/cloud-inquisitor) - Tool to enforce ownership and data security.
* [salesforce/policy_sentry :fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/salesforce/policy_sentry) ![GitHub last commit](https://img.shields.io/github/last-commit/salesforce/policy_sentry)](https://github.com/salesforce/policy_sentry/) - IAM Least Privilege Policy Generator.
* [sebsto/AWSVPN :fire: ![GitHub Repo stars](https://img.shields.io/github/stars/sebsto/AWSVPN) ![GitHub last commit](https://img.shields.io/github/last-commit/sebsto/AWSVPN)](https://github.com/sebsto/AWSVPN) - Start a private VPN server in the cloud.
* [trailofbits/algo :fire::fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/trailofbits/algo) ![GitHub last commit](https://img.shields.io/github/last-commit/trailofbits/algo)](https://github.com/trailofbits/algo) - Set up a personal IPSEC VPN on EC2 and other cloud services.
* [ttlequals0/autovpn :fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/ttlequals0/autovpn) ![GitHub last commit](https://img.shields.io/github/last-commit/ttlequals0/autovpn)](https://github.com/ttlequals0/autovpn) - Create On Demand Disposable OpenVPN Endpoints.
...
* [aws-arch-backoff-simulator :fire: ![GitHub Repo stars](https://img.shields.io/github/stars/awslabs/aws-arch-backoff-simulator) ![GitHub last commit](https://img.shields.io/github/last-commit/awslabs/aws-arch-backoff-simulator)](https://github.com/awslabs/aws-arch-backoff-simulator) - Jitter and backoff Simulator for AWS architecture blog.
* [aws-big-data-blog :fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/awslabs/aws-big-data-blog) ![GitHub last commit](https://img.shields.io/github/last-commit/awslabs/aws-big-data-blog)](https://github.com/awslabs/aws-big-data-blog) - Samples from the AWS Big Data Blog.
* [aws-demo-php-simple-app ![GitHub Repo stars](https://img.shields.io/github/stars/awslabs/aws-demo-php-simple-app) ![GitHub last commit](https://img.shields.io/github/last-commit/awslabs/aws-demo-php-simple-app)](https://github.com/awslabs/aws-demo-php-simple-app) - PHP apps from the AWS Blogs.
* [aws-mobile-sample-wif ![GitHub Repo stars](https://img.shields.io/github/stars/awslabs/aws-mobile-sample-wif) ![GitHub last commit](https://img.shields.io/github/last-commit/awslabs/aws-mobile-sample-wif)](https://github.com/awslabs/aws-mobile-sample-wif) - Samples from the AWS Mobile SDK blog.
* [aws-mobile-self-paced-labs-samples ![GitHub Repo stars](https://img.shields.io/github/stars/awslabs/aws-mobile-self-paced-labs-samples) ![GitHub last commit](https://img.shields.io/github/last-commit/awslabs/aws-mobile-self-paced-labs-samples)](https://github.com/awslabs/aws-mobile-self-paced-labs-samples) - Android Snake Game from a self-paced lab.
* [aws-quickstart](https://github.com/aws-quickstart/) - Official repository for AWS Quick Start.
* [aws-spot-labs :fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/awslabs/aws-spot-labs) ![GitHub last commit](https://img.shields.io/github/last-commit/awslabs/aws-spot-labs)](https://github.com/awslabs/aws-spot-labs) - Best practices using AWS Spot Instances.
* [aws-training-demo :fire: ![GitHub Repo stars](https://img.shields.io/github/stars/awslabs/aws-training-demo) ![GitHub last commit](https://img.shields.io/github/last-commit/awslabs/aws-training-demo)](https://github.com/awslabs/aws-training-demo) - Demos from the Technical Trainers community.
* [java-meme-generator-sample ![GitHub Repo stars](https://img.shields.io/github/stars/awslabs/java-meme-generator-sample) ![GitHub last commit](https://img.shields.io/github/last-commit/awslabs/java-meme-generator-sample)](https://github.com/awslabs/java-meme-generator-sample) - Meme generation app from re:Invent 2012.
* [railsconf2013-tech-demo :fire: ![GitHub Repo stars](https://img.shields.io/github/stars/awslabs/railsconf2013-tech-demo) ![GitHub last commit](https://img.shields.io/github/last-commit/awslabs/railsconf2013-tech-demo)](https://github.com/awslabs/railsconf2013-tech-demo) - Seahorse demo from RailsConf 2013.
* [reinvent2013-js-blog-demo ![GitHub Repo stars](https://img.shields.io/github/stars/awslabs/reinvent2013-js-blog-demo) ![GitHub last commit](https://img.shields.io/github/last-commit/awslabs/reinvent2013-js-blog-demo)](https://github.com/awslabs/reinvent2013-js-blog-demo) - Demo blogging app from re:Invent 2013.
* [reinvent2013-mobile-photo-share ![GitHub Repo stars](https://img.shields.io/github/stars/awslabs/reinvent2013-mobile-photo-share) ![GitHub last commit](https://img.shields.io/github/last-commit/awslabs/reinvent2013-mobile-photo-share)](https://github.com/awslabs/reinvent2013-mobile-photo-share) - Mobile photo share app from re:Invent 2014.
* [reinvent2014-scalable-site-management ![GitHub Repo stars](https://img.shields.io/github/stars/awslabs/reinvent2014-scalable-site-management) ![GitHub last commit](https://img.shields.io/github/last-commit/awslabs/reinvent2014-scalable-site-management)](https://github.com/awslabs/reinvent2014-scalable-site-management) - Scalable site management sample from re:Invent 2014.
* [reinvent2015-dev309 ![GitHub Repo stars](https://img.shields.io/github/stars/awslabs/reinvent2015-dev309) ![GitHub last commit](https://img.shields.io/github/last-commit/awslabs/reinvent2015-dev309)](https://github.com/awslabs/reinvent2015-dev309) - Large Scale Metrics Analysis from re:Invent 2015.
* [timely-security-analytics ![GitHub Repo stars](https://img.shields.io/github/stars/awslabs/timely-security-analytics) ![GitHub last commit](https://img.shields.io/github/last-commit/awslabs/timely-security-analytics)](https://github.com/awslabs/timely-security-analytics) - Security analytics sample from 2015 re:Invent 2015.
* [todo-sample-app ![GitHub Repo stars](https://img.shields.io/github/stars/awslabs/todo-sample-app) ![GitHub last commit](https://img.shields.io/github/last-commit/awslabs/todo-sample-app)](https://github.com/awslabs/todo-sample-app) - Simple "Todo" app from RailsConf 2014.

Community Repos:

* [startup-class/setup :fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/startup-class/setup) ![GitHub last commit](https://img.shields.io/github/last-commit/startup-class/setup)](https://github.com/startup-class/setup) -  EC2 setup files for Startup Engineering MOOC.

### Miscellaneous Repos

AWS Repos:

* [amediamanager ![GitHub Repo stars](https://img.shields.io/github/stars/awslabs/amediamanager) ![GitHub last commit](https://img.shields.io/github/last-commit/awslabs/amediamanager)](https://github.com/awslabs/amediamanager) - Media manager.
* [aws-hal-client-java ![GitHub Repo stars](https://img.shields.io/github/stars/awslabs/aws-hal-client-java) ![GitHub last commit](https://img.shields.io/github/last-commit/awslabs/aws-hal-client-java)](https://github.com/awslabs/aws-hal-client-java) - Java client for the Hypertext Application Language.
* [aws-model-validators ![GitHub Repo stars](https://img.shields.io/github/stars/awslabs/aws-model-validators) ![GitHub last commit](https://img.shields.io/github/last-commit/awslabs/aws-model-validators)](https://github.com/awslabs/aws-model-validators) - Tools for validating the AWS service JSON model files.
* [aws-sdk-js-sample-video-transcoder ![GitHub Repo stars](https://img.shields.io/github/stars/awslabs/aws-sdk-js-sample-video-transcoder) ![GitHub last commit](https://img.shields.io/github/last-commit/awslabs/aws-sdk-js-sample-video-transcoder)](https://github.com/awslabs/aws-sdk-js-sample-video-transcoder) - Sample cross-platform video transcoder app.
* [simplebeerservice :fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/awslabs/simplebeerservice) ![GitHub last commit](https://img.shields.io/github/last-commit/awslabs/simplebeerservice)](https://github.com/awslabs/simplebeerservice) - Cloud-connected kegerator that streams live sensor data to AWS.

Community Repos:

* [bcoe/thumbd :fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/bcoe/thumbd) ![GitHub last commit](https://img.shields.io/github/last-commit/bcoe/thumbd)](https://github.com/bcoe/thumbd) - Node.js/ImageMagick-based image thumbnailing service.
* [cdkpatterns/serverless :fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/cdk-patterns/serverless) ![GitHub last commit](https://img.shields.io/github/last-commit/cdk-patterns/serverless)](https://github.com/cdk-patterns/serverless) - Deployable serverless architecture patterns built in AWS CDK.
* [Comcast/cmb :fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/Comcast/cmb) ![GitHub last commit](https://img.shields.io/github/last-commit/Comcast/cmb)](https://github.com/Comcast/cmb) - Highly available, horizontally scalable queuing and notification service.
* [convox/rack :fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/convox/rack) ![GitHub last commit](https://img.shields.io/github/last-commit/convox/rack)](https://github.com/convox/rack) - Open-source PaaS on AWS.
* [devops-israel/aws-inventory :fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/devops-israel/aws-inventory) ![GitHub last commit](https://img.shields.io/github/last-commit/devops-israel/aws-inventory)](https://github.com/devops-israel/aws-inventory) - Display all your AWS resources on a single web page.
* [donnemartin/dev-setup :fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/donnemartin/dev-setup) ![GitHub last commit](https://img.shields.io/github/last-commit/donnemartin/dev-setup)](https://github.com/donnemartin/dev-setup) - Mac setup of various developer tools and AWS services.
* [dtan4/terraforming :fire::fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/dtan4/terraforming) ![GitHub last commit](https://img.shields.io/github/last-commit/dtan4/terraforming)](https://github.com/dtan4/terraforming) - Export existing resources to Terraform style (tf, tfstate).
* [segmentio/stack :fire::fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/segmentio/stack) ![GitHub last commit](https://img.shields.io/github/last-commit/segmentio/stack)](https://github.com/segmentio/stack) - A set of Terraform modules for configuring production infrastructure.
* [j2labs/microarmy  ![GitHub Repo stars](https://img.shields.io/github/stars/j2labs/microarmy) ![GitHub last commit](https://img.shields.io/github/last-commit/j2labs/microarmy)](https://github.com/j2labs/microarmy) - Deploy micro instances to launch a coordinated siege.
* [jpillora/grunt-aws :fire: ![GitHub Repo stars](https://img.shields.io/github/stars/jpillora/grunt-aws) ![GitHub last commit](https://img.shields.io/github/last-commit/jpillora/grunt-aws)](https://github.com/jpillora/grunt-aws) - Grunt interface into the Node.JS SDK.
* [jvehent/haproxy-aws :fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/jvehent/haproxy-aws) ![GitHub last commit](https://img.shields.io/github/last-commit/jvehent/haproxy-aws)](https://github.com/jvehent/haproxy-aws) - Documentation on building a HTTPS stack with HAProxy.
* [localstack/localstack :fire::fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/localstack/localstack) ![GitHub last commit](https://img.shields.io/github/last-commit/localstack/localstack)](https://github.com/localstack/localstack) - A fully functional local AWS cloud stack. Develop and test your cloud apps offline!
* [meducation/propono :fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/meducation/propono) ![GitHub last commit](https://img.shields.io/github/last-commit/meducation/propono)](https://github.com/meducation/propono) - Easy-to-use pub/sub in Ruby.
* [mozilla/awsbox :fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/mozilla/awsbox) ![GitHub last commit](https://img.shields.io/github/last-commit/mozilla/awsbox)](https://github.com/mozilla/awsbox) - A featherweight PaaS on top of EC2 for deploying node apps.
* [Netflix/aminator :fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/Netflix/aminator) ![GitHub last commit](https://img.shields.io/github/last-commit/Netflix/aminator)](https://github.com/Netflix/aminator) - A tool for creating EBS AMIs.
* [Netflix/archaius :fire::fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/Netflix/archaius) ![GitHub last commit](https://img.shields.io/github/last-commit/Netflix/archaius)](https://github.com/Netflix/archaius) - Library for configuration management API.
* [Netflix/asgard :fire::fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/Netflix/asgard) ![GitHub last commit](https://img.shields.io/github/last-commit/Netflix/asgard)](https://github.com/Netflix/asgard) - Web interface for application deployments and cloud management.
* [Netflix/aws-autoscaling :fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/Netflix/aws-autoscaling) ![GitHub last commit](https://img.shields.io/github/last-commit/Netflix/aws-autoscaling)](https://github.com/Netflix/aws-autoscaling) - Tools for using auto scaling and documentation best practices.
* [Netflix/chaosmonkey :fire::fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/Netflix/chaosmonkey) ![GitHub last commit](https://img.shields.io/github/last-commit/Netflix/chaosmonkey)](https://github.com/Netflix/chaosmonkey) - Resiliency tool that helps applications tolerate random instance failures.
* [Netflix/eureka :fire::fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/Netflix/eureka) ![GitHub last commit](https://img.shields.io/github/last-commit/Netflix/eureka)](https://github.com/Netflix/eureka) - Service registry for resilient mid-tier load balancing and failover.
* [Netflix/EVCache :fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/Netflix/EVCache) ![GitHub last commit](https://img.shields.io/github/last-commit/Netflix/EVCache)](https://github.com/Netflix/EVCache) - A distributed in-memory data store.
* [Netflix/Fenzo :fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/Netflix/Fenzo) ![GitHub last commit](https://img.shields.io/github/last-commit/Netflix/Fenzo)](https://github.com/Netflix/Fenzo) - Extensible Scheduler for Mesos Frameworks.
* [Netflix/ice :fire::fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/Netflix/ice) ![GitHub last commit](https://img.shields.io/github/last-commit/Netflix/ice)](https://github.com/Netflix/ice) - Usage and cost monitoring tool.
* [Netflix/ribbon :fire::fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/Netflix/ribbon) ![GitHub last commit](https://img.shields.io/github/last-commit/Netflix/ribbon)](https://github.com/Netflix/ribbon) - Remote procedure call library with built in software load balancers.
* [Netflix/SimianArmy :fire::fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/Netflix/SimianArmy) ![GitHub last commit](https://img.shields.io/github/last-commit/Netflix/SimianArmy)](https://github.com/Netflix/SimianArmy) - Tools to keep your cloud operating in top form.
* [Netflix/zuul :fire::fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/Netflix/zuul) ![GitHub last commit](https://img.shields.io/github/last-commit/Netflix/zuul)](https://github.com/Netflix/zuul) - Edge service that provides dynamic routing, monitoring, resiliency, security, and more.
* [niftylettuce/gulp-aws-splash :fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/niftylettuce/gulp-aws-splash) ![GitHub last commit](https://img.shields.io/github/last-commit/niftylettuce/gulp-aws-splash)](https://github.com/niftylettuce/gulp-aws-splash) - Open-source LaunchRock alternative. Build beautiful splash pages.
* [puppetlabs/puppetlabs-aws :fire: ![GitHub Repo stars](https://img.shields.io/github/stars/puppetlabs/puppetlabs-aws) ![GitHub last commit](https://img.shields.io/github/last-commit/puppetlabs/puppetlabs-aws)](https://github.com/puppetlabs/puppetlabs-aws) - Puppet module for managing resources to build out infrastructure.
* [mhart/react-server-routing-example :fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/mhart/react-server-routing-example) ![GitHub last commit](https://img.shields.io/github/last-commit/mhart/react-server-routing-example)](https://github.com/mhart/react-server-routing-example) - Sample universal client/server routing and data in React.
* [Similarweb/finala :fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/similarweb/finala) ![GitHub last commit](https://img.shields.io/github/last-commit/similarweb/finala)](https://github.com/similarweb/finala) - A resource cloud scanner that analyzes and reports wasteful and unused resources to cut unwanted expenses.
* [snowplow/snowplow :fire::fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/snowplow/snowplow) ![GitHub last commit](https://img.shields.io/github/last-commit/snowplow/snowplow)](https://github.com/snowplow/snowplow) - Enterprise-strength web, mobile and event analytics, powered by Hadoop, Kafka, Kinesis, Redshift and Elasticsearch.
* [Spinnaker/spinnaker :fire::fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/Spinnaker/spinnaker) ![GitHub last commit](https://img.shields.io/github/last-commit/Spinnaker/spinnaker)](https://github.com/Spinnaker/spinnaker) - Successor to asgard supporting pipelines and more.
* [spulec/moto :fire::fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/spulec/moto) ![GitHub last commit](https://img.shields.io/github/last-commit/spulec/moto)](https://github.com/spulec/moto) - Allows your python tests to easily mock out the boto library.
...
* [Open Guide to AWS :fire::fire::fire::fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/open-guides/og-aws) ![GitHub last commit](https://img.shields.io/github/last-commit/open-guides/og-aws)](https://github.com/open-guides/og-aws)
...
* AWS Lambda in Action [Manning](https://www.manning.com/books/aws-lambda-in-action) or [Amazon.com](http://amzn.com/1617293717) - [Code Repo :fire::fire: ![GitHub Repo stars](https://img.shields.io/github/stars/danilop/AWS_Lambda_in_Action) ![GitHub last commit](https://img.shields.io/github/last-commit/danilop/AWS_Lambda_in_Action)](https://github.com/danilop/AWS_Lambda_in_Action)
...
* [A Curated List of Engineering Blogs ![GitHub Repo stars](https://img.shields.io/github/stars/kilimchoi/engineering-blogs) ![GitHub last commit](https://img.shields.io/github/last-commit/kilimchoi/engineering-blogs)](https://github.com/kilimchoi/engineering-blogs)
...
Check out the [Credits page ![GitHub Repo stars](https://img.shields.io/github/stars/donnemartin/awesome-aws) ![GitHub last commit](https://img.shields.io/github/last-commit/donnemartin/awesome-aws)](https://github.com/donnemartin/awesome-aws/blob/master/CREDITS.md).

## Other Awesome Lists

Other awesome lists can be found in [awesome ![GitHub Repo stars](https://img.shields.io/github/stars/sindresorhus/awesome) ![GitHub last commit](https://img.shields.io/github/last-commit/sindresorhus/awesome)](https://github.com/sindresorhus/awesome) and [awesome-awesomeness ![GitHub Repo stars](https://img.shields.io/github/stars/bayandin/awesome-awesomeness) ![GitHub last commit](https://img.shields.io/github/last-commit/bayandin/awesome-awesomeness)](https://github.com/bayandin/awesome-awesomeness).
