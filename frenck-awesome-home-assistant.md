...
please read the [guide ![GitHub Repo stars](https://img.shields.io/github/stars/frenck/awesome-home-assistant) ![GitHub last commit](https://img.shields.io/github/last-commit/frenck/awesome-home-assistant)](https://github.com/frenck/awesome-home-assistant/blob/master/CONTRIBUTING.md).
...
- [Home Assistant Supervised ![GitHub Repo stars](https://img.shields.io/github/stars/home-assistant/supervised-installer) ![GitHub last commit](https://img.shields.io/github/last-commit/home-assistant/supervised-installer)](https://github.com/home-assistant/supervised-installer/blob/master/README.md) - Installing a semi managed environment for experts.
...
- [Isabella Gross Alström ![GitHub Repo stars](https://img.shields.io/github/stars/isabellaalstrom/home-assistant-config) ![GitHub last commit](https://img.shields.io/github/last-commit/isabellaalstrom/home-assistant-config)](https://github.com/isabellaalstrom/home-assistant-config) - Hass.io, Intel NUC, Ubuntu, Docker, Lovelace UI.
...
- [stanvx ![GitHub Repo stars](https://img.shields.io/github/stars/stanvx/Home-Assistant-Configuration) ![GitHub last commit](https://img.shields.io/github/last-commit/stanvx/Home-Assistant-Configuration)](https://github.com/stanvx/Home-Assistant-Configuration) - Complete setup which uses AppDaemon and HA Floorplan as well.
- [Vasiley ![GitHub Repo stars](https://img.shields.io/github/stars/Vasiley/Home-Assistant-Main) ![GitHub last commit](https://img.shields.io/github/last-commit/Vasiley/Home-Assistant-Main)](https://github.com/Vasiley/Home-Assistant-Main) - Runs two instances that work together.
...
- [James McCarthy ![GitHub Repo stars](https://img.shields.io/github/stars/JamesMcCarthy79/Home-Assistant-Config) ![GitHub last commit](https://img.shields.io/github/last-commit/JamesMcCarthy79/Home-Assistant-Config)](https://github.com/JamesMcCarthy79/Home-Assistant-Config) - Well documented, 3 instances & automations in YAML & Node-RED.
...
- [Andrea Donno ![GitHub Repo stars](https://img.shields.io/github/stars/adonno/Home-AssistantConfig) ![GitHub last commit](https://img.shields.io/github/last-commit/adonno/Home-AssistantConfig)](https://github.com/adonno/Home-AssistantConfig) - Hass.io based, focused on touchscreen usage.
- [Klaas Schoute ![GitHub Repo stars](https://img.shields.io/github/stars/klaasnicolaas/Smarthome-homeassistant-config) ![GitHub last commit](https://img.shields.io/github/last-commit/klaasnicolaas/Smarthome-homeassistant-config)](https://github.com/klaasnicolaas/Smarthome-homeassistant-config) - Hass.io based, Intel NUC, Ubuntu Server, Docker and regularly updated.
- [Jason Hunter ![GitHub Repo stars](https://img.shields.io/github/stars/hunterjm/home-assistant-config) ![GitHub last commit](https://img.shields.io/github/last-commit/hunterjm/home-assistant-config)](https://github.com/hunterjm/home-assistant-config) - Hass.io based, Intel NUC i5, TensorFlow & camera streams.
- [Nathan ![GitHub Repo stars](https://img.shields.io/github/stars/N-l1/home-assistant-config) ![GitHub last commit](https://img.shields.io/github/last-commit/N-l1/home-assistant-config)](https://github.com/N-l1/home-assistant-config) - Lovelace config and themes based on Soft UI.
...
- [OpenZWave ![GitHub Repo stars](https://img.shields.io/github/stars/home-assistant/hassio-addons) ![GitHub last commit](https://img.shields.io/github/last-commit/home-assistant/hassio-addons)](https://github.com/home-assistant/hassio-addons/blob/master/zwave/DOCS.md) - Use an Z-Wave USB-stick with the QT OpenZWave Daemon.
...
- [Grafana ![GitHub Repo stars](https://img.shields.io/github/stars/hassio-addons/addon-grafana) ![GitHub last commit](https://img.shields.io/github/last-commit/hassio-addons/addon-grafana)](https://github.com/hassio-addons/addon-grafana) - Open platform for beautiful analytics and monitoring.
...
- [JupyterLab Lite ![GitHub Repo stars](https://img.shields.io/github/stars/hassio-addons/addon-jupyterlab-lite) ![GitHub last commit](https://img.shields.io/github/last-commit/hassio-addons/addon-jupyterlab-lite)](https://github.com/hassio-addons/addon-jupyterlab-lite) - Create documents containing live code, equations, visualizations, and explanatory text.
...
- [ADB ![GitHub Repo stars](https://img.shields.io/github/stars/hassio-addons/addon-adb) ![GitHub last commit](https://img.shields.io/github/last-commit/hassio-addons/addon-adb)](https://github.com/hassio-addons/addon-adb) - The Android Debug Bridge server program.
...
- [Home Panel ![GitHub Repo stars](https://img.shields.io/github/stars/hassio-addons/addon-home-panel) ![GitHub last commit](https://img.shields.io/github/last-commit/hassio-addons/addon-home-panel)](https://github.com/hassio-addons/addon-home-panel) - A touch-compatible web frontend for controlling the home.
...
- [Button card ![GitHub Repo stars](https://img.shields.io/github/stars/kuuji/button-card) ![GitHub last commit](https://img.shields.io/github/last-commit/kuuji/button-card)](https://github.com/kuuji/button-card) - Button card for your entities.
- [Slideshow card ![GitHub Repo stars](https://img.shields.io/github/stars/zsarnett/slideshow-card) ![GitHub last commit](https://img.shields.io/github/last-commit/zsarnett/slideshow-card)](https://github.com/zsarnett/slideshow-card) - Dynamic slideshow of images or cards.
...
- [Compact Custom Header ![GitHub Repo stars](https://img.shields.io/github/stars/maykar/compact-custom-header) ![GitHub last commit](https://img.shields.io/github/last-commit/maykar/compact-custom-header)](https://github.com/maykar/compact-custom-header) - Customize and compact the frontend header bar.
- [Card Modder ![GitHub Repo stars](https://img.shields.io/github/stars/thomasloven/lovelace-card-modder) ![GitHub last commit](https://img.shields.io/github/last-commit/thomasloven/lovelace-card-modder)](https://github.com/thomasloven/lovelace-card-modder) - Style your Lovelace cards.
...
- [Atomic Calendar Card ![GitHub Repo stars](https://img.shields.io/github/stars/atomic7777/atomic_calendar) ![GitHub last commit](https://img.shields.io/github/last-commit/atomic7777/atomic_calendar)](https://github.com/atomic7777/atomic_calendar) - Calendar card with advanced settings.
...
- [Lovelace Floorplan ![GitHub Repo stars](https://img.shields.io/github/stars/pkozul/lovelace-floorplan) ![GitHub last commit](https://img.shields.io/github/last-commit/pkozul/lovelace-floorplan)](https://github.com/pkozul/lovelace-floorplan) - Interaction with your entities from a Floorplan.
...
- [Upcoming Media Card ![GitHub Repo stars](https://img.shields.io/github/stars/custom-cards/upcoming-media-card) ![GitHub last commit](https://img.shields.io/github/last-commit/custom-cards/upcoming-media-card)](https://github.com/custom-cards/upcoming-media-card) - Display upcoming episodes and movies from services like: Plex, Kodi, Radarr, Sonarr, and Trakt.
...
- [Xiaomi Vacuum Map Card ![GitHub Repo stars](https://img.shields.io/github/stars/PiotrMachowski/Home-Assistant-Lovelace-Xiaomi-Vacuum-Map-card) ![GitHub last commit](https://img.shields.io/github/last-commit/PiotrMachowski/Home-Assistant-Lovelace-Xiaomi-Vacuum-Map-card)](https://github.com/PiotrMachowski/Home-Assistant-Lovelace-Xiaomi-Vacuum-Map-card) - Interactive Xiaomi Vacuum map, just like in Mi Home app.
...
- [Hue Sensors ![GitHub Repo stars](https://img.shields.io/github/stars/robmarkcole/Hue-sensors-HASS) ![GitHub last commit](https://img.shields.io/github/last-commit/robmarkcole/Hue-sensors-HASS)](https://github.com/robmarkcole/Hue-sensors-HASS) - Enables the use of Philips Hue sensors.
- [Google Geocode ![GitHub Repo stars](https://img.shields.io/github/stars/michaelmcarthur/GoogleGeocode-HASS) ![GitHub last commit](https://img.shields.io/github/last-commit/michaelmcarthur/GoogleGeocode-HASS)](https://github.com/michaelmcarthur/GoogleGeocode-HASS) - Converts a device tracker location into a human-readable address.
...
- [Elasticsearch ![GitHub Repo stars](https://img.shields.io/github/stars/legrego/homeassistant-elasticsearch) ![GitHub last commit](https://img.shields.io/github/last-commit/legrego/homeassistant-elasticsearch)](https://github.com/legrego/homeassistant-elasticsearch) - Publishes events to Elasticsearch.
- [Sonoff/eWeLink ![GitHub Repo stars](https://img.shields.io/github/stars/peterbuga/HASS-sonoff-ewelink) ![GitHub last commit](https://img.shields.io/github/last-commit/peterbuga/HASS-sonoff-ewelink)](https://github.com/peterbuga/HASS-sonoff-ewelink) - Control Sonoff/eWeLink smart devices using the stock firmware.
...
- [Sonoff Tasmota ![GitHub Repo stars](https://img.shields.io/github/stars/arendst/Sonoff-Tasmota) ![GitHub last commit](https://img.shields.io/github/last-commit/arendst/Sonoff-Tasmota)](https://github.com/arendst/Sonoff-Tasmota) - Firmware for ESP8266 boards and devices.
...
- [Hassio Vagrant ![GitHub Repo stars](https://img.shields.io/github/stars/hassio-addons/hassio-vagrant) ![GitHub last commit](https://img.shields.io/github/last-commit/hassio-addons/hassio-vagrant)](https://github.com/hassio-addons/hassio-vagrant) - Vagrant box original created for developing add-ons.
...
See [LICENSE ![GitHub Repo stars](https://img.shields.io/github/stars/frenck/awesome-home-assistant) ![GitHub last commit](https://img.shields.io/github/last-commit/frenck/awesome-home-assistant)](https://github.com/frenck/awesome-home-assistant/blob/master/LICENSE.md) for
