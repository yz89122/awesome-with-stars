...
- [openapi-python-client ![GitHub Repo stars](https://img.shields.io/github/stars/triaxtec/openapi-python-client) ![GitHub last commit](https://img.shields.io/github/last-commit/triaxtec/openapi-python-client)](https://github.com/triaxtec/openapi-python-client) - Generate modern FastAPI Python clients (via FastAPI) from OpenAPI.
